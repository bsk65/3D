 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vs=new Map,Np=new Map,Xi=new Map;function Cc(r,e){try{r.container.addComponent(e)}catch(n){ot.debug(`Component ${e.name} failed to register with FirebaseApp ${r.name}`,n)}}function qt(r){const e=r.name;if(Xi.has(e))return ot.debug(`There were multiple attempts to register component ${e}.`),!1;Xi.set(e,r);for(const n of vs.values())Cc(n,r);for(const n of Np.values())Cc(n,r);return!0}function Ls(r,e){const n=r.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),r.container.getProvider(e)}function qe(r){return r.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt=kp;function Zl(r,e={}){let n=r;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Qi,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw At.create("bad-app-name",{appName:String(i)});if(n||(n=Kl()),!n)throw At.create("no-options");const o=vs.get(i);if(o){if(ys(n,o.options)&&ys(s,o.config))return o;throw At.create("duplicate-app",{appName:i})}const c=new Bf(i);for(const h of Xi.values())c.addComponent(h);const l=new Vp(n,s,c);return vs.set(i,l),l}function To(r=Qi){const e=vs.get(r);if(!e&&r===Qi&&Kl())return Zl();if(!e)throw At.create("no-app",{appName:r});return e}function He(r,e,n){var s;let i=(s=Dp[r])!==null&&s!==void 0?s:r;n&&(i+=`-${n}`);const o=i.match(/\s|\//),c=e.match(/\s|\//);if(o||c){const l=[`Unable to register library "${i}" with version "${e}":`];o&&l.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&c&&l.push("and"),c&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ot.warn(l.join(" "));return}qt(new bt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es=new Eo("@firebase/auth");function Gp(r,...e){Es.logLevel<=G.WARN&&Es.warn(`Auth (${Xt}): ${r}`,...e)}function is(r,...e){Es.logLevel<=G.ERROR&&Es.error(`Auth (${Xt}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yp=new Er(3e4,6e4);function ut(r,e){return r.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:r.tenantId}):e}async function ht(r,e,n,s,i={}){return ou(r,i,async()=>{let o={},c={};s&&(e==="GET"?c=s:o={body:JSON.stringify(s)});const l=vr(Object.assign({key:r.config.apiKey},c)).slice(1),h=await r._getAdditionalHeaders();h["Content-Type"]="application/json",r.languageCode&&(h["X-Firebase-Locale"]=r.languageCode);const f=Object.assign({method:e,headers:h},o);return If()||(f.referrerPolicy="no-referrer"),iu.fetch()(au(r,r.config.apiHost,n,l),f)})}async function ou(r,e,n){r._canInitEmulator=!1;const s=Object.assign(Object.assign({},Jp),e);try{const i=new em(r),o=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const c=await o.json();if("needConfirmation"in c)throw Yr(r,"account-exists-with-different-credential",c);if(o.ok&&!("errorMessage"in c))return c;{const l=o.ok?c.errorMessage:c.error.message,[h,f]=l.split(" : ");if(h==="FEDERATED_USER_ID_ALREADY_LINKED")throw Yr(r,"credential-already-in-use",c);if(h==="EMAIL_EXISTS")throw Yr(r,"email-already-in-use",c);if(h==="USER_DISABLED")throw Yr(r,"user-disabled",c);const m=s[h]||h.toLowerCase().replace(/[_\s]+/g,"-");if(f)throw su(r,m,f);Be(r,m)}}catch(i){if(i instanceof Je)throw i;Be(r,"network-request-failed",{message:String(i)})}}async function wr(r,e,n,s,i={}){const o=await ht(r,e,n,s,i);return"mfaPendingCredential"in o&&Be(r,"multi-factor-auth-required",{_serverResponse:o}),o}function au(r,e,n,s){const i=`${e}${n}?${s}`;return r.config.emulator?Ro(r.config,i):`${r.config.apiScheme}://${i}`}function Zp(r){switch(r){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class em{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(ze(this.auth,"network-request-failed")),Yp.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Yr(r,e,n){const s={appName:r.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const i=ze(r,e,s);return i.customData._tokenResponse=n,i}function Vc(r){return r!==void 0&&r.enterprise!==void 0}class tm{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const n of this.recaptchaEnforcementState)if(n.provider&&n.provider===e)return Zp(n.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function nm(r,e){return ht(r,"GET","/v2/recaptchaConfig",ut(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function os(r,e,n){return`firebase:${r}:${e}:${n}`}class un{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:i,name:o}=this.auth;this.fullUserKey=os(this.userKey,i.apiKey,o),this.fullPersistenceKey=os("persistence",i.apiKey,o),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?nt._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new un(rt(xc),e,s);const i=(await Promise.all(n.map(async f=>{if(await f._isAvailable())return f}))).filter(f=>f);let o=i[0]||rt(xc);const c=os(s,e.config.apiKey,e.name);let l=null;for(const f of n)try{const m=await f._get(c);if(m){const v=nt._fromJSON(e,m);f!==o&&(l=v),o=f;break}}catch{}const h=i.filter(f=>f._shouldAllowMigration);return!o._shouldAllowMigration||!h.length?new un(o,e,s):(o=h[0],l&&await o._set(c,l.toJSON()),await Promise.all(n.map(async f=>{if(f!==o)try{await f._remove(c)}catch{}})),new un(o,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rm(r,e){const n=Ls(r,"auth");if(n.isInitialized()){const i=n.getImmediate(),o=n.getOptions();if(ys(o,e??{}))return i;Be(i,"already-initialized")}return n.initialize({options:e})}function bm(r,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(rt);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function Pm(r,e,n){const s=kt(r);U(s._canInitEmulator,s,"emulator-config-failed"),U(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,o=wu(e),{host:c,port:l}=Sm(e),h=l===null?"":`:${l}`;s.config.emulator={url:`${o}//${c}${h}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:c,port:l,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:i})}),Cm()}function wu(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function Sm(r){const e=wu(r),n=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const o=i[1];return{host:o,port:$c(s.substr(o.length+1))}}else{const[o,c]=s.split(":");return{host:o,port:$c(c)}}}function $c(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function Cm(){function r(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Is extends Je{constructor(e,n,s,i){var o;super(n.code,n.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,Is.prototype),this.customData={appName:e.name,tenantId:(o=e.tenantId)!==null&&o!==void 0?o:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,i){return new Is(e,n,s,i)}}function Iu(r,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(r):n._getIdTokenResponse(r)).catch(o=>{throw o.code==="auth/multi-factor-auth-required"?Is._fromErrorAndOperation(r,o,e,s):o})}async function Bm(r,e,n=!1){const s=await lr(r,e._linkToIdToken(r.auth,await r.getIdToken()),n);return zt._forOperation(r,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ru(r){const e=kt(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function qm(r,e,n){const s=kt(r);await Ts(s,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Om)}async function Hm(r,e,n){if(qe(r.app))return Promise.reject(st(r));const s=kt(r),c=await Ts(s,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Fm).catch(h=>{throw h.code==="auth/password-does-not-meet-requirements"&&Ru(r),h}),l=await zt._fromIdTokenResponse(s,"signIn",c);return await s._updateCurrentUser(l.user),l}function zm(r,e,n){return qe(r.app)?Promise.reject(st(r)):jm(ae(r),wn.credential(e,n)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&Ru(r),s})}function Wm(r,e,n,s){return ae(r).onIdTokenChanged(e,n,s)}function Gm(r,e,n){return ae(r).beforeAuthStateChanged(e,n)}function Km(r,e,n,s){return ae(r).onAuthStateChanged(e,n,s)}function Qm(r){return ae(r).signOut()}const As="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xs{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const n=this.receivers.find(i=>i.isListeningto(e));if(n)return n;const s=new xs(e);return this.receivers.push(s),s}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const n=e,{eventId:s,eventType:i,data:o}=n.data,c=this.handlersMap[i];if(!(c!=null&&c.size))return;n.ports[0].postMessage({status:"ack",eventId:s,eventType:i});const l=Array.from(c).map(async f=>f(n.origin,o)),h=await Zm(l);n.ports[0].postMessage({status:"done",eventId:s,eventType:i,response:h})}_subscribe(e,n){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(n)}_unsubscribe(e,n){this.handlersMap[e]&&n&&this.handlersMap[e].delete(n),(!n||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}xs.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Du="firebaseLocalStorageDb",ig=1,Rs="firebaseLocalStorage",Nu="fbase_key";class Ir{constructor(e){this.request=e}toPromise(){return new Promise((e,n)=>{this.request.addEventListener("success",()=>{e(this.request.result)}),this.request.addEventListener("error",()=>{n(this.request.error)})})}}function Us(r,e){return r.transaction([Rs],e?"readwrite":"readonly").objectStore(Rs)}function og(){const r=indexedDB.deleteDatabase(Du);return new Ir(r).toPromise()}function Zi(){const r=indexedDB.open(Du,ig);return new Promise((e,n)=>{r.addEventListener("error",()=>{n(r.error)}),r.addEventListener("upgradeneeded",()=>{const s=r.result;try{s.createObjectStore(Rs,{keyPath:Nu})}catch(i){n(i)}}),r.addEventListener("success",async()=>{const s=r.result;s.objectStoreNames.contains(Rs)?e(s):(s.close(),await og(),e(await Zi()))})})}async function qc(r,e,n){const s=Us(r,!0).put({[Nu]:e,value:n});return new Ir(s).toPromise()}async function ag(r,e){const n=Us(r,!1).get(e),s=await new Ir(n).toPromise();return s===void 0?null:s.value}function Hc(r,e){const n=Us(r,!0).delete(e);return new Ir(n).toPromise()}const cg=800,lg=3;class Ou{constructor(){this.type="LOCAL",this._shouldAllowMigration=!0,this.listeners={},this.localCache={},this.pollTimer=null,this.pendingWrites=0,this.receiver=null,this.sender=null,this.serviceWorkerReceiverAvailable=!1,this.activeServiceWorker=null,this._workerInitializationPromise=this.initializeServiceWorkerMessaging().then(()=>{},()=>{})}async _openDb(){return this.db?this.db:(this.db=await Zi(),this.db)}async _withRetries(e){let n=0;for(;;)try{const s=await this._openDb();return await e(s)}catch(s){if(n++>lg)throw s;this.db&&(this.db.close(),this.db=void 0)}}async initializeServiceWorkerMessaging(){return ku()?this.initializeReceiver():this.initializeSender()}async initializeReceiver(){this.receiver=xs._getInstance(sg()),this.receiver._subscribe("keyChanged",async(e,n)=>({keyProcessed:(await this._poll()).includes(n.key)})),this.receiver._subscribe("ping",async(e,n)=>["keyChanged"])}async initializeSender(){var e,n;if(this.activeServiceWorker=await ng(),!this.activeServiceWorker)return;this.sender=new eg(this.activeServiceWorker);const s=await this.sender._send("ping",{},800);s&&!((e=s[0])===null||e===void 0)&&e.fulfilled&&!((n=s[0])===null||n===void 0)&&n.value.includes("keyChanged")&&(this.serviceWorkerReceiverAvailable=!0)}async notifyServiceWorker(e){if(!(!this.sender||!this.activeServiceWorker||rg()!==this.activeServiceWorker))try{await this.sender._send("keyChanged",{key:e},this.serviceWorkerReceiverAvailable?800:50)}catch{}}async _isAvailable(){try{if(!indexedDB)return!1;const e=await Zi();return await qc(e,As,"1"),await Hc(e,As),!0}catch{}return!1}async _withPendingWrite(e){this.pendingWrites++;try{await e()}finally{this.pendingWrites--}}async _set(e,n){return this._withPendingWrite(async()=>(await this._withRetries(s=>qc(s,e,n)),this.localCache[e]=n,this.notifyServiceWorker(e)))}async _get(e){const n=await this._withRetries(s=>ag(s,e));return this.localCache[e]=n,n}async _remove(e){return this._withPendingWrite(async()=>(await this._withRetries(n=>Hc(n,e)),delete this.localCache[e],this.notifyServiceWorker(e)))}async _poll(){const e=await this._withRetries(i=>{const o=Us(i,!1).getAll();return new Ir(o).toPromise()});if(!e)return[];if(this.pendingWrites!==0)return[];const n=[],s=new Set;if(e.length!==0)for(const{fbase_key:i,value:o}of e)s.add(i),JSON.stringify(this.localCache[i])!==JSON.stringify(o)&&(this.notifyListeners(i,o),n.push(i));for(const i of Object.keys(this.localCache))this.localCache[i]&&!s.has(i)&&(this.notifyListeners(i,null),n.push(i));return n}notifyListeners(e,n){this.localCache[e]=n;const s=this.listeners[e];if(s)for(const i of Array.from(s))i(n)}startPolling(){this.stopPolling(),this.pollTimer=setInterval(async()=>this._poll(),cg)}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}_addListener(e,n){Object.keys(this.listeners).length===0&&this.startPolling(),this.listeners[e]||(this.listeners[e]=new Set,this._get(e)),this.listeners[e].add(n)}_removeListener(e,n){this.listeners[e]&&(this.listeners[e].delete(n),this.listeners[e].size===0&&delete this.listeners[e]),Object.keys(this.listeners).length===0&&this.stopPolling()}}Ou.type="LOCAL";const ug=Ou;new Er(3e4,6e4);/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gg="pendingRedirect",as=new Map;class _g extends Vu{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=as.get(this.auth._key());if(!e){try{const s=await yg(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}as.set(this.auth._key(),e)}return this.bypassAuthState||as.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function yg(r,e){const n=wg(e),s=Eg(r);if(!await s._isAvailable())return!1;const i=await s._get(n)==="true";return await s._remove(n),i}function vg(r,e){as.set(r._key(),e)}function Eg(r){return rt(r._redirectPersistence)}function wg(r){return os(gg,r.config.apiKey,r.name)}async function Tg(r,e,n=!1){if(qe(r.app))return Promise.reject(st(r));const s=kt(r),i=hg(s,e),c=await new _g(s,i,n).execute();return c&&!n&&(delete c.user._redirectEventId,await s._persistUserIfCurrent(c.user),await s._setRedirectUser(null,e)),c}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oo{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=s=>this.ie(s),this.se=s=>n.writeSequenceNumber(s))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}Oo.oe=-1;function Fs(r){return r==null}function bs(r){return r===0&&1/r==-1/0}function I_(r){return typeof r=="number"&&Number.isInteger(r)&&!bs(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le{constructor(e){this.fields=e,e.sort(ge.comparator)}static empty(){return new Le([])}unionWith(e){let n=new _e(ge.comparator);for(const s of this.fields)n=n.add(s);for(const s of e)n=n.add(s);return new Le(n.toArray())}covers(e){for(const n of this.fields)if(n.isPrefixOf(e))return!0;return!1}isEqual(e){return pn(this.fields,e.fields,(n,s)=>n.isEqual(s))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne{constructor(e){this.value=e}static empty(){return new Ne({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let s=0;s<e.length-1;++s)if(n=(n.mapValue.fields||{})[e.get(s)],!us(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=nr(n)}setAll(e){let n=ge.emptyPath(),s={},i=[];e.forEach((c,l)=>{if(!n.isImmediateParentOf(l)){const h=this.getFieldsMap(n);this.applyChanges(h,s,i),s={},i=[],n=l.popLast()}c?s[l.lastSegment()]=nr(c):i.push(l.lastSegment())});const o=this.getFieldsMap(n);this.applyChanges(o,s,i)}delete(e){const n=this.field(e.popLast());us(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return Qe(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let s=0;s<e.length;++s){let i=n.mapValue.fields[e.get(s)];us(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},n.mapValue.fields[e.get(s)]=i),n=i}return n.mapValue.fields}applyChanges(e,n,s){Jt(n,(i,o)=>e[i]=o);for(const i of s)delete e[i]}clone(){return new Ne(nr(this.value))}}function Wu(r){const e=[];return Jt(r.fields,(n,s)=>{const i=new ge([n]);if(us(s)){const o=Wu(s.mapValue).fields;if(o.length===0)e.push(i);else for(const c of o)e.push(i.child(c))}else e.push(i)}),new Le(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(e,n="asc"){this.field=e,this.dir=n}}function S_(r,e){return r.dir===e.dir&&r.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bs{constructor(e,n=null,s=[],i=[],o=null,c="F",l=null,h=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=s,this.filters=i,this.limit=o,this.limitType=c,this.startAt=l,this.endAt=h,this.ce=null,this.le=null,this.he=null,this.startAt,this.endAt}}function U_(r,e,n,s,i,o,c,l){return new Bs(r,e,n,s,i,o,c,l)}function Fo(r){return new Bs(r)}function ll(r){return r.filters.length===0&&r.limit===null&&r.startAt==null&&r.endAt==null&&(r.explicitOrderBy.length===0||r.explicitOrderBy.length===1&&r.explicitOrderBy[0].field.isKeyField())}function F_(r){return r.collectionGroup!==null}function rr(r){const e=$(r);if(e.ce===null){e.ce=[];const n=new Set;for(const o of e.explicitOrderBy)e.ce.push(o),n.add(o.field.canonicalString());const s=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(c){let l=new _e(ge.comparator);return c.filters.forEach(h=>{h.getFlattenedFilters().forEach(f=>{f.isInequality()&&(l=l.add(f.field))})}),l})(e).forEach(o=>{n.has(o.canonicalString())||o.isKeyField()||e.ce.push(new Ss(o,s))}),n.has(ge.keyField().canonicalString())||e.ce.push(new Ss(ge.keyField(),s))}return e.ce}function Ge(r){const e=$(r);return e.le||(e.le=B_(e,rr(r))),e.le}function B_(r,e){if(r.limitType==="F")return cl(r.path,r.collectionGroup,e,r.filters,r.limit,r.startAt,r.endAt);{e=e.map(i=>{const o=i.dir==="desc"?"asc":"desc";return new Ss(i.field,o)});const n=r.endAt?new Ps(r.endAt.position,r.endAt.inclusive):null,s=r.startAt?new Ps(r.startAt.position,r.startAt.inclusive):null;return cl(r.path,r.collectionGroup,e,r.filters,r.limit,n,s)}}function io(r,e,n){return new Bs(r.path,r.collectionGroup,r.explicitOrderBy.slice(),r.filters.slice(),e,n,r.startAt,r.endAt)}function $s(r,e){return Uo(Ge(r),Ge(e))&&r.limitType===e.limitType}function Zu(r){return`${xo(Ge(r))}|lt:${r.limitType}`}function sn(r){return`Query(target=${function(n){let s=n.path.canonicalString();return n.collectionGroup!==null&&(s+=" collectionGroup="+n.collectionGroup),n.filters.length>0&&(s+=`, filters: [${n.filters.map(i=>Ju(i)).join(", ")}]`),Fs(n.limit)||(s+=", limit: "+n.limit),n.orderBy.length>0&&(s+=`, orderBy: [${n.orderBy.map(i=>function(c){return`${c.field.canonicalString()} (${c.dir})`}(i)).join(", ")}]`),n.startAt&&(s+=", startAt: ",s+=n.startAt.inclusive?"b:":"a:",s+=n.startAt.position.map(i=>gn(i)).join(",")),n.endAt&&(s+=", endAt: ",s+=n.endAt.inclusive?"a:":"b:",s+=n.endAt.position.map(i=>gn(i)).join(",")),`Target(${s})`}(Ge(r))}; limitType=${r.limitType})`}function js(r,e){return e.isFoundDocument()&&function(s,i){const o=i.key.path;return s.collectionGroup!==null?i.key.hasCollectionId(s.collectionGroup)&&s.path.isPrefixOf(o):x.isDocumentKey(s.path)?s.path.isEqual(o):s.path.isImmediateParentOf(o)}(r,e)&&function(s,i){for(const o of rr(s))if(!o.field.isKeyField()&&i.data.field(o.field)===null)return!1;return!0}(r,e)&&function(s,i){for(const o of s.filters)if(!o.matches(i))return!1;return!0}(r,e)&&function(s,i){return!(s.startAt&&!function(c,l,h){const f=ol(c,l,h);return c.inclusive?f<=0:f<0}(s.startAt,rr(s),i)||s.endAt&&!function(c,l,h){const f=ol(c,l,h);return c.inclusive?f>=0:f>0}(s.endAt,rr(s),i))}(r,e)}function $_(r){return r.collectionGroup||(r.path.length%2==1?r.path.lastSegment():r.path.get(r.path.length-2))}function eh(r){return(e,n)=>{let s=!1;for(const i of rr(r)){const o=j_(i,e,n);if(o!==0)return o;s=s||i.field.isKeyField()}return 0}}function j_(r,e,n){const s=r.field.isKeyField()?x.comparator(e.key,n.key):function(o,c,l){const h=c.data.field(o),f=l.data.field(o);return h!==null&&f!==null?mn(h,f):F()}(r.field,e,n);switch(r.dir){case"asc":return s;case"desc":return-1*s;default:return F()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bo(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:bs(e)?"-0":e}}function sh(r){return{integerValue:""+r}}function K_(r,e){return I_(e)?sh(e):Bo(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qs{constructor(){this._=void 0}}function Q_(r,e,n){return r instanceof mr?function(i,o){const c={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return o&&Vo(o)&&(o=Lo(o)),o&&(c.fields.__previous_value__=o),{mapValue:c}}(n,e):r instanceof gr?oh(r,e):r instanceof _r?ah(r,e):function(i,o){const c=ih(i,o),l=ul(c)+ul(i.Pe);return no(c)&&no(i.Pe)?sh(l):Bo(i.serializer,l)}(r,e)}function X_(r,e,n){return r instanceof gr?oh(r,e):r instanceof _r?ah(r,e):n}function ih(r,e){return r instanceof Cs?function(s){return no(s)||function(o){return!!o&&"doubleValue"in o}(s)}(e)?e:{integerValue:0}:null}class mr extends qs{}class gr extends qs{constructor(e){super(),this.elements=e}}function oh(r,e){const n=ch(e);for(const s of r.elements)n.some(i=>Qe(i,s))||n.push(s);return{arrayValue:{values:n}}}class _r extends qs{constructor(e){super(),this.elements=e}}function ah(r,e){let n=ch(e);for(const s of r.elements)n=n.filter(i=>!Qe(i,s));return{arrayValue:{values:n}}}class Cs extends qs{constructor(e,n){super(),this.serializer=e,this.Pe=n}}function ul(r){return oe(r.integerValue||r.doubleValue)}function ch(r){return Mo(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J_{constructor(e,n){this.field=e,this.transform=n}}function Y_(r,e){return r.field.isEqual(e.field)&&function(s,i){return s instanceof gr&&i instanceof gr||s instanceof _r&&i instanceof _r?pn(s.elements,i.elements,Qe):s instanceof Cs&&i instanceof Cs?Qe(s.Pe,i.Pe):s instanceof mr&&i instanceof mr}(r.transform,e.transform)}class Z_{constructor(e,n){this.version=e,this.transformResults=n}}class xe{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new xe}static exists(e){return new xe(void 0,e)}static updateTime(e){return new xe(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function hs(r,e){return r.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(r.updateTime):r.exists===void 0||r.exists===e.isFoundDocument()}class Hs{}function lh(r,e){if(!r.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return r.isNoDocument()?new $o(r.key,xe.none()):new br(r.key,r.data,xe.none());{const n=r.data,s=Ne.empty();let i=new _e(ge.comparator);for(let o of e.fields)if(!i.has(o)){let c=n.field(o);c===null&&o.length>1&&(o=o.popLast(),c=n.field(o)),c===null?s.delete(o):s.set(o,c),i=i.add(o)}return new Dt(r.key,s,new Le(i.toArray()),xe.none())}}function ey(r,e,n){r instanceof br?function(i,o,c){const l=i.value.clone(),h=dl(i.fieldTransforms,o,c.transformResults);l.setAll(h),o.convertToFoundDocument(c.version,l).setHasCommittedMutations()}(r,e,n):r instanceof Dt?function(i,o,c){if(!hs(i.precondition,o))return void o.convertToUnknownDocument(c.version);const l=dl(i.fieldTransforms,o,c.transformResults),h=o.data;h.setAll(uh(i)),h.setAll(l),o.convertToFoundDocument(c.version,h).setHasCommittedMutations()}(r,e,n):function(i,o,c){o.convertToNoDocument(c.version).setHasCommittedMutations()}(0,e,n)}function ir(r,e,n,s){return r instanceof br?function(o,c,l,h){if(!hs(o.precondition,c))return l;const f=o.value.clone(),m=fl(o.fieldTransforms,h,c);return f.setAll(m),c.convertToFoundDocument(c.version,f).setHasLocalMutations(),null}(r,e,n,s):r instanceof Dt?function(o,c,l,h){if(!hs(o.precondition,c))return l;const f=fl(o.fieldTransforms,h,c),m=c.data;return m.setAll(uh(o)),m.setAll(f),c.convertToFoundDocument(c.version,m).setHasLocalMutations(),l===null?null:l.unionWith(o.fieldMask.fields).unionWith(o.fieldTransforms.map(v=>v.field))}(r,e,n,s):function(o,c,l){return hs(o.precondition,c)?(c.convertToNoDocument(c.version).setHasLocalMutations(),null):l}(r,e,n)}function ty(r,e){let n=null;for(const s of r.fieldTransforms){const i=e.data.field(s.field),o=ih(s.transform,i||null);o!=null&&(n===null&&(n=Ne.empty()),n.set(s.field,o))}return n||null}function hl(r,e){return r.type===e.type&&!!r.key.isEqual(e.key)&&!!r.precondition.isEqual(e.precondition)&&!!function(s,i){return s===void 0&&i===void 0||!(!s||!i)&&pn(s,i,(o,c)=>Y_(o,c))}(r.fieldTransforms,e.fieldTransforms)&&(r.type===0?r.value.isEqual(e.value):r.type!==1||r.data.isEqual(e.data)&&r.fieldMask.isEqual(e.fieldMask))}class br extends Hs{constructor(e,n,s,i=[]){super(),this.key=e,this.value=n,this.precondition=s,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class Dt extends Hs{constructor(e,n,s,i,o=[]){super(),this.key=e,this.data=n,this.fieldMask=s,this.precondition=i,this.fieldTransforms=o,this.type=1}getFieldMask(){return this.fieldMask}}function uh(r){const e=new Map;return r.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const s=r.data.field(n);e.set(n,s)}}),e}function dl(r,e,n){const s=new Map;J(r.length===n.length);for(let i=0;i<n.length;i++){const o=r[i],c=o.transform,l=e.data.field(o.field);s.set(o.field,X_(c,l,n[i]))}return s}function fl(r,e,n){const s=new Map;for(const i of r){const o=i.transform,c=n.data.field(i.field);s.set(i.field,Q_(o,c,e))}return s}class $o extends Hs{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class ny extends Hs{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(e,n,s,i,o){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,n,s){const i=new Map;return i.set(e,Pr.createSynthesizedTargetChangeForCurrentChange(e,n,s)),new zs(B.min(),i,new ne(X),lt(),W())}}class Pr{constructor(e,n,s,i,o){this.resumeToken=e,this.current=n,this.addedDocuments=s,this.modifiedDocuments=i,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,n,s){return new Pr(s,n,W(),W(),W())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ns=null;function $i(){return ns===null?ns=function(){return 268435456+Math.round(2147483648*Math.random())}():ns++,"0x"+ns.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(r){return new fy(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xs{constructor(e,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new Xs(this.firestore,e,this._query)}}class Oe{constructor(e,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Rt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Oe(this.firestore,e,this._key)}}class Rt extends Xs{constructor(e,n,s){super(e,n,Fo(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Oe(this.firestore,null,new x(e))}withConverter(e){return new Rt(this.firestore,e,this._path)}}function kr(r,e,...n){if(r=ae(r),Wh("collection","path",e),r instanceof Qs){const s=te.fromString(e,...n);return Nl(s),new Rt(r,null,s)}{if(!(r instanceof Oe||r instanceof Rt))throw new M(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=r._path.child(te.fromString(e,...n));return Nl(s),new Rt(r.firestore,null,s)}}function De(r,e,...n){if(r=ae(r),arguments.length===1&&(e=qu.newId()),Wh("doc","path",e),r instanceof Qs){const s=te.fromString(e,...n);return Dl(s),new Oe(r,null,new x(s))}{if(!(r instanceof Oe||r instanceof Rt))throw new M(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=r._path.child(te.fromString(e,...n));return Dl(s),new Oe(r.firestore,r instanceof Rt?r.converter:null,new x(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new M(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ge(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xv=/^__.*__$/;class Jv{constructor(e,n,s){this.data=e,this.fieldMask=n,this.fieldTransforms=s}toMutation(e,n){return this.fieldMask!==null?new Dt(e,this.data,this.fieldMask,n,this.fieldTransforms):new br(e,this.data,n,this.fieldTransforms)}}class Gh{constructor(e,n,s){this.data=e,this.fieldMask=n,this.fieldTransforms=s}toMutation(e,n){return new Dt(e,this.data,this.fieldMask,n,this.fieldTransforms)}}function Kh(r){switch(r){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw F()}}class oa{constructor(e,n,s,i,o,c){this.settings=e,this.databaseId=n,this.serializer=s,this.ignoreUndefinedProperties=i,o===void 0&&this.vu(),this.fieldTransforms=o||[],this.fieldMask=c||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new oa(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var n;const s=(n=this.path)===null||n===void 0?void 0:n.child(e),i=this.Fu({path:s,xu:!1});return i.Ou(e),i}Nu(e){var n;const s=(n=this.path)===null||n===void 0?void 0:n.child(e),i=this.Fu({path:s,xu:!1});return i.vu(),i}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return Os(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(Kh(this.Cu)&&Xv.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class Yv{constructor(e,n,s){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=s||Ws(e)}Qu(e,n,s,i=!1){return new oa({Cu:e,methodName:n,qu:s,path:ge.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function aa(r){const e=r._freezeSettings(),n=Ws(r._databaseId);return new Yv(r._databaseId,!!e.ignoreUndefinedProperties,n)}function Qh(r,e,n,s,i,o={}){const c=r.Qu(o.merge||o.mergeFields?2:0,e,n,i);la("Data must be an object, but it was:",c,s);const l=Xh(s,c);let h,f;if(o.merge)h=new Le(c.fieldMask),f=c.fieldTransforms;else if(o.mergeFields){const m=[];for(const v of o.mergeFields){const R=mo(e,v,n);if(!c.contains(R))throw new M(C.INVALID_ARGUMENT,`Field '${R}' is specified in your field mask but missing from your input data.`);Yh(m,R)||m.push(R)}h=new Le(m),f=c.fieldTransforms.filter(v=>h.covers(v.field))}else h=null,f=c.fieldTransforms;return new Jv(new Ne(l),h,f)}class Zs extends Ys{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Zs}}class ca extends Ys{_toFieldTransform(e){return new J_(e.path,new mr)}isEqual(e){return e instanceof ca}}function Zv(r,e,n,s){const i=r.Qu(1,e,n);la("Data must be an object, but it was:",i,s);const o=[],c=Ne.empty();Jt(s,(h,f)=>{const m=ua(e,h,n);f=ae(f);const v=i.Nu(m);if(f instanceof Zs)o.push(m);else{const R=ei(f,v);R!=null&&(o.push(m),c.set(m,R))}});const l=new Le(o);return new Gh(c,l,i.fieldTransforms)}function eE(r,e,n,s,i,o){const c=r.Qu(1,e,n),l=[mo(e,s,n)],h=[i];if(o.length%2!=0)throw new M(C.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let R=0;R<o.length;R+=2)l.push(mo(e,o[R])),h.push(o[R+1]);const f=[],m=Ne.empty();for(let R=l.length-1;R>=0;--R)if(!Yh(f,l[R])){const S=l[R];let N=h[R];N=ae(N);const V=c.Nu(S);if(N instanceof Zs)f.push(S);else{const D=ei(N,V);D!=null&&(f.push(S),m.set(S,D))}}const v=new Le(f);return new Gh(m,v,c.fieldTransforms)}function ei(r,e){if(Jh(r=ae(r)))return la("Unsupported field value:",e,r),Xh(r,e);if(r instanceof Ys)return function(s,i){if(!Kh(i.Cu))throw i.Bu(`${s._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Bu(`${s._methodName}() is not currently supported inside arrays`);const o=s._toFieldTransform(i);o&&i.fieldTransforms.push(o)}(r,e),null;if(r===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),r instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(s,i){const o=[];let c=0;for(const l of s){let h=ei(l,i.Lu(c));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),c++}return{arrayValue:{values:o}}}(r,e)}return function(s,i){if((s=ae(s))===null)return{nullValue:"NULL_VALUE"};if(typeof s=="number")return K_(i.serializer,s);if(typeof s=="boolean")return{booleanValue:s};if(typeof s=="string")return{stringValue:s};if(s instanceof Date){const o=ue.fromDate(s);return{timestampValue:ks(i.serializer,o)}}if(s instanceof ue){const o=new ue(s.seconds,1e3*Math.floor(s.nanoseconds/1e3));return{timestampValue:ks(i.serializer,o)}}if(s instanceof sa)return{geoPointValue:{latitude:s.latitude,longitude:s.longitude}};if(s instanceof vn)return{bytesValue:ph(i.serializer,s._byteString)};if(s instanceof Oe){const o=i.databaseId,c=s.firestore._databaseId;if(!c.isEqual(o))throw i.Bu(`Document reference is for database ${c.projectId}/${c.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:Ho(s.firestore._databaseId||i.databaseId,s._key.path)}}if(s instanceof ia)return function(c,l){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:c.toArray().map(h=>{if(typeof h!="number")throw l.Bu("VectorValues must only contain numeric values.");return Bo(l.serializer,h)})}}}}}}(s,i);throw i.Bu(`Unsupported field value: ${na(s)}`)}(r,e)}function Xh(r,e){const n={};return Hu(r)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Jt(r,(s,i)=>{const o=ei(i,e.Mu(s));o!=null&&(n[s]=o)}),{mapValue:{fields:n}}}function Jh(r){return!(typeof r!="object"||r===null||r instanceof Array||r instanceof Date||r instanceof ue||r instanceof sa||r instanceof vn||r instanceof Oe||r instanceof Ys||r instanceof ia)}function la(r,e,n){if(!Jh(n)||!function(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}(n)){const s=na(n);throw s==="an object"?e.Bu(r+" a custom object"):e.Bu(r+" "+s)}}function mo(r,e,n){if((e=ae(e))instanceof Js)return e._internalPath;if(typeof e=="string")return ua(r,e);throw Os("Field path arguments must be of type string or ",r,!1,void 0,n)}const tE=new RegExp("[~\\*/\\[\\]]");function ua(r,e,n){if(e.search(tE)>=0)throw Os(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,r,!1,void 0,n);try{return new Js(...e.split("."))._internalPath}catch{throw Os(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r,!1,void 0,n)}}function Os(r,e,n,s,i){const o=s&&!s.isEmpty(),c=i!==void 0;let l=`Function ${e}() called with invalid data`;n&&(l+=" (via `toFirestore()`)"),l+=". ";let h="";return(o||c)&&(h+=" (found",o&&(h+=` in field ${s}`),c&&(h+=` in document ${i}`),h+=")"),new M(C.INVALID_ARGUMENT,l+r+h)}function Yh(r,e){return r.some(n=>n.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zn{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class nd extends Zh{constructor(e,n,s,i,o,c){super(e,n,s,i,c),this._firestore=e,this._firestoreImpl=e,this.metadata=o}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new fs(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const s=this._document.data.field(ed("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}}class fs extends nd{data(e={}){return super.data(e)}}class iE{constructor(e,n,s,i){this._firestore=e,this._userDataWriter=n,this._snapshot=i,this.metadata=new Zn(i.hasPendingWrites,i.fromCache),this.query=s}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(s=>{e.call(n,new fs(this._firestore,this._userDataWriter,s.key,s,new Zn(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new M(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(i,o){if(i._snapshot.oldDocs.isEmpty()){let c=0;return i._snapshot.docChanges.map(l=>{const h=new fs(i._firestore,i._userDataWriter,l.doc.key,l.doc,new Zn(i._snapshot.mutatedKeys.has(l.doc.key),i._snapshot.fromCache),i.query.converter);return l.doc,{type:"added",doc:h,oldIndex:-1,newIndex:c++}})}{let c=i._snapshot.oldDocs;return i._snapshot.docChanges.filter(l=>o||l.type!==3).map(l=>{const h=new fs(i._firestore,i._userDataWriter,l.doc.key,l.doc,new Zn(i._snapshot.mutatedKeys.has(l.doc.key),i._snapshot.fromCache),i.query.converter);let f=-1,m=-1;return l.type!==0&&(f=c.indexOf(l.doc.key),c=c.delete(l.doc.key)),l.type!==1&&(c=c.add(l.doc),m=c.indexOf(l.doc.key)),{type:oE(l.type),doc:h,oldIndex:f,newIndex:m}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function oE(r){switch(r){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return F()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(r){r=$e(r,Oe);const e=$e(r.firestore,Zt);return Hv(ra(e),r._key).then(n=>cE(e,r,n))}class rd extends sE{constructor(e){super(),this.firestore=e}convertBytes(e){return new vn(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Oe(this.firestore,null,n)}}function ti(r){r=$e(r,Xs);const e=$e(r.firestore,Zt),n=ra(e),s=new rd(e);return rE(r._query),zv(n,r._query).then(i=>new iE(e,s,r,i))}function ha(r,e,n){r=$e(r,Oe);const s=$e(r.firestore,Zt),i=td(r.converter,e);return si(s,[Qh(aa(s),"setDoc",r._key,i,r.converter!==null,n).toMutation(r._key,xe.none())])}function ni(r,e,n,...s){r=$e(r,Oe);const i=$e(r.firestore,Zt),o=aa(i);let c;return c=typeof(e=ae(e))=="string"||e instanceof Js?eE(o,"updateDoc",r._key,e,n,s):Zv(o,"updateDoc",r._key,e),si(i,[c.toMutation(r._key,xe.exists(!0))])}function ri(r){return si($e(r.firestore,Zt),[new $o(r._key,xe.none())])}function aE(r,e){const n=$e(r.firestore,Zt),s=De(r),i=td(r.converter,e);return si(n,[Qh(aa(r.firestore),"addDoc",s._key,i,r.converter!==null,{}).toMutation(s._key,xe.exists(!1))]).then(()=>s)}function si(r,e){return function(s,i){const o=new it;return s.asyncQueue.enqueueAndForget(async()=>Ov(await qv(s),i,o)),o.promise}(ra(r),e)}function cE(r,e,n){const s=n.docs.get(e._key),i=new rd(r);return new nd(r,i,e._key,s,new Zn(n.hasPendingWrites,n.fromCache),e.converter)}function da(){return new ca("serverTimestamp")}(function(e,n=!0){(function(i){Tn=i})(Xt),qt(new bt("firestore",(s,{instanceIdentifier:i,options:o})=>{const c=s.getProvider("app").getImmediate(),l=new Zt(new u_(s.getProvider("auth-internal")),new p_(s.getProvider("app-check-internal")),function(f,m){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new M(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new fr(f.options.projectId,m)}(c,i),c);return o=Object.assign({useFetchStreams:n},o),l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),He(Zc,"4.7.3",e),He(Zc,"4.7.3","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DE{constructor(e,n,s,i,o,c,l,h,f,m,v,R=!0){this.url_=e,this.method_=n,this.headers_=s,this.body_=i,this.successCodes_=o,this.additionalRetryCodes_=c,this.callback_=l,this.errorCallback_=h,this.timeout_=f,this.progressCallback_=m,this.connectionFactory_=v,this.retry=R,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((S,N)=>{this.resolve_=S,this.reject_=N,this.start_()})}start_(){const e=(s,i)=>{if(i){s(!1,new rs(!1,null,!0));return}const o=this.connectionFactory_();this.pendingConnection_=o;const c=l=>{const h=l.loaded,f=l.lengthComputable?l.total:-1;this.progressCallback_!==null&&this.progressCallback_(h,f)};this.progressCallback_!==null&&o.addUploadProgressListener(c),o.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&o.removeUploadProgressListener(c),this.pendingConnection_=null;const l=o.getErrorCode()===Bt.NO_ERROR,h=o.getStatus();if(!l||kE(h,this.additionalRetryCodes_)&&this.retry){const m=o.getErrorCode()===Bt.ABORT;s(!1,new rs(!1,null,m));return}const f=this.successCodes_.indexOf(h)!==-1;s(!0,new rs(f,o))})},n=(s,i)=>{const o=this.resolve_,c=this.reject_,l=i.connection;if(i.wasSuccessCode)try{const h=this.callback_(l,l.getResponse());SE(h)?o(h):o()}catch(h){c(h)}else if(l!==null){const h=fa();h.serverResponse=l.getErrorText(),this.errorCallback_?c(this.errorCallback_(l,h)):c(h)}else if(i.canceled){const h=this.appDelete_?od():_E();c(h)}else{const h=gE();c(h)}};this.canceled_?n(!1,new rs(!1,null,!0)):this.backoffId_=bE(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&PE(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class rs{constructor(e,n,s){this.wasSuccessCode=e,this.connection=n,this.canceled=!!s}}function NE(r,e){e!==null&&e.length>0&&(r.Authorization="Firebase "+e)}function OE(r,e){r["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function VE(r,e){e&&(r["X-Firebase-GMPID"]=e)}function LE(r,e){e!==null&&(r["X-Firebase-AppCheck"]=e)}function ME(r,e,n,s,i,o,c=!0){const l=ad(r.urlParams),h=r.url+l,f=Object.assign({},r.headers);return VE(f,e),NE(f,n),OE(f,o),LE(f,s),new DE(h,r.method,f,r.body,r.successCodes,r.additionalRetryCodes,r.handler,r.errorHandler,r.timeout,r.progressCallback,i,c)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class zi{constructor(e,n){this.data=e,this.contentType=n||null}}function cd(r,e){switch(r){case Fe.RAW:return new zi(ld(e));case Fe.BASE64:case Fe.BASE64URL:return new zi(ud(r,e));case Fe.DATA_URL:return new zi(jE(e),qE(e))}throw fa()}function ld(r){const e=[];for(let n=0;n<r.length;n++){let s=r.charCodeAt(n);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<r.length-1&&(r.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const o=s,c=r.charCodeAt(++n);s=65536|(o&1023)<<10|c&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function $E(r){let e;try{e=decodeURIComponent(r)}catch{throw or(Fe.DATA_URL,"Malformed data URL.")}return ld(e)}function ud(r,e){switch(r){case Fe.BASE64:{const i=e.indexOf("-")!==-1,o=e.indexOf("_")!==-1;if(i||o)throw or(r,"Invalid character '"+(i?"-":"_")+"' found: is it base64url encoded?");break}case Fe.BASE64URL:{const i=e.indexOf("+")!==-1,o=e.indexOf("/")!==-1;if(i||o)throw or(r,"Invalid character '"+(i?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=BE(e)}catch(i){throw i.message.includes("polyfill")?i:or(r,"Invalid character found")}const s=new Uint8Array(n.length);for(let i=0;i<n.length;i++)s[i]=n.charCodeAt(i);return s}class hd{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw or(Fe.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=HE(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function jE(r){const e=new hd(r);return e.base64?ud(Fe.BASE64,e.rest):$E(e.rest)}function qE(r){return new hd(r).contentType}function HE(r,e){return r.length>=e.length?r.substring(r.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e,n){this._service=e,n instanceof Me?this._location=n:this._location=Me.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new Qt(e,n)}get root(){const e=new Me(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return fd(this._location.path)}get storage(){return this._service}get parent(){const e=zE(this._location.path);if(e===null)return null;const n=new Me(this._location.bucket,e);return new Qt(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw AE(e)}}function cw(r,e,n){r._throwIfRoot("uploadBytes");const s=iw(r.storage,r._location,pd(),new wt(e,!0),n);return r.storage.makeRequestWithTokens(s,vd).then(i=>({metadata:i,ref:r}))}function lw(r,e,n=Fe.RAW,s){r._throwIfRoot("uploadString");const i=cd(n,e),o=Object.assign({},s);return o.contentType==null&&i.contentType!=null&&(o.contentType=i.contentType),cw(r,i.data,o)}function uw(r){r._throwIfRoot("getDownloadURL");const e=nw(r.storage,r._location,pd());return r.storage.makeRequestWithTokens(e,vd).then(n=>{if(n===null)throw TE();return n})}function hw(r,e){const n=WE(r._location.path,e),s=new Me(r._location.bucket,n);return new Qt(r.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wd="storage";function gw(r,e,n,s){return r=ae(r),lw(r,e,n,s)}function _w(r){return r=ae(r),uw(r)}function yw(r,e){return r=ae(r),pw(r,e)}function vw(r=To(),e){r=ae(r);const s=Ls(r,wd).getImmediate({identifier:e}),i=Gl("storage");return i&&Ew(s,...i),s}function Ew(r,e,n,s={}){mw(r,e,n,s)}function ww(r,{instanceIdentifier:e}){const n=r.getProvider("app").getImmediate(),s=r.getProvider("auth-internal"),i=r.getProvider("app-check-internal");return new _a(n,s,i,e,Xt)}function Tw(){qt(new bt(wd,ww,"PUBLIC").setMultipleInstances(!0)),He(Ul,Fl,""),He(Ul,Fl,"esm2017")}Tw();const Iw={apiKey:"AIzaSyD6jfZeueaQfBhlI5Mz6766c3k--gCwIjc",authDomain:"archery-app-70e20.firebaseapp.com",projectId:"archery-app-70e20",storageBucket:"archery-app-70e20.firebasestorage.app",messagingSenderId:"1025324581093",appId:"1:1025324581093:web:03b41dbee9cc81c6eb540c"},ya=Zl(Iw),Dr=o_(ya),he=Kv(ya),Aw=vw(ya),Td="archery_v5",Rw="archery_v4";function Bl(){try{const r=JSON.parse(localStorage.getItem(Td)||"null");if(r)return r;const e=JSON.parse(localStorage.getItem(Rw)||"{}");return{friends:e.friends||[],rounds:e.rounds||[],courses:e.courses||[]}}catch{return{friends:[],rounds:[],courses:[]}}}function Rn(){try{localStorage.setItem(Td,JSON.stringify({friends:w.friends,rounds:w.rounds.slice(0,200),courses:w.courses}))}catch{}}const bw=[11,10,8,5,"M"];function ii(r){return r==="M"||r==null?0:Number(r)}function Id(r){return r?r.split(";").map(e=>e.split(",").map(n=>n==="M"?"M":Number(n))):[]}function Pw(r){return r.map(e=>e.map(n=>n??"M").join(",")).join(";")}function ke(r){return r.flat().reduce((e,n)=>e+ii(n),0)}function Sw(r,e){const n=r.flatMap(s=>(s.scores[e]||[]).filter(i=>i!=null).map(ii));return n.length?(n.reduce((s,i)=>s+i,0)/n.length).toFixed(1):null}function Cw(r){const e={11:0,10:0,8:0,5:0,M:0};return r.flat().forEach(n=>{n==="M"?e.M++:n!=null&&e[Number(n)]!==void 0&&e[Number(n)]++}),e}function Nr(r){return r.length?r.reduce((e,n)=>ke(n.scores)>ke(e.scores)?n:e,r[0]):null}function kw(r,e){const n=r.flat().filter(s=>s!=null);return n.length?n.reduce((s,i)=>s+ii(i),0)/n.length<e:!1}function Dw(r,e,n){return{id:r,name:e,isGuest:!!n,scores:[]}}function Nw(r,e){for(;r.scores.length<e;)r.scores.push([null,null])}function Ow(r,e){let n=0;for(let s=0;s<e;s++)r.every(i=>{const o=i.scores[s]||[null,null];return o[0]!=null&&o[1]!=null})&&n++;return n}function Ad(r){return{name:r.name,courseId:r.courseId||null,courseName:r.courseName||null,numTargets:r.numTargets,startTarget:r.startTarget||1,created:r.created,completed:r.completed||null,gpsRoute:r.gpsRoute||null,gpsDuration:r.gpsDuration||null,gpsDistance:r.gpsDistance||null,traversalOrder:r.traversalOrder,traversalPos:r.traversalPos||0,shooters:r.shooters.map(e=>({id:e.id,name:e.name,isGuest:e.isGuest||!1,scores:Pw(e.scores)}))}}function Vw(r){return{...r,shooters:(r.shooters||[]).map(e=>({...e,scores:Id(e.scores)}))}}let ps=null,ms=!1,$t=!1,_o=[],ar=null,er=0,je=null,yo=null,Gn=null;function Lw(r){return r?r.split(";").map(e=>{const[n,s]=e.split(",").map(Number);return{lat:n,lng:s}}):[]}function Rd(r,e){const s=(e.lat-r.lat)*Math.PI/180,i=(e.lng-r.lng)*Math.PI/180,o=Math.sin(s/2)**2+Math.cos(r.lat*Math.PI/180)*Math.cos(e.lat*Math.PI/180)*Math.sin(i/2)**2;return 6371e3*2*Math.atan2(Math.sqrt(o),Math.sqrt(1-o))}function Mw(r){return`${Math.floor(r/60).toString().padStart(2,"0")}:${(r%60).toString().padStart(2,"0")}`}function xw(r){return r<1e3?`${Math.round(r)} m`:`${(r/1e3).toFixed(2)} km`}function Uw(r){return navigator.geolocation?(Gn=r,_o=[],er=0,je=null,ar=Date.now(),$t=!1,ms=!0,ps=navigator.geolocation.watchPosition(e=>{if(!ms||$t)return;const n={lat:e.coords.latitude,lng:e.coords.longitude};je&&(er+=Rd(je,n)),je=n,_o.push(n),Gn&&Gn({lat:n.lat,lng:n.lng,distance:er,elapsed:Math.round((Date.now()-ar)/1e3)})},e=>console.warn(e),{enableHighAccuracy:!0,maximumAge:5e3,timeout:1e4}),yo=setInterval(()=>{ms&&!$t&&Gn&&Gn({lat:je==null?void 0:je.lat,lng:je==null?void 0:je.lng,distance:er,elapsed:Math.round((Date.now()-ar)/1e3)})},1e3),!0):!1}window.toggleGpsPause=function(){return $t=!$t,$t};function bd(){return ms=!1,$t=!1,ps!==null&&(navigator.geolocation.clearWatch(ps),ps=null),clearInterval(yo),yo=null,{route:_o.map(r=>`${r.lat},${r.lng}`).join(";"),distance:Math.round(er),duration:ar?Math.round((Date.now()-ar)/1e3):0}}function va(){return new Promise((r,e)=>{if(!navigator.geolocation){e(new Error("GPS ikke understøttet"));return}navigator.geolocation.getCurrentPosition(n=>r({lat:n.coords.latitude,lng:n.coords.longitude}),e,{enableHighAccuracy:!0,timeout:1e4})})}function Fw(r,e){if(!(r!=null&&r.length)||!e)return 0;let n=1/0,s=0;return r.forEach((i,o)=>{if(!i.gps||i.GPS)return;const c=Rd(e,i.gps||i.GPS);c<n&&(n=c,s=o)}),s}const w={user:null,profile:null,isAdmin:!1,friends:[],courses:[],rounds:[],round:null,course:null,currentCourse:null,courseMap:null,courseMapLayer:null,gpsTracking:!1,warnThreshold:8,deleteConfirm:{},editFriendId:null,finishTap:0,abortTap:0};let gs=null;async function Bw(){try{"wakeLock"in navigator&&(gs=await navigator.wakeLock.request("screen"))}catch{}}function Ea(){gs&&(gs.release(),gs=null)}function jt(r,e="error"){const n=document.getElementById("auth-err");n.textContent=r,n.style.color=e==="ok"?"var(--success)":"",n.classList.remove("hidden")}window.showAuthTab=function(r){document.querySelectorAll(".auth-tab").forEach((e,n)=>e.classList.toggle("active",n===0==(r==="login"))),document.getElementById("login-form").classList.toggle("hidden",r!=="login"),document.getElementById("signup-form").classList.toggle("hidden",r!=="signup"),document.getElementById("auth-err").classList.add("hidden")};window.doLogin=async function(){const r=document.getElementById("login-email").value.trim(),e=document.getElementById("login-password").value;if(!r||!e){jt("Udfyld alle felter.");return}const n=document.querySelector("#login-form .btn");n.disabled=!0,n.textContent="...";try{await zm(Dr,r,e)}catch(s){jt(s.code==="auth/invalid-credential"?"Ugyldig email eller kodeord.":"Der opstod en fejl: "+s.code)}finally{n.disabled=!1,n.textContent="LOG IND"}};window.doSignup=async function(){const r=document.getElementById("signup-name").value.trim(),e=document.getElementById("signup-email").value.trim(),n=document.getElementById("signup-password").value;if(!r||!e||!n){jt("Udfyld alle felter.");return}const s=document.querySelector("#signup-form .btn");s.disabled=!0,s.textContent="...";try{const i=await Hm(Dr,e,n);await ha(De(he,"users",i.user.uid),{name:r,email:e,yam:r,"e-mail":e,created:da()})}catch(i){jt("Fejl: "+i.code)}finally{s.disabled=!1,s.textContent="OPRET KONTO"}};window.doForgot=async function(){const r=document.getElementById("login-email").value.trim();if(!r){jt("Indtast din email først.");return}try{await qm(Dr,r),jt("Nulstillingsmail sendt!","ok")}catch(e){jt("Fejl: "+e.code)}};window.doLogout=async function(){try{await Qm(Dr)}catch{}};document.addEventListener("DOMContentLoaded",()=>{var e,n,s;Km(Dr,async i=>{var o;if(i){w.user=i;let c,l;for(let h=0;h<3;h++)try{console.log("Henter profil for uid:",i.uid),[c,l]=await Promise.all([En(De(he,"users",i.uid)),En(De(he,"admins",i.uid))]),console.log("Profil:",c.exists(),(o=c.data)==null?void 0:o.call(c));break}catch(f){console.error("Profil fejl attempt",h,f.code,f.message),h<2?await new Promise(m=>setTimeout(m,2e3*(h+1))):(w.profile={name:i.email,email:i.email},w.isAdmin=!1)}if(c!=null&&c.exists()){const h=c.data();w.profile={name:h.name||h.yam||i.email,email:h.email||h["e-mail"]||i.email}}else w.profile||(w.profile={name:i.email,email:i.email});w.isAdmin=(l==null?void 0:l.exists())||!1,$w()}else jw()});let r=null;window.addEventListener("beforeinstallprompt",i=>{i.preventDefault(),r=i,document.getElementById("pwa-banner").style.display="flex"}),(e=document.getElementById("pwa-install-btn"))==null||e.addEventListener("click",async()=>{r&&(r.prompt(),await r.userChoice,r=null,document.getElementById("pwa-banner").style.display="none")}),(n=document.getElementById("pwa-dismiss-btn"))==null||n.addEventListener("click",()=>{document.getElementById("pwa-banner").style.display="none"}),vo(24),document.getElementById("target-count").addEventListener("change",i=>vo(Number(i.target.value))),(s=document.getElementById("photo-input"))==null||s.addEventListener("change",async i=>{var c;const o=i.target.files[0];if(o)try{const l=await Yw(o),h=bn(),f=yw(Aw,`courses/${w.round.courseId}/target_${h}.jpg`);await gw(f,l,"base64",{contentType:"image/jpeg"});const m=await _w(f);await Ta(w.round.courseId,h,{imageUrl:m}),(c=w.course)!=null&&c.targets&&(w.course.targets[h].imageUrl=m),Nt()}catch(l){alert("Upload fejl: "+l.message)}}),document.querySelectorAll(".modal").forEach(i=>{i.addEventListener("click",o=>{o.target===i&&i.classList.add("hidden")})})});function $w(){var n;document.getElementById("hdr-name").textContent=w.profile.name,document.getElementById("auth-screen").classList.remove("active"),document.getElementById("app-screen").classList.add("active"),document.getElementById("admin-badge").classList.toggle("hidden",!w.isAdmin),document.querySelectorAll(".admin-only").forEach(s=>s.classList.toggle("hidden",!w.isAdmin));const r=Bl();w.friends=r.friends||[],w.rounds=r.rounds||[],ci(),oi(),wa();const e=Bl().courses||[];w.courses=e,jl(),$l(),console.log("Henter baner, user uid:",(n=w.user)==null?void 0:n.uid),ti(kr(he,"courses")).then(s=>{console.log("Baner hentet:",s.docs.length,s.docs.map(o=>o.id));const i=s.docs.map(o=>{const c=o.data();return{id:o.id,name:c.name||c.yam||c.id||"—",numTargets:c.numTargets||c.antalMål||24,location:c.location||c.beliggenhed||"",targets:c.targets||c.mal||c.mål||[],visits:c.visits||c.besøg||[]}});i.length&&(w.courses=i,Rn(),jl(),$l())}).catch(s=>console.warn("courses:",s)),zw()}function jw(){w.user=null,w.profile=null,w.round=null,Ea(),document.getElementById("app-screen").classList.remove("active"),document.getElementById("auth-screen").classList.add("active")}window.toggleLang=function(){window.appLang=window.appLang==="da"?"en":"da",document.getElementById("lang-btn").textContent=window.appLang.toUpperCase()};window.switchTab=function(r){var n;document.querySelectorAll(".tab").forEach(s=>s.classList.remove("active")),document.querySelectorAll(".nav-btn").forEach(s=>s.classList.remove("active"));const e=document.getElementById(`tab-${r}`);e&&(e.classList.add("active"),e.classList.remove("hidden")),(n=document.querySelector(`.nav-btn[data-tab="${r}"]`))==null||n.classList.add("active"),r==="friends"&&Zw(),r==="courses"&&w.courseMap&&setTimeout(()=>w.courseMap.invalidateSize(),100)};function $l(){const r=document.getElementById("course-sel"),e=r.value;r.innerHTML='<option value="">-- Ingen bane --</option>',w.courses.forEach(s=>{const i=document.createElement("option");i.value=s.id,i.textContent=`${s.name} (${s.numTargets} mål)`,r.appendChild(i)}),e&&(r.value=e),r.onchange=()=>{const s=w.courses.find(o=>o.id===r.value),i=document.getElementById("target-count");s?(i.value=s.numTargets,i.disabled=!0):i.disabled=!1,vo(s?s.numTargets:Number(i.value))},w.courses.find(s=>s.id===r.value)&&(document.getElementById("target-count").disabled=!0)}function vo(r){const e=document.getElementById("start-target");e.innerHTML="";for(let n=1;n<=r;n++){const s=document.createElement("option");s.value=n,s.textContent=n,e.appendChild(s)}}window.addParticipant=function(r,e){if(document.getElementById(`chip-${r}`))return;const n=document.createElement("div");n.className="pchip",n.id=`chip-${r}`,n.innerHTML=`<span class="pchip-name">🎯 ${e}</span><button class="pchip-rm" onclick="this.closest('.pchip').remove()">✕</button>`,document.getElementById("p-list").appendChild(n)};function qw(){return Array.from(document.querySelectorAll(".pchip")).map(r=>({id:r.id.replace("chip-",""),name:r.querySelector(".pchip-name").textContent.replace("🎯 ","").trim(),isGuest:r.id.startsWith("chip-guest-")}))}function oi(){const r=document.getElementById("qfriends");r.innerHTML="",w.friends.forEach(e=>{const n=document.createElement("button");n.className="qfbtn",n.textContent=e.name,n.onclick=()=>window.addParticipant(e.id,e.name),r.appendChild(n)})}window.searchFriends=async function(r){const e=document.getElementById("ac-list");if(!r.trim()){e.classList.add("hidden");return}const n=w.friends.filter(o=>o.name.toLowerCase().includes(r.toLowerCase()));let s=[];try{s=(await ti(kr(he,"users"))).docs.map(c=>({id:c.id,...c.data()})).filter(c=>{var l;return(c.name||c.yam||"").toLowerCase().includes(r.toLowerCase())&&c.id!==((l=w.user)==null?void 0:l.uid)&&!n.find(h=>h.id===c.id)}).map(c=>({id:c.id,name:c.name||c.yam||c.email||c["e-mail"]||"—",email:c.email||c["e-mail"]||""}))}catch(o){console.warn(o)}const i=[...n,...s];if(!i.length){e.classList.add("hidden");return}e.innerHTML=i.map(o=>`<div class="ac-item" onclick="selectFriend('${o.id}','${(o.name||"").replace(/'/g,"\\'")}','${(o.email||"").replace(/'/g,"\\'")}');document.getElementById('friend-search').value='';document.getElementById('ac-list').classList.add('hidden');">${o.name}${o.email?' <span style="font-size:11px;opacity:.6">${f.email}</span>':""}</div>`).join(""),e.classList.remove("hidden")};window.selectFriend=function(r,e,n){w.friends.find(s=>s.id===r)||(w.friends.push({id:r,name:e,email:n}),Rn(),ci(),oi()),window.addParticipant(r,e)};window.startRound=async function(){var f,m;const r=document.getElementById("round-name").value.trim()||"Min Skydning",e=document.getElementById("course-sel").value,n=Number(document.getElementById("target-count").value)||24,s=Number(document.getElementById("start-target").value)-1,i=document.getElementById("gps-auto-sw").classList.contains("on"),o=document.getElementById("gps-track-sw").classList.contains("on");w.warnThreshold=Number(document.getElementById("warn-thresh").value)||8;const c=[{id:w.user.uid,name:w.profile.name,isGuest:!1},...qw().filter(v=>v.id!==w.user.uid)];w.course=e&&w.courses.find(v=>v.id===e)||null;const l=c.map(v=>{const R=Dw(v.id,v.name,v.isGuest);return Nw(R,n),R});let h=s;if(i&&((f=w.course)!=null&&f.targets))try{h=Fw(w.course.targets,await va())}catch{}w.round={name:r,courseId:e||null,courseName:((m=w.course)==null?void 0:m.name)||null,numTargets:n,startTarget:h+1,shooters:l,created:Date.now(),traversalOrder:Pd(h,n),traversalPos:0},o&&(w.gpsTracking=Uw(Hw),document.getElementById("gps-bar").classList.toggle("hidden",!w.gpsTracking),Bw()),showActivePanel(),Pn(),Nt(),ai()};function Pd(r,e){return Array.from({length:e},(n,s)=>(r+s)%e)}function bn(){return w.round.traversalOrder[w.round.traversalPos]}window.showSetupPanel=function(){document.getElementById("setup-panel").classList.remove("hidden"),document.getElementById("active-panel").classList.add("hidden"),document.getElementById("results-panel").classList.add("hidden")};window.showActivePanel=function(){document.getElementById("setup-panel").classList.add("hidden"),document.getElementById("active-panel").classList.remove("hidden"),document.getElementById("results-panel").classList.add("hidden")};window.showResultsPanel=function(){document.getElementById("setup-panel").classList.add("hidden"),document.getElementById("active-panel").classList.add("hidden"),document.getElementById("results-panel").classList.remove("hidden")};function Nt(){var h,f;if(!w.round)return;const r=bn(),e=w.round.numTargets;document.getElementById("tnum-big").textContent=r+1,document.getElementById("tnum-suf").textContent=" af "+e,document.getElementById("round-badge").textContent=w.round.name;const n=(f=(h=w.course)==null?void 0:h.targets)==null?void 0:f[r];document.getElementById("anim-name").textContent=(n==null?void 0:n.name)||`Mål ${r+1}`;const s=Ow(w.round.shooters,e);document.getElementById("pbar").style.width=`${s/e*100}%`;const i=w.round.shooters.flatMap(m=>m.scores.flat().filter(v=>v!=null)),o=i.reduce((m,v)=>m+ii(v),0);document.getElementById("stat-avg").textContent=i.length?(o/i.length).toFixed(1):"—",document.getElementById("stat-tot").textContent=o,document.getElementById("stat-rem").textContent=e-s;const c=document.getElementById("anim-img");n!=null&&n.imageUrl||n!=null&&n.photo?(c.src=n.imageUrl||n.photo||n.photo||t.photo,c.classList.remove("hidden")):c.classList.add("hidden"),document.getElementById("edit-target-btn").classList.toggle("hidden",!(w.isAdmin&&w.round.courseId)),document.getElementById("next-btn").textContent=w.round.traversalPos===e-1?"AFSLUT →":"NÆSTE →";const l=Sw(w.round.shooters,r);document.getElementById("target-avg").textContent=l!==null?`Gns. dette mål: ${l}`:""}function Pn(){if(!w.round)return;const r=bn(),e=document.getElementById("shooters-list");e.innerHTML="",w.round.shooters.forEach((n,s)=>{const i=ke(n.scores),o=kw(n.scores,w.warnThreshold),c=n.scores[r]||[null,null],l=document.createElement("div");l.className="shooter-card",l.innerHTML=`
      ...
      </div>`,e.appendChild(l)})}window.setScore=function(r,e,n,s){const i=s==="M"?"M":Number(s);w.round.shooters[r].scores[e][n]=i,ai(),Pn(),Nt()};function Hw({lat:r,lng:e,distance:n,elapsed:s}){document.getElementById("gps-time").textContent=Mw(s),document.getElementById("gps-dist").textContent=xw(n),r&&e&&(document.getElementById("gps-coord").textContent=`${r.toFixed(5)}, ${e.toFixed(5)}`)}async function ai(){if(!(!w.round||!w.user))try{await ha(De(he,"users",w.user.uid,"active","round"),Ad(w.round))}catch(r){console.warn(r)}}async function zw(){var r;try{const e=await En(De(he,"users",w.user.uid,"active","round"));if(!e.exists())return;const n=e.data();if(Date.now()-((r=n.created)!=null&&r.toMillis?n.created.toMillis():n.created||0)>24*60*60*1e3){await ri(De(he,"users",w.user.uid,"active","round"));return}confirm("Genoptag den igangværende runde?")&&(w.round=Vw(n),w.round.traversalOrder=n.traversalOrder||Pd(0,w.round.numTargets),w.round.traversalPos=n.traversalPos||0,w.round.courseId&&(w.course=w.courses.find(i=>i.id===w.round.courseId)||null),showActivePanel(),Pn(),Nt())}catch(e){console.warn(e)}}window.prevTarget=function(){!w.round||w.round.traversalPos<=0||(w.round.traversalPos--,ai(),Pn(),Nt(),document.getElementById("scroll-area").scrollTop=0)};window.nextTarget=function(){w.round&&(w.round.traversalPos<w.round.numTargets-1?(w.round.traversalPos++,ai(),Pn(),Nt(),document.getElementById("scroll-area").scrollTop=0):window.finishRound())};window.skipToTarget=function(){w.round&&(document.getElementById("skip-input").max=w.round.numTargets,document.getElementById("skip-modal").classList.remove("hidden"))};window.doSkip=function(){const r=Number(document.getElementById("skip-input").value);if(!w.round||r<1||r>w.round.numTargets)return;const e=w.round.traversalOrder.indexOf(r-1);e!==-1&&(w.round.traversalPos=e),document.getElementById("skip-modal").classList.add("hidden"),Pn(),Nt()};window.finishRound=async function(){w.finishTap++;const r=document.getElementById("finish-btn");if(w.finishTap===1){r.textContent="✓ BEKRÆFT",setTimeout(()=>{w.finishTap=0,r.textContent="✓ AFSLUT NU"},3e3);return}w.finishTap=0,r.textContent="✓ AFSLUT NU";let e={};w.gpsTracking&&(e=bd(),w.gpsTracking=!1),Ea();const n="r_"+Date.now(),s={...Ad(w.round),completed:Date.now(),...e,id:n};if(w.rounds.unshift({...s,created:{toDate:()=>new Date,toMillis:()=>Date.now()}}),Rn(),wa(),w.round.courseId){const o=Nr(w.round.shooters);Jw(w.round.courseId,{roundId:n,date:new Date().toLocaleDateString("da-DK"),participants:w.round.shooters.map(c=>c.name),winner:o==null?void 0:o.name,winnerScore:o?ke(o.scores):0,gpsRoute:e.route||null,gpsDuration:e.duration||null,gpsDistance:e.distance||null}).catch(console.warn)}ri(De(he,"users",w.user.uid,"active","round")).catch(()=>{});const i=w.round;w.round=null,Ww(i),showResultsPanel()};window.abortRound=async function(){w.abortTap++;const r=document.getElementById("abort-btn");if(w.abortTap===1){r.textContent="🗑 BEKRÆFT",setTimeout(()=>{w.abortTap=0,r.textContent="🗑 AFBRYD"},3e3);return}w.abortTap=0,r.textContent="🗑 AFBRYD",w.gpsTracking&&(bd(),w.gpsTracking=!1),Ea(),ri(De(he,"users",w.user.uid,"active","round")).catch(()=>{}),w.round=null,showSetupPanel()};function Ww(r){const e=Nr(r.shooters);document.getElementById("win-wrap").innerHTML=`<div class="win-trophy">🏆</div><div class="win-name">${(e==null?void 0:e.name)||"—"}</div><div class="win-score">${e?ke(e.scores):0} point</div>`,document.getElementById("res-table").innerHTML=Sd(r),document.getElementById("res-dist").innerHTML=Cd(r)}function Sd(r){let e=`<div class="tbl-wrap"><table class="rtbl"><tr><th>Mål</th>${r.shooters.map(n=>`<th>${n.name}</th>`).join("")}</tr>`;for(let n=0;n<r.numTargets;n++)e+=`<tr><td class="tc">${n+1}</td>`,r.shooters.forEach(s=>{const i=s.scores[n]||[null,null],o=(i[0]!=null&&i[0]!=="M"?Number(i[0]):0)+(i[1]!=null&&i[1]!=="M"?Number(i[1]):0);e+=`<td>${i.map(c=>c??"—").join("/")}<br><small>${o}</small></td>`}),e+="</tr>";return e+=`<tr class="tr-tot"><td class="tc">Total</td>${r.shooters.map(n=>`<td>${ke(n.scores)}</td>`).join("")}</tr></table></div>`,e}function Cd(r){return'<div class="dist-grid">'+r.shooters.map(e=>{const n=Cw(e.scores);return`<div class="dist-card"><div class="dist-name">${e.name}</div>${Object.entries(n).map(([s,i])=>`<div class="dist-row"><span>${s}</span><span>${i}x</span></div>`).join("")}</div>`}).join("")+"</div>"}function wa(){const r=document.getElementById("rounds-list");if(!w.rounds.length){r.innerHTML='<div class="empty"><div class="empty-icon">📊</div>Ingen runder endnu</div>';return}r.innerHTML="",w.rounds.forEach(e=>{var c;const n=(e.shooters||[]).map(l=>({...l,scores:Id(l.scores)})),s=n.length?Nr(n):null,i=(c=e.created)!=null&&c.toDate?e.created.toDate().toLocaleDateString("da-DK"):e.created?new Date(e.created).toLocaleDateString("da-DK"):"—",o=document.createElement("div");o.className="rcard",o.innerHTML=`<div class="rcard-info"><div class="rcard-name">${e.name||"Runde"}</div><div class="rcard-meta">${i} · ${e.courseName||e.numTargets+" mål"}</div><div class="rcard-win">🏆 ${(s==null?void 0:s.name)||"—"} (${s?ke(s.scores):0} pt)</div></div><button class="del-btn" data-id="${e.id}">✕</button>`,o.querySelector(".rcard-info").onclick=()=>Gw({...e,shooters:n}),o.querySelector(".del-btn").onclick=l=>{const h=l.currentTarget,f=`r-${e.id}`;w.deleteConfirm[f]?(delete w.deleteConfirm[f],w.rounds=w.rounds.filter(m=>m.id!==e.id),Rn(),wa()):(w.deleteConfirm[f]=!0,h.classList.add("conf"),h.textContent="Slet?",setTimeout(()=>{delete w.deleteConfirm[f],h.classList.remove("conf"),h.textContent="✕"},3e3))},r.appendChild(o)})}function Gw(r){window._lastRound=r;let e=document.getElementById("round-popup");e||(e=document.createElement("div"),e.id="round-popup",e.className="rpop",e.innerHTML=`<div class="rpop-box"><button class="rpop-close" onclick="this.closest('.rpop').classList.add('hidden')">✕</button><div id="rpop-body"></div></div>`,document.body.appendChild(e)),e.classList.remove("hidden"),document.getElementById("rpop-body").innerHTML=`<h3 style="font-family:var(--fd);color:var(--acc);margin-bottom:12px;">${r.name}</h3>`+Sd(r)+Cd(r)+'<button class="btn btn-gold" style="width:100%;margin-top:12px;" onclick="window.sendResults(window._lastRound)">📧 Send resultater</button>'}function jl(){const r=document.getElementById("courses-list");if(!w.courses.length){r.innerHTML='<div class="empty"><div class="empty-icon">🗺️</div>Ingen baner endnu</div>';return}r.innerHTML="",w.courses.forEach(e=>{const n=document.createElement("div");n.className="ccard",n.innerHTML=`<div class="ccard-name">${e.name}</div><div class="ccard-meta">${e.numTargets} mål · ${e.location||"—"}</div>`,n.onclick=()=>Kw(e),r.appendChild(n)})}function Kw(r){w.currentCourse=r,document.getElementById("courses-list-view").classList.add("hidden"),document.getElementById("course-detail-view").classList.remove("hidden"),document.getElementById("course-detail-title").textContent=r.name,window.switchSubtab("map"),Qw(r),kd(r),Xw(r)}function Qw(r){const e=document.getElementById("course-map");w.courseMap&&(w.courseMap.remove(),w.courseMap=null),w.courseMap=window.L.map(e),window.L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:"Esri",maxZoom:19}).addTo(w.courseMap);const n=[];(r.targets||[]).forEach((s,i)=>{!s.gps||s.GPS||(n.push([s.gps||s.GPS.lat,s.gps||s.GPS.lng]),window.L.marker([s.gps||s.GPS.lat,s.gps||s.GPS.lng],{icon:window.L.divIcon({className:"",html:`<div style="background:#e8a020;color:#000;border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;border:2px solid #fff;">${i+1}</div>`,iconSize:[28,28],iconAnchor:[14,14]})}).addTo(w.courseMap).bindPopup(`<b>${i+1}. ${s.name||"Mål"}</b>${s.emoji?`<br>${s.emoji}`:""}${s.imageUrl||s.photo?`<br><img src="${s.imageUrl||s.photo}" style="max-width:140px;border-radius:4px;"/>`:""}`))}),n.length?w.courseMap.fitBounds(n,{padding:[20,20]}):w.courseMap.setView([55.7,12.5],10)}function kd(r){const e=document.getElementById("visits-list"),n=r.visits||r.besøg||[];if(!n.length){e.innerHTML='<div class="empty"><div class="empty-icon">📍</div>Ingen besøg endnu</div>';return}e.innerHTML="",n.forEach((s,i)=>{const o=document.createElement("div");o.className="visit-card",o.innerHTML=`<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:4px;"><span style="font-weight:700;font-size:13px;">${s.date}</span><div style="display:flex;gap:6px;">${s.gpsRoute?`<button class="btn-icon" onclick="showRouteOnMap(parseRoute('${s.gpsRoute}'))">🗺️</button>`:""}<button class="btn-icon" style="color:var(--danger);" onclick="deleteVisit(${i})">✕</button></div></div><div style="font-size:12px;color:var(--muted);">${(s.participants||[]).join(", ")}</div>${s.winner?`<div style="font-size:12px;color:var(--acc);font-weight:600;">🏆 ${s.winner} (${s.winnerScore} pt)</div>`:""}`,e.appendChild(o)})}window.deleteVisit=async function(r){if(!confirm("Slet dette besøg?"))return;const e=De(he,"courses",w.currentCourse.id),n=await En(e);if(!n.exists())return;const s=[...n.data().visits||n.data().besøg||[]];s.splice(r,1),await ni(e,{visits:s,besøg:s}),w.currentCourse.visits=s,kd(w.currentCourse)};window.showRouteOnMap=function(r){!w.courseMap||!r.length||(w.courseMapLayer&&w.courseMap.removeLayer(w.courseMapLayer),w.courseMapLayer=window.L.polyline(r.map(e=>[e.lat,e.lng]),{color:"#e8a020",weight:3,dashArray:"8,4"}).addTo(w.courseMap),w.courseMap.fitBounds(w.courseMapLayer.getBounds(),{padding:[20,20]}),window.switchSubtab("map"))};window.parseRoute=Lw;function Xw(r){document.getElementById("course-edit-form").innerHTML=`<div class="fg"><label class="lbl">Banenavn</label><input type="text" id="edit-cname" value="${r.name}" /></div><div class="fg"><label class="lbl">Lokation</label><input type="text" id="edit-cloc" value="${r.location||""}" /></div><button class="btn btn-gold" onclick="saveCourseEdit()">Gem ændringer</button>`}window.saveCourseEdit=async function(){const r=document.getElementById("edit-cname").value.trim(),e=document.getElementById("edit-cloc").value.trim();r&&(await ni(De(he,"courses",w.currentCourse.id),{name:r,yam:r,location:e,beliggenhed:e}),w.currentCourse.name=r,w.currentCourse.location=e,document.getElementById("course-detail-title").textContent=r,alert("Gemt!"))};window.switchSubtab=function(r){document.querySelectorAll(".stab").forEach(e=>e.classList.toggle("active",e.dataset.stab===r)),document.querySelectorAll(".stab-c").forEach(e=>{e.classList.toggle("active",e.id===`stab-${r}`),e.classList.toggle("hidden",e.id!==`stab-${r}`)}),r==="map"&&w.courseMap&&setTimeout(()=>w.courseMap.invalidateSize(),100)};window.toggleMyPos=async function(){const r=document.getElementById("mypos-sw");if(r.classList.toggle("on"),r.classList.contains("on"))try{const e=await va();window.L.circle([e.lat,e.lng],{radius:10,color:"#2a7ae8",fillOpacity:.7}).addTo(w.courseMap),w.courseMap.panTo([e.lat,e.lng])}catch{alert("GPS ikke tilgængeligt"),r.classList.remove("on")}};window.doDeleteCourse=async function(){!w.currentCourse||!confirm(`Slet banen "${w.currentCourse.name}"?`)||(await ri(De(he,"courses",w.currentCourse.id)),document.getElementById("courses-list-view").classList.remove("hidden"),document.getElementById("course-detail-view").classList.add("hidden"))};window.doCreateCourse=async function(){const r=document.getElementById("new-course-name").value.trim(),e=document.getElementById("new-course-loc").value.trim(),n=Number(document.getElementById("new-course-targets").value)||24;if(!r)return;const s=Array.from({length:n},(i,o)=>({number:o+1,name:"",emoji:"",imageUrl:"",distance:null,gps:null}));await aE(kr(he,"courses"),{name:r,yam:r,numTargets:n,antalMål:n,location:e,beliggenhed:e,targets:s,mål:s,created:da(),visits:[],besøg:[]}),document.getElementById("create-course-modal").classList.add("hidden"),document.getElementById("new-course-name").value=""};async function Jw(r,e){try{const n=De(he,"courses",r),s=await En(n);if(!s.exists())return;const i=[e,...s.data().visits||s.data().besøg||[]].slice(0,50);await ni(n,{visits:i,besøg:i})}catch(n){console.warn(n)}}async function Ta(r,e,n){const s=De(he,"courses",r),i=await En(s);if(!i.exists())return;const o=i.data(),c=[...o.targets||o.mål||[]];for(;c.length<=e;)c.push({});c[e]={...c[e],...n},await ni(s,{targets:c,mål:c})}function Yw(r){return new Promise((e,n)=>{const s=new FileReader;s.onload=i=>{const o=new Image;o.onload=()=>{let l=o.width,h=o.height;l>h?l>400&&(h=h*400/l,l=400):h>400&&(l=l*400/h,h=400);const f=document.createElement("canvas");f.width=l,f.height=h,f.getContext("2d").drawImage(o,0,0,l,h),e(f.toDataURL("image/jpeg",.65).split(",")[1])},o.onerror=n,o.src=i.target.result},s.onerror=n,s.readAsDataURL(r)})}window.openEditTarget=function(){var n,s;const r=bn(),e=(s=(n=w.course)==null?void 0:n.targets)==null?void 0:s[r];document.getElementById("edit-tname").value=(e==null?void 0:e.name)||"",document.getElementById("edit-panel").classList.remove("hidden")};window.saveEditTarget=async function(){var n;const r=document.getElementById("edit-tname").value.trim(),e=bn();w.round.courseId&&(await Ta(w.round.courseId,e,{name:r}),(n=w.course)!=null&&n.targets&&(w.course.targets[e].name=r)),document.getElementById("edit-panel").classList.add("hidden"),Nt()};window.editGps=async function(){var r;try{const e=await va(),n=bn();await Ta(w.round.courseId,n,{gps:e}),(r=w.course)!=null&&r.targets&&(w.course.targets[n].gps=e),alert("GPS gemt!")}catch(e){alert("GPS fejl: "+e.message)}};function ci(){const r=document.getElementById("friends-list");if(!w.friends.length){r.innerHTML='<div class="empty"><div class="empty-icon">👥</div>Ingen venner endnu</div>';return}r.innerHTML="",w.friends.forEach(e=>{const n=document.createElement("div");n.className="fcard",n.innerHTML=`<div class="favatar">🎯</div><div class="finfo"><div class="fname">${e.name}</div><div class="fmeta">${[e.email,e.phone,e.club,e.bowType].filter(Boolean).join(" · ")}</div></div><div class="factions"><button class="btn-icon" onclick='openFriendModal(${JSON.stringify(e)})'>✏️</button><button class="btn-icon" style="color:var(--danger);" onclick="doDeleteFriend('${e.id}','${e.name.replace(/'/g,"\\'")}')">🗑</button></div>`,r.appendChild(n)})}window.openFriendModal=function(r){w.editFriendId=(r==null?void 0:r.id)||null,document.getElementById("friend-modal-title").textContent=r?"Rediger ven":"Tilføj ven",document.getElementById("f-name").value=(r==null?void 0:r.name)||"",document.getElementById("f-email").value=(r==null?void 0:r.email)||"",document.getElementById("f-phone").value=(r==null?void 0:r.phone)||"",document.getElementById("f-club").value=(r==null?void 0:r.club)||"",document.getElementById("f-bow").value=(r==null?void 0:r.bowType)||"",document.getElementById("friend-modal").classList.remove("hidden")};window.saveFriendModal=function(){const r={name:document.getElementById("f-name").value.trim(),email:document.getElementById("f-email").value.trim(),phone:document.getElementById("f-phone").value.trim(),club:document.getElementById("f-club").value.trim(),bowType:document.getElementById("f-bow").value};if(r.name){if(w.editFriendId){const e=w.friends.findIndex(n=>n.id===w.editFriendId);e!==-1?w.friends[e]={...r,id:w.editFriendId}:w.friends.push({...r,id:w.editFriendId})}else w.friends.push({...r,id:"f_"+Date.now()});Rn(),document.getElementById("friend-modal").classList.add("hidden"),ci(),oi()}};window.doDeleteFriend=function(r,e){confirm(`Slet ${e}?`)&&(w.friends=w.friends.filter(n=>n.id!==r),Rn(),ci(),oi())};async function Zw(){if(w.isAdmin){document.getElementById("admin-section").classList.remove("hidden");try{const r=await ti(kr(he,"users")),e=document.getElementById("users-list");e.innerHTML="",r.docs.forEach(n=>{var c;const s=n.data(),i=document.createElement("div");i.className="urow";const o=(c=s.created)!=null&&c.toDate?s.created.toDate().toLocaleDateString("da-DK"):"—";i.innerHTML=`<span class="un">${s.name||s.yam||"—"}</span><span class="ue">${s.email||s["e-mail"]||""}</span><span class="ud">${o}</span>`,e.appendChild(i)})}catch(r){console.warn(r)}}}window.doAddAdmin=async function(){const r=document.getElementById("admin-email").value.trim();if(r)try{const n=(await ti(kr(he,"users"))).docs.find(s=>s.data().email===r||s.data()["e-mail"]===r);if(!n){alert("Bruger ikke fundet");return}await ha(De(he,"admins",n.id),{email:r,created:da()}),alert(`${n.data().name||r} er nu admin`),document.getElementById("admin-email").value=""}catch(e){alert("Fejl: "+e.message)}};window.showQR=function(){document.getElementById("qr-modal").classList.remove("hidden");const r=document.getElementById("qr-canvas");r.innerHTML="",typeof window.QRCode<"u"&&new window.QRCode(r,{text:window.location.href,width:200,height:200,colorDark:"#1a3a1a",colorLight:"#fff"})};window.sendResults=async function(r){if(!r)return;Nr(r.shooters);const e=new Date().toLocaleDateString("da-DK");let n=`3D Bueskydning - Resultater
`;n+=`Dato: ${e}
`,r.courseName&&(n+=`Bane: ${r.courseName}
`),n+=`
--- RESULTATER ---
`,[...r.shooters].sort((l,h)=>ke(h.scores)-ke(l.scores)).forEach((l,h)=>{n+=`
${h+1}. ${l.name}: ${ke(l.scores)} point`}),n+=`
...
`}n+=`  Total: ${ke(l.scores)} point
`});const o=`mailto:${r.shooters.map(l=>{var h;return(h=w.friends.find(f=>f.id===l.id))==null?void 0:h.email}).filter(Boolean).join(",")}?subject=3D Bueskydning - ${r.name}&body=${encodeURIComponent(n)}`,c=document.createElement("a");c.href=o,c.target="_blank",document.body.appendChild(c),c.click(),document.body.removeChild(c)};window.sendResults=async function(r){if(!r){alert("Ingen runde at sende");return}Nr(r.shooters);const e=new Date().toLocaleDateString("da-DK");let n=`3D Bueskydning - Resultater
`;n+="Dato: "+e+`
`,r.courseName&&(n+="Bane: "+r.courseName+`
`),n+=`
--- RESULTATER ---
...
`;for(let h=0;h<r.numTargets;h++){const f=l.scores[h]||[null,null],m=(f[0]!=null&&f[0]!=="M"?Number(f[0]):0)+(f[1]!=null&&f[1]!=="M"?Number(f[1]):0);n+="  Mål "+(h+1)+": "+f.map(v=>v??"-").join("+")+" = "+m+`
`}n+="  Total: "+ke(l.scores)+` point
`});const i=r.shooters.map(l=>{var h;return(h=w.friends.find(f=>f.id===l.id))==null?void 0:h.email}).filter(Boolean),o="3D Bueskydning - "+r.name;if(navigator.share)try{await navigator.share({title:o,text:n});return}catch(l){console.log("share failed",l)}const c="mailto:"+i.join(",")+"?subject="+encodeURIComponent(o)+"&body="+encodeURIComponent(n);window.location.href=c};window.openGuestModal=function(){document.getElementById("guest-name").value="",document.getElementById("guest-modal").classList.remove("hidden")};window.addGuest=function(){const r=document.getElementById("guest-name").value.trim();r&&(window.addParticipant(`guest-${Date.now()}`,r,!0),document.getElementById("guest-modal").classList.add("hidden"))};
