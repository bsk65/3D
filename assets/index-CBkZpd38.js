 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L_(r){Dn(new sn("platform-logger",e=>new Qg(e),"PRIVATE")),Dn(new sn("heartbeat",e=>new V_(e),"PRIVATE")),pt(ba,yu,r),pt(ba,yu,"esm2017"),pt("fire-js","")}L_("");var M_="firebase",F_="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ji(r){var e;const t=r.auth,n=await r.getIdToken(),s=await Ts(r,Td(t,{idToken:n}));H(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];r._notifyReloadListener(i);const o=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?bd(i.providerUserInfo):[],c=ty(r.providerData,o),l=r.isAnonymous,h=!(r.email&&i.passwordHash)&&!(c!=null&&c.length),f=l?h:!1,p={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new Pa(i.createdAt,i.lastLoginAt),isAnonymous:f};Object.assign(r,p)}async function ey(r){const e=we(r);await ji(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function ty(r,e){return[...r.filter(n=>!e.some(s=>s.providerId===n.providerId)),...e]}function bd(r){return r.map(e=>{var{providerId:t}=e,n=sc(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){H(e.idToken,"internal-error"),H(typeof e.idToken<"u","internal-error"),H(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Au(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){H(e.length!==0,"internal-error");const t=Au(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(H(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:s,expiresIn:i}=await ny(e,t);this.updateTokensAndExpiration(n,s,Number(i))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+n*1e3}static fromJSON(e,t){const{refreshToken:n,accessToken:s,expirationTime:i}=t,o=new hr;return n&&(H(typeof n=="string","internal-error",{appName:e}),o.refreshToken=n),s&&(H(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),i&&(H(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new hr,this.toJSON())}_performRefresh(){return St("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cy="http://localhost";class Vn extends lc{constructor(){super(...arguments),this.pendingToken=null}static _fromParams(e){const t=new Vn(e.providerId,e.signInMethod);return e.idToken||e.accessToken?(e.idToken&&(t.idToken=e.idToken),e.accessToken&&(t.accessToken=e.accessToken),e.nonce&&!e.pendingToken&&(t.nonce=e.nonce),e.pendingToken&&(t.pendingToken=e.pendingToken)):e.oauthToken&&e.oauthTokenSecret?(t.accessToken=e.oauthToken,t.secret=e.oauthTokenSecret):lt("argument-error"),t}toJSON(){return{idToken:this.idToken,accessToken:this.accessToken,secret:this.secret,nonce:this.nonce,pendingToken:this.pendingToken,providerId:this.providerId,signInMethod:this.signInMethod}}static fromJSON(e){const t=typeof e=="string"?JSON.parse(e):e,{providerId:n,signInMethod:s}=t,i=sc(t,["providerId","signInMethod"]);if(!n||!s)return null;const o=new Vn(n,s);return o.idToken=i.idToken||void 0,o.accessToken=i.accessToken||void 0,o.secret=i.secret,o.nonce=i.nonce,o.pendingToken=i.pendingToken||null,o}_getIdTokenResponse(e){const t=this.buildRequest();return fr(e,t)}_linkToIdToken(e,t){const n=this.buildRequest();return n.idToken=t,fr(e,n)}_getReauthenticationResolver(e){const t=this.buildRequest();return t.autoCreate=!1,fr(e,t)}buildRequest(){const e={requestUri:Cy,returnSecureToken:!0};if(this.pendingToken)e.pendingToken=this.pendingToken;else{const t={};this.idToken&&(t.id_token=this.idToken),this.accessToken&&(t.access_token=this.accessToken),this.secret&&(t.oauth_token_secret=this.secret),t.providerId=this.providerId,this.nonce&&!this.pendingToken&&(t.nonce=this.nonce),e.postBody=Fs(t)}return e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr{constructor(){this.providerId=Cr.PROVIDER_ID}static credential(e,t){return bs._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=uc.parseLink(t);return H(n,"argument-error"),bs._fromEmailAndCode(e,n.code,n.tenantId)}}Cr.PROVIDER_ID="password";Cr.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Cr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi extends Et{constructor(e,t,n,s){var i;super(t.code,t.message),this.operationType=n,this.user=s,Object.setPrototypeOf(this,zi.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:t.customData._serverResponse,operationType:n}}static _fromErrorAndOperation(e,t,n,s){return new zi(e,t,n,s)}}function Fd(r,e,t,n){return(e==="reauthenticate"?t._getReauthenticationResolver(r):t._getIdTokenResponse(r)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?zi._fromErrorAndOperation(r,i,e,n):i})}async function Vy(r,e,t=!1){const n=await Ts(r,e._linkToIdToken(r.auth,await r.getIdToken()),t);return Nn._forOperation(r,"link",n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ny(r,e,t=!1){const{auth:n}=r;if(dt(n.app))return Promise.reject(Dt(n));const s="reauthenticate";try{const i=await Ts(r,Fd(n,s,e,r),t);H(i.idToken,n,"internal-error");const o=ac(i.idToken);H(o,n,"internal-error");const{sub:c}=o;return H(r.uid===c,n,"user-mismatch"),Nn._forOperation(r,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&lt(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ud(r,e,t=!1){if(dt(r.app))return Promise.reject(Dt(r));const n="signIn",s=await Fd(r,n,e),i=await Nn._fromIdTokenResponse(r,n,s);return t||await r._updateCurrentUser(i.user),i}async function Oy(r,e){return Ud(ln(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bd(r){const e=ln(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Ly(r,e,t){const n=ln(r);await qi(n,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Ry)}async function My(r,e,t){if(dt(r.app))return Promise.reject(Dt(r));const n=ln(r),o=await qi(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Dy).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&Bd(r),l}),c=await Nn._fromIdTokenResponse(n,"signIn",o);return await n._updateCurrentUser(c.user),c}function Fy(r,e,t){return dt(r.app)?Promise.reject(Dt(r)):Oy(we(r),Cr.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&Bd(r),n})}function Uy(r,e,t,n){return we(r).onIdTokenChanged(e,t,n)}function By(r,e,t){return we(r).beforeAuthStateChanged(e,t)}function $y(r,e,t,n){return we(r).onAuthStateChanged(e,t,n)}function jy(r){return we(r).signOut()}const Gi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sv(r,e){return e?Ct(e):(H(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa="webStorageSupport";class Gv{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=zd,this._completeRedirectFn=pv,this._overrideRedirectResult=dv}async _openPopup(e,t,n,s){var i;Nt((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await Fu(e,t,n,Sa(),s);return Uv(e,o,hc())}async _openRedirect(e,t,n,s){await this._originValidation(e);const i=await Fu(e,t,n,Sa(),s);return Wy(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(Nt(i,"If manager is not set, promise should be"),i)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){const t=await Vv(e),n=new _v(e);return t.register("authEvent",s=>(H(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:n.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(fa,{type:fa},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[fa];o!==void 0&&t(!!o),lt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=wv(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Vd()||Sd()||cc()}}const Kv=Gv;var Uu="@firebase/auth",Bu="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wv(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Qv(r){Dn(new sn("auth",(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=n.options;H(o&&!o.includes(":"),"invalid-api-key",{appName:n.name});const l={apiKey:o,authDomain:c,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Nd(r)},h=new uy(n,s,i,l);return vy(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,n)=>{e.getProvider("auth-internal").initialize()})),Dn(new sn("auth-internal",e=>{const t=ln(e.getProvider("auth").getImmediate());return(n=>new Hv(n))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),pt(Uu,Bu,Wv(r)),pt(Uu,Bu,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Yd,os,Zd,Si,xa,ef,tf,nf;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,u,d){return a==Array.prototype||a==Object.prototype||(a[u]=d.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof pi=="object"&&pi];for(var u=0;u<a.length;++u){var d=a[u];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var n=t(this);function s(a,u){if(u)e:{var d=n;a=a.split(".");for(var m=0;m<a.length-1;m++){var b=a[m];if(!(b in d))break e;d=d[b]}a=a[a.length-1],m=d[a],u=u(m),u!=m&&u!=null&&e(d,a,{configurable:!0,writable:!0,value:u})}}function i(a,u){a instanceof String&&(a+="");var d=0,m=!1,b={next:function(){if(!m&&d<a.length){var P=d++;return{value:u(P,a[P]),done:!1}}return m=!0,{done:!0,value:void 0}}};return b[Symbol.iterator]=function(){return b},b}s("Array.prototype.values",function(a){return a||function(){return i(this,function(u,d){return d})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(a){var u=typeof a;return u=u!="object"?u:a?Array.isArray(a)?"array":u:"null",u=="array"||u=="object"&&typeof a.length=="number"}function h(a){var u=typeof a;return u=="object"&&a!=null||u=="function"}function f(a,u,d){return a.call.apply(a.bind,arguments)}function p(a,u,d){if(!a)throw Error();if(2<arguments.length){var m=Array.prototype.slice.call(arguments,2);return function(){var b=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(b,m),a.apply(u,b)}}return function(){return a.apply(u,arguments)}}function y(a,u,d){return y=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:p,y.apply(null,arguments)}function S(a,u){var d=Array.prototype.slice.call(arguments,1);return function(){var m=d.slice();return m.push.apply(m,arguments),a.apply(this,m)}}function k(a,u){function d(){}d.prototype=u.prototype,a.aa=u.prototype,a.prototype=new d,a.prototype.constructor=a,a.Qb=function(m,b,P){for(var N=Array(arguments.length-2),ue=2;ue<arguments.length;ue++)N[ue-2]=arguments[ue];return u.prototype[b].apply(m,N)}}function V(a){const u=a.length;if(0<u){const d=Array(u);for(let m=0;m<u;m++)d[m]=a[m];return d}return[]}function x(a,u){for(let d=1;d<arguments.length;d++){const m=arguments[d];if(l(m)){const b=a.length||0,P=m.length||0;a.length=b+P;for(let N=0;N<P;N++)a[b+N]=m[N]}else a.push(m)}}class G{constructor(u,d){this.i=u,this.j=d,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function B(a){return/^[\s\xa0]*$/.test(a)}function M(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function q(a){return q[" "](a),a}q[" "]=function(){};var X=M().indexOf("Gecko")!=-1&&!(M().toLowerCase().indexOf("webkit")!=-1&&M().indexOf("Edge")==-1)&&!(M().indexOf("Trident")!=-1||M().indexOf("MSIE")!=-1)&&M().indexOf("Edge")==-1;function W(a,u,d){for(const m in a)u.call(d,a[m],m,a)}function E(a,u){for(const d in a)u.call(void 0,a[d],d,a)}function g(a){const u={};for(const d in a)u[d]=a[d];return u}const I="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function w(a,u){let d,m;for(let b=1;b<arguments.length;b++){m=arguments[b];for(d in m)a[d]=m[d];for(let P=0;P<I.length;P++)d=I[P],Object.prototype.hasOwnProperty.call(m,d)&&(a[d]=m[d])}}function T(a){var u=1;a=a.split(":");const d=[];for(;0<u&&a.length;)d.push(a.shift()),u--;return a.length&&d.push(a.join(":")),d}function A(a){c.setTimeout(()=>{throw a},0)}function v(){var a=Qn;let u=null;return a.g&&(u=a.g,a.g=a.g.next,a.g||(a.h=null),u.next=null),u}class ot{constructor(){this.h=this.g=null}add(u,d){const m=$e.get();m.set(u,d),this.h?this.h.next=m:this.g=m,this.h=m}}var $e=new G(()=>new Bo,a=>a.reset());class Bo{constructor(){this.next=this.g=this.h=null}set(u,d){this.h=u,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let st,Ut=!1,Qn=new ot,Mr=()=>{const a=c.Promise.resolve(void 0);st=()=>{a.then(Js)}};var Js=()=>{for(var a;a=v();){try{a.h.call(a.g)}catch(d){A(d)}var u=$e;u.j(a),100>u.h&&(u.h++,a.next=u.g,u.g=a)}Ut=!1};function K(){this.s=this.s,this.C=this.C}K.prototype.s=!1,K.prototype.ma=function(){this.s||(this.s=!0,this.N())},K.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function j(a,u){this.type=a,this.g=this.target=u,this.defaultPrevented=!1}j.prototype.h=function(){this.defaultPrevented=!0};var he=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,u=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};c.addEventListener("test",d,u),c.removeEventListener("test",d,u)}catch{}return a}();function se(a,u){if(j.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var d=this.type=a.type,m=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=u,u=a.relatedTarget){if(X){e:{try{q(u.nodeName);var b=!0;break e}catch{}b=!1}b||(u=null)}}else d=="mouseover"?u=a.fromElement:d=="mouseout"&&(u=a.toElement);this.relatedTarget=u,m?(this.clientX=m.clientX!==void 0?m.clientX:m.pageX,this.clientY=m.clientY!==void 0?m.clientY:m.pageY,this.screenX=m.screenX||0,this.screenY=m.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:Z[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&se.aa.h.call(this)}}k(se,j);var Z={2:"touch",3:"pen",4:"mouse"};se.prototype.h=function(){se.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var De="closure_listenable_"+(1e6*Math.random()|0),je=0;function Se(a,u,d,m,b){this.listener=a,this.proxy=null,this.src=u,this.type=d,this.capture=!!m,this.ha=b,this.key=++je,this.da=this.fa=!1}function We(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Ce(a){this.src=a,this.g={},this.h=0}Ce.prototype.add=function(a,u,d,m,b){var P=a.toString();a=this.g[P],a||(a=this.g[P]=[],this.h++);var N=wt(a,u,m,b);return-1<N?(u=a[N],d||(u.fa=!1)):(u=new Se(u,this.src,P,!!m,b),u.fa=d,a.push(u)),u};function Ve(a,u){var d=u.type;if(d in a.g){var m=a.g[d],b=Array.prototype.indexOf.call(m,u,void 0),P;(P=0<=b)&&Array.prototype.splice.call(m,b,1),P&&(We(u),a.g[d].length==0&&(delete a.g[d],a.h--))}}function wt(a,u,d,m){for(var b=0;b<a.length;++b){var P=a[b];if(!P.da&&P.listener==u&&P.capture==!!d&&P.ha==m)return b}return-1}var Tt="closure_lm_"+(1e6*Math.random()|0),Jn={};function Xs(a,u,d,m,b){if(Array.isArray(u)){for(var P=0;P<u.length;P++)Xs(a,u[P],d,m,b);return null}return d=_l(d),a&&a[De]?a.K(u,d,h(m)?!!m.capture:!1,b):$o(a,u,d,!1,m,b)}function $o(a,u,d,m,b,P){if(!u)throw Error("Invalid event type");var N=h(b)?!!b.capture:!!b,ue=qo(a);if(ue||(a[Tt]=ue=new Ce(a)),d=ue.add(u,d,m,N,P),d.proxy)return d;if(m=ie(),d.proxy=m,m.src=a,m.listener=d,a.addEventListener)he||(b=N),b===void 0&&(b=!1),a.addEventListener(u.toString(),m,b);else if(a.attachEvent)a.attachEvent(gl(u.toString()),m);else if(a.addListener&&a.removeListener)a.addListener(m);else throw Error("addEventListener and attachEvent are unavailable.");return d}function ie(){function a(d){return u.call(a.src,a.listener,d)}const u=Vp;return a}function bt(a,u,d,m,b){if(Array.isArray(u))for(var P=0;P<u.length;P++)bt(a,u[P],d,m,b);else m=h(m)?!!m.capture:!!m,d=_l(d),a&&a[De]?(a=a.i,u=String(u).toString(),u in a.g&&(P=a.g[u],d=wt(P,d,m,b),-1<d&&(We(P[d]),Array.prototype.splice.call(P,d,1),P.length==0&&(delete a.g[u],a.h--)))):a&&(a=qo(a))&&(u=a.g[u.toString()],a=-1,u&&(a=wt(u,d,m,b)),(d=-1<a?u[a]:null)&&jo(d))}function jo(a){if(typeof a!="number"&&a&&!a.da){var u=a.src;if(u&&u[De])Ve(u.i,a);else{var d=a.type,m=a.proxy;u.removeEventListener?u.removeEventListener(d,m,a.capture):u.detachEvent?u.detachEvent(gl(d),m):u.addListener&&u.removeListener&&u.removeListener(m),(d=qo(u))?(Ve(d,a),d.h==0&&(d.src=null,u[Tt]=null)):We(a)}}}function gl(a){return a in Jn?Jn[a]:Jn[a]="on"+a}function Vp(a,u){if(a.da)a=!0;else{u=new se(u,this);var d=a.listener,m=a.ha||a.src;a.fa&&jo(a),a=d.call(m,u)}return a}function qo(a){return a=a[Tt],a instanceof Ce?a:null}var zo="__closure_events_fn_"+(1e9*Math.random()>>>0);function _l(a){return typeof a=="function"?a:(a[zo]||(a[zo]=function(u){return a.handleEvent(u)}),a[zo])}function Ne(){K.call(this),this.i=new Ce(this),this.M=this,this.F=null}k(Ne,K),Ne.prototype[De]=!0,Ne.prototype.removeEventListener=function(a,u,d,m){bt(this,a,u,d,m)};function qe(a,u){var d,m=a.F;if(m)for(d=[];m;m=m.F)d.push(m);if(a=a.M,m=u.type||u,typeof u=="string")u=new j(u,a);else if(u instanceof j)u.target=u.target||a;else{var b=u;u=new j(m,a),w(u,b)}if(b=!0,d)for(var P=d.length-1;0<=P;P--){var N=u.g=d[P];b=Ys(N,m,!0,u)&&b}if(N=u.g=a,b=Ys(N,m,!0,u)&&b,b=Ys(N,m,!1,u)&&b,d)for(P=0;P<d.length;P++)N=u.g=d[P],b=Ys(N,m,!1,u)&&b}Ne.prototype.N=function(){if(Ne.aa.N.call(this),this.i){var a=this.i,u;for(u in a.g){for(var d=a.g[u],m=0;m<d.length;m++)We(d[m]);delete a.g[u],a.h--}}this.F=null},Ne.prototype.K=function(a,u,d,m){return this.i.add(String(a),u,!1,d,m)},Ne.prototype.L=function(a,u,d,m){return this.i.add(String(a),u,!0,d,m)};function Ys(a,u,d,m){if(u=a.i.g[String(u)],!u)return!0;u=u.concat();for(var b=!0,P=0;P<u.length;++P){var N=u[P];if(N&&!N.da&&N.capture==d){var ue=N.listener,xe=N.ha||N.src;N.fa&&Ve(a.i,N),b=ue.call(xe,m)!==!1&&b}}return b&&!m.defaultPrevented}function yl(a,u,d){if(typeof a=="function")d&&(a=y(a,d));else if(a&&typeof a.handleEvent=="function")a=y(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:c.setTimeout(a,u||0)}function vl(a){a.g=yl(()=>{a.g=null,a.i&&(a.i=!1,vl(a))},a.l);const u=a.h;a.h=null,a.m.apply(null,u)}class Np extends K{constructor(u,d){super(),this.m=u,this.l=d,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:vl(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Fr(a){K.call(this),this.h=a,this.g={}}k(Fr,K);var Il=[];function El(a){W(a.g,function(u,d){this.g.hasOwnProperty(d)&&jo(u)},a),a.g={}}Fr.prototype.N=function(){Fr.aa.N.call(this),El(this)},Fr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Go=c.JSON.stringify,Op=c.JSON.parse,Lp=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function Ko(){}Ko.prototype.h=null;function wl(a){return a.h||(a.h=a.i())}function Tl(){}var Ur={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Ho(){j.call(this,"d")}k(Ho,j);function Wo(){j.call(this,"c")}k(Wo,j);var pn={},bl=null;function Zs(){return bl=bl||new Ne}pn.La="serverreachability";function Al(a){j.call(this,pn.La,a)}k(Al,j);function Br(a){const u=Zs();qe(u,new Al(u))}pn.STAT_EVENT="statevent";function Rl(a,u){j.call(this,pn.STAT_EVENT,a),this.stat=u}k(Rl,j);function ze(a){const u=Zs();qe(u,new Rl(u,a))}pn.Ma="timingevent";function Sl(a,u){j.call(this,pn.Ma,a),this.size=u}k(Sl,j);function $r(a,u){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},u)}function jr(){this.g=!0}jr.prototype.xa=function(){this.g=!1};function Mp(a,u,d,m,b,P){a.info(function(){if(a.g)if(P)for(var N="",ue=P.split("&"),xe=0;xe<ue.length;xe++){var re=ue[xe].split("=");if(1<re.length){var Oe=re[0];re=re[1];var Le=Oe.split("_");N=2<=Le.length&&Le[1]=="type"?N+(Oe+"="+re+"&"):N+(Oe+"=redacted&")}}else N=null;else N=P;return"XMLHTTP REQ ("+m+") [attempt "+b+"]: "+u+`
`+d+`
`+N})}function Fp(a,u,d,m,b,P,N){a.info(function(){return"XMLHTTP RESP ("+m+") [ attempt "+b+"]: "+u+`
`+d+`
`+P+" "+N})}function Xn(a,u,d,m){a.info(function(){return"XMLHTTP TEXT ("+u+"): "+Bp(a,d)+(m?" "+m:"")})}function Up(a,u){a.info(function(){return"TIMEOUT: "+u})}jr.prototype.info=function(){};function Bp(a,u){if(!a.g)return u;if(!u)return null;try{var d=JSON.parse(u);if(d){for(a=0;a<d.length;a++)if(Array.isArray(d[a])){var m=d[a];if(!(2>m.length)){var b=m[1];if(Array.isArray(b)&&!(1>b.length)){var P=b[0];if(P!="noop"&&P!="stop"&&P!="close")for(var N=1;N<b.length;N++)b[N]=""}}}}return Go(d)}catch{return u}}var ei={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Pl={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Qo;function ti(){}k(ti,Ko),ti.prototype.g=function(){return new XMLHttpRequest},ti.prototype.i=function(){return{}},Qo=new ti;function Bt(a,u,d,m){this.j=a,this.i=u,this.l=d,this.R=m||1,this.U=new Fr(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Cl}function Cl(){this.i=null,this.g="",this.h=!1}var xl={},Jo={};function Xo(a,u,d){a.L=1,a.v=ii(At(u)),a.m=d,a.P=!0,kl(a,null)}function kl(a,u){a.F=Date.now(),ni(a),a.A=At(a.v);var d=a.A,m=a.R;Array.isArray(m)||(m=[String(m)]),Gl(d.i,"t",m),a.C=0,d=a.j.J,a.h=new Cl,a.g=lu(a.j,d?u:null,!a.m),0<a.O&&(a.M=new Np(y(a.Y,a,a.g),a.O)),u=a.U,d=a.g,m=a.ca;var b="readystatechange";Array.isArray(b)||(b&&(Il[0]=b.toString()),b=Il);for(var P=0;P<b.length;P++){var N=Xs(d,b[P],m||u.handleEvent,!1,u.h||u);if(!N)break;u.g[N.key]=N}u=a.H?g(a.H):{},a.m?(a.u||(a.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,u)):(a.u="GET",a.g.ea(a.A,a.u,null,u)),Br(),Mp(a.i,a.u,a.A,a.l,a.R,a.m)}Bt.prototype.ca=function(a){a=a.target;const u=this.M;u&&Rt(a)==3?u.j():this.Y(a)},Bt.prototype.Y=function(a){try{if(a==this.g)e:{const Le=Rt(this.g);var u=this.g.Ba();const er=this.g.Z();if(!(3>Le)&&(Le!=3||this.g&&(this.h.h||this.g.oa()||Yl(this.g)))){this.J||Le!=4||u==7||(u==8||0>=er?Br(3):Br(2)),Yo(this);var d=this.g.Z();this.X=d;t:if(Dl(this)){var m=Yl(this.g);a="";var b=m.length,P=Rt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){gn(this),qr(this);var N="";break t}this.h.i=new c.TextDecoder}for(u=0;u<b;u++)this.h.h=!0,a+=this.h.i.decode(m[u],{stream:!(P&&u==b-1)});m.length=0,this.h.g+=a,this.C=0,N=this.h.g}else N=this.g.oa();if(this.o=d==200,Fp(this.i,this.u,this.A,this.l,this.R,Le,d),this.o){if(this.T&&!this.K){t:{if(this.g){var ue,xe=this.g;if((ue=xe.g?xe.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!B(ue)){var re=ue;break t}}re=null}if(d=re)Xn(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Zo(this,d);else{this.o=!1,this.s=3,ze(12),gn(this),qr(this);break e}}if(this.P){d=!0;let at;for(;!this.J&&this.C<N.length;)if(at=$p(this,N),at==Jo){Le==4&&(this.s=4,ze(14),d=!1),Xn(this.i,this.l,null,"[Incomplete Response]");break}else if(at==xl){this.s=4,ze(15),Xn(this.i,this.l,N,"[Invalid Chunk]"),d=!1;break}else Xn(this.i,this.l,at,null),Zo(this,at);if(Dl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Le!=4||N.length!=0||this.h.h||(this.s=1,ze(16),d=!1),this.o=this.o&&d,!d)Xn(this.i,this.l,N,"[Invalid Chunked Response]"),gn(this),qr(this);else if(0<N.length&&!this.W){this.W=!0;var Oe=this.j;Oe.g==this&&Oe.ba&&!Oe.M&&(Oe.j.info("Great, no buffering proxy detected. Bytes received: "+N.length),ia(Oe),Oe.M=!0,ze(11))}}else Xn(this.i,this.l,N,null),Zo(this,N);Le==4&&gn(this),this.o&&!this.J&&(Le==4?iu(this.j,this):(this.o=!1,ni(this)))}else sg(this.g),d==400&&0<N.indexOf("Unknown SID")?(this.s=3,ze(12)):(this.s=0,ze(13)),gn(this),qr(this)}}}catch{}finally{}};function Dl(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function $p(a,u){var d=a.C,m=u.indexOf(`
`,d);return m==-1?Jo:(d=Number(u.substring(d,m)),isNaN(d)?xl:(m+=1,m+d>u.length?Jo:(u=u.slice(m,m+d),a.C=m+d,u)))}Bt.prototype.cancel=function(){this.J=!0,gn(this)};function ni(a){a.S=Date.now()+a.I,Vl(a,a.I)}function Vl(a,u){if(a.B!=null)throw Error("WatchDog timer not null");a.B=$r(y(a.ba,a),u)}function Yo(a){a.B&&(c.clearTimeout(a.B),a.B=null)}Bt.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Up(this.i,this.A),this.L!=2&&(Br(),ze(17)),gn(this),this.s=2,qr(this)):Vl(this,this.S-a)};function qr(a){a.j.G==0||a.J||iu(a.j,a)}function gn(a){Yo(a);var u=a.M;u&&typeof u.ma=="function"&&u.ma(),a.M=null,El(a.U),a.g&&(u=a.g,a.g=null,u.abort(),u.ma())}function Zo(a,u){try{var d=a.j;if(d.G!=0&&(d.g==a||ea(d.h,a))){if(!a.K&&ea(d.h,a)&&d.G==3){try{var m=d.Da.g.parse(u)}catch{m=null}if(Array.isArray(m)&&m.length==3){var b=m;if(b[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<a.F)hi(d),li(d);else break e;sa(d),ze(18)}}else d.za=b[1],0<d.za-d.T&&37500>b[2]&&d.F&&d.v==0&&!d.C&&(d.C=$r(y(d.Za,d),6e3));if(1>=Ll(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else yn(d,11)}else if((a.K||d.g==a)&&hi(d),!B(u))for(b=d.Da.g.parse(u),u=0;u<b.length;u++){let re=b[u];if(d.T=re[0],re=re[1],d.G==2)if(re[0]=="c"){d.K=re[1],d.ia=re[2];const Oe=re[3];Oe!=null&&(d.la=Oe,d.j.info("VER="+d.la));const Le=re[4];Le!=null&&(d.Aa=Le,d.j.info("SVER="+d.Aa));const er=re[5];er!=null&&typeof er=="number"&&0<er&&(m=1.5*er,d.L=m,d.j.info("backChannelRequestTimeoutMs_="+m)),m=d;const at=a.g;if(at){const fi=at.g?at.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(fi){var P=m.h;P.g||fi.indexOf("spdy")==-1&&fi.indexOf("quic")==-1&&fi.indexOf("h2")==-1||(P.j=P.l,P.g=new Set,P.h&&(ta(P,P.h),P.h=null))}if(m.D){const oa=at.g?at.g.getResponseHeader("X-HTTP-Session-Id"):null;oa&&(m.ya=oa,fe(m.I,m.D,oa))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-a.F,d.j.info("Handshake RTT: "+d.R+"ms")),m=d;var N=a;if(m.qa=cu(m,m.J?m.ia:null,m.W),N.K){Ml(m.h,N);var ue=N,xe=m.L;xe&&(ue.I=xe),ue.B&&(Yo(ue),ni(ue)),m.g=N}else ru(m);0<d.i.length&&ui(d)}else re[0]!="stop"&&re[0]!="close"||yn(d,7);else d.G==3&&(re[0]=="stop"||re[0]=="close"?re[0]=="stop"?yn(d,7):ra(d):re[0]!="noop"&&d.l&&d.l.ta(re),d.v=0)}}Br(4)}catch{}}var jp=class{constructor(a,u){this.g=a,this.map=u}};function Nl(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ol(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Ll(a){return a.h?1:a.g?a.g.size:0}function ea(a,u){return a.h?a.h==u:a.g?a.g.has(u):!1}function ta(a,u){a.g?a.g.add(u):a.h=u}function Ml(a,u){a.h&&a.h==u?a.h=null:a.g&&a.g.has(u)&&a.g.delete(u)}Nl.prototype.cancel=function(){if(this.i=Fl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Fl(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let u=a.i;for(const d of a.g.values())u=u.concat(d.D);return u}return V(a.i)}function qp(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(l(a)){for(var u=[],d=a.length,m=0;m<d;m++)u.push(a[m]);return u}u=[],d=0;for(m in a)u[d++]=a[m];return u}function zp(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(l(a)||typeof a=="string"){var u=[];a=a.length;for(var d=0;d<a;d++)u.push(d);return u}u=[],d=0;for(const m in a)u[d++]=m;return u}}}function Ul(a,u){if(a.forEach&&typeof a.forEach=="function")a.forEach(u,void 0);else if(l(a)||typeof a=="string")Array.prototype.forEach.call(a,u,void 0);else for(var d=zp(a),m=qp(a),b=m.length,P=0;P<b;P++)u.call(void 0,m[P],d&&d[P],a)}var Bl=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Gp(a,u){if(a){a=a.split("&");for(var d=0;d<a.length;d++){var m=a[d].indexOf("="),b=null;if(0<=m){var P=a[d].substring(0,m);b=a[d].substring(m+1)}else P=a[d];u(P,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function _n(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof _n){this.h=a.h,ri(this,a.j),this.o=a.o,this.g=a.g,si(this,a.s),this.l=a.l;var u=a.i,d=new Kr;d.i=u.i,u.g&&(d.g=new Map(u.g),d.h=u.h),$l(this,d),this.m=a.m}else a&&(u=String(a).match(Bl))?(this.h=!1,ri(this,u[1]||"",!0),this.o=zr(u[2]||""),this.g=zr(u[3]||"",!0),si(this,u[4]),this.l=zr(u[5]||"",!0),$l(this,u[6]||"",!0),this.m=zr(u[7]||"")):(this.h=!1,this.i=new Kr(null,this.h))}_n.prototype.toString=function(){var a=[],u=this.j;u&&a.push(Gr(u,jl,!0),":");var d=this.g;return(d||u=="file")&&(a.push("//"),(u=this.o)&&a.push(Gr(u,jl,!0),"@"),a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&a.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(Gr(d,d.charAt(0)=="/"?Wp:Hp,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",Gr(d,Jp)),a.join("")};function At(a){return new _n(a)}function ri(a,u,d){a.j=d?zr(u,!0):u,a.j&&(a.j=a.j.replace(/:$/,""))}function si(a,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);a.s=u}else a.s=null}function $l(a,u,d){u instanceof Kr?(a.i=u,Xp(a.i,a.h)):(d||(u=Gr(u,Qp)),a.i=new Kr(u,a.h))}function fe(a,u,d){a.i.set(u,d)}function ii(a){return fe(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function zr(a,u){return a?u?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Gr(a,u,d){return typeof a=="string"?(a=encodeURI(a).replace(u,Kp),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Kp(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var jl=/[#\/\?@]/g,Hp=/[#\?:]/g,Wp=/[#\?]/g,Qp=/[#\?@]/g,Jp=/#/g;function Kr(a,u){this.h=this.g=null,this.i=a||null,this.j=!!u}function $t(a){a.g||(a.g=new Map,a.h=0,a.i&&Gp(a.i,function(u,d){a.add(decodeURIComponent(u.replace(/\+/g," ")),d)}))}r=Kr.prototype,r.add=function(a,u){$t(this),this.i=null,a=Yn(this,a);var d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(u),this.h+=1,this};function ql(a,u){$t(a),u=Yn(a,u),a.g.has(u)&&(a.i=null,a.h-=a.g.get(u).length,a.g.delete(u))}function zl(a,u){return $t(a),u=Yn(a,u),a.g.has(u)}r.forEach=function(a,u){$t(this),this.g.forEach(function(d,m){d.forEach(function(b){a.call(u,b,m,this)},this)},this)},r.na=function(){$t(this);const a=Array.from(this.g.values()),u=Array.from(this.g.keys()),d=[];for(let m=0;m<u.length;m++){const b=a[m];for(let P=0;P<b.length;P++)d.push(u[m])}return d},r.V=function(a){$t(this);let u=[];if(typeof a=="string")zl(this,a)&&(u=u.concat(this.g.get(Yn(this,a))));else{a=Array.from(this.g.values());for(let d=0;d<a.length;d++)u=u.concat(a[d])}return u},r.set=function(a,u){return $t(this),this.i=null,a=Yn(this,a),zl(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[u]),this.h+=1,this},r.get=function(a,u){return a?(a=this.V(a),0<a.length?String(a[0]):u):u};function Gl(a,u,d){ql(a,u),0<d.length&&(a.i=null,a.g.set(Yn(a,u),V(d)),a.h+=d.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],u=Array.from(this.g.keys());for(var d=0;d<u.length;d++){var m=u[d];const P=encodeURIComponent(String(m)),N=this.V(m);for(m=0;m<N.length;m++){var b=P;N[m]!==""&&(b+="="+encodeURIComponent(String(N[m]))),a.push(b)}}return this.i=a.join("&")};function Yn(a,u){return u=String(u),a.j&&(u=u.toLowerCase()),u}function Xp(a,u){u&&!a.j&&($t(a),a.i=null,a.g.forEach(function(d,m){var b=m.toLowerCase();m!=b&&(ql(this,m),Gl(this,b,d))},a)),a.j=u}function Yp(a,u){const d=new jr;if(c.Image){const m=new Image;m.onload=S(jt,d,"TestLoadImage: loaded",!0,u,m),m.onerror=S(jt,d,"TestLoadImage: error",!1,u,m),m.onabort=S(jt,d,"TestLoadImage: abort",!1,u,m),m.ontimeout=S(jt,d,"TestLoadImage: timeout",!1,u,m),c.setTimeout(function(){m.ontimeout&&m.ontimeout()},1e4),m.src=a}else u(!1)}function Zp(a,u){const d=new jr,m=new AbortController,b=setTimeout(()=>{m.abort(),jt(d,"TestPingServer: timeout",!1,u)},1e4);fetch(a,{signal:m.signal}).then(P=>{clearTimeout(b),P.ok?jt(d,"TestPingServer: ok",!0,u):jt(d,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(b),jt(d,"TestPingServer: error",!1,u)})}function jt(a,u,d,m,b){try{b&&(b.onload=null,b.onerror=null,b.onabort=null,b.ontimeout=null),m(d)}catch{}}function eg(){this.g=new Lp}function tg(a,u,d){const m=d||"";try{Ul(a,function(b,P){let N=b;h(b)&&(N=Go(b)),u.push(m+P+"="+encodeURIComponent(N))})}catch(b){throw u.push(m+"type="+encodeURIComponent("_badmap")),b}}function oi(a){this.l=a.Ub||null,this.j=a.eb||!1}k(oi,Ko),oi.prototype.g=function(){return new ai(this.l,this.j)},oi.prototype.i=function(a){return function(){return a}}({});function ai(a,u){Ne.call(this),this.D=a,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}k(ai,Ne),r=ai.prototype,r.open=function(a,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=u,this.readyState=1,Wr(this)},r.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(u.body=a),(this.D||c).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Hr(this)),this.readyState=0},r.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Wr(this)),this.g&&(this.readyState=3,Wr(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Kl(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Kl(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}r.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var u=a.value?a.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!a.done}))&&(this.response=this.responseText+=u)}a.done?Hr(this):Wr(this),this.readyState==3&&Kl(this)}},r.Ra=function(a){this.g&&(this.response=this.responseText=a,Hr(this))},r.Qa=function(a){this.g&&(this.response=a,Hr(this))},r.ga=function(){this.g&&Hr(this)};function Hr(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Wr(a)}r.setRequestHeader=function(a,u){this.u.append(a,u)},r.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],u=this.h.entries();for(var d=u.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=u.next();return a.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const On=new nc("@firebase/firestore");function ir(){return On.logLevel}function D(r,...e){if(On.logLevel<=Y.DEBUG){const t=e.map(fc);On.debug(`Firestore (${xr}): ${r}`,...t)}}function Ee(r,...e){if(On.logLevel<=Y.ERROR){const t=e.map(fc);On.error(`Firestore (${xr}): ${r}`,...t)}}function As(r,...e){if(On.logLevel<=Y.WARN){const t=e.map(fc);On.warn(`Firestore (${xr}): ${r}`,...t)}}function fc(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e,t,n,s){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=s}}function ka(r){return r.fields.find(e=>e.kind===2)}function En(r){return r.fields.filter(e=>e.kind!==2)}Hi.UNKNOWN_ID=-1;class Pi{constructor(e,t){this.fieldPath=e,this.kind=t}}class Ss{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new Ss(0,rt.min())}}function of(r,e){const t=r.toTimestamp().seconds,n=r.toTimestamp().nanoseconds+1,s=z.fromTimestamp(n===1e9?new ge(t+1,0):new ge(t,n));return new rt(s,O.empty(),e)}function af(r){return new rt(r.readTime,r.key,-1)}class rt{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new rt(z.min(),O.empty(),-1)}static max(){return new rt(z.max(),O.empty(),-1)}}function mc(r,e){let t=r.readTime.compareTo(e.readTime);return t!==0?t:(t=O.comparator(r.documentKey,e.documentKey),t!==0?t:Q(r.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function un(r){if(r.code!==C.FAILED_PRECONDITION||r.message!==cf)throw r;D("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cE=new Rn([4294967295,4294967295],0);function uh(r){const e=aE().encode(r),t=new Xd;return t.update(e),new Uint8Array(t.digest())}function hh(r){const e=new DataView(r.buffer),t=e.getUint32(0,!0),n=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new Rn([t,n],0),new Rn([s,i],0)]}class Rc{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new cs(`Invalid padding: ${t}`);if(n<0)throw new cs(`Invalid hash count: ${n}`);if(e.length>0&&this.hashCount===0)throw new cs(`Invalid hash count: ${n}`);if(e.length===0&&t!==0)throw new cs(`Invalid padding when bitmap length is 0: ${t}`);this.Ie=8*e.length-t,this.Te=Rn.fromNumber(this.Ie)}Ee(e,t,n){let s=e.add(t.multiply(Rn.fromNumber(n)));return s.compare(cE)===1&&(s=new Rn([s.getBits(0),s.getBits(1)],0)),s.modulo(this.Te).toNumber()}de(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}mightContain(e){if(this.Ie===0)return!1;const t=uh(e),[n,s]=hh(t);for(let i=0;i<this.hashCount;i++){const o=this.Ee(n,s,i);if(!this.de(o))return!1}return!0}static create(e,t,n){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new Rc(i,s,t);return n.forEach(c=>o.insert(c)),o}insert(e){if(this.Ie===0)return;const t=uh(e),[n,s]=hh(t);for(let i=0;i<this.hashCount;i++){const o=this.Ee(n,s,i);this.Ae(o)}}Ae(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class cs extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bE{getBundleMetadata(e,t){return vh(e).get(t).next(n=>{if(n)return function(i){return{id:i.bundleId,createTime:Bn(i.createTime),version:i.version}}(n)})}saveBundleMetadata(e,t){return vh(e).put(function(s){return{bundleId:s.id,createTime:Un(He(s.createTime)),version:s.version}}(t))}getNamedQuery(e,t){return Ih(e).get(t).next(n=>{if(n)return function(i){return{name:i.name,query:om(i.bundledQuery),readTime:Bn(i.readTime)}}(n)})}saveNamedQuery(e,t){return Ih(e).put(function(s){return{name:s.name,readTime:Un(He(s.readTime)),bundledQuery:s.bundledQuery}}(t))}}function vh(r){return Re(r,"bundles")}function Ih(r){return Re(r,"namedQueries")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class An{constructor(e,t,n,s){this.indexId=e,this.documentKey=t,this.arrayValue=n,this.directionalValue=s}Zt(){const e=this.directionalValue.length,t=e===0||this.directionalValue[e-1]===255?e+1:e,n=new Uint8Array(t);return n.set(this.directionalValue,0),t!==e?n.set([0],this.directionalValue.length):++n[n.length-1],new An(this.indexId,this.documentKey,this.arrayValue,n)}}function zt(r,e){let t=r.indexId-e.indexId;return t!==0?t:(t=wh(r.arrayValue,e.arrayValue),t!==0?t:(t=wh(r.directionalValue,e.directionalValue),t!==0?t:O.comparator(r.documentKey,e.documentKey)))}function wh(r,e){for(let t=0;t<r.length&&t<e.length;++t){const n=r[t]-e[t];if(n!==0)return n}return r.length-e.length}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _i=new Uint8Array(0);class DE{constructor(e,t){this.databaseId=t,this.cn=new Cc,this.ln=new dn(n=>Fn(n),(n,s)=>qs(n,s)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.cn.has(t)){const n=t.lastSegment(),s=t.popLast();e.addOnCommittedListener(()=>{this.cn.add(t)});const i={collectionId:n,parent:Ke(s)};return Ah(e).put(i)}return R.resolve()}getCollectionParents(e,t){const n=[],s=IDBKeyRange.bound([t,""],[sf(t),""],!1,!0);return Ah(e).U(s).next(i=>{for(const o of i){if(o.collectionId!==t)break;n.push(ft(o.parent))}return n})}addFieldIndex(e,t){const n=Zr(e),s=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(l=>[l.fieldPath.canonicalString(),l.kind])}}(t);delete s.indexId;const i=n.add(s);if(t.indexState){const o=rr(e);return i.next(c=>{o.put(yh(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){const n=Zr(e),s=rr(e),i=nr(e);return n.delete(t.indexId).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=Zr(e),n=nr(e),s=rr(e);return t.j().next(()=>n.j()).next(()=>s.j())}createTargetIndexes(e,t){return R.forEach(this.hn(t),n=>this.getIndexType(e,n).next(s=>{if(s===0||s===1){const i=new Th(n).an();if(i!=null)return this.addFieldIndex(e,i)}}))}getDocumentsMatchingTarget(e,t){const n=nr(e);let s=!0;const i=new Map;return R.forEach(this.hn(t),o=>this.Pn(e,o).next(c=>{s&&(s=!!c),i.set(o,c)})).next(()=>{if(s){let o=J();const c=[];return R.forEach(i,(l,h)=>{D("IndexedDbIndexManager",`Using index ${function(M){return`id=${M.indexId}|cg=${M.collectionGroup}|f=${M.fields.map(q=>`${q.fieldPath}:${q.kind}`).join(",")}`}(l)} to execute ${Fn(t)}`);const f=function(M,q){const X=ka(q);if(X===void 0)return null;for(const W of Ji(M,X.fieldPath))switch(W.op){case"array-contains-any":return W.value.arrayValue.values||[];case"array-contains":return[W.value]}return null}(h,l),p=function(M,q){const X=new Map;for(const W of En(q))for(const E of Ji(M,W.fieldPath))switch(E.op){case"==":case"in":X.set(W.fieldPath.canonicalString(),E.value);break;case"not-in":case"!=":return X.set(W.fieldPath.canonicalString(),E.value),Array.from(X.values())}return null}(h,l),y=function(M,q){const X=[];let W=!0;for(const E of En(q)){const g=E.kind===0?rh(M,E.fieldPath,M.startAt):sh(M,E.fieldPath,M.startAt);X.push(g.value),W&&(W=g.inclusive)}return new yr(X,W)}(h,l),S=function(M,q){const X=[];let W=!0;for(const E of En(q)){const g=E.kind===0?sh(M,E.fieldPath,M.endAt):rh(M,E.fieldPath,M.endAt);X.push(g.value),W&&(W=g.inclusive)}return new yr(X,W)}(h,l),k=this.In(l,h,y),V=this.In(l,h,S),x=this.Tn(l,h,p),G=this.En(l.indexId,f,k,y.inclusive,V,S.inclusive,x);return R.forEach(G,B=>n.G(B,t.limit).next(M=>{M.forEach(q=>{const X=O.fromSegments(q.documentKey);o.has(X)||(o=o.add(X),c.push(X))})}))}).next(()=>c)}return R.resolve(null)})}hn(e){let t=this.ln.get(e);return t||(e.filters.length===0?t=[e]:t=xE(ce.create(e.filters,"and")).map(n=>Ma(e.path,e.collectionGroup,e.orderBy,n.getFilters(),e.limit,e.startAt,e.endAt)),this.ln.set(e,t),t)}En(e,t,n,s,i,o,c){const l=(t!=null?t.length:1)*Math.max(n.length,i.length),h=l/(t!=null?t.length:1),f=[];for(let p=0;p<l;++p){const y=t?this.dn(t[p/h]):_i,S=this.An(e,y,n[p%h],s),k=this.Rn(e,y,i[p%h],o),V=c.map(x=>this.An(e,y,x,!0));f.push(...this.createRange(S,k,V))}return f}An(e,t,n,s){const i=new An(e,O.empty(),t,n);return s?i:i.Zt()}Rn(e,t,n,s){const i=new An(e,O.empty(),t,n);return s?i.Zt():i}Pn(e,t){const n=new Th(t),s=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,s).next(i=>{let o=null;for(const c of i)n.rn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let n=2;const s=this.hn(t);return R.forEach(s,i=>this.Pn(e,i).next(o=>{o?n!==0&&o.fields.length<function(l){let h=new le(pe.comparator),f=!1;for(const p of l.filters)for(const y of p.getFlattenedFilters())y.field.isKeyField()||(y.op==="array-contains"||y.op==="array-contains-any"?f=!0:h=h.add(y.field));for(const p of l.orderBy)p.field.isKeyField()||(h=h.add(p.field));return h.size+(f?1:0)}(i)&&(n=1):n=0})).next(()=>function(o){return o.limit!==null}(t)&&s.length>1&&n===2?1:n)}Vn(e,t){const n=new Yr;for(const s of En(e)){const i=t.data.field(s.fieldPath);if(i==null)return null;const o=n.Yt(s.kind);bn.vt.It(i,o)}return n.zt()}dn(e){const t=new Yr;return bn.vt.It(e,t.Yt(0)),t.zt()}mn(e,t){const n=new Yr;return bn.vt.It(vc(this.databaseId,t),n.Yt(function(i){const o=En(i);return o.length===0?0:o[o.length-1].kind}(e))),n.zt()}Tn(e,t,n){if(n===null)return[];let s=[];s.push(new Yr);let i=0;for(const o of En(e)){const c=n[i++];for(const l of s)if(this.fn(t,o.fieldPath)&&ks(c))s=this.gn(s,o,c);else{const h=l.Yt(o.kind);bn.vt.It(c,h)}}return this.pn(s)}In(e,t,n){return this.Tn(e,t,n.position)}pn(e){const t=[];for(let n=0;n<e.length;++n)t[n]=e[n].zt();return t}gn(e,t,n){const s=[...e],i=[];for(const o of n.arrayValue.values||[])for(const c of s){const l=new Yr;l.seed(c.zt()),bn.vt.It(o,l.Yt(t.kind)),i.push(l)}return i}fn(e,t){return!!e.filters.find(n=>n instanceof ee&&n.field.isEqual(t)&&(n.op==="in"||n.op==="not-in"))}getFieldIndexes(e,t){const n=Zr(e),s=rr(e);return(t?n.U("collectionGroupIndex",IDBKeyRange.bound(t,t)):n.U()).next(i=>{const o=[];return R.forEach(i,c=>s.get([c.indexId,this.uid]).next(l=>{o.push(function(f,p){const y=p?new Ss(p.sequenceNumber,new rt(Bn(p.readTime),new O(ft(p.documentKey)),p.largestBatchId)):Ss.empty(),S=f.fields.map(([k,V])=>new Pi(pe.fromServerFormat(k),V));return new Hi(f.indexId,f.collectionGroup,S,y)}(c,l))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((n,s)=>{const i=n.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:Q(n.collectionGroup,s.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,n){const s=Zr(e),i=rr(e);return this.yn(e).next(o=>s.U("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(c=>R.forEach(c,l=>i.put(yh(l.indexId,this.uid,o,n)))))}updateIndexEntries(e,t){const n=new Map;return R.forEach(t,(s,i)=>{const o=n.get(s.collectionGroup);return(o?R.resolve(o):this.getFieldIndexes(e,s.collectionGroup)).next(c=>(n.set(s.collectionGroup,c),R.forEach(c,l=>this.wn(e,s,l).next(h=>{const f=this.Sn(i,l);return h.isEqual(f)?R.resolve():this.bn(e,i,l,h,f)}))))})}Dn(e,t,n,s){return nr(e).put({indexId:s.indexId,uid:this.uid,arrayValue:s.arrayValue,directionalValue:s.directionalValue,orderedDocumentKey:this.mn(n,t.key),documentKey:t.key.path.toArray()})}vn(e,t,n,s){return nr(e).delete([s.indexId,this.uid,s.arrayValue,s.directionalValue,this.mn(n,t.key),t.key.path.toArray()])}wn(e,t,n){const s=nr(e);let i=new le(zt);return s.J({index:"documentKeyIndex",range:IDBKeyRange.only([n.indexId,this.uid,this.mn(n,t)])},(o,c)=>{i=i.add(new An(n.indexId,t,c.arrayValue,c.directionalValue))}).next(()=>i)}Sn(e,t){let n=new le(zt);const s=this.Vn(t,e);if(s==null)return n;const i=ka(t);if(i!=null){const o=e.data.field(i.fieldPath);if(ks(o))for(const c of o.arrayValue.values||[])n=n.add(new An(t.indexId,e.key,this.dn(c),s))}else n=n.add(new An(t.indexId,e.key,_i,s));return n}bn(e,t,n,s,i){D("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const o=[];return function(l,h,f,p,y){const S=l.getIterator(),k=h.getIterator();let V=tr(S),x=tr(k);for(;V||x;){let G=!1,B=!1;if(V&&x){const M=f(V,x);M<0?B=!0:M>0&&(G=!0)}else V!=null?B=!0:G=!0;G?(p(x),x=tr(k)):B?(y(V),V=tr(S)):(V=tr(S),x=tr(k))}}(s,i,zt,c=>{o.push(this.Dn(e,t,n,c))},c=>{o.push(this.vn(e,t,n,c))}),R.waitFor(o)}yn(e){let t=1;return rr(e).J({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(n,s,i)=>{i.done(),t=s.sequenceNumber+1}).next(()=>t)}createRange(e,t,n){n=n.sort((o,c)=>zt(o,c)).filter((o,c,l)=>!c||zt(o,l[c-1])!==0);const s=[];s.push(e);for(const o of n){const c=zt(o,e),l=zt(o,t);if(c===0)s[0]=e.Zt();else if(c>0&&l<0)s.push(o),s.push(o.Zt());else if(l>0)break}s.push(t);const i=[];for(let o=0;o<s.length;o+=2){if(this.Cn(s[o],s[o+1]))return[];const c=[s[o].indexId,this.uid,s[o].arrayValue,s[o].directionalValue,_i,[]],l=[s[o+1].indexId,this.uid,s[o+1].arrayValue,s[o+1].directionalValue,_i,[]];i.push(IDBKeyRange.bound(c,l))}return i}Cn(e,t){return zt(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(Rh)}getMinOffset(e,t){return R.mapArray(this.hn(t),n=>this.Pn(e,n).next(s=>s||F())).next(Rh)}}function Ah(r){return Re(r,"collectionParents")}function nr(r){return Re(r,"indexEntries")}function Zr(r){return Re(r,"indexConfiguration")}function rr(r){return Re(r,"indexState")}function Rh(r){$(r.length!==0);let e=r[0].indexState.offset,t=e.largestBatchId;for(let n=1;n<r.length;n++){const s=r[n].indexState.offset;mc(s,e)<0&&(e=s),t<s.largestBatchId&&(t=s.largestBatchId)}return new rt(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lm(r,e,t){const n=r.store("mutations"),s=r.store("documentMutations"),i=[],o=IDBKeyRange.only(t.batchId);let c=0;const l=n.J({range:o},(f,p,y)=>(c++,y.delete()));i.push(l.next(()=>{$(c===1)}));const h=[];for(const f of t.mutations){const p=df(e,f.key.path,t.batchId);i.push(s.delete(p)),h.push(f.key)}return R.waitFor(i).next(()=>h)}function to(r){if(!r)return 0;let e;if(r.document)e=r.document;else if(r.unknownDocument)e=r.unknownDocument;else{if(!r.noDocument)throw F();e=r.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Qe.DEFAULT_COLLECTION_PERCENTILE=10,Qe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Qe.DEFAULT=new Qe(41943040,Qe.DEFAULT_COLLECTION_PERCENTILE,Qe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Qe.DISABLED=new Qe(-1,0,0);class bo{constructor(e,t,n,s){this.userId=e,this.serializer=t,this.indexManager=n,this.referenceDelegate=s,this.Fn={}}static lt(e,t,n,s){$(e.uid!=="");const i=e.isAuthenticated()?e.uid:"";return new bo(i,t,n,s)}checkEmpty(e){let t=!0;const n=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return Gt(e).J({index:"userMutationsIndex",range:n},(s,i,o)=>{t=!1,o.done()}).next(()=>t)}addMutationBatch(e,t,n,s){const i=lr(e),o=Gt(e);return o.add({}).next(c=>{$(typeof c=="number");const l=new Tc(c,t,n,s),h=function(S,k,V){const x=V.baseMutations.map(B=>Yi(S.ct,B)),G=V.mutations.map(B=>Yi(S.ct,B));return{userId:k,batchId:V.batchId,localWriteTimeMs:V.localWriteTime.toMillis(),baseMutations:x,mutations:G}}(this.serializer,this.userId,l),f=[];let p=new le((y,S)=>Q(y.canonicalString(),S.canonicalString()));for(const y of s){const S=df(this.userId,y.key.path,c);p=p.add(y.key.path.popLast()),f.push(o.put(h)),f.push(i.put(S,pI))}return p.forEach(y=>{f.push(this.indexManager.addToCollectionParentIndex(e,y))}),e.addOnCommittedListener(()=>{this.Fn[c]=l.keys()}),R.waitFor(f).next(()=>l)})}lookupMutationBatch(e,t){return Gt(e).get(t).next(n=>n?($(n.userId===this.userId),Tn(this.serializer,n)):null)}Mn(e,t){return this.Fn[t]?R.resolve(this.Fn[t]):this.lookupMutationBatch(e,t).next(n=>{if(n){const s=n.keys();return this.Fn[t]=s,s}return null})}getNextMutationBatchAfterBatchId(e,t){const n=t+1,s=IDBKeyRange.lowerBound([this.userId,n]);let i=null;return Gt(e).J({index:"userMutationsIndex",range:s},(o,c,l)=>{c.userId===this.userId&&($(c.batchId>=n),i=Tn(this.serializer,c)),l.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(e){const t=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let n=-1;return Gt(e).J({index:"userMutationsIndex",range:t,reverse:!0},(s,i,o)=>{n=i.batchId,o.done()}).next(()=>n)}getAllMutationBatches(e){const t=IDBKeyRange.bound([this.userId,-1],[this.userId,Number.POSITIVE_INFINITY]);return Gt(e).U("userMutationsIndex",t).next(n=>n.map(s=>Tn(this.serializer,s)))}getAllMutationBatchesAffectingDocumentKey(e,t){const n=Ci(this.userId,t.path),s=IDBKeyRange.lowerBound(n),i=[];return lr(e).J({range:s},(o,c,l)=>{const[h,f,p]=o,y=ft(f);if(h===this.userId&&t.path.isEqual(y))return Gt(e).get(p).next(S=>{if(!S)throw F();$(S.userId===this.userId),i.push(Tn(this.serializer,S))});l.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new le(Q);const s=[];return t.forEach(i=>{const o=Ci(this.userId,i.path),c=IDBKeyRange.lowerBound(o),l=lr(e).J({range:c},(h,f,p)=>{const[y,S,k]=h,V=ft(S);y===this.userId&&i.path.isEqual(V)?n=n.add(k):p.done()});s.push(l)}),R.waitFor(s).next(()=>this.xn(e,n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,s=n.length+1,i=Ci(this.userId,n),o=IDBKeyRange.lowerBound(i);let c=new le(Q);return lr(e).J({range:o},(l,h,f)=>{const[p,y,S]=l,k=ft(y);p===this.userId&&n.isPrefixOf(k)?k.length===s&&(c=c.add(S)):f.done()}).next(()=>this.xn(e,c))}xn(e,t){const n=[],s=[];return t.forEach(i=>{s.push(Gt(e).get(i).next(o=>{if(o===null)throw F();$(o.userId===this.userId),n.push(Tn(this.serializer,o))}))}),R.waitFor(s).next(()=>n)}removeMutationBatch(e,t){return lm(e._e,this.userId,t).next(n=>(e.addOnCommittedListener(()=>{this.On(t.batchId)}),R.forEach(n,s=>this.referenceDelegate.markPotentiallyOrphaned(e,s))))}On(e){delete this.Fn[e]}performConsistencyCheck(e){return this.checkEmpty(e).next(t=>{if(!t)return R.resolve();const n=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),s=[];return lr(e).J({range:n},(i,o,c)=>{if(i[0]===this.userId){const l=ft(i[1]);s.push(l)}else c.done()}).next(()=>{$(s.length===0)})})}containsKey(e,t){return um(e,this.userId,t)}Nn(e){return hm(e).get(this.userId).next(t=>t||{userId:this.userId,lastAcknowledgedBatchId:-1,lastStreamToken:""})}}function um(r,e,t){const n=Ci(e,t.path),s=n[1],i=IDBKeyRange.lowerBound(n);let o=!1;return lr(r).J({range:i,H:!0},(c,l,h)=>{const[f,p,y]=c;f===e&&p===s&&(o=!0),h.done()}).next(()=>o)}function Gt(r){return Re(r,"mutations")}function lr(r){return Re(r,"documentMutations")}function hm(r){return Re(r,"mutationQueues")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dm{constructor(){this.changes=new dn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ye.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return n!==void 0?R.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UE{constructor(e){this.serializer=e}setIndexManager(e){this.indexManager=e}addEntry(e,t,n){return vn(e).put(n)}removeEntry(e,t,n){return vn(e).delete(function(i,o){const c=i.path.toArray();return[c.slice(0,c.length-2),c[c.length-2],Zi(o),c[c.length-1]]}(t,n))}updateMetadata(e,t){return this.getMetadata(e).next(n=>(n.byteSize+=t,this.rr(e,n)))}getEntry(e,t){let n=ye.newInvalidDocument(t);return vn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(es(t))},(s,i)=>{n=this.ir(t,i)}).next(()=>n)}sr(e,t){let n={size:0,document:ye.newInvalidDocument(t)};return vn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(es(t))},(s,i)=>{n={document:this.ir(t,i),size:to(i)}}).next(()=>n)}getEntries(e,t){let n=et();return this._r(e,t,(s,i)=>{const o=this.ir(s,i);n=n.insert(s,o)}).next(()=>n)}ar(e,t){let n=et(),s=new de(O.comparator);return this._r(e,t,(i,o)=>{const c=this.ir(i,o);n=n.insert(i,c),s=s.insert(i,to(o))}).next(()=>({documents:n,ur:s}))}_r(e,t,n){if(t.isEmpty())return R.resolve();let s=new le(Dh);t.forEach(l=>s=s.add(l));const i=IDBKeyRange.bound(es(s.first()),es(s.last())),o=s.getIterator();let c=o.getNext();return vn(e).J({index:"documentKeyIndex",range:i},(l,h,f)=>{const p=O.fromSegments([...h.prefixPath,h.collectionGroup,h.documentId]);for(;c&&Dh(c,p)<0;)n(c,null),c=o.getNext();c&&c.isEqual(p)&&(n(c,h),c=o.hasNext()?o.getNext():null),c?f.$(es(c)):f.done()}).next(()=>{for(;c;)n(c,null),c=o.hasNext()?o.getNext():null})}getDocumentsMatchingQuery(e,t,n,s,i){const o=t.path,c=[o.popLast().toArray(),o.lastSegment(),Zi(n.readTime),n.documentKey.path.isEmpty()?"":n.documentKey.path.lastSegment()],l=[o.popLast().toArray(),o.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return vn(e).U(IDBKeyRange.bound(c,l,!0)).next(h=>{i==null||i.incrementDocumentReadCount(h.length);let f=et();for(const p of h){const y=this.ir(O.fromSegments(p.prefixPath.concat(p.collectionGroup,p.documentId)),p);y.isFoundDocument()&&(zs(t,y)||s.has(y.key))&&(f=f.insert(y.key,y))}return f})}getAllFromCollectionGroup(e,t,n,s){let i=et();const o=kh(t,n),c=kh(t,rt.max());return vn(e).J({index:"collectionGroupIndex",range:IDBKeyRange.bound(o,c,!0)},(l,h,f)=>{const p=this.ir(O.fromSegments(h.prefixPath.concat(h.collectionGroup,h.documentId)),h);i=i.insert(p.key,p),i.size===s&&f.done()}).next(()=>i)}newChangeBuffer(e){return new BE(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next(t=>t.byteSize)}getMetadata(e){return xh(e).get("remoteDocumentGlobalKey").next(t=>($(!!t),t))}rr(e,t){return xh(e).put("remoteDocumentGlobalKey",t)}ir(e,t){if(t){const n=TE(this.serializer,t);if(!(n.isNoDocument()&&n.version.isEqual(z.min())))return n}return ye.newInvalidDocument(e)}}function fm(r){return new UE(r)}class BE extends dm{constructor(e,t){super(),this.cr=e,this.trackRemovals=t,this.lr=new dn(n=>n.toString(),(n,s)=>n.isEqual(s))}applyChanges(e){const t=[];let n=0,s=new le((i,o)=>Q(i.canonicalString(),o.canonicalString()));return this.changes.forEach((i,o)=>{const c=this.lr.get(i);if(t.push(this.cr.removeEntry(e,i,c.readTime)),o.isValidDocument()){const l=gh(this.cr.serializer,o);s=s.add(i.path.popLast());const h=to(l);n+=h-c.size,t.push(this.cr.addEntry(e,i,l))}else if(n-=c.size,this.trackRemovals){const l=gh(this.cr.serializer,o.convertToNoDocument(z.min()));t.push(this.cr.addEntry(e,i,l))}}),s.forEach(i=>{t.push(this.cr.indexManager.addToCollectionParentIndex(e,i))}),t.push(this.cr.updateMetadata(e,n)),R.waitFor(t)}getFromCache(e,t){return this.cr.sr(e,t).next(n=>(this.lr.set(t,{size:n.size,readTime:n.document.readTime}),n.document))}getAllFromCache(e,t){return this.cr.ar(e,t).next(({documents:n,ur:s})=>(s.forEach((i,o)=>{this.lr.set(i,{size:o,readTime:n.get(i).readTime})}),n))}}function xh(r){return Re(r,"remoteDocumentGlobal")}function vn(r){return Re(r,"remoteDocumentsV14")}function es(r){const e=r.path.toArray();return[e.slice(0,e.length-2),e[e.length-2],e[e.length-1]]}function kh(r,e){const t=e.documentKey.path.toArray();return[r,Zi(e.readTime),t.slice(0,t.length-2),t.length>0?t[t.length-1]:""]}function Dh(r,e){const t=r.path.toArray(),n=e.path.toArray();let s=0;for(let i=0;i<t.length-2&&i<n.length-2;++i)if(s=Q(t[i],n[i]),s)return s;return s=Q(t.length,n.length),s||(s=Q(t[t.length-2],n[n.length-2]),s||Q(t[t.length-1],n[n.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hm(r,e,t){if(!t)throw new L(C.INVALID_ARGUMENT,`Function ${r}() cannot be called with an empty ${e}.`)}function eT(r,e,t,n){if(e===!0&&n===!0)throw new L(C.INVALID_ARGUMENT,`${r} and ${t} cannot be used together.`)}function Gh(r){if(!O.isDocumentKey(r))throw new L(C.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${r} has ${r.length}.`)}function Kh(r){if(O.isDocumentKey(r))throw new L(C.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${r} has ${r.length}.`)}function Gc(r){if(r===void 0)return"undefined";if(r===null)return"null";if(typeof r=="string")return r.length>20&&(r=`${r.substring(0,20)}...`),JSON.stringify(r);if(typeof r=="number"||typeof r=="boolean")return""+r;if(typeof r=="object"){if(r instanceof Array)return"an array";{const e=function(n){return n.constructor?n.constructor.name:null}(r);return e?`a custom ${e} object`:"an object"}}return typeof r=="function"?"a function":F()}function It(r,e){if("_delegate"in r&&(r=r._delegate),!(r instanceof e)){if(e.name===r.constructor.name)throw new L(C.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const t=Gc(r);throw new L(C.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${t}`)}}return r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new xo(this.firestore,e,this._query)}}class Ye{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new nn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ye(this.firestore,e,this._key)}}class nn extends xo{constructor(e,t,n){super(e,t,yo(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ye(this.firestore,null,new O(e))}withConverter(e){return new nn(this.firestore,e,this._path)}}function Pn(r,e,...t){if(r=we(r),Hm("collection","path",e),r instanceof Kc){const n=oe.fromString(e,...t);return Kh(n),new nn(r,null,n)}{if(!(r instanceof Ye||r instanceof nn))throw new L(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(oe.fromString(e,...t));return Kh(n),new nn(r.firestore,null,n)}}function ae(r,e,...t){if(r=we(r),arguments.length===1&&(e=rf.newId()),Hm("doc","path",e),r instanceof Kc){const n=oe.fromString(e,...t);return Gh(n),new Ye(r,null,new O(n))}{if(!(r instanceof Ye||r instanceof nn))throw new L(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(oe.fromString(e,...t));return Gh(n),new Ye(r.firestore,r instanceof nn?r.converter:null,new O(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Pr(Te.fromBase64String(e))}catch(t){throw new L(C.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Pr(Te.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new L(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new pe(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=tt.makeFromUrl(e,t)}catch{return new tt(e,"")}if(n.path==="")return n;throw DT(e)}static makeFromUrl(e,t){let n=null;const s="([A-Za-z0-9.\\-_]+)";function i(q){q.path.charAt(q.path.length-1)==="/"&&(q.path_=q.path_.slice(0,-1))}const o="(/(.*))?$",c=new RegExp("^gs://"+s+o,"i"),l={bucket:1,path:3};function h(q){q.path_=decodeURIComponent(q.path)}const f="v[A-Za-z0-9_]+",p=t.replace(/[.]/g,"\\."),y="(/([^?#]*).*)?$",S=new RegExp(`^https?://${p}/${f}/b/${s}/o${y}`,"i"),k={bucket:1,path:3},V=t===ip?"(?:storage.googleapis.com|storage.cloud.google.com)":t,x="([^?#]*)",G=new RegExp(`^https?://${V}/${s}/${x}`,"i"),M=[{regex:c,indices:l,postModify:i},{regex:S,indices:k,postModify:h},{regex:G,indices:{bucket:1,path:2},postModify:h}];for(let q=0;q<M.length;q++){const X=M[q],W=X.regex.exec(e);if(W){const E=W[X.indices.bucket];let g=W[X.indices.path];g||(g=""),n=new tt(E,g),X.postModify(n);break}}if(n==null)throw kT(e);return n}}class FT{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UT(r,e,t){let n=1,s=null,i=null,o=!1,c=0;function l(){return c===2}let h=!1;function f(...x){h||(h=!0,e.apply(null,x))}function p(x){s=setTimeout(()=>{s=null,r(S,l())},x)}function y(){i&&clearTimeout(i)}function S(x,...G){if(h){y();return}if(x){y(),f.call(null,x,...G);return}if(l()||o){y(),f.call(null,x,...G);return}n<64&&(n*=2);let M;c===1?(c=2,M=0):M=(n+Math.random())*1e3,p(M)}let k=!1;function V(x){k||(k=!0,y(),!h&&(s!==null?(x||(c=2),clearTimeout(s),p(0)):x||(c=1)))}return p(0),i=setTimeout(()=>{o=!0,V(!0)},t),V}function BT(r){r(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sl(r,e,t){let n=e;return t==null&&(n=`https://${e}`),`${t}://${n}/v0${r}`}function cp(r){const e=encodeURIComponent;let t="?";for(const n in r)if(r.hasOwnProperty(n)){const s=e(n)+"="+e(r[n]);t=t+s+"&"}return t=t.slice(0,-1),t}var Cn;(function(r){r[r.NO_ERROR=0]="NO_ERROR",r[r.NETWORK_ERROR=1]="NETWORK_ERROR",r[r.ABORT=2]="ABORT"})(Cn||(Cn={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const wp="storage";function ol(r,e,t,n){return r=we(r),wb(r,e,t,n)}function al(r){return r=we(r),Tb(r)}function cl(r,e){return r=we(r),Sb(r,e)}function Cb(r=md(),e){r=we(r);const n=lo(r,wp).getImmediate({identifier:e}),s=fg("storage");return s&&xb(n,...s),n}function xb(r,e,t,n={}){Pb(r,e,t,n)}function kb(r,{instanceIdentifier:e}){const t=r.getProvider("app").getImmediate(),n=r.getProvider("auth-internal"),s=r.getProvider("app-check-internal");return new il(t,n,s,e,Gn)}function Db(){Dn(new sn(wp,kb,"PUBLIC").setMultipleInstances(!0)),pt(Yh,Zh,""),pt(Yh,Zh,"esm2017")}Db();const Vb={apiKey:"AIzaSyD6jfZeueaQfBhlI5Mz6766c3k--gCwIjc",authDomain:"archery-app-70e20.firebaseapp.com",projectId:"archery-app-70e20",storageBucket:"archery-app-70e20.firebasestorage.app",messagingSenderId:"1025324581093",appId:"1:1025324581093:web:03b41dbee9cc81c6eb540c"},ll=fd(Vb),Qs=Zv(ll),te=tT(ll,{localCache:_T({tabManager:ET()})}),ul=Cb(ll),Tp="archery_v5",Nb="archery_v4";function ed(){try{const r=JSON.parse(localStorage.getItem(Tp)||"null");if(r)return r;const e=JSON.parse(localStorage.getItem(Nb)||"{}");return{friends:e.friends||[],rounds:e.rounds||[],courses:e.courses||[]}}catch{return{friends:[],rounds:[],courses:[]}}}function rn(){try{localStorage.setItem(Tp,JSON.stringify({friends:_.friends,rounds:_.rounds.slice(0,200),courses:_.courses}))}catch{}}const Ob=[11,10,8,5,"M"];function zn(r){return r==="M"||r==null?0:Number(r)}function Mo(r){return r?r.split(";").map(e=>e.split(",").map(t=>t==="M"?"M":Number(t))):[]}function Lb(r){return r.map(e=>e.map(t=>t??"M").join(",")).join(";")}function it(r){return r.flat().reduce((e,t)=>e+zn(t),0)}function Mb(r,e){const t=r.flatMap(n=>(n.scores[e]||[]).filter(s=>s!=null).map(zn));return t.length?(t.reduce((n,s)=>n+s,0)/t.length).toFixed(1):null}function Fb(r){const e={11:0,10:0,8:0,5:0,M:0};return r.flat().forEach(t=>{t==="M"?e.M++:t!=null&&e[Number(t)]!==void 0&&e[Number(t)]++}),e}function hl(r){return r.length?r.reduce((e,t)=>it(t.scores)>it(e.scores)?t:e,r[0]):null}function Ub(r,e){const t=r.flat().filter(n=>n!=null);return t.length?t.reduce((n,s)=>n+zn(s),0)/t.length<e:!1}function Bb(r,e,t){return{id:r,name:e,isGuest:!!t,scores:[]}}function $b(r,e){for(;r.scores.length<e;)r.scores.push([null,null])}function jb(r,e){let t=0;for(let n=0;n<e;n++)r.every(s=>{const i=s.scores[n]||[null,null];return i[0]!=null&&i[1]!=null})&&t++;return t}function bp(r){return{name:r.name,courseId:r.courseId||null,courseName:r.courseName||null,numTargets:r.numTargets,startTarget:r.startTarget||1,created:r.created,completed:r.completed||null,gpsRoute:r.gpsRoute||null,gpsDuration:r.gpsDuration||null,gpsDistance:r.gpsDistance||null,traversalOrder:r.traversalOrder,traversalPos:r.traversalPos||0,shooters:r.shooters.map(e=>({id:e.id,name:e.name,isGuest:e.isGuest||!1,scores:Lb(e.scores)}))}}function qb(r){return{...r,shooters:(r.shooters||[]).map(e=>({...e,scores:Mo(e.scores)}))}}let Li=null,Mi=!1,xn=!1,Za=[],Is=null,hs=0,ht=null,ec=null,rs=null;function zb(r){return r?r.split(";").map(e=>{const[t,n]=e.split(",").map(Number);return{lat:t,lng:n}}):[]}function dl(r,e){const n=(e.lat-r.lat)*Math.PI/180,s=(e.lng-r.lng)*Math.PI/180,i=Math.sin(n/2)**2+Math.cos(r.lat*Math.PI/180)*Math.cos(e.lat*Math.PI/180)*Math.sin(s/2)**2;return 6371e3*2*Math.atan2(Math.sqrt(i),Math.sqrt(1-i))}function Ap(r){return`${Math.floor(r/60).toString().padStart(2,"0")}:${(r%60).toString().padStart(2,"0")}`}function Rp(r){return r<1e3?`${Math.round(r)} m`:`${(r/1e3).toFixed(2)} km`}function Gb(r){return navigator.geolocation?(rs=r,Za=[],hs=0,ht=null,Is=Date.now(),xn=!1,Mi=!0,Li=navigator.geolocation.watchPosition(e=>{if(!Mi||xn)return;const t={lat:e.coords.latitude,lng:e.coords.longitude};ht&&(hs+=dl(ht,t)),ht=t,Za.push(t),rs&&rs({lat:t.lat,lng:t.lng,distance:hs,elapsed:Math.round((Date.now()-Is)/1e3)})},e=>console.warn(e),{enableHighAccuracy:!0,maximumAge:5e3,timeout:1e4}),ec=setInterval(()=>{Mi&&!xn&&rs&&rs({lat:ht==null?void 0:ht.lat,lng:ht==null?void 0:ht.lng,distance:hs,elapsed:Math.round((Date.now()-Is)/1e3)})},1e3),!0):!1}window.toggleGpsPause=function(){return xn=!xn,xn};function Sp(){return Mi=!1,xn=!1,Li!==null&&(navigator.geolocation.clearWatch(Li),Li=null),clearInterval(ec),ec=null,{route:Za.map(r=>`${r.lat},${r.lng}`).join(";"),distance:Math.round(hs),duration:Is?Math.round((Date.now()-Is)/1e3):0}}function Fo(){return new Promise((r,e)=>{if(!navigator.geolocation){e(new Error("GPS ikke understøttet"));return}navigator.geolocation.getCurrentPosition(t=>r({lat:t.coords.latitude,lng:t.coords.longitude}),e,{enableHighAccuracy:!0,timeout:1e4})})}function Kb(r,e){if(!(r!=null&&r.length)||!e)return 0;let t=1/0,n=0;return r.forEach((s,i)=>{if(!s.gps)return;const o=dl(e,s.gps);o<t&&(t=o,n=i)}),n}const _={user:null,profile:null,isAdmin:!1,friends:[],courses:[],rounds:[],round:null,course:null,currentCourse:null,courseMap:null,courseMapLayer:null,gpsTracking:!1,warnThreshold:8,deleteConfirm:{},editFriendId:null,finishTap:0,abortTap:0};let Fi=null;async function Hb(){try{"wakeLock"in navigator&&(Fi=await navigator.wakeLock.request("screen"))}catch{}}function fl(){Fi&&(Fi.release(),Fi=null)}function kn(r,e="error"){const t=document.getElementById("auth-err");t.textContent=r,t.style.color=e==="ok"?"var(--success)":"",t.classList.remove("hidden")}window.showAuthTab=function(r){document.querySelectorAll(".auth-tab").forEach((e,t)=>e.classList.toggle("active",t===0==(r==="login"))),document.getElementById("login-form").classList.toggle("hidden",r!=="login"),document.getElementById("signup-form").classList.toggle("hidden",r!=="signup"),document.getElementById("auth-err").classList.add("hidden")};window.doLogin=async function(){const r=document.getElementById("login-email").value.trim(),e=document.getElementById("login-password").value;if(!r||!e){kn("Udfyld alle felter.");return}const t=document.querySelector("#login-form .btn");t.disabled=!0,t.textContent="...";try{await Fy(Qs,r,e)}catch(n){kn(n.code==="auth/invalid-credential"?"Ugyldig email eller kodeord.":"Der opstod en fejl: "+n.code)}finally{t.disabled=!1,t.textContent="LOG IND"}};window.doSignup=async function(){const r=document.getElementById("signup-name").value.trim(),e=document.getElementById("signup-email").value.trim(),t=document.getElementById("signup-password").value;if(!r||!e||!t){kn("Udfyld alle felter.");return}const n=document.querySelector("#signup-form .btn");n.disabled=!0,n.textContent="...";try{const s=await My(Qs,e,t);await Ws(ae(te,"users",s.user.uid),{name:r,email:e,yam:r,"e-mail":e,created:Lo()})}catch(s){kn("Fejl: "+s.code)}finally{n.disabled=!1,n.textContent="OPRET KONTO"}};window.doForgot=async function(){const r=document.getElementById("login-email").value.trim();if(!r){kn("Indtast din email først.");return}try{await Ly(Qs,r),kn("Nulstillingsmail sendt!","ok")}catch(e){kn("Fejl: "+e.code)}};window.doLogout=async function(){try{await jy(Qs)}catch{}};document.addEventListener("DOMContentLoaded",()=>{var t,n,s;const r=document.getElementById("warn-enabled-sw");if(r){const i=localStorage.getItem("warnEnabled");_.warnEnabled=i===null?!0:i==="true",r.classList.toggle("on",_.warnEnabled),r.addEventListener("click",()=>{_.warnEnabled=!_.warnEnabled,r.classList.toggle("on",_.warnEnabled),localStorage.setItem("warnEnabled",_.warnEnabled)})}$y(Qs,async i=>{var o;if(i){_.user=i;let c,l;for(let h=0;h<3;h++)try{console.log("Henter profil for uid:",i.uid),[c,l]=await Promise.all([jn(ae(te,"users",i.uid)),jn(ae(te,"admins",i.uid))]),console.log("Profil:",c.exists(),(o=c.data)==null?void 0:o.call(c));break}catch(f){console.error("Profil fejl attempt",h,f.code,f.message),h<2?await new Promise(p=>setTimeout(p,2e3*(h+1))):(_.profile={name:i.email,email:i.email},_.isAdmin=!1)}if(c!=null&&c.exists()){const h=c.data();_.profile={name:h.name||h.yam||i.email,email:h.email||h["e-mail"]||i.email}}else _.profile||(_.profile={name:i.email,email:i.email});_.isAdmin=(l==null?void 0:l.exists())||!1,Wb()}else Qb()});let e=null;window.addEventListener("beforeinstallprompt",i=>{i.preventDefault(),e=i,document.getElementById("pwa-banner").style.display="flex"}),(t=document.getElementById("pwa-install-btn"))==null||t.addEventListener("click",async()=>{e&&(e.prompt(),await e.userChoice,e=null,document.getElementById("pwa-banner").style.display="none")}),(n=document.getElementById("pwa-dismiss-btn"))==null||n.addEventListener("click",()=>{document.getElementById("pwa-banner").style.display="none"}),tc(24),document.getElementById("target-count").addEventListener("change",i=>tc(Number(i.target.value))),(s=document.getElementById("photo-input"))==null||s.addEventListener("change",async i=>{var c;const o=i.target.files[0];if(o)try{const l=await pl(o),h=Nr(),f=cl(ul,`courses/${_.round.courseId}/target_${h}.jpg`);await ol(f,l,"base64",{contentType:"image/jpeg"});const p=await al(f);await ml(_.round.courseId,h,{imageUrl:p}),(c=_.course)!=null&&c.targets&&(_.course.targets[h].imageUrl=p),mn()}catch(l){alert("Upload fejl: "+l.message)}}),document.querySelectorAll(".modal").forEach(i=>{i.addEventListener("click",o=>{o.target===i&&i.classList.add("hidden")})})});function Wb(){var t;document.getElementById("hdr-name").textContent=_.profile.name,document.getElementById("auth-screen").classList.remove("active"),document.getElementById("app-screen").classList.add("active"),document.getElementById("admin-badge").classList.toggle("hidden",!_.isAdmin),document.querySelectorAll(".admin-only").forEach(n=>n.classList.toggle("hidden",!_.isAdmin));const r=ed();_.friends=r.friends||[],_.rounds=r.rounds||[],pr(Pn(te,"users",_.user.uid,"friends")).then(n=>{if(!n.docs.length)return;const s=n.docs.map(c=>({...c.data(),id:c.id})),i=new Set(_.friends.map(c=>c.id)),o=s.filter(c=>!i.has(c.id));o.length&&(_.friends=[..._.friends,...o],rn(),Ls(),Os())}).catch(n=>console.warn("Hent venner:",n)),Ls(),Os(),ao();const e=ed().courses||[];_.courses=e,nd(),td(),Jb(),pr(Pn(te,"users",_.user.uid,"rounds")).then(n=>{if(!n.docs.length)return;const s=n.docs.map(c=>({...c.data(),id:c.id})),i=new Set(_.rounds.map(c=>c.id)),o=s.filter(c=>!i.has(c.id));o.length&&(_.rounds=[..._.rounds,...o].sort((c,l)=>{var p,y;const h=c.completed||c.created||0,f=l.completed||l.created||0;return(typeof f=="number"?f:((p=f.toMillis)==null?void 0:p.call(f))??0)-(typeof h=="number"?h:((y=h.toMillis)==null?void 0:y.call(h))??0)}),rn(),ao(),console.log("Runder fra Firestore:",o.length))}).catch(n=>console.warn("Hent runder:",n)),console.log("Henter baner, user uid:",(t=_.user)==null?void 0:t.uid),pr(Pn(te,"courses")).then(n=>{console.log("Baner hentet:",n.docs.length,n.docs.map(i=>i.id));const s=n.docs.map(i=>{const o=i.data();return{id:i.id,name:o.name||o.yam||"—",numTargets:o.numTargets||o.antalMål||24,location:o.location||o.beliggenhed||"",targets:o.targets||o.mål||[],visits:o.visits||o.besøg||[]}});s.length&&(_.courses=s,rn(),nd(),td())}).catch(n=>console.warn("courses:",n)),Zb()}function Qb(){_.user=null,_.profile=null,_.round=null,fl(),document.getElementById("app-screen").classList.remove("active"),document.getElementById("auth-screen").classList.add("active")}window.toggleLang=function(){window.appLang=window.appLang==="da"?"en":"da",document.getElementById("lang-btn").textContent=window.appLang.toUpperCase()};window.switchTab=function(r){var t;document.querySelectorAll(".tab").forEach(n=>{n.classList.remove("active"),n.classList.add("hidden")}),document.querySelectorAll(".nav-btn").forEach(n=>n.classList.remove("active"));const e=document.getElementById(`tab-${r}`);e&&(e.classList.add("active"),e.classList.remove("hidden")),(t=document.querySelector(`.nav-btn[data-tab="${r}"]`))==null||t.classList.add("active"),r==="friends"&&sA(),r==="analyse"&&window.renderAnalyse(),r==="courses"&&_.courseMap&&setTimeout(()=>_.courseMap.invalidateSize(),100)};function Jb(){!navigator.geolocation||!_.courses.length||navigator.geolocation.getCurrentPosition(r=>{const e={lat:r.coords.latitude,lng:r.coords.longitude};let t=1/0,n=null;if(_.courses.forEach(s=>{(s.targets||[]).forEach(i=>{const o=i.gps||i.GPS;if(!o||!o.lat)return;const c=dl(e,o);c<t&&(t=c,n=s.id)})}),n&&t<500){const s=document.getElementById("course-sel");s.value=n,s.dispatchEvent(new Event("change"))}},()=>{},{enableHighAccuracy:!0,timeout:5e3})}function td(){const r=document.getElementById("course-sel"),e=r.value;r.innerHTML='<option value="">-- Ingen bane --</option>',_.courses.forEach(t=>{const n=document.createElement("option");n.value=t.id,n.textContent=`${t.name} (${t.numTargets} mål)`,r.appendChild(n)}),e&&(r.value=e),r.onchange=()=>{const t=_.courses.find(s=>s.id===r.value),n=document.getElementById("target-count");t?(n.value=t.numTargets,n.disabled=!0):n.disabled=!1,tc(t?t.numTargets:Number(n.value))}}function tc(r){const e=document.getElementById("start-target");e.innerHTML="";for(let t=1;t<=r;t++){const n=document.createElement("option");n.value=t,n.textContent=t,e.appendChild(n)}}window.addParticipant=function(r,e){if(document.getElementById(`chip-${r}`))return;const t=document.createElement("div");t.className="pchip",t.id=`chip-${r}`,t.innerHTML=`<span class="pchip-name">🎯 ${e}</span><button class="pchip-rm" onclick="this.closest('.pchip').remove()">✕</button>`,document.getElementById("p-list").appendChild(t)};function Xb(){return Array.from(document.querySelectorAll(".pchip")).map(r=>({id:r.id.replace("chip-",""),name:r.querySelector(".pchip-name").textContent.replace("🎯 ","").trim(),isGuest:r.id.startsWith("chip-guest-")}))}function Os(){const r=document.getElementById("qfriends");r.innerHTML="",_.friends.forEach(e=>{const t=document.createElement("button");t.className="qfbtn",t.textContent=e.name,t.onclick=()=>window.addParticipant(e.id,e.name),r.appendChild(t)})}window.searchFriends=async function(r){const e=document.getElementById("ac-list");if(!r.trim()){e.classList.add("hidden");return}const t=_.friends.filter(i=>i.name.toLowerCase().includes(r.toLowerCase()));let n=[];try{n=(await pr(Pn(te,"users"))).docs.map(o=>({id:o.id,...o.data()})).filter(o=>{var c;return(o.name||o.yam||"").toLowerCase().includes(r.toLowerCase())&&o.id!==((c=_.user)==null?void 0:c.uid)&&!t.find(l=>l.id===o.id)}).map(o=>({id:o.id,name:o.name||o.yam||o.email||"—",email:o.email||o["e-mail"]||""}))}catch(i){console.warn(i)}const s=[...t,...n];if(!s.length){e.classList.add("hidden");return}e.innerHTML=s.map(i=>`<div class="ac-item" onclick="selectFriend('${i.id}','${(i.name||"").replace(/'/g,"\\'")}','${(i.email||"").replace(/'/g,"\\'")}');document.getElementById('friend-search').value='';document.getElementById('ac-list').classList.add('hidden');">${i.name}${i.email?` <span style='font-size:11px;opacity:.6'>${i.email}</span>`:""}</div>`).join(""),e.classList.remove("hidden")};window.selectFriend=function(r,e,t){_.friends.find(n=>n.id===r)||(_.friends.push({id:r,name:e,email:t}),rn(),Ls(),Os()),window.addParticipant(r,e)};window.startRound=async function(){var h,f;const r=document.getElementById("round-name").value.trim()||"Min Skydning",e=document.getElementById("course-sel").value,t=Number(document.getElementById("target-count").value)||24,n=Number(document.getElementById("start-target").value)-1,s=document.getElementById("gps-auto-sw").classList.contains("on"),i=document.getElementById("gps-track-sw").classList.contains("on");_.warnThreshold=Number(document.getElementById("warn-thresh").value)||8;const o=[{id:_.user.uid,name:_.profile.name,isGuest:!1},...Xb().filter(p=>p.id!==_.user.uid)];_.course=e&&_.courses.find(p=>p.id===e)||null;const c=o.map(p=>{const y=Bb(p.id,p.name,p.isGuest);return $b(y,t),y});let l=n;if(s&&((h=_.course)!=null&&h.targets))try{l=Kb(_.course.targets,await Fo())}catch{}_.round={name:r,courseId:e||null,courseName:((f=_.course)==null?void 0:f.name)||null,numTargets:t,startTarget:l+1,shooters:c,created:Date.now(),traversalOrder:Pp(l,t),traversalPos:0},i&&(_.gpsTracking=Gb(Yb),document.getElementById("gps-bar").classList.toggle("hidden",!_.gpsTracking),Hb()),showActivePanel(),Or(),mn(),Uo()};function Pp(r,e){return Array.from({length:e},(t,n)=>(r+n)%e)}function Nr(){return _.round.traversalOrder[_.round.traversalPos]}window.showSetupPanel=function(){document.getElementById("setup-panel").classList.remove("hidden"),document.getElementById("active-panel").classList.add("hidden"),document.getElementById("results-panel").classList.add("hidden")};window.showActivePanel=function(){document.getElementById("setup-panel").classList.add("hidden"),document.getElementById("active-panel").classList.remove("hidden"),document.getElementById("results-panel").classList.add("hidden")};window.showResultsPanel=function(){document.getElementById("setup-panel").classList.add("hidden"),document.getElementById("active-panel").classList.add("hidden"),document.getElementById("results-panel").classList.remove("hidden")};function mn(){var l,h;if(!_.round)return;const r=Nr(),e=_.round.numTargets;document.getElementById("tnum-big").textContent=r+1,document.getElementById("tnum-suf").textContent=" af "+e,document.getElementById("round-badge").textContent=_.round.name;const t=(h=(l=_.course)==null?void 0:l.targets)==null?void 0:h[r];document.getElementById("anim-name").textContent=(t==null?void 0:t.name)||`Mål ${r+1}`;const n=jb(_.round.shooters,e);document.getElementById("pbar").style.width=`${n/e*100}%`;const s=_.round.shooters.flatMap(f=>f.scores.flat().filter(p=>p!=null)),i=s.reduce((f,p)=>f+zn(p),0);document.getElementById("stat-avg").textContent=s.length?(i/s.length).toFixed(1):"—",document.getElementById("stat-tot").textContent=i,document.getElementById("stat-rem").textContent=e-n;const o=document.getElementById("anim-img");t!=null&&t.imageUrl||t!=null&&t.photo?(o.src=t.imageUrl||t.photo,o.classList.remove("hidden")):o.classList.add("hidden"),document.getElementById("edit-target-btn").classList.toggle("hidden",!(_.isAdmin&&_.round.courseId)),document.getElementById("next-btn").textContent=_.round.traversalPos===e-1?"AFSLUT →":"NÆSTE →";const c=Mb(_.round.shooters,r);document.getElementById("target-avg").textContent=c!==null?`Gns. dette mål: ${c}`:""}function Or(){if(!_.round)return;const r=Nr(),e=document.getElementById("shooters-list");e.innerHTML="",_.round.shooters.forEach((t,n)=>{const s=it(t.scores),i=Ub(t.scores,_.warnThreshold),o=t.scores[r]||[null,null],c=document.createElement("div");c.className="shooter-card",t.scores.flat().filter(y=>y!=null);const l=t.scores.map(y=>y[0]).filter(y=>y!=null),h=t.scores.map(y=>y[1]).filter(y=>y!=null),f=l.length?(l.reduce((y,S)=>y+zn(S),0)/l.length).toFixed(2):"—",p=h.length?(h.reduce((y,S)=>y+zn(S),0)/h.length).toFixed(2):"—";c.innerHTML=`
    ...
    <div class="card" style="text-align:center;padding:12px;"><div style="font-size:11px;color:var(--muted);">SNIT/RUNDE</div><div style="font-size:28px;font-weight:700;color:var(--acc);">${y}</div></div>
    ...
    <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:4px;">`,ot.forEach(K=>{const j=M[K]||0,he=q[K]||0,se=j+he,Z=28;let De="";if(se===0)De=`<circle cx="${Z}" cy="${Z}" r="${Z}" fill="var(--surface2)"/>`;else if(he===0)De=`<circle cx="${Z}" cy="${Z}" r="${Z}" fill="${v[K]}"/>`;else if(j===0)De=`<circle cx="${Z}" cy="${Z}" r="${Z}" fill="#5a3a8a"/>`;else{const je=j/se,Se=je*2*Math.PI,We=Z+Z*Math.sin(0),Ce=Z-Z*Math.cos(0),Ve=Z+Z*Math.sin(Se),wt=Z-Z*Math.cos(Se),Tt=Se>Math.PI?1:0;De=`<path d="M${Z},${Z} L${We},${Ce} A${Z},${Z} 0 ${Tt},1 ${Ve},${wt} Z" fill="${v[K]}"/>
      ...
      <div style="font-weight:700;font-size:14px;color:${v[K]}">${K}</div>
