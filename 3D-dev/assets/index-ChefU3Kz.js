    ...
    <div class="card" style="margin-bottom:12px;">
      ...
      <div id="edit-capproved-wrap" style="display:${n.hidden?"":"none"};">
        ...
        <div style="display:flex;gap:6px;">
          <input type="text" id="edit-capproved-manual" placeholder="…eller indtast email direkte" style="flex:1;" />
          <button type="button" class="btn btn-dark" onclick="addApprovedEmailManual('edit')">Tilføj</button>
        </div>
      </div>
