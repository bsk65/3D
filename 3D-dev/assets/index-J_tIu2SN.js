 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fo=new Map,Sv=new Map,Dc=new Map;function Rd(n,e){try{n.container.addComponent(e)}catch(t){an.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Dt(n){const e=n.name;if(Dc.has(e))return an.debug(`There were multiple attempts to register component ${e}.`),!1;Dc.set(e,n);for(const t of Fo.values())Rd(t,n);for(const t of Sv.values())Rd(t,n);return!0}function Tr(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Ut(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const br=bv;function xf(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:kc,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw Cn.create("bad-app-name",{appName:String(s)});if(t||(t=Rf()),!t)throw Cn.create("no-options");const i=Fo.get(s);if(i){if(ai(t,i.options)&&ai(r,i.config))return i;throw Cn.create("duplicate-app",{appName:s})}const o=new Ly(s);for(const l of Dc.values())o.addComponent(l);const c=new Pv(t,r,o);return Fo.set(s,c),c}function hl(n=kc){const e=Fo.get(n);if(!e&&n===kc&&Rf())return xf();if(!e)throw Cn.create("no-app",{appName:n});return e}function ft(n,e,t){var r;let s=(r=Av[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),an.warn(c.join(" "));return}Dt(new At(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cv="firebase-heartbeat-database",kv=1,ci="firebase-heartbeat-store";let lc=null;function Vf(){return lc||(lc=ua(Cv,kv,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(ci)}catch(t){console.warn(t)}}}}).catch(n=>{throw Cn.create("idb-open",{originalErrorMessage:n.message})})),lc}async function Dv(n){try{const t=(await Vf()).transaction(ci),r=await t.objectStore(ci).get(Lf(n));return await t.done,r}catch(e){if(e instanceof Lt)an.warn(e.message);else{const t=Cn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});an.warn(t.message)}}}async function Pd(n,e){try{const r=(await Vf()).transaction(ci,"readwrite");await r.objectStore(ci).put(e,Lf(n)),await r.done}catch(t){if(t instanceof Lt)an.warn(t.message);else{const r=Cn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});an.warn(r.message)}}}function Lf(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nv=1024,xv=30*24*60*60*1e3;class Vv{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Ov(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Cd();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i)?void 0:(this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const c=new Date(o.date).valueOf();return Date.now()-c<=xv}),this._storage.overwrite(this._heartbeatsCache))}catch(r){an.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Cd(),{heartbeatsToSend:r,unsentEntries:s}=Lv(this._heartbeatsCache.heartbeats),i=Mo(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(t){return an.warn(t),""}}}function Cd(){return new Date().toISOString().substring(0,10)}function Lv(n,e=Nv){const t=[];let r=n.slice();for(const s of n){const i=t.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),kd(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),kd(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class Ov{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ll()?kf().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Dv(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const s=await this.read();return Pd(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const s=await this.read();return Pd(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function kd(n){return Mo(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mv(n){Dt(new At("platform-logger",e=>new Jy(e),"PRIVATE")),Dt(new At("heartbeat",e=>new Vv(e),"PRIVATE")),ft(Cc,Sd,n),ft(Cc,Sd,"esm2017"),ft("fire-js","")}Mv("");var Fv="firebase",Bv="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ft(Fv,Bv,"app");function fl(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}function Of(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Uv=Of,Mf=new Er("auth","Firebase",Of());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bo=new ul("@firebase/auth");function $v(n,...e){Bo.logLevel<=oe.WARN&&Bo.warn(`Auth (${br}): ${n}`,...e)}function wo(n,...e){Bo.logLevel<=oe.ERROR&&Bo.error(`Auth (${br}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci{constructor(e,t){this.shortDelay=e,this.longDelay=t,cn(t>e,"Short delay should be less than long delay!"),this.isMobile=yy()||Ey()}get(){return qv()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ml(n,e){cn(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function li(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof Lt&&Zv(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Zv({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uo(n){var e;const t=n.auth,r=await n.getIdToken(),s=await li(n,jf(t,{idToken:r}));te(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const o=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?qf(i.providerUserInfo):[],c=nw(n.providerData,o),l=n.isAnonymous,u=!(n.email&&i.passwordHash)&&!(c!=null&&c.length),h=l?u:!1,m={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new xc(i.createdAt,i.lastLoginAt),isAnonymous:h};Object.assign(n,m)}async function tw(n){const e=Ee(n);await Uo(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function nw(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function qf(n){return n.map(e=>{var{providerId:t}=e,r=fl(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rw(n,e){const t=await Uf(n,{},async()=>{const r=Pi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,o=$f(n,s,"/v1/token",`key=${i}`),c=await n._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",Bf.fetch()(o,{method:"POST",headers:c,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function sw(n,e){return hn(n,"POST","/v2/accounts:revokeToken",dn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vd=new Map;function tn(n){cn(n instanceof Function,"Expected a class definition");let e=Vd.get(n);return e?(cn(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Vd.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Od(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Wf(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Gf(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Jf(e))return"Blackberry";if(Yf(e))return"Webos";if(zf(e))return"Safari";if((e.includes("chrome/")||Hf(e))&&!e.includes("edge/"))return"Chrome";if(Qf(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Gf(n=Me()){return/firefox\//i.test(n)}function zf(n=Me()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Hf(n=Me()){return/crios\//i.test(n)}function Wf(n=Me()){return/iemobile/i.test(n)}function Qf(n=Me()){return/android/i.test(n)}function Jf(n=Me()){return/blackberry/i.test(n)}function Yf(n=Me()){return/webos/i.test(n)}function _l(n=Me()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function iw(n=Me()){var e;return _l(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function ow(){return Ty()&&document.documentMode===10}function Xf(n=Me()){return _l(n)||Qf(n)||Yf(n)||Jf(n)||/windows phone/i.test(n)||Wf(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vw(n,e){const t=Tr(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(ai(i,e??{}))return s;Nt(s,"already-initialized")}return t.initialize({options:e})}function ww(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(tn);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Iw(n,e,t){const r=On(n);te(r._canInitEmulator,r,"emulator-config-failed"),te(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=tp(e),{host:o,port:c}=Ew(e),l=c===null?"":`:${c}`;r.config.emulator={url:`${i}//${o}${l}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),Tw()}function tp(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Ew(n){const e=tp(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Bd(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:Bd(o)}}}function Bd(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Tw(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yl{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Zt("not implemented")}_getIdTokenResponse(e){return Zt("not implemented")}_linkToIdToken(e,t){return Zt("not implemented")}_getReauthenticationResolver(e){return Zt("not implemented")}}async function bw(n,e){return hn(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Aw(n,e){return ki(n,"POST","/v1/accounts:signInWithPassword",dn(n,e))}async function Sw(n,e){return hn(n,"POST","/v1/accounts:sendOobCode",dn(n,e))}async function Rw(n,e){return Sw(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pw(n,e){return ki(n,"POST","/v1/accounts:signInWithEmailLink",dn(n,e))}async function Cw(n,e){return ki(n,"POST","/v1/accounts:signInWithEmailLink",dn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xr(n,e){return ki(n,"POST","/v1/accounts:signInWithIdp",dn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dw(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Nw(n){const e=$s(js(n)).link,t=e?$s(js(e)).deep_link_id:null,r=$s(js(n)).deep_link_id;return(r?$s(js(r)).link:null)||r||t||e||n}class vl{constructor(e){var t,r,s,i,o,c;const l=$s(js(e)),u=(t=l.apiKey)!==null&&t!==void 0?t:null,h=(r=l.oobCode)!==null&&r!==void 0?r:null,m=Dw((s=l.mode)!==null&&s!==void 0?s:null);te(u&&h&&m,"argument-error"),this.apiKey=u,this.operation=m,this.code=h,this.continueUrl=(i=l.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(c=l.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=Nw(e);try{return new vl(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xw(n,e){return ki(n,"POST","/v1/accounts:signUp",dn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sp(n,e,t=!1){if(Ut(n.app))return Promise.reject(on(n));const r="signIn",s=await rp(n,r,e),i=await ur._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Ow(n,e){return sp(On(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ip(n){const e=On(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Mw(n,e,t){const r=On(n);await $o(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Rw)}async function Fw(n,e,t){if(Ut(n.app))return Promise.reject(on(n));const r=On(n),o=await $o(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",xw).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&ip(n),l}),c=await ur._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function Bw(n,e,t){return Ut(n.app)?Promise.reject(on(n)):Ow(Ee(n),fs.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&ip(n),r})}function Uw(n,e,t,r){return Ee(n).onIdTokenChanged(e,t,r)}function $w(n,e,t){return Ee(n).beforeAuthStateChanged(e,t)}function jw(n,e,t,r){return Ee(n).onAuthStateChanged(e,t,r)}function qw(n){return Ee(n).signOut()}const qo="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kt(){return window}function Qw(n){Kt().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function up(){return typeof Kt().WorkerGlobalScope<"u"&&typeof Kt().importScripts=="function"}async function Jw(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Yw(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Xw(){return up()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iI(n,e){return e?tn(e):(te(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uI="pendingRedirect",Eo=new Map;class dI extends pp{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Eo.get(this.auth._key());if(!e){try{const r=await hI(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Eo.set(this.auth._key(),e)}return this.bypassAuthState||Eo.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function hI(n,e){const t=mI(e),r=pI(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function fI(n,e){Eo.set(n._key(),e)}function pI(n){return tn(n._redirectPersistence)}function mI(n){return Io(uI,n.config.apiKey,n.name)}async function gI(n,e,t=!1){if(Ut(n.app))return Promise.reject(on(n));const r=On(n),s=iI(r,e),o=await new dI(r,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AI=new Ci(3e4,6e4);function Kd(){const n=Kt().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function SI(n){return new Promise((e,t)=>{var r,s,i;function o(){Kd(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Kd(),t(qt(n,"network-request-failed"))},timeout:AI.get()})}if(!((s=(r=Kt().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=Kt().gapi)===null||i===void 0)&&i.load)o();else{const c=mw("iframefcb");return Kt()[c]=()=>{gapi.load?o():t(qt(n,"network-request-failed"))},ep(`${pw()}?onload=${c}`).catch(l=>t(l))}}).catch(e=>{throw To=null,e})}let To=null;function RI(n){return To=To||SI(n),To}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LI={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},OI=500,MI=600,FI="_blank",BI="http://localhost";class Gd{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function UI(n,e,t,r=OI,s=MI){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const l=Object.assign(Object.assign({},LI),{width:r.toString(),height:s.toString(),top:i,left:o}),u=Me().toLowerCase();t&&(c=Hf(u)?FI:t),Gf(u)&&(e=e||BI,l.scrollbars="yes");const h=Object.entries(l).reduce((_,[v,P])=>`${_}${v}=${P},`,"");if(iw(u)&&c!=="_self")return $I(e||"",c),new Gd(null);const m=window.open(e||"",c,h);te(m,n,"popup-blocked");try{m.focus()}catch{}return new Gd(m)}function $I(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc="webStorageSupport";class zI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=lp,this._completeRedirectFn=gI,this._overrideRedirectResult=fI}async _openPopup(e,t,r,s){var i;cn((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await zd(e,t,r,Nc(),s);return UI(e,o,wl())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await zd(e,t,r,Nc(),s);return Qw(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(cn(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await VI(e),r=new yI(e);return t.register("authEvent",s=>(te(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(dc,{type:dc},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[dc];o!==void 0&&t(!!o),Nt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=TI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Xf()||zf()||_l()}}const HI=zI;var Hd="@firebase/auth",Wd="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sl(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Rl(n){const e=n.mapValue.fields.__previous_value__;return Sl(e)?Rl(e):e}function mi(n){const e=ln(n.mapValue.fields.__local_write_time__.timestampValue);return new Ae(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{constructor(e,t="asc"){this.field=e,this.dir=t}}function FE(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GE{constructor(e,t=null,r=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.ue=null}}function jc(n,e=null,t=[],r=[],s=null,i=null,o=null){return new GE(n,e,t,r,s,i,o)}function pr(n){const e=K(n);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>$c(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(i){return i.field.canonicalString()+i.dir}(r)).join(","),ma(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>ts(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>ts(r)).join(",")),e.ue=t}return e.ue}function xi(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!FE(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!$p(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!uh(n.startAt,e.startAt)&&uh(n.endAt,e.endAt)}function Ho(n){return j.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}function Wo(n,e){return n.filters.filter(t=>t instanceof ae&&t.field.isEqual(e))}function dh(n,e,t){let r=Ro,s=!0;for(const i of Wo(n,e)){let o=Ro,c=!0;switch(i.op){case"<":case"<=":o=OE(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,c=!1;break;case"!=":case"not-in":o=Ro}ah({value:r,inclusive:s},{value:o,inclusive:c})<0&&(r=o,s=c)}if(t!==null){for(let i=0;i<n.orderBy.length;++i)if(n.orderBy[i].field.isEqual(e)){const o=t.position[i];ah({value:r,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(r=o,s=t.inclusive);break}}return{value:r,inclusive:s}}function hh(n,e,t){let r=Pn,s=!0;for(const i of Wo(n,e)){let o=Pn,c=!0;switch(i.op){case">=":case">":o=ME(i.value),c=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,c=!1;break;case"!=":case"not-in":o=Pn}ch({value:r,inclusive:s},{value:o,inclusive:c})>0&&(r=o,s=c)}if(t!==null){for(let i=0;i<n.orderBy.length;++i)if(n.orderBy[i].field.isEqual(e)){const o=t.position[i];ch({value:r,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(r=o,s=t.inclusive);break}}return{value:r,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WE=new ve(j.comparator);function wt(){return WE}const Yp=new ve(j.comparator);function Ks(...n){let e=Yp;for(const t of n)e=e.insert(t.key,t);return e}function Xp(n){let e=Yp;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function jt(){return ti()}function Zp(){return ti()}function ti(){return new Bn(n=>n.toString(),(n,e)=>n.isEqual(e))}const QE=new ve(j.comparator),JE=new ge(j.comparator);function se(...n){let e=JE;for(const t of n)e=e.add(t);return e}const YE=new ge(ne);function Cl(){return YE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kl(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:pi(e)?"-0":e}}function em(n){return{integerValue:""+n}}function XE(n,e){return Cp(e)?em(e):kl(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class im{constructor(e,t){this.field=e,this.transform=t}}function tT(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof is&&s instanceof is||r instanceof os&&s instanceof os?es(r.elements,s.elements,zt):r instanceof vi&&s instanceof vi?zt(r.Pe,s.Pe):r instanceof ss&&s instanceof ss}(n.transform,e.transform)}class nT{constructor(e,t){this.version=e,this.transformResults=t}}class Xe{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Xe}static exists(e){return new Xe(void 0,e)}static updateTime(e){return new Xe(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Co(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class wa{}function om(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Ia(n.key,Xe.none()):new gs(n.key,n.data,Xe.none());{const t=n.data,r=Ye.empty();let s=new ge(be.comparator);for(let i of e.fields)if(!s.has(i)){let o=t.field(i);o===null&&i.length>1&&(i=i.popLast(),o=t.field(i)),o===null?r.delete(i):r.set(i,o),s=s.add(i)}return new fn(n.key,r,new ht(s.toArray()),Xe.none())}}function rT(n,e,t){n instanceof gs?function(s,i,o){const c=s.value.clone(),l=gh(s.fieldTransforms,i,o.transformResults);c.setAll(l),i.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(n,e,t):n instanceof fn?function(s,i,o){if(!Co(s.precondition,i))return void i.convertToUnknownDocument(o.version);const c=gh(s.fieldTransforms,i,o.transformResults),l=i.data;l.setAll(am(s)),l.setAll(c),i.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(n,e,t):function(s,i,o){i.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,t)}function ni(n,e,t,r){return n instanceof gs?function(i,o,c,l){if(!Co(i.precondition,o))return c;const u=i.value.clone(),h=_h(i.fieldTransforms,l,o);return u.setAll(h),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),null}(n,e,t,r):n instanceof fn?function(i,o,c,l){if(!Co(i.precondition,o))return c;const u=_h(i.fieldTransforms,l,o),h=o.data;return h.setAll(am(i)),h.setAll(u),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(m=>m.field))}(n,e,t,r):function(i,o,c){return Co(i.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):c}(n,e,t)}function sT(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=tm(r.transform,s||null);i!=null&&(t===null&&(t=Ye.empty()),t.set(r.field,i))}return t||null}function mh(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&es(r,s,(i,o)=>tT(i,o))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class gs extends wa{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class fn extends wa{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function am(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function gh(n,e,t){const r=new Map;H(n.length===t.length);for(let s=0;s<t.length;s++){const i=n[s],o=i.transform,c=e.data.field(i.field);r.set(i.field,eT(o,c,t[s]))}return r}function _h(n,e,t){const r=new Map;for(const s of n){const i=s.transform,o=t.data.field(s.field);r.set(s.field,ZE(i,o,e))}return r}class Ia extends wa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class cm extends wa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BT{constructor(e){this.serializer=e}setIndexManager(e){this.indexManager=e}addEntry(e,t,r){return Jn(e).put(r)}removeEntry(e,t,r){return Jn(e).delete(function(i,o){const c=i.path.toArray();return[c.slice(0,c.length-2),c[c.length-2],Yo(o),c[c.length-1]]}(t,r))}updateMetadata(e,t){return this.getMetadata(e).next(r=>(r.byteSize+=t,this.rr(e,r)))}getEntry(e,t){let r=Re.newInvalidDocument(t);return Jn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(Ms(t))},(s,i)=>{r=this.ir(t,i)}).next(()=>r)}sr(e,t){let r={size:0,document:Re.newInvalidDocument(t)};return Jn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(Ms(t))},(s,i)=>{r={document:this.ir(t,i),size:Zo(i)}}).next(()=>r)}getEntries(e,t){let r=wt();return this._r(e,t,(s,i)=>{const o=this.ir(s,i);r=r.insert(s,o)}).next(()=>r)}ar(e,t){let r=wt(),s=new ve(j.comparator);return this._r(e,t,(i,o)=>{const c=this.ir(i,o);r=r.insert(i,c),s=s.insert(i,Zo(o))}).next(()=>({documents:r,ur:s}))}_r(e,t,r){if(t.isEmpty())return R.resolve();let s=new ge(Uh);t.forEach(l=>s=s.add(l));const i=IDBKeyRange.bound(Ms(s.first()),Ms(s.last())),o=s.getIterator();let c=o.getNext();return Jn(e).J({index:"documentKeyIndex",range:i},(l,u,h)=>{const m=j.fromSegments([...u.prefixPath,u.collectionGroup,u.documentId]);for(;c&&Uh(c,m)<0;)r(c,null),c=o.getNext();c&&c.isEqual(m)&&(r(c,u),c=o.hasNext()?o.getNext():null),c?h.$(Ms(c)):h.done()}).next(()=>{for(;c;)r(c,null),c=o.hasNext()?o.getNext():null})}getDocumentsMatchingQuery(e,t,r,s,i){const o=t.path,c=[o.popLast().toArray(),o.lastSegment(),Yo(r.readTime),r.documentKey.path.isEmpty()?"":r.documentKey.path.lastSegment()],l=[o.popLast().toArray(),o.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return Jn(e).U(IDBKeyRange.bound(c,l,!0)).next(u=>{i==null||i.incrementDocumentReadCount(u.length);let h=wt();for(const m of u){const _=this.ir(j.fromSegments(m.prefixPath.concat(m.collectionGroup,m.documentId)),m);_.isFoundDocument()&&(Vi(t,_)||s.has(_.key))&&(h=h.insert(_.key,_))}return h})}getAllFromCollectionGroup(e,t,r,s){let i=wt();const o=Bh(t,r),c=Bh(t,Tt.max());return Jn(e).J({index:"collectionGroupIndex",range:IDBKeyRange.bound(o,c,!0)},(l,u,h)=>{const m=this.ir(j.fromSegments(u.prefixPath.concat(u.collectionGroup,u.documentId)),u);i=i.insert(m.key,m),i.size===s&&h.done()}).next(()=>i)}newChangeBuffer(e){return new UT(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next(t=>t.byteSize)}getMetadata(e){return Fh(e).get("remoteDocumentGlobalKey").next(t=>(H(!!t),t))}rr(e,t){return Fh(e).put("remoteDocumentGlobalKey",t)}ir(e,t){if(t){const r=TT(this.serializer,t);if(!(r.isNoDocument()&&r.version.isEqual(Y.min())))return r}return Re.newInvalidDocument(e)}}function Nm(n){return new BT(n)}class UT extends Dm{constructor(e,t){super(),this.cr=e,this.trackRemovals=t,this.lr=new Bn(r=>r.toString(),(r,s)=>r.isEqual(s))}applyChanges(e){const t=[];let r=0,s=new ge((i,o)=>ne(i.canonicalString(),o.canonicalString()));return this.changes.forEach((i,o)=>{const c=this.lr.get(i);if(t.push(this.cr.removeEntry(e,i,c.readTime)),o.isValidDocument()){const l=bh(this.cr.serializer,o);s=s.add(i.path.popLast());const u=Zo(l);r+=u-c.size,t.push(this.cr.addEntry(e,i,l))}else if(r-=c.size,this.trackRemovals){const l=bh(this.cr.serializer,o.convertToNoDocument(Y.min()));t.push(this.cr.addEntry(e,i,l))}}),s.forEach(i=>{t.push(this.cr.indexManager.addToCollectionParentIndex(e,i))}),t.push(this.cr.updateMetadata(e,r)),R.waitFor(t)}getFromCache(e,t){return this.cr.sr(e,t).next(r=>(this.lr.set(t,{size:r.size,readTime:r.document.readTime}),r.document))}getAllFromCache(e,t){return this.cr.ar(e,t).next(({documents:r,ur:s})=>(s.forEach((i,o)=>{this.lr.set(i,{size:o,readTime:r.get(i).readTime})}),r))}}function Fh(n){return Fe(n,"remoteDocumentGlobal")}function Jn(n){return Fe(n,"remoteDocumentsV14")}function Ms(n){const e=n.path.toArray();return[e.slice(0,e.length-2),e[e.length-2],e[e.length-1]]}function Bh(n,e){const t=e.documentKey.path.toArray();return[n,Yo(e.readTime),t.slice(0,t.length-2),t.length>0?t[t.length-1]:""]}function Uh(n,e){const t=n.path.toArray(),r=e.path.toArray();let s=0;for(let i=0;i<t.length-2&&i<r.length-2;++i)if(s=ne(t[i],r[i]),s)return s;return s=ne(t.length,r.length),s||(s=ne(t[t.length-2],r[r.length-2]),s||ne(t[t.length-1],r[r.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Om{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Cf()?8:Pp(Me())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Yi(e,t).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Zi(e,t,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new YT;return this.Xi(e,t,o).next(c=>{if(i.result=c,this.zi)return this.es(e,t,o,c.size)})}).next(()=>i.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(Kr()<=oe.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",Gr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),R.resolve()):(Kr()<=oe.DEBUG&&x("QueryEngine","Query:",Gr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Kr()<=oe.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",Gr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Et(t))):R.resolve())}Yi(e,t){if(fh(t))return R.resolve(null);let r=Et(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=Kc(t,null,"F"),r=Et(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=se(...i);return this.Ji.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.ts(t,c);return this.ns(t,u,o,l.readTime)?this.Yi(e,Kc(t,null,"F")):this.rs(e,u,t,l)}))})))}Zi(e,t,r,s){return fh(t)||s.isEqual(Y.min())?R.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const o=this.ts(t,i);return this.ns(t,o,r,s)?R.resolve(null):(Kr()<=oe.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Gr(t)),this.rs(e,o,t,bp(s,-1)).next(c=>c))})}ts(e,t){let r=new ge(Jp(e));return t.forEach((s,i)=>{Vi(e,i)&&(r=r.add(i))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Xi(e,t,r){return Kr()<=oe.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",Gr(t)),this.Ji.getDocumentsMatchingQuery(e,t,Tt.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Aa(n){return new fT(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Rr(this.firestore,e,this._query)}}class lt{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Dn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new lt(this.firestore,e,this._key)}}class Dn extends Rr{constructor(e,t,r){super(e,t,_a(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new lt(this.firestore,null,new j(e))}withConverter(e){return new Dn(this.firestore,e,this._path)}}function qe(n,e,...t){if(n=Ee(n),Zl("collection","path",e),n instanceof ka){const r=pe.fromString(e,...t);return ef(r),new Dn(n,null,r)}{if(!(n instanceof lt||n instanceof Dn))throw new M(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(pe.fromString(e,...t));return ef(r),new Dn(n.firestore,null,r)}}function tA(n,e){if(n=xt(n,ka),Zl("collectionGroup","collection id",e),e.indexOf("/")>=0)throw new M(N.INVALID_ARGUMENT,`Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new Rr(n,null,function(r){return new ms(pe.emptyPath(),r)}(e))}function ie(n,e,...t){if(n=Ee(n),arguments.length===1&&(e=Ep.newId()),Zl("doc","path",e),n instanceof ka){const r=pe.fromString(e,...t);return Zh(r),new lt(n,null,new j(r))}{if(!(n instanceof lt||n instanceof Dn))throw new M(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(pe.fromString(e,...t));return Zh(r),new lt(n.firestore,n instanceof Dn?n.converter:null,new j(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cS(n,e){return e}class ot{constructor(e,t,r,s){this.server=e,this.local=t||e,this.writable=!!r,this.xform=s||cS}}let vo=null;function lS(n){return!du(n)||n.length<2?n:xg(n)}function Vg(){if(vo)return vo;const n=[];n.push(new ot("bucket")),n.push(new ot("generation")),n.push(new ot("metageneration")),n.push(new ot("name","fullPath",!0));function e(i,o){return lS(o)}const t=new ot("name");t.xform=e,n.push(t);function r(i,o){return o!==void 0?Number(o):o}const s=new ot("size");return s.xform=r,n.push(s),n.push(new ot("timeCreated")),n.push(new ot("updated")),n.push(new ot("md5Hash",null,!0)),n.push(new ot("cacheControl",null,!0)),n.push(new ot("contentDisposition",null,!0)),n.push(new ot("contentEncoding",null,!0)),n.push(new ot("contentLanguage",null,!0)),n.push(new ot("contentType",null,!0)),n.push(new ot("metadata","customMetadata",!0)),vo=n,vo}function uS(n,e){function t(){const r=n.bucket,s=n.fullPath,i=new It(r,s);return e._makeStorageReference(i)}Object.defineProperty(n,"ref",{get:t})}function dS(n,e,t){const r={};r.type="file";const s=t.length;for(let i=0;i<s;i++){const o=t[i];r[o.local]=o.xform(r,e[o.server])}return uS(r,n),r}function Lg(n,e,t){const r=Ng(e);return r===null?null:dS(n,r,t)}function hS(n,e,t,r){const s=Ng(e);if(s===null||!du(s.downloadTokens))return null;const i=s.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(u=>{const h=n.bucket,m=n.fullPath,_="/b/"+o(h)+"/o/"+o(m),v=fu(_,t,r),P=Rg({alt:"media",token:u});return v+P})[0]}function fS(n,e){const t={},r=e.length;for(let s=0;s<r;s++){const i=e[s];i.writable&&(t[i.server]=n[i.local])}return JSON.stringify(t)}class Og{constructor(e,t,r,s){this.url=e,this.method=t,this.handler=r,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mg(n){if(!n)throw uu()}function pS(n,e){function t(r,s){const i=Lg(n,s,e);return Mg(i!==null),i}return t}function mS(n,e){function t(r,s){const i=Lg(n,s,e);return Mg(i!==null),hS(i,s,n.host,n._protocol)}return t}function Fg(n){function e(t,r){let s;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?s=CA():s=PA():t.getStatus()===402?s=RA(n.bucket):t.getStatus()===403?s=kA(n.path):s=r,s.status=t.getStatus(),s.serverResponse=r.serverResponse,s}return e}function gS(n){const e=Fg(n);function t(r,s){let i=e(r,s);return r.getStatus()===404&&(i=SA(n.path)),i.serverResponse=s.serverResponse,i}return t}function _S(n,e,t){const r=e.fullServerUrl(),s=fu(r,n.host,n._protocol),i="GET",o=n.maxOperationRetryTime,c=new Og(s,i,mS(n,t),o);return c.errorHandler=gS(e),c}function yS(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function vS(n,e,t){const r=Object.assign({},t);return r.fullPath=n.path,r.size=e.size(),r.contentType||(r.contentType=yS(null,e)),r}function wS(n,e,t,r,s){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let V="";for(let U=0;U<2;U++)V=V+Math.random().toString().slice(2);return V}const l=c();o["Content-Type"]="multipart/related; boundary="+l;const u=vS(e,r,s),h=fS(u,t),m="--"+l+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zg=1e4,Hg=`w:${mu}`,Wg="FIS_v2",LS="https://firebaseinstallations.googleapis.com/v1",OS=60*60*1e3,MS="installations",FS="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n_=new Map;function r_(n,e){const t=Ma(n);s_(t,e),WS(t,e)}function s_(n,e){const t=n_.get(n);if(t)for(const r of t)r(e)}function WS(n,e){const t=QS();t&&t.postMessage({key:n,fid:e}),JS()}let rr=null;function QS(){return!rr&&"BroadcastChannel"in self&&(rr=new BroadcastChannel("[Firebase] FID Change"),rr.onmessage=n=>{s_(n.data.key,n.data.fid)}),rr}function JS(){n_.size===0&&rr&&(rr.close(),rr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xt(n){const e=new Uint8Array(n);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function S0(n){const e="=".repeat((4-n.length%4)%4),t=(n+e).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(t),s=new Uint8Array(r.length);for(let i=0;i<r.length;++i)s[i]=r.charCodeAt(i);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ec="fcm_token_details_db",R0=5,pf="fcm_token_object_Store";async function P0(n){if("databases"in indexedDB&&!(await indexedDB.databases()).map(i=>i.name).includes(Ec))return null;let e=null;return(await ua(Ec,R0,{upgrade:async(r,s,i,o)=>{var c;if(s<2||!r.objectStoreNames.contains(pf))return;const l=o.objectStore(pf),u=await l.index("fcmSenderId").get(n);if(await l.clear(),!!u){if(s===2){const h=u;if(!h.auth||!h.p256dh||!h.endpoint)return;e={token:h.fcmToken,createTime:(c=h.createTime)!==null&&c!==void 0?c:Date.now(),subscriptionOptions:{auth:h.auth,p256dh:h.p256dh,endpoint:h.endpoint,swScope:h.swScope,vapidKey:typeof h.vapidKey=="string"?h.vapidKey:Xt(h.vapidKey)}}}else if(s===3){const h=u;e={token:h.fcmToken,createTime:h.createTime,subscriptionOptions:{auth:Xt(h.auth),p256dh:Xt(h.p256dh),endpoint:h.endpoint,swScope:h.swScope,vapidKey:Xt(h.vapidKey)}}}else if(s===4){const h=u;e={token:h.fcmToken,createTime:h.createTime,subscriptionOptions:{auth:Xt(h.auth),p256dh:Xt(h.p256dh),endpoint:h.endpoint,swScope:h.swScope,vapidKey:Xt(h.vapidKey)}}}}}})).close(),await ac(Ec),await ac("fcm_vapid_details_db"),await ac("undefined"),C0(e)?e:null}function C0(n){if(!n||!n.subscriptionOptions)return!1;const{subscriptionOptions:e}=n;return typeof n.createTime=="number"&&n.createTime>0&&typeof n.token=="string"&&n.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k0="firebase-messaging-database",D0=1,bi="firebase-messaging-store";let Tc=null;function d_(){return Tc||(Tc=ua(k0,D0,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(bi)}}})),Tc}async function N0(n){const e=h_(n),r=await(await d_()).transaction(bi).objectStore(bi).get(e);if(r)return r;{const s=await P0(n.appConfig.senderId);if(s)return await vu(n,s),s}}async function vu(n,e){const t=h_(n),s=(await d_()).transaction(bi,"readwrite");return await s.objectStore(bi).put(e,t),await s.done,e}function h_({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Y0(n,e,t){const r=X0(e);(await n.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:t[u_],message_name:t[T0],message_time:t[b0],message_device_time:Math.floor(Date.now()/1e3)})}function X0(n){switch(n){case Ti.NOTIFICATION_CLICKED:return"notification_open";case Ti.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z0(n,e){const t=e.data;if(!t.isFirebaseMessaging)return;n.onMessageHandler&&t.messageType===Ti.PUSH_RECEIVED&&(typeof n.onMessageHandler=="function"?n.onMessageHandler(gf(t)):n.onMessageHandler.next(gf(t)));const r=t.data;G0(r)&&r[A0]==="1"&&await Y0(n,t.messageType,r)}const _f="@firebase/messaging",yf="0.12.12";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
(Kræver login med din bruger)`);const s=n.shooters.map(c=>{var l;return(l=p.friends.find(u=>u.id===c.id))==null?void 0:l.email}).filter(Boolean),i="3D Bueskydning - "+n.name,o="mailto:"+s.join(",")+"?subject="+encodeURIComponent(i)+"&body="+encodeURIComponent(t);window.location.href=o};const C_="archery_meetups_seen",xR={afventer:"Afventer",tilmeldt:"Tilmeldt ✅",foreslået:"Foreslår andet tidspunkt 🕓",afvist:"Afbud ❌"};function Sc(n){if(!n)return"";const[e,t,r]=n.split("-");return e&&t&&r?`${r}-${t}-${e}`:n}let je=new Map,qi="venner",Js=null,k_=null,Pu=null,D_=null;async function Cu(){if(p.user)try{const n=[et(ia(qe(X,"meetups"),si("creatorUid","==",p.user.uid))),et(ia(qe(X,"meetups"),si("invitedUids","array-contains",p.user.uid)))];p.isSuperAdmin&&n.push(et(qe(X,"meetups")));const e=await Promise.all(n),t=new Map;e.forEach(r=>r.docs.forEach(s=>t.set(s.id,{id:s.id,...s.data()}))),p.meetups=[...t.values()].sort((r,s)=>`${r.date}${r.time}`.localeCompare(`${s.date}${s.time}`))}catch(n){console.warn("Hent meetups:",n)}}function VR(n,e){return n.filter(t=>{var s,i;return(((i=(s=t.updatedAt)==null?void 0:s.toMillis)==null?void 0:i.call(s))??(typeof t.updatedAt=="number"?t.updatedAt:0))>e}).length}function ja(){const n=document.getElementById("meetup-badge");if(!n)return;const e=Number(localStorage.getItem(C_)||0),t=VR(p.meetups,e);n.classList.toggle("hidden",t===0),n.textContent=t}function LR(){localStorage.setItem(C_,String(Date.now())),ja()}function Ht(){const n=document.getElementById("meetups-list");if(!n)return;const e=new Date().toISOString().slice(0,10),t=p.meetups.filter(r=>r.date>=e);if(!t.length){n.innerHTML='<div class="empty"><div class="empty-icon">🏹</div>Ingen planlagte skydninger endnu</div>';return}n.innerHTML="",t.forEach(r=>n.appendChild(OR(r)))}function OR(n){var u;const e=document.createElement("div");e.className="meetup-card"+(n.status==="aflyst"?" meetup-cancelled":"");const t=n.creatorUid===((u=p.user)==null?void 0:u.uid),r=(n.participants||[]).find(h=>{var m;return h.uid===((m=p.user)==null?void 0:m.uid)}),s=p.isSuperAdmin&&!t&&!r,i=(n.participants||[]).map(h=>{const m=h.status==="foreslået"&&h.proposedDate?` → ${z(Sc(h.proposedDate))} ${z(h.proposedTime||"")}`:"";return`<div class="meetup-partrow"><span>${z(h.name)}</span><span class="meetup-status meetup-status-${z(h.status)}">${z(xR[h.status]||h.status)}${m}</span></div>`}).join(""),o=(n.comments||[]).map(h=>`<div class="meetup-comment"><b>${z(h.name)}:</b> ${z(h.text)}</div>`).join("");let c="";n.status!=="aflyst"&&(r&&(r.status!=="tilmeldt"&&(c+=`<button class="btn btn-gold btn-sm" onclick="joinMeetup('${n.id}')">Tilmeld</button>`),c+=`<button class="btn btn-dark btn-sm" onclick="openProposeTimeModal('${n.id}')">Foreslå andet tidspunkt</button>`,r.status!=="afvist"&&(c+=`<button class="btn btn-dark btn-sm" onclick="declineMeetup('${n.id}')">Afbud</button>`)),t&&((n.participants||[]).filter(h=>h.status==="foreslået"&&h.proposedDate).forEach(h=>{c+=`<button class="btn btn-gold btn-sm" onclick="acceptProposedTime('${n.id}','${h.uid}')">Accepter ${z(Sc(h.proposedDate))} ${z(h.proposedTime||"")} (${z(h.name)})</button>`}),c+=`<button class="btn btn-dark btn-sm" onclick="openEditMeetupModal('${n.id}')">Rediger tidspunkt</button>`,c+=`<button class="btn btn-dark btn-sm" onclick="cancelMeetup('${n.id}')">Aflys</button>`)),e.innerHTML=`
  ...
  `;const l=e.querySelector(".meetup-comment-input");return e.querySelector(".meetup-comment-send").addEventListener("click",()=>{FR(n.id,l.value),l.value=""}),e}window.openMeetupModal=function(){if(!p.courses.length){Z("Ingen baner tilgængelige","error");return}je=new Map,qi="venner",Js=null,Pu=null,document.getElementById("mu-course-display").value="",document.getElementById("mu-course-list").classList.add("hidden"),MR(),document.getElementById("mu-date").value="",document.getElementById("mu-time").value="",document.getElementById("mu-comment").value="",document.querySelectorAll(".mu-pool-tab").forEach(n=>n.classList.toggle("active",n.dataset.pool==="venner")),Ki(),qa(),document.getElementById("meetup-modal").classList.remove("hidden")};window.toggleMeetupCourseList=function(){document.getElementById("mu-course-list").classList.toggle("hidden")};function MR(){const n=document.getElementById("mu-course-list");n.innerHTML="",p.courses.forEach(e=>{const t=document.createElement("div");t.className="ac-item",t.textContent=e.name||e.yam||"",t.addEventListener("click",()=>{Pu=e.id,document.getElementById("mu-course-display").value=e.name||e.yam||"",n.classList.add("hidden")}),n.appendChild(t)})}window.toggleMeetupPool=function(n){qi=n,document.querySelectorAll(".mu-pool-tab").forEach(e=>e.classList.toggle("active",e.dataset.pool===n)),Ki()};async function cl(){if(!Js)try{Js=(await et(qe(X,"users"))).docs.map(e=>({uid:e.id,name:e.data().name||e.data().yam||e.data().email||"—"}))}catch(n){console.warn(n),Js=[]}return Js}async function N_(){if(qi==="venner"){const e=new Set((await cl()).map(t=>t.uid));return p.friends.map(t=>({uid:t.id,name:t.name,registered:e.has(t.id)})).sort((t,r)=>t.name.localeCompare(r.name,"da"))}return(await cl()).filter(e=>{var t;return e.uid!==((t=p.user)==null?void 0:t.uid)}).map(e=>({...e,registered:!0})).sort((e,t)=>e.name.localeCompare(t.name,"da"))}async function Ki(){const n=document.getElementById("mu-invitee-list");if(!n)return;const e=await N_();if(n.innerHTML="",!e.length){n.innerHTML=`<div class="empty"><div class="empty-icon">👤</div>${qi==="venner"?"Du har ingen venner endnu":"Ingen andre registrerede brugere"}</div>`;return}e.forEach(t=>{const r=document.createElement("label");r.className="mu-invitee-row"+(t.registered===!1?" mu-invitee-unregistered":"");const s=document.createElement("input");s.type="checkbox",s.checked=je.has(t.uid);const i=document.createElement("span");if(i.textContent=t.name,r.appendChild(s),r.appendChild(i),t.registered===!1){s.disabled=!0;const o=document.createElement("span");o.className="mu-invitee-note",o.textContent="ikke registreret i appen",r.appendChild(o)}else s.addEventListener("change",()=>x_(t.uid,t.name));n.appendChild(r)})}function x_(n,e){je.has(n)?je.delete(n):je.set(n,{uid:n,name:e}),qa(),Ki()}window.toggleSelectAllMeetup=async function(){const n=(await N_()).filter(t=>t.registered!==!1);if(!n.length)return;n.every(t=>je.has(t.uid))?n.forEach(t=>je.delete(t.uid)):n.forEach(t=>je.set(t.uid,t)),qa(),Ki()};function qa(){const n=document.getElementById("mu-selected-chips");if(n){if(n.innerHTML="",!je.size){n.innerHTML='<div class="mu-chips-empty">Ingen modtagere valgt endnu</div>';return}[...je.values()].forEach(e=>{const t=document.createElement("div");t.className="pchip";const r=document.createElement("span");r.className="pchip-name",r.textContent=e.name;const s=document.createElement("button");s.className="pchip-rm",s.textContent="✕",s.addEventListener("click",()=>x_(e.uid,e.name)),t.appendChild(r),t.appendChild(s),n.appendChild(t)})}}window.saveMeetup=async function(){var m,_;const n=p.courses.find(v=>v.id===Pu),e=document.getElementById("mu-date").value,t=document.getElementById("mu-time").value;if(!n){Z("Vælg en bane","error");return}if(!e||!t){Z("Vælg dato og tid","error");return}if(!je.size){Z("Vælg mindst én modtager","error");return}const r=new Set((await cl()).map(v=>v.uid)),s=[...je.values()].filter(v=>!r.has(v.uid)).map(v=>v.name);if(s.length&&(s.forEach(v=>{const P=[...je.entries()].find(([,C])=>C.name===v);P&&je.delete(P[0])}),Z(`${s.join(", ")} er ikke registreret i appen og blev ikke inviteret`,"error"),qa(),Ki(),!je.size))return;const i=document.getElementById("mu-comment").value.trim().slice(0,300),o=[...je.keys()],c=[...je.values()].map(v=>({uid:v.uid,name:v.name,status:"afventer",proposedDate:null,proposedTime:null})),l=i?[{uid:p.user.uid,name:((m=p.profile)==null?void 0:m.name)||"—",text:i,createdAt:new Date}]:[],u=new Date(`${e}T${t}`);u.setDate(u.getDate()+1);const h={courseId:n.id,courseName:n.name||n.yam||"",date:e,time:t,creatorUid:p.user.uid,creatorName:((_=p.profile)==null?void 0:_.name)||"—",pool:qi,invitedUids:o,participants:c,comments:l,status:"åben",createdAt:pt(),updatedAt:pt(),expireAt:u};try{await Tg(qe(X,"meetups"),h),document.getElementById("meetup-modal").classList.add("hidden"),Z("Forslag sendt","success"),await Cu(),Ht(),ja()}catch(v){Z("Fejl: "+v.message,"error")}};async function V_(n,e){const t=p.meetups.find(s=>s.id===n);if(!t||!p.user)return;const r=(t.participants||[]).map(s=>s.uid===p.user.uid?{...s,status:e,proposedDate:null,proposedTime:null}:s);try{await nt(ie(X,"meetups",t.id),{participants:r,updatedAt:pt()}),t.participants=r,t.updatedAt=Date.now(),Ht()}catch(s){Z("Fejl: "+s.message,"error")}}window.joinMeetup=function(n){V_(n,"tilmeldt")};window.declineMeetup=function(n){V_(n,"afvist")};window.openProposeTimeModal=function(n){k_=n,document.getElementById("mu-propose-date").value="",document.getElementById("mu-propose-time").value="",document.getElementById("meetup-propose-modal").classList.remove("hidden")};window.saveProposeTime=async function(){const n=document.getElementById("mu-propose-date").value,e=document.getElementById("mu-propose-time").value;if(!n||!e){Z("Vælg dato og tid","error");return}const t=p.meetups.find(s=>s.id===k_);if(!t||!p.user)return;const r=(t.participants||[]).map(s=>s.uid===p.user.uid?{...s,status:"foreslået",proposedDate:n,proposedTime:e}:s);try{await nt(ie(X,"meetups",t.id),{participants:r,updatedAt:pt()}),t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-propose-modal").classList.add("hidden"),Ht()}catch(s){Z("Fejl: "+s.message,"error")}};window.acceptProposedTime=async function(n,e){var c;const t=p.meetups.find(l=>l.id===n);if(!t||t.creatorUid!==((c=p.user)==null?void 0:c.uid))return;const r=(t.participants||[]).find(l=>l.uid===e);if(!(r!=null&&r.proposedDate)||!(r!=null&&r.proposedTime))return;const s=r.proposedDate,i=r.proposedTime,o=t.participants.map(l=>l.uid===e?{...l,status:"tilmeldt",proposedDate:null,proposedTime:null}:{...l,status:"afventer",proposedDate:null,proposedTime:null});try{await nt(ie(X,"meetups",t.id),{date:s,time:i,participants:o,updatedAt:pt()}),t.date=s,t.time=i,t.participants=o,t.updatedAt=Date.now(),Ht(),Z("Nyt tidspunkt accepteret","success")}catch(l){Z("Fejl: "+l.message,"error")}};window.openEditMeetupModal=function(n){var t;const e=p.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=p.user)==null?void 0:t.uid)||(D_=n,document.getElementById("mu-edit-date").value=e.date,document.getElementById("mu-edit-time").value=e.time,document.getElementById("meetup-edit-modal").classList.remove("hidden"))};window.saveEditMeetup=async function(){var s;const n=document.getElementById("mu-edit-date").value,e=document.getElementById("mu-edit-time").value;if(!n||!e){Z("Vælg dato og tid","error");return}const t=p.meetups.find(i=>i.id===D_);if(!t||t.creatorUid!==((s=p.user)==null?void 0:s.uid))return;const r=(t.participants||[]).map(i=>({...i,status:"afventer",proposedDate:null,proposedTime:null}));try{await nt(ie(X,"meetups",t.id),{date:n,time:e,participants:r,updatedAt:pt()}),t.date=n,t.time=e,t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-edit-modal").classList.add("hidden"),Ht(),Z("Tidspunkt opdateret","success")}catch(i){Z("Fejl: "+i.message,"error")}};window.cancelMeetup=function(n){var t;const e=p.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=p.user)==null?void 0:t.uid)||Ui("Aflys denne skydning?",async()=>{try{await nt(ie(X,"meetups",e.id),{status:"aflyst",updatedAt:pt()}),e.status="aflyst",e.updatedAt=Date.now(),Ht()}catch(r){Z("Fejl: "+r.message,"error")}})};async function FR(n,e){var i;if(e=(e||"").trim().slice(0,300),!e||!p.user)return;const t=p.meetups.find(o=>o.id===n);if(!t)return;const r={uid:p.user.uid,name:((i=p.profile)==null?void 0:i.name)||"—",text:e,createdAt:new Date},s=[...t.comments||[],r];try{await nt(ie(X,"meetups",t.id),{comments:s,updatedAt:pt()}),t.comments=s,t.updatedAt=Date.now(),Ht()}catch(o){Z("Fejl: "+o.message,"error")}}const BR="BOJHqC2HeXd9Ru6EjuL7HEuAZuZ2MM86LPqPfVbeQsm8M8-wgT_u3QPWYFs0XN0vfMz_FS3rDgjXgCXXm0GkmZs",UR="/3D/sw.js";async function L_(){if(!("serviceWorker"in navigator))return null;try{return await navigator.serviceWorker.register(UR,{scope:"/3D/3D-dev/"})}catch(n){return console.warn("SW-registrering fejlede",n),null}}function $R(){return"Notification"in window&&Notification.permission==="default"}async function O_(){let n;try{n=await Notification.requestPermission()}catch(e){return console.warn("Notification.requestPermission fejlede",e),Z("Kunne ikke bede om tilladelse: "+e.message,"error"),!1}if(n==="denied")return Z("Notifikationer blokeret i browseren — skal ændres i browserens side-indstillinger","error"),!1;if(n!=="granted")return!1;try{if(!await __||!Ai)return Z("Push-notifikationer understøttes ikke i denne browser","error"),!1;const t=await L_();if(!t)return Z("Kunne ikke registrere service worker","error"),!1;const r=await iR(Ai,{vapidKey:BR,serviceWorkerRegistration:t});return r?(await nt(ie(X,"users",p.user.uid),{fcmToken:r}),!0):(Z("Kunne ikke hente push-token","error"),!1)}catch(e){return console.warn("Push-opsætning fejlede",e),Z("Push-fejl: "+e.message,"error"),!1}}function jR(){"Notification"in window&&Notification.permission==="granted"&&O_()}function qR(){__.then(n=>{!n||!Ai||oR(Ai,e=>{const t=e.data||{};Z(t.body||"Ny besked","info"),Cu().then(()=>{Ht(),ja()}).catch(()=>{})})})}function wf(n,e){var L;const t=V=>{var U;return V.shooters.find(G=>G.id===e)||((U=V.shooters)==null?void 0:U[0])},r=n.map(V=>{const U=t(V);return U?Ze(U.scores):null}).filter(V=>V!==null);let s=0,i=0,o=0,c=0;const l={11:0,10:0,8:0,5:0,M:0},u={11:0,10:0,8:0,5:0,M:0};n.forEach(V=>{const U=t(V);U&&U.scores.forEach(G=>{G[0]!=null&&(G[0]==="M"?(l.M++,i++):(l[Number(G[0])]=(l[Number(G[0])]||0)+1,s+=Number(G[0]),i++)),G[1]!=null&&(G[1]==="M"?(u.M++,c++):(u[Number(G[1])]=(u[Number(G[1])]||0)+1,o+=Number(G[1]),c++))})});const h=i?(s/i).toFixed(2):0,m=c?(o/c).toFixed(2):0,_=i+c?((s+o)/(i+c)).toFixed(2):0,v=((L=n[0])==null?void 0:L.numTargets)||24,C=Array.from({length:v},(V,U)=>{let G=0,ee=0;return n.forEach(E=>{const y=t(E);if(!y)return;(y.scores[U]||[null,null]).forEach(T=>{T!=null&&(G+=Oe(T),ee++)})}),ee?G/ee:null}).map((V,U)=>({v:V,i:U})).filter(V=>V.v!==null),k=C.length?C.reduce((V,U)=>V.v>U.v?V:U):null,F=C.length?C.reduce((V,U)=>V.v<U.v?V:U):null;return{myScores:r,p1avg:h,p2avg:m,pilAvg:_,distP1:l,distP2:u,bestTarget:k,worstTarget:F}}function If(n){if(!n.length)return 0;const e=n.reduce((t,r)=>t+r,0)/n.length;return Math.sqrt(n.reduce((t,r)=>t+(r-e)**2,0)/n.length)}function KR(n){var l;const e=n.length;if(e<2)return{slope:0,intercept:((l=n[0])==null?void 0:l.y)||0};const t=n.reduce((u,h)=>u+h.x,0),r=n.reduce((u,h)=>u+h.y,0),s=n.reduce((u,h)=>u+h.x*h.y,0),i=n.reduce((u,h)=>u+h.x*h.x,0),o=e*i-t*t,c=o?(e*s-t*r)/o:0;return{slope:c,intercept:(r-c*t)/e}}function GR(n,e){var o,c;const t=((o=n.shooters)==null?void 0:o.find(l=>l.id===e))||((c=n.shooters)==null?void 0:c[0]);if(!t)return[];const r=n.numTargets||24,s=n.traversalOrder||Array.from({length:r},(l,u)=>u),i=[];for(let l=0;l<r;l++){const u=s[l];if(u===void 0)continue;const h=t.scores[u]||[null,null];let m=0,_=0;h.forEach(v=>{v!=null&&(m+=Oe(v),_++)}),_&&i.push(m/_)}return i}function zR(n,e){let t=1,r=0,s=0,i=0,o=1,c=0,l=0,u=0,h=0,m=0,_=0,v=0,P=0;const C=()=>{e.style.transformOrigin="0 0",e.style.transform=t>1?`translate(${r}px,${s}px) scale(${t})`:""};n.addEventListener("touchstart",F=>{if(F.preventDefault(),F.touches.length===2){const L=F.touches,V=n.getBoundingClientRect();i=Math.hypot(L[0].clientX-L[1].clientX,L[0].clientY-L[1].clientY),o=t,c=r,l=s,u=(L[0].clientX+L[1].clientX)/2-V.left,h=(L[0].clientY+L[1].clientY)/2-V.top}else F.touches.length===1&&(m=F.touches[0].clientX,_=F.touches[0].clientY,v=r,P=s)},{passive:!1}),n.addEventListener("touchmove",F=>{if(F.preventDefault(),F.touches.length===2){const L=F.touches,V=Math.hypot(L[0].clientX-L[1].clientX,L[0].clientY-L[1].clientY),U=Math.min(8,Math.max(1,o*V/i)),G=(u-c)/o,ee=(h-l)/o;r=u-G*U,s=h-ee*U,t=U,C()}else F.touches.length===1&&t>1&&(r=v+F.touches[0].clientX-m,s=P+F.touches[0].clientY-_,C())},{passive:!1}),n.addEventListener("touchend",()=>{t<1.05&&(t=1,r=0,s=0,C())},{passive:!0});let k=0;n.addEventListener("touchend",()=>{const F=Date.now();F-k<300&&(t=1,r=0,s=0,C()),k=F},{passive:!0})}let Bt=null,sr=null;function HR(){const n=document.getElementById("graph-fs");n&&n.classList.add("hidden"),Bt&&(window.removeEventListener("resize",Bt),window.removeEventListener("orientationchange",Bt),Bt=null),sr&&(document.removeEventListener("gesturestart",sr),sr=null)}window.closeGraphFs=HR;function WR(n){p.pendingAnalyseRound=n,document.getElementById("analyse-filter").value="specific",window.switchTab("analyse")}window.analyseRound=WR;function QR(n,e,t,r){const s=["11","10","8","5","M"],i={11:"#1a7a3a",10:"#1a5aaa",8:"#d4700a",5:"#7a3aaa",M:"#cc3333"},o=n.myScores[0]||0,c=t.myScores[0]||0,l=Math.abs(o-c),u='<div class="cmp-sep"></div>',h=(v,P,C)=>`<div style="font-size:11px;color:${C};margin-bottom:4px;">${z(P)}</div>
    ...
    <div class="cmp-pil-grid">
      <div><div class="stat-lbl">PIL 1</div><div class="stat-val-22">${Wt}</div></div>
      <div class="cmp-pil-mid">
        <div class="stat-lbl">SNT/PIL</div>
        <div class="stat-val-22-mid">${jn}</div>
      </div>
      <div><div class="stat-lbl">PIL 2</div><div class="stat-val-22">${Qt}</div></div>
    </div>
    <div class="pil-best-note">
      ${Number(Wt)>Number(Qt)?"Bedst med PIL 1 🏹":Number(Qt)>Number(Wt)?"Bedst med PIL 2 🏹":"Begge pile er lige gode 🎯"}
    </div>
    ...
    </div>`,window.openGraphFs=function(){const _e=document.getElementById("graph-fs");if(!_e)return;_e.classList.remove("hidden");const st=document.getElementById("graph-fs-svg"),Mt=document.getElementById("graph-fs-box"),Rt=document.getElementById("graph-fs-viewport"),Lr=()=>{const Ge=Math.min(window.innerWidth*.96,900),ze=Math.min(window.innerHeight*.9,700),zn=Math.max(200,Ge-32),Pt=Math.max(140,ze-90),pn=Math.max(zn,mt*30);st.setAttribute("viewBox",`0 0 ${pn} ${Pt}`),st.innerHTML=St(pn,Pt,{dotR:5,valFont:10,showVals:!0}),Mt&&(Mt.style.width=Ge+"px"),Rt&&(Rt.style.width=zn+"px",Rt.style.height=Pt+"px")};Lr(),Bt&&(window.removeEventListener("resize",Bt),window.removeEventListener("orientationchange",Bt)),Bt=Lr,window.addEventListener("resize",Bt),window.addEventListener("orientationchange",Bt),sr&&document.removeEventListener("gesturestart",sr),sr=Ge=>Ge.preventDefault(),document.addEventListener("gesturestart",sr,{passive:!1}),Rt&&!Rt.dataset.pinchInit&&(zR(Rt,st),Rt.dataset.pinchInit="1")}}if(s!=="all"){const $=Q=>{const W=Q.created;return W!=null&&W.toDate?W.toDate().getTime():W!=null&&W.seconds?W.seconds*1e3:typeof W=="number"?W:0},B=P.filter(Q=>Q.courseId===s).filter(Q=>!C||F(Q)).filter(Q=>!k||L(Q)).map(Q=>{var J;const W=GR(Q,(J=p.user)==null?void 0:J.uid);return W.length>1?{t:$(Q),cv:If(W)}:null}).filter(Boolean).sort((Q,W)=>Q.t-W.t);if(B.length>1){const ce=B.map(Ve=>Ve.cv),de=Math.min(...ce),fe=Math.max(...ce),re=fe-de||1,le=(Ve,St)=>({x:30+St/(B.length-1)*(340-2*30),y:90-(Ve.cv-de)/re*(120-2*30)}),rt=B.map((Ve,St)=>{const{x:yt,y:_e}=le(Ve,St);return`${yt},${_e}`}).join(" "),xe=B.map((Ve,St)=>{const{x:yt,y:_e}=le(Ve,St);return`<circle cx="${yt}" cy="${_e}" r="4" fill="#f0c030"/><text x="${yt}" y="${_e-8}" text-anchor="middle" font-size="10" fill="var(--text)">${Ve.cv.toFixed(2)}</text>`}).join("");_t+=`<div class="card card-mb16">
