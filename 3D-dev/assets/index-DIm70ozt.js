 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jo=new Map,Pv=new Map,Vc=new Map;function Cd(n,e){try{n.container.addComponent(e)}catch(t){hn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ct(n){const e=n.name;if(Vc.has(e))return hn.debug(`There were multiple attempts to register component ${e}.`),!1;Vc.set(e,n);for(const t of jo.values())Cd(t,n);for(const t of Pv.values())Cd(t,n);return!0}function Ar(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function jt(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=Sv;function Lf(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:xc,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw xn.create("bad-app-name",{appName:String(s)});if(t||(t=Cf()),!t)throw xn.create("no-options");const i=jo.get(s);if(i){if(fi(t,i.options)&&fi(r,i.config))return i;throw xn.create("duplicate-app",{appName:s})}const o=new Oy(s);for(const l of Vc.values())o.addComponent(l);const c=new kv(t,r,o);return jo.set(s,c),c}function ml(n=xc){const e=jo.get(n);if(!e&&n===xc&&Cf())return Lf();if(!e)throw xn.create("no-app",{appName:n});return e}function pt(n,e,t){var r;let s=(r=Rv[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),hn.warn(c.join(" "));return}Ct(new St(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bv(n){Ct(new St("platform-logger",e=>new Xy(e),"PRIVATE")),Ct(new St("heartbeat",e=>new Mv(e),"PRIVATE")),pt(Nc,Pd,n),pt(Nc,Pd,"esm2017"),pt("fire-js","")}Bv("");var Uv="firebase",$v="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qo=new fl("@firebase/auth");function qv(n,...e){qo.logLevel<=ae.WARN&&qo.warn(`Auth (${Sr}): ${n}`,...e)}function bo(n,...e){qo.logLevel<=ae.ERROR&&qo.error(`Auth (${Sr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Li{constructor(e,t){this.shortDelay=e,this.longDelay=t,fn(t>e,"Short delay should be less than long delay!"),this.isMobile=wy()||by()}get(){return Gv()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yl(n,e){fn(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zv(n,e){return gn(n,"POST","/v1/accounts:delete",e)}async function Kf(n,e){return gn(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Md=new Map;function an(n){fn(n instanceof Function,"Expected a class definition");let e=Md.get(n);return e?(fn(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Md.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fd(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Jf(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Hf(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Xf(e))return"Blackberry";if(Zf(e))return"Webos";if(Wf(e))return"Safari";if((e.includes("chrome/")||Qf(e))&&!e.includes("edge/"))return"Chrome";if(Yf(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Hf(n=Fe()){return/firefox\//i.test(n)}function Wf(n=Fe()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Qf(n=Fe()){return/crios\//i.test(n)}function Jf(n=Fe()){return/iemobile/i.test(n)}function Yf(n=Fe()){return/android/i.test(n)}function Xf(n=Fe()){return/blackberry/i.test(n)}function Zf(n=Fe()){return/webos/i.test(n)}function wl(n=Fe()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function aw(n=Fe()){var e;return wl(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function cw(){return Ay()&&document.documentMode===10}function ep(n=Fe()){return wl(n)||Yf(n)||Zf(n)||Xf(n)||/windows phone/i.test(n)||Jf(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uw(n,e={}){return gn(n,"GET","/v2/passwordPolicy",mn(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Il{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return sn("not implemented")}_getIdTokenResponse(e){return sn("not implemented")}_linkToIdToken(e,t){return sn("not implemented")}_getReauthenticationResolver(e){return sn("not implemented")}}async function Sw(n,e){return gn(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rw(n,e){return Mi(n,"POST","/v1/accounts:signInWithPassword",mn(n,e))}async function Pw(n,e){return gn(n,"POST","/v1/accounts:sendOobCode",mn(n,e))}async function Cw(n,e){return Pw(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kw(n,e){return Mi(n,"POST","/v1/accounts:signInWithEmailLink",mn(n,e))}async function Dw(n,e){return Mi(n,"POST","/v1/accounts:signInWithEmailLink",mn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ns(n,e){return Mi(n,"POST","/v1/accounts:signInWithIdp",mn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xw(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Vw(n){const e=Hs(Ws(n)).link,t=e?Hs(Ws(e)).deep_link_id:null,r=Hs(Ws(n)).deep_link_id;return(r?Hs(Ws(r)).link:null)||r||t||e||n}class El{constructor(e){var t,r,s,i,o,c;const l=Hs(Ws(e)),u=(t=l.apiKey)!==null&&t!==void 0?t:null,h=(r=l.oobCode)!==null&&r!==void 0?r:null,p=xw((s=l.mode)!==null&&s!==void 0?s:null);ne(u&&h&&p,"argument-error"),this.apiKey=u,this.operation=p,this.code=h,this.continueUrl=(i=l.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(c=l.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=Vw(e);try{return new El(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn extends Oi{constructor(){super("facebook.com")}static credential(e){return dr._fromParams({providerId:Sn.PROVIDER_ID,signInMethod:Sn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Sn.credentialFromTaggedObject(e)}static credentialFromError(e){return Sn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Sn.credential(e.oauthAccessToken)}catch{return null}}}Sn.FACEBOOK_SIGN_IN_METHOD="facebook.com";Sn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn extends Oi{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return dr._fromParams({providerId:Rn.PROVIDER_ID,signInMethod:Rn.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Rn.credentialFromTaggedObject(e)}static credentialFromError(e){return Rn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return Rn.credential(t,r)}catch{return null}}}Rn.GOOGLE_SIGN_IN_METHOD="google.com";Rn.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pn extends Oi{constructor(){super("github.com")}static credential(e){return dr._fromParams({providerId:Pn.PROVIDER_ID,signInMethod:Pn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Pn.credentialFromTaggedObject(e)}static credentialFromError(e){return Pn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Pn.credential(e.oauthAccessToken)}catch{return null}}}Pn.GITHUB_SIGN_IN_METHOD="github.com";Pn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cn extends Oi{constructor(){super("twitter.com")}static credential(e,t){return dr._fromParams({providerId:Cn.PROVIDER_ID,signInMethod:Cn.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Cn.credentialFromTaggedObject(e)}static credentialFromError(e){return Cn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return Cn.credential(t,r)}catch{return null}}}Cn.TWITTER_SIGN_IN_METHOD="twitter.com";Cn.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lw(n,e){return Mi(n,"POST","/v1/accounts:signUp",mn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ow(n,e,t=!1){const{auth:r}=n;if(jt(r.app))return Promise.reject(dn(r));const s="reauthenticate";try{const i=await mi(n,ip(r,s,e,n),t);ne(i.idToken,r,"internal-error");const o=vl(i.idToken);ne(o,r,"internal-error");const{sub:c}=o;return ne(n.uid===c,r,"user-mismatch"),hr._forOperation(n,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&kt(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function op(n,e,t=!1){if(jt(n.app))return Promise.reject(dn(n));const r="signIn",s=await ip(n,r,e),i=await hr._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Fw(n,e){return op(Un(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ap(n){const e=Un(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Bw(n,e,t){const r=Un(n);await Go(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Cw)}async function Uw(n,e,t){if(jt(n.app))return Promise.reject(dn(n));const r=Un(n),o=await Go(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Lw).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&ap(n),l}),c=await hr._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function $w(n,e,t){return jt(n.app)?Promise.reject(dn(n)):Fw(we(n),_s.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&ap(n),r})}function jw(n,e,t,r){return we(n).onIdTokenChanged(e,t,r)}function qw(n,e,t){return we(n).beforeAuthStateChanged(e,t)}function Kw(n,e,t,r){return we(n).onAuthStateChanged(e,t,r)}function Gw(n){return we(n).signOut()}const Ho="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aI(n,e){return e?an(e):(ne(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gp{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:o,type:c}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(c)(l))}catch(u){this.reject(u)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return cI;case"linkViaPopup":case"linkViaRedirect":return uI;case"reauthViaPopup":case"reauthViaRedirect":return lI;default:kt(this.auth,"internal-error")}}resolve(e){fn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){fn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function EI(n,e={}){return gn(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pc="webStorageSupport";class WI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=dp,this._completeRedirectFn=yI,this._overrideRedirectResult=mI}async _openPopup(e,t,r,s){var i;fn((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await Wd(e,t,r,Lc(),s);return jI(e,o,Tl())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await Wd(e,t,r,Lc(),s);return Yw(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(fn(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await MI(e),r=new wI(e);return t.register("authEvent",s=>(ne(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(pc,{type:pc},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[pc];o!==void 0&&t(!!o),kt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=AI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ep()||Wf()||wl()}}const QI=WI;var Qd="@firebase/auth",Jd="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YI(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function XI(n){Ct(new St("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;ne(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:tp(n)},u=new fw(r,s,i,l);return Ew(u,t),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),Ct(new St("auth-internal",e=>{const t=Un(e.getProvider("auth").getImmediate());return(r=>new JI(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),pt(Qd,Jd,YI(n)),pt(Qd,Jd,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var vp,Qs,wp,Po,Fc,Ip,Ep,Tp;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,d,f){return a==Array.prototype||a==Object.prototype||(a[d]=f.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof go=="object"&&go];for(var d=0;d<a.length;++d){var f=a[d];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=t(this);function s(a,d){if(d)e:{var f=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var S=a[g];if(!(S in f))break e;f=f[S]}a=a[a.length-1],g=f[a],d=d(g),d!=g&&d!=null&&e(f,a,{configurable:!0,writable:!0,value:d})}}function i(a,d){a instanceof String&&(a+="");var f=0,g=!1,S={next:function(){if(!g&&f<a.length){var k=f++;return{value:d(k,a[k]),done:!1}}return g=!0,{done:!0,value:void 0}}};return S[Symbol.iterator]=function(){return S},S}s("Array.prototype.values",function(a){return a||function(){return i(this,function(d,f){return f})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(a){var d=typeof a;return d=d!="object"?d:a?Array.isArray(a)?"array":d:"null",d=="array"||d=="object"&&typeof a.length=="number"}function u(a){var d=typeof a;return d=="object"&&a!=null||d=="function"}function h(a,d,f){return a.call.apply(a.bind,arguments)}function p(a,d,f){if(!a)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var S=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(S,g),a.apply(d,S)}}return function(){return a.apply(d,arguments)}}function _(a,d,f){return _=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:p,_.apply(null,arguments)}function v(a,d){var f=Array.prototype.slice.call(arguments,1);return function(){var g=f.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function A(a,d){function f(){}f.prototype=d.prototype,a.aa=d.prototype,a.prototype=new f,a.prototype.constructor=a,a.Qb=function(g,S,k){for(var M=Array(arguments.length-2),me=2;me<arguments.length;me++)M[me-2]=arguments[me];return d.prototype[S].apply(g,M)}}function D(a){const d=a.length;if(0<d){const f=Array(d);for(let g=0;g<d;g++)f[g]=a[g];return f}return[]}function C(a,d){for(let f=1;f<arguments.length;f++){const g=arguments[f];if(l(g)){const S=a.length||0,k=g.length||0;a.length=S+k;for(let M=0;M<k;M++)a[S+M]=g[M]}else a.push(g)}}class V{constructor(d,f){this.i=d,this.j=f,this.h=0,this.g=null}get(){let d;return 0<this.h?(this.h--,d=this.g,this.g=d.next,d.next=null):d=this.i(),d}}function F(a){return/^[\s\xa0]*$/.test(a)}function B(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function q(a){return q[" "](a),a}q[" "]=function(){};var H=B().indexOf("Gecko")!=-1&&!(B().toLowerCase().indexOf("webkit")!=-1&&B().indexOf("Edge")==-1)&&!(B().indexOf("Trident")!=-1||B().indexOf("MSIE")!=-1)&&B().indexOf("Edge")==-1;function j(a,d,f){for(const g in a)d.call(f,a[g],g,a)}function E(a,d){for(const f in a)d.call(void 0,a[f],f,a)}function y(a){const d={};for(const f in a)d[f]=a[f];return d}const I="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function T(a,d){let f,g;for(let S=1;S<arguments.length;S++){g=arguments[S];for(f in g)a[f]=g[f];for(let k=0;k<I.length;k++)f=I[k],Object.prototype.hasOwnProperty.call(g,f)&&(a[f]=g[f])}}function b(a){var d=1;a=a.split(":");const f=[];for(;0<d&&a.length;)f.push(a.shift()),d--;return a.length&&f.push(a.join(":")),f}function R(a){c.setTimeout(()=>{throw a},0)}function w(){var a=zn;let d=null;return a.g&&(d=a.g,a.g=a.g.next,a.g||(a.h=null),d.next=null),d}class gt{constructor(){this.h=this.g=null}add(d,f){const g=Et.get();g.set(d,f),this.h?this.h.next=g:this.g=g,this.h=g}}var Et=new V(()=>new Ss,a=>a.reset());class Ss{constructor(){this.next=this.g=this.h=null}set(d,f){this.h=d,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let Lt,Mt=!1,zn=new gt,Dr=()=>{const a=c.Promise.resolve(void 0);Lt=()=>{a.then(Rs)}};var Rs=()=>{for(var a;a=w();){try{a.h.call(a.g)}catch(f){R(f)}var d=Et;d.j(a),100>d.h&&(d.h++,a.next=d.g,d.g=a)}Mt=!1};function Ve(){this.s=this.s,this.C=this.C}Ve.prototype.s=!1,Ve.prototype.ma=function(){this.s||(this.s=!0,this.N())},Ve.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Me(a,d){this.type=a,this.g=this.target=d,this.defaultPrevented=!1}Me.prototype.h=function(){this.defaultPrevented=!0};var Nr=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,d=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};c.addEventListener("test",f,d),c.removeEventListener("test",f,d)}catch{}return a}();function Ot(a,d){if(Me.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var f=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=d,d=a.relatedTarget){if(H){e:{try{q(d.nodeName);var S=!0;break e}catch{}S=!1}S||(d=null)}}else f=="mouseover"?d=a.fromElement:f=="mouseout"&&(d=a.toElement);this.relatedTarget=d,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:xr[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Ot.aa.h.call(this)}}A(Ot,Me);var xr={2:"touch",3:"pen",4:"mouse"};Ot.prototype.h=function(){Ot.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Vr="closure_listenable_"+(1e6*Math.random()|0),ze=0;function Yt(a,d,f,g,S){this.listener=a,this.proxy=null,this.src=d,this.type=f,this.capture=!!g,this.ha=S,this.key=++ze,this.da=this.fa=!1}function Hn(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Wn(a){this.src=a,this.g={},this.h=0}Wn.prototype.add=function(a,d,f,g,S){var k=a.toString();a=this.g[k],a||(a=this.g[k]=[],this.h++);var M=Mr(a,d,g,S);return-1<M?(d=a[M],f||(d.fa=!1)):(d=new Yt(d,this.src,k,!!g,S),d.fa=f,a.push(d)),d};function Lr(a,d){var f=d.type;if(f in a.g){var g=a.g[f],S=Array.prototype.indexOf.call(g,d,void 0),k;(k=0<=S)&&Array.prototype.splice.call(g,S,1),k&&(Hn(d),a.g[f].length==0&&(delete a.g[f],a.h--))}}function Mr(a,d,f,g){for(var S=0;S<a.length;++S){var k=a[S];if(!k.da&&k.listener==d&&k.capture==!!f&&k.ha==g)return S}return-1}var Or="closure_lm_"+(1e6*Math.random()|0),Fr={};function Ps(a,d,f,g,S){if(Array.isArray(d)){for(var k=0;k<d.length;k++)Ps(a,d[k],f,g,S);return null}return f=Y(f),a&&a[Vr]?a.K(d,f,u(g)?!!g.capture:!1,S):Yi(a,d,f,!1,g,S)}function Yi(a,d,f,g,S,k){if(!d)throw Error("Invalid event type");var M=u(S)?!!S.capture:!!S,me=J(a);if(me||(a[Or]=me=new Wn(a)),f=me.add(d,f,g,M,k),f.proxy)return f;if(g=Xi(),f.proxy=g,g.src=a,g.listener=f,a.addEventListener)Nr||(S=M),S===void 0&&(S=!1),a.addEventListener(d.toString(),g,S);else if(a.attachEvent)a.attachEvent(L(d.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return f}function Xi(){function a(f){return d.call(a.src,a.listener,f)}const d=U;return a}function Cs(a,d,f,g,S){if(Array.isArray(d))for(var k=0;k<d.length;k++)Cs(a,d[k],f,g,S);else g=u(g)?!!g.capture:!!g,f=Y(f),a&&a[Vr]?(a=a.i,d=String(d).toString(),d in a.g&&(k=a.g[d],f=Mr(k,f,g,S),-1<f&&(Hn(k[f]),Array.prototype.splice.call(k,f,1),k.length==0&&(delete a.g[d],a.h--)))):a&&(a=J(a))&&(d=a.g[d.toString()],a=-1,d&&(a=Mr(d,f,g,S)),(f=-1<a?d[a]:null)&&Br(f))}function Br(a){if(typeof a!="number"&&a&&!a.da){var d=a.src;if(d&&d[Vr])Lr(d.i,a);else{var f=a.type,g=a.proxy;d.removeEventListener?d.removeEventListener(f,g,a.capture):d.detachEvent?d.detachEvent(L(f),g):d.addListener&&d.removeListener&&d.removeListener(g),(f=J(d))?(Lr(f,a),f.h==0&&(f.src=null,d[Or]=null)):Hn(a)}}}function L(a){return a in Fr?Fr[a]:Fr[a]="on"+a}function U(a,d){if(a.da)a=!0;else{d=new Ot(d,this);var f=a.listener,g=a.ha||a.src;a.fa&&Br(a),a=f.call(g,d)}return a}function J(a){return a=a[Or],a instanceof Wn?a:null}var W="__closure_events_fn_"+(1e9*Math.random()>>>0);function Y(a){return typeof a=="function"?a:(a[W]||(a[W]=function(d){return a.handleEvent(d)}),a[W])}function te(){Ve.call(this),this.i=new Wn(this),this.M=this,this.F=null}A(te,Ve),te.prototype[Vr]=!0,te.prototype.removeEventListener=function(a,d,f,g){Cs(this,a,d,f,g)};function se(a,d){var f,g=a.F;if(g)for(f=[];g;g=g.F)f.push(g);if(a=a.M,g=d.type||d,typeof d=="string")d=new Me(d,a);else if(d instanceof Me)d.target=d.target||a;else{var S=d;d=new Me(g,a),T(d,S)}if(S=!0,f)for(var k=f.length-1;0<=k;k--){var M=d.g=f[k];S=ue(M,g,!0,d)&&S}if(M=d.g=a,S=ue(M,g,!0,d)&&S,S=ue(M,g,!1,d)&&S,f)for(k=0;k<f.length;k++)M=d.g=f[k],S=ue(M,g,!1,d)&&S}te.prototype.N=function(){if(te.aa.N.call(this),this.i){var a=this.i,d;for(d in a.g){for(var f=a.g[d],g=0;g<f.length;g++)Hn(f[g]);delete a.g[d],a.h--}}this.F=null},te.prototype.K=function(a,d,f,g){return this.i.add(String(a),d,!1,f,g)},te.prototype.L=function(a,d,f,g){return this.i.add(String(a),d,!0,f,g)};function ue(a,d,f,g){if(d=a.i.g[String(d)],!d)return!0;d=d.concat();for(var S=!0,k=0;k<d.length;++k){var M=d[k];if(M&&!M.da&&M.capture==f){var me=M.listener,je=M.ha||M.src;M.fa&&Lr(a.i,M),S=me.call(je,g)!==!1&&S}}return S&&!g.defaultPrevented}function ge(a,d,f){if(typeof a=="function")f&&(a=_(a,f));else if(a&&typeof a.handleEvent=="function")a=_(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(d)?-1:c.setTimeout(a,d||0)}function ye(a){a.g=ge(()=>{a.g=null,a.i&&(a.i=!1,ye(a))},a.l);const d=a.h;a.h=null,a.m.apply(null,d)}class it extends Ve{constructor(d,f){super(),this.m=d,this.l=f,this.h=null,this.i=!1,this.g=null}j(d){this.h=arguments,this.g?this.i=!0:ye(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ae(a){Ve.call(this),this.h=a,this.g={}}A(Ae,Ve);var ke=[];function Ft(a){j(a.g,function(d,f){this.g.hasOwnProperty(f)&&Br(d)},a),a.g={}}Ae.prototype.N=function(){Ae.aa.N.call(this),Ft(this)},Ae.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Tt=c.JSON.stringify,Xt=c.JSON.parse,De=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function He(){}He.prototype.h=null;function Zt(a){return a.h||(a.h=a.i())}function bt(){}var Bt={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function We(){Me.call(this,"d")}A(We,Me);function $e(){Me.call(this,"c")}A($e,Me);var At={},yn=null;function en(){return yn=yn||new te}At.La="serverreachability";function Zi(a){Me.call(this,At.La,a)}A(Zi,Me);function Ee(a){const d=en();se(d,new Zi(d))}At.STAT_EVENT="statevent";function vn(a,d){Me.call(this,At.STAT_EVENT,a),this.stat=d}A(vn,Me);function ot(a){const d=en();se(d,new vn(d,a))}At.Ma="timingevent";function Ou(a,d){Me.call(this,At.Ma,a),this.size=d}A(Ou,Me);function ks(a,d){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},d)}function Ds(){this.g=!0}Ds.prototype.xa=function(){this.g=!1};function $_(a,d,f,g,S,k){a.info(function(){if(a.g)if(k)for(var M="",me=k.split("&"),je=0;je<me.length;je++){var de=me[je].split("=");if(1<de.length){var Qe=de[0];de=de[1];var Je=Qe.split("_");M=2<=Je.length&&Je[1]=="type"?M+(Qe+"="+de+"&"):M+(Qe+"=redacted&")}}else M=null;else M=k;return"XMLHTTP REQ ("+g+") [attempt "+S+"]: "+d+`
`+f+`
`+M})}function j_(a,d,f,g,S,k,M){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+S+"]: "+d+`
`+f+`
`+k+" "+M})}function Ur(a,d,f,g){a.info(function(){return"XMLHTTP TEXT ("+d+"): "+K_(a,f)+(g?" "+g:"")})}function q_(a,d){a.info(function(){return"TIMEOUT: "+d})}Ds.prototype.info=function(){};function K_(a,d){if(!a.g)return d;if(!d)return null;try{var f=JSON.parse(d);if(f){for(a=0;a<f.length;a++)if(Array.isArray(f[a])){var g=f[a];if(!(2>g.length)){var S=g[1];if(Array.isArray(S)&&!(1>S.length)){var k=S[0];if(k!="noop"&&k!="stop"&&k!="close")for(var M=1;M<S.length;M++)S[M]=""}}}}return Tt(f)}catch{return d}}var eo={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Fu={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Qa;function to(){}A(to,He),to.prototype.g=function(){return new XMLHttpRequest},to.prototype.i=function(){return{}},Qa=new to;function wn(a,d,f,g){this.j=a,this.i=d,this.l=f,this.R=g||1,this.U=new Ae(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Bu}function Bu(){this.i=null,this.g="",this.h=!1}var Uu={},Ja={};function Ya(a,d,f){a.L=1,a.v=io(tn(d)),a.m=f,a.P=!0,$u(a,null)}function $u(a,d){a.F=Date.now(),no(a),a.A=tn(a.v);var f=a.A,g=a.R;Array.isArray(g)||(g=[String(g)]),td(f.i,"t",g),a.C=0,f=a.j.J,a.h=new Bu,a.g=vd(a.j,f?d:null,!a.m),0<a.O&&(a.M=new it(_(a.Y,a,a.g),a.O)),d=a.U,f=a.g,g=a.ca;var S="readystatechange";Array.isArray(S)||(S&&(ke[0]=S.toString()),S=ke);for(var k=0;k<S.length;k++){var M=Ps(f,S[k],g||d.handleEvent,!1,d.h||d);if(!M)break;d.g[M.key]=M}d=a.H?y(a.H):{},a.m?(a.u||(a.u="POST"),d["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,d)):(a.u="GET",a.g.ea(a.A,a.u,null,d)),Ee(),$_(a.i,a.u,a.A,a.l,a.R,a.m)}wn.prototype.ca=function(a){a=a.target;const d=this.M;d&&nn(a)==3?d.j():this.Y(a)},wn.prototype.Y=function(a){try{if(a==this.g)e:{const Je=nn(this.g);var d=this.g.Ba();const qr=this.g.Z();if(!(3>Je)&&(Je!=3||this.g&&(this.h.h||this.g.oa()||cd(this.g)))){this.J||Je!=4||d==7||(d==8||0>=qr?Ee(3):Ee(2)),Xa(this);var f=this.g.Z();this.X=f;t:if(ju(this)){var g=cd(this.g);a="";var S=g.length,k=nn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Qn(this),Ns(this);var M="";break t}this.h.i=new c.TextDecoder}for(d=0;d<S;d++)this.h.h=!0,a+=this.h.i.decode(g[d],{stream:!(k&&d==S-1)});g.length=0,this.h.g+=a,this.C=0,M=this.h.g}else M=this.g.oa();if(this.o=f==200,j_(this.i,this.u,this.A,this.l,this.R,Je,f),this.o){if(this.T&&!this.K){t:{if(this.g){var me,je=this.g;if((me=je.g?je.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!F(me)){var de=me;break t}}de=null}if(f=de)Ur(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Za(this,f);else{this.o=!1,this.s=3,ot(12),Qn(this),Ns(this);break e}}if(this.P){f=!0;let Rt;for(;!this.J&&this.C<M.length;)if(Rt=G_(this,M),Rt==Ja){Je==4&&(this.s=4,ot(14),f=!1),Ur(this.i,this.l,null,"[Incomplete Response]");break}else if(Rt==Uu){this.s=4,ot(15),Ur(this.i,this.l,M,"[Invalid Chunk]"),f=!1;break}else Ur(this.i,this.l,Rt,null),Za(this,Rt);if(ju(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Je!=4||M.length!=0||this.h.h||(this.s=1,ot(16),f=!1),this.o=this.o&&f,!f)Ur(this.i,this.l,M,"[Invalid Chunked Response]"),Qn(this),Ns(this);else if(0<M.length&&!this.W){this.W=!0;var Qe=this.j;Qe.g==this&&Qe.ba&&!Qe.M&&(Qe.j.info("Great, no buffering proxy detected. Bytes received: "+M.length),ic(Qe),Qe.M=!0,ot(11))}}else Ur(this.i,this.l,M,null),Za(this,M);Je==4&&Qn(this),this.o&&!this.J&&(Je==4?md(this.j,this):(this.o=!1,no(this)))}else cy(this.g),f==400&&0<M.indexOf("Unknown SID")?(this.s=3,ot(12)):(this.s=0,ot(13)),Qn(this),Ns(this)}}}catch{}finally{}};function ju(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function G_(a,d){var f=a.C,g=d.indexOf(`
`,f);return g==-1?Ja:(f=Number(d.substring(f,g)),isNaN(f)?Uu:(g+=1,g+f>d.length?Ja:(d=d.slice(g,g+f),a.C=g+f,d)))}wn.prototype.cancel=function(){this.J=!0,Qn(this)};function no(a){a.S=Date.now()+a.I,qu(a,a.I)}function qu(a,d){if(a.B!=null)throw Error("WatchDog timer not null");a.B=ks(_(a.ba,a),d)}function Xa(a){a.B&&(c.clearTimeout(a.B),a.B=null)}wn.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(q_(this.i,this.A),this.L!=2&&(Ee(),ot(17)),Qn(this),this.s=2,Ns(this)):qu(this,this.S-a)};function Ns(a){a.j.G==0||a.J||md(a.j,a)}function Qn(a){Xa(a);var d=a.M;d&&typeof d.ma=="function"&&d.ma(),a.M=null,Ft(a.U),a.g&&(d=a.g,a.g=null,d.abort(),d.ma())}function Za(a,d){try{var f=a.j;if(f.G!=0&&(f.g==a||ec(f.h,a))){if(!a.K&&ec(f.h,a)&&f.G==3){try{var g=f.Da.g.parse(d)}catch{g=null}if(Array.isArray(g)&&g.length==3){var S=g;if(S[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<a.F)ho(f),lo(f);else break e;sc(f),ot(18)}}else f.za=S[1],0<f.za-f.T&&37500>S[2]&&f.F&&f.v==0&&!f.C&&(f.C=ks(_(f.Za,f),6e3));if(1>=zu(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else Yn(f,11)}else if((a.K||f.g==a)&&ho(f),!F(d))for(S=f.Da.g.parse(d),d=0;d<S.length;d++){let de=S[d];if(f.T=de[0],de=de[1],f.G==2)if(de[0]=="c"){f.K=de[1],f.ia=de[2];const Qe=de[3];Qe!=null&&(f.la=Qe,f.j.info("VER="+f.la));const Je=de[4];Je!=null&&(f.Aa=Je,f.j.info("SVER="+f.Aa));const qr=de[5];qr!=null&&typeof qr=="number"&&0<qr&&(g=1.5*qr,f.L=g,f.j.info("backChannelRequestTimeoutMs_="+g)),g=f;const Rt=a.g;if(Rt){const po=Rt.g?Rt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(po){var k=g.h;k.g||po.indexOf("spdy")==-1&&po.indexOf("quic")==-1&&po.indexOf("h2")==-1||(k.j=k.l,k.g=new Set,k.h&&(tc(k,k.h),k.h=null))}if(g.D){const oc=Rt.g?Rt.g.getResponseHeader("X-HTTP-Session-Id"):null;oc&&(g.ya=oc,ve(g.I,g.D,oc))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-a.F,f.j.info("Handshake RTT: "+f.R+"ms")),g=f;var M=a;if(g.qa=yd(g,g.J?g.ia:null,g.W),M.K){Hu(g.h,M);var me=M,je=g.L;je&&(me.I=je),me.B&&(Xa(me),no(me)),g.g=M}else fd(g);0<f.i.length&&uo(f)}else de[0]!="stop"&&de[0]!="close"||Yn(f,7);else f.G==3&&(de[0]=="stop"||de[0]=="close"?de[0]=="stop"?Yn(f,7):rc(f):de[0]!="noop"&&f.l&&f.l.ta(de),f.v=0)}}Ee(4)}catch{}}var z_=class{constructor(a,d){this.g=a,this.map=d}};function Ku(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Gu(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function zu(a){return a.h?1:a.g?a.g.size:0}function ec(a,d){return a.h?a.h==d:a.g?a.g.has(d):!1}function tc(a,d){a.g?a.g.add(d):a.h=d}function Hu(a,d){a.h&&a.h==d?a.h=null:a.g&&a.g.has(d)&&a.g.delete(d)}Ku.prototype.cancel=function(){if(this.i=Wu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Wu(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let d=a.i;for(const f of a.g.values())d=d.concat(f.D);return d}return D(a.i)}function H_(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(l(a)){for(var d=[],f=a.length,g=0;g<f;g++)d.push(a[g]);return d}d=[],f=0;for(g in a)d[f++]=a[g];return d}function W_(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(l(a)||typeof a=="string"){var d=[];a=a.length;for(var f=0;f<a;f++)d.push(f);return d}d=[],f=0;for(const g in a)d[f++]=g;return d}}}function Qu(a,d){if(a.forEach&&typeof a.forEach=="function")a.forEach(d,void 0);else if(l(a)||typeof a=="string")Array.prototype.forEach.call(a,d,void 0);else for(var f=W_(a),g=H_(a),S=g.length,k=0;k<S;k++)d.call(void 0,g[k],f&&f[k],a)}var Ju=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Q_(a,d){if(a){a=a.split("&");for(var f=0;f<a.length;f++){var g=a[f].indexOf("="),S=null;if(0<=g){var k=a[f].substring(0,g);S=a[f].substring(g+1)}else k=a[f];d(k,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function Jn(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof Jn){this.h=a.h,ro(this,a.j),this.o=a.o,this.g=a.g,so(this,a.s),this.l=a.l;var d=a.i,f=new Ls;f.i=d.i,d.g&&(f.g=new Map(d.g),f.h=d.h),Yu(this,f),this.m=a.m}else a&&(d=String(a).match(Ju))?(this.h=!1,ro(this,d[1]||"",!0),this.o=xs(d[2]||""),this.g=xs(d[3]||"",!0),so(this,d[4]),this.l=xs(d[5]||"",!0),Yu(this,d[6]||"",!0),this.m=xs(d[7]||"")):(this.h=!1,this.i=new Ls(null,this.h))}Jn.prototype.toString=function(){var a=[],d=this.j;d&&a.push(Vs(d,Xu,!0),":");var f=this.g;return(f||d=="file")&&(a.push("//"),(d=this.o)&&a.push(Vs(d,Xu,!0),"@"),a.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&a.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&a.push("/"),a.push(Vs(f,f.charAt(0)=="/"?X_:Y_,!0))),(f=this.i.toString())&&a.push("?",f),(f=this.m)&&a.push("#",Vs(f,ey)),a.join("")};function tn(a){return new Jn(a)}function ro(a,d,f){a.j=f?xs(d,!0):d,a.j&&(a.j=a.j.replace(/:$/,""))}function so(a,d){if(d){if(d=Number(d),isNaN(d)||0>d)throw Error("Bad port number "+d);a.s=d}else a.s=null}function Yu(a,d,f){d instanceof Ls?(a.i=d,ty(a.i,a.h)):(f||(d=Vs(d,Z_)),a.i=new Ls(d,a.h))}function ve(a,d,f){a.i.set(d,f)}function io(a){return ve(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function xs(a,d){return a?d?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Vs(a,d,f){return typeof a=="string"?(a=encodeURI(a).replace(d,J_),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function J_(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Xu=/[#\/\?@]/g,Y_=/[#\?:]/g,X_=/[#\?]/g,Z_=/[#\?@]/g,ey=/#/g;function Ls(a,d){this.h=this.g=null,this.i=a||null,this.j=!!d}function In(a){a.g||(a.g=new Map,a.h=0,a.i&&Q_(a.i,function(d,f){a.add(decodeURIComponent(d.replace(/\+/g," ")),f)}))}n=Ls.prototype,n.add=function(a,d){In(this),this.i=null,a=$r(this,a);var f=this.g.get(a);return f||this.g.set(a,f=[]),f.push(d),this.h+=1,this};function Zu(a,d){In(a),d=$r(a,d),a.g.has(d)&&(a.i=null,a.h-=a.g.get(d).length,a.g.delete(d))}function ed(a,d){return In(a),d=$r(a,d),a.g.has(d)}n.forEach=function(a,d){In(this),this.g.forEach(function(f,g){f.forEach(function(S){a.call(d,S,g,this)},this)},this)},n.na=function(){In(this);const a=Array.from(this.g.values()),d=Array.from(this.g.keys()),f=[];for(let g=0;g<d.length;g++){const S=a[g];for(let k=0;k<S.length;k++)f.push(d[g])}return f},n.V=function(a){In(this);let d=[];if(typeof a=="string")ed(this,a)&&(d=d.concat(this.g.get($r(this,a))));else{a=Array.from(this.g.values());for(let f=0;f<a.length;f++)d=d.concat(a[f])}return d},n.set=function(a,d){return In(this),this.i=null,a=$r(this,a),ed(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[d]),this.h+=1,this},n.get=function(a,d){return a?(a=this.V(a),0<a.length?String(a[0]):d):d};function td(a,d,f){Zu(a,d),0<f.length&&(a.i=null,a.g.set($r(a,d),D(f)),a.h+=f.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],d=Array.from(this.g.keys());for(var f=0;f<d.length;f++){var g=d[f];const k=encodeURIComponent(String(g)),M=this.V(g);for(g=0;g<M.length;g++){var S=k;M[g]!==""&&(S+="="+encodeURIComponent(String(M[g]))),a.push(S)}}return this.i=a.join("&")};function $r(a,d){return d=String(d),a.j&&(d=d.toLowerCase()),d}function ty(a,d){d&&!a.j&&(In(a),a.i=null,a.g.forEach(function(f,g){var S=g.toLowerCase();g!=S&&(Zu(this,g),td(this,S,f))},a)),a.j=d}function ny(a,d){const f=new Ds;if(c.Image){const g=new Image;g.onload=v(En,f,"TestLoadImage: loaded",!0,d,g),g.onerror=v(En,f,"TestLoadImage: error",!1,d,g),g.onabort=v(En,f,"TestLoadImage: abort",!1,d,g),g.ontimeout=v(En,f,"TestLoadImage: timeout",!1,d,g),c.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else d(!1)}function ry(a,d){const f=new Ds,g=new AbortController,S=setTimeout(()=>{g.abort(),En(f,"TestPingServer: timeout",!1,d)},1e4);fetch(a,{signal:g.signal}).then(k=>{clearTimeout(S),k.ok?En(f,"TestPingServer: ok",!0,d):En(f,"TestPingServer: server error",!1,d)}).catch(()=>{clearTimeout(S),En(f,"TestPingServer: error",!1,d)})}function En(a,d,f,g,S){try{S&&(S.onload=null,S.onerror=null,S.onabort=null,S.ontimeout=null),g(f)}catch{}}function sy(){this.g=new De}function iy(a,d,f){const g=f||"";try{Qu(a,function(S,k){let M=S;u(S)&&(M=Tt(S)),d.push(g+k+"="+encodeURIComponent(M))})}catch(S){throw d.push(g+"type="+encodeURIComponent("_badmap")),S}}function oo(a){this.l=a.Ub||null,this.j=a.eb||!1}A(oo,He),oo.prototype.g=function(){return new ao(this.l,this.j)},oo.prototype.i=function(a){return function(){return a}}({});function ao(a,d){te.call(this),this.D=a,this.o=d,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}A(ao,te),n=ao.prototype,n.open=function(a,d){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=d,this.readyState=1,Os(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const d={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(d.body=a),(this.D||c).fetch(new Request(this.A,d)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Ms(this)),this.readyState=0},n.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Os(this)),this.g&&(this.readyState=3,Os(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;nd(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function nd(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}n.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var d=a.value?a.value:new Uint8Array(0);(d=this.v.decode(d,{stream:!a.done}))&&(this.response=this.responseText+=d)}a.done?Ms(this):Os(this),this.readyState==3&&nd(this)}},n.Ra=function(a){this.g&&(this.response=this.responseText=a,Ms(this))},n.Qa=function(a){this.g&&(this.response=a,Ms(this))},n.ga=function(){this.g&&Ms(this)};function Ms(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Os(a)}n.setRequestHeader=function(a,d){this.u.append(a,d)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],d=this.h.entries();for(var f=d.next();!f.done;)f=f.value,a.push(f[0]+": "+f[1]),f=d.next();return a.join(`\r
...
`}),d}function nc(a,d,f){e:{for(g in f){var g=!1;break e}g=!0}g||(f=rd(f),typeof a=="string"?f!=null&&encodeURIComponent(String(f)):ve(a,d,f))}function Se(a){te.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}A(Se,te);var oy=/^https?$/i,ay=["POST","PUT"];n=Se.prototype,n.Ha=function(a){this.J=a},n.ea=function(a,d,f,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);d=d?d.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Qa.g(),this.v=this.o?Zt(this.o):Zt(Qa),this.g.onreadystatechange=_(this.Ea,this);try{this.B=!0,this.g.open(d,String(a),!0),this.B=!1}catch(k){sd(this,k);return}if(a=f||"",f=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var S in g)f.set(S,g[S]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const k of g.keys())f.set(k,g.get(k));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(f.keys()).find(k=>k.toLowerCase()=="content-type"),S=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call(ay,d,void 0))||g||S||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[k,M]of f)this.g.setRequestHeader(k,M);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ad(this),this.u=!0,this.g.send(a),this.u=!1}catch(k){sd(this,k)}};function sd(a,d){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=d,a.m=5,id(a),co(a)}function id(a){a.A||(a.A=!0,se(a,"complete"),se(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,se(this,"complete"),se(this,"abort"),co(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),co(this,!0)),Se.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?od(this):this.bb())},n.bb=function(){od(this)};function od(a){if(a.h&&typeof o<"u"&&(!a.v[1]||nn(a)!=4||a.Z()!=2)){if(a.u&&nn(a)==4)ge(a.Ea,0,a);else if(se(a,"readystatechange"),nn(a)==4){a.h=!1;try{const M=a.Z();e:switch(M){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var d=!0;break e;default:d=!1}var f;if(!(f=d)){var g;if(g=M===0){var S=String(a.D).match(Ju)[1]||null;!S&&c.self&&c.self.location&&(S=c.self.location.protocol.slice(0,-1)),g=!oy.test(S?S.toLowerCase():"")}f=g}if(f)se(a,"complete"),se(a,"success");else{a.m=6;try{var k=2<nn(a)?a.g.statusText:""}catch{k=""}a.l=k+" ["+a.Z()+"]",id(a)}}finally{co(a)}}}}function co(a,d){if(a.g){ad(a);const f=a.g,g=a.v[0]?()=>{}:null;a.g=null,a.v=null,d||se(a,"ready");try{f.onreadystatechange=g}catch{}}}function ad(a){a.I&&(c.clearTimeout(a.I),a.I=null)}n.isActive=function(){return!!this.g};function nn(a){return a.g?a.g.readyState:0}n.Z=function(){try{return 2<nn(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(a){if(this.g){var d=this.g.responseText;return a&&d.indexOf(a)==0&&(d=d.substring(a.length)),Xt(d)}};function cd(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function cy(a){const d={};a=(a.g&&2<=nn(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(F(a[g]))continue;var f=b(a[g]);const S=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const k=d[S]||[];d[S]=k,k.push(f)}E(d,function(g){return g.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Fs(a,d,f){return f&&f.internalChannelParams&&f.internalChannelParams[a]||d}function ld(a){this.Aa=0,this.i=[],this.j=new Ds,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Fs("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Fs("baseRetryDelayMs",5e3,a),this.cb=Fs("retryDelaySeedMs",1e4,a),this.Wa=Fs("forwardChannelMaxRetries",2,a),this.wa=Fs("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Ku(a&&a.concurrentRequestLimit),this.Da=new sy,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=ld.prototype,n.la=8,n.G=1,n.connect=function(a,d,f,g){ot(0),this.W=a,this.H=d||{},f&&g!==void 0&&(this.H.OSID=f,this.H.OAID=g),this.F=this.X,this.I=yd(this,null,this.W),uo(this)};function rc(a){if(ud(a),a.G==3){var d=a.U++,f=tn(a.I);if(ve(f,"SID",a.K),ve(f,"RID",d),ve(f,"TYPE","terminate"),Bs(a,f),d=new wn(a,a.j,d),d.L=2,d.v=io(tn(f)),f=!1,c.navigator&&c.navigator.sendBeacon)try{f=c.navigator.sendBeacon(d.v.toString(),"")}catch{}!f&&c.Image&&(new Image().src=d.v,f=!0),f||(d.g=vd(d.j,null),d.g.ea(d.v)),d.F=Date.now(),no(d)}_d(a)}function lo(a){a.g&&(ic(a),a.g.cancel(),a.g=null)}function ud(a){lo(a),a.u&&(c.clearTimeout(a.u),a.u=null),ho(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function uo(a){if(!Gu(a.h)&&!a.s){a.s=!0;var d=a.Ga;Lt||Dr(),Mt||(Lt(),Mt=!0),zn.add(d,a),a.B=0}}function ly(a,d){return zu(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=d.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=ks(_(a.Ga,a,d),gd(a,a.B)),a.B++,!0)}n.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const S=new wn(this,this.j,a);let k=this.o;if(this.S&&(k?(k=y(k),T(k,this.S)):k=this.S),this.m!==null||this.O||(S.H=k,k=null),this.P)e:{for(var d=0,f=0;f<this.i.length;f++){t:{var g=this.i[f];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(d+=g,4096<d){d=f;break e}if(d===4096||f===this.i.length-1){d=f+1;break e}}d=1e3}else d=1e3;d=hd(this,S,d),f=tn(this.I),ve(f,"RID",a),ve(f,"CVER",22),this.D&&ve(f,"X-HTTP-Session-Id",this.D),Bs(this,f),k&&(this.O?d="headers="+encodeURIComponent(String(rd(k)))+"&"+d:this.m&&nc(f,this.m,k)),tc(this.h,S),this.Ua&&ve(f,"TYPE","init"),this.P?(ve(f,"$req",d),ve(f,"SID","null"),S.T=!0,Ya(S,f,null)):Ya(S,f,d),this.G=2}}else this.G==3&&(a?dd(this,a):this.i.length==0||Gu(this.h)||dd(this))};function dd(a,d){var f;d?f=d.l:f=a.U++;const g=tn(a.I);ve(g,"SID",a.K),ve(g,"RID",f),ve(g,"AID",a.T),Bs(a,g),a.m&&a.o&&nc(g,a.m,a.o),f=new wn(a,a.j,f,a.B+1),a.m===null&&(f.H=a.o),d&&(a.i=d.D.concat(a.i)),d=hd(a,f,1e3),f.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),tc(a.h,f),Ya(f,g,d)}function Bs(a,d){a.H&&j(a.H,function(f,g){ve(d,g,f)}),a.l&&Qu({},function(f,g){ve(d,g,f)})}function hd(a,d,f){f=Math.min(a.i.length,f);var g=a.l?_(a.l.Na,a.l,a):null;e:{var S=a.i;let k=-1;for(;;){const M=["count="+f];k==-1?0<f?(k=S[0].g,M.push("ofs="+k)):k=0:M.push("ofs="+k);let me=!0;for(let je=0;je<f;je++){let de=S[je].g;const Qe=S[je].map;if(de-=k,0>de)k=Math.max(0,S[je].g-100),me=!1;else try{iy(Qe,M,"req"+de+"_")}catch{g&&g(Qe)}}if(me){g=M.join("&");break e}}}return a=a.i.splice(0,f),d.D=a,g}function fd(a){if(!a.g&&!a.u){a.Y=1;var d=a.Fa;Lt||Dr(),Mt||(Lt(),Mt=!0),zn.add(d,a),a.v=0}}function sc(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=ks(_(a.Fa,a),gd(a,a.v)),a.v++,!0)}n.Fa=function(){if(this.u=null,pd(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=ks(_(this.ab,this),a)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,ot(10),lo(this),pd(this))};function ic(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function pd(a){a.g=new wn(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var d=tn(a.qa);ve(d,"RID","rpc"),ve(d,"SID",a.K),ve(d,"AID",a.T),ve(d,"CI",a.F?"0":"1"),!a.F&&a.ja&&ve(d,"TO",a.ja),ve(d,"TYPE","xmlhttp"),Bs(a,d),a.m&&a.o&&nc(d,a.m,a.o),a.L&&(a.g.I=a.L);var f=a.g;a=a.ia,f.L=1,f.v=io(tn(d)),f.m=null,f.P=!0,$u(f,a)}n.Za=function(){this.C!=null&&(this.C=null,lo(this),sc(this),ot(19))};function ho(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function md(a,d){var f=null;if(a.g==d){ho(a),ic(a),a.g=null;var g=2}else if(ec(a.h,d))f=d.D,Hu(a.h,d),g=1;else return;if(a.G!=0){if(d.o)if(g==1){f=d.m?d.m.length:0,d=Date.now()-d.F;var S=a.B;g=en(),se(g,new Ou(g,f)),uo(a)}else fd(a);else if(S=d.s,S==3||S==0&&0<d.X||!(g==1&&ly(a,d)||g==2&&sc(a)))switch(f&&0<f.length&&(d=a.h,d.i=d.i.concat(f)),S){case 1:Yn(a,5);break;case 4:Yn(a,10);break;case 3:Yn(a,6);break;default:Yn(a,2)}}}function gd(a,d){let f=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(f*=2),f*d}function Yn(a,d){if(a.j.info("Error code "+d),d==2){var f=_(a.fb,a),g=a.Xa;const S=!g;g=new Jn(g||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||ro(g,"https"),io(g),S?ny(g.toString(),f):ry(g.toString(),f)}else ot(2);a.G=0,a.l&&a.l.sa(d),_d(a),ud(a)}n.fb=function(a){a?(this.j.info("Successfully pinged google.com"),ot(2)):(this.j.info("Failed to ping google.com"),ot(1))};function _d(a){if(a.G=0,a.ka=[],a.l){const d=Wu(a.h);(d.length!=0||a.i.length!=0)&&(C(a.ka,d),C(a.ka,a.i),a.h.i.length=0,D(a.i),a.i.length=0),a.l.ra()}}function yd(a,d,f){var g=f instanceof Jn?tn(f):new Jn(f);if(g.g!="")d&&(g.g=d+"."+g.g),so(g,g.s);else{var S=c.location;g=S.protocol,d=d?d+"."+S.hostname:S.hostname,S=+S.port;var k=new Jn(null);g&&ro(k,g),d&&(k.g=d),S&&so(k,S),f&&(k.l=f),g=k}return f=a.D,d=a.ya,f&&d&&ve(g,f,d),ve(g,"VER",a.la),Bs(a,g),g}function vd(a,d,f){if(d&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return d=a.Ca&&!a.pa?new Se(new oo({eb:f})):new Se(a.pa),d.Ha(a.J),d}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function wd(){}n=wd.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function fo(){}fo.prototype.g=function(a,d){return new _t(a,d)};function _t(a,d){te.call(this),this.g=new ld(d),this.l=a,this.h=d&&d.messageUrlParams||null,a=d&&d.messageHeaders||null,d&&d.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=d&&d.initMessageHeaders||null,d&&d.messageContentType&&(a?a["X-WebChannel-Content-Type"]=d.messageContentType:a={"X-WebChannel-Content-Type":d.messageContentType}),d&&d.va&&(a?a["X-WebChannel-Client-Profile"]=d.va:a={"X-WebChannel-Client-Profile":d.va}),this.g.S=a,(a=d&&d.Sb)&&!F(a)&&(this.g.m=a),this.v=d&&d.supportsCrossDomainXhr||!1,this.u=d&&d.sendRawJson||!1,(d=d&&d.httpSessionIdParam)&&!F(d)&&(this.g.D=d,a=this.h,a!==null&&d in a&&(a=this.h,d in a&&delete a[d])),this.j=new jr(this)}A(_t,te),_t.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},_t.prototype.close=function(){rc(this.g)},_t.prototype.o=function(a){var d=this.g;if(typeof a=="string"){var f={};f.__data__=a,a=f}else this.u&&(f={},f.__data__=Tt(a),a=f);d.i.push(new z_(d.Ya++,a)),d.G==3&&uo(d)},_t.prototype.N=function(){this.g.l=null,delete this.j,rc(this.g),delete this.g,_t.aa.N.call(this)};function Id(a){We.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var d=a.__sm__;if(d){e:{for(const f in d){a=f;break e}a=void 0}(this.i=a)&&(a=this.i,d=d!==null&&a in d?d[a]:void 0),this.data=d}else this.data=a}A(Id,We);function Ed(){$e.call(this),this.status=1}A(Ed,$e);function jr(a){this.g=a}A(jr,wd),jr.prototype.ua=function(){se(this.g,"a")},jr.prototype.ta=function(a){se(this.g,new Id(a))},jr.prototype.sa=function(a){se(this.g,new Ed)},jr.prototype.ra=function(){se(this.g,"b")},fo.prototype.createWebChannel=fo.prototype.g,_t.prototype.send=_t.prototype.o,_t.prototype.open=_t.prototype.m,_t.prototype.close=_t.prototype.close,Tp=function(){return new fo},Ep=function(){return en()},Ip=At,Fc={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},eo.NO_ERROR=0,eo.TIMEOUT=8,eo.HTTP_ERROR=6,Po=eo,Fu.COMPLETE="complete",wp=Fu,bt.EventType=Bt,Bt.OPEN="a",Bt.CLOSE="b",Bt.ERROR="c",Bt.MESSAGE="d",te.prototype.listen=te.prototype.K,Qs=bt,Se.prototype.listenOnce=Se.prototype.L,Se.prototype.getLastError=Se.prototype.Ka,Se.prototype.getLastErrorCode=Se.prototype.Ba,Se.prototype.getStatus=Se.prototype.Z,Se.prototype.getResponseJson=Se.prototype.Oa,Se.prototype.getResponseText=Se.prototype.oa,Se.prototype.send=Se.prototype.ea,Se.prototype.setWithCredentials=Se.prototype.Ha,vp=Se}).apply(typeof go<"u"?go:typeof self<"u"?self:typeof window<"u"?window:{});const Zd="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=new fl("@firebase/firestore");function Wr(){return fr.logLevel}function x(n,...e){if(fr.logLevel<=ae.DEBUG){const t=e.map(Al);fr.debug(`Firestore (${ys}): ${n}`,...t)}}function Ne(n,...e){if(fr.logLevel<=ae.ERROR){const t=e.map(Al);fr.error(`Firestore (${ys}): ${n}`,...t)}}function _i(n,...e){if(fr.logLevel<=ae.WARN){const t=e.map(Al);fr.warn(`Firestore (${ys}): ${n}`,...t)}}function Al(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G(n="Unexpected state"){const e=`FIRESTORE (${ys}) INTERNAL ASSERTION FAILED: `+n;throw Ne(e),new Error(e)}function Q(n,e){n||G()}function z(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sE{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class iE{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Xe.UNAUTHENTICATED))}shutdown(){}}class oE{constructor(e){this.t=e,this.currentUser=Xe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){Q(this.o===void 0);let r=this.i;const s=l=>this.i!==r?(r=this.i,t(l)):Promise.resolve();let i=new Ht;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Ht,e.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},c=l=>{x("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(x("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Ht)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(x("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Q(typeof r.accessToken=="string"),new sE(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Q(e===null||typeof e=="string"),new Xe(e)}}class aE{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=Xe.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class cE{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new aE(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(Xe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class lE{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class uE{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){Q(this.o===void 0);const r=i=>{i.error!=null&&x("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.R;return this.R=i.token,x("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{x("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):x("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(Q(typeof t.token=="string"),this.R=t.token,new lE(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{constructor(e,t,r,s){this.indexId=e,this.collectionGroup=t,this.fields=r,this.indexState=s}}function Bc(n){return n.fields.find(e=>e.kind===2)}function er(n){return n.fields.filter(e=>e.kind!==2)}Qo.UNKNOWN_ID=-1;class Co{constructor(e,t){this.fieldPath=e,this.kind=t}}class vi{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new vi(0,It.min())}}function Sp(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=Z.fromTimestamp(r===1e9?new be(t+1,0):new be(t,r));return new It(s,$.empty(),e)}function Rp(n){return new It(n.readTime,n.key,-1)}class It{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new It(Z.min(),$.empty(),-1)}static max(){return new It(Z.max(),$.empty(),-1)}}function Sl(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=$.comparator(n.documentKey,e.documentKey),t!==0?t:re(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $n(n){if(n.code!==N.FAILED_PRECONDITION||n.message!==Pp)throw n;x("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=r=>this.ie(r),this.se=r=>t.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}ht.oe=-1;function va(n){return n==null}function wi(n){return n===0&&1/n==-1/0}function Dp(n){return typeof n=="number"&&Number.isInteger(n)&&!wi(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ct(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=th(e)),e=_E(n.get(t),e);return th(e)}function _E(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case"":t+="";break;default:t+=i}}return t}function th(n){return n+""}function qt(n){const e=n.length;if(Q(e>=2),e===2)return Q(n.charAt(0)===""&&n.charAt(1)===""),he.emptyPath();const t=e-2,r=[];let s="";for(let i=0;i<e;){const o=n.indexOf("",i);switch((o<0||o>t)&&G(),n.charAt(o+1)){case"":const c=n.substring(i,o);let l;s.length===0?l=c:(s+=c,l=s,s=""),r.push(l);break;case"":s+=n.substring(i,o),s+="\0";break;case"":s+=n.substring(i,o+1);break;default:G()}i=o+2}return new he(r)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uc extends Cp{constructor(e,t){super(),this._e=e,this.currentSequenceNumber=t}}function Be(n,e){const t=z(n);return Vn.F(t._e,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cl(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function kl(n){const e=n.mapValue.fields.__previous_value__;return Cl(e)?kl(e):e}function Ii(n){const e=pn(n.mapValue.fields.__local_write_time__.timestampValue);return new be(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nn={mapValue:{fields:{__type__:{stringValue:"__max__"}}}},Do={nullValue:"NULL_VALUE"};function mr(n){return"nullValue"in n?0:"booleanValue"in n?1:"integerValue"in n||"doubleValue"in n?2:"timestampValue"in n?3:"stringValue"in n?5:"bytesValue"in n?6:"referenceValue"in n?7:"geoPointValue"in n?8:"arrayValue"in n?9:"mapValue"in n?Cl(n)?4:Fp(n)?9007199254740991:wa(n)?10:11:G()}function Wt(n,e){if(n===e)return!0;const t=mr(n);if(t!==mr(e))return!1;switch(t){case 0:case 9007199254740991:return!0;case 1:return n.booleanValue===e.booleanValue;case 4:return Ii(n).isEqual(Ii(e));case 3:return function(s,i){if(typeof s.timestampValue=="string"&&typeof i.timestampValue=="string"&&s.timestampValue.length===i.timestampValue.length)return s.timestampValue===i.timestampValue;const o=pn(s.timestampValue),c=pn(i.timestampValue);return o.seconds===c.seconds&&o.nanos===c.nanos}(n,e);case 5:return n.stringValue===e.stringValue;case 6:return function(s,i){return On(s.bytesValue).isEqual(On(i.bytesValue))}(n,e);case 7:return n.referenceValue===e.referenceValue;case 8:return function(s,i){return Ie(s.geoPointValue.latitude)===Ie(i.geoPointValue.latitude)&&Ie(s.geoPointValue.longitude)===Ie(i.geoPointValue.longitude)}(n,e);case 2:return function(s,i){if("integerValue"in s&&"integerValue"in i)return Ie(s.integerValue)===Ie(i.integerValue);if("doubleValue"in s&&"doubleValue"in i){const o=Ie(s.doubleValue),c=Ie(i.doubleValue);return o===c?wi(o)===wi(c):isNaN(o)&&isNaN(c)}return!1}(n,e);case 9:return ss(n.arrayValue.values||[],e.arrayValue.values||[],Wt);case 10:case 11:return function(s,i){const o=s.mapValue.fields||{},c=i.mapValue.fields||{};if(rh(o)!==rh(c))return!1;for(const l in o)if(o.hasOwnProperty(l)&&(c[l]===void 0||!Wt(o[l],c[l])))return!1;return!0}(n,e);default:return G()}}function Ei(n,e){return(n.values||[]).find(t=>Wt(t,e))!==void 0}function Fn(n,e){if(n===e)return 0;const t=mr(n),r=mr(e);if(t!==r)return re(t,r);switch(t){case 0:case 9007199254740991:return 0;case 1:return re(n.booleanValue,e.booleanValue);case 2:return function(i,o){const c=Ie(i.integerValue||i.doubleValue),l=Ie(o.integerValue||o.doubleValue);return c<l?-1:c>l?1:c===l?0:isNaN(c)?isNaN(l)?0:-1:1}(n,e);case 3:return ih(n.timestampValue,e.timestampValue);case 4:return ih(Ii(n),Ii(e));case 5:return re(n.stringValue,e.stringValue);case 6:return function(i,o){const c=On(i),l=On(o);return c.compareTo(l)}(n.bytesValue,e.bytesValue);case 7:return function(i,o){const c=i.split("/"),l=o.split("/");for(let u=0;u<c.length&&u<l.length;u++){const h=re(c[u],l[u]);if(h!==0)return h}return re(c.length,l.length)}(n.referenceValue,e.referenceValue);case 8:return function(i,o){const c=re(Ie(i.latitude),Ie(o.latitude));return c!==0?c:re(Ie(i.longitude),Ie(o.longitude))}(n.geoPointValue,e.geoPointValue);case 9:return oh(n.arrayValue,e.arrayValue);case 10:return function(i,o){var c,l,u,h;const p=i.fields||{},_=o.fields||{},v=(c=p.value)===null||c===void 0?void 0:c.arrayValue,A=(l=_.value)===null||l===void 0?void 0:l.arrayValue,D=re(((u=v==null?void 0:v.values)===null||u===void 0?void 0:u.length)||0,((h=A==null?void 0:A.values)===null||h===void 0?void 0:h.length)||0);return D!==0?D:oh(v,A)}(n.mapValue,e.mapValue);case 11:return function(i,o){if(i===Nn.mapValue&&o===Nn.mapValue)return 0;if(i===Nn.mapValue)return 1;if(o===Nn.mapValue)return-1;const c=i.fields||{},l=Object.keys(c),u=o.fields||{},h=Object.keys(u);l.sort(),h.sort();for(let p=0;p<l.length&&p<h.length;++p){const _=re(l[p],h[p]);if(_!==0)return _;const v=Fn(c[l[p]],u[h[p]]);if(v!==0)return v}return re(l.length,h.length)}(n.mapValue,e.mapValue);default:throw G()}}function ih(n,e){if(typeof n=="string"&&typeof e=="string"&&n.length===e.length)return re(n,e);const t=pn(n),r=pn(e),s=re(t.seconds,r.seconds);return s!==0?s:re(t.nanos,r.nanos)}function oh(n,e){const t=n.values||[],r=e.values||[];for(let s=0;s<t.length&&s<r.length;++s){const i=Fn(t[s],r[s]);if(i)return i}return re(t.length,r.length)}function is(n){return $c(n)}function $c(n){return"nullValue"in n?"null":"booleanValue"in n?""+n.booleanValue:"integerValue"in n?""+n.integerValue:"doubleValue"in n?""+n.doubleValue:"timestampValue"in n?function(t){const r=pn(t);return`time(${r.seconds},${r.nanos})`}(n.timestampValue):"stringValue"in n?n.stringValue:"bytesValue"in n?function(t){return On(t).toBase64()}(n.bytesValue):"referenceValue"in n?function(t){return $.fromName(t).toString()}(n.referenceValue):"geoPointValue"in n?function(t){return`geo(${t.latitude},${t.longitude})`}(n.geoPointValue):"arrayValue"in n?function(t){let r="[",s=!0;for(const i of t.values||[])s?s=!1:r+=",",r+=$c(i);return r+"]"}(n.arrayValue):"mapValue"in n?function(t){const r=Object.keys(t.fields||{}).sort();let s="{",i=!0;for(const o of r)i?i=!1:s+=",",s+=`${o}:${$c(t.fields[o])}`;return s+"}"}(n.mapValue):G()}function Ti(n,e){return{referenceValue:`projects/${n.projectId}/databases/${n.database}/documents/${e.path.canonicalString()}`}}function jc(n){return!!n&&"integerValue"in n}function bi(n){return!!n&&"arrayValue"in n}function ah(n){return!!n&&"nullValue"in n}function ch(n){return!!n&&"doubleValue"in n&&isNaN(Number(n.doubleValue))}function No(n){return!!n&&"mapValue"in n}function wa(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="__vector__"}function ii(n){if(n.geoPointValue)return{geoPointValue:Object.assign({},n.geoPointValue)};if(n.timestampValue&&typeof n.timestampValue=="object")return{timestampValue:Object.assign({},n.timestampValue)};if(n.mapValue){const e={mapValue:{fields:{}}};return Rr(n.mapValue.fields,(t,r)=>e.mapValue.fields[t]=ii(r)),e}if(n.arrayValue){const e={arrayValue:{values:[]}};for(let t=0;t<(n.arrayValue.values||[]).length;++t)e.arrayValue.values[t]=ii(n.arrayValue.values[t]);return e}return Object.assign({},n)}function Fp(n){return(((n.mapValue||{}).fields||{}).__type__||{}).stringValue==="__max__"}const Bp={mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{}}}}};function FE(n){return"nullValue"in n?Do:"booleanValue"in n?{booleanValue:!1}:"integerValue"in n||"doubleValue"in n?{doubleValue:NaN}:"timestampValue"in n?{timestampValue:{seconds:Number.MIN_SAFE_INTEGER}}:"stringValue"in n?{stringValue:""}:"bytesValue"in n?{bytesValue:""}:"referenceValue"in n?Ti(pr.empty(),$.empty()):"geoPointValue"in n?{geoPointValue:{latitude:-90,longitude:-180}}:"arrayValue"in n?{arrayValue:{}}:"mapValue"in n?wa(n)?Bp:{mapValue:{}}:G()}function BE(n){return"nullValue"in n?{booleanValue:!1}:"booleanValue"in n?{doubleValue:NaN}:"integerValue"in n||"doubleValue"in n?{timestampValue:{seconds:Number.MIN_SAFE_INTEGER}}:"timestampValue"in n?{stringValue:""}:"stringValue"in n?{bytesValue:""}:"bytesValue"in n?Ti(pr.empty(),$.empty()):"referenceValue"in n?{geoPointValue:{latitude:-90,longitude:-180}}:"geoPointValue"in n?{arrayValue:{}}:"arrayValue"in n?Bp:"mapValue"in n?wa(n)?{mapValue:{}}:Nn:G()}function lh(n,e){const t=Fn(n.value,e.value);return t!==0?t:n.inclusive&&!e.inclusive?-1:!n.inclusive&&e.inclusive?1:0}function uh(n,e){const t=Fn(n.value,e.value);return t!==0?t:n.inclusive&&!e.inclusive?1:!n.inclusive&&e.inclusive?-1:0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this.value=e}static empty(){return new Ze({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!No(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=ii(t)}setAll(e){let t=Te.emptyPath(),r={},s=[];e.forEach((o,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,r,s),r={},s=[],t=c.popLast()}o?r[c.lastSegment()]=ii(o):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());No(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Wt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];No(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Rr(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Ze(ii(this.value))}}function Up(n){const e=[];return Rr(n.fields,(t,r)=>{const s=new Te([t]);if(No(r)){const i=Up(r.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)}),new ft(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Re{constructor(e,t,r,s,i,o,c){this.key=e,this.documentType=t,this.version=r,this.readTime=s,this.createTime=i,this.data=o,this.documentState=c}static newInvalidDocument(e){return new Re(e,0,Z.min(),Z.min(),Z.min(),Ze.empty(),0)}static newFoundDocument(e,t,r,s){return new Re(e,1,t,Z.min(),r,s,0)}static newNoDocument(e,t){return new Re(e,2,t,Z.min(),Z.min(),Ze.empty(),0)}static newUnknownDocument(e,t){return new Re(e,3,t,Z.min(),Z.min(),Ze.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(Z.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Ze.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Ze.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=Z.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Re&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Re(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HE{constructor(e,t=null,r=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.ue=null}}function Gc(n,e=null,t=[],r=[],s=null,i=null,o=null){return new HE(n,e,t,r,s,i,o)}function gr(n){const e=z(n);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>Kc(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(i){return i.field.canonicalString()+i.dir}(r)).join(","),va(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>is(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>is(r)).join(",")),e.ue=t}return e.ue}function Bi(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!UE(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!qp(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!hh(n.startAt,e.startAt)&&hh(n.endAt,e.endAt)}function Yo(n){return $.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}function Xo(n,e){return n.filters.filter(t=>t instanceof ce&&t.field.isEqual(e))}function fh(n,e,t){let r=Do,s=!0;for(const i of Xo(n,e)){let o=Do,c=!0;switch(i.op){case"<":case"<=":o=FE(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,c=!1;break;case"!=":case"not-in":o=Do}lh({value:r,inclusive:s},{value:o,inclusive:c})<0&&(r=o,s=c)}if(t!==null){for(let i=0;i<n.orderBy.length;++i)if(n.orderBy[i].field.isEqual(e)){const o=t.position[i];lh({value:r,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(r=o,s=t.inclusive);break}}return{value:r,inclusive:s}}function ph(n,e,t){let r=Nn,s=!0;for(const i of Xo(n,e)){let o=Nn,c=!0;switch(i.op){case">=":case">":o=BE(i.value),c=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,c=!1;break;case"!=":case"not-in":o=Nn}uh({value:r,inclusive:s},{value:o,inclusive:c})>0&&(r=o,s=c)}if(t!==null){for(let i=0;i<n.orderBy.length;++i)if(n.orderBy[i].field.isEqual(e)){const o=t.position[i];uh({value:r,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(r=o,s=t.inclusive);break}}return{value:r,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JE=new _e($.comparator);function yt(){return JE}const Zp=new _e($.comparator);function Js(...n){let e=Zp;for(const t of n)e=e.insert(t.key,t);return e}function em(n){let e=Zp;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Kt(){return ai()}function tm(){return ai()}function ai(){return new qn(n=>n.toString(),(n,e)=>n.isEqual(e))}const YE=new _e($.comparator),XE=new pe($.comparator);function ie(...n){let e=XE;for(const t of n)e=e.add(t);return e}const ZE=new pe(re);function Nl(){return ZE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,ji.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new $i(Z.min(),s,new _e(re),yt(),ie())}}class ji{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new ji(r,t,ie(),ie(),ie())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pm(n){var e,t;if(Q(n instanceof ce||n instanceof fe),n instanceof ce){if(n instanceof Hp){const s=((t=(e=n.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(i=>ce.create(n.field,"==",i)))||[];return fe.create(s,"or")}return n}const r=n.filters.map(s=>Pm(s));return fe.create(r,n.op)}function NT(n){if(n.getFilters().length===0)return[];const e=el(Pm(n));return Q(Cm(e)),Xc(e)||Zc(e)?[e]:e.getFilters()}function Xc(n){return n instanceof ce}function Zc(n){return n instanceof fe&&Dl(n)}function Cm(n){return Xc(n)||Zc(n)||function(t){if(t instanceof fe&&qc(t)){for(const r of t.getFilters())if(!Xc(r)&&!Zc(r))return!1;return!0}return!1}(n)}function el(n){if(Q(n instanceof ce||n instanceof fe),n instanceof ce)return n;if(n.filters.length===1)return el(n.filters[0]);const e=n.filters.map(r=>el(r));let t=fe.create(e,n.op);return t=na(t),Cm(t)?t:(Q(t instanceof fe),Q(as(t)),Q(t.filters.length>1),t.filters.reduce((r,s)=>Bl(r,s)))}function Bl(n,e){let t;return Q(n instanceof ce||n instanceof fe),Q(e instanceof ce||e instanceof fe),t=n instanceof ce?e instanceof ce?function(s,i){return fe.create([s,i],"and")}(n,e):Vh(n,e):e instanceof ce?Vh(e,n):function(s,i){if(Q(s.filters.length>0&&i.filters.length>0),as(s)&&as(i))return Kp(s,i.getFilters());const o=qc(s)?s:i,c=qc(s)?i:s,l=o.filters.map(u=>Bl(u,c));return fe.create(l,"or")}(n,e),na(t)}function Vh(n,e){if(as(e))return Kp(e,n.getFilters());{const t=e.filters.map(r=>Bl(n,r));return fe.create(t,"or")}}function na(n){if(Q(n instanceof ce||n instanceof fe),n instanceof ce)return n;const e=n.getFilters();if(e.length===1)return na(e[0]);if(jp(n))return n;const t=e.map(s=>na(s)),r=[];return t.forEach(s=>{s instanceof ce?r.push(s):s instanceof fe&&(s.op===n.op?r.push(...s.filters):r.push(s))}),r.length===1?r[0]:fe.create(r,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yo=new Uint8Array(0);class VT{constructor(e,t){this.databaseId=t,this.cn=new Ul,this.ln=new qn(r=>gr(r),(r,s)=>Bi(r,s)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.cn.has(t)){const r=t.lastSegment(),s=t.popLast();e.addOnCommittedListener(()=>{this.cn.add(t)});const i={collectionId:r,parent:ct(s)};return Lh(e).put(i)}return P.resolve()}getCollectionParents(e,t){const r=[],s=IDBKeyRange.bound([t,""],[Ap(t),""],!1,!0);return Lh(e).U(s).next(i=>{for(const o of i){if(o.collectionId!==t)break;r.push(qt(o.parent))}return r})}addFieldIndex(e,t){const r=js(e),s=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(l=>[l.fieldPath.canonicalString(),l.kind])}}(t);delete s.indexId;const i=r.add(s);if(t.indexState){const o=zr(e);return i.next(c=>{o.put(Ph(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){const r=js(e),s=zr(e),i=Gr(e);return r.delete(t.indexId).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=js(e),r=Gr(e),s=zr(e);return t.j().next(()=>r.j()).next(()=>s.j())}createTargetIndexes(e,t){return P.forEach(this.hn(t),r=>this.getIndexType(e,r).next(s=>{if(s===0||s===1){const i=new xh(r).an();if(i!=null)return this.addFieldIndex(e,i)}}))}getDocumentsMatchingTarget(e,t){const r=Gr(e);let s=!0;const i=new Map;return P.forEach(this.hn(t),o=>this.Pn(e,o).next(c=>{s&&(s=!!c),i.set(o,c)})).next(()=>{if(s){let o=ie();const c=[];return P.forEach(i,(l,u)=>{x("IndexedDbIndexManager",`Using index ${function(B){return`id=${B.indexId}|cg=${B.collectionGroup}|f=${B.fields.map(q=>`${q.fieldPath}:${q.kind}`).join(",")}`}(l)} to execute ${gr(t)}`);const h=function(B,q){const H=Bc(q);if(H===void 0)return null;for(const j of Xo(B,H.fieldPath))switch(j.op){case"array-contains-any":return j.value.arrayValue.values||[];case"array-contains":return[j.value]}return null}(u,l),p=function(B,q){const H=new Map;for(const j of er(q))for(const E of Xo(B,j.fieldPath))switch(E.op){case"==":case"in":H.set(j.fieldPath.canonicalString(),E.value);break;case"not-in":case"!=":return H.set(j.fieldPath.canonicalString(),E.value),Array.from(H.values())}return null}(u,l),_=function(B,q){const H=[];let j=!0;for(const E of er(q)){const y=E.kind===0?fh(B,E.fieldPath,B.startAt):ph(B,E.fieldPath,B.startAt);H.push(y.value),j&&(j=y.inclusive)}return new os(H,j)}(u,l),v=function(B,q){const H=[];let j=!0;for(const E of er(q)){const y=E.kind===0?ph(B,E.fieldPath,B.endAt):fh(B,E.fieldPath,B.endAt);H.push(y.value),j&&(j=y.inclusive)}return new os(H,j)}(u,l),A=this.In(l,u,_),D=this.In(l,u,v),C=this.Tn(l,u,p),V=this.En(l.indexId,h,A,_.inclusive,D,v.inclusive,C);return P.forEach(V,F=>r.G(F,t.limit).next(B=>{B.forEach(q=>{const H=$.fromSegments(q.documentKey);o.has(H)||(o=o.add(H),c.push(H))})}))}).next(()=>c)}return P.resolve(null)})}hn(e){let t=this.ln.get(e);return t||(e.filters.length===0?t=[e]:t=NT(fe.create(e.filters,"and")).map(r=>Gc(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.ln.set(e,t),t)}En(e,t,r,s,i,o,c){const l=(t!=null?t.length:1)*Math.max(r.length,i.length),u=l/(t!=null?t.length:1),h=[];for(let p=0;p<l;++p){const _=t?this.dn(t[p/u]):yo,v=this.An(e,_,r[p%u],s),A=this.Rn(e,_,i[p%u],o),D=c.map(C=>this.An(e,_,C,!0));h.push(...this.createRange(v,A,D))}return h}An(e,t,r,s){const i=new sr(e,$.empty(),t,r);return s?i:i.Zt()}Rn(e,t,r,s){const i=new sr(e,$.empty(),t,r);return s?i.Zt():i}Pn(e,t){const r=new xh(t),s=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,s).next(i=>{let o=null;for(const c of i)r.rn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let r=2;const s=this.hn(t);return P.forEach(s,i=>this.Pn(e,i).next(o=>{o?r!==0&&o.fields.length<function(l){let u=new pe(Te.comparator),h=!1;for(const p of l.filters)for(const _ of p.getFlattenedFilters())_.field.isKeyField()||(_.op==="array-contains"||_.op==="array-contains-any"?h=!0:u=u.add(_.field));for(const p of l.orderBy)p.field.isKeyField()||(u=u.add(p.field));return u.size+(h?1:0)}(i)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(t)&&s.length>1&&r===2?1:r)}Vn(e,t){const r=new $s;for(const s of er(e)){const i=t.data.field(s.fieldPath);if(i==null)return null;const o=r.Yt(s.kind);rr.vt.It(i,o)}return r.zt()}dn(e){const t=new $s;return rr.vt.It(e,t.Yt(0)),t.zt()}mn(e,t){const r=new $s;return rr.vt.It(Ti(this.databaseId,t),r.Yt(function(i){const o=er(i);return o.length===0?0:o[o.length-1].kind}(e))),r.zt()}Tn(e,t,r){if(r===null)return[];let s=[];s.push(new $s);let i=0;for(const o of er(e)){const c=r[i++];for(const l of s)if(this.fn(t,o.fieldPath)&&bi(c))s=this.gn(s,o,c);else{const u=l.Yt(o.kind);rr.vt.It(c,u)}}return this.pn(s)}In(e,t,r){return this.Tn(e,t,r.position)}pn(e){const t=[];for(let r=0;r<e.length;++r)t[r]=e[r].zt();return t}gn(e,t,r){const s=[...e],i=[];for(const o of r.arrayValue.values||[])for(const c of s){const l=new $s;l.seed(c.zt()),rr.vt.It(o,l.Yt(t.kind)),i.push(l)}return i}fn(e,t){return!!e.filters.find(r=>r instanceof ce&&r.field.isEqual(t)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,t){const r=js(e),s=zr(e);return(t?r.U("collectionGroupIndex",IDBKeyRange.bound(t,t)):r.U()).next(i=>{const o=[];return P.forEach(i,c=>s.get([c.indexId,this.uid]).next(l=>{o.push(function(h,p){const _=p?new vi(p.sequenceNumber,new It(yr(p.readTime),new $(qt(p.documentKey)),p.largestBatchId)):vi.empty(),v=h.fields.map(([A,D])=>new Co(Te.fromServerFormat(A),D));return new Qo(h.indexId,h.collectionGroup,v,_)}(c,l))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((r,s)=>{const i=r.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:re(r.collectionGroup,s.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,r){const s=js(e),i=zr(e);return this.yn(e).next(o=>s.U("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(c=>P.forEach(c,l=>i.put(Ph(l.indexId,this.uid,o,r)))))}updateIndexEntries(e,t){const r=new Map;return P.forEach(t,(s,i)=>{const o=r.get(s.collectionGroup);return(o?P.resolve(o):this.getFieldIndexes(e,s.collectionGroup)).next(c=>(r.set(s.collectionGroup,c),P.forEach(c,l=>this.wn(e,s,l).next(u=>{const h=this.Sn(i,l);return u.isEqual(h)?P.resolve():this.bn(e,i,l,u,h)}))))})}Dn(e,t,r,s){return Gr(e).put({indexId:s.indexId,uid:this.uid,arrayValue:s.arrayValue,directionalValue:s.directionalValue,orderedDocumentKey:this.mn(r,t.key),documentKey:t.key.path.toArray()})}vn(e,t,r,s){return Gr(e).delete([s.indexId,this.uid,s.arrayValue,s.directionalValue,this.mn(r,t.key),t.key.path.toArray()])}wn(e,t,r){const s=Gr(e);let i=new pe(bn);return s.J({index:"documentKeyIndex",range:IDBKeyRange.only([r.indexId,this.uid,this.mn(r,t)])},(o,c)=>{i=i.add(new sr(r.indexId,t,c.arrayValue,c.directionalValue))}).next(()=>i)}Sn(e,t){let r=new pe(bn);const s=this.Vn(t,e);if(s==null)return r;const i=Bc(t);if(i!=null){const o=e.data.field(i.fieldPath);if(bi(o))for(const c of o.arrayValue.values||[])r=r.add(new sr(t.indexId,e.key,this.dn(c),s))}else r=r.add(new sr(t.indexId,e.key,yo,s));return r}bn(e,t,r,s,i){x("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const o=[];return function(l,u,h,p,_){const v=l.getIterator(),A=u.getIterator();let D=Kr(v),C=Kr(A);for(;D||C;){let V=!1,F=!1;if(D&&C){const B=h(D,C);B<0?F=!0:B>0&&(V=!0)}else D!=null?F=!0:V=!0;V?(p(C),C=Kr(A)):F?(_(D),D=Kr(v)):(D=Kr(v),C=Kr(A))}}(s,i,bn,c=>{o.push(this.Dn(e,t,r,c))},c=>{o.push(this.vn(e,t,r,c))}),P.waitFor(o)}yn(e){let t=1;return zr(e).J({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,s,i)=>{i.done(),t=s.sequenceNumber+1}).next(()=>t)}createRange(e,t,r){r=r.sort((o,c)=>bn(o,c)).filter((o,c,l)=>!c||bn(o,l[c-1])!==0);const s=[];s.push(e);for(const o of r){const c=bn(o,e),l=bn(o,t);if(c===0)s[0]=e.Zt();else if(c>0&&l<0)s.push(o),s.push(o.Zt());else if(l>0)break}s.push(t);const i=[];for(let o=0;o<s.length;o+=2){if(this.Cn(s[o],s[o+1]))return[];const c=[s[o].indexId,this.uid,s[o].arrayValue,s[o].directionalValue,yo,[]],l=[s[o+1].indexId,this.uid,s[o+1].arrayValue,s[o+1].directionalValue,yo,[]];i.push(IDBKeyRange.bound(c,l))}return i}Cn(e,t){return bn(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(Mh)}getMinOffset(e,t){return P.mapArray(this.hn(t),r=>this.Pn(e,r).next(s=>s||G())).next(Mh)}}function Lh(n){return Be(n,"collectionParents")}function Gr(n){return Be(n,"indexEntries")}function js(n){return Be(n,"indexConfiguration")}function zr(n){return Be(n,"indexState")}function Mh(n){Q(n.length!==0);let e=n[0].indexState.offset,t=e.largestBatchId;for(let r=1;r<n.length;r++){const s=n[r].indexState.offset;Sl(s,e)<0&&(e=s),t<s.largestBatchId&&(t=s.largestBatchId)}return new It(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oh={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0};class dt{constructor(e,t,r){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=r}static withCacheSize(e){return new dt(e,dt.DEFAULT_COLLECTION_PERCENTILE,dt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */dt.DEFAULT_COLLECTION_PERCENTILE=10,dt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,dt.DEFAULT=new dt(41943040,dt.DEFAULT_COLLECTION_PERCENTILE,dt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),dt.DISABLED=new dt(-1,0,0);class Ra{constructor(e,t,r,s){this.userId=e,this.serializer=t,this.indexManager=r,this.referenceDelegate=s,this.Fn={}}static lt(e,t,r,s){Q(e.uid!=="");const i=e.isAuthenticated()?e.uid:"";return new Ra(i,t,r,s)}checkEmpty(e){let t=!0;const r=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return An(e).J({index:"userMutationsIndex",range:r},(s,i,o)=>{t=!1,o.done()}).next(()=>t)}addMutationBatch(e,t,r,s){const i=Xr(e),o=An(e);return o.add({}).next(c=>{Q(typeof c=="number");const l=new Vl(c,t,r,s),u=function(v,A,D){const C=D.baseMutations.map(F=>ea(v.ct,F)),V=D.mutations.map(F=>ea(v.ct,F));return{userId:A,batchId:D.batchId,localWriteTimeMs:D.localWriteTime.toMillis(),baseMutations:C,mutations:V}}(this.serializer,this.userId,l),h=[];let p=new pe((_,v)=>re(_.canonicalString(),v.canonicalString()));for(const _ of s){const v=Np(this.userId,_.key.path,c);p=p.add(_.key.path.popLast()),h.push(o.put(u)),h.push(i.put(v,yE))}return p.forEach(_=>{h.push(this.indexManager.addToCollectionParentIndex(e,_))}),e.addOnCommittedListener(()=>{this.Fn[c]=l.keys()}),P.waitFor(h).next(()=>l)})}lookupMutationBatch(e,t){return An(e).get(t).next(r=>r?(Q(r.userId===this.userId),nr(this.serializer,r)):null)}Mn(e,t){return this.Fn[t]?P.resolve(this.Fn[t]):this.lookupMutationBatch(e,t).next(r=>{if(r){const s=r.keys();return this.Fn[t]=s,s}return null})}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=IDBKeyRange.lowerBound([this.userId,r]);let i=null;return An(e).J({index:"userMutationsIndex",range:s},(o,c,l)=>{c.userId===this.userId&&(Q(c.batchId>=r),i=nr(this.serializer,c)),l.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(e){const t=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let r=-1;return An(e).J({index:"userMutationsIndex",range:t,reverse:!0},(s,i,o)=>{r=i.batchId,o.done()}).next(()=>r)}getAllMutationBatches(e){const t=IDBKeyRange.bound([this.userId,-1],[this.userId,Number.POSITIVE_INFINITY]);return An(e).U("userMutationsIndex",t).next(r=>r.map(s=>nr(this.serializer,s)))}getAllMutationBatchesAffectingDocumentKey(e,t){const r=ko(this.userId,t.path),s=IDBKeyRange.lowerBound(r),i=[];return Xr(e).J({range:s},(o,c,l)=>{const[u,h,p]=o,_=qt(h);if(u===this.userId&&t.path.isEqual(_))return An(e).get(p).next(v=>{if(!v)throw G();Q(v.userId===this.userId),i.push(nr(this.serializer,v))});l.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new pe(re);const s=[];return t.forEach(i=>{const o=ko(this.userId,i.path),c=IDBKeyRange.lowerBound(o),l=Xr(e).J({range:c},(u,h,p)=>{const[_,v,A]=u,D=qt(v);_===this.userId&&i.path.isEqual(D)?r=r.add(A):p.done()});s.push(l)}),P.waitFor(s).next(()=>this.xn(e,r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1,i=ko(this.userId,r),o=IDBKeyRange.lowerBound(i);let c=new pe(re);return Xr(e).J({range:o},(l,u,h)=>{const[p,_,v]=l,A=qt(_);p===this.userId&&r.isPrefixOf(A)?A.length===s&&(c=c.add(v)):h.done()}).next(()=>this.xn(e,c))}xn(e,t){const r=[],s=[];return t.forEach(i=>{s.push(An(e).get(i).next(o=>{if(o===null)throw G();Q(o.userId===this.userId),r.push(nr(this.serializer,o))}))}),P.waitFor(s).next(()=>r)}removeMutationBatch(e,t){return km(e._e,this.userId,t).next(r=>(e.addOnCommittedListener(()=>{this.On(t.batchId)}),P.forEach(r,s=>this.referenceDelegate.markPotentiallyOrphaned(e,s))))}On(e){delete this.Fn[e]}performConsistencyCheck(e){return this.checkEmpty(e).next(t=>{if(!t)return P.resolve();const r=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),s=[];return Xr(e).J({range:r},(i,o,c)=>{if(i[0]===this.userId){const l=qt(i[1]);s.push(l)}else c.done()}).next(()=>{Q(s.length===0)})})}containsKey(e,t){return Dm(e,this.userId,t)}Nn(e){return Nm(e).get(this.userId).next(t=>t||{userId:this.userId,lastAcknowledgedBatchId:-1,lastStreamToken:""})}}function Dm(n,e,t){const r=ko(e,t.path),s=r[1],i=IDBKeyRange.lowerBound(r);let o=!1;return Xr(n).J({range:i,H:!0},(c,l,u)=>{const[h,p,_]=c;h===e&&p===s&&(o=!0),u.done()}).next(()=>o)}function An(n){return Be(n,"mutations")}function Xr(n){return Be(n,"documentMutations")}function Nm(n){return Be(n,"mutationQueues")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UT{constructor(e,t){this.db=e,this.garbageCollector=BT(this,t)}Yn(e){const t=this.er(e);return this.db.getTargetCache().getTargetCount(e).next(r=>t.next(s=>r+s))}er(e){let t=0;return this.Zn(e,r=>{t++}).next(()=>t)}forEachTarget(e,t){return this.db.getTargetCache().forEachTarget(e,t)}Zn(e,t){return this.tr(e,(r,s)=>t(s))}addReference(e,t,r){return vo(e,r)}removeReference(e,t,r){return vo(e,r)}removeTargets(e,t,r){return this.db.getTargetCache().removeTargets(e,t,r)}markPotentiallyOrphaned(e,t){return vo(e,t)}nr(e,t){return function(s,i){let o=!1;return Nm(s).Y(c=>Dm(s,c,i).next(l=>(l&&(o=!0),P.resolve(!l)))).next(()=>o)}(e,t)}removeOrphanedDocuments(e,t){const r=this.db.getRemoteDocumentCache().newChangeBuffer(),s=[];let i=0;return this.tr(e,(o,c)=>{if(c<=t){const l=this.nr(e,o).next(u=>{if(!u)return i++,r.getEntry(e,o).next(()=>(r.removeEntry(o,Z.min()),kn(e).delete(function(p){return[0,ct(p.path)]}(o))))});s.push(l)}}).next(()=>P.waitFor(s)).next(()=>r.apply(e)).next(()=>i)}removeTarget(e,t){const r=t.withSequenceNumber(e.currentSequenceNumber);return this.db.getTargetCache().updateTargetData(e,r)}updateLimboDocument(e,t){return vo(e,t)}tr(e,t){const r=kn(e);let s,i=ht.oe;return r.J({index:"documentTargetsIndex"},([o,c],{path:l,sequenceNumber:u})=>{o===0?(i!==ht.oe&&t(new $(qt(s)),i),i=u,s=l):i=ht.oe}).next(()=>{i!==ht.oe&&t(new $(qt(s)),i)})}getCacheSize(e){return this.db.getRemoteDocumentCache().getSize(e)}}function vo(n,e){return kn(n).put(function(r,s){return{targetId:0,path:ct(r.path),sequenceNumber:s}}(e,n.currentSequenceNumber))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xm{constructor(){this.changes=new qn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Re.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?P.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $l{constructor(){this.Tr=new pe(Ue.Er),this.dr=new pe(Ue.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Ue(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Ue(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new $(new he([])),r=new Ue(t,e),s=new Ue(t,e+1),i=[];return this.dr.forEachInRange([r,s],o=>{this.Vr(o),i.push(o.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new $(new he([])),r=new Ue(t,e),s=new Ue(t,e+1);let i=ie();return this.dr.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const t=new Ue(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Ue{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return $.comparator(e.key,t.key)||re(e.wr,t.wr)}static Ar(e,t){return re(e.wr,t.wr)||$.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HT{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Sr=1,this.br=new pe(Ue.Er)}checkEmpty(e){return P.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,s){const i=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new Vl(i,t,r,s);this.mutationQueue.push(o);for(const c of s)this.br=this.br.add(new Ue(c.key,i)),this.indexManager.addToCollectionParentIndex(e,c.key.path.popLast());return P.resolve(o)}lookupMutationBatch(e,t){return P.resolve(this.Dr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=this.vr(r),i=s<0?0:s;return P.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return P.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return P.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new Ue(t,0),s=new Ue(t,Number.POSITIVE_INFINITY),i=[];return this.br.forEachInRange([r,s],o=>{const c=this.Dr(o.wr);i.push(c)}),P.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new pe(re);return t.forEach(s=>{const i=new Ue(s,0),o=new Ue(s,Number.POSITIVE_INFINITY);this.br.forEachInRange([i,o],c=>{r=r.add(c.wr)})}),P.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1;let i=r;$.isDocumentKey(i)||(i=i.child(""));const o=new Ue(new $(i),0);let c=new pe(re);return this.br.forEachWhile(l=>{const u=l.key.path;return!!r.isPrefixOf(u)&&(u.length===s&&(c=c.add(l.wr)),!0)},o),P.resolve(this.Cr(c))}Cr(e){const t=[];return e.forEach(r=>{const s=this.Dr(r);s!==null&&t.push(s)}),t}removeMutationBatch(e,t){Q(this.Fr(t.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return P.forEach(t.mutations,s=>{const i=new Ue(s.key,t.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,t){const r=new Ue(t,0),s=this.br.firstAfterOrEqual(r);return P.resolve(t.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,P.resolve()}Fr(e,t){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const t=this.vr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mm{constructor(e,t){this.qr={},this.overlays={},this.Qr=new ht(0),this.Kr=!1,this.Kr=!0,this.$r=new zT,this.referenceDelegate=e(this),this.Ur=new JT(this),this.indexManager=new xT,this.remoteDocumentCache=function(s){return new WT(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new Am(t),this.Gr=new KT(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new GT,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new HT(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){x("MemoryPersistence","Starting transaction:",e);const s=new YT(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return P.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class YT extends Cp{constructor(e){super(),this.currentSequenceNumber=e}}class Pa{constructor(e){this.persistence=e,this.Jr=new $l,this.Yr=null}static Zr(e){return new Pa(e)}get Xr(){if(this.Yr)return this.Yr;throw G()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),P.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),P.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),P.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return P.forEach(this.Xr,r=>{const s=$.fromPath(r);return this.ei(e,s).next(i=>{i||t.removeEntry(s,Z.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return P.or([()=>P.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ql{constructor(e,t,r,s){this.targetId=e,this.fromCache=t,this.$i=r,this.Ui=s}static Wi(e,t){let r=ie(),s=ie();for(const i of t.docChanges)switch(i.type){case 0:r=r.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new ql(e,t.fromCache,r,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bb{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class Ab{constructor(){this.queries=Qh(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(t,r){const s=z(t),i=s.queries;s.queries=Qh(),i.forEach((o,c)=>{for(const l of c.j_)l.onError(r)})})(this,new O(N.ABORTED,"Firestore shutting down"))}}function Qh(){return new qn(n=>Jp(n),Ea)}async function eg(n,e){const t=z(n);let r=3;const s=e.query;let i=t.queries.get(s);i?!i.H_()&&e.J_()&&(r=2):(i=new bb,r=e.J_()?0:1);try{switch(r){case 0:i.z_=await t.onListen(s,!0);break;case 1:i.z_=await t.onListen(s,!1);break;case 2:await t.onFirstRemoteStoreListen(s)}}catch(o){const c=Ql(o,`Initialization of query '${Qr(e.query)}' failed`);return void e.onError(c)}t.queries.set(s,i),i.j_.push(e),e.Z_(t.onlineState),i.z_&&e.X_(i.z_)&&Jl(t)}async function tg(n,e){const t=z(n),r=e.query;let s=3;const i=t.queries.get(r);if(i){const o=i.j_.indexOf(e);o>=0&&(i.j_.splice(o,1),i.j_.length===0?s=e.J_()?0:1:!i.H_()&&e.J_()&&(s=2))}switch(s){case 0:return t.queries.delete(r),t.onUnlisten(r,!0);case 1:return t.queries.delete(r),t.onUnlisten(r,!1);case 2:return t.onLastRemoteStoreUnlisten(r);default:return}}function Sb(n,e){const t=z(n);let r=!1;for(const s of e){const i=s.query,o=t.queries.get(i);if(o){for(const c of o.j_)c.X_(s)&&(r=!0);o.z_=s}}r&&Jl(t)}function Rb(n,e,t){const r=z(n),s=r.queries.get(e);if(s)for(const i of s.j_)i.onError(t);r.queries.delete(e)}function Jl(n){n.Y_.forEach(e=>{e.next()})}var sl,Jh;(Jh=sl||(sl={})).ea="default",Jh.Cache="cache";class ng{constructor(e,t,r){this.query=e,this.ta=t,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=r||{}}X_(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new ps(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.na?this.ia(e)&&(this.ta.next(e),t=!0):this.sa(e,this.onlineState)&&(this.oa(e),t=!0),this.ra=e,t}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let t=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),t=!0),t}sa(e,t){if(!e.fromCache||!this.J_())return!0;const r=t!=="Offline";return(!this.options._a||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const t=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}oa(e){e=ps.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==sl.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Cr(this.firestore,e,this._query)}}class ut{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ln(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ut(this.firestore,e,this._key)}}class Ln extends Cr{constructor(e,t,r){super(e,t,Ia(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ut(this.firestore,null,new $(e))}withConverter(e){return new Ln(this.firestore,e,this._path)}}function Ge(n,e,...t){if(n=we(n),nu("collection","path",e),n instanceof Va){const r=he.fromString(e,...t);return nf(r),new Ln(n,null,r)}{if(!(n instanceof ut||n instanceof Ln))throw new O(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(he.fromString(e,...t));return nf(r),new Ln(n.firestore,null,r)}}function rA(n,e){if(n=Dt(n,Va),nu("collectionGroup","collection id",e),e.indexOf("/")>=0)throw new O(N.INVALID_ARGUMENT,`Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new Cr(n,null,function(r){return new vs(he.emptyPath(),r)}(e))}function oe(n,e,...t){if(n=we(n),arguments.length===1&&(e=bp.newId()),nu("doc","path",e),n instanceof Va){const r=he.fromString(e,...t);return tf(r),new ut(n,null,new $(r))}{if(!(n instanceof ut||n instanceof Ln))throw new O(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(he.fromString(e,...t));return tf(r),new ut(n.firestore,n instanceof Ln?n.converter:null,new $(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e,t){let r=0,s="";cf(e)?(this.data_=e,r=e.size,s=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),r=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),r=e.length),this.size_=r,this.type_=s}size(){return this.size_}type(){return this.type_}slice(e,t){if(cf(this.data_)){const r=this.data_,s=nS(r,e,t);return s===null?null:new Dn(s)}else{const r=new Uint8Array(this.data_.buffer,e,t-e);return new Dn(r,!0)}}static getBlob(...e){if(mu()){const t=e.map(r=>r instanceof Dn?r.data_:r);return new Dn(tS.apply(null,t))}else{const t=e.map(o=>pu(o)?kg(Pt.RAW,o).data:o.data_);let r=0;t.forEach(o=>{r+=o.byteLength});const s=new Uint8Array(r);let i=0;return t.forEach(o=>{for(let c=0;c<o.length;c++)s[i++]=o[c]}),new Dn(s,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(e,t){this._service=e,t instanceof vt?this._location=t:this._location=vt.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new wr(e,t)}get root(){const e=new vt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Lg(this._location.path)}get storage(){return this._service}get parent(){const e=cS(this._location.path);if(e===null)return null;const t=new vt(this._location.bucket,e);return new wr(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw $A(e)}}function AS(n,e,t){n._throwIfRoot("uploadBytes");const r=ES(n.storage,n._location,Mg(),new Dn(e,!0),t);return n.storage.makeRequestWithTokens(r,$g).then(s=>({metadata:s,ref:n}))}function SS(n,e,t=Pt.RAW,r){n._throwIfRoot("uploadString");const s=kg(t,e),i=Object.assign({},r);return i.contentType==null&&s.contentType!=null&&(i.contentType=s.contentType),AS(n,s.data,i)}function RS(n){n._throwIfRoot("getDownloadURL");const e=vS(n.storage,n._location,Mg());return n.storage.makeRequestWithTokens(e,$g).then(t=>{if(t===null)throw BA();return t})}function PS(n,e){const t=lS(n._location.path,e),r=new vt(n._location.bucket,t);return new wr(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qg="storage";function Kg(n,e,t,r){return n=we(n),SS(n,e,t,r)}function Gg(n){return n=we(n),RS(n)}function zg(n,e){return n=we(n),DS(n,e)}function xS(n=ml(),e){n=we(n);const r=Ar(n,qg).getImmediate({identifier:e}),s=_y("storage");return s&&VS(r,...s),r}function VS(n,e,t,r={}){NS(n,e,t,r)}function LS(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new _u(t,r,s,e,Sr)}function MS(){Ct(new St(qg,LS,"PUBLIC").setMultipleInstances(!0)),pt(df,hf,""),pt(df,hf,"esm2017")}MS();const Hg="@firebase/installations",yu="0.6.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rn(n){const e=new Uint8Array(n);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function P0(n){const e="=".repeat((4-n.length%4)%4),t=(n+e).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(t),s=new Uint8Array(r.length);for(let i=0;i<r.length;++i)s[i]=r.charCodeAt(i);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function M0(n,e){const t=await bu(n),r=m_(e),s={method:"POST",headers:t,body:JSON.stringify(r)};let i;try{i=await(await fetch(Tu(n.appConfig),s)).json()}catch(o){throw rt.create("token-subscribe-failed",{errorInfo:o==null?void 0:o.toString()})}if(i.error){const o=i.error.message;throw rt.create("token-subscribe-failed",{errorInfo:o})}if(!i.token)throw rt.create("token-subscribe-no-token");return i.token}async function O0(n,e){const t=await bu(n),r=m_(e.subscriptionOptions),s={method:"PATCH",headers:t,body:JSON.stringify(r)};let i;try{i=await(await fetch(`${Tu(n.appConfig)}/${e.token}`,s)).json()}catch(o){throw rt.create("token-update-failed",{errorInfo:o==null?void 0:o.toString()})}if(i.error){const o=i.error.message;throw rt.create("token-update-failed",{errorInfo:o})}if(!i.token)throw rt.create("token-update-no-token");return i.token}async function F0(n,e){const r={method:"DELETE",headers:await bu(n)};try{const i=await(await fetch(`${Tu(n.appConfig)}/${e}`,r)).json();if(i.error){const o=i.error.message;throw rt.create("token-unsubscribe-failed",{errorInfo:o})}}catch(s){throw rt.create("token-unsubscribe-failed",{errorInfo:s==null?void 0:s.toString()})}}function Tu({projectId:n}){return`${b0}/projects/${n}/registrations`}async function bu({appConfig:n,installations:e}){const t=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n.apiKey,"x-goog-firebase-installations-auth":`FIS ${t}`})}function m_({p256dh:n,auth:e,endpoint:t,vapidKey:r}){const s={web:{endpoint:t,auth:e,p256dh:n}};return r!==d_&&(s.web.applicationPubKey=r),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}const u=l.scores.flat().filter(_=>_!=null),h=u.length?(u.reduce((_,v)=>_+Oe(v),0)/u.length).toFixed(2):"—",p=Su(l.scores);if(t+="  Total: "+tt(l.scores)+` point
...
(Kræver login med din bruger)`);const i=n.shooters.map(l=>{var u;return(u=m.friends.find(h=>h.id===l.id))==null?void 0:u.email}).filter(Boolean),o="3D Bueskydning - "+n.name,c="mailto:"+i.join(",")+"?subject="+encodeURIComponent(o)+"&body="+encodeURIComponent(t);window.location.href=c};const D_="archery_meetups_seen",MR={afventer:"Afventer",tilmeldt:"Tilmeldt ✅",foreslået:"Foreslår andet tidspunkt 🕓",afvist:"Afbud ❌"};function Cc(n){if(!n)return"";const[e,t,r]=n.split("-");return e&&t&&r?`${r}-${t}-${e}`:n}let Ke=new Map,Wi="venner",ni=null,N_=null,Nu=null,x_=null;async function xu(){if(m.user)try{const n=[nt(la(Ge(X,"meetups"),ui("creatorUid","==",m.user.uid))),nt(la(Ge(X,"meetups"),ui("invitedUids","array-contains",m.user.uid)))];m.isSuperAdmin&&n.push(nt(Ge(X,"meetups")));const e=await Promise.all(n),t=new Map;e.forEach(r=>r.docs.forEach(s=>t.set(s.id,{id:s.id,...s.data()}))),m.meetups=[...t.values()].sort((r,s)=>`${r.date}${r.time}`.localeCompare(`${s.date}${s.time}`))}catch(n){console.warn("Hent meetups:",n)}}function OR(n,e){return n.filter(t=>{var s,i;return(((i=(s=t.updatedAt)==null?void 0:s.toMillis)==null?void 0:i.call(s))??(typeof t.updatedAt=="number"?t.updatedAt:0))>e}).length}function Qi(){const n=document.getElementById("meetup-badge");if(!n)return;const e=Number(localStorage.getItem(D_)||0),t=OR(m.meetups,e);n.classList.toggle("hidden",t===0),n.textContent=t}function FR(){localStorage.setItem(D_,String(Date.now())),Qi()}function Vt(){const n=document.getElementById("meetups-list");if(!n)return;const e=new Date().toISOString().slice(0,10),t=m.meetups.filter(r=>r.date>=e);if(!t.length){n.innerHTML='<div class="empty"><div class="empty-icon">🏹</div>Ingen planlagte skydninger endnu</div>';return}n.innerHTML="",t.forEach(r=>n.appendChild(BR(r)))}function BR(n){var u;const e=document.createElement("div");e.className="meetup-card"+(n.status==="aflyst"?" meetup-cancelled":"");const t=n.creatorUid===((u=m.user)==null?void 0:u.uid),r=(n.participants||[]).find(h=>{var p;return h.uid===((p=m.user)==null?void 0:p.uid)}),s=m.isSuperAdmin&&!t&&!r,i=(n.participants||[]).map(h=>{const p=h.status==="foreslået"&&h.proposedDate?` → ${K(Cc(h.proposedDate))} ${K(h.proposedTime||"")}`:"";return`<div class="meetup-partrow"><span>${K(h.name)}</span><span class="meetup-status meetup-status-${K(h.status)}">${K(MR[h.status]||h.status)}${p}</span></div>`}).join(""),o=(n.comments||[]).map(h=>`<div class="meetup-comment"><b>${K(h.name)}:</b> ${K(h.text)}</div>`).join("");let c="";n.status!=="aflyst"&&(r&&(r.status!=="tilmeldt"&&(c+=`<button class="btn btn-gold btn-sm" onclick="joinMeetup('${n.id}')">Tilmeld</button>`),c+=`<button class="btn btn-dark btn-sm" onclick="openProposeTimeModal('${n.id}')">Foreslå andet tidspunkt</button>`,r.status!=="afvist"&&(c+=`<button class="btn btn-dark btn-sm" onclick="declineMeetup('${n.id}')">Afbud</button>`)),t&&((n.participants||[]).filter(h=>h.status==="foreslået"&&h.proposedDate).forEach(h=>{c+=`<button class="btn btn-gold btn-sm" onclick="acceptProposedTime('${n.id}','${h.uid}')">Accepter ${K(Cc(h.proposedDate))} ${K(h.proposedTime||"")} (${K(h.name)})</button>`}),c+=`<button class="btn btn-dark btn-sm" onclick="openEditMeetupModal('${n.id}')">Rediger tidspunkt</button>`,c+=`<button class="btn btn-dark btn-sm" onclick="cancelMeetup('${n.id}')">Aflys</button>`,c+=`<button class="btn btn-red btn-sm" onclick="deleteMeetup('${n.id}')">Slet</button>`)),e.innerHTML=`
    ...
    <div class="meetup-head">
      ...
      <div class="meetup-when">${K(Cc(n.date))} kl. ${K(n.time)}</div>
  ...
  `;const l=e.querySelector(".meetup-comment-input");return e.querySelector(".meetup-comment-send").addEventListener("click",()=>{$R(n.id,l.value),l.value=""}),e}window.openMeetupModal=function(){if(!m.courses.length){ee("Ingen baner tilgængelige","error");return}Ke=new Map,Wi="venner",ni=null,Nu=null,document.getElementById("mu-course-display").value="",document.getElementById("mu-course-list").classList.add("hidden"),UR(),document.getElementById("mu-date").value="",document.getElementById("mu-time").value="",document.getElementById("mu-comment").value="",document.querySelectorAll(".mu-pool-tab").forEach(n=>n.classList.toggle("active",n.dataset.pool==="venner")),Ji(),za(),document.getElementById("meetup-modal").classList.remove("hidden")};window.toggleMeetupCourseList=function(){document.getElementById("mu-course-list").classList.toggle("hidden")};function UR(){const n=document.getElementById("mu-course-list");n.innerHTML="",m.courses.forEach(e=>{const t=document.createElement("div");t.className="ac-item",t.textContent=e.name||e.yam||"",t.addEventListener("click",()=>{Nu=e.id,document.getElementById("mu-course-display").value=e.name||e.yam||"",n.classList.add("hidden")}),n.appendChild(t)})}window.toggleMeetupPool=function(n){Wi=n,document.querySelectorAll(".mu-pool-tab").forEach(e=>e.classList.toggle("active",e.dataset.pool===n)),Ji()};async function dl(){if(!ni)try{ni=(await nt(Ge(X,"users"))).docs.map(e=>({uid:e.id,name:e.data().name||e.data().yam||e.data().email||"—"}))}catch(n){console.warn(n),ni=[]}return ni}async function V_(){if(Wi==="venner"){const e=new Set((await dl()).map(t=>t.uid));return m.friends.map(t=>({uid:t.id,name:t.name,registered:e.has(t.id)})).sort((t,r)=>t.name.localeCompare(r.name,"da"))}return(await dl()).filter(e=>{var t;return e.uid!==((t=m.user)==null?void 0:t.uid)}).map(e=>({...e,registered:!0})).sort((e,t)=>e.name.localeCompare(t.name,"da"))}async function Ji(){const n=document.getElementById("mu-invitee-list");if(!n)return;const e=await V_();if(n.innerHTML="",!e.length){n.innerHTML=`<div class="empty"><div class="empty-icon">👤</div>${Wi==="venner"?"Du har ingen venner endnu":"Ingen andre registrerede brugere"}</div>`;return}e.forEach(t=>{const r=document.createElement("label");r.className="mu-invitee-row"+(t.registered===!1?" mu-invitee-unregistered":"");const s=document.createElement("input");s.type="checkbox",s.checked=Ke.has(t.uid);const i=document.createElement("span");if(i.textContent=t.name,r.appendChild(s),r.appendChild(i),t.registered===!1){s.disabled=!0;const o=document.createElement("span");o.className="mu-invitee-note",o.textContent="ikke registreret i appen",r.appendChild(o)}else s.addEventListener("change",()=>L_(t.uid,t.name));n.appendChild(r)})}function L_(n,e){Ke.has(n)?Ke.delete(n):Ke.set(n,{uid:n,name:e}),za(),Ji()}window.toggleSelectAllMeetup=async function(){const n=(await V_()).filter(t=>t.registered!==!1);if(!n.length)return;n.every(t=>Ke.has(t.uid))?n.forEach(t=>Ke.delete(t.uid)):n.forEach(t=>Ke.set(t.uid,t)),za(),Ji()};function za(){const n=document.getElementById("mu-selected-chips");if(n){if(n.innerHTML="",!Ke.size){n.innerHTML='<div class="mu-chips-empty">Ingen modtagere valgt endnu</div>';return}[...Ke.values()].forEach(e=>{const t=document.createElement("div");t.className="pchip";const r=document.createElement("span");r.className="pchip-name",r.textContent=e.name;const s=document.createElement("button");s.className="pchip-rm",s.textContent="✕",s.addEventListener("click",()=>L_(e.uid,e.name)),t.appendChild(r),t.appendChild(s),n.appendChild(t)})}}window.saveMeetup=async function(){var p,_;const n=m.courses.find(v=>v.id===Nu),e=document.getElementById("mu-date").value,t=document.getElementById("mu-time").value;if(!n){ee("Vælg en bane","error");return}if(!e||!t){ee("Vælg dato og tid","error");return}if(!Ke.size){ee("Vælg mindst én modtager","error");return}const r=new Set((await dl()).map(v=>v.uid)),s=[...Ke.values()].filter(v=>!r.has(v.uid)).map(v=>v.name);if(s.length&&(s.forEach(v=>{const A=[...Ke.entries()].find(([,D])=>D.name===v);A&&Ke.delete(A[0])}),ee(`${s.join(", ")} er ikke registreret i appen og blev ikke inviteret`,"error"),za(),Ji(),!Ke.size))return;const i=document.getElementById("mu-comment").value.trim().slice(0,300),o=[...Ke.keys()],c=[...Ke.values()].map(v=>({uid:v.uid,name:v.name,status:"afventer",proposedDate:null,proposedTime:null})),l=i?[{uid:m.user.uid,name:((p=m.profile)==null?void 0:p.name)||"—",text:i,createdAt:new Date}]:[],u=new Date(`${e}T${t}`);u.setDate(u.getDate()+1);const h={courseId:n.id,courseName:n.name||n.yam||"",date:e,time:t,creatorUid:m.user.uid,creatorName:((_=m.profile)==null?void 0:_.name)||"—",pool:Wi,invitedUids:o,participants:c,comments:l,status:"åben",createdAt:mt(),updatedAt:mt(),expireAt:u};try{await Ag(Ge(X,"meetups"),h),document.getElementById("meetup-modal").classList.add("hidden"),ee("Forslag sendt","success"),await xu(),Vt(),Qi()}catch(v){ee("Fejl: "+v.message,"error")}};async function M_(n,e){const t=m.meetups.find(s=>s.id===n);if(!t||!m.user)return;const r=(t.participants||[]).map(s=>s.uid===m.user.uid?{...s,status:e,proposedDate:null,proposedTime:null}:s);try{await st(oe(X,"meetups",t.id),{participants:r,updatedAt:mt()}),t.participants=r,t.updatedAt=Date.now(),Vt()}catch(s){ee("Fejl: "+s.message,"error")}}window.joinMeetup=function(n){M_(n,"tilmeldt")};window.declineMeetup=function(n){M_(n,"afvist")};window.openProposeTimeModal=function(n){N_=n,document.getElementById("mu-propose-date").value="",document.getElementById("mu-propose-time").value="",document.getElementById("meetup-propose-modal").classList.remove("hidden")};window.saveProposeTime=async function(){const n=document.getElementById("mu-propose-date").value,e=document.getElementById("mu-propose-time").value;if(!n||!e){ee("Vælg dato og tid","error");return}const t=m.meetups.find(s=>s.id===N_);if(!t||!m.user)return;const r=(t.participants||[]).map(s=>s.uid===m.user.uid?{...s,status:"foreslået",proposedDate:n,proposedTime:e}:s);try{await st(oe(X,"meetups",t.id),{participants:r,updatedAt:mt()}),t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-propose-modal").classList.add("hidden"),Vt()}catch(s){ee("Fejl: "+s.message,"error")}};window.acceptProposedTime=async function(n,e){var c;const t=m.meetups.find(l=>l.id===n);if(!t||t.creatorUid!==((c=m.user)==null?void 0:c.uid))return;const r=(t.participants||[]).find(l=>l.uid===e);if(!(r!=null&&r.proposedDate)||!(r!=null&&r.proposedTime))return;const s=r.proposedDate,i=r.proposedTime,o=t.participants.map(l=>l.uid===e?{...l,status:"tilmeldt",proposedDate:null,proposedTime:null}:{...l,status:"afventer",proposedDate:null,proposedTime:null});try{await st(oe(X,"meetups",t.id),{date:s,time:i,participants:o,updatedAt:mt()}),t.date=s,t.time=i,t.participants=o,t.updatedAt=Date.now(),Vt(),ee("Nyt tidspunkt accepteret","success")}catch(l){ee("Fejl: "+l.message,"error")}};window.openEditMeetupModal=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||(x_=n,document.getElementById("mu-edit-date").value=e.date,document.getElementById("mu-edit-time").value=e.time,document.getElementById("meetup-edit-modal").classList.remove("hidden"))};window.saveEditMeetup=async function(){var s;const n=document.getElementById("mu-edit-date").value,e=document.getElementById("mu-edit-time").value;if(!n||!e){ee("Vælg dato og tid","error");return}const t=m.meetups.find(i=>i.id===x_);if(!t||t.creatorUid!==((s=m.user)==null?void 0:s.uid))return;const r=(t.participants||[]).map(i=>({...i,status:"afventer",proposedDate:null,proposedTime:null}));try{await st(oe(X,"meetups",t.id),{date:n,time:e,participants:r,updatedAt:mt()}),t.date=n,t.time=e,t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-edit-modal").classList.add("hidden"),Vt(),ee("Tidspunkt opdateret","success")}catch(i){ee("Fejl: "+i.message,"error")}};window.cancelMeetup=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||Ts("Aflys denne skydning?",async()=>{try{await st(oe(X,"meetups",e.id),{status:"aflyst",updatedAt:mt()}),e.status="aflyst",e.updatedAt=Date.now(),Vt()}catch(r){ee("Fejl: "+r.message,"error")}})};window.deleteMeetup=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||Ts("Slet denne skydning permanent? Det kan ikke fortrydes.",async()=>{try{await Qt(oe(X,"meetups",e.id)),m.meetups=m.meetups.filter(r=>r.id!==n),Vt(),Qi()}catch(r){ee("Fejl: "+r.message,"error")}})};async function $R(n,e){var i;if(e=(e||"").trim().slice(0,300),!e||!m.user)return;const t=m.meetups.find(o=>o.id===n);if(!t)return;const r={uid:m.user.uid,name:((i=m.profile)==null?void 0:i.name)||"—",text:e,createdAt:new Date},s=[...t.comments||[],r];try{await st(oe(X,"meetups",t.id),{comments:s,updatedAt:mt()}),t.comments=s,t.updatedAt=Date.now(),Vt()}catch(o){ee("Fejl: "+o.message,"error")}}const jR="BOJHqC2HeXd9Ru6EjuL7HEuAZuZ2MM86LPqPfVbeQsm8M8-wgT_u3QPWYFs0XN0vfMz_FS3rDgjXgCXXm0GkmZs",qR="/3D/sw.js";async function O_(){if(!("serviceWorker"in navigator))return null;try{return await navigator.serviceWorker.register(qR,{scope:"/3D/3D-dev/"})}catch(n){return console.warn("SW-registrering fejlede",n),null}}function KR(){return"Notification"in window&&Notification.permission==="default"}async function F_(){let n;try{n=await Notification.requestPermission()}catch(e){return console.warn("Notification.requestPermission fejlede",e),ee("Kunne ikke bede om tilladelse: "+e.message,"error"),!1}if(n==="denied")return ee("Notifikationer blokeret i browseren — skal ændres i browserens side-indstillinger","error"),!1;if(n!=="granted")return!1;try{if(!await v_||!Di)return ee("Push-notifikationer understøttes ikke i denne browser","error"),!1;const t=await O_();if(!t)return ee("Kunne ikke registrere service worker","error"),!1;const r=await aR(Di,{vapidKey:jR,serviceWorkerRegistration:t});return r?(await st(oe(X,"users",m.user.uid),{fcmToken:r}),!0):(ee("Kunne ikke hente push-token","error"),!1)}catch(e){return console.warn("Push-opsætning fejlede",e),ee("Push-fejl: "+e.message,"error"),!1}}function GR(){"Notification"in window&&Notification.permission==="granted"&&F_()}function zR(){v_.then(n=>{!n||!Di||cR(Di,e=>{const t=e.data||{};ee(t.body||"Ny besked","info"),xu().then(()=>{Vt(),Qi()}).catch(()=>{})})})}function Ef(n,e){var q;const t=H=>{var j;return H.shooters.find(E=>E.id===e)||((j=H.shooters)==null?void 0:j[0])},r=n.map(H=>{const j=t(H);return j?tt(j.scores):null}).filter(H=>H!==null);let s=0,i=0,o=0,c=0,l=0;const u={11:0,10:0,8:0,5:0,M:0},h={11:0,10:0,8:0,5:0,M:0},p={11:0,10:0,8:0,5:0,M:0};n.forEach(H=>{const j=t(H);j&&(j.scores.forEach(E=>{E.forEach(y=>{y!=null&&(y==="M"?p.M++:p[Number(y)]=(p[Number(y)]||0)+1)})}),!(Jt(H.ruleset)<2)&&(l++,j.scores.forEach(E=>{E[0]!=null&&(E[0]==="M"?(u.M++,i++):(u[Number(E[0])]=(u[Number(E[0])]||0)+1,s+=Number(E[0]),i++)),E[1]!=null&&(E[1]==="M"?(h.M++,c++):(h[Number(E[1])]=(h[Number(E[1])]||0)+1,o+=Number(E[1]),c++))})))});const _=i?(s/i).toFixed(2):0,v=c?(o/c).toFixed(2):0,A=i+c?((s+o)/(i+c)).toFixed(2):0,D=((q=n[0])==null?void 0:q.numTargets)||24,V=Array.from({length:D},(H,j)=>{let E=0,y=0;return n.forEach(I=>{const T=t(I);if(!T)return;(T.scores[j]||[null,null]).forEach(R=>{R!=null&&(E+=Oe(R),y++)})}),y?E/y:null}).map((H,j)=>({v:H,i:j})).filter(H=>H.v!==null),F=V.length?V.reduce((H,j)=>H.v>j.v?H:j):null,B=V.length?V.reduce((H,j)=>H.v<j.v?H:j):null;return{myScores:r,p1avg:_,p2avg:v,pilAvg:A,distP1:u,distP2:h,distAll:p,bestTarget:F,worstTarget:B,waRoundCount:l}}function Tf(n){if(!n.length)return 0;const e=n.reduce((t,r)=>t+r,0)/n.length;return Math.sqrt(n.reduce((t,r)=>t+(r-e)**2,0)/n.length)}function HR(n){var l;const e=n.length;if(e<2)return{slope:0,intercept:((l=n[0])==null?void 0:l.y)||0};const t=n.reduce((u,h)=>u+h.x,0),r=n.reduce((u,h)=>u+h.y,0),s=n.reduce((u,h)=>u+h.x*h.y,0),i=n.reduce((u,h)=>u+h.x*h.x,0),o=e*i-t*t,c=o?(e*s-t*r)/o:0;return{slope:c,intercept:(r-c*t)/e}}function WR(n,e){var o,c;const t=((o=n.shooters)==null?void 0:o.find(l=>l.id===e))||((c=n.shooters)==null?void 0:c[0]);if(!t)return[];const r=n.numTargets||24,s=n.traversalOrder||Array.from({length:r},(l,u)=>u),i=[];for(let l=0;l<r;l++){const u=s[l];if(u===void 0)continue;const h=t.scores[u]||[null,null];let p=0,_=0;h.forEach(v=>{v!=null&&(p+=Oe(v),_++)}),_&&i.push(p/_)}return i}function QR(n,e){let t=1,r=0,s=0,i=0,o=1,c=0,l=0,u=0,h=0,p=0,_=0,v=0,A=0;const D=()=>{e.style.transformOrigin="0 0",e.style.transform=t>1?`translate(${r}px,${s}px) scale(${t})`:""};n.addEventListener("touchstart",V=>{if(V.preventDefault(),V.touches.length===2){const F=V.touches,B=n.getBoundingClientRect();i=Math.hypot(F[0].clientX-F[1].clientX,F[0].clientY-F[1].clientY),o=t,c=r,l=s,u=(F[0].clientX+F[1].clientX)/2-B.left,h=(F[0].clientY+F[1].clientY)/2-B.top}else V.touches.length===1&&(p=V.touches[0].clientX,_=V.touches[0].clientY,v=r,A=s)},{passive:!1}),n.addEventListener("touchmove",V=>{if(V.preventDefault(),V.touches.length===2){const F=V.touches,B=Math.hypot(F[0].clientX-F[1].clientX,F[0].clientY-F[1].clientY),q=Math.min(8,Math.max(1,o*B/i)),H=(u-c)/o,j=(h-l)/o;r=u-H*q,s=h-j*q,t=q,D()}else V.touches.length===1&&t>1&&(r=v+V.touches[0].clientX-p,s=A+V.touches[0].clientY-_,D())},{passive:!1}),n.addEventListener("touchend",()=>{t<1.05&&(t=1,r=0,s=0,D())},{passive:!0});let C=0;n.addEventListener("touchend",()=>{const V=Date.now();V-C<300&&(t=1,r=0,s=0,D()),C=V},{passive:!0})}let $t=null,or=null;function JR(){const n=document.getElementById("graph-fs");n&&n.classList.add("hidden"),$t&&(window.removeEventListener("resize",$t),window.removeEventListener("orientationchange",$t),$t=null),or&&(document.removeEventListener("gesturestart",or),or=null)}window.closeGraphFs=JR;function YR(n){m.pendingAnalyseRound=n,document.getElementById("analyse-filter").value="specific",window.switchTab("analyse")}window.analyseRound=YR;function XR(n,e,t,r){const s=["11","10","8","5","M"],i={11:"#1a7a3a",10:"#1a5aaa",8:"#d4700a",5:"#7a3aaa",M:"#cc3333"},o=n.myScores[0]||0,c=t.myScores[0]||0,l=Math.abs(o-c),u='<div class="cmp-sep"></div>',h=(v,A,D)=>`<div style="font-size:11px;color:${D};margin-bottom:4px;">${K(A)}</div>
  ...
  </div>`,_}window.renderAnalyse=function(){var Hn,Wn,Lr,Mr,Or,Fr,Ps,Yi,Xi,Cs,Br;const n=document.getElementById("analyse-content");if(!n)return;const e=document.getElementById("analyse-bane");if(e&&e.options.length<=1&&[...new Set(m.rounds.map(U=>U.courseId).filter(Boolean))].forEach(U=>{const J=m.courses.find(W=>W.id===U);if(J&&!Array.from(e.options).find(W=>W.value===U)){const W=document.createElement("option");W.value=U,W.textContent=J.name,e.appendChild(W)}}),m.pendingAnalyseRound&&e){const L=m.rounds.find(U=>U.id===m.pendingAnalyseRound);L!=null&&L.courseId&&Array.from(e.options).some(U=>U.value===L.courseId)&&(e.value=L.courseId)}const t=((Hn=document.getElementById("analyse-filter"))==null?void 0:Hn.value)||"all",r=t==="all"?0:t==="lastround"?1:t==="specific"?0:Number(t),s=((Wn=document.getElementById("analyse-bane"))==null?void 0:Wn.value)||"all",i=Number((Lr=document.getElementById("analyse-antal"))==null?void 0:Lr.value)||0,o=document.getElementById("analyse-runde-wrap"),c=document.getElementById("analyse-runde"),l=document.getElementById("analyse-runde-wrap-2"),u=document.getElementById("analyse-runde-2"),h=document.getElementById("analyse-runde-lbl"),p=t==="compare";o&&(o.style.display=t==="specific"||p?"":"none"),l&&(l.style.display=p?"":"none"),h&&(h.style.display=p?"":"none");const _=L=>{const U=L.created;return U!=null&&U.toDate?U.toDate().toLocaleDateString("da-DK"):U!=null&&U.seconds?new Date(U.seconds*1e3).toLocaleDateString("da-DK"):typeof U=="number"?new Date(U).toLocaleDateString("da-DK"):"—"},v=(L,U)=>{const J=s==="all"?m.rounds:m.rounds.filter(Y=>Y.courseId===s),W=L.value;L.innerHTML=`<option value="">${U}</option>`,J.forEach(Y=>{const te=document.createElement("option");te.value=Y.id,te.textContent=`${_(Y)} — ${Y.name||"Runde"}`,L.appendChild(te)}),J.some(Y=>Y.id===W)&&(L.value=W)};if((t==="specific"||p)&&c&&(v(c,"Vælg runde..."),m.pendingAnalyseRound&&(c.value=m.pendingAnalyseRound,m.pendingAnalyseRound=null)),p&&u&&v(u,"Vælg runde 2..."),p){const L=c==null?void 0:c.value,U=u==null?void 0:u.value;if(!L||!U){n.innerHTML='<div class="empty"><div class="empty-icon">📊</div>Vælg to runder ovenfor</div>';return}const J=m.rounds.map(ue=>({...ue,shooters:(ue.shooters||[]).map(ge=>({...ge,scores:Tr(ge.scores)}))})),W=J.find(ue=>ue.id===L),Y=J.find(ue=>ue.id===U);if(!W||!Y){n.innerHTML='<div class="empty">Kunne ikke finde runderne</div>';return}const te=`${W.name||"Runde"} (${_(W)})`,se=`${Y.name||"Runde"} (${_(Y)})`;n.innerHTML=XR(Ef([W],(Mr=m.user)==null?void 0:Mr.uid),te,Ef([Y],(Or=m.user)==null?void 0:Or.uid),se);return}const A=m.rounds.map(L=>({...L,shooters:(L.shooters||[]).map(U=>({...U,scores:Tr(U.scores)}))})),D=((Fr=document.getElementById("analyse-completed-only"))==null?void 0:Fr.checked)||!1,C=((Ps=document.getElementById("analyse-startat1-only"))==null?void 0:Ps.checked)||!1,V=L=>{var W,Y;const U=((W=L.shooters)==null?void 0:W.find(te=>{var se;return te.id===((se=m.user)==null?void 0:se.uid)}))||((Y=L.shooters)==null?void 0:Y[0]);if(!U)return!1;const J=L.numTargets||24;for(let te=0;te<J;te++){const se=U.scores[te]||[null,null];if(se[0]==null&&se[1]==null)return!1}return!0},F=L=>L.startTarget===1,B=((Yi=document.getElementById("analyse-ruleset"))==null?void 0:Yi.value)||"all";let q=s==="all"?A:A.filter(L=>L.courseId===s);if(B!=="all"&&(q=q.filter(L=>(L.ruleset||"WA")===B)),D&&(q=q.filter(V)),C&&(q=q.filter(F)),t==="specific"){const L=c==null?void 0:c.value;q=L?q.filter(U=>U.id===L):[]}const H=i||r,j=H&&t!=="specific"?q.slice(0,H):q;if(!j.length){n.innerHTML='<div class="empty"><div class="empty-icon">📈</div>Ingen runder endnu</div>';return}const E=L=>{var U;return L.shooters.find(J=>{var W;return J.id===((W=m.user)==null?void 0:W.uid)})||((U=L.shooters)==null?void 0:U[0])},y=j.map(L=>{const U=E(L);return U?tt(U.scores):null}).filter(L=>L!==null),I=y.length?(y.reduce((L,U)=>L+U,0)/y.length).toFixed(1):0,T=y.length?Math.max(...y):0,b=y.length?Math.min(...y):0;let R=0,w=0,gt=0,Et=0,Ss=0;const Lt={11:0,10:0,8:0,5:0,M:0},Mt={11:0,10:0,8:0,5:0,M:0};j.forEach(L=>{const U=E(L);U&&(Jt(L.ruleset)<2||(Ss++,U.scores.forEach(J=>{J[0]!=null&&(J[0]==="M"?(Lt.M++,w++):(Lt[Number(J[0])]=(Lt[Number(J[0])]||0)+1,R+=Number(J[0]),w++)),J[1]!=null&&(J[1]==="M"?(Mt.M++,Et++):(Mt[Number(J[1])]=(Mt[Number(J[1])]||0)+1,gt+=Number(J[1]),Et++))})))});const zn=w?(R/w).toFixed(2):0,Dr=Et?(gt/Et).toFixed(2):0,Rs=w+Et?((R+gt)/(w+Et)).toFixed(2):0,Ve=((Xi=j[0])==null?void 0:Xi.numTargets)||24,Me=Array.from({length:Ve},(L,U)=>{let J=0,W=0;return j.forEach(Y=>{const te=E(Y);if(!te)return;const ue=(Y.traversalOrder||Array.from({length:Y.numTargets||Ve},(ye,it)=>it))[U];if(ue===void 0)return;(te.scores[ue]||[null,null]).forEach(ye=>{ye!=null&&(J+=Oe(ye),W++)})}),W?J/W:null}),Nr=Me.map((L,U)=>({v:L,i:U})).filter(L=>L.v!==null),Ot=Nr.length?Nr.reduce((L,U)=>L.v>U.v?L:U):null,xr=Nr.length?Nr.reduce((L,U)=>L.v<U.v?L:U):null,Vr=["11","10","8","5","M"];let ze="";if(ze+=`<div class="stats-grid2">
  ...
  </details>`,ze+=`<div class="card card-mb16">
    <div class="section-title-mb8">PIL STATISTIK</div>
    ${Ss?`<div class="cmp-pil-grid">
      <div><div class="stat-lbl">PIL 1</div><div class="stat-val-22">${zn}</div></div>
      <div class="cmp-pil-mid">
    ...
    <div class="pil-best-note">
      ${Number(zn)>Number(Dr)?"Bedst med PIL 1 🏹":Number(Dr)>Number(zn)?"Bedst med PIL 2 🏹":"Begge pile er lige gode 🎯"}
    </div>`:'<div class="pil-best-note">Ikke relevant — ingen WA-runder i dette udvalg</div>'}
  </div>`,Ot&&xr&&Ot.i!==xr.i&&(ze+=`<div class="card card-mb16">
    ...
    <div class="section-title-mb12">FORDELING PR. SCOREZONE</div>`,Ss?(ze+='<div class="pie-grid">',Vr.forEach(L=>{const U=Lt[L]||0,J=Mt[L]||0,W=U+J,Y=30;let te="";if(W===0)te=`<circle cx="${Y}" cy="${Y}" r="${Y}" fill="var(--surface2)"/>`;else if(J===0)te=`<circle cx="${Y}" cy="${Y}" r="${Y}" fill="#ffd700"/>`;else if(U===0)te=`<circle cx="${Y}" cy="${Y}" r="${Y}" fill="#00cc44"/>`;else{const se=U/W,ue=se*2*Math.PI,ge=Y,ye=0,it=Y-Y*Math.sin(ue),Ae=Y-Y*Math.cos(ue),ke=ue>Math.PI?1:0;te=`<path d="M${Y},${Y} L${ge},${ye} A${Y},${Y} 0 ${ke},0 ${it},${Ae} Z" fill="#ffd700"/>
             <path d="M${Y},${Y} L${it},${Ae} A${Y},${Y} 0 ${1-ke},0 ${ge},${ye} Z" fill="#00cc44"/>`}ze+=`<div class="pie-cell">
      ...
      </div>`):ze+='<div class="pil-best-note">Ikke relevant — ingen WA-runder i dette udvalg</div>',ze+="</div>",y.length>1){const W=Math.min(...y)-5,Y=Math.max(...y)+5,te=y.slice().reverse().map((se,ue)=>{const ge=30+ue/(y.length-1)*280,ye=90-(se-W)/(Y-W)*(120-2*30);return`${ge},${ye}`}).join(" ");ze+=`<div class="card card-mb16">
      ...
      <svg viewBox="0 0 340 120" class="graph-svg">
        ...
        ${y.slice().reverse().map((se,ue)=>{const ge=30+ue/(y.length-1)*280,ye=90-(se-W)/(Y-W)*(120-2*30);return`<circle cx="${ge}" cy="${ye}" r="4" fill="var(--acc)"/><text x="${ge}" y="${ye-8}" text-anchor="middle" font-size="10" fill="var(--text)">${se}</text>`}).join("")}
    ...
    </div>`}const Yt=Me.map((L,U)=>({v:L,i:U})).filter(L=>L.v!==null);if(Yt.length>1){const{slope:se,intercept:ue}=HR(Yt.map(({v:De,i:He})=>({x:He,y:De}))),ge=[ue,ue+se*(Ve-1)],ye=Math.floor(Math.min(...Yt.map(De=>De.v),...ge)),it=Math.ceil(Math.max(...Yt.map(De=>De.v),...ge)),Ae=it-ye||1,ke=[];for(let De=ye;De<=it;De++)(it-ye<=6||De%Math.ceil((it-ye)/5)===0)&&ke.push(De);const Ft=Tf(Yt.map(De=>De.v)),Tt=(De,He,{dotR:Zt=3,valFont:bt=9,showVals:Bt=!1}={})=>{const We=Ee=>42+(Ve>1?Ee/(Ve-1)*(De-42-15):0),$e=Ee=>15+(He-15-25)*(1-(Ee-ye)/Ae),At=Yt.map(({v:Ee,i:vn})=>We(vn)+","+$e(Ee)).join(" "),yn=ke.map(Ee=>`<line x1="38" y1="${$e(Ee)}" x2="42" y2="${$e(Ee)}" stroke="var(--muted)" stroke-width="1" pointer-events="none"/><text x="36" y="${$e(Ee)+4}" text-anchor="end" font-size="9" fill="var(--muted)" pointer-events="none">${Ee}</text><line x1="42" y1="${$e(Ee)}" x2="${De-15}" y2="${$e(Ee)}" stroke="var(--surface2)" stroke-width="0.5" stroke-dasharray="3,3" pointer-events="none"/>`).join(""),en=Yt.map(({v:Ee,i:vn})=>Bt?`<circle cx="${We(vn)}" cy="${$e(Ee)}" r="${Zt}" fill="var(--acc)" pointer-events="none"/><text x="${We(vn)}" y="${$e(Ee)-Zt-5}" text-anchor="middle" font-size="${bt}" fill="#fff" pointer-events="none">${Ee.toFixed(1)}</text>`:`<circle cx="${We(vn)}" cy="${$e(Ee)}" r="${Zt}" fill="var(--acc)" pointer-events="none"/>`).join(""),Zi=`<line x1="${We(0)}" y1="${$e(ue)}" x2="${We(Ve-1)}" y2="${$e(ue+se*(Ve-1))}" stroke="#f0c030" stroke-width="1.5" stroke-dasharray="6,4" pointer-events="none"/>`;return`<line x1="42" y1="15" x2="42" y2="${He-25}" stroke="var(--surface2)" stroke-width="1" pointer-events="none"/>
        <line x1="42" y1="${He-25}" x2="${De-15}" y2="${He-25}" stroke="var(--surface2)" stroke-width="1" pointer-events="none"/>
        ${yn}
        <polyline points="${At}" fill="none" stroke="var(--acc)" stroke-width="2" stroke-linejoin="round" pointer-events="none"/>
        ${Zi}
        ${en}
        <text x="42" y="${He-5}" font-size="9" fill="var(--muted)" pointer-events="none">1</text>
        <text x="${We(Ve-1)}" y="${He-5}" text-anchor="end" font-size="9" fill="var(--muted)" pointer-events="none">${Ve}</text>`},Xt=Math.max(340,Ve*30);ze+=`<div class="card card-mb16">
    ...
    <div class="card card-mb16">
      ...
      <div class="spredning-row">
        <div class="stat-val-28">${Ft.toFixed(2)}</div>
    ...
    <div id="graph-fs" class="fs-ov hidden graph-fs-overlay" onclick="window.closeGraphFs()">
      <div class="graph-fs-box" id="graph-fs-box" onclick="event.stopPropagation()">
        ...
        <div id="graph-fs-viewport" class="graph-fs-viewport">
          <svg id="graph-fs-svg" viewBox="0 0 ${Xt} 160" class="graph-fs-svg">${Tt(Xt,160,{dotR:5,valFont:10,showVals:!0})}</svg>
        </div>
        <button class="btn btn-dark graph-fs-close-btn" onclick="window.closeGraphFs()">Luk</button>
      </div>
    </div>`,window.openGraphFs=function(){const De=document.getElementById("graph-fs");if(!De)return;De.classList.remove("hidden");const He=document.getElementById("graph-fs-svg"),Zt=document.getElementById("graph-fs-box"),bt=document.getElementById("graph-fs-viewport"),Bt=()=>{const We=Math.min(window.innerWidth*.96,900),$e=Math.min(window.innerHeight*.9,700),At=Math.max(200,We-32),yn=Math.max(140,$e-90),en=Math.max(At,Ve*30);He.setAttribute("viewBox",`0 0 ${en} ${yn}`),He.innerHTML=Tt(en,yn,{dotR:5,valFont:10,showVals:!0}),Zt&&(Zt.style.width=We+"px"),bt&&(bt.style.width=At+"px",bt.style.height=yn+"px")};Bt(),$t&&(window.removeEventListener("resize",$t),window.removeEventListener("orientationchange",$t)),$t=Bt,window.addEventListener("resize",$t),window.addEventListener("orientationchange",$t),or&&document.removeEventListener("gesturestart",or),or=We=>We.preventDefault(),document.addEventListener("gesturestart",or,{passive:!1}),bt&&!bt.dataset.pinchInit&&(QR(bt,He),bt.dataset.pinchInit="1")}}if(s!=="all"){const L=J=>{const W=J.created;return W!=null&&W.toDate?W.toDate().getTime():W!=null&&W.seconds?W.seconds*1e3:typeof W=="number"?W:0},U=A.filter(J=>J.courseId===s).filter(J=>!D||V(J)).filter(J=>!C||F(J)).map(J=>{var Y;const W=WR(J,(Y=m.user)==null?void 0:Y.uid);return W.length>1?{t:L(J),cv:Tf(W)}:null}).filter(Boolean).sort((J,W)=>J.t-W.t);if(U.length>1){const te=U.map(ke=>ke.cv),se=Math.min(...te),ue=Math.max(...te),ge=ue-se||1,ye=(ke,Ft)=>({x:30+Ft/(U.length-1)*(340-2*30),y:90-(ke.cv-se)/ge*(120-2*30)}),it=U.map((ke,Ft)=>{const{x:Tt,y:Xt}=ye(ke,Ft);return`${Tt},${Xt}`}).join(" "),Ae=U.map((ke,Ft)=>{const{x:Tt,y:Xt}=ye(ke,Ft);return`<circle cx="${Tt}" cy="${Xt}" r="4" fill="#f0c030"/><text x="${Tt}" y="${Xt-8}" text-anchor="middle" font-size="10" fill="var(--text)">${ke.cv.toFixed(2)}</text>`}).join("");ze+=`<div class="card card-mb16">
      ...
      </div>`}}if(n.innerHTML=ze,s!=="all"&&((Cs=m.profile)!=null&&Cs.kon)&&((Br=m.profile)!=null&&Br.bueklasse)){const L=m.profile.kon==="herre"?"Herre":"Dame",U={langbue:"Langbue",trad:"Traditionel",recurve:"Recurve",compound:"Compound",barbue:"Barbue",buejæger:"Buejæger","trad-buejæger":"Trad. buejæger",rytterbue:"Rytterbue"}[m.profile.bueklasse]||m.profile.bueklasse,J=document.createElement("div");J.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${L} ${U}</div><div class="comp-loading-msg">Henter...</div></div>`,n.appendChild(J),nt(Ge(X,"bane_stats",s,"runder")).then(W=>{const te=W.docs.map(Ae=>Ae.data()).filter(Ae=>Ae.kon===m.profile.kon&&Ae.bueklasse===m.profile.bueklasse);if(!te.length){J.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${L} ${U}</div><div class="comp-loading-msg">Ingen andre ${L} ${U}-skytter har skudt denne bane endnu.</div></div>`;return}const se=te.filter(Ae=>(Ae.arrowsShot||Ae.numTargets*2)>0),ue=se.length?(se.reduce((Ae,ke)=>Ae+ke.score/(ke.arrowsShot||ke.numTargets*2),0)/se.length).toFixed(2):"—",ge=ue!=="—"?Number(Rs)-Number(ue):null,ye=ge!==null?(ge>0?"+":"")+ge.toFixed(2):"—",it=ge===null?"var(--muted)":ge>0?"#2aaa5a":ge<0?"var(--danger)":"var(--muted)";J.innerHTML=`<div class="card card-mb16">
        ...
        <div class="cmp-pil-grid">
          ...
          <div class="cmp-pil-mid">
            ...
            <div style="font-size:22px;font-weight:700;color:${it};">${ye}</div>
          </div>
