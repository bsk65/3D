 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ow=new ve(U.comparator);function pt(){return Ow}const mm=new ve(U.comparator);function Os(...n){let e=mm;for(const t of n)e=e.insert(t.key,t);return e}function pm(n){let e=mm;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Ot(){return Ws()}function gm(){return Ws()}function Ws(){return new Ln(n=>n.toString(),(n,e)=>n.isEqual(e))}const Fw=new ve(U.comparator),Bw=new ge(U.comparator);function se(...n){let e=Bw;for(const t of n)e=e.add(t);return e}const Uw=new ge(te);function sl(){return Uw}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fl{constructor(){this.Tr=new ge(Be.Er),this.dr=new ge(Be.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Be(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Be(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new U(new me([])),r=new Be(t,e),s=new Be(t,e+1),i=[];return this.dr.forEachInRange([r,s],o=>{this.Vr(o),i.push(o.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new U(new me([])),r=new Be(t,e),s=new Be(t,e+1);let i=se();return this.dr.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const t=new Be(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Be{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return U.comparator(e.key,t.key)||te(e.wr,t.wr)}static Ar(e,t){return te(e.wr,t.wr)||U.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kb(n,e,t){let r=1,s=null,i=null,o=!1,c=0;function l(){return c===2}let d=!1;function f(...D){d||(d=!0,e.apply(null,D))}function m(D){s=setTimeout(()=>{s=null,n(E,l())},D)}function _(){i&&clearTimeout(i)}function E(D,...$){if(d){_();return}if(D){_(),f.call(null,D,...$);return}if(l()||o){_(),f.call(null,D,...$);return}r<64&&(r*=2);let N;c===1?(c=2,N=0):N=(r+Math.random())*1e3,m(N)}let P=!1;function C(D){P||(P=!0,_(),!d&&(s!==null?(D||(c=2),clearTimeout(s),m(0)):D||(c=1)))}return m(0),i=setTimeout(()=>{o=!0,C(!0)},t),C}function Db(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(e,t){this._service=e,t instanceof gt?this._location=t:this._location=gt.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new pr(e,t)}get root(){const e=new gt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Jp(this._location.path)}get storage(){return this._service}get parent(){const e=Qb(this._location.path);if(e===null)return null;const t=new gt(this._location.bucket,e);return new pr(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw Pb(e)}}function hA(n,e,t){n._throwIfRoot("uploadBytes");const r=lA(n.storage,n._location,Yp(),new wn(e,!0),t);return n.storage.makeRequestWithTokens(r,ng).then(s=>({metadata:s,ref:n}))}function fA(n,e,t=St.RAW,r){n._throwIfRoot("uploadString");const s=zp(t,e),i=Object.assign({},r);return i.contentType==null&&s.contentType!=null&&(i.contentType=s.contentType),hA(n,s.data,i)}function mA(n){n._throwIfRoot("getDownloadURL");const e=oA(n.storage,n._location,Yp());return n.storage.makeRequestWithTokens(e,ng).then(t=>{if(t===null)throw Rb();return t})}function pA(n,e){const t=Jb(n._location.path,e),r=new gt(n._location.bucket,t);return new pr(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
(Kræver login med din bruger)`);const s=n.shooters.map(c=>{var l;return(l=p.friends.find(d=>d.id===c.id))==null?void 0:l.email}).filter(Boolean),i="3D Bueskydning - "+n.name,o="mailto:"+s.join(",")+"?subject="+encodeURIComponent(i)+"&body="+encodeURIComponent(t);window.location.href=o};const Ig="archery_meetups_seen",QA={afventer:"Afventer",tilmeldt:"Tilmeldt ✅",foreslået:"Foreslår andet tidspunkt 🕓",afvist:"Afbud ❌"};function ic(n){if(!n)return"";const[e,t,r]=n.split("-");return e&&t&&r?`${r}-${t}-${e}`:n}let vt=new Map,Ni="venner",qs=null,wg=null,Yl=null;async function Eg(){if(p.user)try{const n=[Ze(Qo(je(X,"meetups"),Ys("creatorUid","==",p.user.uid))),Ze(Qo(je(X,"meetups"),Ys("invitedUids","array-contains",p.user.uid)))];p.isSuperAdmin&&n.push(Ze(je(X,"meetups")));const e=await Promise.all(n),t=new Map;e.forEach(r=>r.docs.forEach(s=>t.set(s.id,{id:s.id,...s.data()}))),p.meetups=[...t.values()].sort((r,s)=>`${r.date}${r.time}`.localeCompare(`${s.date}${s.time}`))}catch(n){console.warn("Hent meetups:",n)}}function JA(n,e){return n.filter(t=>{var s,i;return(((i=(s=t.updatedAt)==null?void 0:s.toMillis)==null?void 0:i.call(s))??(typeof t.updatedAt=="number"?t.updatedAt:0))>e}).length}function Xl(){const n=document.getElementById("meetup-badge");if(!n)return;const e=Number(localStorage.getItem(Ig)||0),t=JA(p.meetups,e);n.classList.toggle("hidden",t===0),n.textContent=t}function YA(){localStorage.setItem(Ig,String(Date.now())),Xl()}function On(){const n=document.getElementById("meetups-list");if(!n)return;const e=new Date().toISOString().slice(0,10),t=p.meetups.filter(r=>r.date>=e);if(!t.length){n.innerHTML='<div class="empty"><div class="empty-icon">🏹</div>Ingen planlagte skydninger endnu</div>';return}n.innerHTML="",t.forEach(r=>n.appendChild(XA(r)))}function XA(n){var d;const e=document.createElement("div");e.className="meetup-card"+(n.status==="aflyst"?" meetup-cancelled":"");const t=n.creatorUid===((d=p.user)==null?void 0:d.uid),r=(n.participants||[]).find(f=>{var m;return f.uid===((m=p.user)==null?void 0:m.uid)}),s=p.isSuperAdmin&&!t&&!r,i=(n.participants||[]).map(f=>{const m=f.status==="foreslået"&&f.proposedDate?` → ${K(ic(f.proposedDate))} ${K(f.proposedTime||"")}`:"";return`<div class="meetup-partrow"><span>${K(f.name)}</span><span class="meetup-status meetup-status-${K(f.status)}">${K(QA[f.status]||f.status)}${m}</span></div>`}).join(""),o=(n.comments||[]).map(f=>`<div class="meetup-comment"><b>${K(f.name)}:</b> ${K(f.text)}</div>`).join("");let c="";n.status!=="aflyst"&&(r&&(r.status!=="tilmeldt"&&(c+=`<button class="btn btn-gold btn-sm" onclick="joinMeetup('${n.id}')">Tilmeld</button>`),c+=`<button class="btn btn-dark btn-sm" onclick="openProposeTimeModal('${n.id}')">Foreslå andet tidspunkt</button>`,r.status!=="afvist"&&(c+=`<button class="btn btn-dark btn-sm" onclick="declineMeetup('${n.id}')">Afbud</button>`)),t&&((n.participants||[]).filter(f=>f.status==="foreslået"&&f.proposedDate).forEach(f=>{c+=`<button class="btn btn-gold btn-sm" onclick="acceptProposedTime('${n.id}','${f.uid}')">Accepter ${K(ic(f.proposedDate))} ${K(f.proposedTime||"")} (${K(f.name)})</button>`}),c+=`<button class="btn btn-dark btn-sm" onclick="cancelMeetup('${n.id}')">Aflys</button>`)),e.innerHTML=`
  ...
  `;const l=e.querySelector(".meetup-comment-input");return e.querySelector(".meetup-comment-send").addEventListener("click",()=>{e0(n.id,l.value),l.value=""}),e}window.openMeetupModal=function(){if(!p.courses.length){ne("Ingen baner tilgængelige","error");return}vt=new Map,Ni="venner",qs=null,Yl=null,document.getElementById("mu-course-display").value="",document.getElementById("mu-course-list").classList.add("hidden"),ZA(),document.getElementById("mu-date").value="",document.getElementById("mu-time").value="",document.querySelectorAll(".mu-pool-tab").forEach(n=>n.classList.toggle("active",n.dataset.pool==="venner")),Pa(),Zl(),document.getElementById("meetup-modal").classList.remove("hidden")};window.toggleMeetupCourseList=function(){document.getElementById("mu-course-list").classList.toggle("hidden")};function ZA(){const n=document.getElementById("mu-course-list");n.innerHTML="",p.courses.forEach(e=>{const t=document.createElement("div");t.className="ac-item",t.textContent=e.name||e.yam||"",t.addEventListener("click",()=>{Yl=e.id,document.getElementById("mu-course-display").value=e.name||e.yam||"",n.classList.add("hidden")}),n.appendChild(t)})}window.toggleMeetupPool=function(n){Ni=n,document.querySelectorAll(".mu-pool-tab").forEach(e=>e.classList.toggle("active",e.dataset.pool===n)),Pa()};async function Tg(){if(Ni==="venner")return p.friends.map(n=>({uid:n.id,name:n.name}));if(!qs)try{qs=(await Ze(je(X,"users"))).docs.map(e=>({uid:e.id,name:e.data().name||e.data().yam||e.data().email||"—"}))}catch(n){console.warn(n),qs=[]}return qs.filter(n=>{var e;return n.uid!==((e=p.user)==null?void 0:e.uid)})}async function Pa(){const n=document.getElementById("mu-invitee-list");if(!n)return;const e=await Tg();if(n.innerHTML="",!e.length){n.innerHTML=`<div class="empty"><div class="empty-icon">👤</div>${Ni==="venner"?"Du har ingen venner endnu":"Ingen andre registrerede brugere"}</div>`;return}e.forEach(t=>{const r=document.createElement("label");r.className="mu-invitee-row";const s=document.createElement("input");s.type="checkbox",s.checked=vt.has(t.uid),s.addEventListener("change",()=>bg(t.uid,t.name));const i=document.createElement("span");i.textContent=t.name,r.appendChild(s),r.appendChild(i),n.appendChild(r)})}function bg(n,e){vt.has(n)?vt.delete(n):vt.set(n,{uid:n,name:e}),Zl(),Pa()}window.toggleSelectAllMeetup=async function(){const n=await Tg();if(!n.length)return;n.every(t=>vt.has(t.uid))?n.forEach(t=>vt.delete(t.uid)):n.forEach(t=>vt.set(t.uid,t)),Zl(),Pa()};function Zl(){const n=document.getElementById("mu-selected-chips");if(n){if(n.innerHTML="",!vt.size){n.innerHTML='<div class="mu-chips-empty">Ingen modtagere valgt endnu</div>';return}[...vt.values()].forEach(e=>{const t=document.createElement("div");t.className="pchip";const r=document.createElement("span");r.className="pchip-name",r.textContent=e.name;const s=document.createElement("button");s.className="pchip-rm",s.textContent="✕",s.addEventListener("click",()=>bg(e.uid,e.name)),t.appendChild(r),t.appendChild(s),n.appendChild(t)})}}window.saveMeetup=async function(){var c;const n=p.courses.find(l=>l.id===Yl),e=document.getElementById("mu-date").value,t=document.getElementById("mu-time").value;if(!n){ne("Vælg en bane","error");return}if(!e||!t){ne("Vælg dato og tid","error");return}if(!vt.size){ne("Vælg mindst én modtager","error");return}const r=[...vt.keys()],s=[...vt.values()].map(l=>({uid:l.uid,name:l.name,status:"afventer",proposedDate:null,proposedTime:null})),i=new Date(`${e}T${t}`);i.setDate(i.getDate()+1);const o={courseId:n.id,courseName:n.name||n.yam||"",date:e,time:t,creatorUid:p.user.uid,creatorName:((c=p.profile)==null?void 0:c.name)||"—",pool:Ni,invitedUids:r,participants:s,comments:[],status:"åben",createdAt:yt(),updatedAt:yt(),expireAt:i};try{await Up(je(X,"meetups"),o),document.getElementById("meetup-modal").classList.add("hidden"),ne("Forslag sendt","success"),await Eg(),On(),Xl()}catch(l){ne("Fejl: "+l.message,"error")}};async function Ag(n,e){const t=p.meetups.find(s=>s.id===n);if(!t||!p.user)return;const r=(t.participants||[]).map(s=>s.uid===p.user.uid?{...s,status:e,proposedDate:null,proposedTime:null}:s);try{await ut(le(X,"meetups",t.id),{participants:r,updatedAt:yt()}),t.participants=r,t.updatedAt=Date.now(),On()}catch(s){ne("Fejl: "+s.message,"error")}}window.joinMeetup=function(n){Ag(n,"tilmeldt")};window.declineMeetup=function(n){Ag(n,"afvist")};window.openProposeTimeModal=function(n){wg=n,document.getElementById("mu-propose-date").value="",document.getElementById("mu-propose-time").value="",document.getElementById("meetup-propose-modal").classList.remove("hidden")};window.saveProposeTime=async function(){const n=document.getElementById("mu-propose-date").value,e=document.getElementById("mu-propose-time").value;if(!n||!e){ne("Vælg dato og tid","error");return}const t=p.meetups.find(s=>s.id===wg);if(!t||!p.user)return;const r=(t.participants||[]).map(s=>s.uid===p.user.uid?{...s,status:"foreslået",proposedDate:n,proposedTime:e}:s);try{await ut(le(X,"meetups",t.id),{participants:r,updatedAt:yt()}),t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-propose-modal").classList.add("hidden"),On()}catch(s){ne("Fejl: "+s.message,"error")}};window.acceptProposedTime=async function(n,e){var c;const t=p.meetups.find(l=>l.id===n);if(!t||t.creatorUid!==((c=p.user)==null?void 0:c.uid))return;const r=(t.participants||[]).find(l=>l.uid===e);if(!(r!=null&&r.proposedDate)||!(r!=null&&r.proposedTime))return;const s=r.proposedDate,i=r.proposedTime,o=t.participants.map(l=>l.uid===e?{...l,status:"tilmeldt",proposedDate:null,proposedTime:null}:{...l,status:"afventer",proposedDate:null,proposedTime:null});try{await ut(le(X,"meetups",t.id),{date:s,time:i,participants:o,updatedAt:yt()}),t.date=s,t.time=i,t.participants=o,t.updatedAt=Date.now(),On(),ne("Nyt tidspunkt accepteret","success")}catch(l){ne("Fejl: "+l.message,"error")}};window.cancelMeetup=function(n){var t;const e=p.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=p.user)==null?void 0:t.uid)||Di("Aflys denne skydning?",async()=>{try{await ut(le(X,"meetups",e.id),{status:"aflyst",updatedAt:yt()}),e.status="aflyst",e.updatedAt=Date.now(),On()}catch(r){ne("Fejl: "+r.message,"error")}})};async function e0(n,e){var i;if(e=(e||"").trim().slice(0,300),!e||!p.user)return;const t=p.meetups.find(o=>o.id===n);if(!t)return;const r={uid:p.user.uid,name:((i=p.profile)==null?void 0:i.name)||"—",text:e,createdAt:new Date},s=[...t.comments||[],r];try{await ut(le(X,"meetups",t.id),{comments:s,updatedAt:yt()}),t.comments=s,t.updatedAt=Date.now(),On()}catch(o){ne("Fejl: "+o.message,"error")}}function Lh(n,e){var F;const t=N=>{var B;return N.shooters.find(z=>z.id===e)||((B=N.shooters)==null?void 0:B[0])},r=n.map(N=>{const B=t(N);return B?Xe(B.scores):null}).filter(N=>N!==null);let s=0,i=0,o=0,c=0;const l={11:0,10:0,8:0,5:0,M:0},d={11:0,10:0,8:0,5:0,M:0};n.forEach(N=>{const B=t(N);B&&B.scores.forEach(z=>{z[0]!=null&&(z[0]==="M"?(l.M++,i++):(l[Number(z[0])]=(l[Number(z[0])]||0)+1,s+=Number(z[0]),i++)),z[1]!=null&&(z[1]==="M"?(d.M++,c++):(d[Number(z[1])]=(d[Number(z[1])]||0)+1,o+=Number(z[1]),c++))})});const f=i?(s/i).toFixed(2):0,m=c?(o/c).toFixed(2):0,_=i+c?((s+o)/(i+c)).toFixed(2):0,E=((F=n[0])==null?void 0:F.numTargets)||24,C=Array.from({length:E},(N,B)=>{let z=0,Z=0;return n.forEach(w=>{const y=t(w);if(!y)return;(y.scores[B]||[null,null]).forEach(T=>{T!=null&&(z+=Me(T),Z++)})}),Z?z/Z:null}).map((N,B)=>({v:N,i:B})).filter(N=>N.v!==null),D=C.length?C.reduce((N,B)=>N.v>B.v?N:B):null,$=C.length?C.reduce((N,B)=>N.v<B.v?N:B):null;return{myScores:r,p1avg:f,p2avg:m,pilAvg:_,distP1:l,distP2:d,bestTarget:D,worstTarget:$}}function Mh(n){if(!n.length)return 0;const e=n.reduce((t,r)=>t+r,0)/n.length;return Math.sqrt(n.reduce((t,r)=>t+(r-e)**2,0)/n.length)}function t0(n){var l;const e=n.length;if(e<2)return{slope:0,intercept:((l=n[0])==null?void 0:l.y)||0};const t=n.reduce((d,f)=>d+f.x,0),r=n.reduce((d,f)=>d+f.y,0),s=n.reduce((d,f)=>d+f.x*f.y,0),i=n.reduce((d,f)=>d+f.x*f.x,0),o=e*i-t*t,c=o?(e*s-t*r)/o:0;return{slope:c,intercept:(r-c*t)/e}}function n0(n,e){var o,c;const t=((o=n.shooters)==null?void 0:o.find(l=>l.id===e))||((c=n.shooters)==null?void 0:c[0]);if(!t)return[];const r=n.numTargets||24,s=n.traversalOrder||Array.from({length:r},(l,d)=>d),i=[];for(let l=0;l<r;l++){const d=s[l];if(d===void 0)continue;const f=t.scores[d]||[null,null];let m=0,_=0;f.forEach(E=>{E!=null&&(m+=Me(E),_++)}),_&&i.push(m/_)}return i}function r0(n,e){let t=1,r=0,s=0,i=0,o=1,c=0,l=0,d=0,f=0,m=0,_=0,E=0,P=0;const C=()=>{e.style.transformOrigin="0 0",e.style.transform=t>1?`translate(${r}px,${s}px) scale(${t})`:""};n.addEventListener("touchstart",$=>{if($.preventDefault(),$.touches.length===2){const F=$.touches,N=n.getBoundingClientRect();i=Math.hypot(F[0].clientX-F[1].clientX,F[0].clientY-F[1].clientY),o=t,c=r,l=s,d=(F[0].clientX+F[1].clientX)/2-N.left,f=(F[0].clientY+F[1].clientY)/2-N.top}else $.touches.length===1&&(m=$.touches[0].clientX,_=$.touches[0].clientY,E=r,P=s)},{passive:!1}),n.addEventListener("touchmove",$=>{if($.preventDefault(),$.touches.length===2){const F=$.touches,N=Math.hypot(F[0].clientX-F[1].clientX,F[0].clientY-F[1].clientY),B=Math.min(8,Math.max(1,o*N/i)),z=(d-c)/o,Z=(f-l)/o;r=d-z*B,s=f-Z*B,t=B,C()}else $.touches.length===1&&t>1&&(r=E+$.touches[0].clientX-m,s=P+$.touches[0].clientY-_,C())},{passive:!1}),n.addEventListener("touchend",()=>{t<1.05&&(t=1,r=0,s=0,C())},{passive:!0});let D=0;n.addEventListener("touchend",()=>{const $=Date.now();$-D<300&&(t=1,r=0,s=0,C()),D=$},{passive:!0})}let Nt=null,er=null;function s0(){const n=document.getElementById("graph-fs");n&&n.classList.add("hidden"),Nt&&(window.removeEventListener("resize",Nt),window.removeEventListener("orientationchange",Nt),Nt=null),er&&(document.removeEventListener("gesturestart",er),er=null)}window.closeGraphFs=s0;function i0(n){p.pendingAnalyseRound=n,document.getElementById("analyse-filter").value="specific",window.switchTab("analyse")}window.analyseRound=i0;function o0(n,e,t,r){const s=["11","10","8","5","M"],i={11:"#1a7a3a",10:"#1a5aaa",8:"#d4700a",5:"#7a3aaa",M:"#cc3333"},o=n.myScores[0]||0,c=t.myScores[0]||0,l=Math.abs(o-c),d='<div class="cmp-sep"></div>',f=(E,P,C)=>`<div style="font-size:11px;color:${C};margin-bottom:4px;">${K(P)}</div>
  ...
  </div>`,_}window.renderAnalyse=function(){var Mi,Oi,$n,jn,br,Ar,Rr,Sr,ms,Fi;const n=document.getElementById("analyse-content");if(!n)return;const e=document.getElementById("analyse-bane");if(e&&e.options.length<=1&&[...new Set(p.rounds.map(O=>O.courseId).filter(Boolean))].forEach(O=>{const Q=p.courses.find(W=>W.id===O);if(Q&&!Array.from(e.options).find(W=>W.value===O)){const W=document.createElement("option");W.value=O,W.textContent=Q.name,e.appendChild(W)}}),p.pendingAnalyseRound&&e){const j=p.rounds.find(O=>O.id===p.pendingAnalyseRound);j!=null&&j.courseId&&Array.from(e.options).some(O=>O.value===j.courseId)&&(e.value=j.courseId)}const t=((Mi=document.getElementById("analyse-filter"))==null?void 0:Mi.value)||"all",r=t==="all"?0:t==="lastround"?1:t==="specific"?0:Number(t),s=((Oi=document.getElementById("analyse-bane"))==null?void 0:Oi.value)||"all",i=Number(($n=document.getElementById("analyse-antal"))==null?void 0:$n.value)||0,o=document.getElementById("analyse-runde-wrap"),c=document.getElementById("analyse-runde"),l=document.getElementById("analyse-runde-wrap-2"),d=document.getElementById("analyse-runde-2"),f=document.getElementById("analyse-runde-lbl"),m=t==="compare";o&&(o.style.display=t==="specific"||m?"":"none"),l&&(l.style.display=m?"":"none"),f&&(f.style.display=m?"":"none");const _=j=>{const O=j.created;return O!=null&&O.toDate?O.toDate().toLocaleDateString("da-DK"):O!=null&&O.seconds?new Date(O.seconds*1e3).toLocaleDateString("da-DK"):typeof O=="number"?new Date(O).toLocaleDateString("da-DK"):"—"},E=(j,O)=>{const Q=s==="all"?p.rounds:p.rounds.filter(J=>J.courseId===s),W=j.value;j.innerHTML=`<option value="">${O}</option>`,Q.forEach(J=>{const ae=document.createElement("option");ae.value=J.id,ae.textContent=`${_(J)} — ${J.name||"Runde"}`,j.appendChild(ae)}),Q.some(J=>J.id===W)&&(j.value=W)};if((t==="specific"||m)&&c&&(E(c,"Vælg runde..."),p.pendingAnalyseRound&&(c.value=p.pendingAnalyseRound,p.pendingAnalyseRound=null)),m&&d&&E(d,"Vælg runde 2..."),m){const j=c==null?void 0:c.value,O=d==null?void 0:d.value;if(!j||!O){n.innerHTML='<div class="empty"><div class="empty-icon">📊</div>Vælg to runder ovenfor</div>';return}const Q=p.rounds.map(fe=>({...fe,shooters:(fe.shooters||[]).map(re=>({...re,scores:gr(re.scores)}))})),W=Q.find(fe=>fe.id===j),J=Q.find(fe=>fe.id===O);if(!W||!J){n.innerHTML='<div class="empty">Kunne ikke finde runderne</div>';return}const ae=`${W.name||"Runde"} (${_(W)})`,de=`${J.name||"Runde"} (${_(J)})`;n.innerHTML=o0(Lh([W],(jn=p.user)==null?void 0:jn.uid),ae,Lh([J],(br=p.user)==null?void 0:br.uid),de);return}const P=p.rounds.map(j=>({...j,shooters:(j.shooters||[]).map(O=>({...O,scores:gr(O.scores)}))})),C=((Ar=document.getElementById("analyse-completed-only"))==null?void 0:Ar.checked)||!1,D=((Rr=document.getElementById("analyse-startat1-only"))==null?void 0:Rr.checked)||!1,$=j=>{var W,J;const O=((W=j.shooters)==null?void 0:W.find(ae=>{var de;return ae.id===((de=p.user)==null?void 0:de.uid)}))||((J=j.shooters)==null?void 0:J[0]);if(!O)return!1;const Q=j.numTargets||24;for(let ae=0;ae<Q;ae++){const de=O.scores[ae]||[null,null];if(de[0]==null&&de[1]==null)return!1}return!0},F=j=>j.startTarget===1;let N=s==="all"?P:P.filter(j=>j.courseId===s);if(C&&(N=N.filter($)),D&&(N=N.filter(F)),t==="specific"){const j=c==null?void 0:c.value;N=j?N.filter(O=>O.id===j):[]}const B=i||r,z=B&&t!=="specific"?N.slice(0,B):N;if(!z.length){n.innerHTML='<div class="empty"><div class="empty-icon">📈</div>Ingen runder endnu</div>';return}const Z=j=>{var O;return j.shooters.find(Q=>{var W;return Q.id===((W=p.user)==null?void 0:W.uid)})||((O=j.shooters)==null?void 0:O[0])},w=z.map(j=>{const O=Z(j);return O?Xe(O.scores):null}).filter(j=>j!==null),y=w.length?(w.reduce((j,O)=>j+O,0)/w.length).toFixed(1):0,I=w.length?Math.max(...w):0,T=w.length?Math.min(...w):0;let b=0,R=0,v=0,qe=0;const Dt={11:0,10:0,8:0,5:0,M:0},Er={11:0,10:0,8:0,5:0,M:0};z.forEach(j=>{const O=Z(j);O&&O.scores.forEach(Q=>{Q[0]!=null&&(Q[0]==="M"?(Dt.M++,R++):(Dt[Number(Q[0])]=(Dt[Number(Q[0])]||0)+1,b+=Number(Q[0]),R++)),Q[1]!=null&&(Q[1]==="M"?(Er.M++,qe++):(Er[Number(Q[1])]=(Er[Number(Q[1])]||0)+1,v+=Number(Q[1]),qe++))})});const Gt=R?(b/R).toFixed(2):0,zt=qe?(v/qe).toFixed(2):0,Bn=R+qe?((b+v)/(R+qe)).toFixed(2):0,dt=((Sr=z[0])==null?void 0:Sr.numTargets)||24,Li=Array.from({length:dt},(j,O)=>{let Q=0,W=0;return z.forEach(J=>{const ae=Z(J);if(!ae)return;const fe=(J.traversalOrder||Array.from({length:J.numTargets||dt},(ce,et)=>et))[O];if(fe===void 0)return;(ae.scores[fe]||[null,null]).forEach(ce=>{ce!=null&&(Q+=Me(ce),W++)})}),W?Q/W:null}),ht=Li.map((j,O)=>({v:j,i:O})).filter(j=>j.v!==null),ke=ht.length?ht.reduce((j,O)=>j.v>O.v?j:O):null,Tr=ht.length?ht.reduce((j,O)=>j.v<O.v?j:O):null,Un=["11","10","8","5","M"];let wt="";if(wt+=`<div class="stats-grid2">
  ...
  </div>`,w.length>1){const W=Math.min(...w)-5,J=Math.max(...w)+5,ae=w.slice().reverse().map((de,fe)=>{const re=30+fe/(w.length-1)*280,ce=90-(de-W)/(J-W)*(120-2*30);return`${re},${ce}`}).join(" ");wt+=`<div class="card card-mb16">
    ...
    <div id="graph-fs" class="fs-ov hidden graph-fs-overlay" onclick="window.closeGraphFs()">
    ...
    </div>`,window.openGraphFs=function(){const _e=document.getElementById("graph-fs");if(!_e)return;_e.classList.remove("hidden");const tt=document.getElementById("graph-fs-svg"),xt=document.getElementById("graph-fs-box"),bt=document.getElementById("graph-fs-viewport"),Pr=()=>{const Ge=Math.min(window.innerWidth*.96,900),ze=Math.min(window.innerHeight*.9,700),qn=Math.max(200,Ge-32),At=Math.max(140,ze-90),cn=Math.max(qn,dt*30);tt.setAttribute("viewBox",`0 0 ${cn} ${At}`),tt.innerHTML=Tt(cn,At,{dotR:5,valFont:10,showVals:!0}),xt&&(xt.style.width=Ge+"px"),bt&&(bt.style.width=qn+"px",bt.style.height=At+"px")};Pr(),Nt&&(window.removeEventListener("resize",Nt),window.removeEventListener("orientationchange",Nt)),Nt=Pr,window.addEventListener("resize",Nt),window.addEventListener("orientationchange",Nt),er&&document.removeEventListener("gesturestart",er),er=Ge=>Ge.preventDefault(),document.addEventListener("gesturestart",er,{passive:!1}),bt&&!bt.dataset.pinchInit&&(r0(bt,tt),bt.dataset.pinchInit="1")}}if(s!=="all"){const j=Q=>{const W=Q.created;return W!=null&&W.toDate?W.toDate().getTime():W!=null&&W.seconds?W.seconds*1e3:typeof W=="number"?W:0},O=P.filter(Q=>Q.courseId===s).filter(Q=>!C||$(Q)).filter(Q=>!D||F(Q)).map(Q=>{var J;const W=n0(Q,(J=p.user)==null?void 0:J.uid);return W.length>1?{t:j(Q),cv:Mh(W)}:null}).filter(Boolean).sort((Q,W)=>Q.t-W.t);if(O.length>1){const ae=O.map(Ne=>Ne.cv),de=Math.min(...ae),fe=Math.max(...ae),re=fe-de||1,ce=(Ne,Tt)=>({x:30+Tt/(O.length-1)*(340-2*30),y:90-(Ne.cv-de)/re*(120-2*30)}),et=O.map((Ne,Tt)=>{const{x:ft,y:_e}=ce(Ne,Tt);return`${ft},${_e}`}).join(" "),Ve=O.map((Ne,Tt)=>{const{x:ft,y:_e}=ce(Ne,Tt);return`<circle cx="${ft}" cy="${_e}" r="4" fill="#f0c030"/><text x="${ft}" y="${_e-8}" text-anchor="middle" font-size="10" fill="var(--text)">${Ne.cv.toFixed(2)}</text>`}).join("");wt+=`<div class="card card-mb16">
      ...
      </div>`}}if(n.innerHTML=wt,s!=="all"&&((ms=p.profile)!=null&&ms.kon)&&((Fi=p.profile)!=null&&Fi.bueklasse)){const j=p.profile.kon==="herre"?"Herre":"Dame",O={langbue:"Langbue",trad:"Traditionel",recurve:"Recurve",compound:"Compound",barbue:"Barbue",buejæger:"Buejæger","trad-buejæger":"Trad. buejæger",rytterbue:"Rytterbue"}[p.profile.bueklasse]||p.profile.bueklasse,Q=document.createElement("div");Q.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${j} ${O}</div><div class="comp-loading-msg">Henter...</div></div>`,n.appendChild(Q),Ze(je(X,"bane_stats",s,"runder")).then(W=>{const ae=W.docs.map(Ve=>Ve.data()).filter(Ve=>Ve.kon===p.profile.kon&&Ve.bueklasse===p.profile.bueklasse);if(!ae.length){Q.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${j} ${O}</div><div class="comp-loading-msg">Ingen andre ${j} ${O}-skytter har skudt denne bane endnu.</div></div>`;return}const de=ae.filter(Ve=>(Ve.arrowsShot||Ve.numTargets*2)>0),fe=de.length?(de.reduce((Ve,Ne)=>Ve+Ne.score/(Ne.arrowsShot||Ne.numTargets*2),0)/de.length).toFixed(2):"—",re=fe!=="—"?Number(Bn)-Number(fe):null,ce=re!==null?(re>0?"+":"")+re.toFixed(2):"—",et=re===null?"var(--muted)":re>0?"#2aaa5a":re<0?"var(--danger)":"var(--muted)";Q.innerHTML=`<div class="card card-mb16">
