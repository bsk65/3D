 ...
 */const wh=function(n){const e=[];let t=0;for(let r=0;r<n.length;r++){let s=n.charCodeAt(r);s<128?e[t++]=s:s<2048?(e[t++]=s>>6|192,e[t++]=s&63|128):(s&64512)===55296&&r+1<n.length&&(n.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++r)&1023),e[t++]=s>>18|240,e[t++]=s>>12&63|128,e[t++]=s>>6&63|128,e[t++]=s&63|128):(e[t++]=s>>12|224,e[t++]=s>>6&63|128,e[t++]=s&63|128)}return e},Cg=function(n){const e=[];let t=0,r=0;for(;t<n.length;){const s=n[t++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=n[t++];e[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=n[t++],o=n[t++],c=n[t++],l=((s&7)<<18|(i&63)<<12|(o&63)<<6|c&63)-65536;e[r++]=String.fromCharCode(55296+(l>>10)),e[r++]=String.fromCharCode(56320+(l&1023))}else{const i=n[t++],o=n[t++];e[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|o&63)}}return e.join("")},Eh={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<n.length;s+=3){const i=n[s],o=s+1<n.length,c=o?n[s+1]:0,l=s+2<n.length,d=l?n[s+2]:0,f=i>>2,m=(i&3)<<4|c>>4;let _=(c&15)<<2|d>>6,w=d&63;l||(w=64,o||(_=64)),r.push(t[f],t[m],t[_],t[w])}return r.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(wh(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):Cg(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<n.length;){const i=t[n.charAt(s++)],c=s<n.length?t[n.charAt(s)]:0;++s;const d=s<n.length?t[n.charAt(s)]:64;++s;const m=s<n.length?t[n.charAt(s)]:64;if(++s,i==null||c==null||d==null||m==null)throw new kg;const _=i<<2|c>>4;if(r.push(_),d!==64){const w=c<<4&240|d>>2;if(r.push(w),m!==64){const P=d<<6&192|m;r.push(P)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class kg extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Dg=function(n){const e=wh(n);return Eh.encodeByteArray(e,!0)},co=function(n){return Dg(n).replace(/\./g,"")},Th=function(n){try{return Eh.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar=K_;function Dh(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Ha,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw fn.create("bad-app-name",{appName:String(s)});if(t||(t=Ah()),!t)throw fn.create("no-options");const i=lo.get(s);if(i){if(Ms(t,i.options)&&Ms(r,i.config))return i;throw fn.create("duplicate-app",{appName:s})}const o=new n_(s);for(const l of Wa.values())o.addComponent(l);const c=new J_(t,r,o);return lo.set(s,c),c}function xh(n=Ha){const e=lo.get(n);if(!e&&n===Ha&&Ah())return Dh();if(!e)throw fn.create("no-app",{appName:n});return e}function At(n,e,t){var r;let s=(r=H_[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),$t.warn(c.join(" "));return}Qn(new _n(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X_="firebase-heartbeat-database",Y_=1,Fs="firebase-heartbeat-store";let xa=null;function Vh(){return xa||(xa=p_(X_,Y_,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Fs)}catch(t){console.warn(t)}}}}).catch(n=>{throw fn.create("idb-open",{originalErrorMessage:n.message})})),xa}async function Z_(n){try{const t=(await Vh()).transaction(Fs),r=await t.objectStore(Fs).get(Nh(n));return await t.done,r}catch(e){if(e instanceof Dt)$t.warn(e.message);else{const t=fn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});$t.warn(t.message)}}}async function Lu(n,e){try{const r=(await Vh()).transaction(Fs,"readwrite");await r.objectStore(Fs).put(e,Nh(n)),await r.done}catch(t){if(t instanceof Dt)$t.warn(t.message);else{const r=fn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});$t.warn(r.message)}}}function Nh(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iy(n){Qn(new _n("platform-logger",e=>new y_(e),"PRIVATE")),Qn(new _n("heartbeat",e=>new ny(e),"PRIVATE")),At(Ka,Vu,n),At(Ka,Vu,"esm2017"),At("fire-js","")}iy("");var oy="firebase",ay="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */At(oy,ay,"app");function Rc(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}function Lh(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const cy=Lh,Oh=new ti("auth","Firebase",Lh());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri{constructor(e,t){this.shortDelay=e,this.longDelay=t,jt(t>e,"Short delay should be less than long delay!"),this.isMobile=Bg()||qg()}get(){return dy()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vy(n,e){return Kt(n,"POST","/v1/accounts:delete",e)}async function $h(n,e){return Kt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ho(n){var e;const t=n.auth,r=await n.getIdToken(),s=await Bs(n,$h(t,{idToken:r}));Q(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const o=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?jh(i.providerUserInfo):[],c=by(n.providerData,o),l=n.isAnonymous,d=!(n.email&&i.passwordHash)&&!(c!=null&&c.length),f=l?d:!1,m={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new Ja(i.createdAt,i.lastLoginAt),isAnonymous:f};Object.assign(n,m)}async function Ty(n){const e=Pe(n);await ho(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function by(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function jh(n){return n.map(e=>{var{providerId:t}=e,r=Rc(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ay(n,e){const t=await Bh(n,{},async()=>{const r=ni({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,o=Uh(n,s,"/v1/token",`key=${i}`),c=await n._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",Fh.fetch()(o,{method:"POST",headers:c,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Ry(n,e){return Kt(n,"POST","/v2/accounts:revokeToken",zt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qu(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Hh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Gh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Qh(e))return"Blackberry";if(Jh(e))return"Webos";if(zh(e))return"Safari";if((e.includes("chrome/")||Kh(e))&&!e.includes("edge/"))return"Chrome";if(Wh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Gh(n=Le()){return/firefox\//i.test(n)}function zh(n=Le()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Kh(n=Le()){return/crios\//i.test(n)}function Hh(n=Le()){return/iemobile/i.test(n)}function Wh(n=Le()){return/android/i.test(n)}function Qh(n=Le()){return/blackberry/i.test(n)}function Jh(n=Le()){return/webos/i.test(n)}function kc(n=Le()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Sy(n=Le()){var e;return kc(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Py(){return Gg()&&document.documentMode===10}function Xh(n=Le()){return kc(n)||Wh(n)||Jh(n)||Qh(n)||/windows phone/i.test(n)||Hh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yh(n,e=[]){let t;switch(n){case"Browser":t=qu(Le());break;case"Worker":t=`${qu(Le())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${ar}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zy(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function ev(n){const e=vs(Is(n)).link,t=e?vs(Is(e)).deep_link_id:null,r=vs(Is(n)).deep_link_id;return(r?vs(Is(r)).link:null)||r||t||e||n}class xc{constructor(e){var t,r,s,i,o,c;const l=vs(Is(e)),d=(t=l.apiKey)!==null&&t!==void 0?t:null,f=(r=l.oobCode)!==null&&r!==void 0?r:null,m=Zy((s=l.mode)!==null&&s!==void 0?s:null);Q(d&&f&&m,"argument-error"),this.apiKey=d,this.operation=m,this.code=f,this.continueUrl=(i=l.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(c=l.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=ev(e);try{return new xc(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rf(n,e,t=!1){if(Et(n.app))return Promise.reject(Ut(n));const r="signIn",s=await nf(n,r,e),i=await Xn._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function sv(n,e){return rf(wn(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sf(n){const e=wn(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function iv(n,e,t){const r=wn(n);await fo(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Qy)}async function ov(n,e,t){if(Et(n.app))return Promise.reject(Ut(n));const r=wn(n),o=await fo(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",tv).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&sf(n),l}),c=await Xn._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function av(n,e,t){return Et(n.app)?Promise.reject(Ut(n)):sv(Pe(n),Kr.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&sf(n),r})}function cv(n,e,t,r){return Pe(n).onIdTokenChanged(e,t,r)}function lv(n,e,t){return Pe(n).beforeAuthStateChanged(e,t)}function uv(n,e,t,r){return Pe(n).onAuthStateChanged(e,t,r)}function dv(n){return Pe(n).signOut()}const po="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mf{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:o,type:c}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(c)(l))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Pv;case"linkViaPopup":case"linkViaRedirect":return kv;case"reauthViaPopup":case"reauthViaRedirect":return Cv;default:_t(this.auth,"internal-error")}}resolve(e){jt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){jt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uI="__/auth/handler",dI="emulator/auth/handler",hI=encodeURIComponent("fac");async function Zu(n,e,t,r,s,i){Q(n.config.authDomain,n,"auth-domain-config-required"),Q(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:ar,eventId:s};if(e instanceof tf){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Qg(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,m]of Object.entries({}))o[f]=m}if(e instanceof ii){const f=e.getScopes().filter(m=>m!=="");f.length>0&&(o.scopes=f.join(","))}n.tenantId&&(o.tid=n.tenantId);const c=o;for(const f of Object.keys(c))c[f]===void 0&&delete c[f];const l=await n._getAppCheckToken(),d=l?`#${hI}=${encodeURIComponent(l)}`:"";return`${fI(n)}?${ni(c).slice(1)}${d}`}function fI({config:n}){return n.emulator?Pc(n,dI):`https://${n.authDomain}/${uI}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _I(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function yI(n){Qn(new _n("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;Q(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Yh(n)},d=new Vy(r,s,i,l);return jy(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),Qn(new _n("auth-internal",e=>{const t=wn(e.getProvider("auth").getImmediate());return(r=>new gI(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),At(ed,td,_I(n)),At(ed,td,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vI=5*60,II=Rh("authIdTokenMaxAge")||vI;let nd=null;const wI=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>II)return;const s=t==null?void 0:t.token;nd!==s&&(nd=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function EI(n=xh()){const e=No(n,"auth");if(e.isInitialized())return e.getImmediate();const t=$y(n,{popupRedirectResolver:pI,persistence:[Rv,mv,lf]}),r=Rh("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=wI(i.toString());lv(t,o,()=>o(t.currentUser)),cv(t,c=>o(c))}}const s=bh("auth");return s&&qy(t,`http://${s}`),t}function TI(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}Ny({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=Rt("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",TI().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});yI("Browser");var rd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var zn,gf;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,y){function v(){}v.prototype=y.prototype,T.D=y.prototype,T.prototype=new v,T.prototype.constructor=T,T.C=function(E,b,R){for(var I=Array(arguments.length-2),ot=2;ot<arguments.length;ot++)I[ot-2]=arguments[ot];return y.prototype[b].apply(E,I)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,y,v){v||(v=0);var E=Array(16);if(typeof y=="string")for(var b=0;16>b;++b)E[b]=y.charCodeAt(v++)|y.charCodeAt(v++)<<8|y.charCodeAt(v++)<<16|y.charCodeAt(v++)<<24;else for(b=0;16>b;++b)E[b]=y[v++]|y[v++]<<8|y[v++]<<16|y[v++]<<24;y=T.g[0],v=T.g[1],b=T.g[2];var R=T.g[3],I=y+(R^v&(b^R))+E[0]+3614090360&4294967295;y=v+(I<<7&4294967295|I>>>25),I=R+(b^y&(v^b))+E[1]+3905402710&4294967295,R=y+(I<<12&4294967295|I>>>20),I=b+(v^R&(y^v))+E[2]+606105819&4294967295,b=R+(I<<17&4294967295|I>>>15),I=v+(y^b&(R^y))+E[3]+3250441966&4294967295,v=b+(I<<22&4294967295|I>>>10),I=y+(R^v&(b^R))+E[4]+4118548399&4294967295,y=v+(I<<7&4294967295|I>>>25),I=R+(b^y&(v^b))+E[5]+1200080426&4294967295,R=y+(I<<12&4294967295|I>>>20),I=b+(v^R&(y^v))+E[6]+2821735955&4294967295,b=R+(I<<17&4294967295|I>>>15),I=v+(y^b&(R^y))+E[7]+4249261313&4294967295,v=b+(I<<22&4294967295|I>>>10),I=y+(R^v&(b^R))+E[8]+1770035416&4294967295,y=v+(I<<7&4294967295|I>>>25),I=R+(b^y&(v^b))+E[9]+2336552879&4294967295,R=y+(I<<12&4294967295|I>>>20),I=b+(v^R&(y^v))+E[10]+4294925233&4294967295,b=R+(I<<17&4294967295|I>>>15),I=v+(y^b&(R^y))+E[11]+2304563134&4294967295,v=b+(I<<22&4294967295|I>>>10),I=y+(R^v&(b^R))+E[12]+1804603682&4294967295,y=v+(I<<7&4294967295|I>>>25),I=R+(b^y&(v^b))+E[13]+4254626195&4294967295,R=y+(I<<12&4294967295|I>>>20),I=b+(v^R&(y^v))+E[14]+2792965006&4294967295,b=R+(I<<17&4294967295|I>>>15),I=v+(y^b&(R^y))+E[15]+1236535329&4294967295,v=b+(I<<22&4294967295|I>>>10),I=y+(b^R&(v^b))+E[1]+4129170786&4294967295,y=v+(I<<5&4294967295|I>>>27),I=R+(v^b&(y^v))+E[6]+3225465664&4294967295,R=y+(I<<9&4294967295|I>>>23),I=b+(y^v&(R^y))+E[11]+643717713&4294967295,b=R+(I<<14&4294967295|I>>>18),I=v+(R^y&(b^R))+E[0]+3921069994&4294967295,v=b+(I<<20&4294967295|I>>>12),I=y+(b^R&(v^b))+E[5]+3593408605&4294967295,y=v+(I<<5&4294967295|I>>>27),I=R+(v^b&(y^v))+E[10]+38016083&4294967295,R=y+(I<<9&4294967295|I>>>23),I=b+(y^v&(R^y))+E[15]+3634488961&4294967295,b=R+(I<<14&4294967295|I>>>18),I=v+(R^y&(b^R))+E[4]+3889429448&4294967295,v=b+(I<<20&4294967295|I>>>12),I=y+(b^R&(v^b))+E[9]+568446438&4294967295,y=v+(I<<5&4294967295|I>>>27),I=R+(v^b&(y^v))+E[14]+3275163606&4294967295,R=y+(I<<9&4294967295|I>>>23),I=b+(y^v&(R^y))+E[3]+4107603335&4294967295,b=R+(I<<14&4294967295|I>>>18),I=v+(R^y&(b^R))+E[8]+1163531501&4294967295,v=b+(I<<20&4294967295|I>>>12),I=y+(b^R&(v^b))+E[13]+2850285829&4294967295,y=v+(I<<5&4294967295|I>>>27),I=R+(v^b&(y^v))+E[2]+4243563512&4294967295,R=y+(I<<9&4294967295|I>>>23),I=b+(y^v&(R^y))+E[7]+1735328473&4294967295,b=R+(I<<14&4294967295|I>>>18),I=v+(R^y&(b^R))+E[12]+2368359562&4294967295,v=b+(I<<20&4294967295|I>>>12),I=y+(v^b^R)+E[5]+4294588738&4294967295,y=v+(I<<4&4294967295|I>>>28),I=R+(y^v^b)+E[8]+2272392833&4294967295,R=y+(I<<11&4294967295|I>>>21),I=b+(R^y^v)+E[11]+1839030562&4294967295,b=R+(I<<16&4294967295|I>>>16),I=v+(b^R^y)+E[14]+4259657740&4294967295,v=b+(I<<23&4294967295|I>>>9),I=y+(v^b^R)+E[1]+2763975236&4294967295,y=v+(I<<4&4294967295|I>>>28),I=R+(y^v^b)+E[4]+1272893353&4294967295,R=y+(I<<11&4294967295|I>>>21),I=b+(R^y^v)+E[7]+4139469664&4294967295,b=R+(I<<16&4294967295|I>>>16),I=v+(b^R^y)+E[10]+3200236656&4294967295,v=b+(I<<23&4294967295|I>>>9),I=y+(v^b^R)+E[13]+681279174&4294967295,y=v+(I<<4&4294967295|I>>>28),I=R+(y^v^b)+E[0]+3936430074&4294967295,R=y+(I<<11&4294967295|I>>>21),I=b+(R^y^v)+E[3]+3572445317&4294967295,b=R+(I<<16&4294967295|I>>>16),I=v+(b^R^y)+E[6]+76029189&4294967295,v=b+(I<<23&4294967295|I>>>9),I=y+(v^b^R)+E[9]+3654602809&4294967295,y=v+(I<<4&4294967295|I>>>28),I=R+(y^v^b)+E[12]+3873151461&4294967295,R=y+(I<<11&4294967295|I>>>21),I=b+(R^y^v)+E[15]+530742520&4294967295,b=R+(I<<16&4294967295|I>>>16),I=v+(b^R^y)+E[2]+3299628645&4294967295,v=b+(I<<23&4294967295|I>>>9),I=y+(b^(v|~R))+E[0]+4096336452&4294967295,y=v+(I<<6&4294967295|I>>>26),I=R+(v^(y|~b))+E[7]+1126891415&4294967295,R=y+(I<<10&4294967295|I>>>22),I=b+(y^(R|~v))+E[14]+2878612391&4294967295,b=R+(I<<15&4294967295|I>>>17),I=v+(R^(b|~y))+E[5]+4237533241&4294967295,v=b+(I<<21&4294967295|I>>>11),I=y+(b^(v|~R))+E[12]+1700485571&4294967295,y=v+(I<<6&4294967295|I>>>26),I=R+(v^(y|~b))+E[3]+2399980690&4294967295,R=y+(I<<10&4294967295|I>>>22),I=b+(y^(R|~v))+E[10]+4293915773&4294967295,b=R+(I<<15&4294967295|I>>>17),I=v+(R^(b|~y))+E[1]+2240044497&4294967295,v=b+(I<<21&4294967295|I>>>11),I=y+(b^(v|~R))+E[8]+1873313359&4294967295,y=v+(I<<6&4294967295|I>>>26),I=R+(v^(y|~b))+E[15]+4264355552&4294967295,R=y+(I<<10&4294967295|I>>>22),I=b+(y^(R|~v))+E[6]+2734768916&4294967295,b=R+(I<<15&4294967295|I>>>17),I=v+(R^(b|~y))+E[13]+1309151649&4294967295,v=b+(I<<21&4294967295|I>>>11),I=y+(b^(v|~R))+E[4]+4149444226&4294967295,y=v+(I<<6&4294967295|I>>>26),I=R+(v^(y|~b))+E[11]+3174756917&4294967295,R=y+(I<<10&4294967295|I>>>22),I=b+(y^(R|~v))+E[2]+718787259&4294967295,b=R+(I<<15&4294967295|I>>>17),I=v+(R^(b|~y))+E[9]+3951481745&4294967295,T.g[0]=T.g[0]+y&4294967295,T.g[1]=T.g[1]+(b+(I<<21&4294967295|I>>>11))&4294967295,T.g[2]=T.g[2]+b&4294967295,T.g[3]=T.g[3]+R&4294967295}r.prototype.u=function(T,y){y===void 0&&(y=T.length);for(var v=y-this.blockSize,E=this.B,b=this.h,R=0;R<y;){if(b==0)for(;R<=v;)s(this,T,R),R+=this.blockSize;if(typeof T=="string"){for(;R<y;)if(E[b++]=T.charCodeAt(R++),b==this.blockSize){s(this,E),b=0;break}}else for(;R<y;)if(E[b++]=T[R++],b==this.blockSize){s(this,E),b=0;break}}this.h=b,this.o+=y},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var y=1;y<T.length-8;++y)T[y]=0;var v=8*this.o;for(y=T.length-8;y<T.length;++y)T[y]=v&255,v/=256;for(this.u(T),T=Array(16),y=v=0;4>y;++y)for(var E=0;32>E;E+=8)T[v++]=this.g[y]>>>E&255;return T};function i(T,y){var v=c;return Object.prototype.hasOwnProperty.call(v,T)?v[T]:v[T]=y(T)}function o(T,y){this.h=y;for(var v=[],E=!0,b=T.length-1;0<=b;b--){var R=T[b]|0;E&&R==y||(v[b]=R,E=!1)}this.g=v}var c={};function l(T){return-128<=T&&128>T?i(T,function(y){return new o([y|0],0>y?-1:0)}):new o([T|0],0>T?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return m;if(0>T)return k(d(-T));for(var y=[],v=1,E=0;T>=v;E++)y[E]=T/v|0,v*=4294967296;return new o(y,0)}function f(T,y){if(T.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(T.charAt(0)=="-")return k(f(T.substring(1),y));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var v=d(Math.pow(y,8)),E=m,b=0;b<T.length;b+=8){var R=Math.min(8,T.length-b),I=parseInt(T.substring(b,b+R),y);8>R?(R=d(Math.pow(y,R)),E=E.j(R).add(d(I))):(E=E.j(v),E=E.add(d(I)))}return E}var m=l(0),_=l(1),w=l(16777216);n=o.prototype,n.m=function(){if(C(this))return-k(this).m();for(var T=0,y=1,v=0;v<this.g.length;v++){var E=this.i(v);T+=(0<=E?E:4294967296+E)*y,y*=4294967296}return T},n.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(P(this))return"0";if(C(this))return"-"+k(this).toString(T);for(var y=d(Math.pow(T,6)),v=this,E="";;){var b=B(v,y).g;v=F(v,b.j(y));var R=((0<v.g.length?v.g[0]:v.h)>>>0).toString(T);if(v=b,P(v))return R+E;for(;6>R.length;)R="0"+R;E=R+E}},n.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function P(T){if(T.h!=0)return!1;for(var y=0;y<T.g.length;y++)if(T.g[y]!=0)return!1;return!0}function C(T){return T.h==-1}n.l=function(T){return T=F(this,T),C(T)?-1:P(T)?0:1};function k(T){for(var y=T.g.length,v=[],E=0;E<y;E++)v[E]=~T.g[E];return new o(v,~T.h).add(_)}n.abs=function(){return C(this)?k(this):this},n.add=function(T){for(var y=Math.max(this.g.length,T.g.length),v=[],E=0,b=0;b<=y;b++){var R=E+(this.i(b)&65535)+(T.i(b)&65535),I=(R>>>16)+(this.i(b)>>>16)+(T.i(b)>>>16);E=I>>>16,R&=65535,I&=65535,v[b]=I<<16|R}return new o(v,v[v.length-1]&-2147483648?-1:0)};function F(T,y){return T.add(k(y))}n.j=function(T){if(P(this)||P(T))return m;if(C(this))return C(T)?k(this).j(k(T)):k(k(this).j(T));if(C(T))return k(this.j(k(T)));if(0>this.l(w)&&0>T.l(w))return d(this.m()*T.m());for(var y=this.g.length+T.g.length,v=[],E=0;E<2*y;E++)v[E]=0;for(E=0;E<this.g.length;E++)for(var b=0;b<T.g.length;b++){var R=this.i(E)>>>16,I=this.i(E)&65535,ot=T.i(b)>>>16,xt=T.i(b)&65535;v[2*E+2*b]+=I*xt,$(v,2*E+2*b),v[2*E+2*b+1]+=R*xt,$(v,2*E+2*b+1),v[2*E+2*b+1]+=I*ot,$(v,2*E+2*b+1),v[2*E+2*b+2]+=R*ot,$(v,2*E+2*b+2)}for(E=0;E<y;E++)v[E]=v[2*E+1]<<16|v[2*E];for(E=y;E<2*y;E++)v[E]=0;return new o(v,0)};function $(T,y){for(;(T[y]&65535)!=T[y];)T[y+1]+=T[y]>>>16,T[y]&=65535,y++}function V(T,y){this.g=T,this.h=y}function B(T,y){if(P(y))throw Error("division by zero");if(P(T))return new V(m,m);if(C(T))return y=B(k(T),y),new V(k(y.g),k(y.h));if(C(y))return y=B(T,k(y)),new V(k(y.g),y.h);if(30<T.g.length){if(C(T)||C(y))throw Error("slowDivide_ only works with positive integers.");for(var v=_,E=y;0>=E.l(T);)v=K(v),E=K(E);var b=J(v,1),R=J(E,1);for(E=J(E,2),v=J(v,2);!P(E);){var I=R.add(E);0>=I.l(T)&&(b=b.add(v),R=I),E=J(E,1),v=J(v,1)}return y=F(T,b.j(y)),new V(b,y)}for(b=m;0<=T.l(y);){for(v=Math.max(1,Math.floor(T.m()/y.m())),E=Math.ceil(Math.log(v)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),R=d(v),I=R.j(y);C(I)||0<I.l(T);)v-=E,R=d(v),I=R.j(y);P(R)&&(R=_),b=b.add(R),T=F(T,I)}return new V(b,T)}n.A=function(T){return B(this,T).h},n.and=function(T){for(var y=Math.max(this.g.length,T.g.length),v=[],E=0;E<y;E++)v[E]=this.i(E)&T.i(E);return new o(v,this.h&T.h)},n.or=function(T){for(var y=Math.max(this.g.length,T.g.length),v=[],E=0;E<y;E++)v[E]=this.i(E)|T.i(E);return new o(v,this.h|T.h)},n.xor=function(T){for(var y=Math.max(this.g.length,T.g.length),v=[],E=0;E<y;E++)v[E]=this.i(E)^T.i(E);return new o(v,this.h^T.h)};function K(T){for(var y=T.g.length+1,v=[],E=0;E<y;E++)v[E]=T.i(E)<<1|T.i(E-1)>>>31;return new o(v,T.h)}function J(T,y){var v=y>>5;y%=32;for(var E=T.g.length-v,b=[],R=0;R<E;R++)b[R]=0<y?T.i(R+v)>>>y|T.i(R+v+1)<<32-y:T.i(R+v);return new o(b,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,gf=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=d,o.fromString=f,zn=o}).apply(typeof rd<"u"?rd:typeof self<"u"?self:typeof window<"u"?window:{});var Mi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var _f,ws,yf,Qi,Ya,vf,If,wf;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,u,h){return a==Array.prototype||a==Object.prototype||(a[u]=h.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Mi=="object"&&Mi];for(var u=0;u<a.length;++u){var h=a[u];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function s(a,u){if(u)e:{var h=r;a=a.split(".");for(var p=0;p<a.length-1;p++){var A=a[p];if(!(A in h))break e;h=h[A]}a=a[a.length-1],p=h[a],u=u(p),u!=p&&u!=null&&e(h,a,{configurable:!0,writable:!0,value:u})}}function i(a,u){a instanceof String&&(a+="");var h=0,p=!1,A={next:function(){if(!p&&h<a.length){var D=h++;return{value:u(D,a[D]),done:!1}}return p=!0,{done:!0,value:void 0}}};return A[Symbol.iterator]=function(){return A},A}s("Array.prototype.values",function(a){return a||function(){return i(this,function(u,h){return h})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(a){var u=typeof a;return u=u!="object"?u:a?Array.isArray(a)?"array":u:"null",u=="array"||u=="object"&&typeof a.length=="number"}function d(a){var u=typeof a;return u=="object"&&a!=null||u=="function"}function f(a,u,h){return a.call.apply(a.bind,arguments)}function m(a,u,h){if(!a)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var A=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(A,p),a.apply(u,A)}}return function(){return a.apply(u,arguments)}}function _(a,u,h){return _=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:m,_.apply(null,arguments)}function w(a,u){var h=Array.prototype.slice.call(arguments,1);return function(){var p=h.slice();return p.push.apply(p,arguments),a.apply(this,p)}}function P(a,u){function h(){}h.prototype=u.prototype,a.aa=u.prototype,a.prototype=new h,a.prototype.constructor=a,a.Qb=function(p,A,D){for(var L=Array(arguments.length-2),pe=2;pe<arguments.length;pe++)L[pe-2]=arguments[pe];return u.prototype[A].apply(p,L)}}function C(a){const u=a.length;if(0<u){const h=Array(u);for(let p=0;p<u;p++)h[p]=a[p];return h}return[]}function k(a,u){for(let h=1;h<arguments.length;h++){const p=arguments[h];if(l(p)){const A=a.length||0,D=p.length||0;a.length=A+D;for(let L=0;L<D;L++)a[A+L]=p[L]}else a.push(p)}}class F{constructor(u,h){this.i=u,this.j=h,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function $(a){return/^[\s\xa0]*$/.test(a)}function V(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function B(a){return B[" "](a),a}B[" "]=function(){};var K=V().indexOf("Gecko")!=-1&&!(V().toLowerCase().indexOf("webkit")!=-1&&V().indexOf("Edge")==-1)&&!(V().indexOf("Trident")!=-1||V().indexOf("MSIE")!=-1)&&V().indexOf("Edge")==-1;function J(a,u,h){for(const p in a)u.call(h,a[p],p,a)}function T(a,u){for(const h in a)u.call(void 0,a[h],h,a)}function y(a){const u={};for(const h in a)u[h]=a[h];return u}const v="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function E(a,u){let h,p;for(let A=1;A<arguments.length;A++){p=arguments[A];for(h in p)a[h]=p[h];for(let D=0;D<v.length;D++)h=v[D],Object.prototype.hasOwnProperty.call(p,h)&&(a[h]=p[h])}}function b(a){var u=1;a=a.split(":");const h=[];for(;0<u&&a.length;)h.push(a.shift()),u--;return a.length&&h.push(a.join(":")),h}function R(a){c.setTimeout(()=>{throw a},0)}function I(){var a=Jt;let u=null;return a.g&&(u=a.g,a.g=a.g.next,a.g||(a.h=null),u.next=null),u}class ot{constructor(){this.h=this.g=null}add(u,h){const p=xt.get();p.set(u,h),this.h?this.h.next=p:this.g=p,this.h=p}}var xt=new F(()=>new ht,a=>a.reset());class ht{constructor(){this.next=this.g=this.h=null}set(u,h){this.h=u,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let Qt,vt=!1,Jt=new ot,Sn=()=>{const a=c.Promise.resolve(void 0);Qt=()=>{a.then(da)}};var da=()=>{for(var a;a=I();){try{a.h.call(a.g)}catch(h){R(h)}var u=xt;u.j(a),100>u.h&&(u.h++,a.next=u.g,u.g=a)}vt=!1};function Me(){this.s=this.s,this.C=this.C}Me.prototype.s=!1,Me.prototype.ma=function(){this.s||(this.s=!0,this.N())},Me.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Fe(a,u){this.type=a,this.g=this.target=u,this.defaultPrevented=!1}Fe.prototype.h=function(){this.defaultPrevented=!0};var It=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,u=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const h=()=>{};c.addEventListener("test",h,u),c.removeEventListener("test",h,u)}catch{}return a}();function Xt(a,u){if(Fe.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var h=this.type=a.type,p=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=u,u=a.relatedTarget){if(K){e:{try{B(u.nodeName);var A=!0;break e}catch{}A=!1}A||(u=null)}}else h=="mouseover"?u=a.fromElement:h=="mouseout"&&(u=a.toElement);this.relatedTarget=u,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:_i[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Xt.aa.h.call(this)}}P(Xt,Fe);var _i={2:"touch",3:"pen",4:"mouse"};Xt.prototype.h=function(){Xt.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Pn="closure_listenable_"+(1e6*Math.random()|0),yi=0;function vi(a,u,h,p,A){this.listener=a,this.proxy=null,this.src=u,this.type=h,this.capture=!!p,this.ha=A,this.key=++yi,this.da=this.fa=!1}function Cn(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function kn(a){this.src=a,this.g={},this.h=0}kn.prototype.add=function(a,u,h,p,A){var D=a.toString();a=this.g[D],a||(a=this.g[D]=[],this.h++);var L=hr(a,u,p,A);return-1<L?(u=a[L],h||(u.fa=!1)):(u=new vi(u,this.src,D,!!p,A),u.fa=h,a.push(u)),u};function dr(a,u){var h=u.type;if(h in a.g){var p=a.g[h],A=Array.prototype.indexOf.call(p,u,void 0),D;(D=0<=A)&&Array.prototype.splice.call(p,A,1),D&&(Cn(u),a.g[h].length==0&&(delete a.g[h],a.h--))}}function hr(a,u,h,p){for(var A=0;A<a.length;++A){var D=a[A];if(!D.da&&D.listener==u&&D.capture==!!h&&D.ha==p)return A}return-1}var j="closure_lm_"+(1e6*Math.random()|0),U={};function te(a,u,h,p,A){if(Array.isArray(u)){for(var D=0;D<u.length;D++)te(a,u[D],h,p,A);return null}return h=Ue(h),a&&a[Pn]?a.K(u,h,d(p)?!!p.capture:!1,A):re(a,u,h,!1,p,A)}function re(a,u,h,p,A,D){if(!u)throw Error("Invalid event type");var L=d(A)?!!A.capture:!!A,pe=Ae(a);if(pe||(a[j]=pe=new kn(a)),h=pe.add(u,h,p,L,D),h.proxy)return h;if(p=W(),h.proxy=p,p.src=a,p.listener=h,a.addEventListener)It||(A=L),A===void 0&&(A=!1),a.addEventListener(u.toString(),p,A);else if(a.attachEvent)a.attachEvent(ue(u.toString()),p);else if(a.addListener&&a.removeListener)a.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return h}function W(){function a(h){return u.call(a.src,a.listener,h)}const u=be;return a}function ye(a,u,h,p,A){if(Array.isArray(u))for(var D=0;D<u.length;D++)ye(a,u[D],h,p,A);else p=d(p)?!!p.capture:!!p,h=Ue(h),a&&a[Pn]?(a=a.i,u=String(u).toString(),u in a.g&&(D=a.g[u],h=hr(D,h,p,A),-1<h&&(Cn(D[h]),Array.prototype.splice.call(D,h,1),D.length==0&&(delete a.g[u],a.h--)))):a&&(a=Ae(a))&&(u=a.g[u.toString()],a=-1,u&&(a=hr(u,h,p,A)),(h=-1<a?u[a]:null)&&we(h))}function we(a){if(typeof a!="number"&&a&&!a.da){var u=a.src;if(u&&u[Pn])dr(u.i,a);else{var h=a.type,p=a.proxy;u.removeEventListener?u.removeEventListener(h,p,a.capture):u.detachEvent?u.detachEvent(ue(h),p):u.addListener&&u.removeListener&&u.removeListener(p),(h=Ae(u))?(dr(h,a),h.h==0&&(h.src=null,u[j]=null)):Cn(a)}}}function ue(a){return a in U?U[a]:U[a]="on"+a}function be(a,u){if(a.da)a=!0;else{u=new Xt(u,this);var h=a.listener,p=a.ha||a.src;a.fa&&we(a),a=h.call(p,u)}return a}function Ae(a){return a=a[j],a instanceof kn?a:null}var he="__closure_events_fn_"+(1e9*Math.random()>>>0);function Ue(a){return typeof a=="function"?a:(a[he]||(a[he]=function(u){return a.handleEvent(u)}),a[he])}function me(){Me.call(this),this.i=new kn(this),this.M=this,this.F=null}P(me,Me),me.prototype[Pn]=!0,me.prototype.removeEventListener=function(a,u,h,p){ye(this,a,u,h,p)};function $e(a,u){var h,p=a.F;if(p)for(h=[];p;p=p.F)h.push(p);if(a=a.M,p=u.type||u,typeof u=="string")u=new Fe(u,a);else if(u instanceof Fe)u.target=u.target||a;else{var A=u;u=new Fe(p,a),E(u,A)}if(A=!0,h)for(var D=h.length-1;0<=D;D--){var L=u.g=h[D];A=fr(L,p,!0,u)&&A}if(L=u.g=a,A=fr(L,p,!0,u)&&A,A=fr(L,p,!1,u)&&A,h)for(D=0;D<h.length;D++)L=u.g=h[D],A=fr(L,p,!1,u)&&A}me.prototype.N=function(){if(me.aa.N.call(this),this.i){var a=this.i,u;for(u in a.g){for(var h=a.g[u],p=0;p<h.length;p++)Cn(h[p]);delete a.g[u],a.h--}}this.F=null},me.prototype.K=function(a,u,h,p){return this.i.add(String(a),u,!1,h,p)},me.prototype.L=function(a,u,h,p){return this.i.add(String(a),u,!0,h,p)};function fr(a,u,h,p){if(u=a.i.g[String(u)],!u)return!0;u=u.concat();for(var A=!0,D=0;D<u.length;++D){var L=u[D];if(L&&!L.da&&L.capture==h){var pe=L.listener,je=L.ha||L.src;L.fa&&dr(a.i,L),A=pe.call(je,p)!==!1&&A}}return A&&!p.defaultPrevented}function Dn(a,u,h){if(typeof a=="function")h&&(a=_(a,h));else if(a&&typeof a.handleEvent=="function")a=_(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:c.setTimeout(a,u||0)}function xn(a){a.g=Dn(()=>{a.g=null,a.i&&(a.i=!1,xn(a))},a.l);const u=a.h;a.h=null,a.m.apply(null,u)}class ha extends Me{constructor(u,h){super(),this.m=u,this.l=h,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:xn(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Vn(a){Me.call(this),this.h=a,this.g={}}P(Vn,Me);var Ii=[];function X(a){J(a.g,function(u,h){this.g.hasOwnProperty(h)&&we(u)},a),a.g={}}Vn.prototype.N=function(){Vn.aa.N.call(this),X(this)},Vn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Xe=c.JSON.stringify,sg=c.JSON.parse,ig=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function fa(){}fa.prototype.h=null;function Ml(a){return a.h||(a.h=a.i())}function Fl(){}var es={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function ma(){Fe.call(this,"d")}P(ma,Fe);function pa(){Fe.call(this,"c")}P(pa,Fe);var Nn={},Bl=null;function wi(){return Bl=Bl||new me}Nn.La="serverreachability";function Ul(a){Fe.call(this,Nn.La,a)}P(Ul,Fe);function ts(a){const u=wi();$e(u,new Ul(u))}Nn.STAT_EVENT="statevent";function $l(a,u){Fe.call(this,Nn.STAT_EVENT,a),this.stat=u}P($l,Fe);function Ye(a){const u=wi();$e(u,new $l(u,a))}Nn.Ma="timingevent";function jl(a,u){Fe.call(this,Nn.Ma,a),this.size=u}P(jl,Fe);function ns(a,u){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},u)}function rs(){this.g=!0}rs.prototype.xa=function(){this.g=!1};function og(a,u,h,p,A,D){a.info(function(){if(a.g)if(D)for(var L="",pe=D.split("&"),je=0;je<pe.length;je++){var ae=pe[je].split("=");if(1<ae.length){var Ge=ae[0];ae=ae[1];var ze=Ge.split("_");L=2<=ze.length&&ze[1]=="type"?L+(Ge+"="+ae+"&"):L+(Ge+"=redacted&")}}else L=null;else L=D;return"XMLHTTP REQ ("+p+") [attempt "+A+"]: "+u+`
`+h+`
`+L})}function ag(a,u,h,p,A,D,L){a.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+A+"]: "+u+`
`+h+`
`+D+" "+L})}function mr(a,u,h,p){a.info(function(){return"XMLHTTP TEXT ("+u+"): "+lg(a,h)+(p?" "+p:"")})}function cg(a,u){a.info(function(){return"TIMEOUT: "+u})}rs.prototype.info=function(){};function lg(a,u){if(!a.g)return u;if(!u)return null;try{var h=JSON.parse(u);if(h){for(a=0;a<h.length;a++)if(Array.isArray(h[a])){var p=h[a];if(!(2>p.length)){var A=p[1];if(Array.isArray(A)&&!(1>A.length)){var D=A[0];if(D!="noop"&&D!="stop"&&D!="close")for(var L=1;L<A.length;L++)A[L]=""}}}}return Xe(h)}catch{return u}}var Ei={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},ql={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ga;function Ti(){}P(Ti,fa),Ti.prototype.g=function(){return new XMLHttpRequest},Ti.prototype.i=function(){return{}},ga=new Ti;function Yt(a,u,h,p){this.j=a,this.i=u,this.l=h,this.R=p||1,this.U=new Vn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Gl}function Gl(){this.i=null,this.g="",this.h=!1}var zl={},_a={};function ya(a,u,h){a.L=1,a.v=Si(Vt(u)),a.m=h,a.P=!0,Kl(a,null)}function Kl(a,u){a.F=Date.now(),bi(a),a.A=Vt(a.v);var h=a.A,p=a.R;Array.isArray(p)||(p=[String(p)]),ou(h.i,"t",p),a.C=0,h=a.j.J,a.h=new Gl,a.g=bu(a.j,h?u:null,!a.m),0<a.O&&(a.M=new ha(_(a.Y,a,a.g),a.O)),u=a.U,h=a.g,p=a.ca;var A="readystatechange";Array.isArray(A)||(A&&(Ii[0]=A.toString()),A=Ii);for(var D=0;D<A.length;D++){var L=te(h,A[D],p||u.handleEvent,!1,u.h||u);if(!L)break;u.g[L.key]=L}u=a.H?y(a.H):{},a.m?(a.u||(a.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,u)):(a.u="GET",a.g.ea(a.A,a.u,null,u)),ts(),og(a.i,a.u,a.A,a.l,a.R,a.m)}Yt.prototype.ca=function(a){a=a.target;const u=this.M;u&&Nt(a)==3?u.j():this.Y(a)},Yt.prototype.Y=function(a){try{if(a==this.g)e:{const ze=Nt(this.g);var u=this.g.Ba();const _r=this.g.Z();if(!(3>ze)&&(ze!=3||this.g&&(this.h.h||this.g.oa()||fu(this.g)))){this.J||ze!=4||u==7||(u==8||0>=_r?ts(3):ts(2)),va(this);var h=this.g.Z();this.X=h;t:if(Hl(this)){var p=fu(this.g);a="";var A=p.length,D=Nt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Ln(this),ss(this);var L="";break t}this.h.i=new c.TextDecoder}for(u=0;u<A;u++)this.h.h=!0,a+=this.h.i.decode(p[u],{stream:!(D&&u==A-1)});p.length=0,this.h.g+=a,this.C=0,L=this.h.g}else L=this.g.oa();if(this.o=h==200,ag(this.i,this.u,this.A,this.l,this.R,ze,h),this.o){if(this.T&&!this.K){t:{if(this.g){var pe,je=this.g;if((pe=je.g?je.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!$(pe)){var ae=pe;break t}}ae=null}if(h=ae)mr(this.i,this.l,h,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Ia(this,h);else{this.o=!1,this.s=3,Ye(12),Ln(this),ss(this);break e}}if(this.P){h=!0;let mt;for(;!this.J&&this.C<L.length;)if(mt=ug(this,L),mt==_a){ze==4&&(this.s=4,Ye(14),h=!1),mr(this.i,this.l,null,"[Incomplete Response]");break}else if(mt==zl){this.s=4,Ye(15),mr(this.i,this.l,L,"[Invalid Chunk]"),h=!1;break}else mr(this.i,this.l,mt,null),Ia(this,mt);if(Hl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ze!=4||L.length!=0||this.h.h||(this.s=1,Ye(16),h=!1),this.o=this.o&&h,!h)mr(this.i,this.l,L,"[Invalid Chunked Response]"),Ln(this),ss(this);else if(0<L.length&&!this.W){this.W=!0;var Ge=this.j;Ge.g==this&&Ge.ba&&!Ge.M&&(Ge.j.info("Great, no buffering proxy detected. Bytes received: "+L.length),Ra(Ge),Ge.M=!0,Ye(11))}}else mr(this.i,this.l,L,null),Ia(this,L);ze==4&&Ln(this),this.o&&!this.J&&(ze==4?Iu(this.j,this):(this.o=!1,bi(this)))}else Sg(this.g),h==400&&0<L.indexOf("Unknown SID")?(this.s=3,Ye(12)):(this.s=0,Ye(13)),Ln(this),ss(this)}}}catch{}finally{}};function Hl(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function ug(a,u){var h=a.C,p=u.indexOf(`
`,h);return p==-1?_a:(h=Number(u.substring(h,p)),isNaN(h)?zl:(p+=1,p+h>u.length?_a:(u=u.slice(p,p+h),a.C=p+h,u)))}Yt.prototype.cancel=function(){this.J=!0,Ln(this)};function bi(a){a.S=Date.now()+a.I,Wl(a,a.I)}function Wl(a,u){if(a.B!=null)throw Error("WatchDog timer not null");a.B=ns(_(a.ba,a),u)}function va(a){a.B&&(c.clearTimeout(a.B),a.B=null)}Yt.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(cg(this.i,this.A),this.L!=2&&(ts(),Ye(17)),Ln(this),this.s=2,ss(this)):Wl(this,this.S-a)};function ss(a){a.j.G==0||a.J||Iu(a.j,a)}function Ln(a){va(a);var u=a.M;u&&typeof u.ma=="function"&&u.ma(),a.M=null,X(a.U),a.g&&(u=a.g,a.g=null,u.abort(),u.ma())}function Ia(a,u){try{var h=a.j;if(h.G!=0&&(h.g==a||wa(h.h,a))){if(!a.K&&wa(h.h,a)&&h.G==3){try{var p=h.Da.g.parse(u)}catch{p=null}if(Array.isArray(p)&&p.length==3){var A=p;if(A[0]==0){e:if(!h.u){if(h.g)if(h.g.F+3e3<a.F)Vi(h),Di(h);else break e;Aa(h),Ye(18)}}else h.za=A[1],0<h.za-h.T&&37500>A[2]&&h.F&&h.v==0&&!h.C&&(h.C=ns(_(h.Za,h),6e3));if(1>=Xl(h.h)&&h.ca){try{h.ca()}catch{}h.ca=void 0}}else Mn(h,11)}else if((a.K||h.g==a)&&Vi(h),!$(u))for(A=h.Da.g.parse(u),u=0;u<A.length;u++){let ae=A[u];if(h.T=ae[0],ae=ae[1],h.G==2)if(ae[0]=="c"){h.K=ae[1],h.ia=ae[2];const Ge=ae[3];Ge!=null&&(h.la=Ge,h.j.info("VER="+h.la));const ze=ae[4];ze!=null&&(h.Aa=ze,h.j.info("SVER="+h.Aa));const _r=ae[5];_r!=null&&typeof _r=="number"&&0<_r&&(p=1.5*_r,h.L=p,h.j.info("backChannelRequestTimeoutMs_="+p)),p=h;const mt=a.g;if(mt){const Li=mt.g?mt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Li){var D=p.h;D.g||Li.indexOf("spdy")==-1&&Li.indexOf("quic")==-1&&Li.indexOf("h2")==-1||(D.j=D.l,D.g=new Set,D.h&&(Ea(D,D.h),D.h=null))}if(p.D){const Sa=mt.g?mt.g.getResponseHeader("X-HTTP-Session-Id"):null;Sa&&(p.ya=Sa,ve(p.I,p.D,Sa))}}h.G=3,h.l&&h.l.ua(),h.ba&&(h.R=Date.now()-a.F,h.j.info("Handshake RTT: "+h.R+"ms")),p=h;var L=a;if(p.qa=Tu(p,p.J?p.ia:null,p.W),L.K){Yl(p.h,L);var pe=L,je=p.L;je&&(pe.I=je),pe.B&&(va(pe),bi(pe)),p.g=L}else yu(p);0<h.i.length&&xi(h)}else ae[0]!="stop"&&ae[0]!="close"||Mn(h,7);else h.G==3&&(ae[0]=="stop"||ae[0]=="close"?ae[0]=="stop"?Mn(h,7):ba(h):ae[0]!="noop"&&h.l&&h.l.ta(ae),h.v=0)}}ts(4)}catch{}}var dg=class{constructor(a,u){this.g=a,this.map=u}};function Ql(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Jl(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Xl(a){return a.h?1:a.g?a.g.size:0}function wa(a,u){return a.h?a.h==u:a.g?a.g.has(u):!1}function Ea(a,u){a.g?a.g.add(u):a.h=u}function Yl(a,u){a.h&&a.h==u?a.h=null:a.g&&a.g.has(u)&&a.g.delete(u)}Ql.prototype.cancel=function(){if(this.i=Zl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Zl(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let u=a.i;for(const h of a.g.values())u=u.concat(h.D);return u}return C(a.i)}function hg(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(l(a)){for(var u=[],h=a.length,p=0;p<h;p++)u.push(a[p]);return u}u=[],h=0;for(p in a)u[h++]=a[p];return u}function fg(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(l(a)||typeof a=="string"){var u=[];a=a.length;for(var h=0;h<a;h++)u.push(h);return u}u=[],h=0;for(const p in a)u[h++]=p;return u}}}function eu(a,u){if(a.forEach&&typeof a.forEach=="function")a.forEach(u,void 0);else if(l(a)||typeof a=="string")Array.prototype.forEach.call(a,u,void 0);else for(var h=fg(a),p=hg(a),A=p.length,D=0;D<A;D++)u.call(void 0,p[D],h&&h[D],a)}var tu=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function mg(a,u){if(a){a=a.split("&");for(var h=0;h<a.length;h++){var p=a[h].indexOf("="),A=null;if(0<=p){var D=a[h].substring(0,p);A=a[h].substring(p+1)}else D=a[h];u(D,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function On(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof On){this.h=a.h,Ai(this,a.j),this.o=a.o,this.g=a.g,Ri(this,a.s),this.l=a.l;var u=a.i,h=new as;h.i=u.i,u.g&&(h.g=new Map(u.g),h.h=u.h),nu(this,h),this.m=a.m}else a&&(u=String(a).match(tu))?(this.h=!1,Ai(this,u[1]||"",!0),this.o=is(u[2]||""),this.g=is(u[3]||"",!0),Ri(this,u[4]),this.l=is(u[5]||"",!0),nu(this,u[6]||"",!0),this.m=is(u[7]||"")):(this.h=!1,this.i=new as(null,this.h))}On.prototype.toString=function(){var a=[],u=this.j;u&&a.push(os(u,ru,!0),":");var h=this.g;return(h||u=="file")&&(a.push("//"),(u=this.o)&&a.push(os(u,ru,!0),"@"),a.push(encodeURIComponent(String(h)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.s,h!=null&&a.push(":",String(h))),(h=this.l)&&(this.g&&h.charAt(0)!="/"&&a.push("/"),a.push(os(h,h.charAt(0)=="/"?_g:gg,!0))),(h=this.i.toString())&&a.push("?",h),(h=this.m)&&a.push("#",os(h,vg)),a.join("")};function Vt(a){return new On(a)}function Ai(a,u,h){a.j=h?is(u,!0):u,a.j&&(a.j=a.j.replace(/:$/,""))}function Ri(a,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);a.s=u}else a.s=null}function nu(a,u,h){u instanceof as?(a.i=u,Ig(a.i,a.h)):(h||(u=os(u,yg)),a.i=new as(u,a.h))}function ve(a,u,h){a.i.set(u,h)}function Si(a){return ve(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function is(a,u){return a?u?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function os(a,u,h){return typeof a=="string"?(a=encodeURI(a).replace(u,pg),h&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function pg(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var ru=/[#\/\?@]/g,gg=/[#\?:]/g,_g=/[#\?]/g,yg=/[#\?@]/g,vg=/#/g;function as(a,u){this.h=this.g=null,this.i=a||null,this.j=!!u}function Zt(a){a.g||(a.g=new Map,a.h=0,a.i&&mg(a.i,function(u,h){a.add(decodeURIComponent(u.replace(/\+/g," ")),h)}))}n=as.prototype,n.add=function(a,u){Zt(this),this.i=null,a=pr(this,a);var h=this.g.get(a);return h||this.g.set(a,h=[]),h.push(u),this.h+=1,this};function su(a,u){Zt(a),u=pr(a,u),a.g.has(u)&&(a.i=null,a.h-=a.g.get(u).length,a.g.delete(u))}function iu(a,u){return Zt(a),u=pr(a,u),a.g.has(u)}n.forEach=function(a,u){Zt(this),this.g.forEach(function(h,p){h.forEach(function(A){a.call(u,A,p,this)},this)},this)},n.na=function(){Zt(this);const a=Array.from(this.g.values()),u=Array.from(this.g.keys()),h=[];for(let p=0;p<u.length;p++){const A=a[p];for(let D=0;D<A.length;D++)h.push(u[p])}return h},n.V=function(a){Zt(this);let u=[];if(typeof a=="string")iu(this,a)&&(u=u.concat(this.g.get(pr(this,a))));else{a=Array.from(this.g.values());for(let h=0;h<a.length;h++)u=u.concat(a[h])}return u},n.set=function(a,u){return Zt(this),this.i=null,a=pr(this,a),iu(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[u]),this.h+=1,this},n.get=function(a,u){return a?(a=this.V(a),0<a.length?String(a[0]):u):u};function ou(a,u,h){su(a,u),0<h.length&&(a.i=null,a.g.set(pr(a,u),C(h)),a.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],u=Array.from(this.g.keys());for(var h=0;h<u.length;h++){var p=u[h];const D=encodeURIComponent(String(p)),L=this.V(p);for(p=0;p<L.length;p++){var A=D;L[p]!==""&&(A+="="+encodeURIComponent(String(L[p]))),a.push(A)}}return this.i=a.join("&")};function pr(a,u){return u=String(u),a.j&&(u=u.toLowerCase()),u}function Ig(a,u){u&&!a.j&&(Zt(a),a.i=null,a.g.forEach(function(h,p){var A=p.toLowerCase();p!=A&&(su(this,p),ou(this,A,h))},a)),a.j=u}function wg(a,u){const h=new rs;if(c.Image){const p=new Image;p.onload=w(en,h,"TestLoadImage: loaded",!0,u,p),p.onerror=w(en,h,"TestLoadImage: error",!1,u,p),p.onabort=w(en,h,"TestLoadImage: abort",!1,u,p),p.ontimeout=w(en,h,"TestLoadImage: timeout",!1,u,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=a}else u(!1)}function Eg(a,u){const h=new rs,p=new AbortController,A=setTimeout(()=>{p.abort(),en(h,"TestPingServer: timeout",!1,u)},1e4);fetch(a,{signal:p.signal}).then(D=>{clearTimeout(A),D.ok?en(h,"TestPingServer: ok",!0,u):en(h,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(A),en(h,"TestPingServer: error",!1,u)})}function en(a,u,h,p,A){try{A&&(A.onload=null,A.onerror=null,A.onabort=null,A.ontimeout=null),p(h)}catch{}}function Tg(){this.g=new ig}function bg(a,u,h){const p=h||"";try{eu(a,function(A,D){let L=A;d(A)&&(L=Xe(A)),u.push(p+D+"="+encodeURIComponent(L))})}catch(A){throw u.push(p+"type="+encodeURIComponent("_badmap")),A}}function Pi(a){this.l=a.Ub||null,this.j=a.eb||!1}P(Pi,fa),Pi.prototype.g=function(){return new Ci(this.l,this.j)},Pi.prototype.i=function(a){return function(){return a}}({});function Ci(a,u){me.call(this),this.D=a,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}P(Ci,me),n=Ci.prototype,n.open=function(a,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=u,this.readyState=1,ls(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(u.body=a),(this.D||c).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,cs(this)),this.readyState=0},n.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,ls(this)),this.g&&(this.readyState=3,ls(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;au(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function au(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}n.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var u=a.value?a.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!a.done}))&&(this.response=this.responseText+=u)}a.done?cs(this):ls(this),this.readyState==3&&au(this)}},n.Ra=function(a){this.g&&(this.response=this.responseText=a,cs(this))},n.Qa=function(a){this.g&&(this.response=a,cs(this))},n.ga=function(){this.g&&cs(this)};function cs(a){a.readyState=4,a.l=null,a.j=null,a.v=null,ls(a)}n.setRequestHeader=function(a,u){this.u.append(a,u)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],u=this.h.entries();for(var h=u.next();!h.done;)h=h.value,a.push(h[0]+": "+h[1]),h=u.next();return a.join(`\r
`)};function ls(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Ci.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function cu(a){let u="";return J(a,function(h,p){u+=p,u+=":",u+=h,u+=`\r
`}),u}function Ta(a,u,h){e:{for(p in h){var p=!1;break e}p=!0}p||(h=cu(h),typeof a=="string"?h!=null&&encodeURIComponent(String(h)):ve(a,u,h))}function Re(a){me.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}P(Re,me);var Ag=/^https?$/i,Rg=["POST","PUT"];n=Re.prototype,n.Ha=function(a){this.J=a},n.ea=function(a,u,h,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);u=u?u.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ga.g(),this.v=this.o?Ml(this.o):Ml(ga),this.g.onreadystatechange=_(this.Ea,this);try{this.B=!0,this.g.open(u,String(a),!0),this.B=!1}catch(D){lu(this,D);return}if(a=h||"",h=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var A in p)h.set(A,p[A]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const D of p.keys())h.set(D,p.get(D));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(h.keys()).find(D=>D.toLowerCase()=="content-type"),A=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Rg,u,void 0))||p||A||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[D,L]of h)this.g.setRequestHeader(D,L);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{hu(this),this.u=!0,this.g.send(a),this.u=!1}catch(D){lu(this,D)}};function lu(a,u){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=u,a.m=5,uu(a),ki(a)}function uu(a){a.A||(a.A=!0,$e(a,"complete"),$e(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,$e(this,"complete"),$e(this,"abort"),ki(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ki(this,!0)),Re.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?du(this):this.bb())},n.bb=function(){du(this)};function du(a){if(a.h&&typeof o<"u"&&(!a.v[1]||Nt(a)!=4||a.Z()!=2)){if(a.u&&Nt(a)==4)Dn(a.Ea,0,a);else if($e(a,"readystatechange"),Nt(a)==4){a.h=!1;try{const L=a.Z();e:switch(L){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var h;if(!(h=u)){var p;if(p=L===0){var A=String(a.D).match(tu)[1]||null;!A&&c.self&&c.self.location&&(A=c.self.location.protocol.slice(0,-1)),p=!Ag.test(A?A.toLowerCase():"")}h=p}if(h)$e(a,"complete"),$e(a,"success");else{a.m=6;try{var D=2<Nt(a)?a.g.statusText:""}catch{D=""}a.l=D+" ["+a.Z()+"]",uu(a)}}finally{ki(a)}}}}function ki(a,u){if(a.g){hu(a);const h=a.g,p=a.v[0]?()=>{}:null;a.g=null,a.v=null,u||$e(a,"ready");try{h.onreadystatechange=p}catch{}}}function hu(a){a.I&&(c.clearTimeout(a.I),a.I=null)}n.isActive=function(){return!!this.g};function Nt(a){return a.g?a.g.readyState:0}n.Z=function(){try{return 2<Nt(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(a){if(this.g){var u=this.g.responseText;return a&&u.indexOf(a)==0&&(u=u.substring(a.length)),sg(u)}};function fu(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Sg(a){const u={};a=(a.g&&2<=Nt(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<a.length;p++){if($(a[p]))continue;var h=b(a[p]);const A=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const D=u[A]||[];u[A]=D,D.push(h)}T(u,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function us(a,u,h){return h&&h.internalChannelParams&&h.internalChannelParams[a]||u}function mu(a){this.Aa=0,this.i=[],this.j=new rs,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=us("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=us("baseRetryDelayMs",5e3,a),this.cb=us("retryDelaySeedMs",1e4,a),this.Wa=us("forwardChannelMaxRetries",2,a),this.wa=us("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Ql(a&&a.concurrentRequestLimit),this.Da=new Tg,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=mu.prototype,n.la=8,n.G=1,n.connect=function(a,u,h,p){Ye(0),this.W=a,this.H=u||{},h&&p!==void 0&&(this.H.OSID=h,this.H.OAID=p),this.F=this.X,this.I=Tu(this,null,this.W),xi(this)};function ba(a){if(pu(a),a.G==3){var u=a.U++,h=Vt(a.I);if(ve(h,"SID",a.K),ve(h,"RID",u),ve(h,"TYPE","terminate"),ds(a,h),u=new Yt(a,a.j,u),u.L=2,u.v=Si(Vt(h)),h=!1,c.navigator&&c.navigator.sendBeacon)try{h=c.navigator.sendBeacon(u.v.toString(),"")}catch{}!h&&c.Image&&(new Image().src=u.v,h=!0),h||(u.g=bu(u.j,null),u.g.ea(u.v)),u.F=Date.now(),bi(u)}Eu(a)}function Di(a){a.g&&(Ra(a),a.g.cancel(),a.g=null)}function pu(a){Di(a),a.u&&(c.clearTimeout(a.u),a.u=null),Vi(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function xi(a){if(!Jl(a.h)&&!a.s){a.s=!0;var u=a.Ga;Qt||Sn(),vt||(Qt(),vt=!0),Jt.add(u,a),a.B=0}}function Pg(a,u){return Xl(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=u.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=ns(_(a.Ga,a,u),wu(a,a.B)),a.B++,!0)}n.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const A=new Yt(this,this.j,a);let D=this.o;if(this.S&&(D?(D=y(D),E(D,this.S)):D=this.S),this.m!==null||this.O||(A.H=D,D=null),this.P)e:{for(var u=0,h=0;h<this.i.length;h++){t:{var p=this.i[h];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(u+=p,4096<u){u=h;break e}if(u===4096||h===this.i.length-1){u=h+1;break e}}u=1e3}else u=1e3;u=_u(this,A,u),h=Vt(this.I),ve(h,"RID",a),ve(h,"CVER",22),this.D&&ve(h,"X-HTTP-Session-Id",this.D),ds(this,h),D&&(this.O?u="headers="+encodeURIComponent(String(cu(D)))+"&"+u:this.m&&Ta(h,this.m,D)),Ea(this.h,A),this.Ua&&ve(h,"TYPE","init"),this.P?(ve(h,"$req",u),ve(h,"SID","null"),A.T=!0,ya(A,h,null)):ya(A,h,u),this.G=2}}else this.G==3&&(a?gu(this,a):this.i.length==0||Jl(this.h)||gu(this))};function gu(a,u){var h;u?h=u.l:h=a.U++;const p=Vt(a.I);ve(p,"SID",a.K),ve(p,"RID",h),ve(p,"AID",a.T),ds(a,p),a.m&&a.o&&Ta(p,a.m,a.o),h=new Yt(a,a.j,h,a.B+1),a.m===null&&(h.H=a.o),u&&(a.i=u.D.concat(a.i)),u=_u(a,h,1e3),h.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Ea(a.h,h),ya(h,p,u)}function ds(a,u){a.H&&J(a.H,function(h,p){ve(u,p,h)}),a.l&&eu({},function(h,p){ve(u,p,h)})}function _u(a,u,h){h=Math.min(a.i.length,h);var p=a.l?_(a.l.Na,a.l,a):null;e:{var A=a.i;let D=-1;for(;;){const L=["count="+h];D==-1?0<h?(D=A[0].g,L.push("ofs="+D)):D=0:L.push("ofs="+D);let pe=!0;for(let je=0;je<h;je++){let ae=A[je].g;const Ge=A[je].map;if(ae-=D,0>ae)D=Math.max(0,A[je].g-100),pe=!1;else try{bg(Ge,L,"req"+ae+"_")}catch{p&&p(Ge)}}if(pe){p=L.join("&");break e}}}return a=a.i.splice(0,h),u.D=a,p}function yu(a){if(!a.g&&!a.u){a.Y=1;var u=a.Fa;Qt||Sn(),vt||(Qt(),vt=!0),Jt.add(u,a),a.v=0}}function Aa(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=ns(_(a.Fa,a),wu(a,a.v)),a.v++,!0)}n.Fa=function(){if(this.u=null,vu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=ns(_(this.ab,this),a)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ye(10),Di(this),vu(this))};function Ra(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function vu(a){a.g=new Yt(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var u=Vt(a.qa);ve(u,"RID","rpc"),ve(u,"SID",a.K),ve(u,"AID",a.T),ve(u,"CI",a.F?"0":"1"),!a.F&&a.ja&&ve(u,"TO",a.ja),ve(u,"TYPE","xmlhttp"),ds(a,u),a.m&&a.o&&Ta(u,a.m,a.o),a.L&&(a.g.I=a.L);var h=a.g;a=a.ia,h.L=1,h.v=Si(Vt(u)),h.m=null,h.P=!0,Kl(h,a)}n.Za=function(){this.C!=null&&(this.C=null,Di(this),Aa(this),Ye(19))};function Vi(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function Iu(a,u){var h=null;if(a.g==u){Vi(a),Ra(a),a.g=null;var p=2}else if(wa(a.h,u))h=u.D,Yl(a.h,u),p=1;else return;if(a.G!=0){if(u.o)if(p==1){h=u.m?u.m.length:0,u=Date.now()-u.F;var A=a.B;p=wi(),$e(p,new jl(p,h)),xi(a)}else yu(a);else if(A=u.s,A==3||A==0&&0<u.X||!(p==1&&Pg(a,u)||p==2&&Aa(a)))switch(h&&0<h.length&&(u=a.h,u.i=u.i.concat(h)),A){case 1:Mn(a,5);break;case 4:Mn(a,10);break;case 3:Mn(a,6);break;default:Mn(a,2)}}}function wu(a,u){let h=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(h*=2),h*u}function Mn(a,u){if(a.j.info("Error code "+u),u==2){var h=_(a.fb,a),p=a.Xa;const A=!p;p=new On(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Ai(p,"https"),Si(p),A?wg(p.toString(),h):Eg(p.toString(),h)}else Ye(2);a.G=0,a.l&&a.l.sa(u),Eu(a),pu(a)}n.fb=function(a){a?(this.j.info("Successfully pinged google.com"),Ye(2)):(this.j.info("Failed to ping google.com"),Ye(1))};function Eu(a){if(a.G=0,a.ka=[],a.l){const u=Zl(a.h);(u.length!=0||a.i.length!=0)&&(k(a.ka,u),k(a.ka,a.i),a.h.i.length=0,C(a.i),a.i.length=0),a.l.ra()}}function Tu(a,u,h){var p=h instanceof On?Vt(h):new On(h);if(p.g!="")u&&(p.g=u+"."+p.g),Ri(p,p.s);else{var A=c.location;p=A.protocol,u=u?u+"."+A.hostname:A.hostname,A=+A.port;var D=new On(null);p&&Ai(D,p),u&&(D.g=u),A&&Ri(D,A),h&&(D.l=h),p=D}return h=a.D,u=a.ya,h&&u&&ve(p,h,u),ve(p,"VER",a.la),ds(a,p),p}function bu(a,u,h){if(u&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=a.Ca&&!a.pa?new Re(new Pi({eb:h})):new Re(a.pa),u.Ha(a.J),u}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Au(){}n=Au.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Ni(){}Ni.prototype.g=function(a,u){return new at(a,u)};function at(a,u){me.call(this),this.g=new mu(u),this.l=a,this.h=u&&u.messageUrlParams||null,a=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(a?a["X-WebChannel-Content-Type"]=u.messageContentType:a={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(a?a["X-WebChannel-Client-Profile"]=u.va:a={"X-WebChannel-Client-Profile":u.va}),this.g.S=a,(a=u&&u.Sb)&&!$(a)&&(this.g.m=a),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!$(u)&&(this.g.D=u,a=this.h,a!==null&&u in a&&(a=this.h,u in a&&delete a[u])),this.j=new gr(this)}P(at,me),at.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},at.prototype.close=function(){ba(this.g)},at.prototype.o=function(a){var u=this.g;if(typeof a=="string"){var h={};h.__data__=a,a=h}else this.u&&(h={},h.__data__=Xe(a),a=h);u.i.push(new dg(u.Ya++,a)),u.G==3&&xi(u)},at.prototype.N=function(){this.g.l=null,delete this.j,ba(this.g),delete this.g,at.aa.N.call(this)};function Ru(a){ma.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var u=a.__sm__;if(u){e:{for(const h in u){a=h;break e}a=void 0}(this.i=a)&&(a=this.i,u=u!==null&&a in u?u[a]:void 0),this.data=u}else this.data=a}P(Ru,ma);function Su(){pa.call(this),this.status=1}P(Su,pa);function gr(a){this.g=a}P(gr,Au),gr.prototype.ua=function(){$e(this.g,"a")},gr.prototype.ta=function(a){$e(this.g,new Ru(a))},gr.prototype.sa=function(a){$e(this.g,new Su)},gr.prototype.ra=function(){$e(this.g,"b")},Ni.prototype.createWebChannel=Ni.prototype.g,at.prototype.send=at.prototype.o,at.prototype.open=at.prototype.m,at.prototype.close=at.prototype.close,wf=function(){return new Ni},If=function(){return wi()},vf=Nn,Ya={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Ei.NO_ERROR=0,Ei.TIMEOUT=8,Ei.HTTP_ERROR=6,Qi=Ei,ql.COMPLETE="complete",yf=ql,Fl.EventType=es,es.OPEN="a",es.CLOSE="b",es.ERROR="c",es.MESSAGE="d",me.prototype.listen=me.prototype.K,ws=Fl,Re.prototype.listenOnce=Re.prototype.L,Re.prototype.getLastError=Re.prototype.Ka,Re.prototype.getLastErrorCode=Re.prototype.Ba,Re.prototype.getStatus=Re.prototype.Z,Re.prototype.getResponseJson=Re.prototype.Oa,Re.prototype.getResponseText=Re.prototype.oa,Re.prototype.send=Re.prototype.ea,Re.prototype.setWithCredentials=Re.prototype.Ha,_f=Re}).apply(typeof Mi<"u"?Mi:typeof self<"u"?self:typeof window<"u"?window:{});const sd="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function En(n){if(n.code!==x.FAILED_PRECONDITION||n.message!==Rf)throw n;N("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cd(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function cr(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Nf(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lr{constructor(e,t){this.position=e,this.inclusive=t}}function gd(n,e,t){let r=0;for(let s=0;s<n.position.length;s++){const i=e[s],o=n.position[s];if(i.field.isKeyField()?r=M.comparator(M.fromName(o.referenceValue),t.key):r=vn(o,t.data.field(i.field)),i.dir==="desc"&&(r*=-1),r!==0)break}return r}function _d(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!Ct(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qo{constructor(){this._=void 0}}function ww(n,e,t){return n instanceof Mr?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Bc(i)&&(i=Uc(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(t,e):n instanceof Fr?nm(n,e):n instanceof Br?rm(n,e):function(s,i){const o=tm(s,i),c=wd(o)+wd(s.Pe);return nc(o)&&nc(s.Pe)?em(c):qc(s.serializer,c)}(n,e)}function Ew(n,e,t){return n instanceof Fr?nm(n,e):n instanceof Br?rm(n,e):t}function tm(n,e){return n instanceof Qs?function(r){return nc(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Mr extends qo{}class Fr extends qo{constructor(e){super(),this.elements=e}}function nm(n,e){const t=sm(e);for(const r of n.elements)t.some(s=>Ct(s,r))||t.push(r);return{arrayValue:{values:t}}}class Br extends qo{constructor(e){super(),this.elements=e}}function rm(n,e){let t=sm(e);for(const r of n.elements)t=t.filter(s=>!Ct(s,r));return{arrayValue:{values:t}}}class Qs extends qo{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function wd(n){return Ie(n.integerValue||n.doubleValue)}function sm(n){return Ws(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kw=new zn([4294967295,4294967295],0);function Ad(n){const e=Cw().encode(n),t=new gf;return t.update(e),new Uint8Array(t.digest())}function Rd(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new zn([t,r],0),new zn([s,i],0)]}class Hc{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new Ts(`Invalid padding: ${t}`);if(r<0)throw new Ts(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new Ts(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new Ts(`Invalid padding when bitmap length is 0: ${t}`);this.Ie=8*e.length-t,this.Te=zn.fromNumber(this.Ie)}Ee(e,t,r){let s=e.add(t.multiply(zn.fromNumber(r)));return s.compare(kw)===1&&(s=new zn([s.getBits(0),s.getBits(1)],0)),s.modulo(this.Te).toNumber()}de(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}mightContain(e){if(this.Ie===0)return!1;const t=Ad(e),[r,s]=Rd(t);for(let i=0;i<this.hashCount;i++){const o=this.Ee(r,s,i);if(!this.de(o))return!1}return!0}static create(e,t,r){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new Hc(i,s,t);return r.forEach(c=>o.insert(c)),o}insert(e){if(this.Ie===0)return;const t=Ad(e),[r,s]=Rd(t);for(let i=0;i<this.hashCount;i++){const o=this.Ee(r,s,i);this.Ae(o)}}Ae(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class Ts extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,di.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new ui(H.min(),s,new _e(Y),ct(),ne())}}class di{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new di(r,t,ne(),ne(),ne())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class to{constructor(e,t,r,s){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=s}}class um{constructor(e,t){this.targetId=e,this.me=t}}class dm{constructor(e,t,r=xe.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class Sd{constructor(){this.fe=0,this.ge=Cd(),this.pe=xe.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=ne(),t=ne(),r=ne();return this.ge.forEach((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:q()}}),new di(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=Cd()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,z(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class Dw{constructor(e){this.Le=e,this.Be=new Map,this.ke=ct(),this.qe=Pd(),this.Qe=new _e(Y)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:q()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,s)=>{this.ze(s)&&t(s)})}He(e){const t=e.targetId,r=e.me.count,s=this.Je(t);if(s){const i=s.target;if(vo(i))if(r===0){const o=new M(i.path);this.Ue(t,o,Se.newNoDocument(o,H.min()))}else z(r===1);else{const o=this.Ye(t);if(o!==r){const c=this.Ze(e),l=c?this.Xe(c,e,o):1;if(l!==0){this.je(t);const d=l===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,d)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let o,c;try{o=yn(r).toUint8Array()}catch(l){if(l instanceof Lf)return $s("Decoding the base64 bloom filter in existence filter failed ("+l.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw l}try{c=new Hc(o,s,i)}catch(l){return $s(l instanceof Ts?"BloomFilter error: ":"Applying bloom filter failed: ",l),null}return c.Ie===0?null:c}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let s=0;return r.forEach(i=>{const o=this.Le.tt(),c=`projects/${o.projectId}/databases/${o.database}/documents/${i.path.canonicalString()}`;e.mightContain(c)||(this.Ue(t,i,null),s++)}),s}rt(e){const t=new Map;this.Be.forEach((i,o)=>{const c=this.Je(o);if(c){if(i.current&&vo(c.target)){const l=new M(c.target.path);this.ke.get(l)!==null||this.it(o,l)||this.Ue(o,l,Se.newNoDocument(l,e))}i.be&&(t.set(o,i.ve()),i.Ce())}});let r=ne();this.qe.forEach((i,o)=>{let c=!0;o.forEachWhile(l=>{const d=this.Je(l);return!d||d.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)}),c&&(r=r.add(i))}),this.ke.forEach((i,o)=>o.setReadTime(e));const s=new ui(e,t,this.Qe,this.ke,r);return this.ke=ct(),this.qe=Pd(),this.Qe=new _e(Y),s}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const s=this.Ge(e);this.it(e,t)?s.Fe(t,1):s.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new Sd,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new fe(Y),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||N("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new Sd),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function Pd(){return new _e(M.comparator)}function Cd(){return new _e(M.comparator)}const xw={asc:"ASCENDING",desc:"DESCENDING"},Vw={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},Nw={and:"AND",or:"OR"};class Lw{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function cc(n,e){return n.useProto3Json||Bo(e)?e:{value:e}}function Ur(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function hm(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function Ow(n,e){return Ur(n,e.toTimestamp())}function tt(n){return z(!!n),H.fromTimestamp(function(t){const r=qt(t);return new Te(r.seconds,r.nanos)}(n))}function Wc(n,e){return lc(n,e).canonicalString()}function lc(n,e){const t=function(s){return new ce(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function fm(n){const e=ce.fromString(n);return z(Em(e)),e}function wo(n,e){return Wc(n.databaseId,e.path)}function Kn(n,e){const t=fm(e);if(t.get(1)!==n.databaseId.projectId)throw new O(x.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new O(x.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new M(gm(t))}function mm(n,e){return Wc(n.databaseId,e)}function pm(n){const e=fm(n);return e.length===4?ce.emptyPath():gm(e)}function uc(n){return new ce(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function gm(n){return z(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function kd(n,e,t){return{name:wo(n,e),fields:t.value.mapValue.fields}}function Mw(n,e,t){const r=Kn(n,e.name),s=tt(e.updateTime),i=e.createTime?tt(e.createTime):H.min(),o=new We({mapValue:{fields:e.fields}}),c=Se.newFoundDocument(r,s,i,o);return t&&c.setHasCommittedMutations(),t?c.setHasCommittedMutations():c}function Fw(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:q()}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=function(d,f){return d.useProto3Json?(z(f===void 0||typeof f=="string"),xe.fromBase64String(f||"")):(z(f===void 0||f instanceof Buffer||f instanceof Uint8Array),xe.fromUint8Array(f||new Uint8Array))}(n,e.targetChange.resumeToken),o=e.targetChange.cause,c=o&&function(d){const f=d.code===void 0?x.UNKNOWN:lm(d.code);return new O(f,d.message||"")}(o);t=new dm(r,s,i,c||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=Kn(n,r.document.name),i=tt(r.document.updateTime),o=r.document.createTime?tt(r.document.createTime):H.min(),c=new We({mapValue:{fields:r.document.fields}}),l=Se.newFoundDocument(s,i,o,c),d=r.targetIds||[],f=r.removedTargetIds||[];t=new to(d,f,l.key,l)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=Kn(n,r.document),i=r.readTime?tt(r.readTime):H.min(),o=Se.newNoDocument(s,i),c=r.removedTargetIds||[];t=new to([],c,o.key,o)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=Kn(n,r.document),i=r.removedTargetIds||[];t=new to([],i,s,null)}else{if(!("filter"in e))return q();{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,o=new Sw(s,i),c=r.targetId;t=new um(c,o)}}return t}function Eo(n,e){let t;if(e instanceof Wr)t={update:kd(n,e.key,e.value)};else if(e instanceof zo)t={delete:wo(n,e.key)};else if(e instanceof Ht)t={update:kd(n,e.key,e.data),updateMask:Gw(e.fieldMask)};else{if(!(e instanceof cm))return q();t={verify:wo(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(i,o){const c=o.transform;if(c instanceof Mr)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(c instanceof Fr)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:c.elements}};if(c instanceof Br)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:c.elements}};if(c instanceof Qs)return{fieldPath:o.field.canonicalString(),increment:c.Pe};throw q()}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,i){return i.updateTime!==void 0?{updateTime:Ow(s,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:q()}(n,e.precondition)),t}function dc(n,e){const t=e.currentDocument?function(i){return i.updateTime!==void 0?Qe.updateTime(tt(i.updateTime)):i.exists!==void 0?Qe.exists(i.exists):Qe.none()}(e.currentDocument):Qe.none(),r=e.updateTransforms?e.updateTransforms.map(s=>function(o,c){let l=null;if("setToServerValue"in c)z(c.setToServerValue==="REQUEST_TIME"),l=new Mr;else if("appendMissingElements"in c){const f=c.appendMissingElements.values||[];l=new Fr(f)}else if("removeAllFromArray"in c){const f=c.removeAllFromArray.values||[];l=new Br(f)}else"increment"in c?l=new Qs(o,c.increment):q();const d=Ee.fromServerFormat(c.fieldPath);return new im(d,l)}(n,s)):[];if(e.update){e.update.name;const s=Kn(n,e.update.name),i=new We({mapValue:{fields:e.update.fields}});if(e.updateMask){const o=function(l){const d=l.fieldPaths||[];return new it(d.map(f=>Ee.fromServerFormat(f)))}(e.updateMask);return new Ht(s,i,o,t,r)}return new Wr(s,i,t,r)}if(e.delete){const s=Kn(n,e.delete);return new zo(s,t)}if(e.verify){const s=Kn(n,e.verify);return new cm(s,t)}return q()}function Bw(n,e){return n&&n.length>0?(z(e!==void 0),n.map(t=>function(s,i){let o=s.updateTime?tt(s.updateTime):tt(i);return o.isEqual(H.min())&&(o=tt(i)),new bw(o,s.transformResults||[])}(t,e))):[]}function _m(n,e){return{documents:[mm(n,e.path)]}}function ym(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=mm(n,s);const i=function(d){if(d.length!==0)return wm(de.create(d,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const o=function(d){if(d.length!==0)return d.map(f=>function(_){return{field:br(_.field),direction:$w(_.dir)}}(f))}(e.orderBy);o&&(t.structuredQuery.orderBy=o);const c=cc(n,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{_t:t,parent:s}}function vm(n){let e=pm(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){z(r===1);const f=t.from[0];f.allDescendants?s=f.collectionId:e=e.child(f.collectionId)}let i=[];t.where&&(i=function(m){const _=Im(m);return _ instanceof de&&$c(_)?_.getFilters():[_]}(t.where));let o=[];t.orderBy&&(o=function(m){return m.map(_=>function(P){return new yo(Ar(P.field),function(k){switch(k){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(P.direction))}(_))}(t.orderBy));let c=null;t.limit&&(c=function(m){let _;return _=typeof m=="object"?m.value:m,Bo(_)?null:_}(t.limit));let l=null;t.startAt&&(l=function(m){const _=!!m.before,w=m.values||[];return new Lr(w,_)}(t.startAt));let d=null;return t.endAt&&(d=function(m){const _=!m.before,w=m.values||[];return new Lr(w,_)}(t.endAt)),Kf(e,s,o,i,c,"F",l,d)}function Uw(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return q()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Im(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=Ar(t.unaryFilter.field);return ie.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=Ar(t.unaryFilter.field);return ie.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=Ar(t.unaryFilter.field);return ie.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=Ar(t.unaryFilter.field);return ie.create(o,"!=",{nullValue:"NULL_VALUE"});default:return q()}}(n):n.fieldFilter!==void 0?function(t){return ie.create(Ar(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return q()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return de.create(t.compositeFilter.filters.map(r=>Im(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return q()}}(t.compositeFilter.op))}(n):q()}function $w(n){return xw[n]}function jw(n){return Vw[n]}function qw(n){return Nw[n]}function br(n){return{fieldPath:n.canonicalString()}}function Ar(n){return Ee.fromServerFormat(n.fieldPath)}function wm(n){return n instanceof ie?function(t){if(t.op==="=="){if(fd(t.value))return{unaryFilter:{field:br(t.field),op:"IS_NAN"}};if(hd(t.value))return{unaryFilter:{field:br(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(fd(t.value))return{unaryFilter:{field:br(t.field),op:"IS_NOT_NAN"}};if(hd(t.value))return{unaryFilter:{field:br(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:br(t.field),op:jw(t.op),value:t.value}}}(n):n instanceof de?function(t){const r=t.getFilters().map(s=>wm(s));return r.length===1?r[0]:{compositeFilter:{op:qw(t.op),filters:r}}}(n):q()}function Gw(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Em(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kw{getBundleMetadata(e,t){return Nd(e).get(t).next(r=>{if(r)return function(i){return{id:i.bundleId,createTime:rr(i.createTime),version:i.version}}(r)})}saveBundleMetadata(e,t){return Nd(e).put(function(s){return{bundleId:s.id,createTime:nr(tt(s.createTime)),version:s.version}}(t))}getNamedQuery(e,t){return Ld(e).get(t).next(r=>{if(r)return function(i){return{name:i.name,query:Am(i.bundledQuery),readTime:rr(i.readTime)}}(r)})}saveNamedQuery(e,t){return Ld(e).put(function(s){return{name:s.name,readTime:nr(tt(s.readTime)),bundledQuery:s.bundledQuery}}(t))}}function Nd(n){return Oe(n,"bundles")}function Ld(n){return Oe(n,"namedQueries")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(e,t){this.serializer=e,this.userId=t}static lt(e,t){const r=t.uid||"";return new Ko(e,r)}getOverlay(e,t){return hs(e).get(xd(this.userId,t)).next(r=>r?La(this.serializer,r):null)}getOverlays(e,t){const r=bt();return S.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,t,r){const s=[];return r.forEach((i,o)=>{const c=new Kc(t,o);s.push(this.ht(e,c))}),S.waitFor(s)}removeOverlaysForBatchId(e,t,r){const s=new Set;t.forEach(o=>s.add(et(o.getCollectionPath())));const i=[];return s.forEach(o=>{const c=IDBKeyRange.bound([this.userId,o,r],[this.userId,o,r+1],!1,!0);i.push(hs(e).j("collectionPathOverlayIndex",c))}),S.waitFor(i)}getOverlaysForCollection(e,t,r){const s=bt(),i=et(t),o=IDBKeyRange.bound([this.userId,i,r],[this.userId,i,Number.POSITIVE_INFINITY],!0);return hs(e).U("collectionPathOverlayIndex",o).next(c=>{for(const l of c){const d=La(this.serializer,l);s.set(d.getKey(),d)}return s})}getOverlaysForCollectionGroup(e,t,r,s){const i=bt();let o;const c=IDBKeyRange.bound([this.userId,t,r],[this.userId,t,Number.POSITIVE_INFINITY],!0);return hs(e).J({index:"collectionGroupOverlayIndex",range:c},(l,d,f)=>{const m=La(this.serializer,d);i.size()<s||m.largestBatchId===o?(i.set(m.getKey(),m),o=m.largestBatchId):f.done()}).next(()=>i)}ht(e,t){return hs(e).put(function(s,i,o){const[c,l,d]=xd(i,o.mutation.key);return{userId:i,collectionPath:l,documentId:d,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:Eo(s.ct,o.mutation)}}(this.serializer,this.userId,t))}}function hs(n){return Oe(n,"documentOverlays")}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gn{constructor(e,t,r,s){this.indexId=e,this.documentKey=t,this.arrayValue=r,this.directionalValue=s}Zt(){const e=this.directionalValue.length,t=e===0||this.directionalValue[e-1]===255?e+1:e,r=new Uint8Array(t);return r.set(this.directionalValue,0),t!==e?r.set([0],this.directionalValue.length):++r[r.length-1],new Gn(this.indexId,this.documentKey,this.arrayValue,r)}}function nn(n,e){let t=n.indexId-e.indexId;return t!==0?t:(t=Md(n.arrayValue,e.arrayValue),t!==0?t:(t=Md(n.directionalValue,e.directionalValue),t!==0?t:M.comparator(n.documentKey,e.documentKey)))}function Md(n,e){for(let t=0;t<n.length&&t<e.length;++t){const r=n[t]-e[t];if(r!==0)return r}return n.length-e.length}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rm(n){var e,t;if(z(n instanceof ie||n instanceof de),n instanceof ie){if(n instanceof zf){const s=((t=(e=n.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(i=>ie.create(n.field,"==",i)))||[];return de.create(s,"or")}return n}const r=n.filters.map(s=>Rm(s));return de.create(r,n.op)}function Yw(n){if(n.getFilters().length===0)return[];const e=mc(Rm(n));return z(Sm(e)),hc(e)||fc(e)?[e]:e.getFilters()}function hc(n){return n instanceof ie}function fc(n){return n instanceof de&&$c(n)}function Sm(n){return hc(n)||fc(n)||function(t){if(t instanceof de&&rc(t)){for(const r of t.getFilters())if(!hc(r)&&!fc(r))return!1;return!0}return!1}(n)}function mc(n){if(z(n instanceof ie||n instanceof de),n instanceof ie)return n;if(n.filters.length===1)return mc(n.filters[0]);const e=n.filters.map(r=>mc(r));let t=de.create(e,n.op);return t=bo(t),Sm(t)?t:(z(t instanceof de),z(Or(t)),z(t.filters.length>1),t.filters.reduce((r,s)=>Qc(r,s)))}function Qc(n,e){let t;return z(n instanceof ie||n instanceof de),z(e instanceof ie||e instanceof de),t=n instanceof ie?e instanceof ie?function(s,i){return de.create([s,i],"and")}(n,e):Bd(n,e):e instanceof ie?Bd(e,n):function(s,i){if(z(s.filters.length>0&&i.filters.length>0),Or(s)&&Or(i))return jf(s,i.getFilters());const o=rc(s)?s:i,c=rc(s)?i:s,l=o.filters.map(d=>Qc(d,c));return de.create(l,"or")}(n,e),bo(t)}function Bd(n,e){if(Or(e))return jf(e,n.getFilters());{const t=e.filters.map(r=>Qc(n,r));return de.create(t,"or")}}function bo(n){if(z(n instanceof ie||n instanceof de),n instanceof ie)return n;const e=n.getFilters();if(e.length===1)return bo(e[0]);if(Uf(n))return n;const t=e.map(s=>bo(s)),r=[];return t.forEach(s=>{s instanceof ie?r.push(s):s instanceof de&&(s.op===n.op?r.push(...s.filters):r.push(s))}),r.length===1?r[0]:de.create(r,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bi=new Uint8Array(0);class eE{constructor(e,t){this.databaseId=t,this.cn=new Jc,this.ln=new bn(r=>tr(r),(r,s)=>ai(r,s)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.cn.has(t)){const r=t.lastSegment(),s=t.popLast();e.addOnCommittedListener(()=>{this.cn.add(t)});const i={collectionId:r,parent:et(s)};return Ud(e).put(i)}return S.resolve()}getCollectionParents(e,t){const r=[],s=IDBKeyRange.bound([t,""],[Tf(t),""],!1,!0);return Ud(e).U(s).next(i=>{for(const o of i){if(o.collectionId!==t)break;r.push(Tt(o.parent))}return r})}addFieldIndex(e,t){const r=ms(e),s=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(l=>[l.fieldPath.canonicalString(),l.kind])}}(t);delete s.indexId;const i=r.add(s);if(t.indexState){const o=Ir(e);return i.next(c=>{o.put(Vd(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){const r=ms(e),s=Ir(e),i=vr(e);return r.delete(t.indexId).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=ms(e),r=vr(e),s=Ir(e);return t.j().next(()=>r.j()).next(()=>s.j())}createTargetIndexes(e,t){return S.forEach(this.hn(t),r=>this.getIndexType(e,r).next(s=>{if(s===0||s===1){const i=new Fd(r).an();if(i!=null)return this.addFieldIndex(e,i)}}))}getDocumentsMatchingTarget(e,t){const r=vr(e);let s=!0;const i=new Map;return S.forEach(this.hn(t),o=>this.Pn(e,o).next(c=>{s&&(s=!!c),i.set(o,c)})).next(()=>{if(s){let o=ne();const c=[];return S.forEach(i,(l,d)=>{N("IndexedDbIndexManager",`Using index ${function(V){return`id=${V.indexId}|cg=${V.collectionGroup}|f=${V.fields.map(B=>`${B.fieldPath}:${B.kind}`).join(",")}`}(l)} to execute ${tr(t)}`);const f=function(V,B){const K=Za(B);if(K===void 0)return null;for(const J of Io(V,K.fieldPath))switch(J.op){case"array-contains-any":return J.value.arrayValue.values||[];case"array-contains":return[J.value]}return null}(d,l),m=function(V,B){const K=new Map;for(const J of Un(B))for(const T of Io(V,J.fieldPath))switch(T.op){case"==":case"in":K.set(J.fieldPath.canonicalString(),T.value);break;case"not-in":case"!=":return K.set(J.fieldPath.canonicalString(),T.value),Array.from(K.values())}return null}(d,l),_=function(V,B){const K=[];let J=!0;for(const T of Un(B)){const y=T.kind===0?yd(V,T.fieldPath,V.startAt):vd(V,T.fieldPath,V.startAt);K.push(y.value),J&&(J=y.inclusive)}return new Lr(K,J)}(d,l),w=function(V,B){const K=[];let J=!0;for(const T of Un(B)){const y=T.kind===0?vd(V,T.fieldPath,V.endAt):yd(V,T.fieldPath,V.endAt);K.push(y.value),J&&(J=y.inclusive)}return new Lr(K,J)}(d,l),P=this.In(l,d,_),C=this.In(l,d,w),k=this.Tn(l,d,m),F=this.En(l.indexId,f,P,_.inclusive,C,w.inclusive,k);return S.forEach(F,$=>r.G($,t.limit).next(V=>{V.forEach(B=>{const K=M.fromSegments(B.documentKey);o.has(K)||(o=o.add(K),c.push(K))})}))}).next(()=>c)}return S.resolve(null)})}hn(e){let t=this.ln.get(e);return t||(e.filters.length===0?t=[e]:t=Yw(de.create(e.filters,"and")).map(r=>ic(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.ln.set(e,t),t)}En(e,t,r,s,i,o,c){const l=(t!=null?t.length:1)*Math.max(r.length,i.length),d=l/(t!=null?t.length:1),f=[];for(let m=0;m<l;++m){const _=t?this.dn(t[m/d]):Bi,w=this.An(e,_,r[m%d],s),P=this.Rn(e,_,i[m%d],o),C=c.map(k=>this.An(e,_,k,!0));f.push(...this.createRange(w,P,C))}return f}An(e,t,r,s){const i=new Gn(e,M.empty(),t,r);return s?i:i.Zt()}Rn(e,t,r,s){const i=new Gn(e,M.empty(),t,r);return s?i.Zt():i}Pn(e,t){const r=new Fd(t),s=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,s).next(i=>{let o=null;for(const c of i)r.rn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let r=2;const s=this.hn(t);return S.forEach(s,i=>this.Pn(e,i).next(o=>{o?r!==0&&o.fields.length<function(l){let d=new fe(Ee.comparator),f=!1;for(const m of l.filters)for(const _ of m.getFlattenedFilters())_.field.isKeyField()||(_.op==="array-contains"||_.op==="array-contains-any"?f=!0:d=d.add(_.field));for(const m of l.orderBy)m.field.isKeyField()||(d=d.add(m.field));return d.size+(f?1:0)}(i)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(t)&&s.length>1&&r===2?1:r)}Vn(e,t){const r=new fs;for(const s of Un(e)){const i=t.data.field(s.fieldPath);if(i==null)return null;const o=r.Yt(s.kind);qn.vt.It(i,o)}return r.zt()}dn(e){const t=new fs;return qn.vt.It(e,t.Yt(0)),t.zt()}mn(e,t){const r=new fs;return qn.vt.It(Hs(this.databaseId,t),r.Yt(function(i){const o=Un(i);return o.length===0?0:o[o.length-1].kind}(e))),r.zt()}Tn(e,t,r){if(r===null)return[];let s=[];s.push(new fs);let i=0;for(const o of Un(e)){const c=r[i++];for(const l of s)if(this.fn(t,o.fieldPath)&&Ws(c))s=this.gn(s,o,c);else{const d=l.Yt(o.kind);qn.vt.It(c,d)}}return this.pn(s)}In(e,t,r){return this.Tn(e,t,r.position)}pn(e){const t=[];for(let r=0;r<e.length;++r)t[r]=e[r].zt();return t}gn(e,t,r){const s=[...e],i=[];for(const o of r.arrayValue.values||[])for(const c of s){const l=new fs;l.seed(c.zt()),qn.vt.It(o,l.Yt(t.kind)),i.push(l)}return i}fn(e,t){return!!e.filters.find(r=>r instanceof ie&&r.field.isEqual(t)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,t){const r=ms(e),s=Ir(e);return(t?r.U("collectionGroupIndex",IDBKeyRange.bound(t,t)):r.U()).next(i=>{const o=[];return S.forEach(i,c=>s.get([c.indexId,this.uid]).next(l=>{o.push(function(f,m){const _=m?new qs(m.sequenceNumber,new dt(rr(m.readTime),new M(Tt(m.documentKey)),m.largestBatchId)):qs.empty(),w=f.fields.map(([P,C])=>new Ji(Ee.fromServerFormat(P),C));return new _o(f.indexId,f.collectionGroup,w,_)}(c,l))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((r,s)=>{const i=r.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:Y(r.collectionGroup,s.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,r){const s=ms(e),i=Ir(e);return this.yn(e).next(o=>s.U("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(c=>S.forEach(c,l=>i.put(Vd(l.indexId,this.uid,o,r)))))}updateIndexEntries(e,t){const r=new Map;return S.forEach(t,(s,i)=>{const o=r.get(s.collectionGroup);return(o?S.resolve(o):this.getFieldIndexes(e,s.collectionGroup)).next(c=>(r.set(s.collectionGroup,c),S.forEach(c,l=>this.wn(e,s,l).next(d=>{const f=this.Sn(i,l);return d.isEqual(f)?S.resolve():this.bn(e,i,l,d,f)}))))})}Dn(e,t,r,s){return vr(e).put({indexId:s.indexId,uid:this.uid,arrayValue:s.arrayValue,directionalValue:s.directionalValue,orderedDocumentKey:this.mn(r,t.key),documentKey:t.key.path.toArray()})}vn(e,t,r,s){return vr(e).delete([s.indexId,this.uid,s.arrayValue,s.directionalValue,this.mn(r,t.key),t.key.path.toArray()])}wn(e,t,r){const s=vr(e);let i=new fe(nn);return s.J({index:"documentKeyIndex",range:IDBKeyRange.only([r.indexId,this.uid,this.mn(r,t)])},(o,c)=>{i=i.add(new Gn(r.indexId,t,c.arrayValue,c.directionalValue))}).next(()=>i)}Sn(e,t){let r=new fe(nn);const s=this.Vn(t,e);if(s==null)return r;const i=Za(t);if(i!=null){const o=e.data.field(i.fieldPath);if(Ws(o))for(const c of o.arrayValue.values||[])r=r.add(new Gn(t.indexId,e.key,this.dn(c),s))}else r=r.add(new Gn(t.indexId,e.key,Bi,s));return r}bn(e,t,r,s,i){N("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const o=[];return function(l,d,f,m,_){const w=l.getIterator(),P=d.getIterator();let C=yr(w),k=yr(P);for(;C||k;){let F=!1,$=!1;if(C&&k){const V=f(C,k);V<0?$=!0:V>0&&(F=!0)}else C!=null?$=!0:F=!0;F?(m(k),k=yr(P)):$?(_(C),C=yr(w)):(C=yr(w),k=yr(P))}}(s,i,nn,c=>{o.push(this.Dn(e,t,r,c))},c=>{o.push(this.vn(e,t,r,c))}),S.waitFor(o)}yn(e){let t=1;return Ir(e).J({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,s,i)=>{i.done(),t=s.sequenceNumber+1}).next(()=>t)}createRange(e,t,r){r=r.sort((o,c)=>nn(o,c)).filter((o,c,l)=>!c||nn(o,l[c-1])!==0);const s=[];s.push(e);for(const o of r){const c=nn(o,e),l=nn(o,t);if(c===0)s[0]=e.Zt();else if(c>0&&l<0)s.push(o),s.push(o.Zt());else if(l>0)break}s.push(t);const i=[];for(let o=0;o<s.length;o+=2){if(this.Cn(s[o],s[o+1]))return[];const c=[s[o].indexId,this.uid,s[o].arrayValue,s[o].directionalValue,Bi,[]],l=[s[o+1].indexId,this.uid,s[o+1].arrayValue,s[o+1].directionalValue,Bi,[]];i.push(IDBKeyRange.bound(c,l))}return i}Cn(e,t){return nn(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next($d)}getMinOffset(e,t){return S.mapArray(this.hn(t),r=>this.Pn(e,r).next(s=>s||q())).next($d)}}function Ud(n){return Oe(n,"collectionParents")}function vr(n){return Oe(n,"indexEntries")}function ms(n){return Oe(n,"indexConfiguration")}function Ir(n){return Oe(n,"indexState")}function $d(n){z(n.length!==0);let e=n[0].indexState.offset,t=e.largestBatchId;for(let r=1;r<n.length;r++){const s=n[r].indexState.offset;Oc(s,e)<0&&(e=s),t<s.largestBatchId&&(t=s.largestBatchId)}return new dt(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jd={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0};class rt{constructor(e,t,r){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=r}static withCacheSize(e){return new rt(e,rt.DEFAULT_COLLECTION_PERCENTILE,rt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pm(n,e,t){const r=n.store("mutations"),s=n.store("documentMutations"),i=[],o=IDBKeyRange.only(t.batchId);let c=0;const l=r.J({range:o},(f,m,_)=>(c++,_.delete()));i.push(l.next(()=>{z(c===1)}));const d=[];for(const f of t.mutations){const m=kf(e,f.key.path,t.batchId);i.push(s.delete(m)),d.push(f.key)}return S.waitFor(i).next(()=>d)}function Ao(n){if(!n)return 0;let e;if(n.document)e=n.document;else if(n.unknownDocument)e=n.unknownDocument;else{if(!n.noDocument)throw q();e=n.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */rt.DEFAULT_COLLECTION_PERCENTILE=10,rt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,rt.DEFAULT=new rt(41943040,rt.DEFAULT_COLLECTION_PERCENTILE,rt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),rt.DISABLED=new rt(-1,0,0);class Ho{constructor(e,t,r,s){this.userId=e,this.serializer=t,this.indexManager=r,this.referenceDelegate=s,this.Fn={}}static lt(e,t,r,s){z(e.uid!=="");const i=e.isAuthenticated()?e.uid:"";return new Ho(i,t,r,s)}checkEmpty(e){let t=!0;const r=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return rn(e).J({index:"userMutationsIndex",range:r},(s,i,o)=>{t=!1,o.done()}).next(()=>t)}addMutationBatch(e,t,r,s){const i=Rr(e),o=rn(e);return o.add({}).next(c=>{z(typeof c=="number");const l=new Gc(c,t,r,s),d=function(w,P,C){const k=C.baseMutations.map($=>Eo(w.ct,$)),F=C.mutations.map($=>Eo(w.ct,$));return{userId:P,batchId:C.batchId,localWriteTimeMs:C.localWriteTime.toMillis(),baseMutations:k,mutations:F}}(this.serializer,this.userId,l),f=[];let m=new fe((_,w)=>Y(_.canonicalString(),w.canonicalString()));for(const _ of s){const w=kf(this.userId,_.key.path,c);m=m.add(_.key.path.popLast()),f.push(o.put(d)),f.push(i.put(w,FI))}return m.forEach(_=>{f.push(this.indexManager.addToCollectionParentIndex(e,_))}),e.addOnCommittedListener(()=>{this.Fn[c]=l.keys()}),S.waitFor(f).next(()=>l)})}lookupMutationBatch(e,t){return rn(e).get(t).next(r=>r?(z(r.userId===this.userId),jn(this.serializer,r)):null)}Mn(e,t){return this.Fn[t]?S.resolve(this.Fn[t]):this.lookupMutationBatch(e,t).next(r=>{if(r){const s=r.keys();return this.Fn[t]=s,s}return null})}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=IDBKeyRange.lowerBound([this.userId,r]);let i=null;return rn(e).J({index:"userMutationsIndex",range:s},(o,c,l)=>{c.userId===this.userId&&(z(c.batchId>=r),i=jn(this.serializer,c)),l.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(e){const t=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let r=-1;return rn(e).J({index:"userMutationsIndex",range:t,reverse:!0},(s,i,o)=>{r=i.batchId,o.done()}).next(()=>r)}getAllMutationBatches(e){const t=IDBKeyRange.bound([this.userId,-1],[this.userId,Number.POSITIVE_INFINITY]);return rn(e).U("userMutationsIndex",t).next(r=>r.map(s=>jn(this.serializer,s)))}getAllMutationBatchesAffectingDocumentKey(e,t){const r=Xi(this.userId,t.path),s=IDBKeyRange.lowerBound(r),i=[];return Rr(e).J({range:s},(o,c,l)=>{const[d,f,m]=o,_=Tt(f);if(d===this.userId&&t.path.isEqual(_))return rn(e).get(m).next(w=>{if(!w)throw q();z(w.userId===this.userId),i.push(jn(this.serializer,w))});l.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new fe(Y);const s=[];return t.forEach(i=>{const o=Xi(this.userId,i.path),c=IDBKeyRange.lowerBound(o),l=Rr(e).J({range:c},(d,f,m)=>{const[_,w,P]=d,C=Tt(w);_===this.userId&&i.path.isEqual(C)?r=r.add(P):m.done()});s.push(l)}),S.waitFor(s).next(()=>this.xn(e,r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1,i=Xi(this.userId,r),o=IDBKeyRange.lowerBound(i);let c=new fe(Y);return Rr(e).J({range:o},(l,d,f)=>{const[m,_,w]=l,P=Tt(_);m===this.userId&&r.isPrefixOf(P)?P.length===s&&(c=c.add(w)):f.done()}).next(()=>this.xn(e,c))}xn(e,t){const r=[],s=[];return t.forEach(i=>{s.push(rn(e).get(i).next(o=>{if(o===null)throw q();z(o.userId===this.userId),r.push(jn(this.serializer,o))}))}),S.waitFor(s).next(()=>r)}removeMutationBatch(e,t){return Pm(e._e,this.userId,t).next(r=>(e.addOnCommittedListener(()=>{this.On(t.batchId)}),S.forEach(r,s=>this.referenceDelegate.markPotentiallyOrphaned(e,s))))}On(e){delete this.Fn[e]}performConsistencyCheck(e){return this.checkEmpty(e).next(t=>{if(!t)return S.resolve();const r=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),s=[];return Rr(e).J({range:r},(i,o,c)=>{if(i[0]===this.userId){const l=Tt(i[1]);s.push(l)}else c.done()}).next(()=>{z(s.length===0)})})}containsKey(e,t){return Cm(e,this.userId,t)}Nn(e){return km(e).get(this.userId).next(t=>t||{userId:this.userId,lastAcknowledgedBatchId:-1,lastStreamToken:""})}}function Cm(n,e,t){const r=Xi(e,t.path),s=r[1],i=IDBKeyRange.lowerBound(r);let o=!1;return Rr(n).J({range:i,H:!0},(c,l,d)=>{const[f,m,_]=c;f===e&&m===s&&(o=!0),d.done()}).next(()=>o)}function rn(n){return Oe(n,"mutations")}function Rr(n){return Oe(n,"documentMutations")}function km(n){return Oe(n,"mutationQueues")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tE{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.qn(e).next(t=>{const r=new sr(t.highestTargetId);return t.highestTargetId=r.next(),this.Qn(e,t).next(()=>t.highestTargetId)})}getLastRemoteSnapshotVersion(e){return this.qn(e).next(t=>H.fromTimestamp(new Te(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds)))}getHighestSequenceNumber(e){return this.qn(e).next(t=>t.highestListenSequenceNumber)}setTargetsMetadata(e,t,r){return this.qn(e).next(s=>(s.highestListenSequenceNumber=t,r&&(s.lastRemoteSnapshotVersion=r.toTimestamp()),t>s.highestListenSequenceNumber&&(s.highestListenSequenceNumber=t),this.Qn(e,s)))}addTargetData(e,t){return this.Kn(e,t).next(()=>this.qn(e).next(r=>(r.targetCount+=1,this.$n(t,r),this.Qn(e,r))))}updateTargetData(e,t){return this.Kn(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next(()=>wr(e).delete(t.targetId)).next(()=>this.qn(e)).next(r=>(z(r.targetCount>0),r.targetCount-=1,this.Qn(e,r)))}removeTargets(e,t,r){let s=0;const i=[];return wr(e).J((o,c)=>{const l=bs(c);l.sequenceNumber<=t&&r.get(l.targetId)===null&&(s++,i.push(this.removeTargetData(e,l)))}).next(()=>S.waitFor(i)).next(()=>s)}forEachTarget(e,t){return wr(e).J((r,s)=>{const i=bs(s);t(i)})}qn(e){return qd(e).get("targetGlobalKey").next(t=>(z(t!==null),t))}Qn(e,t){return qd(e).put("targetGlobalKey",t)}Kn(e,t){return wr(e).put(bm(this.serializer,t))}$n(e,t){let r=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,r=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,r=!0),r}getTargetCount(e){return this.qn(e).next(t=>t.targetCount)}getTargetData(e,t){const r=tr(t),s=IDBKeyRange.bound([r,Number.NEGATIVE_INFINITY],[r,Number.POSITIVE_INFINITY]);let i=null;return wr(e).J({range:s,index:"queryTargetsIndex"},(o,c,l)=>{const d=bs(c);ai(t,d.target)&&(i=d,l.done())}).next(()=>i)}addMatchingKeys(e,t,r){const s=[],i=ln(e);return t.forEach(o=>{const c=et(o.path);s.push(i.put({targetId:r,path:c})),s.push(this.referenceDelegate.addReference(e,r,o))}),S.waitFor(s)}removeMatchingKeys(e,t,r){const s=ln(e);return S.forEach(t,i=>{const o=et(i.path);return S.waitFor([s.delete([r,o]),this.referenceDelegate.removeReference(e,r,i)])})}removeMatchingKeysForTargetId(e,t){const r=ln(e),s=IDBKeyRange.bound([t],[t+1],!1,!0);return r.delete(s)}getMatchingKeysForTargetId(e,t){const r=IDBKeyRange.bound([t],[t+1],!1,!0),s=ln(e);let i=ne();return s.J({range:r,H:!0},(o,c,l)=>{const d=Tt(o[1]),f=new M(d);i=i.add(f)}).next(()=>i)}containsKey(e,t){const r=et(t.path),s=IDBKeyRange.bound([r],[Tf(r)],!1,!0);let i=0;return ln(e).J({index:"documentTargetsIndex",H:!0,range:s},([o,c],l,d)=>{o!==0&&(i++,d.done())}).next(()=>i>0)}ot(e,t){return wr(e).get(t).next(r=>r?bs(r):null)}}function wr(n){return Oe(n,"targets")}function qd(n){return Oe(n,"targetGlobal")}function ln(n){return Oe(n,"targetDocuments")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dm{constructor(){this.changes=new bn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Se.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?S.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aE{constructor(e){this.serializer=e}setIndexManager(e){this.indexManager=e}addEntry(e,t,r){return Fn(e).put(r)}removeEntry(e,t,r){return Fn(e).delete(function(i,o){const c=i.path.toArray();return[c.slice(0,c.length-2),c[c.length-2],To(o),c[c.length-1]]}(t,r))}updateMetadata(e,t){return this.getMetadata(e).next(r=>(r.byteSize+=t,this.rr(e,r)))}getEntry(e,t){let r=Se.newInvalidDocument(t);return Fn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(ps(t))},(s,i)=>{r=this.ir(t,i)}).next(()=>r)}sr(e,t){let r={size:0,document:Se.newInvalidDocument(t)};return Fn(e).J({index:"documentKeyIndex",range:IDBKeyRange.only(ps(t))},(s,i)=>{r={document:this.ir(t,i),size:Ao(i)}}).next(()=>r)}getEntries(e,t){let r=ct();return this._r(e,t,(s,i)=>{const o=this.ir(s,i);r=r.insert(s,o)}).next(()=>r)}ar(e,t){let r=ct(),s=new _e(M.comparator);return this._r(e,t,(i,o)=>{const c=this.ir(i,o);r=r.insert(i,c),s=s.insert(i,Ao(o))}).next(()=>({documents:r,ur:s}))}_r(e,t,r){if(t.isEmpty())return S.resolve();let s=new fe(Hd);t.forEach(l=>s=s.add(l));const i=IDBKeyRange.bound(ps(s.first()),ps(s.last())),o=s.getIterator();let c=o.getNext();return Fn(e).J({index:"documentKeyIndex",range:i},(l,d,f)=>{const m=M.fromSegments([...d.prefixPath,d.collectionGroup,d.documentId]);for(;c&&Hd(c,m)<0;)r(c,null),c=o.getNext();c&&c.isEqual(m)&&(r(c,d),c=o.hasNext()?o.getNext():null),c?f.$(ps(c)):f.done()}).next(()=>{for(;c;)r(c,null),c=o.hasNext()?o.getNext():null})}getDocumentsMatchingQuery(e,t,r,s,i){const o=t.path,c=[o.popLast().toArray(),o.lastSegment(),To(r.readTime),r.documentKey.path.isEmpty()?"":r.documentKey.path.lastSegment()],l=[o.popLast().toArray(),o.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return Fn(e).U(IDBKeyRange.bound(c,l,!0)).next(d=>{i==null||i.incrementDocumentReadCount(d.length);let f=ct();for(const m of d){const _=this.ir(M.fromSegments(m.prefixPath.concat(m.collectionGroup,m.documentId)),m);_.isFoundDocument()&&(li(t,_)||s.has(_.key))&&(f=f.insert(_.key,_))}return f})}getAllFromCollectionGroup(e,t,r,s){let i=ct();const o=Kd(t,r),c=Kd(t,dt.max());return Fn(e).J({index:"collectionGroupIndex",range:IDBKeyRange.bound(o,c,!0)},(l,d,f)=>{const m=this.ir(M.fromSegments(d.prefixPath.concat(d.collectionGroup,d.documentId)),d);i=i.insert(m.key,m),i.size===s&&f.done()}).next(()=>i)}newChangeBuffer(e){return new cE(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next(t=>t.byteSize)}getMetadata(e){return zd(e).get("remoteDocumentGlobalKey").next(t=>(z(!!t),t))}rr(e,t){return zd(e).put("remoteDocumentGlobalKey",t)}ir(e,t){if(t){const r=zw(this.serializer,t);if(!(r.isNoDocument()&&r.version.isEqual(H.min())))return r}return Se.newInvalidDocument(e)}}function xm(n){return new aE(n)}class cE extends Dm{constructor(e,t){super(),this.cr=e,this.trackRemovals=t,this.lr=new bn(r=>r.toString(),(r,s)=>r.isEqual(s))}applyChanges(e){const t=[];let r=0,s=new fe((i,o)=>Y(i.canonicalString(),o.canonicalString()));return this.changes.forEach((i,o)=>{const c=this.lr.get(i);if(t.push(this.cr.removeEntry(e,i,c.readTime)),o.isValidDocument()){const l=Dd(this.cr.serializer,o);s=s.add(i.path.popLast());const d=Ao(l);r+=d-c.size,t.push(this.cr.addEntry(e,i,l))}else if(r-=c.size,this.trackRemovals){const l=Dd(this.cr.serializer,o.convertToNoDocument(H.min()));t.push(this.cr.addEntry(e,i,l))}}),s.forEach(i=>{t.push(this.cr.indexManager.addToCollectionParentIndex(e,i))}),t.push(this.cr.updateMetadata(e,r)),S.waitFor(t)}getFromCache(e,t){return this.cr.sr(e,t).next(r=>(this.lr.set(t,{size:r.size,readTime:r.document.readTime}),r.document))}getAllFromCache(e,t){return this.cr.ar(e,t).next(({documents:r,ur:s})=>(s.forEach((i,o)=>{this.lr.set(i,{size:o,readTime:r.get(i).readTime})}),r))}}function zd(n){return Oe(n,"remoteDocumentGlobal")}function Fn(n){return Oe(n,"remoteDocumentsV14")}function ps(n){const e=n.path.toArray();return[e.slice(0,e.length-2),e[e.length-2],e[e.length-1]]}function Kd(n,e){const t=e.documentKey.path.toArray();return[n,To(e.readTime),t.slice(0,t.length-2),t.length>0?t[t.length-1]:""]}function Hd(n,e){const t=n.path.toArray(),r=e.path.toArray();let s=0;for(let i=0;i<t.length-2&&i<r.length-2;++i)if(s=Y(t[i],r[i]),s)return s;return s=Y(t.length,r.length),s||(s=Y(t[t.length-2],r[r.length-2]),s||Y(t[t.length-1],r[r.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vm{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(r!==null&&Vs(r.mutation,s,it.empty(),Te.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,ne()).next(()=>r))}getLocalViewOfDocuments(e,t,r=ne()){const s=bt();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,r).next(i=>{let o=Es();return i.forEach((c,l)=>{o=o.insert(c,l.overlayedDocument)}),o}))}getOverlayedDocuments(e,t){const r=bt();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,ne()))}populateOverlays(e,t,r){const s=[];return r.forEach(i=>{t.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((o,c)=>{t.set(o,c)})})}computeViews(e,t,r,s){let i=ct();const o=xs(),c=function(){return xs()}();return t.forEach((l,d)=>{const f=r.get(d.key);s.has(d.key)&&(f===void 0||f.mutation instanceof Ht)?i=i.insert(d.key,d):f!==void 0?(o.set(d.key,f.mutation.getFieldMask()),Vs(f.mutation,d,f.mutation.getFieldMask(),Te.now())):o.set(d.key,it.empty())}),this.recalculateAndSaveOverlays(e,i).next(l=>(l.forEach((d,f)=>o.set(d,f)),t.forEach((d,f)=>{var m;return c.set(d,new lE(f,(m=o.get(d))!==null&&m!==void 0?m:null))}),c))}recalculateAndSaveOverlays(e,t){const r=xs();let s=new _e((o,c)=>o-c),i=ne();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(o=>{for(const c of o)c.keys().forEach(l=>{const d=t.get(l);if(d===null)return;let f=r.get(l)||it.empty();f=c.applyToLocalView(d,f),r.set(l,f);const m=(s.get(c.batchId)||ne()).add(l);s=s.insert(c.batchId,m)})}).next(()=>{const o=[],c=s.getReverseIterator();for(;c.hasNext();){const l=c.getNext(),d=l.key,f=l.value,m=Zf();f.forEach(_=>{if(!i.has(_)){const w=om(t.get(_),r.get(_));w!==null&&m.set(_,w),i=i.add(_)}}),o.push(this.documentOverlayCache.saveOverlays(e,d,m))}return S.waitFor(o)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,s){return function(o){return M.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Hf(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next(i=>{const o=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-i.size):S.resolve(bt());let c=-1,l=i;return o.next(d=>S.forEach(d,(f,m)=>(c<m.largestBatchId&&(c=m.largestBatchId),i.get(f)?S.resolve():this.remoteDocumentCache.getEntry(e,f).next(_=>{l=l.insert(f,_)}))).next(()=>this.populateOverlays(e,d,i)).next(()=>this.computeViews(e,l,d,ne())).next(f=>({batchId:c,changes:Yf(f)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new M(t)).next(r=>{let s=Es();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const i=t.collectionGroup;let o=Es();return this.indexManager.getCollectionParents(e,i).next(c=>S.forEach(c,l=>{const d=function(m,_){return new ci(_,null,m.explicitOrderBy.slice(),m.filters.slice(),m.limit,m.limitType,m.startAt,m.endAt)}(t,l.child(i));return this.getDocumentsMatchingCollectionQuery(e,d,r,s).next(f=>{f.forEach((m,_)=>{o=o.insert(m,_)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(e,t,r,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(o=>(i=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,i,s))).next(o=>{i.forEach((l,d)=>{const f=d.getKey();o.get(f)===null&&(o=o.insert(f,Se.newInvalidDocument(f)))});let c=Es();return o.forEach((l,d)=>{const f=i.get(l);f!==void 0&&Vs(f.mutation,d,it.empty(),Te.now()),li(t,d)&&(c=c.insert(l,d))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hE{constructor(){this.sessionToken=xe.EMPTY_BYTE_STRING}getSessionToken(e){return S.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,S.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nm{constructor(e,t){this.qr={},this.overlays={},this.Qr=new st(0),this.Kr=!1,this.Kr=!0,this.$r=new hE,this.referenceDelegate=e(this),this.Ur=new gE(this),this.indexManager=new Zw,this.remoteDocumentCache=function(s){return new mE(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new Tm(t),this.Gr=new uE(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new dE,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new fE(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){N("MemoryPersistence","Starting transaction:",e);const s=new _E(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return S.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class _E extends Sf{constructor(e){super(),this.currentSequenceNumber=e}}class Wo{constructor(e){this.persistence=e,this.Jr=new Xc,this.Yr=null}static Zr(e){return new Wo(e)}get Xr(){if(this.Yr)return this.Yr;throw q()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),S.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),S.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),S.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return S.forEach(this.Xr,r=>{const s=M.fromPath(r);return this.ei(e,s).next(i=>{i||t.removeEntry(s,H.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return S.or([()=>S.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Om{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return Sh()?8:Pf(Le())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Yi(e,t).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Zi(e,t,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new vE;return this.Xi(e,t,o).next(c=>{if(i.result=c,this.zi)return this.es(e,t,o,c.size)})}).next(()=>i.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(Er()<=se.DEBUG&&N("QueryEngine","SDK will not create cache indexes for query:",Tr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),S.resolve()):(Er()<=se.DEBUG&&N("QueryEngine","Query:",Tr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Er()<=se.DEBUG&&N("QueryEngine","The SDK decides to create cache indexes for query:",Tr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,ut(t))):S.resolve())}Yi(e,t){if(Id(t))return S.resolve(null);let r=ut(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=ac(t,null,"F"),r=ut(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=ne(...i);return this.Ji.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const d=this.ts(t,c);return this.ns(t,d,o,l.readTime)?this.Yi(e,ac(t,null,"F")):this.rs(e,d,t,l)}))})))}Zi(e,t,r,s){return Id(t)||s.isEqual(H.min())?S.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const o=this.ts(t,i);return this.ns(t,o,r,s)?S.resolve(null):(Er()<=se.DEBUG&&N("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Tr(t)),this.rs(e,o,t,bf(s,-1)).next(c=>c))})}ts(e,t){let r=new fe(Jf(e));return t.forEach((s,i)=>{li(e,i)&&(r=r.add(i))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Xi(e,t,r){return Er()<=se.DEBUG&&N("QueryEngine","Using full collection scan to execute query:",Tr(t)),this.Ji.getDocumentsMatchingQuery(e,t,dt.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xd{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){N("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){N("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ke="WebChannelConnection";class PE extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,o){const c=Ba(),l=this.xo(t,r.toUriEncodedString());N("RestConnection",`Sending RPC '${t}' ${c}:`,l,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,i,o),this.No(t,l,d,s).then(f=>(N("RestConnection",`Received RPC '${t}' ${c}: `,f),f),f=>{throw $s("RestConnection",`RPC '${t}' ${c} failed with error: `,f,"url: ",l,"request:",s),f})}Lo(t,r,s,i,o,c){return this.Mo(t,r,s,i,o)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Hr}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>t[o]=i),s&&s.headers.forEach((i,o)=>t[o]=i)}xo(t,r){const s=RE[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=Ba();return new Promise((o,c)=>{const l=new _f;l.setWithCredentials(!0),l.listenOnce(yf.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case Qi.NO_ERROR:const f=l.getResponseJson();N(Ke,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(f)),o(f);break;case Qi.TIMEOUT:N(Ke,`RPC '${e}' ${i} timed out`),c(new O(x.DEADLINE_EXCEEDED,"Request time out"));break;case Qi.HTTP_ERROR:const m=l.getStatus();if(N(Ke,`RPC '${e}' ${i} failed with status:`,m,"response text:",l.getResponseText()),m>0){let _=l.getResponseJson();Array.isArray(_)&&(_=_[0]);const w=_==null?void 0:_.error;if(w&&w.status&&w.message){const P=function(k){const F=k.toLowerCase().replace(/_/g,"-");return Object.values(x).indexOf(F)>=0?F:x.UNKNOWN}(w.status);c(new O(P,w.message))}else c(new O(x.UNKNOWN,"Server responded with status "+l.getStatus()))}else c(new O(x.UNAVAILABLE,"Connection failed."));break;default:q()}}finally{N(Ke,`RPC '${e}' ${i} completed.`)}});const d=JSON.stringify(s);N(Ke,`RPC '${e}' ${i} sending request:`,s),l.send(t,"POST",d,r,15)})}Bo(e,t,r){const s=Ba(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=wf(),c=If(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(l.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Oo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const f=i.join("");N(Ke,`Creating RPC '${e}' stream ${s}: ${f}`,l);const m=o.createWebChannel(f,l);let _=!1,w=!1;const P=new SE({Io:k=>{w?N(Ke,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(_||(N(Ke,`Opening RPC '${e}' stream ${s} transport.`),m.open(),_=!0),N(Ke,`RPC '${e}' stream ${s} sending:`,k),m.send(k))},To:()=>m.close()}),C=(k,F,$)=>{k.listen(F,V=>{try{$(V)}catch(B){setTimeout(()=>{throw B},0)}})};return C(m,ws.EventType.OPEN,()=>{w||(N(Ke,`RPC '${e}' stream ${s} transport opened.`),P.yo())}),C(m,ws.EventType.CLOSE,()=>{w||(w=!0,N(Ke,`RPC '${e}' stream ${s} transport closed`),P.So())}),C(m,ws.EventType.ERROR,k=>{w||(w=!0,$s(Ke,`RPC '${e}' stream ${s} transport errored:`,k),P.So(new O(x.UNAVAILABLE,"The operation could not be completed")))}),C(m,ws.EventType.MESSAGE,k=>{var F;if(!w){const $=k.data[0];z(!!$);const V=$,B=V.error||((F=V[0])===null||F===void 0?void 0:F.error);if(B){N(Ke,`RPC '${e}' stream ${s} received error:`,B);const K=B.status;let J=function(v){const E=Ve[v];if(E!==void 0)return lm(E)}(K),T=B.message;J===void 0&&(J=x.INTERNAL,T="Unknown error status: "+K+" with message "+B.message),w=!0,P.So(new O(J,T)),m.close()}else N(Ke,`RPC '${e}' stream ${s} received:`,$),P.bo($)}}),C(c,vf.STAT_EVENT,k=>{k.stat===Ya.PROXY?N(Ke,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===Ya.NOPROXY&&N(Ke,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VE{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=i,this.k_._o(o=>{r.enqueueAndForget(async()=>{lr(this)&&(N("RemoteStore","Restarting streams for network reachability change."),await async function(l){const d=G(l);d.L_.add(4),await hi(d),d.q_.set("Unknown"),d.L_.delete(4),await Jo(d)}(this))})}),this.q_=new xE(r,s)}}async function Jo(n){if(lr(n))for(const e of n.B_)await e(!0)}async function hi(n){for(const e of n.B_)await e(!1)}function Xo(n,e){const t=G(n);t.N_.has(e.targetId)||(t.N_.set(e.targetId,e),rl(t)?nl(t):Jr(t).r_()&&tl(t,e))}function jr(n,e){const t=G(n),r=Jr(t);t.N_.delete(e),r.r_()&&Hm(t,e),t.N_.size===0&&(r.r_()?r.o_():lr(t)&&t.q_.set("Unknown"))}function tl(n,e){if(n.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(H.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Jr(n).A_(e)}function Hm(n,e){n.Q_.xe(e),Jr(n).R_(e)}function nl(n){n.Q_=new Dw({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>n.N_.get(e)||null,tt:()=>n.datastore.serializer.databaseId}),Jr(n).start(),n.q_.v_()}function rl(n){return lr(n)&&!Jr(n).n_()&&n.N_.size>0}function lr(n){return G(n).L_.size===0}function Wm(n){n.Q_=void 0}async function NE(n){n.q_.set("Online")}async function LE(n){n.N_.forEach((e,t)=>{tl(n,e)})}async function OE(n,e){Wm(n),rl(n)?(n.q_.M_(e),nl(n)):n.q_.set("Unknown")}async function ME(n,e,t){if(n.q_.set("Online"),e instanceof dm&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const c of i.targetIds)s.N_.has(c)&&(await s.remoteSyncer.rejectListen(c,o),s.N_.delete(c),s.Q_.removeTarget(c))}(n,e)}catch(r){N("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Co(n,r)}else if(e instanceof to?n.Q_.Ke(e):e instanceof um?n.Q_.He(e):n.Q_.We(e),!t.isEqual(H.min()))try{const r=await Bm(n.localStore);t.compareTo(r)>=0&&await function(i,o){const c=i.Q_.rt(o);return c.targetChanges.forEach((l,d)=>{if(l.resumeToken.approximateByteSize()>0){const f=i.N_.get(d);f&&i.N_.set(d,f.withResumeToken(l.resumeToken,o))}}),c.targetMismatches.forEach((l,d)=>{const f=i.N_.get(l);if(!f)return;i.N_.set(l,f.withResumeToken(xe.EMPTY_BYTE_STRING,f.snapshotVersion)),Hm(i,l);const m=new Ft(f.target,l,d,f.sequenceNumber);tl(i,m)}),i.remoteSyncer.applyRemoteEvent(c)}(n,t)}catch(r){N("RemoteStore","Failed to raise snapshot:",r),await Co(n,r)}}async function Co(n,e,t){if(!Tn(e))throw e;n.L_.add(1),await hi(n),n.q_.set("Offline"),t||(t=()=>Bm(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{N("RemoteStore","Retrying IndexedDB access"),await t(),n.L_.delete(1),await Jo(n)})}function Qm(n,e){return e().catch(t=>Co(n,t,e))}async function Qr(n){const e=G(n),t=In(e);let r=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;FE(e);)try{const s=await bE(e.localStore,r);if(s===null){e.O_.length===0&&t.o_();break}r=s.batchId,BE(e,s)}catch(s){await Co(e,s)}Jm(e)&&Xm(e)}function FE(n){return lr(n)&&n.O_.length<10}function BE(n,e){n.O_.push(e);const t=In(n);t.r_()&&t.V_&&t.m_(e.mutations)}function Jm(n){return lr(n)&&!In(n).n_()&&n.O_.length>0}function Xm(n){In(n).start()}async function UE(n){In(n).p_()}async function $E(n){const e=In(n);for(const t of n.O_)e.m_(t.mutations)}async function jE(n,e,t){const r=n.O_.shift(),s=zc.from(r,e,t);await Qm(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Qr(n)}async function qE(n,e){e&&In(n).V_&&await async function(r,s){if(function(o){return Pw(o)&&o!==x.ABORTED}(s.code)){const i=r.O_.shift();In(r).s_(),await Qm(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Qr(r)}}(n,e),Jm(n)&&Xm(n)}async function Yd(n,e){const t=G(n);t.asyncQueue.verifyOperationInProgress(),N("RemoteStore","RemoteStore received new credentials");const r=lr(t);t.L_.add(3),await hi(t),r&&t.q_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.L_.delete(3),await Jo(t)}async function _c(n,e){const t=G(n);e?(t.L_.delete(2),await Jo(t)):e||(t.L_.add(2),await hi(t),t.q_.set("Unknown"))}function Jr(n){return n.K_||(n.K_=function(t,r,s){const i=G(t);return i.w_(),new CE(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Eo:NE.bind(null,n),Ro:LE.bind(null,n),mo:OE.bind(null,n),d_:ME.bind(null,n)}),n.B_.push(async e=>{e?(n.K_.s_(),rl(n)?nl(n):n.q_.set("Unknown")):(await n.K_.stop(),Wm(n))})),n.K_}function In(n){return n.U_||(n.U_=function(t,r,s){const i=G(t);return i.w_(),new kE(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:UE.bind(null,n),mo:qE.bind(null,n),f_:$E.bind(null,n),g_:jE.bind(null,n)}),n.B_.push(async e=>{e?(n.U_.s_(),await Qr(n)):(await n.U_.stop(),n.O_.length>0&&(N("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zd{constructor(){this.W_=new _e(M.comparator)}track(e){const t=e.doc.key,r=this.W_.get(t);r?e.type!==0&&r.type===3?this.W_=this.W_.insert(t,e):e.type===3&&r.type!==1?this.W_=this.W_.insert(t,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.W_=this.W_.insert(t,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.W_=this.W_.remove(t):e.type===1&&r.type===2?this.W_=this.W_.insert(t,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):q():this.W_=this.W_.insert(t,e)}G_(){const e=[];return this.W_.inorderTraversal((t,r)=>{e.push(r)}),e}}class qr{constructor(e,t,r,s,i,o,c,l,d){this.query=e,this.docs=t,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=i,this.fromCache=o,this.syncStateChanged=c,this.excludesMetadataChanges=l,this.hasCachedResults=d}static fromInitialDocuments(e,t,r,s,i){const o=[];return t.forEach(c=>{o.push({type:0,doc:c})}),new qr(e,t,Dr.emptySet(t),o,r,s,!0,!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&jo(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,r=e.docChanges;if(t.length!==r.length)return!1;for(let s=0;s<t.length;s++)if(t[s].type!==r[s].type||!t[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tp{constructor(e){this.key=e}}class np{constructor(e){this.key=e}}class WE{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=ne(),this.mutatedKeys=ne(),this.Aa=Jf(e),this.Ra=new Dr(this.Aa)}get Va(){return this.Ta}ma(e,t){const r=t?t.fa:new Zd,s=t?t.Ra:this.Ra;let i=t?t.mutatedKeys:this.mutatedKeys,o=s,c=!1;const l=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((f,m)=>{const _=s.get(f),w=li(this.query,m)?m:null,P=!!_&&this.mutatedKeys.has(_.key),C=!!w&&(w.hasLocalMutations||this.mutatedKeys.has(w.key)&&w.hasCommittedMutations);let k=!1;_&&w?_.data.isEqual(w.data)?P!==C&&(r.track({type:3,doc:w}),k=!0):this.ga(_,w)||(r.track({type:2,doc:w}),k=!0,(l&&this.Aa(w,l)>0||d&&this.Aa(w,d)<0)&&(c=!0)):!_&&w?(r.track({type:0,doc:w}),k=!0):_&&!w&&(r.track({type:1,doc:_}),k=!0,(l||d)&&(c=!0)),k&&(w?(o=o.add(w),i=C?i.add(f):i.delete(f)):(o=o.delete(f),i=i.delete(f)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const f=this.query.limitType==="F"?o.last():o.first();o=o.delete(f.key),i=i.delete(f.key),r.track({type:1,doc:f})}return{Ra:o,fa:r,ns:c,mutatedKeys:i}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const o=e.fa.G_();o.sort((f,m)=>function(w,P){const C=k=>{switch(k){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return q()}};return C(w)-C(P)}(f.type,m.type)||this.Aa(f.doc,m.doc)),this.pa(r),s=s!=null&&s;const c=t&&!s?this.ya():[],l=this.da.size===0&&this.current&&!s?1:0,d=l!==this.Ea;return this.Ea=l,o.length!==0||d?{snapshot:new qr(this.query,e.Ra,i,o,e.mutatedKeys,l===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:c}:{wa:c}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new Zd,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(t=>this.Ta=this.Ta.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ta=this.Ta.delete(t)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=ne(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const t=[];return e.forEach(r=>{this.da.has(r)||t.push(new np(r))}),this.da.forEach(r=>{e.has(r)||t.push(new tp(r))}),t}ba(e){this.Ta=e.Ts,this.da=ne();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return qr.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class QE{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class JE{constructor(e){this.key=e,this.va=!1}}class XE{constructor(e,t,r,s,i,o){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=o,this.Ca={},this.Fa=new bn(c=>Wf(c),jo),this.Ma=new Map,this.xa=new Set,this.Oa=new _e(M.comparator),this.Na=new Map,this.La=new Xc,this.Ba={},this.ka=new Map,this.qa=sr.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function YE(n,e,t=!0){const r=Yo(n);let s;const i=r.Fa.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.Da()):s=await rp(r,e,t,!0),s}async function ZE(n,e){const t=Yo(n);await rp(t,e,!0,!1)}async function rp(n,e,t,r){const s=await Ro(n.localStore,ut(e)),i=s.targetId,o=n.sharedClientState.addLocalQueryTarget(i,t);let c;return r&&(c=await al(n,e,i,o==="current",s.resumeToken)),n.isPrimaryClient&&t&&Xo(n.remoteStore,s),c}async function al(n,e,t,r,s){n.Ka=(m,_,w)=>async function(C,k,F,$){let V=k.view.ma(F);V.ns&&(V=await pc(C.localStore,k.query,!1).then(({documents:T})=>k.view.ma(T,V)));const B=$&&$.targetChanges.get(k.targetId),K=$&&$.targetMismatches.get(k.targetId)!=null,J=k.view.applyChanges(V,C.isPrimaryClient,B,K);return vc(C,k.targetId,J.wa),J.snapshot}(n,m,_,w);const i=await pc(n.localStore,e,!0),o=new WE(e,i.Ts),c=o.ma(i.documents),l=di.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),d=o.applyChanges(c,n.isPrimaryClient,l);vc(n,t,d.wa);const f=new QE(e,t,o);return n.Fa.set(e,f),n.Ma.has(t)?n.Ma.get(t).push(e):n.Ma.set(t,[e]),d.snapshot}async function eT(n,e,t){const r=G(n),s=r.Fa.get(e),i=r.Ma.get(s.targetId);if(i.length>1)return r.Ma.set(s.targetId,i.filter(o=>!jo(o,e))),void r.Fa.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await $r(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),t&&jr(r.remoteStore,s.targetId),Gr(r,s.targetId)}).catch(En)):(Gr(r,s.targetId),await $r(r.localStore,s.targetId,!0))}async function tT(n,e){const t=G(n),r=t.Fa.get(e),s=t.Ma.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),jr(t.remoteStore,r.targetId))}async function nT(n,e,t){const r=dl(n);try{const s=await function(o,c){const l=G(o),d=Te.now(),f=c.reduce((w,P)=>w.add(P.key),ne());let m,_;return l.persistence.runTransaction("Locally write mutations","readwrite",w=>{let P=ct(),C=ne();return l.cs.getEntries(w,f).next(k=>{P=k,P.forEach((F,$)=>{$.isValidDocument()||(C=C.add(F))})}).next(()=>l.localDocuments.getOverlayedDocuments(w,P)).next(k=>{m=k;const F=[];for(const $ of c){const V=Rw($,m.get($.key).overlayedDocument);V!=null&&F.push(new Ht($.key,V,Ff(V.value.mapValue),Qe.exists(!0)))}return l.mutationQueue.addMutationBatch(w,d,F,c)}).next(k=>{_=k;const F=k.applyToLocalDocumentSet(m,C);return l.documentOverlayCache.saveOverlays(w,k.batchId,F)})}).then(()=>({batchId:_.batchId,changes:Yf(m)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(o,c,l){let d=o.Ba[o.currentUser.toKey()];d||(d=new _e(Y)),d=d.insert(c,l),o.Ba[o.currentUser.toKey()]=d}(r,s.batchId,t),await An(r,s.changes),await Qr(r.remoteStore)}catch(s){const i=il(s,"Failed to persist write");t.reject(i)}}async function sp(n,e){const t=G(n);try{const r=await EE(t.localStore,e);e.targetChanges.forEach((s,i)=>{const o=t.Na.get(i);o&&(z(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1),s.addedDocuments.size>0?o.va=!0:s.modifiedDocuments.size>0?z(o.va):s.removedDocuments.size>0&&(z(o.va),o.va=!1))}),await An(t,r,e)}catch(r){await En(r)}}function nh(n,e,t){const r=G(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Fa.forEach((i,o)=>{const c=o.view.Z_(e);c.snapshot&&s.push(c.snapshot)}),function(o,c){const l=G(o);l.onlineState=c;let d=!1;l.queries.forEach((f,m)=>{for(const _ of m.j_)_.Z_(c)&&(d=!0)}),d&&ol(l)}(r.eventManager,e),s.length&&r.Ca.d_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function rT(n,e,t){const r=G(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.Na.get(e),i=s&&s.key;if(i){let o=new _e(M.comparator);o=o.insert(i,Se.newNoDocument(i,H.min()));const c=ne().add(i),l=new ui(H.min(),new Map,new _e(Y),o,c);await sp(r,l),r.Oa=r.Oa.remove(i),r.Na.delete(e),ul(r)}else await $r(r.localStore,e,!1).then(()=>Gr(r,e,t)).catch(En)}async function sT(n,e){const t=G(n),r=e.batch.batchId;try{const s=await wE(t.localStore,e);ll(t,r,null),cl(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await An(t,s)}catch(s){await En(s)}}async function iT(n,e,t){const r=G(n);try{const s=await function(o,c){const l=G(o);return l.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let f;return l.mutationQueue.lookupMutationBatch(d,c).next(m=>(z(m!==null),f=m.keys(),l.mutationQueue.removeMutationBatch(d,m))).next(()=>l.mutationQueue.performConsistencyCheck(d)).next(()=>l.documentOverlayCache.removeOverlaysForBatchId(d,f,c)).next(()=>l.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,f)).next(()=>l.localDocuments.getDocuments(d,f))})}(r.localStore,e);ll(r,e,t),cl(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await An(r,s)}catch(s){await En(s)}}function cl(n,e){(n.ka.get(e)||[]).forEach(t=>{t.resolve()}),n.ka.delete(e)}function ll(n,e,t){const r=G(n);let s=r.Ba[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.Ba[r.currentUser.toKey()]=s}}function Gr(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Ma.get(e))n.Fa.delete(r),t&&n.Ca.$a(r,t);n.Ma.delete(e),n.isPrimaryClient&&n.La.gr(e).forEach(r=>{n.La.containsKey(r)||ip(n,r)})}function ip(n,e){n.xa.delete(e.path.canonicalString());const t=n.Oa.get(e);t!==null&&(jr(n.remoteStore,t),n.Oa=n.Oa.remove(e),n.Na.delete(t),ul(n))}function vc(n,e,t){for(const r of t)r instanceof tp?(n.La.addReference(r.key,e),oT(n,r)):r instanceof np?(N("SyncEngine","Document no longer in limbo: "+r.key),n.La.removeReference(r.key,e),n.La.containsKey(r.key)||ip(n,r.key)):q()}function oT(n,e){const t=e.key,r=t.path.canonicalString();n.Oa.get(t)||n.xa.has(r)||(N("SyncEngine","New document in limbo: "+t),n.xa.add(r),ul(n))}function ul(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const e=n.xa.values().next().value;n.xa.delete(e);const t=new M(ce.fromString(e)),r=n.qa.next();n.Na.set(r,new JE(t)),n.Oa=n.Oa.insert(t,r),Xo(n.remoteStore,new Ft(ut($o(t.path)),r,"TargetPurposeLimboResolution",st.oe))}}async function An(n,e,t){const r=G(n),s=[],i=[],o=[];r.Fa.isEmpty()||(r.Fa.forEach((c,l)=>{o.push(r.Ka(l,e,t).then(d=>{var f;if((d||t)&&r.isPrimaryClient){const m=d?!d.fromCache:(f=t==null?void 0:t.targetChanges.get(l.targetId))===null||f===void 0?void 0:f.current;r.sharedClientState.updateQueryState(l.targetId,m?"current":"not-current")}if(d){s.push(d);const m=Zc.Wi(l.targetId,d);i.push(m)}}))}),await Promise.all(o),r.Ca.d_(s),await async function(l,d){const f=G(l);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",m=>S.forEach(d,_=>S.forEach(_.$i,w=>f.persistence.referenceDelegate.addReference(m,_.targetId,w)).next(()=>S.forEach(_.Ui,w=>f.persistence.referenceDelegate.removeReference(m,_.targetId,w)))))}catch(m){if(!Tn(m))throw m;N("LocalStore","Failed to update sequence numbers: "+m)}for(const m of d){const _=m.targetId;if(!m.fromCache){const w=f.os.get(_),P=w.snapshotVersion,C=w.withLastLimboFreeSnapshotVersion(P);f.os=f.os.insert(_,C)}}}(r.localStore,i))}async function aT(n,e){const t=G(n);if(!t.currentUser.isEqual(e)){N("SyncEngine","User change. New user:",e.toKey());const r=await Fm(t.localStore,e);t.currentUser=e,function(i,o){i.ka.forEach(c=>{c.forEach(l=>{l.reject(new O(x.CANCELLED,o))})}),i.ka.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await An(t,r.hs)}}function cT(n,e){const t=G(n),r=t.Na.get(e);if(r&&r.va)return ne().add(r.key);{let s=ne();const i=t.Ma.get(e);if(!i)return s;for(const o of i){const c=t.Fa.get(o);s=s.unionWith(c.view.Va)}return s}}async function lT(n,e){const t=G(n),r=await pc(t.localStore,e.query,!0),s=e.view.ba(r);return t.isPrimaryClient&&vc(t,e.targetId,s.wa),s}async function uT(n,e){const t=G(n);return $m(t.localStore,e).then(r=>An(t,r))}async function dT(n,e,t,r){const s=G(n),i=await function(c,l){const d=G(c),f=G(d.mutationQueue);return d.persistence.runTransaction("Lookup mutation documents","readonly",m=>f.Mn(m,l).next(_=>_?d.localDocuments.getDocuments(m,_):S.resolve(null)))}(s.localStore,e);i!==null?(t==="pending"?await Qr(s.remoteStore):t==="acknowledged"||t==="rejected"?(ll(s,e,r||null),cl(s,e),function(c,l){G(G(c).mutationQueue).On(l)}(s.localStore,e)):q(),await An(s,i)):N("SyncEngine","Cannot apply mutation batch with id: "+e)}async function hT(n,e){const t=G(n);if(Yo(t),dl(t),e===!0&&t.Qa!==!0){const r=t.sharedClientState.getAllActiveQueryTargets(),s=await rh(t,r.toArray());t.Qa=!0,await _c(t.remoteStore,!0);for(const i of s)Xo(t.remoteStore,i)}else if(e===!1&&t.Qa!==!1){const r=[];let s=Promise.resolve();t.Ma.forEach((i,o)=>{t.sharedClientState.isLocalQueryTarget(o)?r.push(o):s=s.then(()=>(Gr(t,o),$r(t.localStore,o,!0))),jr(t.remoteStore,o)}),await s,await rh(t,r),function(o){const c=G(o);c.Na.forEach((l,d)=>{jr(c.remoteStore,d)}),c.La.pr(),c.Na=new Map,c.Oa=new _e(M.comparator)}(t),t.Qa=!1,await _c(t.remoteStore,!1)}}async function rh(n,e,t){const r=G(n),s=[],i=[];for(const o of e){let c;const l=r.Ma.get(o);if(l&&l.length!==0){c=await Ro(r.localStore,ut(l[0]));for(const d of l){const f=r.Fa.get(d),m=await lT(r,f);m.snapshot&&i.push(m.snapshot)}}else{const d=await Um(r.localStore,o);c=await Ro(r.localStore,d),await al(r,op(d),o,!1,c.resumeToken)}s.push(c)}return r.Ca.d_(i),s}function op(n){return Kf(n.path,n.collectionGroup,n.orderBy,n.filters,n.limit,"F",n.startAt,n.endAt)}function fT(n){return function(t){return G(G(t).persistence).Qi()}(G(n).localStore)}async function mT(n,e,t,r){const s=G(n);if(s.Qa)return void N("SyncEngine","Ignoring unexpected query state notification.");const i=s.Ma.get(e);if(i&&i.length>0)switch(t){case"current":case"not-current":{const o=await $m(s.localStore,Qf(i[0])),c=ui.createSynthesizedRemoteEventForCurrentChange(e,t==="current",xe.EMPTY_BYTE_STRING);await An(s,o,c);break}case"rejected":await $r(s.localStore,e,!0),Gr(s,e,r);break;default:q()}}async function pT(n,e,t){const r=Yo(n);if(r.Qa){for(const s of e){if(r.Ma.has(s)&&r.sharedClientState.isActiveQueryTarget(s)){N("SyncEngine","Adding an already active target "+s);continue}const i=await Um(r.localStore,s),o=await Ro(r.localStore,i);await al(r,op(i),o.targetId,!1,o.resumeToken),Xo(r.remoteStore,o)}for(const s of t)r.Ma.has(s)&&await $r(r.localStore,s,!1).then(()=>{jr(r.remoteStore,s),Gr(r,s)}).catch(En)}}function Yo(n){const e=G(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=sp.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=cT.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=rT.bind(null,e),e.Ca.d_=KE.bind(null,e.eventManager),e.Ca.$a=HE.bind(null,e.eventManager),e}function dl(n){const e=G(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=sT.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=iT.bind(null,e),e}class Js{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Qo(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return Mm(this.persistence,new Om,e.initialUser,this.serializer)}Ga(e){return new Nm(Wo.Zr,this.serializer)}Wa(e){return new qm}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Js.provider={build:()=>new Js};class ap extends Js{constructor(e,t,r){super(),this.Ja=e,this.cacheSizeBytes=t,this.forceOwnership=r,this.kind="persistent",this.synchronizeTabs=!1}async initialize(e){await super.initialize(e),await this.Ja.initialize(this,e),await dl(this.Ja.syncEngine),await Qr(this.Ja.remoteStore),await this.persistence.yi(()=>(this.gcScheduler&&!this.gcScheduler.started&&this.gcScheduler.start(),this.indexBackfillerScheduler&&!this.indexBackfillerScheduler.started&&this.indexBackfillerScheduler.start(),Promise.resolve()))}za(e){return Mm(this.persistence,new Om,e.initialUser,this.serializer)}ja(e,t){const r=this.persistence.referenceDelegate.garbageCollector;return new rE(r,e.asyncQueue,t)}Ha(e,t){const r=new OI(t,this.persistence);return new LI(e.asyncQueue,r)}Ga(e){const t=Lm(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey),r=this.cacheSizeBytes!==void 0?rt.withCacheSize(this.cacheSizeBytes):rt.DEFAULT;return new Yc(this.synchronizeTabs,t,e.clientId,r,e.asyncQueue,Gm(),no(),this.serializer,this.sharedClientState,!!this.forceOwnership)}Wa(e){return new qm}}class gT extends ap{constructor(e,t){super(e,t,!1),this.Ja=e,this.cacheSizeBytes=t,this.synchronizeTabs=!0}async initialize(e){await super.initialize(e);const t=this.Ja.syncEngine;this.sharedClientState instanceof Fa&&(this.sharedClientState.syncEngine={no:dT.bind(null,t),ro:mT.bind(null,t),io:pT.bind(null,t),Qi:fT.bind(null,t),eo:uT.bind(null,t)},await this.sharedClientState.start()),await this.persistence.yi(async r=>{await hT(this.Ja.syncEngine,r),this.gcScheduler&&(r&&!this.gcScheduler.started?this.gcScheduler.start():r||this.gcScheduler.stop()),this.indexBackfillerScheduler&&(r&&!this.indexBackfillerScheduler.started?this.indexBackfillerScheduler.start():r||this.indexBackfillerScheduler.stop())})}Wa(e){const t=Gm();if(!Fa.D(t))throw new O(x.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.");const r=Lm(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey);return new Fa(t,e.asyncQueue,r,e.clientId,e.initialUser)}}class Xs{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>nh(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=aT.bind(null,this.syncEngine),await _c(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new zE}()}createDatastore(e){const t=Qo(e.databaseInfo.databaseId),r=function(i){return new PE(i)}(e.databaseInfo);return function(i,o,c,l){return new DE(i,o,c,l)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,s,i,o,c){return new VE(r,s,i,o,c)}(this.localStore,this.datastore,e.asyncQueue,t=>nh(this.syncEngine,t,0),function(){return Xd.D()?new Xd:new AE}())}createSyncEngine(e,t){return function(s,i,o,c,l,d,f){const m=new XE(s,i,o,c,l,d);return f&&(m.Qa=!0),m}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(s){const i=G(s);N("RemoteStore","RemoteStore shutting down."),i.L_.add(5),await hi(i),i.k_.shutdown(),i.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}Xs.provider={build:()=>new Xs};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lt{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let r;try{r=lt.makeFromUrl(e,t)}catch{return new lt(e,"")}if(r.path==="")return r;throw nb(e)}static makeFromUrl(e,t){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(B){B.path.charAt(B.path.length-1)==="/"&&(B.path_=B.path_.slice(0,-1))}const o="(/(.*))?$",c=new RegExp("^gs://"+s+o,"i"),l={bucket:1,path:3};function d(B){B.path_=decodeURIComponent(B.path)}const f="v[A-Za-z0-9_]+",m=t.replace(/[.]/g,"\\."),_="(/([^?#]*).*)?$",w=new RegExp(`^https?://${m}/${f}/b/${s}/o${_}`,"i"),P={bucket:1,path:3},C=t===bp?"(?:storage.googleapis.com|storage.cloud.google.com)":t,k="([^?#]*)",F=new RegExp(`^https?://${C}/${s}/${k}`,"i"),V=[{regex:c,indices:l,postModify:i},{regex:w,indices:P,postModify:d},{regex:F,indices:{bucket:1,path:2},postModify:d}];for(let B=0;B<V.length;B++){const K=V[B],J=K.regex.exec(e);if(J){const T=J[K.indices.bucket];let y=J[K.indices.path];y||(y=""),r=new lt(T,y),K.postModify(r);break}}if(r==null)throw tb(e);return r}}class cb{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lb(n,e,t){let r=1,s=null,i=null,o=!1,c=0;function l(){return c===2}let d=!1;function f(...k){d||(d=!0,e.apply(null,k))}function m(k){s=setTimeout(()=>{s=null,n(w,l())},k)}function _(){i&&clearTimeout(i)}function w(k,...F){if(d){_();return}if(k){_(),f.call(null,k,...F);return}if(l()||o){_(),f.call(null,k,...F);return}r<64&&(r*=2);let V;c===1?(c=2,V=0):V=(r+Math.random())*1e3,m(V)}let P=!1;function C(k){P||(P=!0,_(),!d&&(s!==null?(k||(c=2),clearTimeout(s),m(0)):k||(c=1)))}return m(0),i=setTimeout(()=>{o=!0,C(!0)},t),C}function ub(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function db(n){return n!==void 0}function hb(n){return typeof n=="object"&&!Array.isArray(n)}function bl(n){return typeof n=="string"||n instanceof String}function fh(n){return Al()&&n instanceof Blob}function Al(){return typeof Blob<"u"}function mh(n,e,t,r){if(r<e)throw wc(`Invalid value for '${n}'. Expected ${e} or greater.`);if(r>t)throw wc(`Invalid value for '${n}'. Expected ${t} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xp(n){let e;try{e=JSON.parse(n)}catch{return null}return hb(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
(Kræver login med din bruger)`);const s=n.shooters.map(c=>{var l;return(l=g.friends.find(d=>d.id===c.id))==null?void 0:l.email}).filter(Boolean),i="3D Bueskydning - "+n.name,o="mailto:"+s.join(",")+"?subject="+encodeURIComponent(i)+"&body="+encodeURIComponent(t);window.location.href=o};function vh(n,e){var $;const t=V=>{var B;return V.shooters.find(K=>K.id===e)||((B=V.shooters)==null?void 0:B[0])},r=n.map(V=>{const B=t(V);return B?Je(B.scores):null}).filter(V=>V!==null);let s=0,i=0,o=0,c=0;const l={11:0,10:0,8:0,5:0,M:0},d={11:0,10:0,8:0,5:0,M:0};n.forEach(V=>{const B=t(V);B&&B.scores.forEach(K=>{K[0]!=null&&(K[0]==="M"?(l.M++,i++):(l[Number(K[0])]=(l[Number(K[0])]||0)+1,s+=Number(K[0]),i++)),K[1]!=null&&(K[1]==="M"?(d.M++,c++):(d[Number(K[1])]=(d[Number(K[1])]||0)+1,o+=Number(K[1]),c++))})});const f=i?(s/i).toFixed(2):0,m=c?(o/c).toFixed(2):0,_=i+c?((s+o)/(i+c)).toFixed(2):0,w=(($=n[0])==null?void 0:$.numTargets)||24,C=Array.from({length:w},(V,B)=>{let K=0,J=0;return n.forEach(T=>{const y=t(T);if(!y)return;(y.scores[B]||[null,null]).forEach(E=>{E!=null&&(K+=Ne(E),J++)})}),J?K/J:null}).map((V,B)=>({v:V,i:B})).filter(V=>V.v!==null),k=C.length?C.reduce((V,B)=>V.v>B.v?V:B):null,F=C.length?C.reduce((V,B)=>V.v<B.v?V:B):null;return{myScores:r,p1avg:f,p2avg:m,pilAvg:_,distP1:l,distP2:d,bestTarget:k,worstTarget:F}}function PA(n){let e=1,t=0,r=0,s=0,i=1,o=0,c=0,l=0,d=0,f=0,m=0,_=0,w=0;const P=()=>{n.style.transformOrigin="0 0",n.style.transform=e>1?`translate(${t}px,${r}px) scale(${e})`:""};n.addEventListener("touchstart",k=>{if(k.preventDefault(),k.touches.length===2){const F=k.touches,$=n.getBoundingClientRect();s=Math.hypot(F[0].clientX-F[1].clientX,F[0].clientY-F[1].clientY),i=e,o=t,c=r,l=(F[0].clientX+F[1].clientX)/2-$.left,d=(F[0].clientY+F[1].clientY)/2-$.top}else k.touches.length===1&&(f=k.touches[0].clientX,m=k.touches[0].clientY,_=t,w=r)},{passive:!1}),n.addEventListener("touchmove",k=>{if(k.preventDefault(),k.touches.length===2){const F=k.touches,$=Math.hypot(F[0].clientX-F[1].clientX,F[0].clientY-F[1].clientY),V=Math.min(8,Math.max(1,i*$/s)),B=(l-o)/i,K=(d-c)/i;t=l-B*V,r=d-K*V,e=V,P()}else k.touches.length===1&&e>1&&(t=_+k.touches[0].clientX-f,r=w+k.touches[0].clientY-m,P())},{passive:!1}),n.addEventListener("touchend",()=>{e<1.05&&(e=1,t=0,r=0,P())},{passive:!0});let C=0;n.addEventListener("touchend",()=>{const k=Date.now();k-C<300&&(e=1,t=0,r=0,P()),C=k},{passive:!0})}function CA(n){g.pendingAnalyseRound=n,document.getElementById("analyse-filter").value="specific",window.switchTab("analyse")}window.analyseRound=CA;function kA(n,e,t,r){const s=["11","10","8","5","M"],i={11:"#1a7a3a",10:"#1a5aaa",8:"#d4700a",5:"#7a3aaa",M:"#cc3333"},o=n.myScores[0]||0,c=t.myScores[0]||0,l=Math.abs(o-c),d='<div class="cmp-sep"></div>',f=(w,P,C)=>`<div style="font-size:11px;color:${C};margin-bottom:4px;">${Z(P)}</div>
  ...
  </div>`,_}window.renderAnalyse=function(){var _i,Pn,yi,vi,Cn,kn,dr,hr;const n=document.getElementById("analyse-content");if(!n)return;const e=document.getElementById("analyse-bane");if(e&&e.options.length<=1&&[...new Set(g.rounds.map(U=>U.courseId).filter(Boolean))].forEach(U=>{const te=g.courses.find(re=>re.id===U);if(te&&!Array.from(e.options).find(re=>re.value===U)){const re=document.createElement("option");re.value=U,re.textContent=te.name,e.appendChild(re)}}),g.pendingAnalyseRound&&e){const j=g.rounds.find(U=>U.id===g.pendingAnalyseRound);j!=null&&j.courseId&&Array.from(e.options).some(U=>U.value===j.courseId)&&(e.value=j.courseId)}const t=((_i=document.getElementById("analyse-filter"))==null?void 0:_i.value)||"all",r=t==="all"?0:t==="lastround"?1:t==="specific"?0:Number(t),s=((Pn=document.getElementById("analyse-bane"))==null?void 0:Pn.value)||"all",i=Number((yi=document.getElementById("analyse-antal"))==null?void 0:yi.value)||0,o=document.getElementById("analyse-runde-wrap"),c=document.getElementById("analyse-runde"),l=document.getElementById("analyse-runde-wrap-2"),d=document.getElementById("analyse-runde-2"),f=document.getElementById("analyse-runde-lbl"),m=t==="compare";o&&(o.style.display=t==="specific"||m?"":"none"),l&&(l.style.display=m?"":"none"),f&&(f.style.display=m?"":"none");const _=j=>{const U=j.created;return U!=null&&U.toDate?U.toDate().toLocaleDateString("da-DK"):U!=null&&U.seconds?new Date(U.seconds*1e3).toLocaleDateString("da-DK"):typeof U=="number"?new Date(U).toLocaleDateString("da-DK"):"—"},w=(j,U)=>{const te=s==="all"?g.rounds:g.rounds.filter(W=>W.courseId===s),re=j.value;j.innerHTML=`<option value="">${U}</option>`,te.forEach(W=>{const ye=document.createElement("option");ye.value=W.id,ye.textContent=`${_(W)} — ${W.name||"Runde"}`,j.appendChild(ye)}),te.some(W=>W.id===re)&&(j.value=re)};if((t==="specific"||m)&&c&&(w(c,"Vælg runde..."),g.pendingAnalyseRound&&(c.value=g.pendingAnalyseRound,g.pendingAnalyseRound=null)),m&&d&&w(d,"Vælg runde 2..."),m){const j=c==null?void 0:c.value,U=d==null?void 0:d.value;if(!j||!U){n.innerHTML='<div class="empty"><div class="empty-icon">📊</div>Vælg to runder ovenfor</div>';return}const te=g.rounds.map(ue=>({...ue,shooters:(ue.shooters||[]).map(be=>({...be,scores:or(be.scores)}))})),re=te.find(ue=>ue.id===j),W=te.find(ue=>ue.id===U);if(!re||!W){n.innerHTML='<div class="empty">Kunne ikke finde runderne</div>';return}const ye=`${re.name||"Runde"} (${_(re)})`,we=`${W.name||"Runde"} (${_(W)})`;n.innerHTML=kA(vh([re],(vi=g.user)==null?void 0:vi.uid),ye,vh([W],(Cn=g.user)==null?void 0:Cn.uid),we);return}const P=g.rounds.map(j=>({...j,shooters:(j.shooters||[]).map(U=>({...U,scores:or(U.scores)}))}));let C=s==="all"?P:P.filter(j=>j.courseId===s);if(t==="specific"){const j=c==null?void 0:c.value;C=j?C.filter(U=>U.id===j):[]}const k=i||r,F=k&&t!=="specific"?C.slice(0,k):C;if(!F.length){n.innerHTML='<div class="empty"><div class="empty-icon">📈</div>Ingen runder endnu</div>';return}const $=j=>{var U;return j.shooters.find(te=>{var re;return te.id===((re=g.user)==null?void 0:re.uid)})||((U=j.shooters)==null?void 0:U[0])},V=F.map(j=>{const U=$(j);return U?Je(U.scores):null}).filter(j=>j!==null),B=V.length?(V.reduce((j,U)=>j+U,0)/V.length).toFixed(1):0,K=V.length?Math.max(...V):0,J=V.length?Math.min(...V):0;let T=0,y=0,v=0,E=0;const b={11:0,10:0,8:0,5:0,M:0},R={11:0,10:0,8:0,5:0,M:0};F.forEach(j=>{const U=$(j);U&&U.scores.forEach(te=>{te[0]!=null&&(te[0]==="M"?(b.M++,y++):(b[Number(te[0])]=(b[Number(te[0])]||0)+1,T+=Number(te[0]),y++)),te[1]!=null&&(te[1]==="M"?(R.M++,E++):(R[Number(te[1])]=(R[Number(te[1])]||0)+1,v+=Number(te[1]),E++))})});const I=y?(T/y).toFixed(2):0,ot=E?(v/E).toFixed(2):0,xt=y+E?((T+v)/(y+E)).toFixed(2):0,ht=((kn=F[0])==null?void 0:kn.numTargets)||24,Qt=Array.from({length:ht},(j,U)=>{let te=0,re=0;return F.forEach(W=>{const ye=$(W);if(!ye)return;const ue=(W.traversalOrder||Array.from({length:W.numTargets||ht},(Ae,he)=>he))[U];if(ue===void 0)return;(ye.scores[ue]||[null,null]).forEach(Ae=>{Ae!=null&&(te+=Ne(Ae),re++)})}),re?te/re:null}),vt=Qt.map((j,U)=>({v:j,i:U})).filter(j=>j.v!==null),Jt=vt.length?vt.reduce((j,U)=>j.v>U.v?j:U):null,Sn=vt.length?vt.reduce((j,U)=>j.v<U.v?j:U):null,da=["11","10","8","5","M"];let Me="";if(Me+=`<div class="stats-grid2">
    ...
    <div class="pil-best-note">
  ...
  </div>`,Jt&&Sn&&Jt.i!==Sn.i&&(Me+=`<div class="card card-mb16">
      ...
      <div class="cmp-target-grid">
        ...
        <div class="target-worst-box">
          ...
          <div class="target-worst-val">Skud nr. ${Sn.i+1}</div>
          <div class="target-sub-13">⌀ ${Sn.v.toFixed(2)}</div>
        </div>
      </div>
    </div>`),Me+=`<div class="card card-mb16">
    <div class="section-title-mb12">FORDELING PR. SCOREZONE</div>
    <div class="pie-grid">`,da.forEach(j=>{const U=b[j]||0,te=R[j]||0,re=U+te,W=30;let ye="";if(re===0)ye=`<circle cx="${W}" cy="${W}" r="${W}" fill="var(--surface2)"/>`;else if(te===0)ye=`<circle cx="${W}" cy="${W}" r="${W}" fill="#ffd700"/>`;else if(U===0)ye=`<circle cx="${W}" cy="${W}" r="${W}" fill="#00cc44"/>`;else{const we=U/re,ue=we*2*Math.PI,be=W,Ae=0,he=W-W*Math.sin(ue),Ue=W-W*Math.cos(ue),me=ue>Math.PI?1:0;ye=`<path d="M${W},${W} L${be},${Ae} A${W},${W} 0 ${me},0 ${he},${Ue} Z" fill="#ffd700"/>
           <path d="M${W},${W} L${he},${Ue} A${W},${W} 0 ${1-me},0 ${be},${Ae} Z" fill="#00cc44"/>`}Me+=`<div class="pie-cell">
    ...
    <div class="pie-legend">
  ...
  </div>`,V.length>1){const re=Math.min(...V)-5,W=Math.max(...V)+5,ye=V.slice().reverse().map((we,ue)=>{const be=30+ue/(V.length-1)*280,Ae=90-(we-re)/(W-re)*(120-2*30);return`${be},${Ae}`}).join(" ");Me+=`<div class="card card-mb16">
      ...
      <svg viewBox="0 0 340 120" class="graph-svg">
        ...
        ${V.slice().reverse().map((we,ue)=>{const be=30+ue/(V.length-1)*280,Ae=90-(we-re)/(W-re)*(120-2*30);return`<circle cx="${be}" cy="${Ae}" r="4" fill="var(--acc)"/><text x="${be}" y="${Ae-8}" text-anchor="middle" font-size="10" fill="var(--text)">${we}</text>`}).join("")}
    ...
    </div>`}const Fe=s!=="all"||t==="lastround"||t==="specific",It=Qt.map((j,U)=>({v:j,i:U})).filter(j=>j.v!==null);if(It.length>1&&Fe){const we=Math.floor(Math.min(...It.map(X=>X.v))),ue=Math.ceil(Math.max(...It.map(X=>X.v))),be=ue-we||1,Ae=X=>42+(ht>1?X/(ht-1)*283:0),he=X=>15+120*(1-(X-we)/be),Ue=It.map(({v:X,i:Xe})=>Ae(Xe)+","+he(X)).join(" "),me=[];for(let X=we;X<=ue;X++)(ue-we<=6||X%Math.ceil((ue-we)/5)===0)&&me.push(X);const $e=me.map(X=>`<line x1="38" y1="${he(X)}" x2="42" y2="${he(X)}" stroke="var(--muted)" stroke-width="1"/><text x="36" y="${he(X)+4}" text-anchor="end" font-size="9" fill="var(--muted)">${X}</text><line x1="42" y1="${he(X)}" x2="325" y2="${he(X)}" stroke="var(--surface2)" stroke-width="0.5" stroke-dasharray="3,3"/>`).join(""),fr=It.map(({v:X,i:Xe})=>`<circle cx="${Ae(Xe)}" cy="${he(X)}" r="3" fill="var(--acc)"/>`).join("");It.map(({v:X,i:Xe})=>`<circle cx="${Ae(Xe)}" cy="${he(X)}" r="4" fill="var(--acc)"/><text x="${Ae(Xe)}" y="${he(X)-8}" text-anchor="middle" font-size="9" fill="#fff">${X.toFixed(1)}</text>`).join("");const Dn=Math.max(340,ht*30),xn=X=>42+(ht>1?X/(ht-1)*(Dn-42-15):0),ha=It.map(({v:X,i:Xe})=>xn(Xe)+","+he(X)).join(" "),Vn=me.map(X=>`<line x1="38" y1="${he(X)}" x2="42" y2="${he(X)}" stroke="var(--muted)" stroke-width="1"/><text x="36" y="${he(X)+4}" text-anchor="end" font-size="9" fill="var(--muted)">${X}</text><line x1="42" y1="${he(X)}" x2="${Dn-15}" y2="${he(X)}" stroke="var(--surface2)" stroke-width="0.5" stroke-dasharray="3,3"/>`).join(""),Ii=It.map(({v:X,i:Xe})=>`<circle cx="${xn(Xe)}" cy="${he(X)}" r="5" fill="var(--acc)"/><text x="${xn(Xe)}" y="${he(X)-10}" text-anchor="middle" font-size="10" fill="#fff">${X.toFixed(1)}</text>`).join("");Me+=`<div class="card card-mb16">
      ...
      <svg viewBox="0 0 340 160" class="graph-svg">
        ...
        <text x="325" y="155" text-anchor="end" font-size="9" fill="var(--muted)">${ht}</text>
      </svg>
    ...
    <div id="graph-fs" class="fs-ov hidden graph-fs-overlay" onclick="this.classList.add('hidden')">
      <div class="graph-fs-box" onclick="event.stopPropagation()">
        ...
        <svg id="graph-fs-svg" viewBox="0 0 ${Dn} 160" class="graph-fs-svg">
          <line x1="42" y1="15" x2="42" y2="135" stroke="var(--surface2)" stroke-width="1"/>
          <line x1="42" y1="135" x2="${Dn-15}" y2="135" stroke="var(--surface2)" stroke-width="1"/>
          ${Vn}
          <polyline points="${ha}" fill="none" stroke="var(--acc)" stroke-width="2.5" stroke-linejoin="round"/>
          ${Ii}
          <text x="42" y="155" font-size="9" fill="var(--muted)">1</text>
          <text x="${xn(ht-1)}" y="155" text-anchor="end" font-size="9" fill="var(--muted)">${ht}</text>
        </svg>
        <button class="btn btn-dark graph-fs-close-btn" onclick="document.getElementById('graph-fs').classList.add('hidden')">Luk</button>
      </div>
    </div>`}n.innerHTML=Me;const Xt=document.getElementById("graph-fs-svg");if(Xt&&PA(Xt),s!=="all"&&((dr=g.profile)!=null&&dr.kon)&&((hr=g.profile)!=null&&hr.bueklasse)){const j=g.profile.kon==="herre"?"Herre":"Dame",U={langbue:"Langbue",trad:"Traditionel",recurve:"Recurve",compound:"Compound",barbue:"Barbue",buejæger:"Buejæger","trad-buejæger":"Trad. buejæger",rytterbue:"Rytterbue"}[g.profile.bueklasse]||g.profile.bueklasse,te=document.createElement("div");te.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${j} ${U}</div><div class="comp-loading-msg">Henter...</div></div>`,n.appendChild(te),gt(ft(ee,"bane_stats",s,"runder")).then(re=>{const ye=re.docs.map(Ue=>Ue.data()).filter(Ue=>Ue.kon===g.profile.kon&&Ue.bueklasse===g.profile.bueklasse);if(!ye.length){te.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${j} ${U}</div><div class="comp-loading-msg">Ingen andre ${j} ${U}-skytter har skudt denne bane endnu.</div></div>`;return}const we=ye.filter(Ue=>(Ue.arrowsShot||Ue.numTargets*2)>0),ue=we.length?(we.reduce((Ue,me)=>Ue+me.score/(me.arrowsShot||me.numTargets*2),0)/we.length).toFixed(2):"—",be=ue!=="—"?Number(xt)-Number(ue):null,Ae=be!==null?(be>0?"+":"")+be.toFixed(2):"—",he=be===null?"var(--muted)":be>0?"#2aaa5a":be<0?"var(--danger)":"var(--muted)";te.innerHTML=`<div class="card card-mb16">
        ...
        <div class="cmp-pil-grid">
          ...
          <div class="cmp-pil-mid">
            ...
            <div style="font-size:22px;font-weight:700;color:${he};">${Ae}</div>
          </div>
