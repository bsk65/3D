(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Od={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ky=()=>Cy().__FIREBASE_DEFAULTS__,Dy=()=>{if(typeof process>"u"||typeof Od>"u")return;const n=Od.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Ny=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&jf(n[1]);return e&&JSON.parse(e)},Ea=()=>{try{return ky()||Dy()||Ny()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},qf=n=>{var e,t;return(t=(e=Ea())===null||e===void 0?void 0:e.emulatorHosts)===null||t===void 0?void 0:t[n]},xy=n=>{const e=qf(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),r]:[e.substring(0,t),r]},Kf=()=>{var n;return(n=Ea())===null||n===void 0?void 0:n.config},Gf=n=>{var e;return(e=Ea())===null||e===void 0?void 0:e[`_${n}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qy="FirebaseError";class $t extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=qy,Object.setPrototypeOf(this,$t.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Or.prototype.create)}}class Or{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?Ky(i,r):"Error",c=`${this.serviceName}: ${o} (${s}).`;return new $t(s,c,r)}}function Ky(n,e){return n.replace(Gy,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Gy=/\{\$([^}]+)}/g;function zy(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Ai(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],o=e[s];if(Md(i)&&Md(o)){if(!Ai(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Md(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _n=new Sl("@firebase/app"),gv="@firebase/app-compat",_v="@firebase/analytics-compat",yv="@firebase/analytics",vv="@firebase/app-check-compat",wv="@firebase/app-check",Iv="@firebase/auth",Ev="@firebase/auth-compat",Tv="@firebase/database",bv="@firebase/data-connect",Av="@firebase/database-compat",Sv="@firebase/functions",Rv="@firebase/functions-compat",Pv="@firebase/installations",Cv="@firebase/installations-compat",kv="@firebase/messaging",Dv="@firebase/messaging-compat",Nv="@firebase/performance",xv="@firebase/performance-compat",Vv="@firebase/remote-config",Lv="@firebase/remote-config-compat",Ov="@firebase/storage",Mv="@firebase/storage-compat",Fv="@firebase/firestore",Bv="@firebase/vertexai-preview",Uv="@firebase/firestore-compat",$v="firebase",jv="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xo=new Map,Kv=new Map,zc=new Map;function jd(n,e){try{n.container.addComponent(e)}catch(t){_n.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ft(n){const e=n.name;if(zc.has(e))return _n.debug(`There were multiple attempts to register component ${e}.`),!1;zc.set(e,n);for(const t of Xo.values())jd(t,n);for(const t of Kv.values())jd(t,n);return!0}function Mr(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Wt(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fr=jv;function Jf(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Gc,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw Bn.create("bad-app-name",{appName:String(s)});if(t||(t=Kf()),!t)throw Bn.create("no-options");const i=Xo.get(s);if(i){if(Ai(t,i.options)&&Ai(r,i.config))return i;throw Bn.create("duplicate-app",{appName:s})}const o=new Zy(s);for(const l of zc.values())o.addComponent(l);const c=new zv(t,r,o);return Xo.set(s,c),c}function Pl(n=Gc){const e=Xo.get(n);if(!e&&n===Gc&&Kf())return Jf();if(!e)throw Bn.create("no-app",{appName:n});return e}function vt(n,e,t){var r;let s=(r=qv[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),_n.warn(c.join(" "));return}Ft(new kt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hv="firebase-heartbeat-database",Wv=1,Si="firebase-heartbeat-store";let bc=null;function Yf(){return bc||(bc=Ta(Hv,Wv,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Si)}catch(t){console.warn(t)}}}}).catch(n=>{throw Bn.create("idb-open",{originalErrorMessage:n.message})})),bc}async function Qv(n){try{const t=(await Yf()).transaction(Si),r=await t.objectStore(Si).get(Xf(n));return await t.done,r}catch(e){if(e instanceof $t)_n.warn(e.message);else{const t=Bn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});_n.warn(t.message)}}}async function qd(n,e){try{const r=(await Yf()).transaction(Si,"readwrite");await r.objectStore(Si).put(e,Xf(n)),await r.done}catch(t){if(t instanceof $t)_n.warn(t.message);else{const r=Bn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});_n.warn(r.message)}}}function Xf(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vt(nw,rw,"app");function Cl(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}function Zf(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const sw=Zf,em=new Or("auth","Firebase",Zf());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zo=new Sl("@firebase/auth");function iw(n,...e){Zo.logLevel<=ie.WARN&&Zo.warn(`Auth (${Fr}): ${n}`,...e)}function xo(n,...e){Zo.logLevel<=ie.ERROR&&Zo.error(`Auth (${Fr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi{constructor(e,t){this.shortDelay=e,this.longDelay=t,yn(t>e,"Short delay should be less than long delay!"),this.isMobile=Oy()||Uy()}get(){return aw()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dl(n,e){yn(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pw(n,e){return In(n,"POST","/v1/accounts:delete",e)}async function im(n,e){return In(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gi(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function gw(n,e=!1){const t=Ie(n),r=await t.getIdToken(e),s=Nl(r);Z(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:gi(Ac(s.auth_time)),issuedAtTime:gi(Ac(s.iat)),expirationTime:gi(Ac(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Ac(n){return Number(n)*1e3}function Nl(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return xo("JWT malformed, contained fewer than 3 sections"),null;try{const s=jf(t);return s?JSON.parse(s):(xo("Failed to decode base64 JWT payload"),null)}catch(s){return xo("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Wd(n){const e=Nl(n);return Z(e,"internal-error"),Z(typeof e.exp<"u","internal-error"),Z(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qd=new Map;function dn(n){yn(n instanceof Function,"Expected a class definition");let e=Qd.get(n);return e?(yn(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Qd.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sw(n,e={}){return In(n,"GET","/v2/passwordPolicy",wn(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vl{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return ln("not implemented")}_getIdTokenResponse(e){return ln("not implemented")}_linkToIdToken(e,t){return ln("not implemented")}_getReauthenticationResolver(e){return ln("not implemented")}}async function jw(n,e){return In(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qw(n,e){return Hi(n,"POST","/v1/accounts:signInWithPassword",wn(n,e))}async function Kw(n,e){return In(n,"POST","/v1/accounts:sendOobCode",wn(n,e))}async function Gw(n,e){return Kw(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zw(n,e){return Hi(n,"POST","/v1/accounts:signInWithEmailLink",wn(n,e))}async function Hw(n,e){return Hi(n,"POST","/v1/accounts:signInWithEmailLink",wn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ms(n,e){return Hi(n,"POST","/v1/accounts:signInWithIdp",wn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn extends Wi{constructor(){super("facebook.com")}static credential(e){return Ir._fromParams({providerId:Nn.PROVIDER_ID,signInMethod:Nn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Nn.credentialFromTaggedObject(e)}static credentialFromError(e){return Nn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Nn.credential(e.oauthAccessToken)}catch{return null}}}Nn.FACEBOOK_SIGN_IN_METHOD="facebook.com";Nn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xn extends Wi{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Ir._fromParams({providerId:xn.PROVIDER_ID,signInMethod:xn.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return xn.credentialFromTaggedObject(e)}static credentialFromError(e){return xn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return xn.credential(t,r)}catch{return null}}}xn.GOOGLE_SIGN_IN_METHOD="google.com";xn.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn extends Wi{constructor(){super("github.com")}static credential(e){return Ir._fromParams({providerId:Vn.PROVIDER_ID,signInMethod:Vn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Vn.credentialFromTaggedObject(e)}static credentialFromError(e){return Vn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Vn.credential(e.oauthAccessToken)}catch{return null}}}Vn.GITHUB_SIGN_IN_METHOD="github.com";Vn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yw(n,e){return Hi(n,"POST","/v1/accounts:signUp",wn(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Im(n,e,t=!1){if(Wt(n.app))return Promise.reject(pn(n));const r="signIn",s=await wm(n,r,e),i=await Er._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function eI(n,e){return Im(zn(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Em(n){const e=zn(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function tI(n,e,t){const r=zn(n);await ta(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",Gw)}async function nI(n,e,t){if(Wt(n.app))return Promise.reject(pn(n));const r=zn(n),o=await ta(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Yw).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&Em(n),l}),c=await Er._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function rI(n,e,t){return Wt(n.app)?Promise.reject(pn(n)):eI(Ie(n),ks.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Em(n),r})}function sI(n,e,t,r){return Ie(n).onIdTokenChanged(e,t,r)}function iI(n,e,t){return Ie(n).beforeAuthStateChanged(e,t)}function oI(n,e,t,r){return Ie(n).onAuthStateChanged(e,t,r)}function aI(n){return Ie(n).signOut()}const ra="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PI="pendingRedirect",Lo=new Map;class CI extends Dm{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Lo.get(this.auth._key());if(!e){try{const r=await kI(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Lo.set(this.auth._key(),e)}return this.bypassAuthState||Lo.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function kI(n,e){const t=xI(e),r=NI(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function DI(n,e){Lo.set(n._key(),e)}function NI(n){return dn(n._redirectPersistence)}function xI(n){return Vo(PI,n.config.apiKey,n.name)}async function VI(n,e,t=!1){if(Wt(n.app))return Promise.reject(pn(n));const r=zn(n),s=TI(r,e),o=await new CI(r,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LI=10*60*1e3;class OI{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!MI(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var r;if(e.error&&!Nm(e)){const s=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";t.onError(Yt(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=LI&&this.cachedEventUids.clear(),this.cachedEventUids.has(sh(e))}saveEventToCache(e){this.cachedEventUids.add(sh(e)),this.lastProcessedEventTime=Date.now()}}function sh(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Nm({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function MI(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Nm(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function FI(n,e={}){return In(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sc="webStorageSupport";class uE{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Sm,this._completeRedirectFn=VI,this._overrideRedirectResult=DI}async _openPopup(e,t,r,s){var i;yn((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await ah(e,t,r,Hc(),s);return sE(e,o,Ol())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await ah(e,t,r,Hc(),s);return fI(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(yn(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await XI(e),r=new OI(e);return t.register("authEvent",s=>(Z(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Sc,{type:Sc},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[Sc];o!==void 0&&t(!!o),Bt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=$I(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return pm()||lm()||xl()}}const dE=uE;var ch="@firebase/auth",lh="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=new Sl("@firebase/firestore");function os(){return Tr.logLevel}function x(n,...e){if(Tr.logLevel<=ie.DEBUG){const t=e.map(Fl);Tr.debug(`Firestore (${Ds}): ${n}`,...t)}}function Le(n,...e){if(Tr.logLevel<=ie.ERROR){const t=e.map(Fl);Tr.error(`Firestore (${Ds}): ${n}`,...t)}}function Ci(n,...e){if(Tr.logLevel<=ie.WARN){const t=e.map(Fl);Tr.warn(`Firestore (${Ds}): ${n}`,...t)}}function Fl(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(n="Unexpected state"){const e=`FIRESTORE (${Ds}) INTERNAL ASSERTION FAILED: `+n;throw Le(e),new Error(e)}function J(n,e){n||z()}function W(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wE{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class IE{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(it.UNAUTHENTICATED))}shutdown(){}}class EE{constructor(e){this.t=e,this.currentUser=it.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){J(this.o===void 0);let r=this.i;const s=l=>this.i!==r?(r=this.i,t(l)):Promise.resolve();let i=new Zt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Zt,e.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},c=l=>{x("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(x("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Zt)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(x("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(J(typeof r.accessToken=="string"),new wE(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return J(e===null||typeof e=="string"),new it(e)}}class TE{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=it.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class bE{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new TE(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(it.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class AE{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class SE{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){J(this.o===void 0);const r=i=>{i.error!=null&&x("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.R;return this.R=i.token,x("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{x("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):x("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(J(typeof t.token=="string"),this.R=t.token,new AE(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hn(n){if(n.code!==N.FAILED_PRECONDITION||n.message!==qm)throw n;x("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc extends Km{constructor(e,t){super(),this._e=e,this.currentSequenceNumber=t}}function ze(n,e){const t=W(n);return Un.F(t._e,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zl(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ni(e)?"-0":e}}function _p(n){return{integerValue:""+n}}function gT(n,e){return zm(e)?_p(e):zl(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Na{constructor(){this._=void 0}}function _T(n,e,t){return n instanceof ws?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&jl(i)&&(i=ql(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(t,e):n instanceof Is?vp(n,e):n instanceof Es?wp(n,e):function(s,i){const o=yp(s,i),c=Ch(o)+Ch(s.Pe);return el(o)&&el(s.Pe)?_p(c):zl(s.serializer,c)}(n,e)}function yT(n,e,t){return n instanceof Is?vp(n,e):n instanceof Es?wp(n,e):t}function yp(n,e){return n instanceof Mi?function(r){return el(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class ws extends Na{}class Is extends Na{constructor(e){super(),this.elements=e}}function vp(n,e){const t=Ip(e);for(const r of n.elements)t.some(s=>en(s,r))||t.push(r);return{arrayValue:{values:t}}}class Es extends Na{constructor(e){super(),this.elements=e}}function wp(n,e){let t=Ip(e);for(const r of n.elements)t=t.filter(s=>!en(s,r));return{arrayValue:{values:t}}}class Mi extends Na{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Ch(n){return Te(n.integerValue||n.doubleValue)}function Ip(n){return Oi(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ep{constructor(e,t){this.field=e,this.transform=t}}function vT(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof Is&&s instanceof Is||r instanceof Es&&s instanceof Es?gs(r.elements,s.elements,en):r instanceof Mi&&s instanceof Mi?en(r.Pe,s.Pe):r instanceof ws&&s instanceof ws}(n.transform,e.transform)}class wT{constructor(e,t){this.version=e,this.transformResults=t}}class at{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new at}static exists(e){return new at(void 0,e)}static updateTime(e){return new at(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function jo(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class xa{}function Tp(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Va(n.key,at.none()):new xs(n.key,n.data,at.none());{const t=n.data,r=ot.empty();let s=new fe(be.comparator);for(let i of e.fields)if(!s.has(i)){let o=t.field(i);o===null&&i.length>1&&(i=i.popLast(),o=t.field(i)),o===null?r.delete(i):r.set(i,o),s=s.add(i)}return new En(n.key,r,new yt(s.toArray()),at.none())}}function IT(n,e,t){n instanceof xs?function(s,i,o){const c=s.value.clone(),l=Dh(s.fieldTransforms,i,o.transformResults);c.setAll(l),i.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(n,e,t):n instanceof En?function(s,i,o){if(!jo(s.precondition,i))return void i.convertToUnknownDocument(o.version);const c=Dh(s.fieldTransforms,i,o.transformResults),l=i.data;l.setAll(bp(s)),l.setAll(c),i.convertToFoundDocument(o.version,l).setHasCommittedMutations()}(n,e,t):function(s,i,o){i.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,t)}function Ii(n,e,t,r){return n instanceof xs?function(i,o,c,l){if(!jo(i.precondition,o))return c;const u=i.value.clone(),h=Nh(i.fieldTransforms,l,o);return u.setAll(h),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),null}(n,e,t,r):n instanceof En?function(i,o,c,l){if(!jo(i.precondition,o))return c;const u=Nh(i.fieldTransforms,l,o),h=o.data;return h.setAll(bp(i)),h.setAll(u),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(p=>p.field))}(n,e,t,r):function(i,o,c){return jo(i.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):c}(n,e,t)}function ET(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=yp(r.transform,s||null);i!=null&&(t===null&&(t=ot.empty()),t.set(r.field,i))}return t||null}function kh(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&gs(r,s,(i,o)=>vT(i,o))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class xs extends xa{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class En extends xa{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function bp(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function Dh(n,e,t){const r=new Map;J(n.length===t.length);for(let s=0;s<t.length;s++){const i=n[s],o=i.transform,c=e.data.field(i.field);r.set(i.field,yT(o,c,t[s]))}return r}function Nh(n,e,t){const r=new Map;for(const s of n){const i=s.transform,o=t.data.field(s.field);r.set(s.field,_T(i,o,e))}return r}class Va extends xa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Ap extends xa{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ST=new gr([4294967295,4294967295],0);function xh(n){const e=AT().encode(n),t=new xm;return t.update(e),new Uint8Array(t.digest())}function Vh(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new gr([t,r],0),new gr([s,i],0)]}class Jl{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new li(`Invalid padding: ${t}`);if(r<0)throw new li(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new li(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new li(`Invalid padding when bitmap length is 0: ${t}`);this.Ie=8*e.length-t,this.Te=gr.fromNumber(this.Ie)}Ee(e,t,r){let s=e.add(t.multiply(gr.fromNumber(r)));return s.compare(ST)===1&&(s=new gr([s.getBits(0),s.getBits(1)],0)),s.modulo(this.Te).toNumber()}de(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}mightContain(e){if(this.Ie===0)return!1;const t=xh(e),[r,s]=Vh(t);for(let i=0;i<this.hashCount;i++){const o=this.Ee(r,s,i);if(!this.de(o))return!1}return!0}static create(e,t,r){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),o=new Jl(i,s,t);return r.forEach(c=>o.insert(c)),o}insert(e){if(this.Ie===0)return;const t=xh(e),[r,s]=Vh(t);for(let i=0;i<this.hashCount;i++){const o=this.Ee(r,s,i);this.Ae(o)}}Ae(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class li extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qo{constructor(e,t,r,s){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=s}}class Rp{constructor(e,t){this.targetId=e,this.me=t}}class Pp{constructor(e,t,r=Me.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class Lh{constructor(){this.fe=0,this.ge=Mh(),this.pe=Me.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=se(),t=se(),r=se();return this.ge.forEach((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:z()}}),new Zi(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=Mh()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,J(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class RT{constructor(e){this.Le=e,this.Be=new Map,this.ke=It(),this.qe=Oh(),this.Qe=new ge(ne)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:z()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,s)=>{this.ze(s)&&t(s)})}He(e){const t=e.targetId,r=e.me.count,s=this.Je(t);if(s){const i=s.target;if(aa(i))if(r===0){const o=new $(i.path);this.Ue(t,o,De.newNoDocument(o,Y.min()))}else J(r===1);else{const o=this.Ye(t);if(o!==r){const c=this.Ze(e),l=c?this.Xe(c,e,o):1;if(l!==0){this.je(t);const u=l===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,u)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let o,c;try{o=jn(r).toUint8Array()}catch(l){if(l instanceof Xm)return Ci("Decoding the base64 bloom filter in existence filter failed ("+l.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw l}try{c=new Jl(o,s,i)}catch(l){return Ci(l instanceof li?"BloomFilter error: ":"Applying bloom filter failed: ",l),null}return c.Ie===0?null:c}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let s=0;return r.forEach(i=>{const o=this.Le.tt(),c=`projects/${o.projectId}/databases/${o.database}/documents/${i.path.canonicalString()}`;e.mightContain(c)||(this.Ue(t,i,null),s++)}),s}rt(e){const t=new Map;this.Be.forEach((i,o)=>{const c=this.Je(o);if(c){if(i.current&&aa(c.target)){const l=new $(c.target.path);this.ke.get(l)!==null||this.it(o,l)||this.Ue(o,l,De.newNoDocument(l,e))}i.be&&(t.set(o,i.ve()),i.Ce())}});let r=se();this.qe.forEach((i,o)=>{let c=!0;o.forEachWhile(l=>{const u=this.Je(l);return!u||u.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)}),c&&(r=r.add(i))}),this.ke.forEach((i,o)=>o.setReadTime(e));const s=new Xi(e,t,this.Qe,this.ke,r);return this.ke=It(),this.qe=Oh(),this.Qe=new ge(ne),s}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const s=this.Ge(e);this.it(e,t)?s.Fe(t,1):s.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new Lh,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new fe(ne),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||x("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new Lh),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function Oh(){return new ge($.comparator)}function Mh(){return new ge($.comparator)}const PT={asc:"ASCENDING",desc:"DESCENDING"},CT={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},kT={and:"AND",or:"OR"};class DT{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function ol(n,e){return n.useProto3Json||Pa(e)?e:{value:e}}function Ts(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Cp(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function NT(n,e){return Ts(n,e.toTimestamp())}function mt(n){return J(!!n),Y.fromTimestamp(function(t){const r=vn(t);return new Ae(r.seconds,r.nanos)}(n))}function Yl(n,e){return al(n,e).canonicalString()}function al(n,e){const t=function(s){return new de(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function kp(n){const e=de.fromString(n);return J(Bp(e)),e}function la(n,e){return Yl(n.databaseId,e.path)}function _r(n,e){const t=kp(e);if(t.get(1)!==n.databaseId.projectId)throw new F(N.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new F(N.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new $(xp(t))}function Dp(n,e){return Yl(n.databaseId,e)}function Np(n){const e=kp(n);return e.length===4?de.emptyPath():xp(e)}function cl(n){return new de(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function xp(n){return J(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function Fh(n,e,t){return{name:la(n,e),fields:t.value.mapValue.fields}}function xT(n,e,t){const r=_r(n,e.name),s=mt(e.updateTime),i=e.createTime?mt(e.createTime):Y.min(),o=new ot({mapValue:{fields:e.fields}}),c=De.newFoundDocument(r,s,i,o);return t&&c.setHasCommittedMutations(),t?c.setHasCommittedMutations():c}function VT(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(u){return u==="NO_CHANGE"?0:u==="ADD"?1:u==="REMOVE"?2:u==="CURRENT"?3:u==="RESET"?4:z()}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=function(u,h){return u.useProto3Json?(J(h===void 0||typeof h=="string"),Me.fromBase64String(h||"")):(J(h===void 0||h instanceof Buffer||h instanceof Uint8Array),Me.fromUint8Array(h||new Uint8Array))}(n,e.targetChange.resumeToken),o=e.targetChange.cause,c=o&&function(u){const h=u.code===void 0?N.UNKNOWN:Sp(u.code);return new F(h,u.message||"")}(o);t=new Pp(r,s,i,c||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=_r(n,r.document.name),i=mt(r.document.updateTime),o=r.document.createTime?mt(r.document.createTime):Y.min(),c=new ot({mapValue:{fields:r.document.fields}}),l=De.newFoundDocument(s,i,o,c),u=r.targetIds||[],h=r.removedTargetIds||[];t=new qo(u,h,l.key,l)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=_r(n,r.document),i=r.readTime?mt(r.readTime):Y.min(),o=De.newNoDocument(s,i),c=r.removedTargetIds||[];t=new qo([],c,o.key,o)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=_r(n,r.document),i=r.removedTargetIds||[];t=new qo([],i,s,null)}else{if(!("filter"in e))return z();{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,o=new TT(s,i),c=r.targetId;t=new Rp(c,o)}}return t}function ua(n,e){let t;if(e instanceof xs)t={update:Fh(n,e.key,e.value)};else if(e instanceof Va)t={delete:la(n,e.key)};else if(e instanceof En)t={update:Fh(n,e.key,e.data),updateMask:UT(e.fieldMask)};else{if(!(e instanceof Ap))return z();t={verify:la(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(i,o){const c=o.transform;if(c instanceof ws)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(c instanceof Is)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:c.elements}};if(c instanceof Es)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:c.elements}};if(c instanceof Mi)return{fieldPath:o.field.canonicalString(),increment:c.Pe};throw z()}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,i){return i.updateTime!==void 0?{updateTime:NT(s,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:z()}(n,e.precondition)),t}function ll(n,e){const t=e.currentDocument?function(i){return i.updateTime!==void 0?at.updateTime(mt(i.updateTime)):i.exists!==void 0?at.exists(i.exists):at.none()}(e.currentDocument):at.none(),r=e.updateTransforms?e.updateTransforms.map(s=>function(o,c){let l=null;if("setToServerValue"in c)J(c.setToServerValue==="REQUEST_TIME"),l=new ws;else if("appendMissingElements"in c){const h=c.appendMissingElements.values||[];l=new Is(h)}else if("removeAllFromArray"in c){const h=c.removeAllFromArray.values||[];l=new Es(h)}else"increment"in c?l=new Mi(o,c.increment):z();const u=be.fromServerFormat(c.fieldPath);return new Ep(u,l)}(n,s)):[];if(e.update){e.update.name;const s=_r(n,e.update.name),i=new ot({mapValue:{fields:e.update.fields}});if(e.updateMask){const o=function(l){const u=l.fieldPaths||[];return new yt(u.map(h=>be.fromServerFormat(h)))}(e.updateMask);return new En(s,i,o,t,r)}return new xs(s,i,t,r)}if(e.delete){const s=_r(n,e.delete);return new Va(s,t)}if(e.verify){const s=_r(n,e.verify);return new Ap(s,t)}return z()}function LT(n,e){return n&&n.length>0?(J(e!==void 0),n.map(t=>function(s,i){let o=s.updateTime?mt(s.updateTime):mt(i);return o.isEqual(Y.min())&&(o=mt(i)),new wT(o,s.transformResults||[])}(t,e))):[]}function Vp(n,e){return{documents:[Dp(n,e.path)]}}function Lp(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=Dp(n,s);const i=function(u){if(u.length!==0)return Fp(he.create(u,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const o=function(u){if(u.length!==0)return u.map(h=>function(g){return{field:cs(g.field),direction:MT(g.dir)}}(h))}(e.orderBy);o&&(t.structuredQuery.orderBy=o);const c=ol(n,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=function(u){return{before:u.inclusive,values:u.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(u){return{before:!u.inclusive,values:u.position}}(e.endAt)),{_t:t,parent:s}}function Op(n){let e=Np(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){J(r===1);const h=t.from[0];h.allDescendants?s=h.collectionId:e=e.child(h.collectionId)}let i=[];t.where&&(i=function(p){const g=Mp(p);return g instanceof he&&Kl(g)?g.getFilters():[g]}(t.where));let o=[];t.orderBy&&(o=function(p){return p.map(g=>function(S){return new oa(ls(S.field),function(P){switch(P){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(S.direction))}(g))}(t.orderBy));let c=null;t.limit&&(c=function(p){let g;return g=typeof p=="object"?p.value:p,Pa(g)?null:g}(t.limit));let l=null;t.startAt&&(l=function(p){const g=!!p.before,y=p.values||[];return new ys(y,g)}(t.startAt));let u=null;return t.endAt&&(u=function(p){const g=!p.before,y=p.values||[];return new ys(y,g)}(t.endAt)),lp(e,s,o,i,c,"F",l,u)}function OT(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return z()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Mp(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=ls(t.unaryFilter.field);return oe.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=ls(t.unaryFilter.field);return oe.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=ls(t.unaryFilter.field);return oe.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=ls(t.unaryFilter.field);return oe.create(o,"!=",{nullValue:"NULL_VALUE"});default:return z()}}(n):n.fieldFilter!==void 0?function(t){return oe.create(ls(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return z()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return he.create(t.compositeFilter.filters.map(r=>Mp(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return z()}}(t.compositeFilter.op))}(n):z()}function MT(n){return PT[n]}function FT(n){return CT[n]}function BT(n){return kT[n]}function cs(n){return{fieldPath:n.canonicalString()}}function ls(n){return be.fromServerFormat(n.fieldPath)}function Fp(n){return n instanceof oe?function(t){if(t.op==="=="){if(Ih(t.value))return{unaryFilter:{field:cs(t.field),op:"IS_NAN"}};if(wh(t.value))return{unaryFilter:{field:cs(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Ih(t.value))return{unaryFilter:{field:cs(t.field),op:"IS_NOT_NAN"}};if(wh(t.value))return{unaryFilter:{field:cs(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:cs(t.field),op:FT(t.op),value:t.value}}}(n):n instanceof he?function(t){const r=t.getFilters().map(s=>Fp(s));return r.length===1?r[0]:{compositeFilter:{op:BT(t.op),filters:r}}}(n):z()}function UT(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Bp(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Up{constructor(e){this.ct=e}}function $T(n,e){let t;if(e.document)t=xT(n.ct,e.document,!!e.hasCommittedMutations);else if(e.noDocument){const r=$.fromSegments(e.noDocument.path),s=Pr(e.noDocument.readTime);t=De.newNoDocument(r,s),e.hasCommittedMutations&&t.setHasCommittedMutations()}else{if(!e.unknownDocument)return z();{const r=$.fromSegments(e.unknownDocument.path),s=Pr(e.unknownDocument.version);t=De.newUnknownDocument(r,s)}}return e.readTime&&t.setReadTime(function(s){const i=new Ae(s[0],s[1]);return Y.fromTimestamp(i)}(e.readTime)),t}function Bh(n,e){const t=e.key,r={prefixPath:t.getCollectionPath().popLast().toArray(),collectionGroup:t.collectionGroup,documentId:t.path.lastSegment(),readTime:da(e.readTime),hasCommittedMutations:e.hasCommittedMutations};if(e.isFoundDocument())r.document=function(i,o){return{name:la(i,o.key),fields:o.data.value.mapValue.fields,updateTime:Ts(i,o.version.toTimestamp()),createTime:Ts(i,o.createTime.toTimestamp())}}(n.ct,e);else if(e.isNoDocument())r.noDocument={path:t.path.toArray(),readTime:Rr(e.version)};else{if(!e.isUnknownDocument())return z();r.unknownDocument={path:t.path.toArray(),version:Rr(e.version)}}return r}function da(n){const e=n.toTimestamp();return[e.seconds,e.nanoseconds]}function Rr(n){const e=n.toTimestamp();return{seconds:e.seconds,nanoseconds:e.nanoseconds}}function Pr(n){const e=new Ae(n.seconds,n.nanoseconds);return Y.fromTimestamp(e)}function dr(n,e){const t=(e.baseMutations||[]).map(i=>ll(n.ct,i));for(let i=0;i<e.mutations.length-1;++i){const o=e.mutations[i];if(i+1<e.mutations.length&&e.mutations[i+1].transform!==void 0){const c=e.mutations[i+1];o.updateTransforms=c.transform.fieldTransforms,e.mutations.splice(i+1,1),++i}}const r=e.mutations.map(i=>ll(n.ct,i)),s=Ae.fromMillis(e.localWriteTimeMs);return new Hl(e.batchId,s,t,r)}function ui(n){const e=Pr(n.readTime),t=n.lastLimboFreeSnapshotVersion!==void 0?Pr(n.lastLimboFreeSnapshotVersion):Y.min();let r;return r=function(i){return i.documents!==void 0}(n.query)?function(i){return J(i.documents.length===1),Tt(ka(Np(i.documents[0])))}(n.query):function(i){return Tt(Op(i))}(n.query),new hn(r,n.targetId,"TargetPurposeListen",n.lastListenSequenceNumber,e,t,Me.fromBase64String(n.resumeToken))}function $p(n,e){const t=Rr(e.snapshotVersion),r=Rr(e.lastLimboFreeSnapshotVersion);let s;s=aa(e.target)?Vp(n.ct,e.target):Lp(n.ct,e.target)._t;const i=e.resumeToken.toBase64();return{targetId:e.targetId,canonicalId:Sr(e.target),readTime:t,resumeToken:i,lastListenSequenceNumber:e.sequenceNumber,lastLimboFreeSnapshotVersion:r,query:s}}function jp(n){const e=Op({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?il(e,e.limit,"L"):e}function Rc(n,e){return new Ql(e.largestBatchId,ll(n.ct,e.overlayMutation))}function Uh(n,e){const t=e.path.lastSegment();return[n,ft(e.path.popLast()),t]}function $h(n,e,t,r){return{indexId:n,uid:e,sequenceNumber:t,readTime:Rr(r.readTime),documentKey:ft(r.documentKey.path),largestBatchId:r.largestBatchId}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jT{getBundleMetadata(e,t){return jh(e).get(t).next(r=>{if(r)return function(i){return{id:i.bundleId,createTime:Pr(i.createTime),version:i.version}}(r)})}saveBundleMetadata(e,t){return jh(e).put(function(s){return{bundleId:s.id,createTime:Rr(mt(s.createTime)),version:s.version}}(t))}getNamedQuery(e,t){return qh(e).get(t).next(r=>{if(r)return function(i){return{name:i.name,query:jp(i.bundledQuery),readTime:Pr(i.readTime)}}(r)})}saveNamedQuery(e,t){return qh(e).put(function(s){return{name:s.name,readTime:Rr(mt(s.readTime)),bundledQuery:s.bundledQuery}}(t))}}function jh(n){return ze(n,"bundles")}function qh(n){return ze(n,"namedQueries")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=new Uint8Array(0);class JT{constructor(e,t){this.databaseId=t,this.cn=new Zl,this.ln=new Qn(r=>Sr(r),(r,s)=>Ji(r,s)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.cn.has(t)){const r=t.lastSegment(),s=t.popLast();e.addOnCommittedListener(()=>{this.cn.add(t)});const i={collectionId:r,parent:ft(s)};return Wh(e).put(i)}return C.resolve()}getCollectionParents(e,t){const r=[],s=IDBKeyRange.bound([t,""],[Um(t),""],!1,!0);return Wh(e).U(s).next(i=>{for(const o of i){if(o.collectionId!==t)break;r.push(Qt(o.parent))}return r})}addFieldIndex(e,t){const r=ei(e),s=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(l=>[l.fieldPath.canonicalString(),l.kind])}}(t);delete s.indexId;const i=r.add(s);if(t.indexState){const o=ss(e);return i.next(c=>{o.put($h(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){const r=ei(e),s=ss(e),i=rs(e);return r.delete(t.indexId).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=ei(e),r=rs(e),s=ss(e);return t.j().next(()=>r.j()).next(()=>s.j())}createTargetIndexes(e,t){return C.forEach(this.hn(t),r=>this.getIndexType(e,r).next(s=>{if(s===0||s===1){const i=new zh(r).an();if(i!=null)return this.addFieldIndex(e,i)}}))}getDocumentsMatchingTarget(e,t){const r=rs(e);let s=!0;const i=new Map;return C.forEach(this.hn(t),o=>this.Pn(e,o).next(c=>{s&&(s=!!c),i.set(o,c)})).next(()=>{if(s){let o=se();const c=[];return C.forEach(i,(l,u)=>{x("IndexedDbIndexManager",`Using index ${function(U){return`id=${U.indexId}|cg=${U.collectionGroup}|f=${U.fields.map(Q=>`${Q.fieldPath}:${Q.kind}`).join(",")}`}(l)} to execute ${Sr(t)}`);const h=function(U,Q){const re=Yc(Q);if(re===void 0)return null;for(const ee of ca(U,re.fieldPath))switch(ee.op){case"array-contains-any":return ee.value.arrayValue.values||[];case"array-contains":return[ee.value]}return null}(u,l),p=function(U,Q){const re=new Map;for(const ee of lr(Q))for(const T of ca(U,ee.fieldPath))switch(T.op){case"==":case"in":re.set(ee.fieldPath.canonicalString(),T.value);break;case"not-in":case"!=":return re.set(ee.fieldPath.canonicalString(),T.value),Array.from(re.values())}return null}(u,l),g=function(U,Q){const re=[];let ee=!0;for(const T of lr(Q)){const v=T.kind===0?Sh(U,T.fieldPath,U.startAt):Rh(U,T.fieldPath,U.startAt);re.push(v.value),ee&&(ee=v.inclusive)}return new ys(re,ee)}(u,l),y=function(U,Q){const re=[];let ee=!0;for(const T of lr(Q)){const v=T.kind===0?Rh(U,T.fieldPath,U.endAt):Sh(U,T.fieldPath,U.endAt);re.push(v.value),ee&&(ee=v.inclusive)}return new ys(re,ee)}(u,l),S=this.In(l,u,g),k=this.In(l,u,y),P=this.Tn(l,u,p),L=this.En(l.indexId,h,S,g.inclusive,k,y.inclusive,P);return C.forEach(L,B=>r.G(B,t.limit).next(U=>{U.forEach(Q=>{const re=$.fromSegments(Q.documentKey);o.has(re)||(o=o.add(re),c.push(re))})}))}).next(()=>c)}return C.resolve(null)})}hn(e){let t=this.ln.get(e);return t||(e.filters.length===0?t=[e]:t=WT(he.create(e.filters,"and")).map(r=>rl(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.ln.set(e,t),t)}En(e,t,r,s,i,o,c){const l=(t!=null?t.length:1)*Math.max(r.length,i.length),u=l/(t!=null?t.length:1),h=[];for(let p=0;p<l;++p){const g=t?this.dn(t[p/u]):Ro,y=this.An(e,g,r[p%u],s),S=this.Rn(e,g,i[p%u],o),k=c.map(P=>this.An(e,g,P,!0));h.push(...this.createRange(y,S,k))}return h}An(e,t,r,s){const i=new fr(e,$.empty(),t,r);return s?i:i.Zt()}Rn(e,t,r,s){const i=new fr(e,$.empty(),t,r);return s?i.Zt():i}Pn(e,t){const r=new zh(t),s=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,s).next(i=>{let o=null;for(const c of i)r.rn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let r=2;const s=this.hn(t);return C.forEach(s,i=>this.Pn(e,i).next(o=>{o?r!==0&&o.fields.length<function(l){let u=new fe(be.comparator),h=!1;for(const p of l.filters)for(const g of p.getFlattenedFilters())g.field.isKeyField()||(g.op==="array-contains"||g.op==="array-contains-any"?h=!0:u=u.add(g.field));for(const p of l.orderBy)p.field.isKeyField()||(u=u.add(p.field));return u.size+(h?1:0)}(i)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(t)&&s.length>1&&r===2?1:r)}Vn(e,t){const r=new Zs;for(const s of lr(e)){const i=t.data.field(s.fieldPath);if(i==null)return null;const o=r.Yt(s.kind);hr.vt.It(i,o)}return r.zt()}dn(e){const t=new Zs;return hr.vt.It(e,t.Yt(0)),t.zt()}mn(e,t){const r=new Zs;return hr.vt.It(Li(this.databaseId,t),r.Yt(function(i){const o=lr(i);return o.length===0?0:o[o.length-1].kind}(e))),r.zt()}Tn(e,t,r){if(r===null)return[];let s=[];s.push(new Zs);let i=0;for(const o of lr(e)){const c=r[i++];for(const l of s)if(this.fn(t,o.fieldPath)&&Oi(c))s=this.gn(s,o,c);else{const u=l.Yt(o.kind);hr.vt.It(c,u)}}return this.pn(s)}In(e,t,r){return this.Tn(e,t,r.position)}pn(e){const t=[];for(let r=0;r<e.length;++r)t[r]=e[r].zt();return t}gn(e,t,r){const s=[...e],i=[];for(const o of r.arrayValue.values||[])for(const c of s){const l=new Zs;l.seed(c.zt()),hr.vt.It(o,l.Yt(t.kind)),i.push(l)}return i}fn(e,t){return!!e.filters.find(r=>r instanceof oe&&r.field.isEqual(t)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,t){const r=ei(e),s=ss(e);return(t?r.U("collectionGroupIndex",IDBKeyRange.bound(t,t)):r.U()).next(i=>{const o=[];return C.forEach(i,c=>s.get([c.indexId,this.uid]).next(l=>{o.push(function(h,p){const g=p?new Di(p.sequenceNumber,new bt(Pr(p.readTime),new $(Qt(p.documentKey)),p.largestBatchId)):Di.empty(),y=h.fields.map(([S,k])=>new Fo(be.fromServerFormat(S),k));return new ia(h.indexId,h.collectionGroup,y,g)}(c,l))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((r,s)=>{const i=r.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:ne(r.collectionGroup,s.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,r){const s=ei(e),i=ss(e);return this.yn(e).next(o=>s.U("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(c=>C.forEach(c,l=>i.put($h(l.indexId,this.uid,o,r)))))}updateIndexEntries(e,t){const r=new Map;return C.forEach(t,(s,i)=>{const o=r.get(s.collectionGroup);return(o?C.resolve(o):this.getFieldIndexes(e,s.collectionGroup)).next(c=>(r.set(s.collectionGroup,c),C.forEach(c,l=>this.wn(e,s,l).next(u=>{const h=this.Sn(i,l);return u.isEqual(h)?C.resolve():this.bn(e,i,l,u,h)}))))})}Dn(e,t,r,s){return rs(e).put({indexId:s.indexId,uid:this.uid,arrayValue:s.arrayValue,directionalValue:s.directionalValue,orderedDocumentKey:this.mn(r,t.key),documentKey:t.key.path.toArray()})}vn(e,t,r,s){return rs(e).delete([s.indexId,this.uid,s.arrayValue,s.directionalValue,this.mn(r,t.key),t.key.path.toArray()])}wn(e,t,r){const s=rs(e);let i=new fe(kn);return s.J({index:"documentKeyIndex",range:IDBKeyRange.only([r.indexId,this.uid,this.mn(r,t)])},(o,c)=>{i=i.add(new fr(r.indexId,t,c.arrayValue,c.directionalValue))}).next(()=>i)}Sn(e,t){let r=new fe(kn);const s=this.Vn(t,e);if(s==null)return r;const i=Yc(t);if(i!=null){const o=e.data.field(i.fieldPath);if(Oi(o))for(const c of o.arrayValue.values||[])r=r.add(new fr(t.indexId,e.key,this.dn(c),s))}else r=r.add(new fr(t.indexId,e.key,Ro,s));return r}bn(e,t,r,s,i){x("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const o=[];return function(l,u,h,p,g){const y=l.getIterator(),S=u.getIterator();let k=ns(y),P=ns(S);for(;k||P;){let L=!1,B=!1;if(k&&P){const U=h(k,P);U<0?B=!0:U>0&&(L=!0)}else k!=null?B=!0:L=!0;L?(p(P),P=ns(S)):B?(g(k),k=ns(y)):(k=ns(y),P=ns(S))}}(s,i,kn,c=>{o.push(this.Dn(e,t,r,c))},c=>{o.push(this.vn(e,t,r,c))}),C.waitFor(o)}yn(e){let t=1;return ss(e).J({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,s,i)=>{i.done(),t=s.sequenceNumber+1}).next(()=>t)}createRange(e,t,r){r=r.sort((o,c)=>kn(o,c)).filter((o,c,l)=>!c||kn(o,l[c-1])!==0);const s=[];s.push(e);for(const o of r){const c=kn(o,e),l=kn(o,t);if(c===0)s[0]=e.Zt();else if(c>0&&l<0)s.push(o),s.push(o.Zt());else if(l>0)break}s.push(t);const i=[];for(let o=0;o<s.length;o+=2){if(this.Cn(s[o],s[o+1]))return[];const c=[s[o].indexId,this.uid,s[o].arrayValue,s[o].directionalValue,Ro,[]],l=[s[o+1].indexId,this.uid,s[o+1].arrayValue,s[o+1].directionalValue,Ro,[]];i.push(IDBKeyRange.bound(c,l))}return i}Cn(e,t){return kn(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(Qh)}getMinOffset(e,t){return C.mapArray(this.hn(t),r=>this.Pn(e,r).next(s=>s||z())).next(Qh)}}function Wh(n){return ze(n,"collectionParents")}function rs(n){return ze(n,"indexEntries")}function ei(n){return ze(n,"indexConfiguration")}function ss(n){return ze(n,"indexState")}function Qh(n){J(n.length!==0);let e=n[0].indexState.offset,t=e.largestBatchId;for(let r=1;r<n.length;r++){const s=n[r].indexState.offset;Bl(s,e)<0&&(e=s),t<s.largestBatchId&&(t=s.largestBatchId)}return new bt(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gt.DEFAULT_COLLECTION_PERCENTILE=10,gt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,gt.DEFAULT=new gt(41943040,gt.DEFAULT_COLLECTION_PERCENTILE,gt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),gt.DISABLED=new gt(-1,0,0);class Oa{constructor(e,t,r,s){this.userId=e,this.serializer=t,this.indexManager=r,this.referenceDelegate=s,this.Fn={}}static lt(e,t,r,s){J(e.uid!=="");const i=e.isAuthenticated()?e.uid:"";return new Oa(i,t,r,s)}checkEmpty(e){let t=!0;const r=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return Dn(e).J({index:"userMutationsIndex",range:r},(s,i,o)=>{t=!1,o.done()}).next(()=>t)}addMutationBatch(e,t,r,s){const i=us(e),o=Dn(e);return o.add({}).next(c=>{J(typeof c=="number");const l=new Hl(c,t,r,s),u=function(y,S,k){const P=k.baseMutations.map(B=>ua(y.ct,B)),L=k.mutations.map(B=>ua(y.ct,B));return{userId:S,batchId:k.batchId,localWriteTimeMs:k.localWriteTime.toMillis(),baseMutations:P,mutations:L}}(this.serializer,this.userId,l),h=[];let p=new fe((g,y)=>ne(g.canonicalString(),y.canonicalString()));for(const g of s){const y=Hm(this.userId,g.key.path,c);p=p.add(g.key.path.popLast()),h.push(o.put(u)),h.push(i.put(y,VE))}return p.forEach(g=>{h.push(this.indexManager.addToCollectionParentIndex(e,g))}),e.addOnCommittedListener(()=>{this.Fn[c]=l.keys()}),C.waitFor(h).next(()=>l)})}lookupMutationBatch(e,t){return Dn(e).get(t).next(r=>r?(J(r.userId===this.userId),dr(this.serializer,r)):null)}Mn(e,t){return this.Fn[t]?C.resolve(this.Fn[t]):this.lookupMutationBatch(e,t).next(r=>{if(r){const s=r.keys();return this.Fn[t]=s,s}return null})}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=IDBKeyRange.lowerBound([this.userId,r]);let i=null;return Dn(e).J({index:"userMutationsIndex",range:s},(o,c,l)=>{c.userId===this.userId&&(J(c.batchId>=r),i=dr(this.serializer,c)),l.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(e){const t=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let r=-1;return Dn(e).J({index:"userMutationsIndex",range:t,reverse:!0},(s,i,o)=>{r=i.batchId,o.done()}).next(()=>r)}getAllMutationBatches(e){const t=IDBKeyRange.bound([this.userId,-1],[this.userId,Number.POSITIVE_INFINITY]);return Dn(e).U("userMutationsIndex",t).next(r=>r.map(s=>dr(this.serializer,s)))}getAllMutationBatchesAffectingDocumentKey(e,t){const r=Bo(this.userId,t.path),s=IDBKeyRange.lowerBound(r),i=[];return us(e).J({range:s},(o,c,l)=>{const[u,h,p]=o,g=Qt(h);if(u===this.userId&&t.path.isEqual(g))return Dn(e).get(p).next(y=>{if(!y)throw z();J(y.userId===this.userId),i.push(dr(this.serializer,y))});l.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new fe(ne);const s=[];return t.forEach(i=>{const o=Bo(this.userId,i.path),c=IDBKeyRange.lowerBound(o),l=us(e).J({range:c},(u,h,p)=>{const[g,y,S]=u,k=Qt(y);g===this.userId&&i.path.isEqual(k)?r=r.add(S):p.done()});s.push(l)}),C.waitFor(s).next(()=>this.xn(e,r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1,i=Bo(this.userId,r),o=IDBKeyRange.lowerBound(i);let c=new fe(ne);return us(e).J({range:o},(l,u,h)=>{const[p,g,y]=l,S=Qt(g);p===this.userId&&r.isPrefixOf(S)?S.length===s&&(c=c.add(y)):h.done()}).next(()=>this.xn(e,c))}xn(e,t){const r=[],s=[];return t.forEach(i=>{s.push(Dn(e).get(i).next(o=>{if(o===null)throw z();J(o.userId===this.userId),r.push(dr(this.serializer,o))}))}),C.waitFor(s).next(()=>r)}removeMutationBatch(e,t){return Gp(e._e,this.userId,t).next(r=>(e.addOnCommittedListener(()=>{this.On(t.batchId)}),C.forEach(r,s=>this.referenceDelegate.markPotentiallyOrphaned(e,s))))}On(e){delete this.Fn[e]}performConsistencyCheck(e){return this.checkEmpty(e).next(t=>{if(!t)return C.resolve();const r=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),s=[];return us(e).J({range:r},(i,o,c)=>{if(i[0]===this.userId){const l=Qt(i[1]);s.push(l)}else c.done()}).next(()=>{J(s.length===0)})})}containsKey(e,t){return zp(e,this.userId,t)}Nn(e){return Hp(e).get(this.userId).next(t=>t||{userId:this.userId,lastAcknowledgedBatchId:-1,lastStreamToken:""})}}function zp(n,e,t){const r=Bo(e,t.path),s=r[1],i=IDBKeyRange.lowerBound(r);let o=!1;return us(n).J({range:i,H:!0},(c,l,u)=>{const[h,p,g]=c;h===e&&p===s&&(o=!0),u.done()}).next(()=>o)}function Dn(n){return ze(n,"mutations")}function us(n){return ze(n,"documentMutations")}function Hp(n){return ze(n,"mutationQueues")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YT{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.qn(e).next(t=>{const r=new Cr(t.highestTargetId);return t.highestTargetId=r.next(),this.Qn(e,t).next(()=>t.highestTargetId)})}getLastRemoteSnapshotVersion(e){return this.qn(e).next(t=>Y.fromTimestamp(new Ae(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds)))}getHighestSequenceNumber(e){return this.qn(e).next(t=>t.highestListenSequenceNumber)}setTargetsMetadata(e,t,r){return this.qn(e).next(s=>(s.highestListenSequenceNumber=t,r&&(s.lastRemoteSnapshotVersion=r.toTimestamp()),t>s.highestListenSequenceNumber&&(s.highestListenSequenceNumber=t),this.Qn(e,s)))}addTargetData(e,t){return this.Kn(e,t).next(()=>this.qn(e).next(r=>(r.targetCount+=1,this.$n(t,r),this.Qn(e,r))))}updateTargetData(e,t){return this.Kn(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next(()=>is(e).delete(t.targetId)).next(()=>this.qn(e)).next(r=>(J(r.targetCount>0),r.targetCount-=1,this.Qn(e,r)))}removeTargets(e,t,r){let s=0;const i=[];return is(e).J((o,c)=>{const l=ui(c);l.sequenceNumber<=t&&r.get(l.targetId)===null&&(s++,i.push(this.removeTargetData(e,l)))}).next(()=>C.waitFor(i)).next(()=>s)}forEachTarget(e,t){return is(e).J((r,s)=>{const i=ui(s);t(i)})}qn(e){return Yh(e).get("targetGlobalKey").next(t=>(J(t!==null),t))}Qn(e,t){return Yh(e).put("targetGlobalKey",t)}Kn(e,t){return is(e).put($p(this.serializer,t))}$n(e,t){let r=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,r=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,r=!0),r}getTargetCount(e){return this.qn(e).next(t=>t.targetCount)}getTargetData(e,t){const r=Sr(t),s=IDBKeyRange.bound([r,Number.NEGATIVE_INFINITY],[r,Number.POSITIVE_INFINITY]);let i=null;return is(e).J({range:s,index:"queryTargetsIndex"},(o,c,l)=>{const u=ui(c);Ji(t,u.target)&&(i=u,l.done())}).next(()=>i)}addMatchingKeys(e,t,r){const s=[],i=On(e);return t.forEach(o=>{const c=ft(o.path);s.push(i.put({targetId:r,path:c})),s.push(this.referenceDelegate.addReference(e,r,o))}),C.waitFor(s)}removeMatchingKeys(e,t,r){const s=On(e);return C.forEach(t,i=>{const o=ft(i.path);return C.waitFor([s.delete([r,o]),this.referenceDelegate.removeReference(e,r,i)])})}removeMatchingKeysForTargetId(e,t){const r=On(e),s=IDBKeyRange.bound([t],[t+1],!1,!0);return r.delete(s)}getMatchingKeysForTargetId(e,t){const r=IDBKeyRange.bound([t],[t+1],!1,!0),s=On(e);let i=se();return s.J({range:r,H:!0},(o,c,l)=>{const u=Qt(o[1]),h=new $(u);i=i.add(h)}).next(()=>i)}containsKey(e,t){const r=ft(t.path),s=IDBKeyRange.bound([r],[Um(r)],!1,!0);let i=0;return On(e).J({index:"documentTargetsIndex",H:!0,range:s},([o,c],l,u)=>{o!==0&&(i++,u.done())}).next(()=>i>0)}ot(e,t){return is(e).get(t).next(r=>r?ui(r):null)}}function is(n){return ze(n,"targets")}function Yh(n){return ze(n,"targetGlobal")}function On(n){return ze(n,"targetDocuments")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nb{constructor(e,t){this.db=e,this.garbageCollector=tb(this,t)}Yn(e){const t=this.er(e);return this.db.getTargetCache().getTargetCount(e).next(r=>t.next(s=>r+s))}er(e){let t=0;return this.Zn(e,r=>{t++}).next(()=>t)}forEachTarget(e,t){return this.db.getTargetCache().forEachTarget(e,t)}Zn(e,t){return this.tr(e,(r,s)=>t(s))}addReference(e,t,r){return Po(e,r)}removeReference(e,t,r){return Po(e,r)}removeTargets(e,t,r){return this.db.getTargetCache().removeTargets(e,t,r)}markPotentiallyOrphaned(e,t){return Po(e,t)}nr(e,t){return function(s,i){let o=!1;return Hp(s).Y(c=>zp(s,c,i).next(l=>(l&&(o=!0),C.resolve(!l)))).next(()=>o)}(e,t)}removeOrphanedDocuments(e,t){const r=this.db.getRemoteDocumentCache().newChangeBuffer(),s=[];let i=0;return this.tr(e,(o,c)=>{if(c<=t){const l=this.nr(e,o).next(u=>{if(!u)return i++,r.getEntry(e,o).next(()=>(r.removeEntry(o,Y.min()),On(e).delete(function(p){return[0,ft(p.path)]}(o))))});s.push(l)}}).next(()=>C.waitFor(s)).next(()=>r.apply(e)).next(()=>i)}removeTarget(e,t){const r=t.withSequenceNumber(e.currentSequenceNumber);return this.db.getTargetCache().updateTargetData(e,r)}updateLimboDocument(e,t){return Po(e,t)}tr(e,t){const r=On(e);let s,i=_t.oe;return r.J({index:"documentTargetsIndex"},([o,c],{path:l,sequenceNumber:u})=>{o===0?(i!==_t.oe&&t(new $(Qt(s)),i),i=u,s=l):i=_t.oe}).next(()=>{i!==_t.oe&&t(new $(Qt(s)),i)})}getCacheSize(e){return this.db.getRemoteDocumentCache().getSize(e)}}function Po(n,e){return On(n).put(function(r,s){return{targetId:0,path:ft(r.path),sequenceNumber:s}}(e,n.currentSequenceNumber))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wp{constructor(){this.changes=new Qn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,De.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?C.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yp{constructor(e,t){this.qr={},this.overlays={},this.Qr=new _t(0),this.Kr=!1,this.Kr=!0,this.$r=new cb,this.referenceDelegate=e(this),this.Ur=new hb(this),this.indexManager=new QT,this.remoteDocumentCache=function(s){return new ub(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new Up(t),this.Gr=new ob(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new ab,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new lb(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){x("MemoryPersistence","Starting transaction:",e);const s=new fb(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return C.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class fb extends Km{constructor(e){super(),this.currentSequenceNumber=e}}class Ma{constructor(e){this.persistence=e,this.Jr=new eu,this.Yr=null}static Zr(e){return new Ma(e)}get Xr(){if(this.Yr)return this.Yr;throw z()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),C.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),C.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),C.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return C.forEach(this.Xr,r=>{const s=$.fromPath(r);return this.ei(e,s).next(i=>{i||t.removeEntry(s,Y.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return C.or([()=>C.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zp{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return zf()?8:Gm(Ge())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Yi(e,t).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Zi(e,t,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new pb;return this.Xi(e,t,o).next(c=>{if(i.result=c,this.zi)return this.es(e,t,o,c.size)})}).next(()=>i.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(os()<=ie.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",as(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),C.resolve()):(os()<=ie.DEBUG&&x("QueryEngine","Query:",as(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(os()<=ie.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",as(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Tt(t))):C.resolve())}Yi(e,t){if(Ph(t))return C.resolve(null);let r=Tt(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=il(t,null,"F"),r=Tt(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=se(...i);return this.Ji.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.ts(t,c);return this.ns(t,u,o,l.readTime)?this.Yi(e,il(t,null,"F")):this.rs(e,u,t,l)}))})))}Zi(e,t,r,s){return Ph(t)||s.isEqual(Y.min())?C.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const o=this.ts(t,i);return this.ns(t,o,r,s)?C.resolve(null):(os()<=ie.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),as(t)),this.rs(e,o,t,$m(s,-1)).next(c=>c))})}ts(e,t){let r=new fe(fp(e));return t.forEach((s,i)=>{Yi(e,i)&&(r=r.add(i))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Xi(e,t,r){return os()<=ie.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",as(t)),this.Ji.getDocumentsMatchingQuery(e,t,bt.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st="WebChannelConnection";class bb extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,o){const c=Dc(),l=this.xo(t,r.toUriEncodedString());x("RestConnection",`Sending RPC '${t}' ${c}:`,l,s);const u={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(u,i,o),this.No(t,l,u,s).then(h=>(x("RestConnection",`Received RPC '${t}' ${c}: `,h),h),h=>{throw Ci("RestConnection",`RPC '${t}' ${c} failed with error: `,h,"url: ",l,"request:",s),h})}Lo(t,r,s,i,o,c){return this.Mo(t,r,s,i,o)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Ds}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>t[o]=i),s&&s.headers.forEach((i,o)=>t[o]=i)}xo(t,r){const s=Eb[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=Dc();return new Promise((o,c)=>{const l=new Vm;l.setWithCredentials(!0),l.listenOnce(Lm.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case Mo.NO_ERROR:const h=l.getResponseJson();x(st,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(h)),o(h);break;case Mo.TIMEOUT:x(st,`RPC '${e}' ${i} timed out`),c(new F(N.DEADLINE_EXCEEDED,"Request time out"));break;case Mo.HTTP_ERROR:const p=l.getStatus();if(x(st,`RPC '${e}' ${i} failed with status:`,p,"response text:",l.getResponseText()),p>0){let g=l.getResponseJson();Array.isArray(g)&&(g=g[0]);const y=g==null?void 0:g.error;if(y&&y.status&&y.message){const S=function(P){const L=P.toLowerCase().replace(/_/g,"-");return Object.values(N).indexOf(L)>=0?L:N.UNKNOWN}(y.status);c(new F(S,y.message))}else c(new F(N.UNKNOWN,"Server responded with status "+l.getStatus()))}else c(new F(N.UNAVAILABLE,"Connection failed."));break;default:z()}}finally{x(st,`RPC '${e}' ${i} completed.`)}});const u=JSON.stringify(s);x(st,`RPC '${e}' ${i} sending request:`,s),l.send(t,"POST",u,r,15)})}Bo(e,t,r){const s=Dc(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Fm(),c=Mm(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Oo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const h=i.join("");x(st,`Creating RPC '${e}' stream ${s}: ${h}`,l);const p=o.createWebChannel(h,l);let g=!1,y=!1;const S=new Tb({Io:P=>{y?x(st,`Not sending because RPC '${e}' stream ${s} is closed:`,P):(g||(x(st,`Opening RPC '${e}' stream ${s} transport.`),p.open(),g=!0),x(st,`RPC '${e}' stream ${s} sending:`,P),p.send(P))},To:()=>p.close()}),k=(P,L,B)=>{P.listen(L,U=>{try{B(U)}catch(Q){setTimeout(()=>{throw Q},0)}})};return k(p,ai.EventType.OPEN,()=>{y||(x(st,`RPC '${e}' stream ${s} transport opened.`),S.yo())}),k(p,ai.EventType.CLOSE,()=>{y||(y=!0,x(st,`RPC '${e}' stream ${s} transport closed`),S.So())}),k(p,ai.EventType.ERROR,P=>{y||(y=!0,Ci(st,`RPC '${e}' stream ${s} transport errored:`,P),S.So(new F(N.UNAVAILABLE,"The operation could not be completed")))}),k(p,ai.EventType.MESSAGE,P=>{var L;if(!y){const B=P.data[0];J(!!B);const U=B,Q=U.error||((L=U[0])===null||L===void 0?void 0:L.error);if(Q){x(st,`RPC '${e}' stream ${s} received error:`,Q);const re=Q.status;let ee=function(I){const b=Be[I];if(b!==void 0)return Sp(b)}(re),T=Q.message;ee===void 0&&(ee=N.INTERNAL,T="Unknown error status: "+re+" with message "+Q.message),y=!0,S.So(new F(ee,T)),p.close()}else x(st,`RPC '${e}' stream ${s} received:`,B),S.bo(B)}}),k(c,Om.STAT_EVENT,P=>{P.stat===Jc.PROXY?x(st,`RPC '${e}' stream ${s} detected buffering proxy`):P.stat===Jc.NOPROXY&&x(st,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{S.wo()},0),S}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rb extends class{}{constructor(e,t,r,s){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=s,this.y_=!1}w_(){if(this.y_)throw new F(N.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,t,r,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.Mo(e,al(t,r),s,i,o)).catch(i=>{throw i.name==="FirebaseError"?(i.code===N.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new F(N.UNKNOWN,i.toString())})}Lo(e,t,r,s,i){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,c])=>this.connection.Lo(e,al(t,r),s,o,c,i)).catch(o=>{throw o.name==="FirebaseError"?(o.code===N.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new F(N.UNKNOWN,o.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class Pb{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(e){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,e==="Online"&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const t=`Could not reach Cloud Firestore backend. ${e}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.D_?(Le(t),this.D_=!1):x("OnlineStateTracker",t)}x_(){this.b_!==null&&(this.b_.cancel(),this.b_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ag{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):Le("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _f{constructor(e){var t,r;if(e.host===void 0){if(e.ssl!==void 0)throw new F(N.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=(t=e.ssl)===null||t===void 0||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new F(N.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}yA("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Pg((r=e.experimentalLongPollingOptions)!==null&&r!==void 0?r:{}),function(i){if(i.timeoutSeconds!==void 0){if(isNaN(i.timeoutSeconds))throw new F(N.INVALID_ARGUMENT,`invalid long polling timeout: ${i.timeoutSeconds} (must not be NaN)`);if(i.timeoutSeconds<5)throw new F(N.INVALID_ARGUMENT,`invalid long polling timeout: ${i.timeoutSeconds} (minimum allowed value is 5)`);if(i.timeoutSeconds>30)throw new F(N.INVALID_ARGUMENT,`invalid long polling timeout: ${i.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(r,s){return r.timeoutSeconds===s.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class qa{constructor(e,t,r,s){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new _f({}),this._settingsFrozen=!1,this._terminateTask="notTerminated"}get app(){if(!this._app)throw new F(N.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new F(N.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new _f(e),e.credentials!==void 0&&(this._authCredentials=function(r){if(!r)return new IE;switch(r.type){case"firstParty":return new bE(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new F(N.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const r=mf.get(t);r&&(x("ComponentProvider","Removing Datastore"),mf.delete(t),r.terminate())}(this),Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $r{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new $r(this.firestore,e,this._query)}}class pt{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new $n(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new pt(this.firestore,e,this._key)}}class $n extends $r{constructor(e,t,r){super(e,t,ka(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new pt(this.firestore,null,new $(e))}withConverter(e){return new $n(this.firestore,e,this._path)}}function Ne(n,e,...t){if(n=Ie(n),pu("collection","path",e),n instanceof qa){const r=de.fromString(e,...t);return gf(r),new $n(n,null,r)}{if(!(n instanceof pt||n instanceof $n))throw new F(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(de.fromString(e,...t));return gf(r),new $n(n.firestore,null,r)}}function vA(n,e){if(n=Ut(n,qa),pu("collectionGroup","collection id",e),e.indexOf("/")>=0)throw new F(N.INVALID_ARGUMENT,`Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new $r(n,null,function(r){return new Ns(de.emptyPath(),r)}(e))}function te(n,e,...t){if(n=Ie(n),arguments.length===1&&(e=Bm.newId()),pu("doc","path",e),n instanceof qa){const r=de.fromString(e,...t);return pf(r),new pt(n,null,new $(r))}{if(!(n instanceof pt||n instanceof $n))throw new F(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(de.fromString(e,...t));return pf(r),new pt(n.firestore,n instanceof $n?n.converter:null,new $(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Ps(Me.fromBase64String(e))}catch(t){throw new F(N.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Ps(Me.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ka{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new F(N.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new be(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _u{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new F(N.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new F(N.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ne(this._lat,e._lat)||ne(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kA(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new F(N.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class bu{}class DA extends bu{}function Gn(n,e,...t){let r=[];e instanceof bu&&r.push(e),r=r.concat(t),function(i){const o=i.filter(l=>l instanceof Au).length,c=i.filter(l=>l instanceof Wa).length;if(o>1||o>0&&c>0)throw new F(N.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const s of r)n=s._apply(n);return n}class Wa extends DA{constructor(e,t,r){super(),this._field=e,this._op=t,this._value=r,this.type="where"}static _create(e,t,r){return new Wa(e,t,r)}_apply(e){const t=this._parse(e);return Og(e._query,t),new $r(e.firestore,e.converter,sl(e._query,t))}_parse(e){const t=za(e.firestore);return function(i,o,c,l,u,h,p){let g;if(u.isKeyField()){if(h==="array-contains"||h==="array-contains-any")throw new F(N.INVALID_ARGUMENT,`Invalid Query. You can't perform '${h}' queries on documentId().`);if(h==="in"||h==="not-in"){wf(p,h);const y=[];for(const S of p)y.push(vf(l,i,S));g={arrayValue:{values:y}}}else g=vf(l,i,p)}else h!=="in"&&h!=="not-in"&&h!=="array-contains-any"||wf(p,h),g=RA(c,o,p,h==="in"||h==="not-in");return oe.create(u,h,g)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}function gn(n,e,t){const r=e,s=Tu("where",n);return Wa._create(s,r,t)}class Au extends bu{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Au(e,t)}_parse(e){const t=this._queryConstraints.map(r=>r._parse(e)).filter(r=>r.getFilters().length>0);return t.length===1?t[0]:he.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(s,i){let o=s;const c=i.getFlattenedFilters();for(const l of c)Og(o,l),o=sl(o,l)}(e._query,t),new $r(e.firestore,e.converter,sl(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}function vf(n,e,t){if(typeof(t=Ie(t))=="string"){if(t==="")throw new F(N.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!up(e)&&t.indexOf("/")!==-1)throw new F(N.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const r=e.path.child(de.fromString(t));if(!$.isDocumentKey(r))throw new F(N.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Li(n,new $(r))}if(t instanceof pt)return Li(n,t._key);throw new F(N.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${ja(t)}.`)}function wf(n,e){if(!Array.isArray(n)||n.length===0)throw new F(N.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function Og(n,e){const t=function(s,i){for(const o of s)for(const c of o.getFlattenedFilters())if(i.indexOf(c.op)>=0)return c.op;return null}(n.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new F(N.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new F(N.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class NA{convertValue(e,t="none"){switch(Ar(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Te(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(jn(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw z()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const r={};return Br(e,(s,i)=>{r[s]=this.convertValue(i,t)}),r}convertVectorValue(e){var t,r,s;const i=(s=(r=(t=e.fields)===null||t===void 0?void 0:t.value.arrayValue)===null||r===void 0?void 0:r.values)===null||s===void 0?void 0:s.map(o=>Te(o.doubleValue));return new yu(i)}convertGeoPoint(e){return new _u(Te(e.latitude),Te(e.longitude))}convertArray(e,t){return(e.values||[]).map(r=>this.convertValue(r,t))}convertServerTimestamp(e,t){switch(t){case"previous":const r=ql(e);return r==null?null:this.convertValue(r,t);case"estimate":return this.convertTimestamp(xi(e));default:return null}}convertTimestamp(e){const t=vn(e);return new Ae(t.seconds,t.nanos)}convertDocumentKey(e,t){const r=de.fromString(e);J(Bp(r));const s=new br(r.get(1),r.get(3)),i=new $(r.popFirst(5));return s.isEqual(t)||Le(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mg(n,e,t){let r;return r=n?n.toFirestore(e):e,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve extends $t{constructor(e,t,r=0){super(xc(e),`Firebase Storage: ${t} (${xc(e)})`),this.status_=r,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,Ve.prototype)}get status(){return this.status_}set status(e){this.status_=e}_codeEquals(e){return xc(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}
${this.customData.serverResponse}`:this.message=this._baseMessage}}var xe;(function(n){n.UNKNOWN="unknown",n.OBJECT_NOT_FOUND="object-not-found",n.BUCKET_NOT_FOUND="bucket-not-found",n.PROJECT_NOT_FOUND="project-not-found",n.QUOTA_EXCEEDED="quota-exceeded",n.UNAUTHENTICATED="unauthenticated",n.UNAUTHORIZED="unauthorized",n.UNAUTHORIZED_APP="unauthorized-app",n.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",n.INVALID_CHECKSUM="invalid-checksum",n.CANCELED="canceled",n.INVALID_EVENT_NAME="invalid-event-name",n.INVALID_URL="invalid-url",n.INVALID_DEFAULT_BUCKET="invalid-default-bucket",n.NO_DEFAULT_BUCKET="no-default-bucket",n.CANNOT_SLICE_BLOB="cannot-slice-blob",n.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",n.NO_DOWNLOAD_URL="no-download-url",n.INVALID_ARGUMENT="invalid-argument",n.INVALID_ARGUMENT_COUNT="invalid-argument-count",n.APP_DELETED="app-deleted",n.INVALID_ROOT_OPERATION="invalid-root-operation",n.INVALID_FORMAT="invalid-format",n.INTERNAL_ERROR="internal-error",n.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(xe||(xe={}));function xc(n){return"storage/"+n}function Su(){const n="An unknown error occurred, please check the error payload for server response.";return new Ve(xe.UNKNOWN,n)}function KA(n){return new Ve(xe.OBJECT_NOT_FOUND,"Object '"+n+"' does not exist.")}function GA(n){return new Ve(xe.QUOTA_EXCEEDED,"Quota for bucket '"+n+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function zA(){const n="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new Ve(xe.UNAUTHENTICATED,n)}function HA(){return new Ve(xe.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function WA(n){return new Ve(xe.UNAUTHORIZED,"User does not have permission to access '"+n+"'.")}function QA(){return new Ve(xe.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function JA(){return new Ve(xe.CANCELED,"User canceled the upload/download.")}function YA(n){return new Ve(xe.INVALID_URL,"Invalid URL '"+n+"'.")}function XA(n){return new Ve(xe.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+n+"'.")}function ZA(){return new Ve(xe.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+jg+"' property when initializing the app?")}function eS(){return new Ve(xe.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function tS(){return new Ve(xe.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function nS(n){return new Ve(xe.UNSUPPORTED_ENVIRONMENT,`${n} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function vl(n){return new Ve(xe.INVALID_ARGUMENT,n)}function qg(){return new Ve(xe.APP_DELETED,"The Firebase app was deleted.")}function rS(n){return new Ve(xe.INVALID_ROOT_OPERATION,"The operation '"+n+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Ti(n,e){return new Ve(xe.INVALID_FORMAT,"String does not match format '"+n+"': "+e)}function ri(n){throw new Ve(xe.INTERNAL_ERROR,"Internal error: "+n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cu(n,e,t){let r=e;return t==null&&(r=`https://${e}`),`${t}://${r}/v0${n}`}function Kg(n){const e=encodeURIComponent;let t="?";for(const r in n)if(n.hasOwnProperty(r)){const s=e(r)+"="+e(n[r]);t=t+s+"&"}return t=t.slice(0,-1),t}var yr;(function(n){n[n.NO_ERROR=0]="NO_ERROR",n[n.NETWORK_ERROR=1]="NETWORK_ERROR",n[n.ABORT=2]="ABORT"})(yr||(yr={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function e_(n){if(!n)throw Su()}function NS(n,e){function t(r,s){const i=Xg(n,s,e);return e_(i!==null),i}return t}function xS(n,e){function t(r,s){const i=Xg(n,s,e);return e_(i!==null),kS(i,s,n.host,n._protocol)}return t}function t_(n){function e(t,r){let s;return t.getStatus()===401?t.getErrorText().includes("Firebase App Check token is invalid")?s=HA():s=zA():t.getStatus()===402?s=GA(n.bucket):t.getStatus()===403?s=WA(n.path):s=r,s.status=t.getStatus(),s.serverResponse=r.serverResponse,s}return e}function VS(n){const e=t_(n);function t(r,s){let i=e(r,s);return r.getStatus()===404&&(i=KA(n.path)),i.serverResponse=s.serverResponse,i}return t}function LS(n,e,t){const r=e.fullServerUrl(),s=Cu(r,n.host,n._protocol),i="GET",o=n.maxOperationRetryTime,c=new Zg(s,i,xS(n,t),o);return c.errorHandler=VS(e),c}function OS(n,e){return n&&n.contentType||e&&e.type()||"application/octet-stream"}function MS(n,e,t){const r=Object.assign({},t);return r.fullPath=n.path,r.size=e.size(),r.contentType||(r.contentType=OS(null,e)),r}function FS(n,e,t,r,s){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let U="";for(let Q=0;Q<2;Q++)U=U+Math.random().toString().slice(2);return U}const l=c();o["Content-Type"]="multipart/related; boundary="+l;const u=MS(e,r,s),h=DS(u,t),p="--"+l+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v_=new Map;function w_(n,e){const t=Ja(n);I_(t,e),hR(t,e)}function I_(n,e){const t=v_.get(n);if(t)for(const r of t)r(e)}function hR(n,e){const t=fR();t&&t.postMessage({key:n,fid:e}),mR()}let mr=null;function fR(){return!mr&&"BroadcastChannel"in self&&(mr=new BroadcastChannel("[Firebase] FID Change"),mr.onmessage=n=>{I_(n.data.key,n.data.fid)}),mr}function mR(){v_.size===0&&mr&&(mr.close(),mr=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pR="firebase-installations-database",gR=1,Nr="firebase-installations-store";let Lc=null;function Nu(){return Lc||(Lc=Ta(pR,gR,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Nr)}}})),Lc}async function va(n,e){const t=Ja(n),s=(await Nu()).transaction(Nr,"readwrite"),i=s.objectStore(Nr),o=await i.get(t);return await i.put(e,t),await s.done,(!o||o.fid!==e.fid)&&w_(n,e.fid),e}async function E_(n){const e=Ja(n),r=(await Nu()).transaction(Nr,"readwrite");await r.objectStore(Nr).delete(e),await r.done}async function Ya(n,e){const t=Ja(n),s=(await Nu()).transaction(Nr,"readwrite"),i=s.objectStore(Nr),o=await i.get(t),c=e(o);return c===void 0?await i.delete(t):await i.put(c,t),await s.done,c&&(!o||o.fid!==c.fid)&&w_(n,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kR(n){const e=n,{installationEntry:t,registrationPromise:r}=await xu(e);return r?r.catch(console.error):Vu(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function DR(n,e=!1){const t=n;return await NR(t),(await Vu(t,e)).token}async function NR(n){const{registrationPromise:e}=await xu(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xR(n){if(!n||!n.options)throw Oc("App Configuration");if(!n.name)throw Oc("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw Oc(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Oc(n){return Dr.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A_="installations",VR="installations-internal",LR=n=>{const e=n.getProvider("app").getImmediate(),t=xR(e),r=Mr(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},OR=n=>{const e=n.getProvider("app").getImmediate(),t=Mr(e,A_).getImmediate();return{getId:()=>kR(t),getToken:s=>DR(t,s)}};function MR(){Ft(new kt(A_,LR,"PUBLIC")),Ft(new kt(VR,OR,"PRIVATE"))}MR();vt(c_,Du);vt(c_,Du,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mc="fcm_token_details_db",GR=5,Cf="fcm_token_object_Store";async function zR(n){if("databases"in indexedDB&&!(await indexedDB.databases()).map(i=>i.name).includes(Mc))return null;let e=null;return(await Ta(Mc,GR,{upgrade:async(r,s,i,o)=>{var c;if(s<2||!r.objectStoreNames.contains(Cf))return;const l=o.objectStore(Cf),u=await l.index("fcmSenderId").get(n);if(await l.clear(),!!u){if(s===2){const h=u;if(!h.auth||!h.p256dh||!h.endpoint)return;e={token:h.fcmToken,createTime:(c=h.createTime)!==null&&c!==void 0?c:Date.now(),subscriptionOptions:{auth:h.auth,p256dh:h.p256dh,endpoint:h.endpoint,swScope:h.swScope,vapidKey:typeof h.vapidKey=="string"?h.vapidKey:cn(h.vapidKey)}}}else if(s===3){const h=u;e={token:h.fcmToken,createTime:h.createTime,subscriptionOptions:{auth:cn(h.auth),p256dh:cn(h.p256dh),endpoint:h.endpoint,swScope:h.swScope,vapidKey:cn(h.vapidKey)}}}else if(s===4){const h=u;e={token:h.fcmToken,createTime:h.createTime,subscriptionOptions:{auth:cn(h.auth),p256dh:cn(h.p256dh),endpoint:h.endpoint,swScope:h.swScope,vapidKey:cn(h.vapidKey)}}}}}})).close(),await Ec(Mc),await Ec("fcm_vapid_details_db"),await Ec("undefined"),HR(e)?e:null}function HR(n){if(!n||!n.subscriptionOptions)return!1;const{subscriptionOptions:e}=n;return typeof n.createTime=="number"&&n.createTime>0&&typeof n.token=="string"&&n.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function XR(n,e){const t=await Mu(n),r=k_(e),s={method:"POST",headers:t,body:JSON.stringify(r)};let i;try{i=await(await fetch(Ou(n.appConfig),s)).json()}catch(o){throw lt.create("token-subscribe-failed",{errorInfo:o==null?void 0:o.toString()})}if(i.error){const o=i.error.message;throw lt.create("token-subscribe-failed",{errorInfo:o})}if(!i.token)throw lt.create("token-subscribe-no-token");return i.token}async function ZR(n,e){const t=await Mu(n),r=k_(e.subscriptionOptions),s={method:"PATCH",headers:t,body:JSON.stringify(r)};let i;try{i=await(await fetch(`${Ou(n.appConfig)}/${e.token}`,s)).json()}catch(o){throw lt.create("token-update-failed",{errorInfo:o==null?void 0:o.toString()})}if(i.error){const o=i.error.message;throw lt.create("token-update-failed",{errorInfo:o})}if(!i.token)throw lt.create("token-update-no-token");return i.token}async function e0(n,e){const r={method:"DELETE",headers:await Mu(n)};try{const i=await(await fetch(`${Ou(n.appConfig)}/${e}`,r)).json();if(i.error){const o=i.error.message;throw lt.create("token-unsubscribe-failed",{errorInfo:o})}}catch(s){throw lt.create("token-unsubscribe-failed",{errorInfo:s==null?void 0:s.toString()})}}function Ou({projectId:n}){return`${UR}/projects/${n}/registrations`}async function Mu({appConfig:n,installations:e}){const t=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n.apiKey,"x-goog-firebase-installations-auth":`FIS ${t}`})}function k_({p256dh:n,auth:e,endpoint:t,vapidKey:r}){const s={web:{endpoint:t,auth:e,p256dh:n}};return r!==S_&&(s.web.applicationPubKey=r),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _0(n,e){const t=e.data;if(!t.isFirebaseMessaging)return;n.onMessageHandler&&t.messageType===Ui.PUSH_RECEIVED&&(typeof n.onMessageHandler=="function"?n.onMessageHandler(Df(t)):n.onMessageHandler.next(Df(t)));const r=t.data;l0(r)&&r[qR]==="1"&&await p0(n,t.messageType,r)}const Nf="@firebase/messaging",xf="0.12.12";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function N_(){try{await Hf()}catch{return!1}return typeof window<"u"&&Al()&&jy()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
(Kræver login med din bruger)`);const i=n.shooters.map(l=>{var u;return(u=m.friends.find(h=>h.id===l.id))==null?void 0:u.email}).filter(Boolean),o="3D Bueskydning - "+n.name,c="mailto:"+i.join(",")+"?subject="+encodeURIComponent(o)+"&body="+encodeURIComponent(t);window.location.href=c};const z_="archery_meetups_seen",X0={afventer:"Afventer",tilmeldt:"Tilmeldt ✅",foreslået:"Foreslår andet tidspunkt 🕓",afvist:"Afbud ❌"};function $c(n){if(!n)return"";const[e,t,r]=n.split("-");return e&&t&&r?`${r}-${t}-${e}`:n}let tt=new Map,io="venner",pi=null,H_=null,zu=null,W_=null;async function Hu(){if(m.user)try{const n=[Oe(Gn(Ne(q,"meetups"),gn("creatorUid","==",m.user.uid))),Oe(Gn(Ne(q,"meetups"),gn("invitedUids","array-contains",m.user.uid)))];m.isSuperAdmin&&n.push(Oe(Ne(q,"meetups")));const e=await Promise.all(n),t=new Map;e.forEach(r=>r.docs.forEach(s=>t.set(s.id,{id:s.id,...s.data()}))),m.meetups=[...t.values()].sort((r,s)=>`${r.date}${r.time}`.localeCompare(`${s.date}${s.time}`))}catch(n){console.warn("Hent meetups:",n)}}function Z0(n,e){return n.filter(t=>{var s,i;return(((i=(s=t.updatedAt)==null?void 0:s.toMillis)==null?void 0:i.call(s))??(typeof t.updatedAt=="number"?t.updatedAt:0))>e}).length}function oo(){const n=document.getElementById("meetup-badge");if(!n)return;const e=Number(localStorage.getItem(z_)||0),t=Z0(m.meetups,e);n.classList.toggle("hidden",t===0),n.textContent=t}function eP(){localStorage.setItem(z_,String(Date.now())),oo()}function qt(){const n=document.getElementById("meetups-list");if(!n)return;const e=new Date().toISOString().slice(0,10),t=m.meetups.filter(r=>r.date>=e);if(!t.length){n.innerHTML='<div class="empty"><div class="empty-icon">🏹</div>Ingen planlagte skydninger endnu</div>';return}n.innerHTML="",t.forEach(r=>n.appendChild(tP(r)))}function tP(n){var u;const e=document.createElement("div");e.className="meetup-card"+(n.status==="aflyst"?" meetup-cancelled":"");const t=n.creatorUid===((u=m.user)==null?void 0:u.uid),r=(n.participants||[]).find(h=>{var p;return h.uid===((p=m.user)==null?void 0:p.uid)}),s=m.isSuperAdmin&&!t&&!r,i=(n.participants||[]).map(h=>{const p=h.status==="foreslået"&&h.proposedDate?` → ${K($c(h.proposedDate))} ${K(h.proposedTime||"")}`:"";return`<div class="meetup-partrow"><span>${K(h.name)}</span><span class="meetup-status meetup-status-${K(h.status)}">${K(X0[h.status]||h.status)}${p}</span></div>`}).join(""),o=(n.comments||[]).map(h=>`<div class="meetup-comment"><b>${K(h.name)}:</b> ${K(h.text)}</div>`).join("");let c="";n.status!=="aflyst"&&(r&&(r.status!=="tilmeldt"&&(c+=`<button class="btn btn-gold btn-sm" onclick="joinMeetup('${n.id}')">Tilmeld</button>`),c+=`<button class="btn btn-dark btn-sm" onclick="openProposeTimeModal('${n.id}')">Foreslå andet tidspunkt</button>`,r.status!=="afvist"&&(c+=`<button class="btn btn-dark btn-sm" onclick="declineMeetup('${n.id}')">Afbud</button>`)),t&&((n.participants||[]).filter(h=>h.status==="foreslået"&&h.proposedDate).forEach(h=>{c+=`<button class="btn btn-gold btn-sm" onclick="acceptProposedTime('${n.id}','${h.uid}')">Accepter ${K($c(h.proposedDate))} ${K(h.proposedTime||"")} (${K(h.name)})</button>`}),c+=`<button class="btn btn-dark btn-sm" onclick="openEditMeetupModal('${n.id}')">Rediger tidspunkt</button>`,c+=`<button class="btn btn-dark btn-sm" onclick="cancelMeetup('${n.id}')">Aflys</button>`,c+=`<button class="btn btn-red btn-sm" onclick="deleteMeetup('${n.id}')">Slet</button>`)),e.innerHTML=`
    ...
    <div class="meetup-head">
      ...
      <div class="meetup-when">${K($c(n.date))} kl. ${K(n.time)}</div>
  ...
  `;const l=e.querySelector(".meetup-comment-input");return e.querySelector(".meetup-comment-send").addEventListener("click",()=>{rP(n.id,l.value),l.value=""}),e}window.openMeetupModal=function(){if(!m.courses.length){j("Ingen baner tilgængelige","error");return}tt=new Map,io="venner",pi=null,zu=null,document.getElementById("mu-course-display").value="",document.getElementById("mu-course-list").classList.add("hidden"),nP(),document.getElementById("mu-date").value="",document.getElementById("mu-time").value="",document.getElementById("mu-comment").value="",document.querySelectorAll(".mu-pool-tab").forEach(n=>n.classList.toggle("active",n.dataset.pool==="venner")),ao(),tc(),document.getElementById("meetup-modal").classList.remove("hidden")};window.toggleMeetupCourseList=function(){document.getElementById("mu-course-list").classList.toggle("hidden")};function nP(){const n=document.getElementById("mu-course-list");n.innerHTML="",m.courses.forEach(e=>{const t=document.createElement("div");t.className="ac-item",t.textContent=e.name||e.yam||"",t.addEventListener("click",()=>{zu=e.id,document.getElementById("mu-course-display").value=e.name||e.yam||"",n.classList.add("hidden")}),n.appendChild(t)})}window.toggleMeetupPool=function(n){io=n,document.querySelectorAll(".mu-pool-tab").forEach(e=>e.classList.toggle("active",e.dataset.pool===n)),ao()};async function bl(){if(!pi)try{pi=(await Oe(Ne(q,"users"))).docs.map(e=>({uid:e.id,name:e.data().name||e.data().yam||e.data().email||"—"}))}catch(n){console.warn(n),pi=[]}return pi}async function Q_(){if(io==="venner"){const e=new Set((await bl()).map(t=>t.uid));return m.friends.map(t=>({uid:t.id,name:t.name,registered:e.has(t.id)})).sort((t,r)=>t.name.localeCompare(r.name,"da"))}return(await bl()).filter(e=>{var t;return e.uid!==((t=m.user)==null?void 0:t.uid)}).map(e=>({...e,registered:!0})).sort((e,t)=>e.name.localeCompare(t.name,"da"))}async function ao(){const n=document.getElementById("mu-invitee-list");if(!n)return;const e=await Q_();if(n.innerHTML="",!e.length){n.innerHTML=`<div class="empty"><div class="empty-icon">👤</div>${io==="venner"?"Du har ingen venner endnu":"Ingen andre registrerede brugere"}</div>`;return}e.forEach(t=>{const r=document.createElement("label");r.className="mu-invitee-row"+(t.registered===!1?" mu-invitee-unregistered":"");const s=document.createElement("input");s.type="checkbox",s.checked=tt.has(t.uid);const i=document.createElement("span");if(i.textContent=t.name,r.appendChild(s),r.appendChild(i),t.registered===!1){s.disabled=!0;const o=document.createElement("span");o.className="mu-invitee-note",o.textContent="ikke registreret i appen",r.appendChild(o)}else s.addEventListener("change",()=>J_(t.uid,t.name));n.appendChild(r)})}function J_(n,e){tt.has(n)?tt.delete(n):tt.set(n,{uid:n,name:e}),tc(),ao()}window.toggleSelectAllMeetup=async function(){const n=(await Q_()).filter(t=>t.registered!==!1);if(!n.length)return;n.every(t=>tt.has(t.uid))?n.forEach(t=>tt.delete(t.uid)):n.forEach(t=>tt.set(t.uid,t)),tc(),ao()};function tc(){const n=document.getElementById("mu-selected-chips");if(n){if(n.innerHTML="",!tt.size){n.innerHTML='<div class="mu-chips-empty">Ingen modtagere valgt endnu</div>';return}[...tt.values()].forEach(e=>{const t=document.createElement("div");t.className="pchip";const r=document.createElement("span");r.className="pchip-name",r.textContent=e.name;const s=document.createElement("button");s.className="pchip-rm",s.textContent="✕",s.addEventListener("click",()=>J_(e.uid,e.name)),t.appendChild(r),t.appendChild(s),n.appendChild(t)})}}window.saveMeetup=async function(){var p,g;const n=m.courses.find(y=>y.id===zu),e=document.getElementById("mu-date").value,t=document.getElementById("mu-time").value;if(!n){j("Vælg en bane","error");return}if(!e||!t){j("Vælg dato og tid","error");return}if(!tt.size){j("Vælg mindst én modtager","error");return}const r=new Set((await bl()).map(y=>y.uid)),s=[...tt.values()].filter(y=>!r.has(y.uid)).map(y=>y.name);if(s.length&&(s.forEach(y=>{const S=[...tt.entries()].find(([,k])=>k.name===y);S&&tt.delete(S[0])}),j(`${s.join(", ")} er ikke registreret i appen og blev ikke inviteret`,"error"),tc(),ao(),!tt.size))return;const i=document.getElementById("mu-comment").value.trim().slice(0,300),o=[...tt.keys()],c=[...tt.values()].map(y=>({uid:y.uid,name:y.name,status:"afventer",proposedDate:null,proposedTime:null})),l=i?[{uid:m.user.uid,name:((p=m.profile)==null?void 0:p.name)||"—",text:i,createdAt:new Date}]:[],u=new Date(`${e}T${t}`);u.setDate(u.getDate()+1);const h={courseId:n.id,courseName:n.name||n.yam||"",date:e,time:t,creatorUid:m.user.uid,creatorName:((g=m.profile)==null?void 0:g.name)||"—",pool:io,invitedUids:o,participants:c,comments:l,status:"åben",createdAt:Ue(),updatedAt:Ue(),expireAt:u};try{await Ug(Ne(q,"meetups"),h),document.getElementById("meetup-modal").classList.add("hidden"),j("Forslag sendt","success"),await Hu(),qt(),oo()}catch(y){j("Fejl: "+y.message,"error")}};async function Y_(n,e){const t=m.meetups.find(s=>s.id===n);if(!t||!m.user)return;const r=(t.participants||[]).map(s=>s.uid===m.user.uid?{...s,status:e,proposedDate:null,proposedTime:null}:s);try{await Ye(te(q,"meetups",t.id),{participants:r,updatedAt:Ue()}),t.participants=r,t.updatedAt=Date.now(),qt()}catch(s){j("Fejl: "+s.message,"error")}}window.joinMeetup=function(n){Y_(n,"tilmeldt")};window.declineMeetup=function(n){Y_(n,"afvist")};window.openProposeTimeModal=function(n){H_=n,document.getElementById("mu-propose-date").value="",document.getElementById("mu-propose-time").value="",document.getElementById("meetup-propose-modal").classList.remove("hidden")};window.saveProposeTime=async function(){const n=document.getElementById("mu-propose-date").value,e=document.getElementById("mu-propose-time").value;if(!n||!e){j("Vælg dato og tid","error");return}const t=m.meetups.find(s=>s.id===H_);if(!t||!m.user)return;const r=(t.participants||[]).map(s=>s.uid===m.user.uid?{...s,status:"foreslået",proposedDate:n,proposedTime:e}:s);try{await Ye(te(q,"meetups",t.id),{participants:r,updatedAt:Ue()}),t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-propose-modal").classList.add("hidden"),qt()}catch(s){j("Fejl: "+s.message,"error")}};window.acceptProposedTime=async function(n,e){var c;const t=m.meetups.find(l=>l.id===n);if(!t||t.creatorUid!==((c=m.user)==null?void 0:c.uid))return;const r=(t.participants||[]).find(l=>l.uid===e);if(!(r!=null&&r.proposedDate)||!(r!=null&&r.proposedTime))return;const s=r.proposedDate,i=r.proposedTime,o=t.participants.map(l=>l.uid===e?{...l,status:"tilmeldt",proposedDate:null,proposedTime:null}:{...l,status:"afventer",proposedDate:null,proposedTime:null});try{await Ye(te(q,"meetups",t.id),{date:s,time:i,participants:o,updatedAt:Ue()}),t.date=s,t.time=i,t.participants=o,t.updatedAt=Date.now(),qt(),j("Nyt tidspunkt accepteret","success")}catch(l){j("Fejl: "+l.message,"error")}};window.openEditMeetupModal=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||(W_=n,document.getElementById("mu-edit-date").value=e.date,document.getElementById("mu-edit-time").value=e.time,document.getElementById("meetup-edit-modal").classList.remove("hidden"))};window.saveEditMeetup=async function(){var s;const n=document.getElementById("mu-edit-date").value,e=document.getElementById("mu-edit-time").value;if(!n||!e){j("Vælg dato og tid","error");return}const t=m.meetups.find(i=>i.id===W_);if(!t||t.creatorUid!==((s=m.user)==null?void 0:s.uid))return;const r=(t.participants||[]).map(i=>({...i,status:"afventer",proposedDate:null,proposedTime:null}));try{await Ye(te(q,"meetups",t.id),{date:n,time:e,participants:r,updatedAt:Ue()}),t.date=n,t.time=e,t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-edit-modal").classList.add("hidden"),qt(),j("Tidspunkt opdateret","success")}catch(i){j("Fejl: "+i.message,"error")}};window.cancelMeetup=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||Yn("Aflys denne skydning?",async()=>{try{await Ye(te(q,"meetups",e.id),{status:"aflyst",updatedAt:Ue()}),e.status="aflyst",e.updatedAt=Date.now(),qt()}catch(r){j("Fejl: "+r.message,"error")}})};window.deleteMeetup=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||Yn("Slet denne skydning permanent? Det kan ikke fortrydes.",async()=>{try{await Dt(te(q,"meetups",e.id)),m.meetups=m.meetups.filter(r=>r.id!==n),qt(),oo()}catch(r){j("Fejl: "+r.message,"error")}})};async function rP(n,e){var i;if(e=(e||"").trim().slice(0,300),!e||!m.user)return;const t=m.meetups.find(o=>o.id===n);if(!t)return;const r={uid:m.user.uid,name:((i=m.profile)==null?void 0:i.name)||"—",text:e,createdAt:new Date},s=[...t.comments||[],r];try{await Ye(te(q,"meetups",t.id),{comments:s,updatedAt:Ue()}),t.comments=s,t.updatedAt=Date.now(),qt()}catch(o){j("Fejl: "+o.message,"error")}}const X_="archery_share_requests_seen";function sP(n,e){return`${n}_${e}`}async function Z_(){if(m.user)try{const[n,e]=await Promise.all([Oe(Gn(Ne(q,"shareRequests"),gn("ownerUid","==",m.user.uid))),Oe(Gn(Ne(q,"shareRequests"),gn("viewerUid","==",m.user.uid)))]),t=new Map;n.docs.forEach(r=>t.set(r.id,{id:r.id,...r.data()})),e.docs.forEach(r=>t.set(r.id,{id:r.id,...r.data()})),m.shareRequests=[...t.values()]}catch(n){console.warn("Hent delingsanmodninger:",n)}}function iP(n,e,t){return n.filter(r=>{var i,o;return r.ownerUid!==e||r.status!=="afventer"?!1:(((o=(i=r.createdAt)==null?void 0:i.toMillis)==null?void 0:o.call(i))??(typeof r.createdAt=="number"?r.createdAt:0))>t}).length}function nc(){var r;const n=document.getElementById("share-badge");if(!n)return;const e=Number(localStorage.getItem(X_)||0),t=iP(m.shareRequests,(r=m.user)==null?void 0:r.uid,e);n.classList.toggle("hidden",t===0),n.textContent=t}function oP(){localStorage.setItem(X_,String(Date.now())),nc()}function ey(){return m.user?m.shareRequests.filter(n=>n.viewerUid===m.user.uid&&n.status==="accepteret").map(n=>({uid:n.ownerUid,name:n.ownerName})).sort((n,e)=>n.name.localeCompare(e.name,"da")):[]}async function aP(n){var e,t;try{const r=m.shareRequests.find(c=>{var l;return c.ownerUid===n&&c.viewerUid===((l=m.user)==null?void 0:l.uid)&&c.status==="accepteret"}),s=((t=(e=(r==null?void 0:r.acceptedAt)||(r==null?void 0:r.updatedAt))==null?void 0:e.toMillis)==null?void 0:t.call(e))??0,o=(await Oe(Gn(Ne(q,"users",n,"rounds"),gn("completed",">",s)))).docs.map(c=>({...c.data(),id:c.id})).sort((c,l)=>{var p,g;const u=c.completed||c.created||0,h=l.completed||l.created||0;return(typeof h=="number"?h:((p=h.toMillis)==null?void 0:p.call(h))??0)-(typeof u=="number"?u:((g=u.toMillis)==null?void 0:g.call(u))??0)});return m.viewedRounds[n]=o,o}catch(r){return console.warn("Hent delte runder:",r),m.viewedRounds[n]=[],[]}}function qr(){var o;const n=document.getElementById("sharing-list");if(!n)return;const e=(o=m.user)==null?void 0:o.uid,t=m.shareRequests.filter(c=>c.ownerUid===e&&c.status==="afventer"),r=m.shareRequests.filter(c=>c.ownerUid===e&&c.status==="accepteret"),s=m.shareRequests.filter(c=>c.viewerUid===e&&c.status==="accepteret");if(!t.length&&!r.length&&!s.length){n.innerHTML='<div class="share-empty">Anmod om at se en vens resultater ved at trykke "🔎 Må jeg kigge med?" på personen i din venneliste ovenfor.</div>';return}let i="";t.length&&(i+='<div class="share-group-title">Anmodninger om at se dine resultater</div>',t.forEach(c=>{i+=`<div class="share-card">
      ...
      </div>`})),n.innerHTML=i}window.requestViewAccess=async function(n,e){var t,r;if(m.user){if(n===m.user.uid){j("Du kan ikke anmode om at se dine egne resultater","error");return}try{let s=(await Cs(te(q,"users",n))).exists();if(!s){const i=m.friends.find(o=>o.id===n);if(i!=null&&i.email){const c=(await Oe(Ne(q,"users"))).docs.find(l=>{const u=l.data(),h=(u.email||u["e-mail"]||"").toLowerCase();return h&&h===i.email.toLowerCase()});c&&(n=c.id,s=!0,i.id=n,At(),Ct(te(q,"users",m.user.uid,"friends",n),i).catch(l=>console.warn(l)))}}if(!s){j(`${e} er ikke registreret i appen`,"error");return}await Ct(te(q,"shareRequests",sP(n,m.user.uid)),{ownerUid:n,ownerName:e,viewerUid:m.user.uid,viewerName:((t=m.profile)==null?void 0:t.name)||"—",status:"afventer",createdAt:Ue(),updatedAt:Ue()}),j("Anmodning sendt","success"),await Z_(),qr(),(r=window.renderFriendsList)==null||r.call(window)}catch(s){j("Fejl: "+s.message,"error")}}};window.cancelShareRequest=async function(n){var e;try{await Dt(te(q,"shareRequests",n)),m.shareRequests=m.shareRequests.filter(t=>t.id!==n),qr(),(e=window.renderFriendsList)==null||e.call(window)}catch(t){j("Fejl: "+t.message,"error")}};window.acceptShareRequest=async function(n){try{await Ye(te(q,"shareRequests",n),{status:"accepteret",acceptedAt:Ue(),updatedAt:Ue()});const e=m.shareRequests.find(t=>t.id===n);e&&(e.status="accepteret"),qr(),nc(),j("Deling accepteret","success")}catch(e){j("Fejl: "+e.message,"error")}};window.declineShareRequest=function(n){Yn("Afvis denne anmodning?",async()=>{try{await Ye(te(q,"shareRequests",n),{status:"afvist",updatedAt:Ue()});const e=m.shareRequests.find(t=>t.id===n);e&&(e.status="afvist"),qr(),nc()}catch(e){j("Fejl: "+e.message,"error")}})};window.endSharing=function(n){Yn("Afslut denne deling? Personen mister med det samme adgang til dine resultater.",async()=>{try{await Dt(te(q,"shareRequests",n)),m.shareRequests=m.shareRequests.filter(e=>e.id!==n),qr(),j("Deling afsluttet","success")}catch(e){j("Fejl: "+e.message,"error")}})};const cP="BOJHqC2HeXd9Ru6EjuL7HEuAZuZ2MM86LPqPfVbeQsm8M8-wgT_u3QPWYFs0XN0vfMz_FS3rDgjXgCXXm0GkmZs",lP="/3D/sw.js";async function ty(){if(!("serviceWorker"in navigator))return null;try{return await navigator.serviceWorker.register(lP,{scope:"/3D/3D-dev/"})}catch(n){return console.warn("SW-registrering fejlede",n),null}}function uP(){return"Notification"in window&&Notification.permission==="default"}async function ny(){let n;try{n=await Notification.requestPermission()}catch(e){return console.warn("Notification.requestPermission fejlede",e),j("Kunne ikke bede om tilladelse: "+e.message,"error"),!1}if(n==="denied")return j("Notifikationer blokeret i browseren — skal ændres i browserens side-indstillinger","error"),!1;if(n!=="granted")return!1;try{if(!await V_||!ji)return j("Push-notifikationer understøttes ikke i denne browser","error"),!1;const t=await ty();if(!t)return j("Kunne ikke registrere service worker","error"),!1;const r=await T0(ji,{vapidKey:cP,serviceWorkerRegistration:t});return r?(await Ye(te(q,"users",m.user.uid),{fcmToken:r}),!0):(j("Kunne ikke hente push-token","error"),!1)}catch(e){return console.warn("Push-opsætning fejlede",e),j("Push-fejl: "+e.message,"error"),!1}}function dP(){"Notification"in window&&Notification.permission==="granted"&&ny()}function hP(){V_.then(n=>{!n||!ji||b0(ji,e=>{const t=e.data||{};j(t.body||"Ny besked","info"),Hu().then(()=>{qt(),oo()}).catch(()=>{})})})}function Lf(n,e){var b;const t=E=>{var A;return E.shooters.find(w=>w.id===e)||((A=E.shooters)==null?void 0:A[0])},r=n.map(E=>{const A=t(E);return A?ct(A.scores):null}).filter(E=>E!==null),s=new Set(n.map(E=>E.ruleset||xr)),i=s.size===1?[...s][0]:null,o=!!i&&jt(i)>=2;let c=0,l=0,u=0,h=0;const p=o?Vr(i):[],g={},y={};p.forEach(E=>{g[E]=0,y[E]=0});const S={};let k=0,P=0;n.forEach(E=>{const A=t(E);A&&(A.scores.forEach(w=>{w.forEach(Fe=>{Fe!=null&&(S[Fe]=(S[Fe]||0)+1,k+=we(Fe),P++)})}),o&&A.scores.forEach(w=>{w[0]!=null&&(g[w[0]]!==void 0&&g[w[0]]++,c+=we(w[0]),l++),w[1]!=null&&(y[w[1]]!==void 0&&y[w[1]]++,u+=we(w[1]),h++)}))});const L=l?(c/l).toFixed(2):0,B=h?(u/h).toFixed(2):0,U=l+h?((c+u)/(l+h)).toFixed(2):0,Q=P?(k/P).toFixed(2):0,re=((b=n[0])==null?void 0:b.numTargets)||24,T=Array.from({length:re},(E,A)=>{let w=0,Fe=0;return n.forEach(tn=>{const Kr=t(tn);if(!Kr)return;(Kr.scores[A]||[null,null]).forEach(St=>{St!=null&&(w+=we(St),Fe++)})}),Fe?w/Fe:null}).map((E,A)=>({v:E,i:A})).filter(E=>E.v!==null),v=T.length?T.reduce((E,A)=>E.v>A.v?E:A):null,I=T.length?T.reduce((E,A)=>E.v<A.v?E:A):null;return{myScores:r,p1avg:L,p2avg:B,pilAvg:U,overallPilAvg:Q,distP1:g,distP2:y,distAll:S,bestTarget:v,worstTarget:I,pilRuleset:i,pilEligible:o}}function Of(n){if(!n.length)return 0;const e=n.reduce((t,r)=>t+r,0)/n.length;return Math.sqrt(n.reduce((t,r)=>t+(r-e)**2,0)/n.length)}function fP(n){var l;const e=n.length;if(e<2)return{slope:0,intercept:((l=n[0])==null?void 0:l.y)||0};const t=n.reduce((u,h)=>u+h.x,0),r=n.reduce((u,h)=>u+h.y,0),s=n.reduce((u,h)=>u+h.x*h.y,0),i=n.reduce((u,h)=>u+h.x*h.x,0),o=e*i-t*t,c=o?(e*s-t*r)/o:0;return{slope:c,intercept:(r-c*t)/e}}function mP(n,e){var o,c;const t=((o=n.shooters)==null?void 0:o.find(l=>l.id===e))||((c=n.shooters)==null?void 0:c[0]);if(!t)return[];const r=n.numTargets||24,s=n.traversalOrder||Array.from({length:r},(l,u)=>u),i=[];for(let l=0;l<r;l++){const u=s[l];if(u===void 0)continue;const h=t.scores[u]||[null,null];let p=0,g=0;h.forEach(y=>{y!=null&&(p+=we(y),g++)}),g&&i.push(p/g)}return i}function pP(n,e){let t=1,r=0,s=0,i=0,o=1,c=0,l=0,u=0,h=0,p=0,g=0,y=0,S=0;const k=()=>{e.style.transformOrigin="0 0",e.style.transform=t>1?`translate(${r}px,${s}px) scale(${t})`:""};n.addEventListener("touchstart",L=>{if(L.preventDefault(),L.touches.length===2){const B=L.touches,U=n.getBoundingClientRect();i=Math.hypot(B[0].clientX-B[1].clientX,B[0].clientY-B[1].clientY),o=t,c=r,l=s,u=(B[0].clientX+B[1].clientX)/2-U.left,h=(B[0].clientY+B[1].clientY)/2-U.top}else L.touches.length===1&&(p=L.touches[0].clientX,g=L.touches[0].clientY,y=r,S=s)},{passive:!1}),n.addEventListener("touchmove",L=>{if(L.preventDefault(),L.touches.length===2){const B=L.touches,U=Math.hypot(B[0].clientX-B[1].clientX,B[0].clientY-B[1].clientY),Q=Math.min(8,Math.max(1,o*U/i)),re=(u-c)/o,ee=(h-l)/o;r=u-re*Q,s=h-ee*Q,t=Q,k()}else L.touches.length===1&&t>1&&(r=y+L.touches[0].clientX-p,s=S+L.touches[0].clientY-g,k())},{passive:!1}),n.addEventListener("touchend",()=>{t<1.05&&(t=1,r=0,s=0,k())},{passive:!0});let P=0;n.addEventListener("touchend",()=>{const L=Date.now();L-P<300&&(t=1,r=0,s=0,k()),P=L},{passive:!0})}let Ht=null,pr=null;function gP(){const n=document.getElementById("graph-fs");n&&n.classList.add("hidden"),Ht&&(window.removeEventListener("resize",Ht),window.removeEventListener("orientationchange",Ht),Ht=null),pr&&(document.removeEventListener("gesturestart",pr),pr=null)}window.closeGraphFs=gP;function _P(n){m.pendingAnalyseRound=n,m.viewingUid=null,m.viewingName=null,document.getElementById("analyse-filter").value="specific",window.switchTab("analyse")}window.setAnalyseViewer=async function(n){m.viewingUid=n||null;const e=n?ey().find(t=>t.uid===n):null;m.viewingName=(e==null?void 0:e.name)||null,n&&!m.viewedRounds[n]&&await aP(n),window.renderAnalyse()};window.analyseRound=_P;const yP={11:"#1a7a3a",10:"#1a5aaa",8:"#d4700a",5:"#7a3aaa",M:"#cc3333",3:"#0a8a8a","-1":"#5a5a6a"};function vP(n,e,t,r){const s=n.myScores[0]||0,i=t.myScores[0]||0,o=Math.abs(s-i),c='<div class="cmp-sep"></div>',l=(g,y,S)=>`<div style="font-size:11px;color:${S};margin-bottom:4px;">${K(y)}</div>
    ...
    <div class="pil-best-note">${g.pilRuleset?`${g.pilRuleset} skydes med 1 pil pr. mål — PIL 1/PIL 2 er derfor ikke relevant`:"Ikke relevant"}</div>`}`,u=(g,y,S)=>g.bestTarget&&g.worstTarget?`<div style="font-size:11px;color:${S};margin-bottom:6px;">${K(y)}</div>
  ...
  </div>`,h}window.renderAnalyse=function(){var Us,lo,Jr,Yr,$s,$e,He,tr,js,qs;const n=document.getElementById("analyse-content");if(!n)return;const e=m.viewingUid||((Us=m.user)==null?void 0:Us.uid),t=m.viewingUid?m.viewedRounds[m.viewingUid]||[]:m.rounds,r=document.getElementById("analyse-viewer-wrap"),s=document.getElementById("analyse-viewer");if(s){const V=ey();for(;s.options.length>1;)s.remove(1);V.forEach(O=>{const G=document.createElement("option");G.value=O.uid,G.textContent=O.name,s.appendChild(G)}),s.value=m.viewingUid&&V.some(O=>O.uid===m.viewingUid)?m.viewingUid:"",r&&r.classList.toggle("hidden",!V.length)}const i=document.getElementById("analyse-bane");if(i){const V=i.value;for(;i.options.length>1;)i.remove(1);const O=[...new Set(t.map(G=>G.courseId).filter(Boolean))];O.forEach(G=>{const X=m.courses.find(H=>H.id===G);if(X){const H=document.createElement("option");H.value=G,H.textContent=X.name,i.appendChild(H)}}),O.includes(V)&&(i.value=V)}if(m.pendingAnalyseRound&&i&&!m.viewingUid){const V=m.rounds.find(O=>O.id===m.pendingAnalyseRound);V!=null&&V.courseId&&Array.from(i.options).some(O=>O.value===V.courseId)&&(i.value=V.courseId)}const o=((lo=document.getElementById("analyse-filter"))==null?void 0:lo.value)||"all",c=o==="all"?0:o==="lastround"?1:o==="specific"?0:Number(o),l=((Jr=document.getElementById("analyse-bane"))==null?void 0:Jr.value)||"all",u=Number((Yr=document.getElementById("analyse-antal"))==null?void 0:Yr.value)||0,h=document.getElementById("analyse-runde-wrap"),p=document.getElementById("analyse-runde"),g=document.getElementById("analyse-runde-wrap-2"),y=document.getElementById("analyse-runde-2"),S=document.getElementById("analyse-runde-lbl"),k=o==="compare";h&&(h.style.display=o==="specific"||k?"":"none"),g&&(g.style.display=k?"":"none"),S&&(S.style.display=k?"":"none");const P=V=>{const O=V.created;return O!=null&&O.toDate?O.toDate().toLocaleDateString("da-DK"):O!=null&&O.seconds?new Date(O.seconds*1e3).toLocaleDateString("da-DK"):typeof O=="number"?new Date(O).toLocaleDateString("da-DK"):"—"},L=(($s=document.getElementById("analyse-ruleset"))==null?void 0:$s.value)||"all",B=(V,O)=>{let G=l==="all"?t:t.filter(H=>H.courseId===l);L!=="all"&&(G=G.filter(H=>(H.ruleset||"WA")===L));const X=V.value;V.innerHTML=`<option value="">${O}</option>`,G.forEach(H=>{const ae=document.createElement("option");ae.value=H.id,ae.textContent=`${P(H)} — ${H.name||"Runde"}`,V.appendChild(ae)}),G.some(H=>H.id===X)&&(V.value=X)};if((o==="specific"||k)&&p&&(B(p,"Vælg runde..."),m.pendingAnalyseRound&&(p.value=m.pendingAnalyseRound,m.pendingAnalyseRound=null)),k&&y&&B(y,"Vælg runde 2..."),k){const V=p==null?void 0:p.value,O=y==null?void 0:y.value;if(!V||!O){n.innerHTML='<div class="empty"><div class="empty-icon">📊</div>Vælg to runder ovenfor</div>';return}const G=t.map(le=>({...le,shooters:(le.shooters||[]).map(pe=>({...pe,scores:Lr(pe.scores)}))})),X=G.find(le=>le.id===V),H=G.find(le=>le.id===O);if(!X||!H){n.innerHTML='<div class="empty">Kunne ikke finde runderne</div>';return}const ae=`${X.name||"Runde"} (${P(X)})`,Ee=`${H.name||"Runde"} (${P(H)})`;n.innerHTML=vP(Lf([X],e),ae,Lf([H],e),Ee);return}const U=t.map(V=>({...V,shooters:(V.shooters||[]).map(O=>({...O,scores:Lr(O.scores)}))})),Q=(($e=document.getElementById("analyse-completed-only"))==null?void 0:$e.checked)||!1,re=((He=document.getElementById("analyse-startat1-only"))==null?void 0:He.checked)||!1,ee=V=>{var X,H;const O=((X=V.shooters)==null?void 0:X.find(ae=>ae.id===e))||((H=V.shooters)==null?void 0:H[0]);if(!O)return!1;const G=V.numTargets||24;for(let ae=0;ae<G;ae++){const Ee=O.scores[ae]||[null,null];if(Ee[0]==null&&Ee[1]==null)return!1}return!0},T=V=>V.startTarget===1,v=L;let I=l==="all"?U:U.filter(V=>V.courseId===l);if(v!=="all"&&(I=I.filter(V=>(V.ruleset||"WA")===v)),Q&&(I=I.filter(ee)),re&&(I=I.filter(T)),o==="specific"){const V=p==null?void 0:p.value;I=V?I.filter(O=>O.id===V):[]}const b=u||c,E=b&&o!=="specific"?I.slice(0,b):I;if(!E.length){n.innerHTML='<div class="empty"><div class="empty-icon">📈</div>Ingen runder endnu</div>';return}const A=V=>{var O;return V.shooters.find(G=>G.id===e)||((O=V.shooters)==null?void 0:O[0])},w=E.map(V=>{const O=A(V);return O?ct(O.scores):null}).filter(V=>V!==null),Fe=w.length?(w.reduce((V,O)=>V+O,0)/w.length).toFixed(1):0,tn=w.length?Math.max(...w):0,Kr=w.length?Math.min(...w):0,Kt=E.flatMap(V=>{const O=A(V);return O?O.scores.flat().filter(G=>G!=null):[]}),St=Kt.length?(Kt.reduce((V,O)=>V+we(O),0)/Kt.length).toFixed(2):0,Gr=new Set(E.map(V=>V.ruleset||xr)),nn=Gr.size===1?[...Gr][0]:null,Zn=!!nn&&jt(nn)>=2;let Rt=0,Se=0,Fs=0,Nt=0;const co=Zn?Vr(nn):[],rn={},zr={};co.forEach(V=>{rn[V]=0,zr[V]=0}),E.forEach(V=>{const O=A(V);O&&Zn&&O.scores.forEach(G=>{G[0]!=null&&(rn[G[0]]!==void 0&&rn[G[0]]++,Rt+=we(G[0]),Se++),G[1]!=null&&(zr[G[1]]!==void 0&&zr[G[1]]++,Fs+=we(G[1]),Nt++)})});const Bs=Se?(Rt/Se).toFixed(2):0,Tn=Nt?(Fs/Nt).toFixed(2):0,Hr=Se+Nt?((Rt+Fs)/(Se+Nt)).toFixed(2):0,ut=((tr=E[0])==null?void 0:tr.numTargets)||24,Wr=Array.from({length:ut},(V,O)=>{let G=0,X=0;return E.forEach(H=>{const ae=A(H);if(!ae)return;const le=(H.traversalOrder||Array.from({length:H.numTargets||ut},(_e,je)=>je))[O];if(le===void 0)return;(ae.scores[le]||[null,null]).forEach(_e=>{_e!=null&&(G+=we(_e),X++)})}),X?G/X:null}),bn=Wr.map((V,O)=>({v:V,i:O})).filter(V=>V.v!==null),An=bn.length?bn.reduce((V,O)=>V.v>O.v?V:O):null,er=bn.length?bn.reduce((V,O)=>V.v<O.v?V:O):null;let Xe="";m.viewingUid&&(Xe+=`<div class="viewing-banner">👁 Viser resultater for ${K(m.viewingName||"—")}</div>`),Xe+=`<div class="stats-grid2">
    <div class="card stat-card"><div class="stat-lbl">RUNDER</div><div class="stat-val-28">${E.length}</div></div>
    <div class="card stat-card"><div class="stat-lbl">SNIT/RUNDE</div><div class="stat-val-28">${Fe}</div></div>
  ...
  </details>`;const ic=nn&&!Zn,Qr=nn?`${nn} skydes med 1 pil pr. mål — PIL 1/PIL 2-sammenligning er derfor ikke relevant`:"Vælg et specifikt forbund i filteret ovenfor for at se pil-fordeling (runderne i dette udvalg bruger forskellige regelsæt)";if(Xe+=`<div class="card card-mb16">
    <div class="section-title-mb8">PIL STATISTIK</div>
    ${Zn?`<div class="cmp-pil-grid">
      ...
      <div><div class="stat-lbl">PIL 2</div><div class="stat-val-22">${Tn}</div></div>
    </div>
    <div class="pil-best-note">
      ${Number(Bs)>Number(Tn)?"Bedst med PIL 1 🏹":Number(Tn)>Number(Bs)?"Bedst med PIL 2 🏹":"Begge pile er lige gode 🎯"}
    ...
    <div class="pil-best-note">${Qr}</div>`:`<div class="pil-best-note">${Qr}</div>`}
  </div>`,An&&er&&An.i!==er.i&&(Xe+=`<div class="card card-mb16">
      ...
      <div class="cmp-target-grid">
        ...
        <div class="target-worst-box">
          ...
          <div class="target-worst-val">Skud nr. ${er.i+1}</div>
          <div class="target-sub-13">⌀ ${er.v.toFixed(2)}</div>
        </div>
      </div>
    </div>`),Xe+=`<div class="card card-mb16">
    <div class="section-title-mb12">FORDELING PR. SCOREZONE</div>`,Zn?(Xe+='<div class="pie-grid">',co.forEach(V=>{const O=rn[V]||0,G=zr[V]||0,X=O+G,H=30;let ae="";if(X===0)ae=`<circle cx="${H}" cy="${H}" r="${H}" fill="var(--surface2)"/>`;else if(G===0)ae=`<circle cx="${H}" cy="${H}" r="${H}" fill="#ffd700"/>`;else if(O===0)ae=`<circle cx="${H}" cy="${H}" r="${H}" fill="#00cc44"/>`;else{const Ee=O/X,le=Ee*2*Math.PI,pe=H,_e=0,je=H-H*Math.sin(le),Re=H-H*Math.cos(le),Pe=le>Math.PI?1:0;ae=`<path d="M${H},${H} L${pe},${_e} A${H},${H} 0 ${Pe},0 ${je},${Re} Z" fill="#ffd700"/>
    ...
    </div>`}const xt=Wr.map((V,O)=>({v:V,i:O})).filter(V=>V.v!==null);if(xt.length>1){const{slope:Ee,intercept:le}=fP(xt.map(({v:Ce,i:We})=>({x:We,y:Ce}))),pe=[le,le+Ee*(ut-1)],_e=Math.floor(Math.min(...xt.map(Ce=>Ce.v),...pe)),je=Math.ceil(Math.max(...xt.map(Ce=>Ce.v),...pe)),Re=je-_e||1,Pe=[];for(let Ce=_e;Ce<=je;Ce++)(je-_e<=6||Ce%Math.ceil((je-_e)/5)===0)&&Pe.push(Ce);const dt=Of(xt.map(Ce=>Ce.v)),Vt=(Ce,We,{dotR:sn=3,valFont:ye=9,showVals:nr=!1}={})=>{const Qe=Ke=>42+(ut>1?Ke/(ut-1)*(Ce-42-15):0),qe=Ke=>15+(We-15-25)*(1-(Ke-_e)/Re),Xr=xt.map(({v:Ke,i:Gt})=>Qe(Gt)+","+qe(Ke)).join(" "),rr=Pe.map(Ke=>`<line x1="38" y1="${qe(Ke)}" x2="42" y2="${qe(Ke)}" stroke="var(--muted)" stroke-width="1" pointer-events="none"/><text x="36" y="${qe(Ke)+4}" text-anchor="end" font-size="9" fill="var(--muted)" pointer-events="none">${Ke}</text><line x1="42" y1="${qe(Ke)}" x2="${Ce-15}" y2="${qe(Ke)}" stroke="var(--surface2)" stroke-width="0.5" stroke-dasharray="3,3" pointer-events="none"/>`).join(""),Lt=xt.map(({v:Ke,i:Gt})=>nr?`<circle cx="${Qe(Gt)}" cy="${qe(Ke)}" r="${sn}" fill="var(--acc)" pointer-events="none"/><text x="${Qe(Gt)}" y="${qe(Ke)-sn-5}" text-anchor="middle" font-size="${ye}" fill="#fff" pointer-events="none">${Ke.toFixed(1)}</text>`:`<circle cx="${Qe(Gt)}" cy="${qe(Ke)}" r="${sn}" fill="var(--acc)" pointer-events="none"/>`).join(""),oc=`<line x1="${Qe(0)}" y1="${qe(le)}" x2="${Qe(ut-1)}" y2="${qe(le+Ee*(ut-1))}" stroke="#f0c030" stroke-width="1.5" stroke-dasharray="6,4" pointer-events="none"/>`;return`<line x1="42" y1="15" x2="42" y2="${We-25}" stroke="var(--surface2)" stroke-width="1" pointer-events="none"/>
    ...
    <div id="graph-fs" class="fs-ov hidden graph-fs-overlay" onclick="window.closeGraphFs()">
    ...
    </div>`,window.openGraphFs=function(){const Ce=document.getElementById("graph-fs");if(!Ce)return;Ce.classList.remove("hidden");const We=document.getElementById("graph-fs-svg"),sn=document.getElementById("graph-fs-box"),ye=document.getElementById("graph-fs-viewport"),nr=()=>{const Qe=Math.min(window.innerWidth*.96,900),qe=Math.min(window.innerHeight*.9,700),Xr=Math.max(200,Qe-32),rr=Math.max(140,qe-90),Lt=Math.max(Xr,ut*30);We.setAttribute("viewBox",`0 0 ${Lt} ${rr}`),We.innerHTML=Vt(Lt,rr,{dotR:5,valFont:10,showVals:!0}),sn&&(sn.style.width=Qe+"px"),ye&&(ye.style.width=Xr+"px",ye.style.height=rr+"px")};nr(),Ht&&(window.removeEventListener("resize",Ht),window.removeEventListener("orientationchange",Ht)),Ht=nr,window.addEventListener("resize",Ht),window.addEventListener("orientationchange",Ht),pr&&document.removeEventListener("gesturestart",pr),pr=Qe=>Qe.preventDefault(),document.addEventListener("gesturestart",pr,{passive:!1}),ye&&!ye.dataset.pinchInit&&(pP(ye,We),ye.dataset.pinchInit="1")}}if(l!=="all"){const V=G=>{const X=G.created;return X!=null&&X.toDate?X.toDate().getTime():X!=null&&X.seconds?X.seconds*1e3:typeof X=="number"?X:0},O=U.filter(G=>G.courseId===l).filter(G=>!Q||ee(G)).filter(G=>!re||T(G)).map(G=>{const X=mP(G,e);return X.length>1?{t:V(G),cv:Of(X)}:null}).filter(Boolean).sort((G,X)=>G.t-X.t);if(O.length>1){const ae=O.map(Pe=>Pe.cv),Ee=Math.min(...ae),le=Math.max(...ae),pe=le-Ee||1,_e=(Pe,dt)=>({x:30+dt/(O.length-1)*(340-2*30),y:90-(Pe.cv-Ee)/pe*(120-2*30)}),je=O.map((Pe,dt)=>{const{x:Vt,y:Pt}=_e(Pe,dt);return`${Vt},${Pt}`}).join(" "),Re=O.map((Pe,dt)=>{const{x:Vt,y:Pt}=_e(Pe,dt);return`<circle cx="${Vt}" cy="${Pt}" r="4" fill="#f0c030"/><text x="${Vt}" y="${Pt-8}" text-anchor="middle" font-size="10" fill="var(--text)">${Pe.cv.toFixed(2)}</text>`}).join("");Xe+=`<div class="card card-mb16">
      ...
      </div>`}}if(n.innerHTML=Xe,!m.viewingUid&&l!=="all"&&((js=m.profile)!=null&&js.kon)&&((qs=m.profile)!=null&&qs.bueklasse)){const V=m.profile.kon==="herre"?"Herre":"Dame",O={langbue:"Langbue",trad:"Traditionel",recurve:"Recurve",compound:"Compound",barbue:"Barbue",buejæger:"Buejæger","trad-buejæger":"Trad. buejæger",rytterbue:"Rytterbue"}[m.profile.bueklasse]||m.profile.bueklasse,G=document.createElement("div");G.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${V} ${O}</div><div class="comp-loading-msg">Henter...</div></div>`,n.appendChild(G),Oe(Ne(q,"bane_stats",l,"runder")).then(X=>{let ae=X.docs.map(Re=>Re.data()).filter(Re=>Re.kon===m.profile.kon&&Re.bueklasse===m.profile.bueklasse);if(v!=="all"&&(ae=ae.filter(Re=>(Re.ruleset||xr)===v)),!ae.length){G.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">SAMMENLIGNING · ${V} ${O}</div><div class="comp-loading-msg">Ingen andre ${V} ${O}-skytter har skudt denne bane endnu.</div></div>`;return}const Ee=ae.filter(Re=>(Re.arrowsShot||Re.numTargets*2)>0),le=Ee.length?(Ee.reduce((Re,Pe)=>Re+Pe.score/(Pe.arrowsShot||Pe.numTargets*2),0)/Ee.length).toFixed(2):"—",pe=le!=="—"?Number(St)-Number(le):null,_e=pe!==null?(pe>0?"+":"")+pe.toFixed(2):"—",je=pe===null?"var(--muted)":pe>0?"#2aaa5a":pe<0?"var(--danger)":"var(--muted)";G.innerHTML=`<div class="card card-mb16">
