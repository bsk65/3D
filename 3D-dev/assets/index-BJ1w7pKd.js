 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Is{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){re(e.idToken,"internal-error"),re(typeof e.idToken<"u","internal-error"),re(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):nh(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){re(e.length!==0,"internal-error");const t=nh(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(re(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:s,expiresIn:i}=await Bw(e,t);this.updateTokensAndExpiration(r,s,Number(i))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:s,expirationTime:i}=t,o=new Is;return r&&(re(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),s&&(re(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),i&&(re(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Is,this.toJSON())}_performRefresh(){return ln("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ho(n,e,t){return`firebase:${n}:${e}:${t}`}class Ts{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=Ho(this.userKey,s.apiKey,i),this.fullPersistenceKey=Ho("persistence",s.apiKey,i),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?un._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new Ts(dn(sh),e,r);const s=(await Promise.all(t.map(async u=>{if(await u._isAvailable())return u}))).filter(u=>u);let i=s[0]||dn(sh);const o=Ho(r,e.config.apiKey,e.name);let c=null;for(const u of t)try{const h=await u._get(o);if(h){const p=un._fromJSON(e,h);u!==i&&(c=p),i=u;break}}catch{}const l=s.filter(u=>u._shouldAllowMigration);return!i._shouldAllowMigration||!l.length?new Ts(i,e,r):(i=l[0],c&&await i._set(o,c.toJSON()),await Promise.all(t.map(async u=>{if(u!==i)try{await u._remove(o)}catch{}})),new Ts(i,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Es(n,e){return ao(n,"POST","/v1/accounts:signInWithIdp",_n(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Us{constructor(){this.providerId=Us.PROVIDER_ID}static credential(e,t){return Gi._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Wl.parseLink(t);return re(r,"argument-error"),Gi._fromEmailAndCode(e,r.code,r.tenantId)}}Us.PROVIDER_ID="password";Us.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Us.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Rr,zm;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(b,_){function T(){}T.prototype=_.prototype,b.D=_.prototype,b.prototype=new T,b.prototype.constructor=b,b.C=function(S,E,R){for(var I=Array(arguments.length-2),Se=2;Se<arguments.length;Se++)I[Se-2]=arguments[Se];return _.prototype[E].apply(S,I)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(b,_,T){T||(T=0);var S=Array(16);if(typeof _=="string")for(var E=0;16>E;++E)S[E]=_.charCodeAt(T++)|_.charCodeAt(T++)<<8|_.charCodeAt(T++)<<16|_.charCodeAt(T++)<<24;else for(E=0;16>E;++E)S[E]=_[T++]|_[T++]<<8|_[T++]<<16|_[T++]<<24;_=b.g[0],T=b.g[1],E=b.g[2];var R=b.g[3],I=_+(R^T&(E^R))+S[0]+3614090360&4294967295;_=T+(I<<7&4294967295|I>>>25),I=R+(E^_&(T^E))+S[1]+3905402710&4294967295,R=_+(I<<12&4294967295|I>>>20),I=E+(T^R&(_^T))+S[2]+606105819&4294967295,E=R+(I<<17&4294967295|I>>>15),I=T+(_^E&(R^_))+S[3]+3250441966&4294967295,T=E+(I<<22&4294967295|I>>>10),I=_+(R^T&(E^R))+S[4]+4118548399&4294967295,_=T+(I<<7&4294967295|I>>>25),I=R+(E^_&(T^E))+S[5]+1200080426&4294967295,R=_+(I<<12&4294967295|I>>>20),I=E+(T^R&(_^T))+S[6]+2821735955&4294967295,E=R+(I<<17&4294967295|I>>>15),I=T+(_^E&(R^_))+S[7]+4249261313&4294967295,T=E+(I<<22&4294967295|I>>>10),I=_+(R^T&(E^R))+S[8]+1770035416&4294967295,_=T+(I<<7&4294967295|I>>>25),I=R+(E^_&(T^E))+S[9]+2336552879&4294967295,R=_+(I<<12&4294967295|I>>>20),I=E+(T^R&(_^T))+S[10]+4294925233&4294967295,E=R+(I<<17&4294967295|I>>>15),I=T+(_^E&(R^_))+S[11]+2304563134&4294967295,T=E+(I<<22&4294967295|I>>>10),I=_+(R^T&(E^R))+S[12]+1804603682&4294967295,_=T+(I<<7&4294967295|I>>>25),I=R+(E^_&(T^E))+S[13]+4254626195&4294967295,R=_+(I<<12&4294967295|I>>>20),I=E+(T^R&(_^T))+S[14]+2792965006&4294967295,E=R+(I<<17&4294967295|I>>>15),I=T+(_^E&(R^_))+S[15]+1236535329&4294967295,T=E+(I<<22&4294967295|I>>>10),I=_+(E^R&(T^E))+S[1]+4129170786&4294967295,_=T+(I<<5&4294967295|I>>>27),I=R+(T^E&(_^T))+S[6]+3225465664&4294967295,R=_+(I<<9&4294967295|I>>>23),I=E+(_^T&(R^_))+S[11]+643717713&4294967295,E=R+(I<<14&4294967295|I>>>18),I=T+(R^_&(E^R))+S[0]+3921069994&4294967295,T=E+(I<<20&4294967295|I>>>12),I=_+(E^R&(T^E))+S[5]+3593408605&4294967295,_=T+(I<<5&4294967295|I>>>27),I=R+(T^E&(_^T))+S[10]+38016083&4294967295,R=_+(I<<9&4294967295|I>>>23),I=E+(_^T&(R^_))+S[15]+3634488961&4294967295,E=R+(I<<14&4294967295|I>>>18),I=T+(R^_&(E^R))+S[4]+3889429448&4294967295,T=E+(I<<20&4294967295|I>>>12),I=_+(E^R&(T^E))+S[9]+568446438&4294967295,_=T+(I<<5&4294967295|I>>>27),I=R+(T^E&(_^T))+S[14]+3275163606&4294967295,R=_+(I<<9&4294967295|I>>>23),I=E+(_^T&(R^_))+S[3]+4107603335&4294967295,E=R+(I<<14&4294967295|I>>>18),I=T+(R^_&(E^R))+S[8]+1163531501&4294967295,T=E+(I<<20&4294967295|I>>>12),I=_+(E^R&(T^E))+S[13]+2850285829&4294967295,_=T+(I<<5&4294967295|I>>>27),I=R+(T^E&(_^T))+S[2]+4243563512&4294967295,R=_+(I<<9&4294967295|I>>>23),I=E+(_^T&(R^_))+S[7]+1735328473&4294967295,E=R+(I<<14&4294967295|I>>>18),I=T+(R^_&(E^R))+S[12]+2368359562&4294967295,T=E+(I<<20&4294967295|I>>>12),I=_+(T^E^R)+S[5]+4294588738&4294967295,_=T+(I<<4&4294967295|I>>>28),I=R+(_^T^E)+S[8]+2272392833&4294967295,R=_+(I<<11&4294967295|I>>>21),I=E+(R^_^T)+S[11]+1839030562&4294967295,E=R+(I<<16&4294967295|I>>>16),I=T+(E^R^_)+S[14]+4259657740&4294967295,T=E+(I<<23&4294967295|I>>>9),I=_+(T^E^R)+S[1]+2763975236&4294967295,_=T+(I<<4&4294967295|I>>>28),I=R+(_^T^E)+S[4]+1272893353&4294967295,R=_+(I<<11&4294967295|I>>>21),I=E+(R^_^T)+S[7]+4139469664&4294967295,E=R+(I<<16&4294967295|I>>>16),I=T+(E^R^_)+S[10]+3200236656&4294967295,T=E+(I<<23&4294967295|I>>>9),I=_+(T^E^R)+S[13]+681279174&4294967295,_=T+(I<<4&4294967295|I>>>28),I=R+(_^T^E)+S[0]+3936430074&4294967295,R=_+(I<<11&4294967295|I>>>21),I=E+(R^_^T)+S[3]+3572445317&4294967295,E=R+(I<<16&4294967295|I>>>16),I=T+(E^R^_)+S[6]+76029189&4294967295,T=E+(I<<23&4294967295|I>>>9),I=_+(T^E^R)+S[9]+3654602809&4294967295,_=T+(I<<4&4294967295|I>>>28),I=R+(_^T^E)+S[12]+3873151461&4294967295,R=_+(I<<11&4294967295|I>>>21),I=E+(R^_^T)+S[15]+530742520&4294967295,E=R+(I<<16&4294967295|I>>>16),I=T+(E^R^_)+S[2]+3299628645&4294967295,T=E+(I<<23&4294967295|I>>>9),I=_+(E^(T|~R))+S[0]+4096336452&4294967295,_=T+(I<<6&4294967295|I>>>26),I=R+(T^(_|~E))+S[7]+1126891415&4294967295,R=_+(I<<10&4294967295|I>>>22),I=E+(_^(R|~T))+S[14]+2878612391&4294967295,E=R+(I<<15&4294967295|I>>>17),I=T+(R^(E|~_))+S[5]+4237533241&4294967295,T=E+(I<<21&4294967295|I>>>11),I=_+(E^(T|~R))+S[12]+1700485571&4294967295,_=T+(I<<6&4294967295|I>>>26),I=R+(T^(_|~E))+S[3]+2399980690&4294967295,R=_+(I<<10&4294967295|I>>>22),I=E+(_^(R|~T))+S[10]+4293915773&4294967295,E=R+(I<<15&4294967295|I>>>17),I=T+(R^(E|~_))+S[1]+2240044497&4294967295,T=E+(I<<21&4294967295|I>>>11),I=_+(E^(T|~R))+S[8]+1873313359&4294967295,_=T+(I<<6&4294967295|I>>>26),I=R+(T^(_|~E))+S[15]+4264355552&4294967295,R=_+(I<<10&4294967295|I>>>22),I=E+(_^(R|~T))+S[6]+2734768916&4294967295,E=R+(I<<15&4294967295|I>>>17),I=T+(R^(E|~_))+S[13]+1309151649&4294967295,T=E+(I<<21&4294967295|I>>>11),I=_+(E^(T|~R))+S[4]+4149444226&4294967295,_=T+(I<<6&4294967295|I>>>26),I=R+(T^(_|~E))+S[11]+3174756917&4294967295,R=_+(I<<10&4294967295|I>>>22),I=E+(_^(R|~T))+S[2]+718787259&4294967295,E=R+(I<<15&4294967295|I>>>17),I=T+(R^(E|~_))+S[9]+3951481745&4294967295,b.g[0]=b.g[0]+_&4294967295,b.g[1]=b.g[1]+(E+(I<<21&4294967295|I>>>11))&4294967295,b.g[2]=b.g[2]+E&4294967295,b.g[3]=b.g[3]+R&4294967295}r.prototype.u=function(b,_){_===void 0&&(_=b.length);for(var T=_-this.blockSize,S=this.B,E=this.h,R=0;R<_;){if(E==0)for(;R<=T;)s(this,b,R),R+=this.blockSize;if(typeof b=="string"){for(;R<_;)if(S[E++]=b.charCodeAt(R++),E==this.blockSize){s(this,S),E=0;break}}else for(;R<_;)if(S[E++]=b[R++],E==this.blockSize){s(this,S),E=0;break}}this.h=E,this.o+=_},r.prototype.v=function(){var b=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);b[0]=128;for(var _=1;_<b.length-8;++_)b[_]=0;var T=8*this.o;for(_=b.length-8;_<b.length;++_)b[_]=T&255,T/=256;for(this.u(b),b=Array(16),_=T=0;4>_;++_)for(var S=0;32>S;S+=8)b[T++]=this.g[_]>>>S&255;return b};function i(b,_){var T=c;return Object.prototype.hasOwnProperty.call(T,b)?T[b]:T[b]=_(b)}function o(b,_){this.h=_;for(var T=[],S=!0,E=b.length-1;0<=E;E--){var R=b[E]|0;S&&R==_||(T[E]=R,S=!1)}this.g=T}var c={};function l(b){return-128<=b&&128>b?i(b,function(_){return new o([_|0],0>_?-1:0)}):new o([b|0],0>b?-1:0)}function u(b){if(isNaN(b)||!isFinite(b))return p;if(0>b)return D(u(-b));for(var _=[],T=1,S=0;b>=T;S++)_[S]=b/T|0,T*=4294967296;return new o(_,0)}function h(b,_){if(b.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(b.charAt(0)=="-")return D(h(b.substring(1),_));if(0<=b.indexOf("-"))throw Error('number format error: interior "-" character');for(var T=u(Math.pow(_,8)),S=p,E=0;E<b.length;E+=8){var R=Math.min(8,b.length-E),I=parseInt(b.substring(E,E+R),_);8>R?(R=u(Math.pow(_,R)),S=S.j(R).add(u(I))):(S=S.j(T),S=S.add(u(I)))}return S}var p=l(0),g=l(1),w=l(16777216);n=o.prototype,n.m=function(){if(P(this))return-D(this).m();for(var b=0,_=1,T=0;T<this.g.length;T++){var S=this.i(T);b+=(0<=S?S:4294967296+S)*_,_*=4294967296}return b},n.toString=function(b){if(b=b||10,2>b||36<b)throw Error("radix out of range: "+b);if(A(this))return"0";if(P(this))return"-"+D(this).toString(b);for(var _=u(Math.pow(b,6)),T=this,S="";;){var E=q(T,_).g;T=N(T,E.j(_));var R=((0<T.g.length?T.g[0]:T.h)>>>0).toString(b);if(T=E,A(T))return R+S;for(;6>R.length;)R="0"+R;S=R+S}},n.i=function(b){return 0>b?0:b<this.g.length?this.g[b]:this.h};function A(b){if(b.h!=0)return!1;for(var _=0;_<b.g.length;_++)if(b.g[_]!=0)return!1;return!0}function P(b){return b.h==-1}n.l=function(b){return b=N(this,b),P(b)?-1:A(b)?0:1};function D(b){for(var _=b.g.length,T=[],S=0;S<_;S++)T[S]=~b.g[S];return new o(T,~b.h).add(g)}n.abs=function(){return P(this)?D(this):this},n.add=function(b){for(var _=Math.max(this.g.length,b.g.length),T=[],S=0,E=0;E<=_;E++){var R=S+(this.i(E)&65535)+(b.i(E)&65535),I=(R>>>16)+(this.i(E)>>>16)+(b.i(E)>>>16);S=I>>>16,R&=65535,I&=65535,T[E]=I<<16|R}return new o(T,T[T.length-1]&-2147483648?-1:0)};function N(b,_){return b.add(D(_))}n.j=function(b){if(A(this)||A(b))return p;if(P(this))return P(b)?D(this).j(D(b)):D(D(this).j(b));if(P(b))return D(this.j(D(b)));if(0>this.l(w)&&0>b.l(w))return u(this.m()*b.m());for(var _=this.g.length+b.g.length,T=[],S=0;S<2*_;S++)T[S]=0;for(S=0;S<this.g.length;S++)for(var E=0;E<b.g.length;E++){var R=this.i(S)>>>16,I=this.i(S)&65535,Se=b.i(E)>>>16,We=b.i(E)&65535;T[2*S+2*E]+=I*We,V(T,2*S+2*E),T[2*S+2*E+1]+=R*We,V(T,2*S+2*E+1),T[2*S+2*E+1]+=I*Se,V(T,2*S+2*E+1),T[2*S+2*E+2]+=R*Se,V(T,2*S+2*E+2)}for(S=0;S<_;S++)T[S]=T[2*S+1]<<16|T[2*S];for(S=_;S<2*_;S++)T[S]=0;return new o(T,0)};function V(b,_){for(;(b[_]&65535)!=b[_];)b[_+1]+=b[_]>>>16,b[_]&=65535,_++}function F(b,_){this.g=b,this.h=_}function q(b,_){if(A(_))throw Error("division by zero");if(A(b))return new F(p,p);if(P(b))return _=q(D(b),_),new F(D(_.g),D(_.h));if(P(_))return _=q(b,D(_)),new F(D(_.g),_.h);if(30<b.g.length){if(P(b)||P(_))throw Error("slowDivide_ only works with positive integers.");for(var T=g,S=_;0>=S.l(b);)T=te(T),S=te(S);var E=Z(T,1),R=Z(S,1);for(S=Z(S,2),T=Z(T,2);!A(S);){var I=R.add(S);0>=I.l(b)&&(E=E.add(T),R=I),S=Z(S,1),T=Z(T,1)}return _=N(b,E.j(_)),new F(E,_)}for(E=p;0<=b.l(_);){for(T=Math.max(1,Math.floor(b.m()/_.m())),S=Math.ceil(Math.log(T)/Math.LN2),S=48>=S?1:Math.pow(2,S-48),R=u(T),I=R.j(_);P(I)||0<I.l(b);)T-=S,R=u(T),I=R.j(_);A(R)&&(R=g),E=E.add(R),b=N(b,I)}return new F(E,b)}n.A=function(b){return q(this,b).h},n.and=function(b){for(var _=Math.max(this.g.length,b.g.length),T=[],S=0;S<_;S++)T[S]=this.i(S)&b.i(S);return new o(T,this.h&b.h)},n.or=function(b){for(var _=Math.max(this.g.length,b.g.length),T=[],S=0;S<_;S++)T[S]=this.i(S)|b.i(S);return new o(T,this.h|b.h)},n.xor=function(b){for(var _=Math.max(this.g.length,b.g.length),T=[],S=0;S<_;S++)T[S]=this.i(S)^b.i(S);return new o(T,this.h^b.h)};function te(b){for(var _=b.g.length+1,T=[],S=0;S<_;S++)T[S]=b.i(S)<<1|b.i(S-1)>>>31;return new o(T,b.h)}function Z(b,_){var T=_>>5;_%=32;for(var S=b.g.length-T,E=[],R=0;R<S;R++)E[R]=0<_?b.i(R+T)>>>_|b.i(R+T+1)<<32-_:b.i(R+T);return new o(E,b.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,zm=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=u,o.fromString=h,Rr=o}).apply(typeof _h<"u"?_h:typeof self<"u"?self:typeof window<"u"?window:{});var Bo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Hm,bi,Wm,Yo,ll,Qm,Ym,Jm;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,d,f){return a==Array.prototype||a==Object.prototype||(a[d]=f.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Bo=="object"&&Bo];for(var d=0;d<a.length;++d){var f=a[d];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=t(this);function s(a,d){if(d)e:{var f=r;a=a.split(".");for(var v=0;v<a.length-1;v++){var C=a[v];if(!(C in f))break e;f=f[C]}a=a[a.length-1],v=f[a],d=d(v),d!=v&&d!=null&&e(f,a,{configurable:!0,writable:!0,value:d})}}function i(a,d){a instanceof String&&(a+="");var f=0,v=!1,C={next:function(){if(!v&&f<a.length){var x=f++;return{value:d(x,a[x]),done:!1}}return v=!0,{done:!0,value:void 0}}};return C[Symbol.iterator]=function(){return C},C}s("Array.prototype.values",function(a){return a||function(){return i(this,function(d,f){return f})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(a){var d=typeof a;return d=d!="object"?d:a?Array.isArray(a)?"array":d:"null",d=="array"||d=="object"&&typeof a.length=="number"}function u(a){var d=typeof a;return d=="object"&&a!=null||d=="function"}function h(a,d,f){return a.call.apply(a.bind,arguments)}function p(a,d,f){if(!a)throw Error();if(2<arguments.length){var v=Array.prototype.slice.call(arguments,2);return function(){var C=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(C,v),a.apply(d,C)}}return function(){return a.apply(d,arguments)}}function g(a,d,f){return g=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:p,g.apply(null,arguments)}function w(a,d){var f=Array.prototype.slice.call(arguments,1);return function(){var v=f.slice();return v.push.apply(v,arguments),a.apply(this,v)}}function A(a,d){function f(){}f.prototype=d.prototype,a.aa=d.prototype,a.prototype=new f,a.prototype.constructor=a,a.Qb=function(v,C,x){for(var $=Array(arguments.length-2),ye=2;ye<arguments.length;ye++)$[ye-2]=arguments[ye];return d.prototype[C].apply(v,$)}}function P(a){const d=a.length;if(0<d){const f=Array(d);for(let v=0;v<d;v++)f[v]=a[v];return f}return[]}function D(a,d){for(let f=1;f<arguments.length;f++){const v=arguments[f];if(l(v)){const C=a.length||0,x=v.length||0;a.length=C+x;for(let $=0;$<x;$++)a[C+$]=v[$]}else a.push(v)}}class N{constructor(d,f){this.i=d,this.j=f,this.h=0,this.g=null}get(){let d;return 0<this.h?(this.h--,d=this.g,this.g=d.next,d.next=null):d=this.i(),d}}function V(a){return/^[\s\xa0]*$/.test(a)}function F(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function q(a){return q[" "](a),a}q[" "]=function(){};var te=F().indexOf("Gecko")!=-1&&!(F().toLowerCase().indexOf("webkit")!=-1&&F().indexOf("Edge")==-1)&&!(F().indexOf("Trident")!=-1||F().indexOf("MSIE")!=-1)&&F().indexOf("Edge")==-1;function Z(a,d,f){for(const v in a)d.call(f,a[v],v,a)}function b(a,d){for(const f in a)d.call(void 0,a[f],f,a)}function _(a){const d={};for(const f in a)d[f]=a[f];return d}const T="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function S(a,d){let f,v;for(let C=1;C<arguments.length;C++){v=arguments[C];for(f in v)a[f]=v[f];for(let x=0;x<T.length;x++)f=T[x],Object.prototype.hasOwnProperty.call(v,f)&&(a[f]=v[f])}}function E(a){var d=1;a=a.split(":");const f=[];for(;0<d&&a.length;)f.push(a.shift()),d--;return a.length&&f.push(a.join(":")),f}function R(a){c.setTimeout(()=>{throw a},0)}function I(){var a=Ye;let d=null;return a.g&&(d=a.g,a.g=a.g.next,a.g||(a.h=null),d.next=null),d}class Se{constructor(){this.h=this.g=null}add(d,f){const v=We.get();v.set(d,f),this.h?this.h.next=v:this.g=v,this.h=v}}var We=new N(()=>new cr,a=>a.reset());class cr{constructor(){this.next=this.g=this.h=null}set(d,f){this.h=d,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let Qe,bt=!1,Ye=new Se,To=()=>{const a=c.Promise.resolve(void 0);Qe=()=>{a.then(wc)}};var wc=()=>{for(var a;a=I();){try{a.h.call(a.g)}catch(f){R(f)}var d=We;d.j(a),100>d.h&&(d.h++,a.next=d.g,d.g=a)}bt=!1};function Gt(){this.s=this.s,this.C=this.C}Gt.prototype.s=!1,Gt.prototype.ma=function(){this.s||(this.s=!0,this.N())},Gt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Ue(a,d){this.type=a,this.g=this.target=d,this.defaultPrevented=!1}Ue.prototype.h=function(){this.defaultPrevented=!0};var Js=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,d=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};c.addEventListener("test",f,d),c.removeEventListener("test",f,d)}catch{}return a}();function Tn(a,d){if(Ue.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var f=this.type=a.type,v=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=d,d=a.relatedTarget){if(te){e:{try{q(d.nodeName);var C=!0;break e}catch{}C=!1}C||(d=null)}}else f=="mouseover"?d=a.fromElement:f=="mouseout"&&(d=a.toElement);this.relatedTarget=d,v?(this.clientX=v.clientX!==void 0?v.clientX:v.pageX,this.clientY=v.clientY!==void 0?v.clientY:v.pageY,this.screenX=v.screenX||0,this.screenY=v.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:En[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Tn.aa.h.call(this)}}A(Tn,Ue);var En={2:"touch",3:"pen",4:"mouse"};Tn.prototype.h=function(){Tn.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Kt="closure_listenable_"+(1e6*Math.random()|0),Xs=0;function lr(a,d,f,v,C){this.listener=a,this.proxy=null,this.src=d,this.type=f,this.capture=!!v,this.ha=C,this.key=++Xs,this.da=this.fa=!1}function bn(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function zt(a){this.src=a,this.g={},this.h=0}zt.prototype.add=function(a,d,f,v,C){var x=a.toString();a=this.g[x],a||(a=this.g[x]=[],this.h++);var $=An(a,d,v,C);return-1<$?(d=a[$],f||(d.fa=!1)):(d=new lr(d,this.src,x,!!v,C),d.fa=f,a.push(d)),d};function es(a,d){var f=d.type;if(f in a.g){var v=a.g[f],C=Array.prototype.indexOf.call(v,d,void 0),x;(x=0<=C)&&Array.prototype.splice.call(v,C,1),x&&(bn(d),a.g[f].length==0&&(delete a.g[f],a.h--))}}function An(a,d,f,v){for(var C=0;C<a.length;++C){var x=a[C];if(!x.da&&x.listener==d&&x.capture==!!f&&x.ha==v)return C}return-1}var Sn="closure_lm_"+(1e6*Math.random()|0),ur={};function ts(a,d,f,v,C){if(Array.isArray(d)){for(var x=0;x<d.length;x++)ts(a,d[x],f,v,C);return null}return f=rs(f),a&&a[Kt]?a.K(d,f,u(v)?!!v.capture:!1,C):Ic(a,d,f,!1,v,C)}function Ic(a,d,f,v,C,x){if(!d)throw Error("Invalid event type");var $=u(C)?!!C.capture:!!C,ye=_e(a);if(ye||(a[Sn]=ye=new zt(a)),f=ye.add(d,f,v,$,x),f.proxy)return f;if(v=At(),f.proxy=v,v.src=a,v.listener=f,a.addEventListener)Js||(C=$),C===void 0&&(C=!1),a.addEventListener(d.toString(),v,C);else if(a.attachEvent)a.attachEvent(dr(d.toString()),v);else if(a.addListener&&a.removeListener)a.addListener(v);else throw Error("addEventListener and attachEvent are unavailable.");return f}function At(){function a(f){return d.call(a.src,a.listener,f)}const d=ns;return a}function Zs(a,d,f,v,C){if(Array.isArray(d))for(var x=0;x<d.length;x++)Zs(a,d[x],f,v,C);else v=u(v)?!!v.capture:!!v,f=rs(f),a&&a[Kt]?(a=a.i,d=String(d).toString(),d in a.g&&(x=a.g[d],f=An(x,f,v,C),-1<f&&(bn(x[f]),Array.prototype.splice.call(x,f,1),x.length==0&&(delete a.g[d],a.h--)))):a&&(a=_e(a))&&(d=a.g[d.toString()],a=-1,d&&(a=An(d,f,v,C)),(f=-1<a?d[a]:null)&&Rn(f))}function Rn(a){if(typeof a!="number"&&a&&!a.da){var d=a.src;if(d&&d[Kt])es(d.i,a);else{var f=a.type,v=a.proxy;d.removeEventListener?d.removeEventListener(f,v,a.capture):d.detachEvent?d.detachEvent(dr(f),v):d.addListener&&d.removeListener&&d.removeListener(v),(f=_e(d))?(es(f,a),f.h==0&&(f.src=null,d[Sn]=null)):bn(a)}}}function dr(a){return a in ur?ur[a]:ur[a]="on"+a}function ns(a,d){if(a.da)a=!0;else{d=new Tn(d,this);var f=a.listener,v=a.ha||a.src;a.fa&&Rn(a),a=f.call(v,d)}return a}function _e(a){return a=a[Sn],a instanceof zt?a:null}var ei="__closure_events_fn_"+(1e9*Math.random()>>>0);function rs(a){return typeof a=="function"?a:(a[ei]||(a[ei]=function(d){return a.handleEvent(d)}),a[ei])}function we(){Gt.call(this),this.i=new zt(this),this.M=this,this.F=null}A(we,Gt),we.prototype[Kt]=!0,we.prototype.removeEventListener=function(a,d,f,v){Zs(this,a,d,f,v)};function Re(a,d){var f,v=a.F;if(v)for(f=[];v;v=v.F)f.push(v);if(a=a.M,v=d.type||d,typeof d=="string")d=new Ue(d,a);else if(d instanceof Ue)d.target=d.target||a;else{var C=d;d=new Ue(v,a),S(d,C)}if(C=!0,f)for(var x=f.length-1;0<=x;x--){var $=d.g=f[x];C=hr($,v,!0,d)&&C}if($=d.g=a,C=hr($,v,!0,d)&&C,C=hr($,v,!1,d)&&C,f)for(x=0;x<f.length;x++)$=d.g=f[x],C=hr($,v,!1,d)&&C}we.prototype.N=function(){if(we.aa.N.call(this),this.i){var a=this.i,d;for(d in a.g){for(var f=a.g[d],v=0;v<f.length;v++)bn(f[v]);delete a.g[d],a.h--}}this.F=null},we.prototype.K=function(a,d,f,v){return this.i.add(String(a),d,!1,f,v)},we.prototype.L=function(a,d,f,v){return this.i.add(String(a),d,!0,f,v)};function hr(a,d,f,v){if(d=a.i.g[String(d)],!d)return!0;d=d.concat();for(var C=!0,x=0;x<d.length;++x){var $=d[x];if($&&!$.da&&$.capture==f){var ye=$.listener,tt=$.ha||$.src;$.fa&&es(a.i,$),C=ye.call(tt,v)!==!1&&C}}return C&&!v.defaultPrevented}function ti(a,d,f){if(typeof a=="function")f&&(a=g(a,f));else if(a&&typeof a.handleEvent=="function")a=g(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(d)?-1:c.setTimeout(a,d||0)}function ni(a){a.g=ti(()=>{a.g=null,a.i&&(a.i=!1,ni(a))},a.l);const d=a.h;a.h=null,a.m.apply(null,d)}class Eo extends Gt{constructor(d,f){super(),this.m=d,this.l=f,this.h=null,this.i=!1,this.g=null}j(d){this.h=arguments,this.g?this.i=!0:ni(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Pn(a){Gt.call(this),this.h=a,this.g={}}A(Pn,Gt);var ri=[];function si(a){Z(a.g,function(d,f){this.g.hasOwnProperty(f)&&Rn(d)},a),a.g={}}Pn.prototype.N=function(){Pn.aa.N.call(this),si(this)},Pn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ss=c.JSON.stringify,bo=c.JSON.parse,Ao=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function is(){}is.prototype.h=null;function ii(a){return a.h||(a.h=a.i())}function oi(){}var Cn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function os(){Ue.call(this,"d")}A(os,Ue);function as(){Ue.call(this,"c")}A(as,Ue);var O={},B=null;function H(){return B=B||new we}O.La="serverreachability";function Q(a){Ue.call(this,O.La,a)}A(Q,Ue);function J(a){const d=H();Re(d,new Q(d))}O.STAT_EVENT="statevent";function ie(a,d){Ue.call(this,O.STAT_EVENT,a),this.stat=d}A(ie,Ue);function ae(a){const d=H();Re(d,new ie(d,a))}O.Ma="timingevent";function me(a,d){Ue.call(this,O.Ma,a),this.size=d}A(me,Ue);function Te(a,d){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},d)}function oe(){this.g=!0}oe.prototype.xa=function(){this.g=!1};function Pe(a,d,f,v,C,x){a.info(function(){if(a.g)if(x)for(var $="",ye=x.split("&"),tt=0;tt<ye.length;tt++){var he=ye[tt].split("=");if(1<he.length){var it=he[0];he=he[1];var ot=it.split("_");$=2<=ot.length&&ot[1]=="type"?$+(it+"="+he+"&"):$+(it+"=redacted&")}}else $=null;else $=x;return"XMLHTTP REQ ("+v+") [attempt "+C+"]: "+d+`
`+f+`
`+$})}function Ht(a,d,f,v,C,x,$){a.info(function(){return"XMLHTTP RESP ("+v+") [ attempt "+C+"]: "+d+`
`+f+`
`+x+" "+$})}function Ce(a,d,f,v){a.info(function(){return"XMLHTTP TEXT ("+d+"): "+_t(a,f)+(v?" "+v:"")})}function Be(a,d){a.info(function(){return"TIMEOUT: "+d})}oe.prototype.info=function(){};function _t(a,d){if(!a.g)return d;if(!d)return null;try{var f=JSON.parse(d);if(f){for(a=0;a<f.length;a++)if(Array.isArray(f[a])){var v=f[a];if(!(2>v.length)){var C=v[1];if(Array.isArray(C)&&!(1>C.length)){var x=C[0];if(x!="noop"&&x!="stop"&&x!="close")for(var $=1;$<C.length;$++)C[$]=""}}}}return ss(f)}catch{return d}}var Nt={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ne={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},st;function Ot(){}A(Ot,is),Ot.prototype.g=function(){return new XMLHttpRequest},Ot.prototype.i=function(){return{}},st=new Ot;function Je(a,d,f,v){this.j=a,this.i=d,this.l=f,this.R=v||1,this.U=new Pn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new fr}function fr(){this.i=null,this.g="",this.h=!1}var ft={},et={};function kn(a,d,f){a.L=1,a.v=Po(on(d)),a.m=f,a.P=!0,Dn(a,null)}function Dn(a,d){a.F=Date.now(),xe(a),a.A=on(a.v);var f=a.A,v=a.R;Array.isArray(v)||(v=[String(v)]),Td(f.i,"t",v),a.C=0,f=a.j.J,a.h=new fr,a.g=$d(a.j,f?d:null,!a.m),0<a.O&&(a.M=new Eo(g(a.Y,a,a.g),a.O)),d=a.U,f=a.g,v=a.ca;var C="readystatechange";Array.isArray(C)||(C&&(ri[0]=C.toString()),C=ri);for(var x=0;x<C.length;x++){var $=ts(f,C[x],v||d.handleEvent,!1,d.h||d);if(!$)break;d.g[$.key]=$}d=a.H?_(a.H):{},a.m?(a.u||(a.u="POST"),d["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,d)):(a.u="GET",a.g.ea(a.A,a.u,null,d)),J(),Pe(a.i,a.u,a.A,a.l,a.R,a.m)}Je.prototype.ca=function(a){a=a.target;const d=this.M;d&&an(a)==3?d.j():this.Y(a)},Je.prototype.Y=function(a){try{if(a==this.g)e:{const ot=an(this.g);var d=this.g.Ba();const us=this.g.Z();if(!(3>ot)&&(ot!=3||this.g&&(this.h.h||this.g.oa()||Cd(this.g)))){this.J||ot!=4||d==7||(d==8||0>=us?J(3):J(2)),Ec(this);var f=this.g.Z();this.X=f;t:if(mr(this)){var v=Cd(this.g);a="";var C=v.length,x=an(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){pr(this),ai(this);var $="";break t}this.h.i=new c.TextDecoder}for(d=0;d<C;d++)this.h.h=!0,a+=this.h.i.decode(v[d],{stream:!(x&&d==C-1)});v.length=0,this.h.g+=a,this.C=0,$=this.h.g}else $=this.g.oa();if(this.o=f==200,Ht(this.i,this.u,this.A,this.l,this.R,ot,f),this.o){if(this.T&&!this.K){t:{if(this.g){var ye,tt=this.g;if((ye=tt.g?tt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!V(ye)){var he=ye;break t}}he=null}if(f=he)Ce(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,bc(this,f);else{this.o=!1,this.s=3,ae(12),pr(this),ai(this);break e}}if(this.P){f=!0;let Mt;for(;!this.J&&this.C<$.length;)if(Mt=Tc(this,$),Mt==et){ot==4&&(this.s=4,ae(14),f=!1),Ce(this.i,this.l,null,"[Incomplete Response]");break}else if(Mt==ft){this.s=4,ae(15),Ce(this.i,this.l,$,"[Invalid Chunk]"),f=!1;break}else Ce(this.i,this.l,Mt,null),bc(this,Mt);if(mr(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ot!=4||$.length!=0||this.h.h||(this.s=1,ae(16),f=!1),this.o=this.o&&f,!f)Ce(this.i,this.l,$,"[Invalid Chunked Response]"),pr(this),ai(this);else if(0<$.length&&!this.W){this.W=!0;var it=this.j;it.g==this&&it.ba&&!it.M&&(it.j.info("Great, no buffering proxy detected. Bytes received: "+$.length),kc(it),it.M=!0,ae(11))}}else Ce(this.i,this.l,$,null),bc(this,$);ot==4&&pr(this),this.o&&!this.J&&(ot==4?Od(this.j,this):(this.o=!1,xe(this)))}else Uv(this.g),f==400&&0<$.indexOf("Unknown SID")?(this.s=3,ae(12)):(this.s=0,ae(13)),pr(this),ai(this)}}}catch{}finally{}};function mr(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function Tc(a,d){var f=a.C,v=d.indexOf(`
`,f);return v==-1?et:(f=Number(d.substring(f,v)),isNaN(f)?ft:(v+=1,v+f>d.length?et:(d=d.slice(v,v+f),a.C=v+f,d)))}Je.prototype.cancel=function(){this.J=!0,pr(this)};function xe(a){a.S=Date.now()+a.I,Nn(a,a.I)}function Nn(a,d){if(a.B!=null)throw Error("WatchDog timer not null");a.B=Te(g(a.ba,a),d)}function Ec(a){a.B&&(c.clearTimeout(a.B),a.B=null)}Je.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Be(this.i,this.A),this.L!=2&&(J(),ae(17)),pr(this),this.s=2,ai(this)):Nn(this,this.S-a)};function ai(a){a.j.G==0||a.J||Od(a.j,a)}function pr(a){Ec(a);var d=a.M;d&&typeof d.ma=="function"&&d.ma(),a.M=null,si(a.U),a.g&&(d=a.g,a.g=null,d.abort(),d.ma())}function bc(a,d){try{var f=a.j;if(f.G!=0&&(f.g==a||Ac(f.h,a))){if(!a.K&&Ac(f.h,a)&&f.G==3){try{var v=f.Da.g.parse(d)}catch{v=null}if(Array.isArray(v)&&v.length==3){var C=v;if(C[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<a.F)Lo(f),No(f);else break e;Cc(f),ae(18)}}else f.za=C[1],0<f.za-f.T&&37500>C[2]&&f.F&&f.v==0&&!f.C&&(f.C=Te(g(f.Za,f),6e3));if(1>=fd(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else yr(f,11)}else if((a.K||f.g==a)&&Lo(f),!V(d))for(C=f.Da.g.parse(d),d=0;d<C.length;d++){let he=C[d];if(f.T=he[0],he=he[1],f.G==2)if(he[0]=="c"){f.K=he[1],f.ia=he[2];const it=he[3];it!=null&&(f.la=it,f.j.info("VER="+f.la));const ot=he[4];ot!=null&&(f.Aa=ot,f.j.info("SVER="+f.Aa));const us=he[5];us!=null&&typeof us=="number"&&0<us&&(v=1.5*us,f.L=v,f.j.info("backChannelRequestTimeoutMs_="+v)),v=f;const Mt=a.g;if(Mt){const Oo=Mt.g?Mt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Oo){var x=v.h;x.g||Oo.indexOf("spdy")==-1&&Oo.indexOf("quic")==-1&&Oo.indexOf("h2")==-1||(x.j=x.l,x.g=new Set,x.h&&(Sc(x,x.h),x.h=null))}if(v.D){const Dc=Mt.g?Mt.g.getResponseHeader("X-HTTP-Session-Id"):null;Dc&&(v.ya=Dc,Ee(v.I,v.D,Dc))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-a.F,f.j.info("Handshake RTT: "+f.R+"ms")),v=f;var $=a;if(v.qa=Fd(v,v.J?v.ia:null,v.W),$.K){md(v.h,$);var ye=$,tt=v.L;tt&&(ye.I=tt),ye.B&&(Ec(ye),xe(ye)),v.g=$}else Ld(v);0<f.i.length&&xo(f)}else he[0]!="stop"&&he[0]!="close"||yr(f,7);else f.G==3&&(he[0]=="stop"||he[0]=="close"?he[0]=="stop"?yr(f,7):Pc(f):he[0]!="noop"&&f.l&&f.l.ta(he),f.v=0)}}J(4)}catch{}}var Av=class{constructor(a,d){this.g=a,this.map=d}};function dd(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function hd(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function fd(a){return a.h?1:a.g?a.g.size:0}function Ac(a,d){return a.h?a.h==d:a.g?a.g.has(d):!1}function Sc(a,d){a.g?a.g.add(d):a.h=d}function md(a,d){a.h&&a.h==d?a.h=null:a.g&&a.g.has(d)&&a.g.delete(d)}dd.prototype.cancel=function(){if(this.i=pd(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function pd(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let d=a.i;for(const f of a.g.values())d=d.concat(f.D);return d}return P(a.i)}function Sv(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(l(a)){for(var d=[],f=a.length,v=0;v<f;v++)d.push(a[v]);return d}d=[],f=0;for(v in a)d[f++]=a[v];return d}function Rv(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(l(a)||typeof a=="string"){var d=[];a=a.length;for(var f=0;f<a;f++)d.push(f);return d}d=[],f=0;for(const v in a)d[f++]=v;return d}}}function gd(a,d){if(a.forEach&&typeof a.forEach=="function")a.forEach(d,void 0);else if(l(a)||typeof a=="string")Array.prototype.forEach.call(a,d,void 0);else for(var f=Rv(a),v=Sv(a),C=v.length,x=0;x<C;x++)d.call(void 0,v[x],f&&f[x],a)}var yd=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Pv(a,d){if(a){a=a.split("&");for(var f=0;f<a.length;f++){var v=a[f].indexOf("="),C=null;if(0<=v){var x=a[f].substring(0,v);C=a[f].substring(v+1)}else x=a[f];d(x,C?decodeURIComponent(C.replace(/\+/g," ")):"")}}}function gr(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof gr){this.h=a.h,So(this,a.j),this.o=a.o,this.g=a.g,Ro(this,a.s),this.l=a.l;var d=a.i,f=new ui;f.i=d.i,d.g&&(f.g=new Map(d.g),f.h=d.h),vd(this,f),this.m=a.m}else a&&(d=String(a).match(yd))?(this.h=!1,So(this,d[1]||"",!0),this.o=ci(d[2]||""),this.g=ci(d[3]||"",!0),Ro(this,d[4]),this.l=ci(d[5]||"",!0),vd(this,d[6]||"",!0),this.m=ci(d[7]||"")):(this.h=!1,this.i=new ui(null,this.h))}gr.prototype.toString=function(){var a=[],d=this.j;d&&a.push(li(d,_d,!0),":");var f=this.g;return(f||d=="file")&&(a.push("//"),(d=this.o)&&a.push(li(d,_d,!0),"@"),a.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&a.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&a.push("/"),a.push(li(f,f.charAt(0)=="/"?Dv:kv,!0))),(f=this.i.toString())&&a.push("?",f),(f=this.m)&&a.push("#",li(f,xv)),a.join("")};function on(a){return new gr(a)}function So(a,d,f){a.j=f?ci(d,!0):d,a.j&&(a.j=a.j.replace(/:$/,""))}function Ro(a,d){if(d){if(d=Number(d),isNaN(d)||0>d)throw Error("Bad port number "+d);a.s=d}else a.s=null}function vd(a,d,f){d instanceof ui?(a.i=d,Lv(a.i,a.h)):(f||(d=li(d,Nv)),a.i=new ui(d,a.h))}function Ee(a,d,f){a.i.set(d,f)}function Po(a){return Ee(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function ci(a,d){return a?d?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function li(a,d,f){return typeof a=="string"?(a=encodeURI(a).replace(d,Cv),f&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Cv(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var _d=/[#\/\?@]/g,kv=/[#\?:]/g,Dv=/[#\?]/g,Nv=/[#\?@]/g,xv=/#/g;function ui(a,d){this.h=this.g=null,this.i=a||null,this.j=!!d}function xn(a){a.g||(a.g=new Map,a.h=0,a.i&&Pv(a.i,function(d,f){a.add(decodeURIComponent(d.replace(/\+/g," ")),f)}))}n=ui.prototype,n.add=function(a,d){xn(this),this.i=null,a=cs(this,a);var f=this.g.get(a);return f||this.g.set(a,f=[]),f.push(d),this.h+=1,this};function wd(a,d){xn(a),d=cs(a,d),a.g.has(d)&&(a.i=null,a.h-=a.g.get(d).length,a.g.delete(d))}function Id(a,d){return xn(a),d=cs(a,d),a.g.has(d)}n.forEach=function(a,d){xn(this),this.g.forEach(function(f,v){f.forEach(function(C){a.call(d,C,v,this)},this)},this)},n.na=function(){xn(this);const a=Array.from(this.g.values()),d=Array.from(this.g.keys()),f=[];for(let v=0;v<d.length;v++){const C=a[v];for(let x=0;x<C.length;x++)f.push(d[v])}return f},n.V=function(a){xn(this);let d=[];if(typeof a=="string")Id(this,a)&&(d=d.concat(this.g.get(cs(this,a))));else{a=Array.from(this.g.values());for(let f=0;f<a.length;f++)d=d.concat(a[f])}return d},n.set=function(a,d){return xn(this),this.i=null,a=cs(this,a),Id(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[d]),this.h+=1,this},n.get=function(a,d){return a?(a=this.V(a),0<a.length?String(a[0]):d):d};function Td(a,d,f){wd(a,d),0<f.length&&(a.i=null,a.g.set(cs(a,d),P(f)),a.h+=f.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],d=Array.from(this.g.keys());for(var f=0;f<d.length;f++){var v=d[f];const x=encodeURIComponent(String(v)),$=this.V(v);for(v=0;v<$.length;v++){var C=x;$[v]!==""&&(C+="="+encodeURIComponent(String($[v]))),a.push(C)}}return this.i=a.join("&")};function cs(a,d){return d=String(d),a.j&&(d=d.toLowerCase()),d}function Lv(a,d){d&&!a.j&&(xn(a),a.i=null,a.g.forEach(function(f,v){var C=v.toLowerCase();v!=C&&(wd(this,v),Td(this,C,f))},a)),a.j=d}function Vv(a,d){const f=new oe;if(c.Image){const v=new Image;v.onload=w(Ln,f,"TestLoadImage: loaded",!0,d,v),v.onerror=w(Ln,f,"TestLoadImage: error",!1,d,v),v.onabort=w(Ln,f,"TestLoadImage: abort",!1,d,v),v.ontimeout=w(Ln,f,"TestLoadImage: timeout",!1,d,v),c.setTimeout(function(){v.ontimeout&&v.ontimeout()},1e4),v.src=a}else d(!1)}function Ov(a,d){const f=new oe,v=new AbortController,C=setTimeout(()=>{v.abort(),Ln(f,"TestPingServer: timeout",!1,d)},1e4);fetch(a,{signal:v.signal}).then(x=>{clearTimeout(C),x.ok?Ln(f,"TestPingServer: ok",!0,d):Ln(f,"TestPingServer: server error",!1,d)}).catch(()=>{clearTimeout(C),Ln(f,"TestPingServer: error",!1,d)})}function Ln(a,d,f,v,C){try{C&&(C.onload=null,C.onerror=null,C.onabort=null,C.ontimeout=null),v(f)}catch{}}function Mv(){this.g=new Ao}function Bv(a,d,f){const v=f||"";try{gd(a,function(C,x){let $=C;u(C)&&($=ss(C)),d.push(v+x+"="+encodeURIComponent($))})}catch(C){throw d.push(v+"type="+encodeURIComponent("_badmap")),C}}function Co(a){this.l=a.Ub||null,this.j=a.eb||!1}A(Co,is),Co.prototype.g=function(){return new ko(this.l,this.j)},Co.prototype.i=function(a){return function(){return a}}({});function ko(a,d){we.call(this),this.D=a,this.o=d,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}A(ko,we),n=ko.prototype,n.open=function(a,d){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=d,this.readyState=1,hi(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const d={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(d.body=a),(this.D||c).fetch(new Request(this.A,d)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,di(this)),this.readyState=0},n.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,hi(this)),this.g&&(this.readyState=3,hi(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Ed(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Ed(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}n.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var d=a.value?a.value:new Uint8Array(0);(d=this.v.decode(d,{stream:!a.done}))&&(this.response=this.responseText+=d)}a.done?di(this):hi(this),this.readyState==3&&Ed(this)}},n.Ra=function(a){this.g&&(this.response=this.responseText=a,di(this))},n.Qa=function(a){this.g&&(this.response=a,di(this))},n.ga=function(){this.g&&di(this)};function di(a){a.readyState=4,a.l=null,a.j=null,a.v=null,hi(a)}n.setRequestHeader=function(a,d){this.u.append(a,d)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],d=this.h.entries();for(var f=d.next();!f.done;)f=f.value,a.push(f[0]+": "+f[1]),f=d.next();return a.join(`\r
`)};function hi(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(ko.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function bd(a){let d="";return Z(a,function(f,v){d+=v,d+=":",d+=f,d+=`\r
`}),d}function Rc(a,d,f){e:{for(v in f){var v=!1;break e}v=!0}v||(f=bd(f),typeof a=="string"?f!=null&&encodeURIComponent(String(f)):Ee(a,d,f))}function Le(a){we.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}A(Le,we);var Fv=/^https?$/i,$v=["POST","PUT"];n=Le.prototype,n.Ha=function(a){this.J=a},n.ea=function(a,d,f,v){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);d=d?d.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():st.g(),this.v=this.o?ii(this.o):ii(st),this.g.onreadystatechange=g(this.Ea,this);try{this.B=!0,this.g.open(d,String(a),!0),this.B=!1}catch(x){Ad(this,x);return}if(a=f||"",f=new Map(this.headers),v)if(Object.getPrototypeOf(v)===Object.prototype)for(var C in v)f.set(C,v[C]);else if(typeof v.keys=="function"&&typeof v.get=="function")for(const x of v.keys())f.set(x,v.get(x));else throw Error("Unknown input type for opt_headers: "+String(v));v=Array.from(f.keys()).find(x=>x.toLowerCase()=="content-type"),C=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call($v,d,void 0))||v||C||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[x,$]of f)this.g.setRequestHeader(x,$);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Pd(this),this.u=!0,this.g.send(a),this.u=!1}catch(x){Ad(this,x)}};function Ad(a,d){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=d,a.m=5,Sd(a),Do(a)}function Sd(a){a.A||(a.A=!0,Re(a,"complete"),Re(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,Re(this,"complete"),Re(this,"abort"),Do(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Do(this,!0)),Le.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Rd(this):this.bb())},n.bb=function(){Rd(this)};function Rd(a){if(a.h&&typeof o<"u"&&(!a.v[1]||an(a)!=4||a.Z()!=2)){if(a.u&&an(a)==4)ti(a.Ea,0,a);else if(Re(a,"readystatechange"),an(a)==4){a.h=!1;try{const $=a.Z();e:switch($){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var d=!0;break e;default:d=!1}var f;if(!(f=d)){var v;if(v=$===0){var C=String(a.D).match(yd)[1]||null;!C&&c.self&&c.self.location&&(C=c.self.location.protocol.slice(0,-1)),v=!Fv.test(C?C.toLowerCase():"")}f=v}if(f)Re(a,"complete"),Re(a,"success");else{a.m=6;try{var x=2<an(a)?a.g.statusText:""}catch{x=""}a.l=x+" ["+a.Z()+"]",Sd(a)}}finally{Do(a)}}}}function Do(a,d){if(a.g){Pd(a);const f=a.g,v=a.v[0]?()=>{}:null;a.g=null,a.v=null,d||Re(a,"ready");try{f.onreadystatechange=v}catch{}}}function Pd(a){a.I&&(c.clearTimeout(a.I),a.I=null)}n.isActive=function(){return!!this.g};function an(a){return a.g?a.g.readyState:0}n.Z=function(){try{return 2<an(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(a){if(this.g){var d=this.g.responseText;return a&&d.indexOf(a)==0&&(d=d.substring(a.length)),bo(d)}};function Cd(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Uv(a){const d={};a=(a.g&&2<=an(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let v=0;v<a.length;v++){if(V(a[v]))continue;var f=E(a[v]);const C=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const x=d[C]||[];d[C]=x,x.push(f)}b(d,function(v){return v.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function fi(a,d,f){return f&&f.internalChannelParams&&f.internalChannelParams[a]||d}function kd(a){this.Aa=0,this.i=[],this.j=new oe,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=fi("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=fi("baseRetryDelayMs",5e3,a),this.cb=fi("retryDelaySeedMs",1e4,a),this.Wa=fi("forwardChannelMaxRetries",2,a),this.wa=fi("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new dd(a&&a.concurrentRequestLimit),this.Da=new Mv,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=kd.prototype,n.la=8,n.G=1,n.connect=function(a,d,f,v){ae(0),this.W=a,this.H=d||{},f&&v!==void 0&&(this.H.OSID=f,this.H.OAID=v),this.F=this.X,this.I=Fd(this,null,this.W),xo(this)};function Pc(a){if(Dd(a),a.G==3){var d=a.U++,f=on(a.I);if(Ee(f,"SID",a.K),Ee(f,"RID",d),Ee(f,"TYPE","terminate"),mi(a,f),d=new Je(a,a.j,d),d.L=2,d.v=Po(on(f)),f=!1,c.navigator&&c.navigator.sendBeacon)try{f=c.navigator.sendBeacon(d.v.toString(),"")}catch{}!f&&c.Image&&(new Image().src=d.v,f=!0),f||(d.g=$d(d.j,null),d.g.ea(d.v)),d.F=Date.now(),xe(d)}Bd(a)}function No(a){a.g&&(kc(a),a.g.cancel(),a.g=null)}function Dd(a){No(a),a.u&&(c.clearTimeout(a.u),a.u=null),Lo(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function xo(a){if(!hd(a.h)&&!a.s){a.s=!0;var d=a.Ga;Qe||To(),bt||(Qe(),bt=!0),Ye.add(d,a),a.B=0}}function jv(a,d){return fd(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=d.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Te(g(a.Ga,a,d),Md(a,a.B)),a.B++,!0)}n.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const C=new Je(this,this.j,a);let x=this.o;if(this.S&&(x?(x=_(x),S(x,this.S)):x=this.S),this.m!==null||this.O||(C.H=x,x=null),this.P)e:{for(var d=0,f=0;f<this.i.length;f++){t:{var v=this.i[f];if("__data__"in v.map&&(v=v.map.__data__,typeof v=="string")){v=v.length;break t}v=void 0}if(v===void 0)break;if(d+=v,4096<d){d=f;break e}if(d===4096||f===this.i.length-1){d=f+1;break e}}d=1e3}else d=1e3;d=xd(this,C,d),f=on(this.I),Ee(f,"RID",a),Ee(f,"CVER",22),this.D&&Ee(f,"X-HTTP-Session-Id",this.D),mi(this,f),x&&(this.O?d="headers="+encodeURIComponent(String(bd(x)))+"&"+d:this.m&&Rc(f,this.m,x)),Sc(this.h,C),this.Ua&&Ee(f,"TYPE","init"),this.P?(Ee(f,"$req",d),Ee(f,"SID","null"),C.T=!0,kn(C,f,null)):kn(C,f,d),this.G=2}}else this.G==3&&(a?Nd(this,a):this.i.length==0||hd(this.h)||Nd(this))};function Nd(a,d){var f;d?f=d.l:f=a.U++;const v=on(a.I);Ee(v,"SID",a.K),Ee(v,"RID",f),Ee(v,"AID",a.T),mi(a,v),a.m&&a.o&&Rc(v,a.m,a.o),f=new Je(a,a.j,f,a.B+1),a.m===null&&(f.H=a.o),d&&(a.i=d.D.concat(a.i)),d=xd(a,f,1e3),f.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Sc(a.h,f),kn(f,v,d)}function mi(a,d){a.H&&Z(a.H,function(f,v){Ee(d,v,f)}),a.l&&gd({},function(f,v){Ee(d,v,f)})}function xd(a,d,f){f=Math.min(a.i.length,f);var v=a.l?g(a.l.Na,a.l,a):null;e:{var C=a.i;let x=-1;for(;;){const $=["count="+f];x==-1?0<f?(x=C[0].g,$.push("ofs="+x)):x=0:$.push("ofs="+x);let ye=!0;for(let tt=0;tt<f;tt++){let he=C[tt].g;const it=C[tt].map;if(he-=x,0>he)x=Math.max(0,C[tt].g-100),ye=!1;else try{Bv(it,$,"req"+he+"_")}catch{v&&v(it)}}if(ye){v=$.join("&");break e}}}return a=a.i.splice(0,f),d.D=a,v}function Ld(a){if(!a.g&&!a.u){a.Y=1;var d=a.Fa;Qe||To(),bt||(Qe(),bt=!0),Ye.add(d,a),a.v=0}}function Cc(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Te(g(a.Fa,a),Md(a,a.v)),a.v++,!0)}n.Fa=function(){if(this.u=null,Vd(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Te(g(this.ab,this),a)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,ae(10),No(this),Vd(this))};function kc(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function Vd(a){a.g=new Je(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var d=on(a.qa);Ee(d,"RID","rpc"),Ee(d,"SID",a.K),Ee(d,"AID",a.T),Ee(d,"CI",a.F?"0":"1"),!a.F&&a.ja&&Ee(d,"TO",a.ja),Ee(d,"TYPE","xmlhttp"),mi(a,d),a.m&&a.o&&Rc(d,a.m,a.o),a.L&&(a.g.I=a.L);var f=a.g;a=a.ia,f.L=1,f.v=Po(on(d)),f.m=null,f.P=!0,Dn(f,a)}n.Za=function(){this.C!=null&&(this.C=null,No(this),Cc(this),ae(19))};function Lo(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function Od(a,d){var f=null;if(a.g==d){Lo(a),kc(a),a.g=null;var v=2}else if(Ac(a.h,d))f=d.D,md(a.h,d),v=1;else return;if(a.G!=0){if(d.o)if(v==1){f=d.m?d.m.length:0,d=Date.now()-d.F;var C=a.B;v=H(),Re(v,new me(v,f)),xo(a)}else Ld(a);else if(C=d.s,C==3||C==0&&0<d.X||!(v==1&&jv(a,d)||v==2&&Cc(a)))switch(f&&0<f.length&&(d=a.h,d.i=d.i.concat(f)),C){case 1:yr(a,5);break;case 4:yr(a,10);break;case 3:yr(a,6);break;default:yr(a,2)}}}function Md(a,d){let f=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(f*=2),f*d}function yr(a,d){if(a.j.info("Error code "+d),d==2){var f=g(a.fb,a),v=a.Xa;const C=!v;v=new gr(v||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||So(v,"https"),Po(v),C?Vv(v.toString(),f):Ov(v.toString(),f)}else ae(2);a.G=0,a.l&&a.l.sa(d),Bd(a),Dd(a)}n.fb=function(a){a?(this.j.info("Successfully pinged google.com"),ae(2)):(this.j.info("Failed to ping google.com"),ae(1))};function Bd(a){if(a.G=0,a.ka=[],a.l){const d=pd(a.h);(d.length!=0||a.i.length!=0)&&(D(a.ka,d),D(a.ka,a.i),a.h.i.length=0,P(a.i),a.i.length=0),a.l.ra()}}function Fd(a,d,f){var v=f instanceof gr?on(f):new gr(f);if(v.g!="")d&&(v.g=d+"."+v.g),Ro(v,v.s);else{var C=c.location;v=C.protocol,d=d?d+"."+C.hostname:C.hostname,C=+C.port;var x=new gr(null);v&&So(x,v),d&&(x.g=d),C&&Ro(x,C),f&&(x.l=f),v=x}return f=a.D,d=a.ya,f&&d&&Ee(v,f,d),Ee(v,"VER",a.la),mi(a,v),v}function $d(a,d,f){if(d&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return d=a.Ca&&!a.pa?new Le(new Co({eb:f})):new Le(a.pa),d.Ha(a.J),d}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Ud(){}n=Ud.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Vo(){}Vo.prototype.g=function(a,d){return new St(a,d)};function St(a,d){we.call(this),this.g=new kd(d),this.l=a,this.h=d&&d.messageUrlParams||null,a=d&&d.messageHeaders||null,d&&d.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=d&&d.initMessageHeaders||null,d&&d.messageContentType&&(a?a["X-WebChannel-Content-Type"]=d.messageContentType:a={"X-WebChannel-Content-Type":d.messageContentType}),d&&d.va&&(a?a["X-WebChannel-Client-Profile"]=d.va:a={"X-WebChannel-Client-Profile":d.va}),this.g.S=a,(a=d&&d.Sb)&&!V(a)&&(this.g.m=a),this.v=d&&d.supportsCrossDomainXhr||!1,this.u=d&&d.sendRawJson||!1,(d=d&&d.httpSessionIdParam)&&!V(d)&&(this.g.D=d,a=this.h,a!==null&&d in a&&(a=this.h,d in a&&delete a[d])),this.j=new ls(this)}A(St,we),St.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},St.prototype.close=function(){Pc(this.g)},St.prototype.o=function(a){var d=this.g;if(typeof a=="string"){var f={};f.__data__=a,a=f}else this.u&&(f={},f.__data__=ss(a),a=f);d.i.push(new Av(d.Ya++,a)),d.G==3&&xo(d)},St.prototype.N=function(){this.g.l=null,delete this.j,Pc(this.g),delete this.g,St.aa.N.call(this)};function jd(a){os.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var d=a.__sm__;if(d){e:{for(const f in d){a=f;break e}a=void 0}(this.i=a)&&(a=this.i,d=d!==null&&a in d?d[a]:void 0),this.data=d}else this.data=a}A(jd,os);function qd(){as.call(this),this.status=1}A(qd,as);function ls(a){this.g=a}A(ls,Ud),ls.prototype.ua=function(){Re(this.g,"a")},ls.prototype.ta=function(a){Re(this.g,new jd(a))},ls.prototype.sa=function(a){Re(this.g,new qd)},ls.prototype.ra=function(){Re(this.g,"b")},Vo.prototype.createWebChannel=Vo.prototype.g,St.prototype.send=St.prototype.o,St.prototype.open=St.prototype.m,St.prototype.close=St.prototype.close,Jm=function(){return new Vo},Ym=function(){return H()},Qm=O,ll={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Nt.NO_ERROR=0,Nt.TIMEOUT=8,Nt.HTTP_ERROR=6,Yo=Nt,Ne.COMPLETE="complete",Wm=Ne,oi.EventType=Cn,Cn.OPEN="a",Cn.CLOSE="b",Cn.ERROR="c",Cn.MESSAGE="d",we.prototype.listen=we.prototype.K,bi=oi,Le.prototype.listenOnce=Le.prototype.L,Le.prototype.getLastError=Le.prototype.Ka,Le.prototype.getLastErrorCode=Le.prototype.Ba,Le.prototype.getStatus=Le.prototype.Z,Le.prototype.getResponseJson=Le.prototype.Oa,Le.prototype.getResponseText=Le.prototype.oa,Le.prototype.send=Le.prototype.ea,Le.prototype.setWithCredentials=Le.prototype.Ha,Hm=Le}).apply(typeof Bo<"u"?Bo:typeof self<"u"?self:typeof window<"u"?window:{});const wh="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lr=new Fl("@firebase/firestore");function ps(){return Lr.logLevel}function M(n,...e){if(Lr.logLevel<=le.DEBUG){const t=e.map(Jl);Lr.debug(`Firestore (${js}): ${n}`,...t)}}function Fe(n,...e){if(Lr.logLevel<=le.ERROR){const t=e.map(Jl);Lr.error(`Firestore (${js}): ${n}`,...t)}}function Ki(n,...e){if(Lr.logLevel<=le.WARN){const t=e.map(Jl);Lr.warn(`Firestore (${js}): ${n}`,...t)}}function Jl(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function W(n="Unexpected state"){const e=`FIRESTORE (${js}) INTERNAL ASSERTION FAILED: `+n;throw Fe(e),new Error(e)}function X(n,e){n||W()}function Y(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class MT{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class BT{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(ct.UNAUTHENTICATED))}shutdown(){}}class FT{constructor(e){this.t=e,this.currentUser=ct.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){X(this.o===void 0);let r=this.i;const s=l=>this.i!==r?(r=this.i,t(l)):Promise.resolve();let i=new tn;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new tn,e.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},c=l=>{M("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(M("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new tn)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(M("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(X(typeof r.accessToken=="string"),new MT(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return X(e===null||typeof e=="string"),new ct(e)}}class $T{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=ct.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class UT{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new $T(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(ct.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class jT{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class qT{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){X(this.o===void 0);const r=i=>{i.error!=null&&M("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.R;return this.R=i.token,M("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{M("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):M("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(X(typeof t.token=="string"),this.R=t.token,new jT(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi{constructor(e,t,r){t===void 0?t=0:t>e.length&&W(),r===void 0?r=e.length-t:r>e.length-t&&W(),this.segments=e,this.offset=t,this.len=r}get length(){return this.len}isEqual(e){return zi.comparator(this,e)===0}child(e){const t=this.segments.slice(this.offset,this.limit());return e instanceof zi?e.forEach(r=>{t.push(r)}):t.push(e),this.construct(t)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let t=0;t<this.length;t++)if(this.get(t)!==e.get(t))return!1;return!0}forEach(e){for(let t=this.offset,r=this.limit();t<r;t++)e(this.segments[t])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,t){const r=Math.min(e.length,t.length);for(let s=0;s<r;s++){const i=e.get(s),o=t.get(s);if(i<o)return-1;if(i>o)return 1}return e.length<t.length?-1:e.length>t.length?1:0}}class fe extends zi{construct(e,t,r){return new fe(e,t,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const t=[];for(const r of e){if(r.indexOf("//")>=0)throw new U(L.INVALID_ARGUMENT,`Invalid segment (${r}). Paths must not contain // in them.`);t.push(...r.split("/").filter(s=>s.length>0))}return new fe(t)}static emptyPath(){return new fe([])}}const KT=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class ke extends zi{construct(e,t,r){return new ke(e,t,r)}static isValidIdentifier(e){return KT.test(e)}canonicalString(){return this.toArray().map(e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),ke.isValidIdentifier(e)||(e="`"+e+"`"),e)).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)==="__name__"}static keyField(){return new ke(["__name__"])}static fromServerFormat(e){const t=[];let r="",s=0;const i=()=>{if(r.length===0)throw new U(L.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);t.push(r),r=""};let o=!1;for(;s<e.length;){const c=e[s];if(c==="\\"){if(s+1===e.length)throw new U(L.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const l=e[s+1];if(l!=="\\"&&l!=="."&&l!=="`")throw new U(L.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);r+=l,s+=2}else c==="`"?(o=!o,s++):c!=="."||o?(r+=c,s++):(i(),s++)}if(i(),o)throw new U(L.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new ke(t)}static emptyPath(){return new ke([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nr(n){if(n.code!==L.FAILED_PRECONDITION||n.message!==np)throw n;M("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=Th(e)),e=YT(n.get(t),e);return Th(e)}function YT(n,e){let t=e;const r=n.length;for(let s=0;s<r;s++){const i=n.charAt(s);switch(i){case"\0":t+="";break;case"":t+="";break;default:t+=i}}return t}function Th(n){return n+""}function Jt(n){const e=n.length;if(X(e>=2),e===2)return X(n.charAt(0)===""&&n.charAt(1)===""),fe.emptyPath();const t=e-2,r=[];let s="";for(let i=0;i<e;){const o=n.indexOf("",i);switch((o<0||o>t)&&W(),n.charAt(o+1)){case"":const c=n.substring(i,o);let l;s.length===0?l=c:(s+=c,l=s,s=""),r.push(l);break;case"":s+=n.substring(i,o),s+="\0";break;case"":s+=n.substring(i,o+1);break;default:W()}i=o+2}return new fe(r)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pp{}class ue extends pp{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new wE(e,t,r):t==="array-contains"?new EE(e,r):t==="in"?new Ip(e,r):t==="not-in"?new bE(e,r):t==="array-contains-any"?new AE(e,r):new ue(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new IE(e,r):new TE(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(Yn(t,this.value)):t!==null&&Or(this.value)===Or(t)&&this.matchesComparison(Yn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return W()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class pe extends pp{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new pe(e,t)}matches(e){return Cs(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Cs(n){return n.op==="and"}function ml(n){return n.op==="or"}function ru(n){return gp(n)&&Cs(n)}function gp(n){for(const e of n.filters)if(e instanceof pe)return!1;return!0}function pl(n){if(n instanceof ue)return n.field.canonicalString()+n.op.toString()+Rs(n.value);if(ru(n))return n.filters.map(e=>pl(e)).join(",");{const e=n.filters.map(t=>pl(t)).join(",");return`${n.op}(${e})`}}function yp(n,e){return n instanceof ue?function(r,s){return s instanceof ue&&r.op===s.op&&r.field.isEqual(s.field)&&rn(r.value,s.value)}(n,e):n instanceof pe?function(r,s){return s instanceof pe&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((i,o,c)=>i&&yp(o,s.filters[c]),!0):!1}(n,e):void W()}function vp(n,e){const t=n.filters.concat(e);return pe.create(t,n.op)}function _p(n){return n instanceof ue?function(t){return`${t.field.canonicalString()} ${t.op} ${Rs(t.value)}`}(n):n instanceof pe?function(t){return t.op.toString()+" {"+t.getFilters().map(_p).join(" ,")+"}"}(n):"Filter"}class wE extends ue{constructor(e,t,r){super(e,t,r),this.key=j.fromName(r.referenceValue)}matches(e){const t=j.comparator(e.key,this.key);return this.matchesComparison(t)}}class IE extends ue{constructor(e,t){super(e,"in",t),this.keys=wp("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class TE extends ue{constructor(e,t){super(e,"not-in",t),this.keys=wp("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function wp(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>j.fromName(r.referenceValue))}class EE extends ue{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Xi(t)&&Yi(t.arrayValue,this.value)}}class Ip extends ue{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&Yi(this.value.arrayValue,t)}}class bE extends ue{constructor(e,t){super(e,"not-in",t)}matches(e){if(Yi(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!Yi(this.value.arrayValue,t)}}class AE extends ue{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Xi(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>Yi(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CE=new Ie(j.comparator);function Rt(){return CE}const Rp=new Ie(j.comparator);function Ai(...n){let e=Rp;for(const t of n)e=e.insert(t.key,t);return e}function Pp(n){let e=Rp;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Xt(){return Mi()}function Cp(){return Mi()}function Mi(){return new sr(n=>n.toString(),(n,e)=>n.isEqual(e))}const kE=new Ie(j.comparator),DE=new ge(j.comparator);function ce(...n){let e=DE;for(const t of n)e=e.add(t);return e}const NE=new ge(se);function su(){return NE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class za{constructor(){this._=void 0}}function LE(n,e,t){return n instanceof ks?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&tu(i)&&(i=nu(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(t,e):n instanceof Br?Np(n,e):n instanceof Ds?xp(n,e):function(s,i){const o=Dp(s,i),c=Mh(o)+Mh(s.Pe);return fl(o)&&fl(s.Pe)?kp(c):iu(s.serializer,c)}(n,e)}function VE(n,e,t){return n instanceof Br?Np(n,e):n instanceof Ds?xp(n,e):t}function Dp(n,e){return n instanceof Zi?function(r){return fl(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class ks extends za{}class Br extends za{constructor(e){super(),this.elements=e}}function Np(n,e){const t=Lp(e);for(const r of n.elements)t.some(s=>rn(s,r))||t.push(r);return{arrayValue:{values:t}}}class Ds extends za{constructor(e){super(),this.elements=e}}function xp(n,e){let t=Lp(e);for(const r of n.elements)t=t.filter(s=>!rn(s,r));return{arrayValue:{values:t}}}class Zi extends za{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Mh(n){return Ae(n.integerValue||n.doubleValue)}function Lp(n){return Xi(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class na{constructor(e,t,r,s){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=s}}class Fp{constructor(e,t){this.targetId=e,this.me=t}}class $p{constructor(e,t,r=$e.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class qh{constructor(){this.fe=0,this.ge=Kh(),this.pe=$e.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=ce(),t=ce(),r=ce();return this.ge.forEach((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:W()}}),new mo(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=Kh()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,X(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class GE{constructor(e){this.Le=e,this.Be=new Map,this.ke=Rt(),this.qe=Gh(),this.Qe=new Ie(se)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:W()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,s)=>{this.ze(s)&&t(s)})}He(e){const t=e.targetId,r=e.me.count,s=this.Je(t);if(s){const i=s.target;if(wa(i))if(r===0){const o=new j(i.path);this.Ue(t,o,Ve.newNoDocument(o,ee.min()))}else X(r===1);else{const o=this.Ye(t);if(o!==r){const c=this.Ze(e),l=c?this.Xe(c,e,o):1;if(l!==0){this.je(t);const u=l===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,u)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let o,c;try{o=Qn(r).toUint8Array()}catch(l){if(l instanceof dp)return Ki("Decoding the base64 bloom filter in existence filter failed ("+l.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw l}try{c=new uu(o,s,i)}catch(l){return Ki(l instanceof Si?"BloomFilter error: ":"Applying bloom filter failed: ",l),null}return c.Ie===0?null:c}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let s=0;return r.forEach(i=>{const o=this.Le.tt(),c=`projects/${o.projectId}/databases/${o.database}/documents/${i.path.canonicalString()}`;e.mightContain(c)||(this.Ue(t,i,null),s++)}),s}rt(e){const t=new Map;this.Be.forEach((i,o)=>{const c=this.Je(o);if(c){if(i.current&&wa(c.target)){const l=new j(c.target.path);this.ke.get(l)!==null||this.it(o,l)||this.Ue(o,l,Ve.newNoDocument(l,e))}i.be&&(t.set(o,i.ve()),i.Ce())}});let r=ce();this.qe.forEach((i,o)=>{let c=!0;o.forEachWhile(l=>{const u=this.Je(l);return!u||u.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)}),c&&(r=r.add(i))}),this.ke.forEach((i,o)=>o.setReadTime(e));const s=new fo(e,t,this.Qe,this.ke,r);return this.ke=Rt(),this.qe=Gh(),this.Qe=new Ie(se),s}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const s=this.Ge(e);this.it(e,t)?s.Fe(t,1):s.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new qh,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new ge(se),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||M("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new qh),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function Gh(){return new Ie(j.comparator)}function Kh(){return new Ie(j.comparator)}const KE={asc:"ASCENDING",desc:"DESCENDING"},zE={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},HE={and:"AND",or:"OR"};class WE{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function _l(n,e){return n.useProto3Json||ja(e)?e:{value:e}}function Ns(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Up(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function QE(n,e){return Ns(n,e.toTimestamp())}function yt(n){return X(!!n),ee.fromTimestamp(function(t){const r=vn(t);return new De(r.seconds,r.nanos)}(n))}function du(n,e){return wl(n,e).canonicalString()}function wl(n,e){const t=function(s){return new fe(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function jp(n){const e=fe.fromString(n);return X(Jp(e)),e}function Ta(n,e){return du(n.databaseId,e.path)}function Pr(n,e){const t=jp(e);if(t.get(1)!==n.databaseId.projectId)throw new U(L.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new U(L.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new j(Kp(t))}function qp(n,e){return du(n.databaseId,e)}function Gp(n){const e=jp(n);return e.length===4?fe.emptyPath():Kp(e)}function Il(n){return new fe(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Kp(n){return X(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function zh(n,e,t){return{name:Ta(n,e),fields:t.value.mapValue.fields}}function YE(n,e,t){const r=Pr(n,e.name),s=yt(e.updateTime),i=e.createTime?yt(e.createTime):ee.min(),o=new lt({mapValue:{fields:e.fields}}),c=Ve.newFoundDocument(r,s,i,o);return t&&c.setHasCommittedMutations(),t?c.setHasCommittedMutations():c}function JE(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(u){return u==="NO_CHANGE"?0:u==="ADD"?1:u==="REMOVE"?2:u==="CURRENT"?3:u==="RESET"?4:W()}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=function(u,h){return u.useProto3Json?(X(h===void 0||typeof h=="string"),$e.fromBase64String(h||"")):(X(h===void 0||h instanceof Buffer||h instanceof Uint8Array),$e.fromUint8Array(h||new Uint8Array))}(n,e.targetChange.resumeToken),o=e.targetChange.cause,c=o&&function(u){const h=u.code===void 0?L.UNKNOWN:Bp(u.code);return new U(h,u.message||"")}(o);t=new $p(r,s,i,c||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=Pr(n,r.document.name),i=yt(r.document.updateTime),o=r.document.createTime?yt(r.document.createTime):ee.min(),c=new lt({mapValue:{fields:r.document.fields}}),l=Ve.newFoundDocument(s,i,o,c),u=r.targetIds||[],h=r.removedTargetIds||[];t=new na(u,h,l.key,l)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=Pr(n,r.document),i=r.readTime?yt(r.readTime):ee.min(),o=Ve.newNoDocument(s,i),c=r.removedTargetIds||[];t=new na([],c,o.key,o)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=Pr(n,r.document),i=r.removedTargetIds||[];t=new na([],i,s,null)}else{if(!("filter"in e))return W();{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,o=new $E(s,i),c=r.targetId;t=new Fp(c,o)}}return t}function Ea(n,e){let t;if(e instanceof Gs)t={update:zh(n,e.key,e.value)};else if(e instanceof Wa)t={delete:Ta(n,e.key)};else if(e instanceof In)t={update:zh(n,e.key,e.data),updateMask:rb(e.fieldMask)};else{if(!(e instanceof Mp))return W();t={verify:Ta(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(i,o){const c=o.transform;if(c instanceof ks)return{fieldPath:o.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(c instanceof Br)return{fieldPath:o.field.canonicalString(),appendMissingElements:{values:c.elements}};if(c instanceof Ds)return{fieldPath:o.field.canonicalString(),removeAllFromArray:{values:c.elements}};if(c instanceof Zi)return{fieldPath:o.field.canonicalString(),increment:c.Pe};throw W()}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,i){return i.updateTime!==void 0?{updateTime:QE(s,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:W()}(n,e.precondition)),t}function Tl(n,e){const t=e.currentDocument?function(i){return i.updateTime!==void 0?ut.updateTime(yt(i.updateTime)):i.exists!==void 0?ut.exists(i.exists):ut.none()}(e.currentDocument):ut.none(),r=e.updateTransforms?e.updateTransforms.map(s=>function(o,c){let l=null;if("setToServerValue"in c)X(c.setToServerValue==="REQUEST_TIME"),l=new ks;else if("appendMissingElements"in c){const h=c.appendMissingElements.values||[];l=new Br(h)}else if("removeAllFromArray"in c){const h=c.removeAllFromArray.values||[];l=new Ds(h)}else"increment"in c?l=new Zi(o,c.increment):W();const u=ke.fromServerFormat(c.fieldPath);return new ou(u,l)}(n,s)):[];if(e.update){e.update.name;const s=Pr(n,e.update.name),i=new lt({mapValue:{fields:e.update.fields}});if(e.updateMask){const o=function(l){const u=l.fieldPaths||[];return new Tt(u.map(h=>ke.fromServerFormat(h)))}(e.updateMask);return new In(s,i,o,t,r)}return new Gs(s,i,t,r)}if(e.delete){const s=Pr(n,e.delete);return new Wa(s,t)}if(e.verify){const s=Pr(n,e.verify);return new Mp(s,t)}return W()}function XE(n,e){return n&&n.length>0?(X(e!==void 0),n.map(t=>function(s,i){let o=s.updateTime?yt(s.updateTime):yt(i);return o.isEqual(ee.min())&&(o=yt(i)),new ME(o,s.transformResults||[])}(t,e))):[]}function zp(n,e){return{documents:[qp(n,e.path)]}}function Hp(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=qp(n,s);const i=function(u){if(u.length!==0)return Yp(pe.create(u,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const o=function(u){if(u.length!==0)return u.map(h=>function(g){return{field:ys(g.field),direction:eb(g.dir)}}(h))}(e.orderBy);o&&(t.structuredQuery.orderBy=o);const c=_l(n,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=function(u){return{before:u.inclusive,values:u.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(u){return{before:!u.inclusive,values:u.position}}(e.endAt)),{_t:t,parent:s}}function Wp(n){let e=Gp(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){X(r===1);const h=t.from[0];h.allDescendants?s=h.collectionId:e=e.child(h.collectionId)}let i=[];t.where&&(i=function(p){const g=Qp(p);return g instanceof pe&&ru(g)?g.getFilters():[g]}(t.where));let o=[];t.orderBy&&(o=function(p){return p.map(g=>function(A){return new _a(vs(A.field),function(D){switch(D){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(A.direction))}(g))}(t.orderBy));let c=null;t.limit&&(c=function(p){let g;return g=typeof p=="object"?p.value:p,ja(g)?null:g}(t.limit));let l=null;t.startAt&&(l=function(p){const g=!!p.before,w=p.values||[];return new Ps(w,g)}(t.startAt));let u=null;return t.endAt&&(u=function(p){const g=!p.before,w=p.values||[];return new Ps(w,g)}(t.endAt)),Tp(e,s,o,i,c,"F",l,u)}function ZE(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return W()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Qp(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=vs(t.unaryFilter.field);return ue.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=vs(t.unaryFilter.field);return ue.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=vs(t.unaryFilter.field);return ue.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const o=vs(t.unaryFilter.field);return ue.create(o,"!=",{nullValue:"NULL_VALUE"});default:return W()}}(n):n.fieldFilter!==void 0?function(t){return ue.create(vs(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return W()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return pe.create(t.compositeFilter.filters.map(r=>Qp(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return W()}}(t.compositeFilter.op))}(n):W()}function eb(n){return KE[n]}function tb(n){return zE[n]}function nb(n){return HE[n]}function ys(n){return{fieldPath:n.canonicalString()}}function vs(n){return ke.fromServerFormat(n.fieldPath)}function Yp(n){return n instanceof ue?function(t){if(t.op==="=="){if(Ch(t.value))return{unaryFilter:{field:ys(t.field),op:"IS_NAN"}};if(Ph(t.value))return{unaryFilter:{field:ys(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Ch(t.value))return{unaryFilter:{field:ys(t.field),op:"IS_NOT_NAN"}};if(Ph(t.value))return{unaryFilter:{field:ys(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:ys(t.field),op:tb(t.op),value:t.value}}}(n):n instanceof pe?function(t){const r=t.getFilters().map(s=>Yp(s));return r.length===1?r[0]:{compositeFilter:{op:nb(t.op),filters:r}}}(n):W()}function rb(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Jp(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ef{constructor(e){this.Xt=new ge((t,r)=>ke.comparator(t.field,r.field)),this.collectionId=e.collectionGroup!=null?e.collectionGroup:e.path.lastSegment(),this.en=e.orderBy,this.tn=[];for(const t of e.filters){const r=t;r.isInequality()?this.Xt=this.Xt.add(r):this.tn.push(r)}}get nn(){return this.Xt.size>1}rn(e){if(X(e.collectionGroup===this.collectionId),this.nn)return!1;const t=ul(e);if(t!==void 0&&!this.sn(t))return!1;const r=wr(e);let s=new Set,i=0,o=0;for(;i<r.length&&this.sn(r[i]);++i)s=s.add(r[i].fieldPath.canonicalString());if(i===r.length)return!0;if(this.Xt.size>0){const c=this.Xt.getIterator().getNext();if(!s.has(c.field.canonicalString())){const l=r[i];if(!this.on(c,l)||!this._n(this.en[o++],l))return!1}++i}for(;i<r.length;++i){const c=r[i];if(o>=this.en.length||!this._n(this.en[o++],c))return!1}return!0}an(){if(this.nn)return null;let e=new ge(ke.comparator);const t=[];for(const r of this.tn)if(!r.field.isKeyField())if(r.op==="array-contains"||r.op==="array-contains-any")t.push(new Jo(r.field,2));else{if(e.has(r.field))continue;e=e.add(r.field),t.push(new Jo(r.field,0))}for(const r of this.en)r.field.isKeyField()||e.has(r.field)||(e=e.add(r.field),t.push(new Jo(r.field,r.dir==="asc"?0:1)));return new va(va.UNKNOWN_ID,this.collectionId,t,Hi.empty())}sn(e){for(const t of this.tn)if(this.on(t,e))return!0;return!1}on(e,t){if(e===void 0||!e.field.isEqual(t.fieldPath))return!1;const r=e.op==="array-contains"||e.op==="array-contains-any";return t.kind===2===r}_n(e,t){return!!e.field.isEqual(t.fieldPath)&&(t.kind===0&&e.dir==="asc"||t.kind===1&&e.dir==="desc")}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tg(n){var e,t;if(X(n instanceof ue||n instanceof pe),n instanceof ue){if(n instanceof Ip){const s=((t=(e=n.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(i=>ue.create(n.field,"==",i)))||[];return pe.create(s,"or")}return n}const r=n.filters.map(s=>tg(s));return pe.create(r,n.op)}function db(n){if(n.getFilters().length===0)return[];const e=Al(tg(n));return X(ng(e)),El(e)||bl(e)?[e]:e.getFilters()}function El(n){return n instanceof ue}function bl(n){return n instanceof pe&&ru(n)}function ng(n){return El(n)||bl(n)||function(t){if(t instanceof pe&&ml(t)){for(const r of t.getFilters())if(!El(r)&&!bl(r))return!1;return!0}return!1}(n)}function Al(n){if(X(n instanceof ue||n instanceof pe),n instanceof ue)return n;if(n.filters.length===1)return Al(n.filters[0]);const e=n.filters.map(r=>Al(r));let t=pe.create(e,n.op);return t=Aa(t),ng(t)?t:(X(t instanceof pe),X(Cs(t)),X(t.filters.length>1),t.filters.reduce((r,s)=>hu(r,s)))}function hu(n,e){let t;return X(n instanceof ue||n instanceof pe),X(e instanceof ue||e instanceof pe),t=n instanceof ue?e instanceof ue?function(s,i){return pe.create([s,i],"and")}(n,e):tf(n,e):e instanceof ue?tf(e,n):function(s,i){if(X(s.filters.length>0&&i.filters.length>0),Cs(s)&&Cs(i))return vp(s,i.getFilters());const o=ml(s)?s:i,c=ml(s)?i:s,l=o.filters.map(u=>hu(u,c));return pe.create(l,"or")}(n,e),Aa(t)}function tf(n,e){if(Cs(e))return vp(e,n.getFilters());{const t=e.filters.map(r=>hu(n,r));return pe.create(t,"or")}}function Aa(n){if(X(n instanceof ue||n instanceof pe),n instanceof ue)return n;const e=n.getFilters();if(e.length===1)return Aa(e[0]);if(gp(n))return n;const t=e.map(s=>Aa(s)),r=[];return t.forEach(s=>{s instanceof ue?r.push(s):s instanceof pe&&(s.op===n.op?r.push(...s.filters):r.push(s))}),r.length===1?r[0]:pe.create(r,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $o=new Uint8Array(0);class fb{constructor(e,t){this.databaseId=t,this.cn=new fu,this.ln=new sr(r=>Mr(r),(r,s)=>uo(r,s)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.cn.has(t)){const r=t.lastSegment(),s=t.popLast();e.addOnCommittedListener(()=>{this.cn.add(t)});const i={collectionId:r,parent:gt(s)};return nf(e).put(i)}return k.resolve()}getCollectionParents(e,t){const r=[],s=IDBKeyRange.bound([t,""],[Zm(t),""],!1,!0);return nf(e).U(s).next(i=>{for(const o of i){if(o.collectionId!==t)break;r.push(Jt(o.parent))}return r})}addFieldIndex(e,t){const r=yi(e),s=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(l=>[l.fieldPath.canonicalString(),l.kind])}}(t);delete s.indexId;const i=r.add(s);if(t.indexState){const o=fs(e);return i.next(c=>{o.put(Qh(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){const r=yi(e),s=fs(e),i=hs(e);return r.delete(t.indexId).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=yi(e),r=hs(e),s=fs(e);return t.j().next(()=>r.j()).next(()=>s.j())}createTargetIndexes(e,t){return k.forEach(this.hn(t),r=>this.getIndexType(e,r).next(s=>{if(s===0||s===1){const i=new ef(r).an();if(i!=null)return this.addFieldIndex(e,i)}}))}getDocumentsMatchingTarget(e,t){const r=hs(e);let s=!0;const i=new Map;return k.forEach(this.hn(t),o=>this.Pn(e,o).next(c=>{s&&(s=!!c),i.set(o,c)})).next(()=>{if(s){let o=ce();const c=[];return k.forEach(i,(l,u)=>{M("IndexedDbIndexManager",`Using index ${function(F){return`id=${F.indexId}|cg=${F.collectionGroup}|f=${F.fields.map(q=>`${q.fieldPath}:${q.kind}`).join(",")}`}(l)} to execute ${Mr(t)}`);const h=function(F,q){const te=ul(q);if(te===void 0)return null;for(const Z of Ia(F,te.fieldPath))switch(Z.op){case"array-contains-any":return Z.value.arrayValue.values||[];case"array-contains":return[Z.value]}return null}(u,l),p=function(F,q){const te=new Map;for(const Z of wr(q))for(const b of Ia(F,Z.fieldPath))switch(b.op){case"==":case"in":te.set(Z.fieldPath.canonicalString(),b.value);break;case"not-in":case"!=":return te.set(Z.fieldPath.canonicalString(),b.value),Array.from(te.values())}return null}(u,l),g=function(F,q){const te=[];let Z=!0;for(const b of wr(q)){const _=b.kind===0?Lh(F,b.fieldPath,F.startAt):Vh(F,b.fieldPath,F.startAt);te.push(_.value),Z&&(Z=_.inclusive)}return new Ps(te,Z)}(u,l),w=function(F,q){const te=[];let Z=!0;for(const b of wr(q)){const _=b.kind===0?Vh(F,b.fieldPath,F.endAt):Lh(F,b.fieldPath,F.endAt);te.push(_.value),Z&&(Z=_.inclusive)}return new Ps(te,Z)}(u,l),A=this.In(l,u,g),P=this.In(l,u,w),D=this.Tn(l,u,p),N=this.En(l.indexId,h,A,g.inclusive,P,w.inclusive,D);return k.forEach(N,V=>r.G(V,t.limit).next(F=>{F.forEach(q=>{const te=j.fromSegments(q.documentKey);o.has(te)||(o=o.add(te),c.push(te))})}))}).next(()=>c)}return k.resolve(null)})}hn(e){let t=this.ln.get(e);return t||(e.filters.length===0?t=[e]:t=db(pe.create(e.filters,"and")).map(r=>gl(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.ln.set(e,t),t)}En(e,t,r,s,i,o,c){const l=(t!=null?t.length:1)*Math.max(r.length,i.length),u=l/(t!=null?t.length:1),h=[];for(let p=0;p<l;++p){const g=t?this.dn(t[p/u]):$o,w=this.An(e,g,r[p%u],s),A=this.Rn(e,g,i[p%u],o),P=c.map(D=>this.An(e,g,D,!0));h.push(...this.createRange(w,A,P))}return h}An(e,t,r,s){const i=new br(e,j.empty(),t,r);return s?i:i.Zt()}Rn(e,t,r,s){const i=new br(e,j.empty(),t,r);return s?i.Zt():i}Pn(e,t){const r=new ef(t),s=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,s).next(i=>{let o=null;for(const c of i)r.rn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let r=2;const s=this.hn(t);return k.forEach(s,i=>this.Pn(e,i).next(o=>{o?r!==0&&o.fields.length<function(l){let u=new ge(ke.comparator),h=!1;for(const p of l.filters)for(const g of p.getFlattenedFilters())g.field.isKeyField()||(g.op==="array-contains"||g.op==="array-contains-any"?h=!0:u=u.add(g.field));for(const p of l.orderBy)p.field.isKeyField()||(u=u.add(p.field));return u.size+(h?1:0)}(i)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(t)&&s.length>1&&r===2?1:r)}Vn(e,t){const r=new gi;for(const s of wr(e)){const i=t.data.field(s.fieldPath);if(i==null)return null;const o=r.Yt(s.kind);Er.vt.It(i,o)}return r.zt()}dn(e){const t=new gi;return Er.vt.It(e,t.Yt(0)),t.zt()}mn(e,t){const r=new gi;return Er.vt.It(Ji(this.databaseId,t),r.Yt(function(i){const o=wr(i);return o.length===0?0:o[o.length-1].kind}(e))),r.zt()}Tn(e,t,r){if(r===null)return[];let s=[];s.push(new gi);let i=0;for(const o of wr(e)){const c=r[i++];for(const l of s)if(this.fn(t,o.fieldPath)&&Xi(c))s=this.gn(s,o,c);else{const u=l.Yt(o.kind);Er.vt.It(c,u)}}return this.pn(s)}In(e,t,r){return this.Tn(e,t,r.position)}pn(e){const t=[];for(let r=0;r<e.length;++r)t[r]=e[r].zt();return t}gn(e,t,r){const s=[...e],i=[];for(const o of r.arrayValue.values||[])for(const c of s){const l=new gi;l.seed(c.zt()),Er.vt.It(o,l.Yt(t.kind)),i.push(l)}return i}fn(e,t){return!!e.filters.find(r=>r instanceof ue&&r.field.isEqual(t)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,t){const r=yi(e),s=fs(e);return(t?r.U("collectionGroupIndex",IDBKeyRange.bound(t,t)):r.U()).next(i=>{const o=[];return k.forEach(i,c=>s.get([c.indexId,this.uid]).next(l=>{o.push(function(h,p){const g=p?new Hi(p.sequenceNumber,new kt($r(p.readTime),new j(Jt(p.documentKey)),p.largestBatchId)):Hi.empty(),w=h.fields.map(([A,P])=>new Jo(ke.fromServerFormat(A),P));return new va(h.indexId,h.collectionGroup,w,g)}(c,l))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((r,s)=>{const i=r.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:se(r.collectionGroup,s.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,r){const s=yi(e),i=fs(e);return this.yn(e).next(o=>s.U("collectionGroupIndex",IDBKeyRange.bound(t,t)).next(c=>k.forEach(c,l=>i.put(Qh(l.indexId,this.uid,o,r)))))}updateIndexEntries(e,t){const r=new Map;return k.forEach(t,(s,i)=>{const o=r.get(s.collectionGroup);return(o?k.resolve(o):this.getFieldIndexes(e,s.collectionGroup)).next(c=>(r.set(s.collectionGroup,c),k.forEach(c,l=>this.wn(e,s,l).next(u=>{const h=this.Sn(i,l);return u.isEqual(h)?k.resolve():this.bn(e,i,l,u,h)}))))})}Dn(e,t,r,s){return hs(e).put({indexId:s.indexId,uid:this.uid,arrayValue:s.arrayValue,directionalValue:s.directionalValue,orderedDocumentKey:this.mn(r,t.key),documentKey:t.key.path.toArray()})}vn(e,t,r,s){return hs(e).delete([s.indexId,this.uid,s.arrayValue,s.directionalValue,this.mn(r,t.key),t.key.path.toArray()])}wn(e,t,r){const s=hs(e);let i=new ge(On);return s.J({index:"documentKeyIndex",range:IDBKeyRange.only([r.indexId,this.uid,this.mn(r,t)])},(o,c)=>{i=i.add(new br(r.indexId,t,c.arrayValue,c.directionalValue))}).next(()=>i)}Sn(e,t){let r=new ge(On);const s=this.Vn(t,e);if(s==null)return r;const i=ul(t);if(i!=null){const o=e.data.field(i.fieldPath);if(Xi(o))for(const c of o.arrayValue.values||[])r=r.add(new br(t.indexId,e.key,this.dn(c),s))}else r=r.add(new br(t.indexId,e.key,$o,s));return r}bn(e,t,r,s,i){M("IndexedDbIndexManager","Updating index entries for document '%s'",t.key);const o=[];return function(l,u,h,p,g){const w=l.getIterator(),A=u.getIterator();let P=ds(w),D=ds(A);for(;P||D;){let N=!1,V=!1;if(P&&D){const F=h(P,D);F<0?V=!0:F>0&&(N=!0)}else P!=null?V=!0:N=!0;N?(p(D),D=ds(A)):V?(g(P),P=ds(w)):(P=ds(w),D=ds(A))}}(s,i,On,c=>{o.push(this.Dn(e,t,r,c))},c=>{o.push(this.vn(e,t,r,c))}),k.waitFor(o)}yn(e){let t=1;return fs(e).J({index:"sequenceNumberIndex",reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,s,i)=>{i.done(),t=s.sequenceNumber+1}).next(()=>t)}createRange(e,t,r){r=r.sort((o,c)=>On(o,c)).filter((o,c,l)=>!c||On(o,l[c-1])!==0);const s=[];s.push(e);for(const o of r){const c=On(o,e),l=On(o,t);if(c===0)s[0]=e.Zt();else if(c>0&&l<0)s.push(o),s.push(o.Zt());else if(l>0)break}s.push(t);const i=[];for(let o=0;o<s.length;o+=2){if(this.Cn(s[o],s[o+1]))return[];const c=[s[o].indexId,this.uid,s[o].arrayValue,s[o].directionalValue,$o,[]],l=[s[o+1].indexId,this.uid,s[o+1].arrayValue,s[o+1].directionalValue,$o,[]];i.push(IDBKeyRange.bound(c,l))}return i}Cn(e,t){return On(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(rf)}getMinOffset(e,t){return k.mapArray(this.hn(t),r=>this.Pn(e,r).next(s=>s||W())).next(rf)}}function nf(n){return He(n,"collectionParents")}function hs(n){return He(n,"indexEntries")}function yi(n){return He(n,"indexConfiguration")}function fs(n){return He(n,"indexState")}function rf(n){X(n.length!==0);let e=n[0].indexState.offset,t=e.largestBatchId;for(let r=1;r<n.length;r++){const s=n[r].indexState.offset;Xl(s,e)<0&&(e=s),t<s.largestBatchId&&(t=s.largestBatchId)}return new kt(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rg(n,e,t){const r=n.store("mutations"),s=n.store("documentMutations"),i=[],o=IDBKeyRange.only(t.batchId);let c=0;const l=r.J({range:o},(h,p,g)=>(c++,g.delete()));i.push(l.next(()=>{X(c===1)}));const u=[];for(const h of t.mutations){const p=op(e,h.key.path,t.batchId);i.push(s.delete(p)),u.push(h.key)}return k.waitFor(i).next(()=>u)}function Sa(n){if(!n)return 0;let e;if(n.document)e=n.document;else if(n.unknownDocument)e=n.unknownDocument;else{if(!n.noDocument)throw W();e=n.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wt.DEFAULT_COLLECTION_PERCENTILE=10,wt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,wt.DEFAULT=new wt(41943040,wt.DEFAULT_COLLECTION_PERCENTILE,wt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),wt.DISABLED=new wt(-1,0,0);class Ya{constructor(e,t,r,s){this.userId=e,this.serializer=t,this.indexManager=r,this.referenceDelegate=s,this.Fn={}}static lt(e,t,r,s){X(e.uid!=="");const i=e.isAuthenticated()?e.uid:"";return new Ya(i,t,r,s)}checkEmpty(e){let t=!0;const r=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return Mn(e).J({index:"userMutationsIndex",range:r},(s,i,o)=>{t=!1,o.done()}).next(()=>t)}addMutationBatch(e,t,r,s){const i=_s(e),o=Mn(e);return o.add({}).next(c=>{X(typeof c=="number");const l=new au(c,t,r,s),u=function(w,A,P){const D=P.baseMutations.map(V=>Ea(w.ct,V)),N=P.mutations.map(V=>Ea(w.ct,V));return{userId:A,batchId:P.batchId,localWriteTimeMs:P.localWriteTime.toMillis(),baseMutations:D,mutations:N}}(this.serializer,this.userId,l),h=[];let p=new ge((g,w)=>se(g.canonicalString(),w.canonicalString()));for(const g of s){const w=op(this.userId,g.key.path,c);p=p.add(g.key.path.popLast()),h.push(o.put(u)),h.push(i.put(w,JT))}return p.forEach(g=>{h.push(this.indexManager.addToCollectionParentIndex(e,g))}),e.addOnCommittedListener(()=>{this.Fn[c]=l.keys()}),k.waitFor(h).next(()=>l)})}lookupMutationBatch(e,t){return Mn(e).get(t).next(r=>r?(X(r.userId===this.userId),Tr(this.serializer,r)):null)}Mn(e,t){return this.Fn[t]?k.resolve(this.Fn[t]):this.lookupMutationBatch(e,t).next(r=>{if(r){const s=r.keys();return this.Fn[t]=s,s}return null})}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=IDBKeyRange.lowerBound([this.userId,r]);let i=null;return Mn(e).J({index:"userMutationsIndex",range:s},(o,c,l)=>{c.userId===this.userId&&(X(c.batchId>=r),i=Tr(this.serializer,c)),l.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(e){const t=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let r=-1;return Mn(e).J({index:"userMutationsIndex",range:t,reverse:!0},(s,i,o)=>{r=i.batchId,o.done()}).next(()=>r)}getAllMutationBatches(e){const t=IDBKeyRange.bound([this.userId,-1],[this.userId,Number.POSITIVE_INFINITY]);return Mn(e).U("userMutationsIndex",t).next(r=>r.map(s=>Tr(this.serializer,s)))}getAllMutationBatchesAffectingDocumentKey(e,t){const r=Xo(this.userId,t.path),s=IDBKeyRange.lowerBound(r),i=[];return _s(e).J({range:s},(o,c,l)=>{const[u,h,p]=o,g=Jt(h);if(u===this.userId&&t.path.isEqual(g))return Mn(e).get(p).next(w=>{if(!w)throw W();X(w.userId===this.userId),i.push(Tr(this.serializer,w))});l.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new ge(se);const s=[];return t.forEach(i=>{const o=Xo(this.userId,i.path),c=IDBKeyRange.lowerBound(o),l=_s(e).J({range:c},(u,h,p)=>{const[g,w,A]=u,P=Jt(w);g===this.userId&&i.path.isEqual(P)?r=r.add(A):p.done()});s.push(l)}),k.waitFor(s).next(()=>this.xn(e,r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1,i=Xo(this.userId,r),o=IDBKeyRange.lowerBound(i);let c=new ge(se);return _s(e).J({range:o},(l,u,h)=>{const[p,g,w]=l,A=Jt(g);p===this.userId&&r.isPrefixOf(A)?A.length===s&&(c=c.add(w)):h.done()}).next(()=>this.xn(e,c))}xn(e,t){const r=[],s=[];return t.forEach(i=>{s.push(Mn(e).get(i).next(o=>{if(o===null)throw W();X(o.userId===this.userId),r.push(Tr(this.serializer,o))}))}),k.waitFor(s).next(()=>r)}removeMutationBatch(e,t){return rg(e._e,this.userId,t).next(r=>(e.addOnCommittedListener(()=>{this.On(t.batchId)}),k.forEach(r,s=>this.referenceDelegate.markPotentiallyOrphaned(e,s))))}On(e){delete this.Fn[e]}performConsistencyCheck(e){return this.checkEmpty(e).next(t=>{if(!t)return k.resolve();const r=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),s=[];return _s(e).J({range:r},(i,o,c)=>{if(i[0]===this.userId){const l=Jt(i[1]);s.push(l)}else c.done()}).next(()=>{X(s.length===0)})})}containsKey(e,t){return sg(e,this.userId,t)}Nn(e){return ig(e).get(this.userId).next(t=>t||{userId:this.userId,lastAcknowledgedBatchId:-1,lastStreamToken:""})}}function sg(n,e,t){const r=Xo(e,t.path),s=r[1],i=IDBKeyRange.lowerBound(r);let o=!1;return _s(n).J({range:i,H:!0},(c,l,u)=>{const[h,p,g]=c;h===e&&p===s&&(o=!0),u.done()}).next(()=>o)}function Mn(n){return He(n,"mutations")}function _s(n){return He(n,"documentMutations")}function ig(n){return He(n,"mutationQueues")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mb{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.qn(e).next(t=>{const r=new Ur(t.highestTargetId);return t.highestTargetId=r.next(),this.Qn(e,t).next(()=>t.highestTargetId)})}getLastRemoteSnapshotVersion(e){return this.qn(e).next(t=>ee.fromTimestamp(new De(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds)))}getHighestSequenceNumber(e){return this.qn(e).next(t=>t.highestListenSequenceNumber)}setTargetsMetadata(e,t,r){return this.qn(e).next(s=>(s.highestListenSequenceNumber=t,r&&(s.lastRemoteSnapshotVersion=r.toTimestamp()),t>s.highestListenSequenceNumber&&(s.highestListenSequenceNumber=t),this.Qn(e,s)))}addTargetData(e,t){return this.Kn(e,t).next(()=>this.qn(e).next(r=>(r.targetCount+=1,this.$n(t,r),this.Qn(e,r))))}updateTargetData(e,t){return this.Kn(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next(()=>ms(e).delete(t.targetId)).next(()=>this.qn(e)).next(r=>(X(r.targetCount>0),r.targetCount-=1,this.Qn(e,r)))}removeTargets(e,t,r){let s=0;const i=[];return ms(e).J((o,c)=>{const l=Ri(c);l.sequenceNumber<=t&&r.get(l.targetId)===null&&(s++,i.push(this.removeTargetData(e,l)))}).next(()=>k.waitFor(i)).next(()=>s)}forEachTarget(e,t){return ms(e).J((r,s)=>{const i=Ri(s);t(i)})}qn(e){return of(e).get("targetGlobalKey").next(t=>(X(t!==null),t))}Qn(e,t){return of(e).put("targetGlobalKey",t)}Kn(e,t){return ms(e).put(Zp(this.serializer,t))}$n(e,t){let r=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,r=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,r=!0),r}getTargetCount(e){return this.qn(e).next(t=>t.targetCount)}getTargetData(e,t){const r=Mr(t),s=IDBKeyRange.bound([r,Number.NEGATIVE_INFINITY],[r,Number.POSITIVE_INFINITY]);let i=null;return ms(e).J({range:s,index:"queryTargetsIndex"},(o,c,l)=>{const u=Ri(c);uo(t,u.target)&&(i=u,l.done())}).next(()=>i)}addMatchingKeys(e,t,r){const s=[],i=jn(e);return t.forEach(o=>{const c=gt(o.path);s.push(i.put({targetId:r,path:c})),s.push(this.referenceDelegate.addReference(e,r,o))}),k.waitFor(s)}removeMatchingKeys(e,t,r){const s=jn(e);return k.forEach(t,i=>{const o=gt(i.path);return k.waitFor([s.delete([r,o]),this.referenceDelegate.removeReference(e,r,i)])})}removeMatchingKeysForTargetId(e,t){const r=jn(e),s=IDBKeyRange.bound([t],[t+1],!1,!0);return r.delete(s)}getMatchingKeysForTargetId(e,t){const r=IDBKeyRange.bound([t],[t+1],!1,!0),s=jn(e);let i=ce();return s.J({range:r,H:!0},(o,c,l)=>{const u=Jt(o[1]),h=new j(u);i=i.add(h)}).next(()=>i)}containsKey(e,t){const r=gt(t.path),s=IDBKeyRange.bound([r],[Zm(r)],!1,!0);let i=0;return jn(e).J({index:"documentTargetsIndex",H:!0,range:s},([o,c],l,u)=>{o!==0&&(i++,u.done())}).next(()=>i>0)}ot(e,t){return ms(e).get(t).next(r=>r?Ri(r):null)}}function ms(n){return He(n,"targets")}function of(n){return He(n,"targetGlobal")}function jn(n){return He(n,"targetDocuments")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu{constructor(){this.Tr=new ge(Xe.Er),this.dr=new ge(Xe.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new Xe(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new Xe(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new j(new fe([])),r=new Xe(t,e),s=new Xe(t,e+1),i=[];return this.dr.forEachInRange([r,s],o=>{this.Vr(o),i.push(o.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new j(new fe([])),r=new Xe(t,e),s=new Xe(t,e+1);let i=ce();return this.dr.forEachInRange([r,s],o=>{i=i.add(o.key)}),i}containsKey(e){const t=new Xe(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class Xe{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return j.comparator(e.key,t.key)||se(e.wr,t.wr)}static Ar(e,t){return se(e.wr,t.wr)||j.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sb{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Sr=1,this.br=new ge(Xe.Er)}checkEmpty(e){return k.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,s){const i=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new au(i,t,r,s);this.mutationQueue.push(o);for(const c of s)this.br=this.br.add(new Xe(c.key,i)),this.indexManager.addToCollectionParentIndex(e,c.key.path.popLast());return k.resolve(o)}lookupMutationBatch(e,t){return k.resolve(this.Dr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=this.vr(r),i=s<0?0:s;return k.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return k.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return k.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new Xe(t,0),s=new Xe(t,Number.POSITIVE_INFINITY),i=[];return this.br.forEachInRange([r,s],o=>{const c=this.Dr(o.wr);i.push(c)}),k.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new ge(se);return t.forEach(s=>{const i=new Xe(s,0),o=new Xe(s,Number.POSITIVE_INFINITY);this.br.forEachInRange([i,o],c=>{r=r.add(c.wr)})}),k.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1;let i=r;j.isDocumentKey(i)||(i=i.child(""));const o=new Xe(new j(i),0);let c=new ge(se);return this.br.forEachWhile(l=>{const u=l.key.path;return!!r.isPrefixOf(u)&&(u.length===s&&(c=c.add(l.wr)),!0)},o),k.resolve(this.Cr(c))}Cr(e){const t=[];return e.forEach(r=>{const s=this.Dr(r);s!==null&&t.push(s)}),t}removeMutationBatch(e,t){X(this.Fr(t.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return k.forEach(t.mutations,s=>{const i=new Xe(s.key,t.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,t){const r=new Xe(t,0),s=this.br.firstAfterOrEqual(r);return k.resolve(t.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,k.resolve()}Fr(e,t){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const t=this.vr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dg{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return im()?8:sp(ze())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Yi(e,t).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Zi(e,t,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new Nb;return this.Xi(e,t,o).next(c=>{if(i.result=c,this.zi)return this.es(e,t,o,c.size)})}).next(()=>i.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(ps()<=le.DEBUG&&M("QueryEngine","SDK will not create cache indexes for query:",gs(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),k.resolve()):(ps()<=le.DEBUG&&M("QueryEngine","Query:",gs(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(ps()<=le.DEBUG&&M("QueryEngine","The SDK decides to create cache indexes for query:",gs(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Ct(t))):k.resolve())}Yi(e,t){if(Oh(t))return k.resolve(null);let r=Ct(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=vl(t,null,"F"),r=Ct(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=ce(...i);return this.Ji.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.ts(t,c);return this.ns(t,u,o,l.readTime)?this.Yi(e,vl(t,null,"F")):this.rs(e,u,t,l)}))})))}Zi(e,t,r,s){return Oh(t)||s.isEqual(ee.min())?k.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const o=this.ts(t,i);return this.ns(t,o,r,s)?k.resolve(null):(ps()<=le.DEBUG&&M("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),gs(t)),this.rs(e,o,t,ep(s,-1)).next(c=>c))})}ts(e,t){let r=new ge(Sp(e));return t.forEach((s,i)=>{ho(e,i)&&(r=r.add(i))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Xi(e,t,r){return ps()<=le.DEBUG&&M("QueryEngine","Using full collection scan to execute query:",gs(t)),this.Ji.getDocumentsMatchingQuery(e,t,kt.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const at="WebChannelConnection";class Ub extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,o){const c=Gc(),l=this.xo(t,r.toUriEncodedString());M("RestConnection",`Sending RPC '${t}' ${c}:`,l,s);const u={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(u,i,o),this.No(t,l,u,s).then(h=>(M("RestConnection",`Received RPC '${t}' ${c}: `,h),h),h=>{throw Ki("RestConnection",`RPC '${t}' ${c} failed with error: `,h,"url: ",l,"request:",s),h})}Lo(t,r,s,i,o,c){return this.Mo(t,r,s,i,o)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+js}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>t[o]=i),s&&s.headers.forEach((i,o)=>t[o]=i)}xo(t,r){const s=Fb[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=Gc();return new Promise((o,c)=>{const l=new Hm;l.setWithCredentials(!0),l.listenOnce(Wm.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case Yo.NO_ERROR:const h=l.getResponseJson();M(at,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(h)),o(h);break;case Yo.TIMEOUT:M(at,`RPC '${e}' ${i} timed out`),c(new U(L.DEADLINE_EXCEEDED,"Request time out"));break;case Yo.HTTP_ERROR:const p=l.getStatus();if(M(at,`RPC '${e}' ${i} failed with status:`,p,"response text:",l.getResponseText()),p>0){let g=l.getResponseJson();Array.isArray(g)&&(g=g[0]);const w=g==null?void 0:g.error;if(w&&w.status&&w.message){const A=function(D){const N=D.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(N)>=0?N:L.UNKNOWN}(w.status);c(new U(A,w.message))}else c(new U(L.UNKNOWN,"Server responded with status "+l.getStatus()))}else c(new U(L.UNAVAILABLE,"Connection failed."));break;default:W()}}finally{M(at,`RPC '${e}' ${i} completed.`)}});const u=JSON.stringify(s);M(at,`RPC '${e}' ${i} sending request:`,s),l.send(t,"POST",u,r,15)})}Bo(e,t,r){const s=Gc(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Jm(),c=Ym(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Oo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const h=i.join("");M(at,`Creating RPC '${e}' stream ${s}: ${h}`,l);const p=o.createWebChannel(h,l);let g=!1,w=!1;const A=new $b({Io:D=>{w?M(at,`Not sending because RPC '${e}' stream ${s} is closed:`,D):(g||(M(at,`Opening RPC '${e}' stream ${s} transport.`),p.open(),g=!0),M(at,`RPC '${e}' stream ${s} sending:`,D),p.send(D))},To:()=>p.close()}),P=(D,N,V)=>{D.listen(N,F=>{try{V(F)}catch(q){setTimeout(()=>{throw q},0)}})};return P(p,bi.EventType.OPEN,()=>{w||(M(at,`RPC '${e}' stream ${s} transport opened.`),A.yo())}),P(p,bi.EventType.CLOSE,()=>{w||(w=!0,M(at,`RPC '${e}' stream ${s} transport closed`),A.So())}),P(p,bi.EventType.ERROR,D=>{w||(w=!0,Ki(at,`RPC '${e}' stream ${s} transport errored:`,D),A.So(new U(L.UNAVAILABLE,"The operation could not be completed")))}),P(p,bi.EventType.MESSAGE,D=>{var N;if(!w){const V=D.data[0];X(!!V);const F=V,q=F.error||((N=F[0])===null||N===void 0?void 0:N.error);if(q){M(at,`RPC '${e}' stream ${s} received error:`,q);const te=q.status;let Z=function(T){const S=je[T];if(S!==void 0)return Bp(S)}(te),b=q.message;Z===void 0&&(Z=L.INTERNAL,b="Unknown error status: "+te+" with message "+q.message),w=!0,A.So(new U(Z,b)),p.close()}else M(at,`RPC '${e}' stream ${s} received:`,V),A.bo(V)}}),P(c,Qm.STAT_EVENT,D=>{D.stat===ll.PROXY?M(at,`RPC '${e}' stream ${s} detected buffering proxy`):D.stat===ll.NOPROXY&&M(at,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{A.wo()},0),A}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gb extends class{}{constructor(e,t,r,s){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=r,this.serializer=s,this.y_=!1}w_(){if(this.y_)throw new U(L.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,t,r,s){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.Mo(e,wl(t,r),s,i,o)).catch(i=>{throw i.name==="FirebaseError"?(i.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new U(L.UNKNOWN,i.toString())})}Lo(e,t,r,s,i){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,c])=>this.connection.Lo(e,wl(t,r),s,o,c,i)).catch(o=>{throw o.name==="FirebaseError"?(o.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new U(L.UNKNOWN,o.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class Kb{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(e){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,e==="Online"&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(){this.W_=new Ie(j.comparator)}track(e){const t=e.doc.key,r=this.W_.get(t);r?e.type!==0&&r.type===3?this.W_=this.W_.insert(t,e):e.type===3&&r.type!==1?this.W_=this.W_.insert(t,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.W_=this.W_.insert(t,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.W_=this.W_.remove(t):e.type===1&&r.type===2?this.W_=this.W_.insert(t,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):W():this.W_=this.W_.insert(t,e)}G_(){const e=[];return this.W_.inorderTraversal((t,r)=>{e.push(r)}),e}}class Vs{constructor(e,t,r,s,i,o,c,l,u){this.query=e,this.docs=t,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=i,this.fromCache=o,this.syncStateChanged=c,this.excludesMetadataChanges=l,this.hasCachedResults=u}static fromInitialDocuments(e,t,r,s,i){const o=[];return t.forEach(c=>{o.push({type:0,doc:c})}),new Vs(e,t,bs.emptySet(t),o,r,s,!0,!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Ka(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,r=e.docChanges;if(t.length!==r.length)return!1;for(let s=0;s<t.length;s++)if(t[s].type!==r[s].type||!t[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jr{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Jr(this.firestore,e,this._query)}}class vt{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Hn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new vt(this.firestore,e,this._key)}}class Hn extends Jr{constructor(e,t,r){super(e,t,Ga(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new vt(this.firestore,null,new j(e))}withConverter(e){return new Hn(this.firestore,e,this._path)}}function qe(n,e,...t){if(n=be(n),Cu("collection","path",e),n instanceof rc){const r=fe.fromString(e,...t);return bf(r),new Hn(n,null,r)}{if(!(n instanceof vt||n instanceof Hn))throw new U(L.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(fe.fromString(e,...t));return bf(r),new Hn(n.firestore,null,r)}}function OA(n,e){if(n=Ut(n,rc),Cu("collectionGroup","collection id",e),e.indexOf("/")>=0)throw new U(L.INVALID_ARGUMENT,`Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);return new Jr(n,null,function(r){return new qs(fe.emptyPath(),r)}(e))}function ne(n,e,...t){if(n=be(n),arguments.length===1&&(e=Xm.newId()),Cu("doc","path",e),n instanceof rc){const r=fe.fromString(e,...t);return Ef(r),new vt(n,null,new j(r))}{if(!(n instanceof vt||n instanceof Hn))throw new U(L.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(fe.fromString(e,...t));return Ef(r),new vt(n.firestore,n instanceof Hn?n.converter:null,new j(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Ms($e.fromBase64String(e))}catch(t){throw new U(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Ms($e.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sc{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new U(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ke(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Du{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new U(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new U(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return se(this._lat,e._lat)||se(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FA=/^__.*__$/;class $A{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new In(e,this.data,this.fieldMask,t,this.fieldTransforms):new Gs(e,this.data,t,this.fieldTransforms)}}class Ug{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new In(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function jg(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw W()}}class ic{constructor(e,t,r,s,i,o){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.vu(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new ic(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),s=this.Fu({path:r,xu:!1});return s.Ou(e),s}Nu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),s=this.Fu({path:r,xu:!1});return s.vu(),s}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return Da(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(jg(this.Cu)&&FA.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class UA{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Xa(e)}Qu(e,t,r,s=!1){return new ic({Cu:e,methodName:t,qu:r,path:ke.emptyPath(),xu:!1,ku:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function oc(n){const e=n._freezeSettings(),t=Xa(n._databaseId);return new UA(n._databaseId,!!e.ignoreUndefinedProperties,t)}function qg(n,e,t,r,s,i={}){const o=n.Qu(i.merge||i.mergeFields?2:0,e,t,s);Vu("Data must be an object, but it was:",o,r);const c=Gg(r,o);let l,u;if(i.merge)l=new Tt(o.fieldMask),u=o.fieldTransforms;else if(i.mergeFields){const h=[];for(const p of i.mergeFields){const g=Dl(e,p,t);if(!o.contains(g))throw new U(L.INVALID_ARGUMENT,`Field '${g}' is specified in your field mask but missing from your input data.`);zg(h,g)||h.push(g)}l=new Tt(h),u=o.fieldTransforms.filter(p=>l.covers(p.field))}else l=null,u=o.fieldTransforms;return new $A(new lt(c),l,u)}class ac extends go{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ac}}function jA(n,e,t){return new ic({Cu:3,qu:e.settings.qu,methodName:n._methodName,xu:t},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class xu extends go{_toFieldTransform(e){return new ou(e.path,new ks)}isEqual(e){return e instanceof xu}}class Lu extends go{constructor(e,t){super(e),this.Ku=t}_toFieldTransform(e){const t=jA(this,e,!0),r=this.Ku.map(i=>Hs(i,t)),s=new Br(r);return new ou(e.path,s)}isEqual(e){return e instanceof Lu&&As(this.Ku,e.Ku)}}function qA(n,e,t,r){const s=n.Qu(1,e,t);Vu("Data must be an object, but it was:",s,r);const i=[],o=lt.empty();Qr(r,(l,u)=>{const h=Ou(e,l,t);u=be(u);const p=s.Nu(h);if(u instanceof ac)i.push(h);else{const g=Hs(u,p);g!=null&&(i.push(h),o.set(h,g))}});const c=new Tt(i);return new Ug(o,c,s.fieldTransforms)}function GA(n,e,t,r,s,i){const o=n.Qu(1,e,t),c=[Dl(e,r,t)],l=[s];if(i.length%2!=0)throw new U(L.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let g=0;g<i.length;g+=2)c.push(Dl(e,i[g])),l.push(i[g+1]);const u=[],h=lt.empty();for(let g=c.length-1;g>=0;--g)if(!zg(u,c[g])){const w=c[g];let A=l[g];A=be(A);const P=o.Nu(w);if(A instanceof ac)u.push(w);else{const D=Hs(A,P);D!=null&&(u.push(w),h.set(w,D))}}const p=new Tt(u);return new Ug(h,p,o.fieldTransforms)}function KA(n,e,t,r=!1){return Hs(t,n.Qu(r?4:3,e))}function Hs(n,e){if(Kg(n=be(n)))return Vu("Unsupported field value:",e,n),Gg(n,e);if(n instanceof go)return function(r,s){if(!jg(s.Cu))throw s.Bu(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Bu(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(r,s){const i=[];let o=0;for(const c of r){let l=Hs(c,s.Lu(o));l==null&&(l={nullValue:"NULL_VALUE"}),i.push(l),o++}return{arrayValue:{values:i}}}(n,e)}return function(r,s){if((r=be(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return xE(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=De.fromDate(r);return{timestampValue:Ns(s.serializer,i)}}if(r instanceof De){const i=new De(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Ns(s.serializer,i)}}if(r instanceof Du)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Ms)return{bytesValue:Up(s.serializer,r._byteString)};if(r instanceof vt){const i=s.databaseId,o=r.firestore._databaseId;if(!o.isEqual(i))throw s.Bu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:du(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof Nu)return function(o,c){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:o.toArray().map(l=>{if(typeof l!="number")throw c.Bu("VectorValues must only contain numeric values.");return iu(c.serializer,l)})}}}}}}(r,s);throw s.Bu(`Unsupported field value: ${nc(r)}`)}(n,e)}function Gg(n,e){const t={};return up(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Qr(n,(r,s)=>{const i=Hs(s,e.Mu(r));i!=null&&(t[r]=i)}),{mapValue:{fields:t}}}function Kg(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof De||n instanceof Du||n instanceof Ms||n instanceof vt||n instanceof go||n instanceof Nu)}function Vu(n,e,t){if(!Kg(t)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(t)){const r=nc(t);throw r==="an object"?e.Bu(n+" a custom object"):e.Bu(n+" "+r)}}function Dl(n,e,t){if((e=be(e))instanceof sc)return e._internalPath;if(typeof e=="string")return Ou(n,e);throw Da("Field path arguments must be of type string or ",n,!1,void 0,t)}const zA=new RegExp("[~\\*/\\[\\]]");function Ou(n,e,t){if(e.search(zA)>=0)throw Da(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new sc(...e.split("."))._internalPath}catch{throw Da(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Da(n,e,t,r,s){const i=r&&!r.isEmpty(),o=s!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let l="";return(i||o)&&(l+=" (found",i&&(l+=` in field ${r}`),o&&(l+=` in document ${s}`),l+=")"),new U(L.INVALID_ARGUMENT,c+n+l)}function zg(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WA(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new U(L.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Bu{}class QA extends Bu{}function Bs(n,e,...t){let r=[];e instanceof Bu&&r.push(e),r=r.concat(t),function(i){const o=i.filter(l=>l instanceof Fu).length,c=i.filter(l=>l instanceof cc).length;if(o>1||o>0&&c>0)throw new U(L.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const s of r)n=s._apply(n);return n}class cc extends QA{constructor(e,t,r){super(),this._field=e,this._op=t,this._value=r,this.type="where"}static _create(e,t,r){return new cc(e,t,r)}_apply(e){const t=this._parse(e);return Wg(e._query,t),new Jr(e.firestore,e.converter,yl(e._query,t))}_parse(e){const t=oc(e.firestore);return function(i,o,c,l,u,h,p){let g;if(u.isKeyField()){if(h==="array-contains"||h==="array-contains-any")throw new U(L.INVALID_ARGUMENT,`Invalid Query. You can't perform '${h}' queries on documentId().`);if(h==="in"||h==="not-in"){Pf(p,h);const w=[];for(const A of p)w.push(Rf(l,i,A));g={arrayValue:{values:w}}}else g=Rf(l,i,p)}else h!=="in"&&h!=="not-in"&&h!=="array-contains-any"||Pf(p,h),g=KA(c,o,p,h==="in"||h==="not-in");return ue.create(u,h,g)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}function Cr(n,e,t){const r=e,s=Mu("where",n);return cc._create(s,r,t)}class Fu extends Bu{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Fu(e,t)}_parse(e){const t=this._queryConstraints.map(r=>r._parse(e)).filter(r=>r.getFilters().length>0);return t.length===1?t[0]:pe.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(s,i){let o=s;const c=i.getFlattenedFilters();for(const l of c)Wg(o,l),o=yl(o,l)}(e._query,t),new Jr(e.firestore,e.converter,yl(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}function Rf(n,e,t){if(typeof(t=be(t))=="string"){if(t==="")throw new U(L.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Ep(e)&&t.indexOf("/")!==-1)throw new U(L.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const r=e.path.child(fe.fromString(t));if(!j.isDocumentKey(r))throw new U(L.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Ji(n,new j(r))}if(t instanceof vt)return Ji(n,t._key);throw new U(L.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${nc(t)}.`)}function Pf(n,e){if(!Array.isArray(n)||n.length===0)throw new U(L.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function Wg(n,e){const t=function(s,i){for(const o of s)for(const c of o.getFlattenedFilters())if(i.indexOf(c.op)>=0)return c.op;return null}(n.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new U(L.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new U(L.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class YA{convertValue(e,t="none"){switch(Or(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Ae(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(Qn(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw W()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const r={};return Qr(e,(s,i)=>{r[s]=this.convertValue(i,t)}),r}convertVectorValue(e){var t,r,s;const i=(s=(r=(t=e.fields)===null||t===void 0?void 0:t.value.arrayValue)===null||r===void 0?void 0:r.values)===null||s===void 0?void 0:s.map(o=>Ae(o.doubleValue));return new Nu(i)}convertGeoPoint(e){return new Du(Ae(e.latitude),Ae(e.longitude))}convertArray(e,t){return(e.values||[]).map(r=>this.convertValue(r,t))}convertServerTimestamp(e,t){switch(t){case"previous":const r=nu(e);return r==null?null:this.convertValue(r,t);case"estimate":return this.convertTimestamp(Qi(e));default:return null}}convertTimestamp(e){const t=vn(e);return new De(t.seconds,t.nanos)}convertDocumentKey(e,t){const r=fe.fromString(e);X(Jp(r));const s=new Vr(r.get(1),r.get(3)),i=new j(r.popFirst(5));return s.isEqual(t)||Fe(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pt{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let r;try{r=Pt.makeFromUrl(e,t)}catch{return new Pt(e,"")}if(r.path==="")return r;throw gS(e)}static makeFromUrl(e,t){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(q){q.path.charAt(q.path.length-1)==="/"&&(q.path_=q.path_.slice(0,-1))}const o="(/(.*))?$",c=new RegExp("^gs://"+s+o,"i"),l={bucket:1,path:3};function u(q){q.path_=decodeURIComponent(q.path)}const h="v[A-Za-z0-9_]+",p=t.replace(/[.]/g,"\\."),g="(/([^?#]*).*)?$",w=new RegExp(`^https?://${p}/${h}/b/${s}/o${g}`,"i"),A={bucket:1,path:3},P=t===ey?"(?:storage.googleapis.com|storage.cloud.google.com)":t,D="([^?#]*)",N=new RegExp(`^https?://${P}/${s}/${D}`,"i"),F=[{regex:c,indices:l,postModify:i},{regex:w,indices:A,postModify:u},{regex:N,indices:{bucket:1,path:2},postModify:u}];for(let q=0;q<F.length;q++){const te=F[q],Z=te.regex.exec(e);if(Z){const b=Z[te.indices.bucket];let _=Z[te.indices.path];_||(_=""),r=new Pt(b,_),te.postModify(r);break}}if(r==null)throw pS(e);return r}}class TS{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ES(n,e,t){let r=1,s=null,i=null,o=!1,c=0;function l(){return c===2}let u=!1;function h(...D){u||(u=!0,e.apply(null,D))}function p(D){s=setTimeout(()=>{s=null,n(w,l())},D)}function g(){i&&clearTimeout(i)}function w(D,...N){if(u){g();return}if(D){g(),h.call(null,D,...N);return}if(l()||o){g(),h.call(null,D,...N);return}r<64&&(r*=2);let F;c===1?(c=2,F=0):F=(r+Math.random())*1e3,p(F)}let A=!1;function P(D){A||(A=!0,g(),!u&&(s!==null?(D||(c=2),clearTimeout(s),p(0)):D||(c=1)))}return p(0),i=setTimeout(()=>{o=!0,P(!0)},t),P}function bS(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}const u=l.scores.flat().filter(g=>g!=null),h=u.length?(u.reduce((g,w)=>g+ve(w),0)/u.length).toFixed(2):"—",p=Zu(l.scores,n.ruleset);if(t+=y("email.totalLabel")+dt(l.scores)+y("email.pointWord")+`
`,s>=2){const g=l.scores.map(D=>(D||[])[0]).filter(D=>D!=null),w=l.scores.map(D=>(D||[])[1]).filter(D=>D!=null),A=g.length?(g.reduce((D,N)=>D+ve(N),0)/g.length).toFixed(2):"—",P=w.length?(w.reduce((D,N)=>D+ve(N),0)/w.length).toFixed(2):"—";t+="  "+y("email.arrow1Label")+": "+A+" | "+y("email.arrow2Label")+": "+P+" | "+y("email.overallAvgLabel")+": "+h+`
...
${y("email.loginRequired")}`);const i=n.shooters.map(l=>{var u;return(u=m.friends.find(h=>h.id===l.id))==null?void 0:u.email}).filter(Boolean),o=y("email.subjectPrefix")+n.name,c="mailto:"+i.join(",")+"?subject="+encodeURIComponent(o)+"&body="+encodeURIComponent(t);window.location.href=c};const lv="archery_meetups_seen",Gf={afventer:"statusPending",tilmeldt:"statusAccepted",foreslået:"statusProposing",afvist:"statusDeclined"};function el(n){if(!n)return"";const[e,t,r]=n.split("-");return e&&t&&r?`${r}-${t}-${e}`:n}let rt=new Map,_o="venner",Ni=null,uv=null,id=null,dv=null;async function od(){if(m.user)try{const n=[Ke(Bs(qe(G,"meetups"),Cr("creatorUid","==",m.user.uid))),Ke(Bs(qe(G,"meetups"),Cr("invitedUids","array-contains",m.user.uid)))];m.isSuperAdmin&&n.push(Ke(qe(G,"meetups")));const e=await Promise.all(n),t=new Map;e.forEach(r=>r.docs.forEach(s=>t.set(s.id,{id:s.id,...s.data()}))),m.meetups=[...t.values()].sort((r,s)=>`${r.date}${r.time}`.localeCompare(`${s.date}${s.time}`))}catch(n){console.warn("Hent meetups:",n)}}function yP(n,e){return n.filter(t=>{var s,i;return(((i=(s=t.updatedAt)==null?void 0:s.toMillis)==null?void 0:i.call(s))??(typeof t.updatedAt=="number"?t.updatedAt:0))>e}).length}function wo(){const n=document.getElementById("meetup-badge");if(!n)return;const e=Number(localStorage.getItem(lv)||0),t=yP(m.meetups,e);n.classList.toggle("hidden",t===0),n.textContent=t}function vP(){localStorage.setItem(lv,String(Date.now())),wo()}function Vt(){const n=document.getElementById("meetups-list");if(!n)return;const e=new Date().toISOString().slice(0,10),t=m.meetups.filter(r=>r.date>=e);if(!t.length){n.innerHTML=`<div class="empty"><div class="empty-icon">🏹</div>${y("meetups.empty")}</div>`;return}n.innerHTML="",t.forEach(r=>n.appendChild(_P(r)))}function _P(n){var u;const e=document.createElement("div");e.className="meetup-card"+(n.status==="aflyst"?" meetup-cancelled":"");const t=n.creatorUid===((u=m.user)==null?void 0:u.uid),r=(n.participants||[]).find(h=>{var p;return h.uid===((p=m.user)==null?void 0:p.uid)}),s=m.isSuperAdmin&&!t&&!r,i=(n.participants||[]).map(h=>{const p=h.status==="foreslået"&&h.proposedDate?` → ${z(el(h.proposedDate))} ${z(h.proposedTime||"")}`:"";return`<div class="meetup-partrow"><span>${z(h.name)}</span><span class="meetup-status meetup-status-${z(h.status)}">${z(Gf[h.status]?y("meetups."+Gf[h.status]):h.status)}${p}</span></div>`}).join(""),o=(n.comments||[]).map(h=>`<div class="meetup-comment"><b>${z(h.name)}:</b> ${z(h.text)}</div>`).join("");let c="";n.status!=="aflyst"&&(r&&(r.status!=="tilmeldt"&&(c+=`<button class="btn btn-gold btn-sm" onclick="joinMeetup('${n.id}')">${y("meetups.joinBtn")}</button>`),c+=`<button class="btn btn-dark btn-sm" onclick="openProposeTimeModal('${n.id}')">${y("meetups.proposeOtherBtn")}</button>`,r.status!=="afvist"&&(c+=`<button class="btn btn-dark btn-sm" onclick="declineMeetup('${n.id}')">${y("meetups.declineBtn")}</button>`)),t&&((n.participants||[]).filter(h=>h.status==="foreslået"&&h.proposedDate).forEach(h=>{c+=`<button class="btn btn-gold btn-sm" onclick="acceptProposedTime('${n.id}','${h.uid}')">${y("meetups.acceptProposalBtn",{date:z(el(h.proposedDate)),time:z(h.proposedTime||""),name:z(h.name)})}</button>`}),c+=`<button class="btn btn-dark btn-sm" onclick="openEditMeetupModal('${n.id}')">${y("meetups.editTimeBtn")}</button>`,c+=`<button class="btn btn-dark btn-sm" onclick="cancelMeetup('${n.id}')">${y("meetups.cancelMeetupBtn")}</button>`,c+=`<button class="btn btn-red btn-sm" onclick="deleteMeetup('${n.id}')">${y("meetups.deleteBtn")}</button>`)),e.innerHTML=`
    ...
    <div class="meetup-head">
      ...
      <div class="meetup-when">${y("meetups.dateTimeLine",{date:z(el(n.date)),time:z(n.time)})}</div>
      <div class="meetup-creator">${y("meetups.createdBy",{name:z(n.creatorName)})}</div>
    </div>
  ...
  `;const l=e.querySelector(".meetup-comment-input");return e.querySelector(".meetup-comment-send").addEventListener("click",()=>{IP(n.id,l.value),l.value=""}),e}window.openMeetupModal=function(){if(!m.courses.length){K(y("meetups.noCoursesToast"),"error");return}rt=new Map,_o="venner",Ni=null,id=null,document.getElementById("mu-course-display").value="",document.getElementById("mu-course-list").classList.add("hidden"),wP(),document.getElementById("mu-date").value="",document.getElementById("mu-time").value="",document.getElementById("mu-comment").value="",document.querySelectorAll(".mu-pool-tab").forEach(n=>n.classList.toggle("active",n.dataset.pool==="venner")),Io(),gc(),document.getElementById("meetup-modal").classList.remove("hidden")};window.toggleMeetupCourseList=function(){document.getElementById("mu-course-list").classList.toggle("hidden")};function wP(){const n=document.getElementById("mu-course-list");n.innerHTML="",m.courses.forEach(e=>{const t=document.createElement("div");t.className="ac-item",t.textContent=e.name||e.yam||"",t.addEventListener("click",()=>{id=e.id,document.getElementById("mu-course-display").value=e.name||e.yam||"",n.classList.add("hidden")}),n.appendChild(t)})}window.toggleMeetupPool=function(n){_o=n,document.querySelectorAll(".mu-pool-tab").forEach(e=>e.classList.toggle("active",e.dataset.pool===n)),Io()};async function Ml(){if(!Ni)try{Ni=(await Ke(qe(G,"users"))).docs.map(e=>({uid:e.id,name:e.data().name||e.data().yam||e.data().email||"—"}))}catch(n){console.warn(n),Ni=[]}return Ni}async function hv(){if(_o==="venner"){const e=new Set((await Ml()).map(t=>t.uid));return m.friends.map(t=>({uid:t.id,name:t.name,registered:e.has(t.id)})).sort((t,r)=>t.name.localeCompare(r.name,"da"))}return(await Ml()).filter(e=>{var t;return e.uid!==((t=m.user)==null?void 0:t.uid)}).map(e=>({...e,registered:!0})).sort((e,t)=>e.name.localeCompare(t.name,"da"))}async function Io(){const n=document.getElementById("mu-invitee-list");if(!n)return;const e=await hv();if(n.innerHTML="",!e.length){n.innerHTML=`<div class="empty"><div class="empty-icon">👤</div>${y(_o==="venner"?"meetups.noFriendsYet":"meetups.noOtherUsers")}</div>`;return}e.forEach(t=>{const r=document.createElement("label");r.className="mu-invitee-row"+(t.registered===!1?" mu-invitee-unregistered":"");const s=document.createElement("input");s.type="checkbox",s.checked=rt.has(t.uid);const i=document.createElement("span");if(i.textContent=t.name,r.appendChild(s),r.appendChild(i),t.registered===!1){s.disabled=!0;const o=document.createElement("span");o.className="mu-invitee-note",o.textContent=y("meetups.notRegisteredNote"),r.appendChild(o)}else s.addEventListener("change",()=>fv(t.uid,t.name));n.appendChild(r)})}function fv(n,e){rt.has(n)?rt.delete(n):rt.set(n,{uid:n,name:e}),gc(),Io()}window.toggleSelectAllMeetup=async function(){const n=(await hv()).filter(t=>t.registered!==!1);if(!n.length)return;n.every(t=>rt.has(t.uid))?n.forEach(t=>rt.delete(t.uid)):n.forEach(t=>rt.set(t.uid,t)),gc(),Io()};function gc(){const n=document.getElementById("mu-selected-chips");if(n){if(n.innerHTML="",!rt.size){n.innerHTML=`<div class="mu-chips-empty">${y("meetups.noRecipientsSelected")}</div>`;return}[...rt.values()].forEach(e=>{const t=document.createElement("div");t.className="pchip";const r=document.createElement("span");r.className="pchip-name",r.textContent=e.name;const s=document.createElement("button");s.className="pchip-rm",s.textContent="✕",s.addEventListener("click",()=>fv(e.uid,e.name)),t.appendChild(r),t.appendChild(s),n.appendChild(t)})}}window.saveMeetup=async function(){var p,g;const n=m.courses.find(w=>w.id===id),e=document.getElementById("mu-date").value,t=document.getElementById("mu-time").value;if(!n){K(y("meetups.selectCourseToast"),"error");return}if(!e||!t){K(y("meetups.selectDateTimeToast"),"error");return}if(!rt.size){K(y("meetups.selectRecipientToast"),"error");return}const r=new Set((await Ml()).map(w=>w.uid)),s=[...rt.values()].filter(w=>!r.has(w.uid)).map(w=>w.name);if(s.length&&(s.forEach(w=>{const A=[...rt.entries()].find(([,P])=>P.name===w);A&&rt.delete(A[0])}),K(y("meetups.invalidNamesToast",{names:s.join(", ")}),"error"),gc(),Io(),!rt.size))return;const i=document.getElementById("mu-comment").value.trim().slice(0,300),o=[...rt.keys()],c=[...rt.values()].map(w=>({uid:w.uid,name:w.name,status:"afventer",proposedDate:null,proposedTime:null})),l=i?[{uid:m.user.uid,name:((p=m.profile)==null?void 0:p.name)||"—",text:i,createdAt:new Date}]:[],u=new Date(`${e}T${t}`);u.setDate(u.getDate()+1);const h={courseId:n.id,courseName:n.name||n.yam||"",date:e,time:t,creatorUid:m.user.uid,creatorName:((g=m.profile)==null?void 0:g.name)||"—",pool:_o,invitedUids:o,participants:c,comments:l,status:"åben",createdAt:Ge(),updatedAt:Ge(),expireAt:u};try{await Xg(qe(G,"meetups"),h),document.getElementById("meetup-modal").classList.add("hidden"),K(y("meetups.proposalSentToast"),"success"),await od(),Vt(),wo()}catch(w){K(y("common.errorPrefix")+w.message,"error")}};async function mv(n,e){const t=m.meetups.find(s=>s.id===n);if(!t||!m.user)return;const r=(t.participants||[]).map(s=>s.uid===m.user.uid?{...s,status:e,proposedDate:null,proposedTime:null}:s);try{await Ze(ne(G,"meetups",t.id),{participants:r,updatedAt:Ge()}),t.participants=r,t.updatedAt=Date.now(),Vt()}catch(s){K(y("common.errorPrefix")+s.message,"error")}}window.joinMeetup=function(n){mv(n,"tilmeldt")};window.declineMeetup=function(n){mv(n,"afvist")};window.openProposeTimeModal=function(n){uv=n,document.getElementById("mu-propose-date").value="",document.getElementById("mu-propose-time").value="",document.getElementById("meetup-propose-modal").classList.remove("hidden")};window.saveProposeTime=async function(){const n=document.getElementById("mu-propose-date").value,e=document.getElementById("mu-propose-time").value;if(!n||!e){K(y("meetups.selectDateTimeToast"),"error");return}const t=m.meetups.find(s=>s.id===uv);if(!t||!m.user)return;const r=(t.participants||[]).map(s=>s.uid===m.user.uid?{...s,status:"foreslået",proposedDate:n,proposedTime:e}:s);try{await Ze(ne(G,"meetups",t.id),{participants:r,updatedAt:Ge()}),t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-propose-modal").classList.add("hidden"),Vt()}catch(s){K(y("common.errorPrefix")+s.message,"error")}};window.acceptProposedTime=async function(n,e){var c;const t=m.meetups.find(l=>l.id===n);if(!t||t.creatorUid!==((c=m.user)==null?void 0:c.uid))return;const r=(t.participants||[]).find(l=>l.uid===e);if(!(r!=null&&r.proposedDate)||!(r!=null&&r.proposedTime))return;const s=r.proposedDate,i=r.proposedTime,o=t.participants.map(l=>l.uid===e?{...l,status:"tilmeldt",proposedDate:null,proposedTime:null}:{...l,status:"afventer",proposedDate:null,proposedTime:null});try{await Ze(ne(G,"meetups",t.id),{date:s,time:i,participants:o,updatedAt:Ge()}),t.date=s,t.time=i,t.participants=o,t.updatedAt=Date.now(),Vt(),K(y("meetups.newTimeAcceptedToast"),"success")}catch(l){K(y("common.errorPrefix")+l.message,"error")}};window.openEditMeetupModal=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||(dv=n,document.getElementById("mu-edit-date").value=e.date,document.getElementById("mu-edit-time").value=e.time,document.getElementById("meetup-edit-modal").classList.remove("hidden"))};window.saveEditMeetup=async function(){var s;const n=document.getElementById("mu-edit-date").value,e=document.getElementById("mu-edit-time").value;if(!n||!e){K(y("meetups.selectDateTimeToast"),"error");return}const t=m.meetups.find(i=>i.id===dv);if(!t||t.creatorUid!==((s=m.user)==null?void 0:s.uid))return;const r=(t.participants||[]).map(i=>({...i,status:"afventer",proposedDate:null,proposedTime:null}));try{await Ze(ne(G,"meetups",t.id),{date:n,time:e,participants:r,updatedAt:Ge()}),t.date=n,t.time=e,t.participants=r,t.updatedAt=Date.now(),document.getElementById("meetup-edit-modal").classList.add("hidden"),Vt(),K(y("meetups.timeUpdatedToast"),"success")}catch(i){K(y("common.errorPrefix")+i.message,"error")}};window.cancelMeetup=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||or(y("meetups.cancelConfirm"),async()=>{try{await Ze(ne(G,"meetups",e.id),{status:"aflyst",updatedAt:Ge()}),e.status="aflyst",e.updatedAt=Date.now(),Vt()}catch(r){K(y("common.errorPrefix")+r.message,"error")}})};window.deleteMeetup=function(n){var t;const e=m.meetups.find(r=>r.id===n);!e||e.creatorUid!==((t=m.user)==null?void 0:t.uid)||or(y("meetups.deleteConfirm"),async()=>{try{await Lt(ne(G,"meetups",e.id)),m.meetups=m.meetups.filter(r=>r.id!==n),Vt(),wo()}catch(r){K(y("common.errorPrefix")+r.message,"error")}})};async function IP(n,e){var i;if(e=(e||"").trim().slice(0,300),!e||!m.user)return;const t=m.meetups.find(o=>o.id===n);if(!t)return;const r={uid:m.user.uid,name:((i=m.profile)==null?void 0:i.name)||"—",text:e,createdAt:new Date},s=[...t.comments||[],r];try{await Ze(ne(G,"meetups",t.id),{comments:s,updatedAt:Ge()}),t.comments=s,t.updatedAt=Date.now(),Vt()}catch(o){K(y("common.errorPrefix")+o.message,"error")}}const pv="archery_share_requests_seen";function TP(n,e){return`${n}_${e}`}async function gv(){if(m.user)try{const[n,e]=await Promise.all([Ke(Bs(qe(G,"shareRequests"),Cr("ownerUid","==",m.user.uid))),Ke(Bs(qe(G,"shareRequests"),Cr("viewerUid","==",m.user.uid)))]),t=new Map;n.docs.forEach(r=>t.set(r.id,{id:r.id,...r.data()})),e.docs.forEach(r=>t.set(r.id,{id:r.id,...r.data()})),m.shareRequests=[...t.values()]}catch(n){console.warn("Hent delingsanmodninger:",n)}}function EP(n,e,t){return n.filter(r=>{var i,o;return r.ownerUid!==e||r.status!=="afventer"?!1:(((o=(i=r.createdAt)==null?void 0:i.toMillis)==null?void 0:o.call(i))??(typeof r.createdAt=="number"?r.createdAt:0))>t}).length}function yc(){var r;const n=document.getElementById("share-badge");if(!n)return;const e=Number(localStorage.getItem(pv)||0),t=EP(m.shareRequests,(r=m.user)==null?void 0:r.uid,e);n.classList.toggle("hidden",t===0),n.textContent=t}function bP(){localStorage.setItem(pv,String(Date.now())),yc()}function yv(){return m.user?m.shareRequests.filter(n=>n.viewerUid===m.user.uid&&n.status==="accepteret").map(n=>({uid:n.ownerUid,name:n.ownerName})).sort((n,e)=>n.name.localeCompare(e.name,"da")):[]}async function vv(n){var e,t,r;try{const s=m.shareRequests.find(p=>{var g;return p.ownerUid===n&&p.viewerUid===((g=m.user)==null?void 0:g.uid)&&p.status==="accepteret"}),i=((t=(e=(s==null?void 0:s.acceptedAt)||(s==null?void 0:s.updatedAt))==null?void 0:e.toMillis)==null?void 0:t.call(e))??0,l=(((r=(await Xn(ne(G,"users",n))).data())==null?void 0:r.roundIndex)||[]).filter(p=>(p.completed||0)>i).map(p=>p.id),h=(await Promise.all(l.map(p=>Xn(ne(G,"users",n,"rounds",p)).catch(()=>null)))).filter(p=>p==null?void 0:p.exists()).map(p=>({...p.data(),id:p.id})).sort((p,g)=>{var P,D;const w=p.completed||p.created||0,A=g.completed||g.created||0;return(typeof A=="number"?A:((P=A.toMillis)==null?void 0:P.call(A))??0)-(typeof w=="number"?w:((D=w.toMillis)==null?void 0:D.call(w))??0)});return m.viewedRounds[n]=h,h}catch(s){return console.warn("Hent delte runder:",s),m.viewedRounds[n]=[],[]}}function ar(){var o;const n=document.getElementById("sharing-list");if(!n)return;const e=(o=m.user)==null?void 0:o.uid,t=m.shareRequests.filter(c=>c.ownerUid===e&&c.status==="afventer"),r=m.shareRequests.filter(c=>c.ownerUid===e&&c.status==="accepteret"),s=m.shareRequests.filter(c=>c.viewerUid===e&&c.status==="accepteret");if(!t.length&&!r.length&&!s.length){n.innerHTML=`<div class="share-empty">${y("sharing.emptyState")}</div>`;return}let i="";t.length&&(i+=`<div class="share-group-title">${y("sharing.incomingRequestsTitle")}</div>`,t.forEach(c=>{i+=`<div class="share-card">
      ...
      </div>`})),n.innerHTML=i}window.requestViewAccess=async function(n,e){var t,r;if(m.user){if(n===m.user.uid){K(y("sharing.ownRequestError"),"error");return}try{let s=(await Xn(ne(G,"users",n))).exists();if(!s){const i=m.friends.find(o=>o.id===n);if(i!=null&&i.email){const c=(await Ke(qe(G,"users"))).docs.find(l=>{const u=l.data(),h=(u.email||u["e-mail"]||"").toLowerCase();return h&&h===i.email.toLowerCase()});c&&(n=c.id,s=!0,i.id=n,Dt(),pt(ne(G,"users",m.user.uid,"friends",n),i).catch(l=>console.warn(l)))}}if(!s){K(y("sharing.notRegisteredError",{name:e}),"error");return}await pt(ne(G,"shareRequests",TP(n,m.user.uid)),{ownerUid:n,ownerName:e,viewerUid:m.user.uid,viewerName:((t=m.profile)==null?void 0:t.name)||"—",status:"afventer",createdAt:Ge(),updatedAt:Ge()}),K(y("sharing.requestSentToast"),"success"),await gv(),ar(),(r=window.renderFriendsList)==null||r.call(window)}catch(s){K(y("common.errorPrefix")+s.message,"error")}}};window.cancelShareRequest=async function(n){var e;try{await Lt(ne(G,"shareRequests",n)),m.shareRequests=m.shareRequests.filter(t=>t.id!==n),ar(),(e=window.renderFriendsList)==null||e.call(window)}catch(t){K(y("common.errorPrefix")+t.message,"error")}};window.acceptShareRequest=async function(n){try{await Ze(ne(G,"shareRequests",n),{status:"accepteret",acceptedAt:Ge(),updatedAt:Ge()});const e=m.shareRequests.find(t=>t.id===n);e&&(e.status="accepteret"),ar(),yc(),K(y("sharing.acceptedToast"),"success")}catch(e){K(y("common.errorPrefix")+e.message,"error")}};window.declineShareRequest=function(n){or(y("sharing.rejectConfirm"),async()=>{try{await Ze(ne(G,"shareRequests",n),{status:"afvist",updatedAt:Ge()});const e=m.shareRequests.find(t=>t.id===n);e&&(e.status="afvist"),ar(),yc()}catch(e){K(y("common.errorPrefix")+e.message,"error")}})};window.endSharing=function(n){or(y("sharing.stopConfirm"),async()=>{try{await Lt(ne(G,"shareRequests",n)),m.shareRequests=m.shareRequests.filter(e=>e.id!==n),ar(),K(y("sharing.stoppedToast"),"success")}catch(e){K(y("common.errorPrefix")+e.message,"error")}})};const AP="BOJHqC2HeXd9Ru6EjuL7HEuAZuZ2MM86LPqPfVbeQsm8M8-wgT_u3QPWYFs0XN0vfMz_FS3rDgjXgCXXm0GkmZs",SP="/3D/sw.js";async function _v(){if(!("serviceWorker"in navigator))return null;try{return await navigator.serviceWorker.register(SP,{scope:"/3D/3D-dev/"})}catch(n){return console.warn("SW-registrering fejlede",n),null}}function RP(){return"Notification"in window&&Notification.permission==="default"}async function wv(){let n;try{n=await Notification.requestPermission()}catch(e){return console.warn("Notification.requestPermission fejlede",e),K(y("push.permissionError",{msg:e.message}),"error"),!1}if(n==="denied")return K(y("push.blocked"),"error"),!1;if(n!=="granted")return!1;try{if(!await Hy||!so)return K(y("push.unsupported"),"error"),!1;const t=await _v();if(!t)return K(y("push.swError"),"error"),!1;const r=await U0(so,{vapidKey:AP,serviceWorkerRegistration:t});return r?(await Ze(ne(G,"users",m.user.uid),{fcmToken:r}),!0):(K(y("push.tokenError"),"error"),!1)}catch(e){return console.warn("Push-opsætning fejlede",e),K(y("push.genericError",{msg:e.message}),"error"),!1}}function PP(){"Notification"in window&&Notification.permission==="granted"&&wv()}function CP(){Hy.then(n=>{!n||!so||j0(so,e=>{const t=e.data||{};K(t.body||y("push.newMessageFallback"),"info"),od().then(()=>{Vt(),wo()}).catch(()=>{})})})}function Kf(n,e){var S;const t=E=>{var R;return E.shooters.find(I=>I.id===e)||((R=E.shooters)==null?void 0:R[0])},r=n.map(E=>{const R=t(E);return R?dt(R.scores):null}).filter(E=>E!==null),s=new Set(n.map(E=>E.ruleset||Zn)),i=s.size===1?[...s][0]:null,o=!!i&&qt(i)>=2;let c=0,l=0,u=0,h=0;const p=o?er(i):[],g={},w={};p.forEach(E=>{g[E]=0,w[E]=0});const A={};let P=0,D=0;n.forEach(E=>{const R=t(E);R&&(R.scores.forEach(I=>{I.forEach(Se=>{Se!=null&&(A[Se]=(A[Se]||0)+1,P+=ve(Se),D++)})}),o&&R.scores.forEach(I=>{I[0]!=null&&(g[I[0]]!==void 0&&g[I[0]]++,c+=ve(I[0]),l++),I[1]!=null&&(w[I[1]]!==void 0&&w[I[1]]++,u+=ve(I[1]),h++)}))});const N=l?(c/l).toFixed(2):0,V=h?(u/h).toFixed(2):0,F=l+h?((c+u)/(l+h)).toFixed(2):0,q=D?(P/D).toFixed(2):0,te=((S=n[0])==null?void 0:S.numTargets)||24,b=Array.from({length:te},(E,R)=>{let I=0,Se=0;return n.forEach(We=>{const cr=t(We);if(!cr)return;(cr.scores[R]||[null,null]).forEach(bt=>{bt!=null&&(I+=ve(bt),Se++)})}),Se?I/Se:null}).map((E,R)=>({v:E,i:R})).filter(E=>E.v!==null),_=b.length?b.reduce((E,R)=>E.v>R.v?E:R):null,T=b.length?b.reduce((E,R)=>E.v<R.v?E:R):null;return{myScores:r,p1avg:N,p2avg:V,pilAvg:F,overallPilAvg:q,distP1:g,distP2:w,distAll:A,bestTarget:_,worstTarget:T,pilRuleset:i,pilEligible:o}}function zf(n){if(!n.length)return 0;const e=n.reduce((t,r)=>t+r,0)/n.length;return Math.sqrt(n.reduce((t,r)=>t+(r-e)**2,0)/n.length)}function kP(n){var l;const e=n.length;if(e<2)return{slope:0,intercept:((l=n[0])==null?void 0:l.y)||0};const t=n.reduce((u,h)=>u+h.x,0),r=n.reduce((u,h)=>u+h.y,0),s=n.reduce((u,h)=>u+h.x*h.y,0),i=n.reduce((u,h)=>u+h.x*h.x,0),o=e*i-t*t,c=o?(e*s-t*r)/o:0;return{slope:c,intercept:(r-c*t)/e}}function DP(n,e){var o,c;const t=((o=n.shooters)==null?void 0:o.find(l=>l.id===e))||((c=n.shooters)==null?void 0:c[0]);if(!t)return[];const r=n.numTargets||24,s=n.traversalOrder||Array.from({length:r},(l,u)=>u),i=[];for(let l=0;l<r;l++){const u=s[l];if(u===void 0)continue;const h=t.scores[u]||[null,null];let p=0,g=0;h.forEach(w=>{w!=null&&(p+=ve(w),g++)}),g&&i.push(p/g)}return i}const Iv=[{key:"under25",max:25},{key:"25to35",min:25,max:35},{key:"35to45",min:35,max:45},{key:"over45",min:45}];function NP(n){return Iv.find(e=>(e.min==null||n>=e.min)&&(e.max==null||n<e.max))}function Hf(n){return n!=null&&n.toDate?n.toDate().getTime():n!=null&&n.seconds?n.seconds*1e3:typeof n=="number"?n:null}const xP=10,Wf=56,LP=4;function VP(n,e,t){const r=N=>{var V;return N.shooters.find(F=>F.id===e)||((V=N.shooters)==null?void 0:V[0])},s={};Iv.forEach(N=>{s[N.key]={...N,shots:0,kills:0,scoreSum:0}});const i=new Set;n.forEach(N=>{var te;const V=t.find(Z=>Z.id===N.courseId);if(!V||!((te=V.targets)!=null&&te.length))return;const F=r(N);if(!F)return;const q=J0(N.ruleset||Zn);F.scores.forEach((Z,b)=>{var S;const _=(S=V.targets[b])==null?void 0:S.distance;if(_==null)return;const T=NP(_);T&&Z.forEach(E=>{E!=null&&(s[T.key].shots++,s[T.key].scoreSum+=ve(E),q.includes(E)&&s[T.key].kills++,i.add(N.id))})})});const o=Object.values(s).filter(N=>N.shots>0).map(N=>({...N,killPct:N.kills/N.shots*100,avgPerArrow:N.scoreSum/N.shots})),c=o.reduce((N,V)=>N+V.shots,0),l=o.reduce((N,V)=>N+V.kills,0),u=o.reduce((N,V)=>N+V.scoreSum,0),h=c?{killPct:l/c*100,avgPerArrow:u/c}:null,p=o.filter(N=>N.shots>=xP),g=p.length?p.reduce((N,V)=>V.killPct<N.killPct?V:N):null;let w=null;if(g&&h&&g.avgPerArrow<h.avgPerArrow&&i.size){const N=g.shots/i.size,V=(h.avgPerArrow-g.avgPerArrow)*N;V>=.5&&(w=Math.round(V))}const A=Date.now()-Wf*864e5,P=n.map(N=>{const V=Hf(N.completed)??Hf(N.created),F=r(N);if(!F||V==null||V<A)return null;const q=F.scores.flat().filter(te=>te!=null);return q.length?{ms:V,avgPerArrow:q.reduce((te,Z)=>te+ve(Z),0)/q.length}:null}).filter(Boolean).sort((N,V)=>N.ms-V.ms);let D=null;if(P.length>=LP){const N=Math.ceil(P.length/2),V=P.slice(0,N),F=P.slice(N),q=b=>b.reduce((_,T)=>_+T.avgPerArrow,0)/b.length,te=q(V),Z=q(F);te>0&&(D={pctChange:(Z-te)/te*100,weeks:Wf/7,rounds:P.length})}return{buckets:o,overall:h,weakest:g,pointPotential:w,trend:D,hasData:o.length>0}}function OP(n,e){let t=1,r=0,s=0,i=0,o=1,c=0,l=0,u=0,h=0,p=0,g=0,w=0,A=0;const P=()=>{e.style.transformOrigin="0 0",e.style.transform=t>1?`translate(${r}px,${s}px) scale(${t})`:""};n.addEventListener("touchstart",N=>{if(N.preventDefault(),N.touches.length===2){const V=N.touches,F=n.getBoundingClientRect();i=Math.hypot(V[0].clientX-V[1].clientX,V[0].clientY-V[1].clientY),o=t,c=r,l=s,u=(V[0].clientX+V[1].clientX)/2-F.left,h=(V[0].clientY+V[1].clientY)/2-F.top}else N.touches.length===1&&(p=N.touches[0].clientX,g=N.touches[0].clientY,w=r,A=s)},{passive:!1}),n.addEventListener("touchmove",N=>{if(N.preventDefault(),N.touches.length===2){const V=N.touches,F=Math.hypot(V[0].clientX-V[1].clientX,V[0].clientY-V[1].clientY),q=Math.min(8,Math.max(1,o*F/i)),te=(u-c)/o,Z=(h-l)/o;r=u-te*q,s=h-Z*q,t=q,P()}else N.touches.length===1&&t>1&&(r=w+N.touches[0].clientX-p,s=A+N.touches[0].clientY-g,P())},{passive:!1}),n.addEventListener("touchend",()=>{t<1.05&&(t=1,r=0,s=0,P())},{passive:!0});let D=0;n.addEventListener("touchend",()=>{const N=Date.now();N-D<300&&(t=1,r=0,s=0,P()),D=N},{passive:!0})}let Qt=null,Sr=null;function MP(){const n=document.getElementById("graph-fs");n&&n.classList.add("hidden"),Qt&&(window.removeEventListener("resize",Qt),window.removeEventListener("orientationchange",Qt),Qt=null),Sr&&(document.removeEventListener("gesturestart",Sr),Sr=null)}window.closeGraphFs=MP;function BP(n){m.pendingAnalyseRound=n,m.viewingUid=null,m.viewingName=null,document.getElementById("analyse-filter").value="specific",window.switchTab("analyse")}window.setAnalyseViewer=async function(n){m.viewingUid=n||null;const e=n?yv().find(t=>t.uid===n):null;m.viewingName=(e==null?void 0:e.name)||null,n&&!m.viewedRounds[n]&&await vv(n),window.renderAnalyse()};window.analyseRound=BP;window.setCompareKilde=async function(n,e){e=e||null,n===1?m.compareUid1=e:m.compareUid2=e,e&&!m.viewedRounds[e]&&await vv(e),window.renderAnalyse()};const FP={11:"#1a7a3a",10:"#1a5aaa",8:"#d4700a",5:"#7a3aaa",M:"#cc3333",3:"#0a8a8a","-1":"#5a5a6a"};function $P(n,e,t,r){const s=n.myScores[0]||0,i=t.myScores[0]||0,o=Math.abs(s-i),c='<div class="cmp-sep"></div>',l=(g,w,A)=>`<div style="font-size:11px;color:${A};margin-bottom:4px;">${z(w)}</div>
    ...
    <div class="pil-best-note">${g.pilRuleset?y("analyse.singleArrowNoteCompare",{ruleset:g.pilRuleset}):y("analyse.notRelevant")}</div>`}`,u=(g,w,A)=>g.bestTarget&&g.worstTarget?`<div style="font-size:11px;color:${A};margin-bottom:6px;">${z(w)}</div>
    ...
    <div class="cmp-winner-line">${s>i?y("analyse.wonBy",{name:z(e),diff:o}):i>s?y("analyse.wonBy",{name:z(r),diff:o}):y("analyse.tie")}</div>
  ...
  </div>`,h}window.renderAnalyse=function(){var hr,ti,ni,Eo,Pn,ri,si,ss,bo,Ao,is,ii,oi,Cn,os,as;const n=document.getElementById("analyse-content");if(!n)return;const e=m.viewingUid||((hr=m.user)==null?void 0:hr.uid),t=m.viewingUid?m.viewedRounds[m.viewingUid]||[]:m.rounds,r=yv(),s=((ti=document.getElementById("analyse-filter"))==null?void 0:ti.value)||"all",i=s==="compare",o=m.compareUid1!==void 0?m.compareUid1:m.viewingUid,c=m.compareUid2!==void 0?m.compareUid2:m.viewingUid,l=o?m.viewedRounds[o]||[]:m.rounds,u=c?m.viewedRounds[c]||[]:m.rounds,h=document.getElementById("analyse-viewer-wrap"),p=document.getElementById("analyse-viewer");if(p){for(;p.options.length>1;)p.remove(1);r.forEach(O=>{const B=document.createElement("option");B.value=O.uid,B.textContent=O.name,p.appendChild(B)}),p.value=m.viewingUid&&r.some(O=>O.uid===m.viewingUid)?m.viewingUid:"",h&&h.classList.toggle("hidden",!r.length)}const g=(O,B)=>{if(O){for(;O.options.length>1;)O.remove(1);r.forEach(H=>{const Q=document.createElement("option");Q.value=H.uid,Q.textContent=H.name,O.appendChild(Q)}),O.value=B&&r.some(H=>H.uid===B)?B:"",O.classList.toggle("hidden",!i||!r.length)}};g(document.getElementById("analyse-kilde-1"),o),g(document.getElementById("analyse-kilde-2"),c);const w=document.getElementById("analyse-bane");if(w){const O=w.value;for(;w.options.length>1;)w.remove(1);const B=i?[...l,...u]:t,H=[...new Set(B.map(Q=>Q.courseId).filter(Boolean))];H.forEach(Q=>{const J=m.courses.find(ie=>ie.id===Q);if(J){const ie=document.createElement("option");ie.value=Q,ie.textContent=J.name,w.appendChild(ie)}}),H.includes(O)&&(w.value=O)}if(m.pendingAnalyseRound&&w&&!m.viewingUid){const O=m.rounds.find(B=>B.id===m.pendingAnalyseRound);O!=null&&O.courseId&&Array.from(w.options).some(B=>B.value===O.courseId)&&(w.value=O.courseId)}const A=s==="all"?0:s==="lastround"?1:s==="specific"?0:Number(s),P=((ni=document.getElementById("analyse-bane"))==null?void 0:ni.value)||"all",D=Number((Eo=document.getElementById("analyse-antal"))==null?void 0:Eo.value)||0,N=document.getElementById("analyse-runde-wrap"),V=document.getElementById("analyse-runde"),F=document.getElementById("analyse-runde-wrap-2"),q=document.getElementById("analyse-runde-2"),te=document.getElementById("analyse-runde-lbl");N&&(N.style.display=s==="specific"||i?"":"none"),F&&(F.style.display=i?"":"none"),te&&(te.style.display=i?"":"none");const Z=O=>{const B=O.created;return B!=null&&B.toDate?B.toDate().toLocaleDateString(nn()):B!=null&&B.seconds?new Date(B.seconds*1e3).toLocaleDateString(nn()):typeof B=="number"?new Date(B).toLocaleDateString(nn()):"—"},b=((Pn=document.getElementById("analyse-ruleset"))==null?void 0:Pn.value)||"all",_=(O,B,H)=>{let Q=P==="all"?H:H.filter(ie=>ie.courseId===P);b!=="all"&&(Q=Q.filter(ie=>(ie.ruleset||"WA")===b));const J=O.value;O.innerHTML=`<option value="">${B}</option>`,Q.forEach(ie=>{const ae=document.createElement("option");ae.value=ie.id,ae.textContent=`${Z(ie)} — ${ie.name||y("results.roundFallback")}`,O.appendChild(ae)}),Q.some(ie=>ie.id===J)&&(O.value=J)};if((s==="specific"||i)&&V&&(_(V,y("analyse.selectRoundPlaceholder"),i?l:t),m.pendingAnalyseRound&&(V.value=m.pendingAnalyseRound,m.pendingAnalyseRound=null)),i&&q&&_(q,y("analyse.selectRound2Placeholder"),u),i){const O=V==null?void 0:V.value,B=q==null?void 0:q.value;if(!O||!B){n.innerHTML=`<div class="empty"><div class="empty-icon">📊</div>${y("analyse.selectTwoRounds")}</div>`;return}const H=oe=>({...oe,shooters:(oe.shooters||[]).map(Pe=>({...Pe,scores:Kr(Pe.scores)}))}),Q=l.map(H).find(oe=>oe.id===O),J=u.map(H).find(oe=>oe.id===B);if(!Q||!J){n.innerHTML=`<div class="empty">${y("analyse.roundsNotFound")}</div>`;return}const ie=o?((ri=r.find(oe=>oe.uid===o))==null?void 0:ri.name)||"—":((si=m.profile)==null?void 0:si.name)||y("analyse.meFallback"),ae=c?((ss=r.find(oe=>oe.uid===c))==null?void 0:ss.name)||"—":((bo=m.profile)==null?void 0:bo.name)||y("analyse.meFallback"),me=`${ie}: ${Q.name||y("results.roundFallback")} (${Z(Q)})`,Te=`${ae}: ${J.name||y("results.roundFallback")} (${Z(J)})`;n.innerHTML=$P(Kf([Q],o||((Ao=m.user)==null?void 0:Ao.uid)),me,Kf([J],c||((is=m.user)==null?void 0:is.uid)),Te);return}const T=t.map(O=>({...O,shooters:(O.shooters||[]).map(B=>({...B,scores:Kr(B.scores)}))})),S=((ii=document.getElementById("analyse-completed-only"))==null?void 0:ii.checked)||!1,E=((oi=document.getElementById("analyse-startat1-only"))==null?void 0:oi.checked)||!1,R=O=>{var Q,J;const B=((Q=O.shooters)==null?void 0:Q.find(ie=>ie.id===e))||((J=O.shooters)==null?void 0:J[0]);if(!B)return!1;const H=O.numTargets||24;for(let ie=0;ie<H;ie++){const ae=B.scores[ie]||[null,null];if(ae[0]==null&&ae[1]==null)return!1}return!0},I=O=>O.startTarget===1,Se=b;let We=P==="all"?T:T.filter(O=>O.courseId===P);if(Se!=="all"&&(We=We.filter(O=>(O.ruleset||"WA")===Se)),S&&(We=We.filter(R)),E&&(We=We.filter(I)),s==="specific"){const O=V==null?void 0:V.value;We=O?We.filter(B=>B.id===O):[]}const cr=D||A,Qe=cr&&s!=="specific"?We.slice(0,cr):We;if(!Qe.length){n.innerHTML=`<div class="empty"><div class="empty-icon">📈</div>${y("results.empty")}</div>`;return}const bt=O=>{var B;return O.shooters.find(H=>H.id===e)||((B=O.shooters)==null?void 0:B[0])},Ye=Qe.map(O=>{const B=bt(O);return B?dt(B.scores):null}).filter(O=>O!==null),To=Ye.length?(Ye.reduce((O,B)=>O+B,0)/Ye.length).toFixed(1):0,wc=Ye.length?Math.max(...Ye):0,Gt=Ye.length?Math.min(...Ye):0,Ue=Qe.flatMap(O=>{const B=bt(O);return B?B.scores.flat().filter(H=>H!=null):[]}),Js=Ue.length?(Ue.reduce((O,B)=>O+ve(B),0)/Ue.length).toFixed(2):0,Tn=new Set(Qe.map(O=>O.ruleset||Zn)),En=Tn.size===1?[...Tn][0]:null,Kt=!!En&&qt(En)>=2;let Xs=0,lr=0,bn=0,zt=0;const es=Kt?er(En):[],An={},Sn={};es.forEach(O=>{An[O]=0,Sn[O]=0}),Qe.forEach(O=>{const B=bt(O);B&&Kt&&B.scores.forEach(H=>{H[0]!=null&&(An[H[0]]!==void 0&&An[H[0]]++,Xs+=ve(H[0]),lr++),H[1]!=null&&(Sn[H[1]]!==void 0&&Sn[H[1]]++,bn+=ve(H[1]),zt++)})});const ur=lr?(Xs/lr).toFixed(2):0,ts=zt?(bn/zt).toFixed(2):0,Ic=lr+zt?((Xs+bn)/(lr+zt)).toFixed(2):0,At=((Cn=Qe[0])==null?void 0:Cn.numTargets)||24,Zs=Array.from({length:At},(O,B)=>{let H=0,Q=0;return Qe.forEach(J=>{const ie=bt(J);if(!ie)return;const me=(J.traversalOrder||Array.from({length:J.numTargets||At},(oe,Pe)=>Pe))[B];if(me===void 0)return;(ie.scores[me]||[null,null]).forEach(oe=>{oe!=null&&(H+=ve(oe),Q++)})}),Q?H/Q:null}),Rn=Zs.map((O,B)=>({v:O,i:B})).filter(O=>O.v!==null),dr=Rn.length?Rn.reduce((O,B)=>O.v>B.v?O:B):null,ns=Rn.length?Rn.reduce((O,B)=>O.v<B.v?O:B):null;let _e="";m.viewingUid&&(_e+=`<div class="viewing-banner">👁 ${y("analyse.viewingResultsFor",{name:z(m.viewingName||"—")})}</div>`),_e+=`<div class="stats-grid2">
  ...
  </div>`,_e+=`<details class="card card-mb16 rounds-included-card">
    ...
    <div class="rounds-included-list">
      ${Qe.map(O=>`<div class="rounds-included-row"><span class="rounds-included-date">${Z(O)}</span><span class="rounds-included-name">${z(O.name||y("results.roundFallback"))}${P==="all"?` · ${z(O.courseName||"")}`:""}${O.ruleset&&O.ruleset!=="WA"?` · <span class="rcard-ruleset-tag">${z(O.ruleset)}</span>`:""}</span></div>`).join("")}
    </div>
  </details>`;const ei=En&&!Kt,rs=En?y("analyse.singleArrowNote",{ruleset:En}):y("analyse.selectRulesetNote");_e+=`<div class="card card-mb16">
    ...
    <div class="pil-best-note">
      ${Number(ur)>Number(ts)?y("analyse.bestWithArrow1"):Number(ts)>Number(ur)?y("analyse.bestWithArrow2"):y("analyse.bothArrowsEqual")}
  ...
  </div>`,dr&&ns&&dr.i!==ns.i&&(_e+=`<div class="card card-mb16">
    ...
    </div>`);const we=VP(Qe,e,m.courses);if(we.hasData){const O={under25:"distBucketUnder25","25to35":"distBucket25to35","35to45":"distBucket35to45",over45:"distBucketOver45"};if(_e+=`<div class="card card-mb16">
      <div class="section-title-mb8">${y("analyse.distanceInsightsTitle")}</div>`,we.trend){const B=we.trend.pctChange,H=we.trend.weeks,Q=Math.abs(B)<.5?y("analyse.trendFlat",{weeks:H}):B>0?y("analyse.trendUp",{pct:B.toFixed(1),weeks:H}):y("analyse.trendDown",{pct:Math.abs(B).toFixed(1),weeks:H});_e+=`<div class="dist-trend-line">${Q}</div>`}else _e+=`<div class="dist-trend-line dist-trend-muted">${y("analyse.trendNotEnoughData",{weeks:8})}</div>`;if(_e+=`<div class="dist-bucket-grid">${we.buckets.map(B=>`
      <div class="dist-bucket-cell">
        <div class="stat-lbl">${y("analyse."+O[B.key])}</div>
        <div class="dist-bucket-pct">${B.killPct.toFixed(0)}%</div>
        <div class="target-sub-13">${y("analyse.killZoneLabel")} · ⌀ ${B.avgPerArrow.toFixed(2)}</div>
      </div>`).join("")}</div>`,we.weakest){const B=y("analyse."+O[we.weakest.key]);_e+=`<div class="dist-weakest-note">${y("analyse.weakestZone",{range:B})}</div>`,we.pointPotential!=null&&(_e+=`<div class="dist-weakest-note">${y("analyse.pointPotential",{range:B,n:we.pointPotential})}</div>`)}_e+="</div>"}if(_e+=`<div class="card card-mb16">
    <div class="section-title-mb12">${y("analyse.zoneDistTitle")}</div>`,Kt?(_e+='<div class="pie-grid">',es.forEach(O=>{const B=An[O]||0,H=Sn[O]||0,Q=B+H,J=30;let ie="";if(Q===0)ie=`<circle cx="${J}" cy="${J}" r="${J}" fill="var(--surface2)"/>`;else if(H===0)ie=`<circle cx="${J}" cy="${J}" r="${J}" fill="#ffd700"/>`;else if(B===0)ie=`<circle cx="${J}" cy="${J}" r="${J}" fill="#00cc44"/>`;else{const ae=B/Q,me=ae*2*Math.PI,Te=J,oe=0,Pe=J-J*Math.sin(me),Ht=J-J*Math.cos(me),Ce=me>Math.PI?1:0;ie=`<path d="M${J},${J} L${Te},${oe} A${J},${J} 0 ${Ce},0 ${Pe},${Ht} Z" fill="#ffd700"/>
             <path d="M${J},${J} L${Pe},${Ht} A${J},${J} 0 ${1-Ce},0 ${Te},${oe} Z" fill="#00cc44"/>`}_e+=`<div class="pie-cell">
        <div class="pie-zone-label">${O}</div>
        <svg viewBox="0 0 ${J*2} ${J*2}" class="pie-svg">${ie}</svg>
        <div class="pie-count">${B}/${H}</div>
      ...
      </div>`):_e+=`<div class="pil-best-note">${rs}</div>`,_e+="</div>",Ye.length>1){const Q=Math.min(...Ye)-5,J=Math.max(...Ye)+5,ie=Ye.slice().reverse().map((ae,me)=>{const Te=30+me/(Ye.length-1)*280,oe=90-(ae-Q)/(J-Q)*(120-2*30);return`${Te},${oe}`}).join(" ");_e+=`<div class="card card-mb16">
      ...
      <svg viewBox="0 0 340 120" class="graph-svg">
        ...
        ${Ye.slice().reverse().map((ae,me)=>{const Te=30+me/(Ye.length-1)*280,oe=90-(ae-Q)/(J-Q)*(120-2*30);return`<circle cx="${Te}" cy="${oe}" r="4" fill="var(--acc)"/><text x="${Te}" y="${oe-8}" text-anchor="middle" font-size="10" fill="var(--text)">${ae}</text>`}).join("")}
        ...
        <text x="${ft(At-1)}" y="${st-5}" text-anchor="end" font-size="9" fill="var(--muted)" pointer-events="none">${At}</text>`},Nt=Math.max(340,At*30);_e+=`<div class="card card-mb16">
    ...
    <div id="graph-fs" class="fs-ov hidden graph-fs-overlay" onclick="window.closeGraphFs()">
    ...
    </div>`,window.openGraphFs=function(){const Ne=document.getElementById("graph-fs");if(!Ne)return;Ne.classList.remove("hidden");const st=document.getElementById("graph-fs-svg"),Ot=document.getElementById("graph-fs-box"),Je=document.getElementById("graph-fs-viewport"),fr=()=>{const ft=Math.min(window.innerWidth*.96,900),et=Math.min(window.innerHeight*.9,700),kn=Math.max(200,ft-32),Dn=Math.max(140,et-90),mr=Math.max(kn,At*30);st.setAttribute("viewBox",`0 0 ${mr} ${Dn}`),st.innerHTML=_t(mr,Dn,{dotR:5,valFont:10,showVals:!0}),Ot&&(Ot.style.width=ft+"px"),Je&&(Je.style.width=kn+"px",Je.style.height=Dn+"px")};fr(),Qt&&(window.removeEventListener("resize",Qt),window.removeEventListener("orientationchange",Qt)),Qt=fr,window.addEventListener("resize",Qt),window.addEventListener("orientationchange",Qt),Sr&&document.removeEventListener("gesturestart",Sr),Sr=ft=>ft.preventDefault(),document.addEventListener("gesturestart",Sr,{passive:!1}),Je&&!Je.dataset.pinchInit&&(OP(Je,st),Je.dataset.pinchInit="1")}}if(P!=="all"){const O=H=>{const Q=H.created;return Q!=null&&Q.toDate?Q.toDate().getTime():Q!=null&&Q.seconds?Q.seconds*1e3:typeof Q=="number"?Q:0},B=T.filter(H=>H.courseId===P).filter(H=>!S||R(H)).filter(H=>!E||I(H)).map(H=>{const Q=DP(H,e);return Q.length>1?{t:O(H),cv:zf(Q)}:null}).filter(Boolean).sort((H,Q)=>H.t-Q.t);if(B.length>1){const ie=B.map(Ce=>Ce.cv),ae=Math.min(...ie),me=Math.max(...ie),Te=me-ae||1,oe=(Ce,Be)=>({x:30+Be/(B.length-1)*(340-2*30),y:90-(Ce.cv-ae)/Te*(120-2*30)}),Pe=B.map((Ce,Be)=>{const{x:_t,y:Nt}=oe(Ce,Be);return`${_t},${Nt}`}).join(" "),Ht=B.map((Ce,Be)=>{const{x:_t,y:Nt}=oe(Ce,Be);return`<circle cx="${_t}" cy="${Nt}" r="4" fill="#f0c030"/><text x="${_t}" y="${Nt-8}" text-anchor="middle" font-size="10" fill="var(--text)">${Ce.cv.toFixed(2)}</text>`}).join("");_e+=`<div class="card card-mb16">
      ...
      </div>`}}if(n.innerHTML=_e,!m.viewingUid&&P!=="all"&&((os=m.profile)!=null&&os.kon)&&((as=m.profile)!=null&&as.bueklasse)){const O=m.profile.kon==="herre"?y("common.gender.herre"):y("common.gender.dame"),H={langbue:"langbue",trad:"trad",recurve:"recurve",compound:"compound",barbue:"barbue",buejæger:"buejaeger","trad-buejæger":"tradBuejaeger",rytterbue:"rytterbue"}[m.profile.bueklasse],Q=H?y("common.bowClassShort."+H):m.profile.bueklasse,J=document.createElement("div");J.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">${y("analyse.comparisonSectionTitle",{gender:O,bowClass:Q})}</div><div class="comp-loading-msg">${y("analyse.loadingComparison")}</div></div>`,n.appendChild(J),Ke(qe(G,"bane_stats",P,"runder")).then(ie=>{let me=ie.docs.map(Be=>Be.data()).filter(Be=>Be.kon===m.profile.kon&&Be.bueklasse===m.profile.bueklasse);if(Se!=="all"&&(me=me.filter(Be=>(Be.ruleset||Zn)===Se)),!me.length){J.innerHTML=`<div class="card card-mb16"><div class="section-title-mb8">${y("analyse.comparisonSectionTitle",{gender:O,bowClass:Q})}</div><div class="comp-loading-msg">${y("analyse.noOtherShootersYet",{gender:O,bowClass:Q})}</div></div>`;return}const Te=me.filter(Be=>(Be.arrowsShot||Be.numTargets*2)>0),oe=Te.length?(Te.reduce((Be,_t)=>Be+_t.score/(_t.arrowsShot||_t.numTargets*2),0)/Te.length).toFixed(2):"—",Pe=oe!=="—"?Number(Js)-Number(oe):null,Ht=Pe!==null?(Pe>0?"+":"")+Pe.toFixed(2):"—",Ce=Pe===null?"var(--muted)":Pe>0?"#2aaa5a":Pe<0?"var(--danger)":"var(--muted)";J.innerHTML=`<div class="card card-mb16">
        <div class="section-title-mb12">${y("analyse.comparisonSectionTitle",{gender:O,bowClass:Q})}</div>
