...
export const translations = {
  da: {
    ...
    setup: {
      ...
      boostTitle:'🟢 Positiv forstærkning', enableBoost:'Aktiver positiv forstærkning',
      boostThreshPre:'Grøn prik hvis gns. mindst', boostThreshPost:'point/pil',
  ...
  en: {
    ...
    setup: {
      ...
      boostTitle:'🟢 Positive reinforcement', enableBoost:'Enable positive reinforcement',
      boostThreshPre:'Green dot if avg. at least', boostThreshPost:'points/arrow',
