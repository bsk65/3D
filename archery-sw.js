const CACHE='archery-2026-v13';
const FILES=['./archery-app.html'];
...
self.addEventListener('fetch',function(e){e.respondWith(caches.match(e.request).then(function(r){return r||fetch(e.request).catch(function(){return caches.match('./archery-app.html');});}));});
